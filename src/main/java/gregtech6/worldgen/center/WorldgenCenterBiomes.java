...
public class WorldgenCenterBiomes extends WorldgenObject {
    ...
    public void reset(World aWorld, Chunk aChunk, int aDimType, int aMinX, int aMinZ, int aMaxX, int aMaxZ,
        ...
        if (GENERATE_BIOMES && aDimType == DIM_OVERWORLD && aMinX >= -96 && aMinX <= 80 && aMinZ >= -96 && aMinZ <= 80)
            GENERATING_SPECIAL = T;
    }
            ...
            if (aMinX == -16 || aMinX == 0 || aMinZ == -16 || aMinZ == 0) {
                ...
                for (int i = 0; i < 16; i++) for (int j = 0; j < 16; j++) {
                    ...
                    WD.set(
                        ...
                        j,
                        BlocksGT.Sands,
                        aMinX < 0 ? aMinZ < 0 ? 0 : 1 : aMinZ < 0 ? 2 : 0);
                ...
                if (aMinZ < 0) {
                    if ((aMinX == -80 || aMinX == -64) && (aMinZ == -80 || aMinZ == -64)) {
                        ...
                        for (int i = 0; i < 16; i++) for (int j = 0; j < 16; j++) {
                            ...
                            for (int k = 1; k < mHeight - 5; k++) WD.set(
                                aChunk,
                                i,
                                k,
                                j,
                                k < 32 ? BlocksGT.SchistGreen : BlocksGT.SchistBlue,
                                aRandom.nextBoolean() ? 2 : 0);
                        }
                    } else {
                        ...
                        new WorldGenTrees(F, 4 + aRandom.nextInt(3), 1, 1, F)
                            .generate(aWorld, aRandom, aMinX + 4, mHeight + 1, aMinZ + 4);
                        new WorldGenTrees(F, 4 + aRandom.nextInt(3), 1, 1, F)
                            .generate(aWorld, aRandom, aMinX + 12, mHeight + 1, aMinZ + 4);
                        new WorldGenTrees(F, 4 + aRandom.nextInt(3), 1, 1, F)
                            .generate(aWorld, aRandom, aMinX + 4, mHeight + 1, aMinZ + 12);
                        new WorldGenTrees(F, 4 + aRandom.nextInt(3), 1, 1, F)
                            .generate(aWorld, aRandom, aMinX + 12, mHeight + 1, aMinZ + 12);
                    }
                } else {
                    if ((aMinX == -80 || aMinX == -64) && (aMinZ == 48 || aMinZ == 64)) {
                        ...
                        for (int i = 0; i < 16; i++) for (int j = 0; j < 16; j++) {
                            ...
                            for (int k = 1; k < mHeight - 5; k++) WD.set(
                                ...
                                k,
                                j,
                                k < 32 ? BlocksGT.Kimberlite : BlocksGT.Quartzite,
                                aRandom.nextBoolean() ? 2 : 0);
                        }
                        ...
                        new WorldGenTrees(F, 4 + aRandom.nextInt(3), 0, 0, F)
                            .generate(aWorld, aRandom, aMinX + 4, mHeight + 1, aMinZ + 4);
                        new WorldGenTrees(F, 4 + aRandom.nextInt(3), 2, 2, F)
                            .generate(aWorld, aRandom, aMinX + 12, mHeight + 1, aMinZ + 4);
                        new WorldGenTrees(F, 4 + aRandom.nextInt(3), 2, 2, F)
                            .generate(aWorld, aRandom, aMinX + 4, mHeight + 1, aMinZ + 12);
                        new WorldGenTrees(F, 4 + aRandom.nextInt(3), 0, 0, F)
                        ...
                        for (int i = 0; i < 16; i++) for (int j = 0; j < 16; j++) {
                            ...
                            for (int k = 1; k < mHeight - 6; k++) WD.set(
                                aChunk,
                                i,
                                k,
                                j,
                                k < 32 ? BlocksGT.Limestone : BlocksGT.Marble,
                                aRandom.nextBoolean() ? 2 : 0);
                            switch (aRandom.nextInt(60)) {
                                case 0:
                                case 1:
                                case 2:
                                    if (tRegistry != null) tRegistry.mBlock.placeBlock(
                                        aWorld,
                                        aMinX + i,
                                        mHeight + 1,
                                        aMinZ + j,
                                        SIDE_UNKNOWN,
                                        (short) 32757,
                                        ST.save(NBT_VALUE, ST.make(Items.flint, 1, 0)),
                                        F,
                                        T);
                                    break;
                                case 3:
                                ...
                                case 13:
                                case 14:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.tallgrass, 1);
                                    break;
                                case 15:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.yellow_flower, 0);
                                    break;
                                case 16:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 0);
                                    break;
                                case 17:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 1);
                                    break;
                                case 18:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 2);
                                    break;
                                case 19:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 3);
                                    break;
                                case 20:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 4);
                                    break;
                                case 21:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 5);
                                    break;
                                case 22:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 6);
                                    break;
                                case 23:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 7);
                                    break;
                                case 24:
                                    WD.set(aChunk, i, mHeight + 1, j, Blocks.red_flower, 8);
                                    break;
                            }
                        }
                    }
                    ...
                    if ((aMinX == 48 || aMinX == 64) && (aMinZ == 48 || aMinZ == 64)) {
                        ...
                        for (int i = 0; i < 16; i++) for (int j = 0; j < 16; j++) {
                            ...
                            for (int k = 1; k < mHeight - 5; k++) WD.set(
                                ...
                                k,
                                j,
                                k < 32 ? BlocksGT.GraniteRed : BlocksGT.GraniteBlack,
                                aRandom.nextBoolean() ? 2 : 0);
                            if (aRandom.nextInt(8) == 0)
                                WD.set(aChunk, i, mHeight + 1, j, BlocksGT.Glowtus, aRandom.nextInt(16));
                        }
                        ...
                        if (IL.EtFu_Dirt.exists()) {
                            ...
                            for (int i = 0; i < 16; i++) for (int j = 0; j < 16; j++) {
                                ...
                                for (int k = 1; k < mHeight - 5; k++) WD.set(
                                    ...
                                    k,
                                    j,
                                    k < 32 ? BlocksGT.Komatiite : BlocksGT.Basalt,
                                    aRandom.nextBoolean() ? 2 : 0);
                            }
                        } else {
                            for (int i = 0; i < 16; i++) for (int j = 0; j < 16; j++) {
                        ...
                        new WorldGenTrees(F, 9 + aRandom.nextInt(3), 3, 3, T)
                            .generate(aWorld, aRandom, aMinX + 4, mHeight + 1, aMinZ + 4);
                        new WorldGenTrees(F, 9 + aRandom.nextInt(3), 3, 3, T)
                            .generate(aWorld, aRandom, aMinX + 12, mHeight + 1, aMinZ + 4);
                        new WorldGenTrees(F, 9 + aRandom.nextInt(3), 3, 3, T)
