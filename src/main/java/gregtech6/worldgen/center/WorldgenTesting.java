    ...
    public boolean generate(World aWorld, Chunk aChunk, int aDimType, int aMinX, int aMinZ, int aMaxX, int aMaxZ,
        ...
        if (aMinX == 32 && aMinZ == -32) {
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 7133,
                UT.NBT.make(NBT_FACING, SIDE_X_POS),
                T,
                T);
            tRegistry.mBlock.placeBlock(
                aWorld,
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 14999,
                UT.NBT.make(NBT_ACTIVE_ENERGY, T),
                T,
                T);
            tRegistry.mBlock.placeBlock(
                aWorld,
                ...
                SIDE_UNKNOWN,
                (short) 14999,
                UT.NBT.make(NBT_ACTIVE_ENERGY, F),
                T,
                T);
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 32727,
                UT.NBT.make(NBT_FACING, SIDE_Z_POS),
                T,
                T);
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 5033,
                UT.NBT.make(NBT_FACING, SIDE_Z_NEG),
                T,
                T);
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 26304,
                UT.NBT.make(NBT_CONNECTION, (byte) (SBIT_U | SBIT_D)),
                T,
                T);
            tRegistry.mBlock.placeBlock(
                aWorld,
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 26304,
                UT.NBT.make(NBT_CONNECTION, (byte) (SBIT_U | SBIT_S)),
                T,
                T);
            tRegistry.mBlock.placeBlock(
                aWorld,
                ...
                SIDE_UNKNOWN,
                (short) 26304,
                UT.NBT.make(NBT_CONNECTION, SBIT_N),
                T,
                T);
            TileEntity tTileEntity = WD.te(aWorld, 36, mHeight - 4, -17, T);
            if (tTileEntity instanceof TileEntityBase06Covers)
                ((TileEntityBase06Covers) tTileEntity).setCoverItem(SIDE_Z_POS, IL.Cover_Drain.get(1), null, T, F);
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 32707,
                UT.NBT.make(NBT_FACING, SIDE_X_NEG),
                T,
                T);
            tRegistry.mBlock.placeBlock(
                aWorld,
            ...
            ItemStack[] tInventory = {
                ...
                ToolsGT.sMetaTool.getToolWithStats(ToolsGT.SENSE, MT.NetherizedDiamond, MT.LightBlue), NI// ToolsGT.sMetaTool.getToolWithStats(ToolsGT.SICKLE
                                                                                                         // ,
                                                                                                         // MT.NetherizedDiamond,
                                                                                                         // MT.LightBlue)
                , NI, ToolsGT.sMetaTool.getToolWithStats(ToolsGT.BUILDERWAND, MT.Vibramantium, MT.WOODS.Scorched)
                ...
                ST.make(Items.wooden_pickaxe, 1, 0), ST.make(Items.stone_pickaxe, 1, 0),
                ST.make(Items.golden_pickaxe, 1, 0), ST.make(Items.iron_pickaxe, 1, 0),
                ST.make(Items.diamond_pickaxe, 1, 0)

                , IL.Tool_Chunk_Remover.get(1), IL.Tool_Worldgen_Debugger.get(1), IL.Tool_Cheat.get(1),
                IL.IC2_Debug.get(1), IL.Pill_Cure_All.get(64), IL.Thermometer_Quicksilver.get(1),
                IL.Circuit_Selector.getWithDamage(1, 0), IL.Circuit_Selector.getWithDamage(1, 1),
                IL.Circuit_Selector.getWithDamage(1, 2)

                , IL.TC_Thaumometer.get(1), IL.TC_Crimson_Rites.get(1), IL.TC_Thaumonomicon.get(1),
                ST.make(MD.TC, "ItemThaumonomicon", 1, 42), ST.make(Items.item_frame, 1, 0),
                ST.make(Items.bucket, 1, 0), ST.make(Items.water_bucket, 1, 0), ST.make(Items.lava_bucket, 1, 0),
                ST.make(Items.milk_bucket, 1, 0)

                , ST.make(Blocks.stone_button, 1, 0), ST.make(Blocks.lever, 1, 0), ST.make(Items.redstone, 1, 0),
                ST.make(Blocks.redstone_torch, 1, 0), ST.make(Items.repeater, 1, 0), ST.make(Items.comparator, 1, 0),
                ST.make(Blocks.redstone_lamp, 1, 0), OP.cableGt01.mat(MT.Signalum, 1), OP.wireGt01.mat(MT.Lumium, 1)

                ,
                ToolsGT.sMetaTool.getToolWithStats(
                    ToolsGT.WRENCH_LV,
                    1,
                    MT.NetherizedDiamond,
                    MT.Magenta,
                ...
                ToolsGT.sMetaTool.getToolWithStats(
                    ...
                    V[2],
                    Long.MAX_VALUE),
                NI, NI, NI, NI, IL.Brain_Tape.get(64), IL.Dynamite_Strong.get(64)
                ...
                ToolsGT.sMetaTool.getToolWithStats(
                    ...
                    V[3],
                    Long.MAX_VALUE),
                NI, NI, NI, NI, NI, IL.Tool_Remote_Activator.get(1)

                , IL.Battery_Lead_Acid_LV.getWithCharge(1, Long.MAX_VALUE),
                IL.Battery_Lead_Acid_MV.getWithCharge(1, Long.MAX_VALUE),
                IL.Battery_Lead_Acid_HV.getWithCharge(1, Long.MAX_VALUE), OP.plateCurved.mat(MT.SteelGalvanized, 64),
                OP.plateCurved.mat(MT.Al, 64), OP.plateCurved.mat(MT.StainlessSteel, 64), IL.MOTORS[1].get(64),
                IL.MOTORS[2].get(64), IL.MOTORS[3].get(64)
                ...
                OP.bulletGtSmall.mat(MT.Steel, 64), OP.bulletGtSmall.mat(MT.Netherite, 64),
                OP.bulletGtSmall.mat(MT.Thaumium, 64), OP.bulletGtSmall.mat(MT.SterlingSilver, 64),
                OP.bulletGtSmall.mat(MT.RoseGold, 64), OP.bulletGtSmall.mat(MT.Rubber, 64)
                ...
                OP.bulletGtMedium.mat(MT.Steel, 64), OP.bulletGtMedium.mat(MT.Netherite, 64),
                OP.bulletGtMedium.mat(MT.Thaumium, 64), OP.bulletGtMedium.mat(MT.SterlingSilver, 64),
                OP.bulletGtMedium.mat(MT.RoseGold, 64), OP.bulletGtMedium.mat(MT.Rubber, 64)
                ...
                OP.bulletGtLarge.mat(MT.Steel, 64), OP.bulletGtLarge.mat(MT.Netherite, 64),
                OP.bulletGtLarge.mat(MT.Thaumium, 64), OP.bulletGtLarge.mat(MT.SterlingSilver, 64),
                OP.bulletGtLarge.mat(MT.RoseGold, 64), OP.bulletGtLarge.mat(MT.Rubber, 64)
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 4033,
                UT.NBT.make(NBT_FACING, SIDE_Z_NEG, NBT_INV_LIST, UT.NBT.makeInv(tInventory)),
                T,
                T);
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 32764,
                UT.NBT.make(NBT_FACING, SIDE_Z_NEG, "display", UT.NBT.makeString("Name", "Bear989Sr")),
                T,
                T);
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 32703,
                UT.NBT.make(NBT_FACING, SIDE_Z_NEG, NBT_STATE, 4),
                T,
                T);
            ...
            tRegistry.mBlock.placeBlock(
                ...
                SIDE_UNKNOWN,
                (short) 32711,
                UT.NBT.make(NBT_FACING, SIDE_Y_POS, NBT_MODE, T),
                T,
                T);
