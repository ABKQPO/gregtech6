...
public class WorldgenNexus extends WorldgenObject {
    ...
    public boolean generate(World aWorld, Chunk aChunk, int aDimType, int aMinX, int aMinZ, int aMaxX, int aMaxZ,
        ...
        // WD.set(aChunk, 5, mHeight+1,15, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        // WD.set(aChunk, 6, mHeight+1,15, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        // WD.set(aChunk, 7, mHeight+1,15, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        // WD.set(aChunk, 8, mHeight+1,15, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        // WD.set(aChunk, 9, mHeight+1,15, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        // WD.set(aChunk,10, mHeight+1,15, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        WD.set(
            aChunk,
            5,
            mHeight + 2,
            15,
            GENERATE_STREETS ? BlocksGT.CFoam : Blocks.stained_hardened_clay,
            DYE_INDEX_Gray);
        ...
        // WD.set(aChunk, 6, mHeight+1,14, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        // WD.set(aChunk, 7, mHeight+1,14, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        // WD.set(aChunk, 8, mHeight+1,14, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        // WD.set(aChunk, 9, mHeight+1,14, GENERATE_STREETS?BlocksGT.CFoam:Blocks.stained_hardened_clay,
        // DYE_INDEX_Gray);
        WD.set(
            aChunk,
            6,
