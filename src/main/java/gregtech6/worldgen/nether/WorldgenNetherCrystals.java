...
public class WorldgenNetherCrystals extends WorldgenObject {
    ...
    public boolean generate(World aWorld, Chunk aChunk, int aDimType, int aMinX, int aMinZ, int aMaxX, int aMaxZ,
        ...
        int aX = aMinX + aRandom.nextInt(16), aY = WD.waterLevel(aWorld), aZ = aMinZ + aRandom.nextInt(16),
            aMeta = new NoiseGenerator(aWorld).get(aX / 2, 360, aZ / 2, BlocksGT.CrystalOres.maxMeta());
        ...
        for (int i = 0; i < 1500; ++i) {
            int tX = aX + aRandom.nextInt(8) - aRandom.nextInt(8), tY = aY - aRandom.nextInt(12),
                tZ = aZ + aRandom.nextInt(8) - aRandom.nextInt(8);
