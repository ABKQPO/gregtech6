...
public class WorldgenColtan extends WorldgenObject {
    ...
    @SafeVarargs
    public WorldgenColtan(String aName, boolean aDefault, int aMinY, int aMaxY, int aAmount, int aRange,
