...
public class Behavior_Spray_Color_Remover extends AbstractBehaviorDefault {
    ...
    private static boolean decolorize(World aWorld, int aX, int aY, int aZ, byte aSide) {
        ...
        if (aBlock instanceof IBlockDecolorable) return ((IBlockDecolorable) aBlock)
            .removePaint(aWorld, aDelegator.mX, aDelegator.mY, aDelegator.mZ, aDelegator.mSideOfTileEntity);
