...
public class Behavior_Key extends AbstractBehaviorDefault {
    ...
    public boolean onItemUseFirst(MultiItem aItem, ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY,
        ...
        if (aTileEntity.mTileEntity instanceof ITileEntityKeyInteractable) {
            ...
            if (tKeyID != 0) return ((ITileEntityKeyInteractable) aTileEntity.mTileEntity)
                .useKey(aPlayer, aSide, hitX, hitY, hitZ, tKeyID);
            ...
            if (tKeyID == 0) {
                ...
                return ((ITileEntityKeyInteractable) aTileEntity.mTileEntity)
                    .useKey(aPlayer, aSide, hitX, hitY, hitZ, tKeyID);
            }
    ...
    public List<String> getAdditionalToolTips(MultiItem aItem, List<String> aList, ItemStack aStack) {
        ...
        if (tNBT != null && tNBT.hasKey(NBT_KEY)) aList.add("Key ID: " + UT.Code.makeString(tNBT.getLong(NBT_KEY)));
        else aList.add("*BLANK*");
        return aList;
    }
}
