    ...
    public boolean onItemUseFirst(MultiItem aItem, ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY,
        ...
        if (aWorld.isRemote)
            return F;/*
                      ...
                      * for (IMetaTileEntityItemPipe tTileEntity :
                      * UT.Code.sortByValuesAcending(IMetaTileEntityItemPipe.Util.scanPipes((IMetaTileEntityItemPipe)
                      * tMetaTileEntity, new HashMap<IMetaTileEntityItemPipe, Long>(), 0, false, true)).keySet()) {
                      ...
                      * if (tStack != null) {
                      * EntityItem tEntity = new EntityItem(aWorld,
                      * ((IGregTechTileEntity)aTileEntity).getOffsetX((byte)aSide, 1) + 0.5,
                      * ((IGregTechTileEntity)aTileEntity).getOffsetY((byte)aSide, 1) + 0.5,
                      * ((IGregTechTileEntity)aTileEntity).getOffsetZ((byte)aSide, 1) + 0.5, tStack);
