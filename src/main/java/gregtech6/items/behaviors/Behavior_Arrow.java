...
public class Behavior_Arrow extends AbstractBehaviorDefault {
    ...
    public ItemStack onDispense(MultiItem aItem, IBlockSource aSource, ItemStack aStack) {
        ...
        EntityProjectile tEntityArrow = getProjectile(
            aItem,
    ...
    public EntityProjectile getProjectile(MultiItem aItem, TagData aProjectileType, ItemStack aStack, World aWorld,
        ...
        EntityArrow_Material rArrow = (EntityArrow_Material) UT.Reflection
            .callConstructor(mArrow.getName(), -1, null, T, aWorld, aX, aY, aZ);
    ...
    public EntityProjectile getProjectile(MultiItem aItem, TagData aProjectileType, ItemStack aStack, World aWorld,
        ...
        if (!hasProjectile(aItem, aProjectileType, aStack)) return null;
        EntityArrow_Material rArrow = (EntityArrow_Material) UT.Reflection
            .callConstructor(mArrow.getName(), -1, null, T, aWorld, aEntity, mSpeedMultiplier * aSpeed);
        rArrow.setProjectileStack(aStack);
        return rArrow;
    }
}
