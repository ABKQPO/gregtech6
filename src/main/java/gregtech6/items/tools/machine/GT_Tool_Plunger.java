...
public class GT_Tool_Plunger extends ToolStats {
    ...
    public boolean isMinableBlock(Block aBlock, byte aMetaData) {
        return TOOL_plunger.equalsIgnoreCase(aBlock.getHarvestTool(aMetaData))
            || aBlock.getMaterial() == Material.dragonEgg;
    }
    ...
    public void onStatsAddedToTool(MultiItemTool aItem, int aID) {
        aItem.addItemBehavior(
            aID,
            new Behavior_Tool(TOOL_plunger, SFX.IC_TRAMPOLINE, 100, !canBlock(), SFX.RANDOM_PITCH));
        ...
        try {
            Object tObject = UT.Reflection.callConstructor(
