...
public class GT_Tool_Builderwand extends ToolStats {
    ...
    public boolean isMinableBlock(Block aBlock, byte aMetaData) {
        return IL.TC_Block_Air.equal(aBlock);
    }

    @Override
    public IIconContainer getIcon(boolean aIsToolHead, ItemStack aStack) {
        return aIsToolHead
            ? MultiItemTool.getPrimaryMaterial(aStack, MT.Heliodor).mTextureSetsItems
                .get(OP.toolHeadBuilderwand.mIconIndexItem)
            : MultiItemTool.getSecondaryMaterial(aStack, MT.WOODS.Scorched).mTextureSetsItems
                .get(OP.stick.mIconIndexItem);
    }

    @Override
    public short[] getRGBa(boolean aIsToolHead, ItemStack aStack) {
        return aIsToolHead ? MultiItemTool.getPrimaryMaterial(aStack, MT.Heliodor).mRGBaSolid
            : MultiItemTool.getSecondaryMaterial(aStack, MT.WOODS.Scorched).mRGBaSolid;
    }
