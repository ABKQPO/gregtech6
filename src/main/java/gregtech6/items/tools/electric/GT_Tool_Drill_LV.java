...
public class GT_Tool_Drill_LV extends ToolStats {
    ...
    public IIconContainer getIcon(boolean aIsToolHead, ItemStack aStack) {
        return !aIsToolHead ? ST.meta(aStack) % 2 != 0 ? Textures.ItemIcons.VOID : Textures.ItemIcons.TIP_ELECTRIC_DRILL
            : Textures.ItemIcons.HANDLE_ELECTRIC_DRILL;
    }
    ...
    public void onStatsAddedToTool(MultiItemTool aItem, int aID) {
        aItem.addItemBehavior(
            aID,
            new Behavior_Tool(TOOL_drill, SFX.GT_SCREWDRIVER, 100, !canBlock(), SFX.RANDOM_PITCH));
