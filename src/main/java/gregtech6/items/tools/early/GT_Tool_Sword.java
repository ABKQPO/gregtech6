...
public class GT_Tool_Sword extends ToolStats {
    ...
    public boolean isMinableBlock(Block aBlock, byte aMetaData) {
        return TOOL_sword.equalsIgnoreCase(aBlock.getHarvestTool(aMetaData)) || aBlock.getMaterial() == Material.leaves
            ...
            || aBlock.getMaterial() == Material.water
            || IL.TC_Block_Flesh.equal(aBlock);
    }

    @Override
    public IIconContainer getIcon(boolean aIsToolHead, ItemStack aStack) {
        return !aIsToolHead
            ? MultiItemTool.getPrimaryMaterial(aStack, MT.Steel).mTextureSetsItems.get(OP.toolHeadSword.mIconIndexItem)
