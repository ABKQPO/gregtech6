...
public class GT_Tool_Shovel extends ToolStats {
    ...
    public boolean isMinableBlock(Block aBlock, byte aMetaData) {
        return TOOL_shovel.equalsIgnoreCase(aBlock.getHarvestTool(aMetaData)) || aBlock.getMaterial() == Material.fire
    ...
    public IIconContainer getIcon(boolean aIsToolHead, ItemStack aStack) {
        return aIsToolHead
            ? MultiItemTool.getPrimaryMaterial(aStack, MT.Steel).mTextureSetsItems.get(OP.toolHeadShovel.mIconIndexItem)
