...
public class MultiTileEntityMeasuringPot extends TileEntityBase10FluidContainerSyncSmall
    implements ITileEntityTapFillable, IMTE_IgnorePlayerCollisionWhenPlacing {
    ...
    public boolean setBlockBounds2(Block aBlock, int aRenderPass, boolean[] aShouldSideBeRendered) {
        switch (aRenderPass) {
            case 0:
                box(aBlock, PX_P[4], PX_P[1], PX_P[5], PX_N[11], PX_N[8], PX_N[5]);
                return T;
            case 1:
                box(aBlock, PX_P[5], PX_P[1], PX_P[4], PX_N[5], PX_N[8], PX_N[11]);
                return T;
            case 2:
                box(aBlock, PX_P[11], PX_P[1], PX_P[5], PX_N[4], PX_N[8], PX_N[5]);
                return T;
            case 3:
                box(aBlock, PX_P[5], PX_P[1], PX_P[11], PX_N[5], PX_N[8], PX_N[4]);
                return T;
            case 4:
                box(aBlock, PX_P[5], PX_P[0], PX_P[5], PX_N[5], PX_N[15], PX_N[5]);
                return T;
            case 5:
                box(aBlock, PX_P[5], PX_P[0], PX_P[5], PX_N[5], PX_N[9], PX_N[5]);
                return T;
        }
        return F;
    }
    ...
    public static IIconContainer sTextureSides = new Textures.BlockIcons.CustomIcon(
        "machines/tanks/measuring_pot/colored/sides"),
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool() {
        return box(PX_P[4], PX_P[0], PX_P[4], PX_N[4], PX_N[8], PX_N[4]);
    }
    ...
    public void setBlockBoundsBasedOnState(Block aBlock) {
        box(aBlock, PX_P[4], PX_P[0], PX_P[4], PX_N[4], PX_N[8], PX_N[4]);
    }
