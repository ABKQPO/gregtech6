...
public class MultiTileEntityCell extends TileEntityBase10FluidContainerSyncSmall
    ...
    public int getRenderPasses2(Block aBlock, boolean[] aShouldSideBeRendered) {
        mTextures[0] = BlockTextureMulti.get(
    ...
    public boolean setBlockBounds2(Block aBlock, int aRenderPass, boolean[] aShouldSideBeRendered) {
        switch (aRenderPass) {
            case 0:
                box(aBlock, PX_P[5], PX_P[1], PX_P[6], PX_N[5], PX_N[5], PX_N[6]);
                return T;
            case 1:
                box(aBlock, PX_P[6], PX_P[1], PX_P[5], PX_N[6], PX_N[5], PX_N[5]);
                return T;
            case 2:
                box(aBlock, PX_P[6], PX_P[0], PX_P[6], PX_N[6], PX_N[4], PX_N[6]);
                return T;
        }
        return F;
    }
    ...
    public static IIconContainer sTextureSides = new Textures.BlockIcons.CustomIcon(
        "machines/tanks/cell/colored/sides"),
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        return mTextures[FACES_TBS[aSide]];
    }

    @Override
    public AxisAlignedBB getCollisionBoundingBoxFromPool() {
        return box(PX_P[5], PX_P[0], PX_P[5], PX_N[5], PX_N[4], PX_N[5]);
    }
    ...
    public void setBlockBoundsBasedOnState(Block aBlock) {
        box(aBlock, PX_P[5], PX_P[0], PX_P[5], PX_N[5], PX_N[4], PX_N[5]);
    }
