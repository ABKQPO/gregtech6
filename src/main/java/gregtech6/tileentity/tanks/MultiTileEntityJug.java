 ...
 */
public class MultiTileEntityJug extends TileEntityBase10FluidContainerSyncSmall implements ITileEntityTapFillable,
    IMTE_GetFoodValues, IMTE_OnEaten, IMTE_GetItemUseAction, IMTE_GetMaxItemUseDuration {
    ...
    public boolean setBlockBounds2(Block aBlock, int aRenderPass, boolean[] aShouldSideBeRendered) {
        switch (aRenderPass) {
            case 0:
                box(aBlock, PX_P[5], PX_P[10], PX_P[6], PX_N[10], PX_N[2], PX_N[6]);
                return T;
            case 1:
                box(aBlock, PX_P[6], PX_P[10], PX_P[5], PX_N[6], PX_N[2], PX_N[10]);
                return T;
            case 2:
                box(aBlock, PX_P[10], PX_P[10], PX_P[6], PX_N[5], PX_N[2], PX_N[6]);
                return T;
            case 3:
                box(aBlock, PX_P[6], PX_P[10], PX_P[10], PX_N[6], PX_N[2], PX_N[5]);
                return T;
            case 4:
                box(aBlock, PX_P[3], PX_P[0], PX_P[3], PX_N[3], PX_N[6], PX_N[3]);
                return T;
            case 5:
                box(aBlock, PX_P[6], PX_P[0], PX_P[6], PX_N[6], PX_N[3], PX_N[6]);
                return T;
        }
        return F;
    }
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool() {
        return box(PX_P[3], PX_P[0], PX_P[3], PX_N[3], PX_N[2], PX_N[3]);
    }
    ...
    public void setBlockBoundsBasedOnState(Block aBlock) {
        box(aBlock, PX_P[3], PX_P[0], PX_P[3], PX_N[3], PX_N[2], PX_N[3]);
    }

    @Override
    public float getSurfaceDistance(byte aSide) {
        return SIDES_VERTICAL[aSide] ? 0.0F : PX_P[3];
    }
