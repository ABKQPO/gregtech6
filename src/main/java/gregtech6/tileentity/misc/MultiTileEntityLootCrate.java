 ...
 */
public class MultiTileEntityLootCrate extends TileEntityBase03MultiTileEntities
    implements IMTE_AddToolTips, IMTE_OnToolClick {
    ...
    public ITexture getTexture(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        return aShouldSideBeRendered[aSide] ? BlockTextureDefault.get(Textures.BlockIcons.CRATE) : null;
    }
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.crate.loot";
    }
}
