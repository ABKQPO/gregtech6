...
public class MultiTileEntityMiniPortalCW2Caveworld extends MultiTileEntityMiniPortal {
    ...
    public float getBlockHardness() {
        return Blocks.mossy_cobblestone.getBlockHardness(worldObj, xCoord, yCoord, zCoord);
    }

    @Override
    public float getExplosionResistance2() {
        return Blocks.mossy_cobblestone.getExplosionResistance(null);
    }

    public ITexture sCW2Portal = BlockTextureCopied
        .get(ST.block(MD.CW2, "caveworld_portal", Blocks.portal), SIDE_ANY, 0, UNCOLOURED, F, T, T),
        sCW2PortalFrame = BlockTextureCopied.get(Blocks.mossy_cobblestone, SIDE_ANY, 0);
    ...
    public ITexture getFrameTexture() {
        return sCW2PortalFrame;
    }

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.portal.caveworld";
    }
}
