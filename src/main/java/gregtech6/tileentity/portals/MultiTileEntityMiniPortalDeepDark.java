...
public class MultiTileEntityMiniPortalDeepDark extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListDeepDarkSide = new ArrayListNoNulls<>(),
    ...
    public ITexture sDeepDarkPortal = BlockTextureCopied.get(
        ...
        T,
        T),
        sDeepDarkPortalFrame = BlockTextureCopied
            .get(ST.block(MD.ExU, "block_bedrockium", Blocks.bedrock), SIDE_ANY, 0, UNCOLOURED, F, F, F);

    @Override
    public ITexture getPortalTexture() {
        return sDeepDarkPortal;
    }

    @Override
    public ITexture getFrameTexture() {
        return sDeepDarkPortalFrame;
    }

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.portal.deepdark";
    }
}
