...
public class MultiTileEntityMiniPortalAtum extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListAtumSide = new ArrayListNoNulls<>(),
    ...
    public ITexture sAtumPortal = BlockTextureCopied
        .get(ST.block(MD.ATUM, "tile.portal", Blocks.portal), SIDE_ANY, 0, UNCOLOURED, F, T, T),
        sAtumPortalFrame = BlockTextureCopied
            .get(ST.block(MD.ATUM, "tile.carvedBrick", BlocksGT.Limestone), SIDE_ANY, 0, UNCOLOURED, F, F, F);
    ...
    public ITexture getFrameTexture() {
        return sAtumPortalFrame;
    }

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.portal.atum";
    }
}
