...
public class MultiTileEntityMiniPortalAroma extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListAromaSide = new ArrayListNoNulls<>(),
    ...
    static {
        LH.add(
            "gt.tileentity.portal.aroma.tooltip.1",
            "Only works between Aroma's Mining Dimension and the Overworld!");
    ...
    public float getBlockHardness() {
        return Blocks.stonebrick.getBlockHardness(worldObj, xCoord, yCoord, zCoord);
    }
    ...
    public ITexture sAromaPortal = BlockTextureCopied
        .get(ST.block(MD.A97_MINING, "aromicPortal", Blocks.portal), SIDE_ANY, 0, UNCOLOURED, F, T, T),
        sAromaPortalFrame = BlockTextureCopied
            .get(ST.block(MD.A97_MINING, "portalFrame", Blocks.stonebrick), SIDE_ANY, 0);
