...
public class MultiTileEntityMiniPortalTwilight extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListTwilightSide = new ArrayListNoNulls<>(),
    ...
    public float getBlockHardness() {
        return Blocks.grass.getBlockHardness(worldObj, xCoord, yCoord, zCoord);
    }
    ...
    public ITexture sTwilightPortal = BlockTextureCopied.get(Blocks.portal, SIDE_ANY, 0, UNCOLOURED, F, T, T),
        sTwilightPortalFrame = BlockTextureCopied.get(Blocks.grass, SIDE_TOP, 0, DYE_Green, F, F, F),
        sTwilightPortalInactive = BlockTextureCopied.get(Blocks.water, SIDE_TOP, 0, UNCOLOURED, F, F, F);

    @Override
    public ITexture getPortalTexture() {
        return sTwilightPortal;
    }

    @Override
    public ITexture getFrameTexture() {
        return sTwilightPortalFrame;
    }

    @Override
    public ITexture getInactiveTexture() {
        return sTwilightPortalInactive;
    }
