...
public class MultiTileEntityMiniPortalEnd extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListEndSide = new ArrayListNoNulls<>(),
    ...
    static {
        LH.add(
            "gt.tileentity.portal.end.tooltip.1",
    ...
    public float getBlockHardness() {
        return Blocks.end_stone.getBlockHardness(worldObj, xCoord, yCoord, zCoord);
    }
    ...
    public ITexture sEndPortal = BlockTextureCopied.get(Blocks.portal, SIDE_ANY, 0, DYE_Black, F, T, T),
        sEndPortalFrame = BlockTextureCopied.get(Blocks.end_portal_frame, SIDE_TOP, 0);
