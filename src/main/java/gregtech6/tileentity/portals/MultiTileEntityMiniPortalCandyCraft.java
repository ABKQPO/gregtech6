...
public class MultiTileEntityMiniPortalCandyCraft extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListCandySide = new ArrayListNoNulls<>(),
    ...
    public ITexture sCandyPortal = BlockTextureCopied
        .get(ST.block(MD.CANDY, "B40", Blocks.portal), SIDE_ANY, 0, UNCOLOURED, F, T, T),
        sCandyPortalFrame = BlockTextureCopied
            .get(ST.block(MD.CANDY, "BarleyBlock", Blocks.quartz_block), SIDE_FRONT, 0, UNCOLOURED, F, F, F);
    ...
    public ITexture getFrameTexture() {
        return sCandyPortalFrame;
    }

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.portal.candy";
    }
}
