...
public class MultiTileEntityMiniPortalAether extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListAetherSide = new ArrayListNoNulls<>(),
    ...
    public float getBlockHardness() {
        return Blocks.glowstone.getBlockHardness(worldObj, xCoord, yCoord, zCoord);
    }

    @Override
    public float getExplosionResistance2() {
        return Blocks.glowstone.getExplosionResistance(null);
    }

    public ITexture sAetherPortal = BlockTextureCopied.get(
        ST.block(
            MD.AETHEL.mLoaded ? MD.AETHEL : MD.AETHER,
            MD.AETHEL.mLoaded ? "aether_portal" : "aetherPortal",
            Blocks.portal),
        SIDE_ANY,
        0,
        UNCOLOURED,
        F,
        T,
        T), sAetherPortalFrame = BlockTextureCopied.get(Blocks.glowstone, SIDE_ANY, 0, UNCOLOURED, F, F, F);

    @Override
    public ITexture getPortalTexture() {
        return sAetherPortal;
    }

    @Override
    public ITexture getFrameTexture() {
        return sAetherPortalFrame;
    }

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.portal.aether";
    }
}
