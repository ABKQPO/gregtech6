...
public class MultiTileEntityMiniPortalAlfheim extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListAlfheimSide = new ArrayListNoNulls<>(),
    ...
    static {
        ...
        LH.add(
            "gt.tileentity.portal.alfheim.tooltip.4",
            "This is not a Trade Portal! It's working just like all other Mini Portals!");
    }
    ...
    public ITexture sAlfheimPortal = BlockTextureCopied.get(Blocks.portal, SIDE_ANY, 0, 0x000088ff, F, T, T),
        sMidgardPortal = BlockTextureCopied.get(Blocks.portal, SIDE_ANY, 0, 0x00ffff00, F, T, T),
        sAlfheimPortalFrame = BlockTextureCopied.get(ST.block(MD.BOTA, "dreamwood", Blocks.planks));

    @Override
    public ITexture getPortalTexture() {
        return WD.dimALF(worldObj) ? sMidgardPortal : sAlfheimPortal;
    }

    @Override
    public ITexture getFrameTexture() {
        return sAlfheimPortalFrame;
    }

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.portal.alfheim";
    }
}
