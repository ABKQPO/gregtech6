...
public class MultiTileEntityMiniPortalEndOfTime extends MultiTileEntityMiniPortal {
    ...
    public static List<MultiTileEntityMiniPortal> sListEndOfTimeSide = new ArrayListNoNulls<>(),
    ...
    static {
        LH.add(
            "gt.tileentity.portal.endoftime.tooltip.1",
            "Only works between the Last Millenium and the Overworld with a x128 Distance Factor!");
    ...
    public ITexture sEndOfTimePortal = BlockTextureCopied.get(
        ST.block(MD.ExU, "dark_portal", ST.block(MD.ExS, "deepPortal", Blocks.portal)),
        SIDE_ANY,
        0,
        UNCOLOURED,
        F,
        T,
        T),
        sEndOfTimePortalFrame = BlockTextureCopied.get(
            ST.block(MD.ExU, "dark_portal", ST.block(MD.ExS, "deepPortal", Blocks.stonebrick)),
            SIDE_ANY,
            2,
            UNCOLOURED,
            F,
    ...
    public ITexture getPortalTexture() {
        return sEndOfTimePortal;
    }

    @Override
    public ITexture getFrameTexture() {
        return sEndOfTimePortalFrame;
    }
