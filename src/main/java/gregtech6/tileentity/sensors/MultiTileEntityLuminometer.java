...
public class MultiTileEntityLuminometer extends MultiTileEntitySensorTE {
    ...
    static {
        LH.add("gt.tooltip.sensor.luminometer", "Measures Light (0 - 15)");
    }

    @Override
    public String getSensorDescription() {
        return LH.get("gt.tooltip.sensor.luminometer");
    }
    ...
    public short[] getSymbolColor() {
        return CA_LIGHT_YELLOW_255;
    }

    @Override
    public IIconContainer getSymbolIcon() {
        return BI.CHAR_LUMIN;
    }
    ...
    public static IIconContainer sTextureFront = new Textures.BlockIcons.CustomIcon(
        "machines/redstone/sensors/luminometer/colored/front"),
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.redstone.sensors.luminometer";
    }
}
