...
public class MultiTileEntityPlayerCounter extends MultiTileEntitySensorTE {
    ...
    static {
        LH.add("gt.tooltip.sensor.playercounter", "Measures Player Count of the whole Server");
    }

    @Override
    public String getSensorDescription() {
        return LH.get("gt.tooltip.sensor.playercounter");
    }

    @Override
    public long getCurrentValue(DelegatorTileEntity<TileEntity> aDelegator) {
        return ((WorldServer) worldObj).func_73046_m()
    ...
    public static IIconContainer sTextureFront = new Textures.BlockIcons.CustomIcon(
        "machines/redstone/sensors/playercounter/colored/front"),
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.redstone.sensors.playercounter";
    }
}
