...
public class MultiTileEntityTachometer extends MultiTileEntitySensorTE {
    ...
    public long getCurrentMax(DelegatorTileEntity<TileEntity> aDelegator) {
        if (aDelegator.mTileEntity instanceof MultiTileEntityAxle)
            return ((MultiTileEntityAxle) aDelegator.mTileEntity).mPower
                * ((MultiTileEntityAxle) aDelegator.mTileEntity).mSpeed;
        if (aDelegator.mTileEntity instanceof MultiTileEntityGearBox)
            return ((MultiTileEntityGearBox) aDelegator.mTileEntity).mMaxThroughPut * 16;
        return 0;
    }
    ...
    public static IIconContainer sTextureFront = new Textures.BlockIcons.CustomIcon(
        "machines/redstone/sensors/tachometer/colored/front"),
