...
public class MultiTileEntityChronometer extends MultiTileEntitySensorTE {
    ...
    static {
        LH.add("gt.tooltip.sensor.chronometer", "Measures Time of Day");
    }

    @Override
    public String getSensorDescription() {
        return LH.get("gt.tooltip.sensor.chronometer");
    }
    ...
    public static IIconContainer sTextureFront = new Textures.BlockIcons.CustomIcon(
        "machines/redstone/sensors/chronometer/colored/front"),
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.redstone.sensors.chronometer";
    }
}
