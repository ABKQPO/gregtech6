...
public class MultiTileEntityStackometer extends MultiTileEntitySensorTE {
    ...
    static {
        LH.add("gt.tooltip.sensor.stackometer", "Measures the precise amount of Stacks");
    }

    @Override
    public String getSensorDescription() {
        return LH.get("gt.tooltip.sensor.stackometer");
    }
    ...
    public long getCurrentMax(DelegatorTileEntity<TileEntity> aDelegator) {
        if (aDelegator.mTileEntity instanceof IInventory) {
            if (aDelegator.mTileEntity instanceof ISidedInventory) return ((ISidedInventory) aDelegator.mTileEntity)
    ...
    public static IIconContainer sTextureFront = new Textures.BlockIcons.CustomIcon(
        "machines/redstone/sensors/stackometer/colored/front"),
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.redstone.sensors.stackometer";
    }
}
