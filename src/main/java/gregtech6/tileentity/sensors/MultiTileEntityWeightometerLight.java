...
public class MultiTileEntityWeightometerLight extends MultiTileEntitySensorTE {
    ...
    static {
        LH.add("gt.tooltip.sensor.lightweightometer", "Measures the weight of an Inventory (in Gramm)");
    }

    @Override
    public String getSensorDescription() {
        return LH.get("gt.tooltip.sensor.lightweightometer");
    }
    ...
    public static IIconContainer sTextureFront = new Textures.BlockIcons.CustomIcon(
        "machines/redstone/sensors/lightweightometer/colored/front"),
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.redstone.sensors.lightweightometer";
    }
}
