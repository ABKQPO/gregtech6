...
public class MultiTileEntityThermometer extends MultiTileEntitySensorTE {
    ...
    public long getCurrentValue(DelegatorTileEntity<TileEntity> aDelegator) {
        if (aDelegator.mTileEntity instanceof ITileEntityTemperature)
            return ((ITileEntityTemperature) aDelegator.mTileEntity).getTemperatureValue(aDelegator.mSideOfTileEntity);
        try {
    ...
    public long getCurrentMax(DelegatorTileEntity<TileEntity> aDelegator) {
        if (aDelegator.mTileEntity instanceof ITileEntityTemperature)
            return ((ITileEntityTemperature) aDelegator.mTileEntity).getTemperatureMax(aDelegator.mSideOfTileEntity);
        try {
    ...
    public static IIconContainer sTextureFront = new Textures.BlockIcons.CustomIcon(
        "machines/redstone/sensors/thermometer/colored/front"),
