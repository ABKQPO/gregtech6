...
public class MultiTileEntityKiloGibblometer extends MultiTileEntitySensorTE {
    ...
    static {
        LH.add("gt.tooltip.sensor.kilogibblometer", "Measures Compression (In Kilo-Gibbl)");
    }

    @Override
    public String getSensorDescription() {
        return LH.get("gt.tooltip.sensor.kilogibblometer");
    }

    @Override
    public long getCurrentValue(DelegatorTileEntity<TileEntity> aDelegator) {
        if (aDelegator.mTileEntity instanceof ITileEntityGibbl)
            return ((ITileEntityGibbl) aDelegator.mTileEntity).getGibblValue(aDelegator.mSideOfTileEntity) / 1000000;
        return 0;
    }
    ...
    public long getCurrentMax(DelegatorTileEntity<TileEntity> aDelegator) {
        if (aDelegator.mTileEntity instanceof ITileEntityGibbl)
            return ((ITileEntityGibbl) aDelegator.mTileEntity).getGibblMax(aDelegator.mSideOfTileEntity) / 1000000;
        return 0;
    }

    @Override
    public short[] getSymbolColor() {
        return CA_YELLOW_255;
    }

    @Override
    public IIconContainer getSymbolIcon() {
        return BI.CHAR_GIBBL;
    }
    ...
    public static IIconContainer sTextureFront = new Textures.BlockIcons.CustomIcon(
        "machines/redstone/sensors/kilogibblometer/colored/front"),
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.redstone.sensors.kilogibblometer";
    }
}
