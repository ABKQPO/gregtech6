...
public class MultiTileEntityFaucet extends TileEntityBase11AttachmentSmall implements ITileEntityMold {
            ...
            if (mAutoPull ? SERVER_TIME % 20 == 5 : (mBlockUpdated && hasRedstoneIncoming())) {
                ...
                if (tDelegator.mTileEntity instanceof ITileEntityCrucible) {
                    ((ITileEntityCrucible) tDelegator.mTileEntity)
                        .fillMoldAtSide(this, tDelegator.mSideOfTileEntity, mFacing);
                }
            }
        }
    }
    ...
    public long getMoldRequiredMaterialUnits() {
        ...
        if (tDelegator.mTileEntity instanceof MultiTileEntityBathingPot
            || tDelegator.mTileEntity instanceof MultiTileEntityMixingBowl) return U;
        return 0;
    }

    @Override
    public long fillMold(OreDictMaterialStack aMaterial, long aTemperature, byte aSide) {
        if (aSide != mFacing || aMaterial == null
        ...
        DelegatorTileEntity<TileEntity> tDelegator = getAdjacentTileEntity(SIDE_BOTTOM);
        while (tDelegator.mY > 0 && (tDelegator.mTileEntity instanceof MultiTileEntityFaucet
            || (!(tDelegator.mTileEntity instanceof MultiTileEntityBathingPot
                || tDelegator.mTileEntity instanceof MultiTileEntityMixingBowl
                || tDelegator.mTileEntity instanceof ITileEntityMold)
                && !WD.hasCollide(tDelegator.mWorld, tDelegator.mX, tDelegator.mY, tDelegator.mZ)))) {
            tDelegator = WD.te(tDelegator.mWorld, tDelegator.mX, tDelegator.mY - 1, tDelegator.mZ, SIDE_TOP, F);
        }
        if (tDelegator.mTileEntity instanceof ITileEntityMold) return ((ITileEntityMold) tDelegator.mTileEntity)
            .fillMold(aMaterial, aTemperature, tDelegator.mSideOfTileEntity);
        if (tDelegator.mTileEntity instanceof MultiTileEntityBathingPot
            || tDelegator.mTileEntity instanceof MultiTileEntityMixingBowl) {
    ...
    public long onToolClick2(String aTool, long aRemainingDurability, long aQuality, Entity aPlayer,
        ...
        if (aTool.equals(TOOL_monkeywrench)) {
            mAutoPull = !mAutoPull;
            if (aChatReturn != null)
                aChatReturn.add(mAutoPull ? "Crucible Auto-Input: AUTOMATIC" : "Crucible Auto-Input: REDSTONE");
            return 10000;
        }
    ...
    public int getRenderPasses2(Block aBlock, boolean[] aShouldSideBeRendered) {
        mTexture = BlockTextureDefault
            .get(mMaterial, OP.blockSolid, UT.Code.getRGBaArray(mRGBa), mMaterial.contains(TD.Properties.GLOWING));
        return 3;
    }
    ...
    public boolean setBlockBounds2(Block aBlock, int aRenderPass, boolean[] aShouldSideBeRendered) {
        switch (aRenderPass) {
            case 0:
                switch (mFacing) {
                    case SIDE_Z_NEG:
                        box(aBlock, PX_P[6], PX_P[1], PX_P[0], PX_N[6], PX_N[14], PX_N[12]);
                        return T;
                    default:
                        box(aBlock, PX_P[6], PX_P[1], PX_P[12], PX_N[6], PX_N[14], PX_N[0]);
                        return T;
                    case SIDE_X_NEG:
                        box(aBlock, PX_P[0], PX_P[1], PX_P[6], PX_N[12], PX_N[14], PX_N[6]);
                        return T;
                    case SIDE_X_POS:
                        box(aBlock, PX_P[12], PX_P[1], PX_P[6], PX_N[0], PX_N[14], PX_N[6]);
                        return T;
                }
            case 1:
                switch (mFacing) {
                    case SIDE_Z_NEG:
                        box(aBlock, PX_P[5], PX_P[2], PX_P[0], PX_N[10], PX_N[10], PX_N[12]);
                        return T;
                    default:
                        box(aBlock, PX_P[5], PX_P[2], PX_P[12], PX_N[10], PX_N[10], PX_N[0]);
                        return T;
                    case SIDE_X_NEG:
                        box(aBlock, PX_P[0], PX_P[2], PX_P[5], PX_N[12], PX_N[10], PX_N[10]);
                        return T;
                    case SIDE_X_POS:
                        box(aBlock, PX_P[12], PX_P[2], PX_P[5], PX_N[0], PX_N[10], PX_N[10]);
                        return T;
                }
            case 2:
                switch (mFacing) {
                    case SIDE_Z_NEG:
                        box(aBlock, PX_P[10], PX_P[2], PX_P[0], PX_N[5], PX_N[10], PX_N[12]);
                        return T;
                    default:
                        box(aBlock, PX_P[10], PX_P[2], PX_P[12], PX_N[5], PX_N[10], PX_N[0]);
                        return T;
                    case SIDE_X_NEG:
                        box(aBlock, PX_P[0], PX_P[2], PX_P[10], PX_N[12], PX_N[10], PX_N[5]);
                        return T;
                    case SIDE_X_POS:
                        box(aBlock, PX_P[12], PX_P[2], PX_P[10], PX_N[0], PX_N[10], PX_N[5]);
                        return T;
                }
        }
        return T;
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool() {
        switch (mFacing) {
            case SIDE_Z_NEG:
                return box(PX_P[5], PX_P[1], PX_P[0], PX_N[5], PX_N[10], PX_N[12]);
            default:
                return box(PX_P[5], PX_P[1], PX_P[12], PX_N[5], PX_N[10], PX_N[0]);
            case SIDE_X_NEG:
                return box(PX_P[0], PX_P[1], PX_P[5], PX_N[12], PX_N[10], PX_N[5]);
            case SIDE_X_POS:
                return box(PX_P[12], PX_P[1], PX_P[5], PX_N[0], PX_N[10], PX_N[5]);
        }
    }
    ...
    public void setBlockBoundsBasedOnState(Block aBlock) {
        switch (mFacing) {
            case SIDE_Z_NEG:
                box(aBlock, PX_P[5], PX_P[1], PX_P[0], PX_N[5], PX_N[10], PX_N[12]);
                break;
            default:
                box(aBlock, PX_P[5], PX_P[1], PX_P[12], PX_N[5], PX_N[10], PX_N[0]);
                break;
            case SIDE_X_NEG:
                box(aBlock, PX_P[0], PX_P[1], PX_P[5], PX_N[12], PX_N[10], PX_N[5]);
                break;
            case SIDE_X_POS:
                box(aBlock, PX_P[12], PX_P[1], PX_P[5], PX_N[0], PX_N[10], PX_N[5]);
                break;
        }
    }
