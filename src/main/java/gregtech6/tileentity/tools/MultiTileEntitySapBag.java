 ...
 */
public class MultiTileEntitySapBag extends TileEntityBase09FacingSingle
            ...
            if (tDelegator.mTileEntity instanceof ITileEntityTreeHole) {
                if (((ITileEntityTreeHole) tDelegator.mTileEntity).hasResin(tDelegator.mSideOfTileEntity)) {
                    if (((ITileEntityTreeHole) tDelegator.mTileEntity).extractResin(tDelegator.mSideOfTileEntity)) {
                        mTank.fill(
                            ((ITileEntityTreeHole) tDelegator.mTileEntity).getResinFluid(tDelegator.mSideOfTileEntity),
                            T);
                        addStackToSlot(
                            0,
                            ((ITileEntityTreeHole) tDelegator.mTileEntity).getResinItem(tDelegator.mSideOfTileEntity));
                    }
                }
            }
            boolean tFull = mFull;
    ...
    public boolean setBlockBounds2(Block aBlock, int aRenderPass, boolean[] aShouldSideBeRendered) {
        switch (mFacing) {
            case SIDE_Z_NEG:
                box(aBlock, PX_P[5], PX_P[0], PX_P[0], PX_N[5], PX_N[9], PX_N[10]);
                return T;
            case SIDE_Z_POS:
                box(aBlock, PX_P[5], PX_P[0], PX_P[10], PX_N[5], PX_N[9], PX_N[0]);
                return T;
            case SIDE_X_NEG:
                box(aBlock, PX_P[0], PX_P[0], PX_P[5], PX_N[10], PX_N[9], PX_N[5]);
                return T;
            default:
                box(aBlock, PX_P[10], PX_P[0], PX_P[5], PX_N[0], PX_N[9], PX_N[5]);
                return T;
        }
    }
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        return (aSide != mFacing && SIDES_TOP_HORIZONTAL[aSide]) || aShouldSideBeRendered[aSide]
            ? BlockTextureMulti.get(
                BlockTextureDefault.get(sColoreds[FACES_TBS[aSide]], mRGBa),
                BlockTextureDefault.get((mFull ? sOverlaysFull : sOverlays)[FACES_TBS[aSide]]))
            : null;
    }
    ...
    public static IIconContainer sColoreds[] = new IIconContainer[] {
        ...
        sOverlays[] = new IIconContainer[] { new Textures.BlockIcons.CustomIcon("machines/tools/sapbag/overlay/bottom"),
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool() {
        switch (mFacing) {
            case SIDE_Z_NEG:
                return box(PX_P[5], PX_P[0], PX_P[0], PX_N[5], PX_N[9], PX_N[10]);
            case SIDE_Z_POS:
                return box(PX_P[5], PX_P[0], PX_P[10], PX_N[5], PX_N[9], PX_N[0]);
            case SIDE_X_NEG:
                return box(PX_P[0], PX_P[0], PX_P[5], PX_N[10], PX_N[9], PX_N[5]);
            default:
                return box(PX_P[10], PX_P[0], PX_P[5], PX_N[0], PX_N[9], PX_N[5]);
        }
    }
