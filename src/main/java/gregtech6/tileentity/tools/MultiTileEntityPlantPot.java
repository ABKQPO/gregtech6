 ...
 */
public class MultiTileEntityPlantPot extends TileEntityBase07Paintable
    implements IMTE_AddToolTips, IMTE_CanSustainPlant {
    ...
    public static IIconContainer sColoreds[] = new IIconContainer[] {
        ...
        sOverlays[] = new IIconContainer[] { new Textures.BlockIcons.CustomIcon("machines/plantpot/overlay/bottom"),
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.plantpot";
    }
