...
public class MultiTileEntityBathingPotTableWood extends MultiTileEntityBathingPotWood {
    ...
    public boolean setBlockBounds2(Block aBlock, int aRenderPass, boolean[] aShouldSideBeRendered) {
        switch (aRenderPass) {
            case 0:
                return box(aBlock, PX_P[0], PX_P[8], PX_P[0], PX_N[14], PX_N[0], PX_N[0]);
            case 1:
                return box(aBlock, PX_P[0], PX_P[8], PX_P[0], PX_N[0], PX_N[0], PX_N[14]);
            case 2:
                return box(aBlock, PX_P[14], PX_P[8], PX_P[0], PX_N[0], PX_N[0], PX_N[0]);
            case 3:
                return box(aBlock, PX_P[0], PX_P[8], PX_P[14], PX_N[0], PX_N[0], PX_N[0]);
            case 4:
                return box(aBlock, PX_P[0], PX_P[8], PX_P[0], PX_N[0], PX_N[6], PX_N[0]);
            case 5:
                return box(aBlock, PX_P[0], PX_P[8], PX_P[0], PX_N[0], PX_N[1], PX_N[0]);
            case 6:
                return box(aBlock, PX_P[0], PX_P[8], PX_P[0], PX_N[14], PX_N[0] + 0.001F, PX_N[14]);
            case 7:
                return box(aBlock, PX_P[0], PX_P[0], PX_P[0], PX_N[0], PX_N[8], PX_N[0]);
        }
        return F;
    }
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.bathing.pot.table.wood";
    }
}
