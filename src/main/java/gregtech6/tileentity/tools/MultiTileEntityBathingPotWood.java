...
public class MultiTileEntityBathingPotWood extends MultiTileEntityBathingPot {
    ...
    protected IFluidTank getFluidTankFillable2(byte aSide, FluidStack aFluidToFill) {
        ...
        if (FL.temperature(aFluidToFill) > mMaterial.mMeltingPoint || !FL.heavier(aFluidToFill)
            || !FL.simple(aFluidToFill)
            || FL.gas(aFluidToFill)
            || FL.acid(aFluidToFill)
            || FL.magic(aFluidToFill)) return null;
    ...
    public static IIconContainer sTextureSides = new Textures.BlockIcons.CustomIcon(
        "machines/tools/bathing_pot_wood/colored/sides"),
