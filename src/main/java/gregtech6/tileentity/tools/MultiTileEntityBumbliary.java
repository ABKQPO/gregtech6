 ...
 */
public class MultiTileEntityBumbliary extends TileEntityBase07Paintable
                    ...
                    if (checkEnvironment(tRoyalTag)) {
                        if (--mLife <= 0) {
                            ...
                            if (mLife % 300 == 150 && rng(10000) < Util.getAggressiveness(tRoyalTag)) {
                                try {
                                    for (EntityLivingBase tEntity : (ArrayList<EntityLivingBase>) worldObj
                                        .getEntitiesWithinAABB(EntityLivingBase.class, box(-4, -4, -4, +5, +5, +5)))
                            ...
                            if (mLife % 1200 == 600 && rng(10000) < Util.getWorkForce(tRoyalTag)
                                && checkWork(tRoyalTag)) {
                                if (null != tRoyalItem
                                    .bumbleCanProduce(worldObj, xCoord, yCoord, zCoord, tRoyalStack, tRoyalMeta, 3)) {
    ...
    public static final int SLOT_ROYAL = 13, SLOT_DRONE = 22,
        ...
        SLOTS_DRONE[] = { 3, 4, 5, 12, 14, 21, 23 }, SLOTS_DEAD[] = { 27, 28, 29, 30, 31, 32, 33, 34, 35 };
    ...
    public class MultiTileEntityGUICommonBumbliary extends ContainerCommon {
        ...
        public int addSlots(InventoryPlayer aInventoryPlayer) {
            ...
            addSlotToContainer(
                new Slot_Normal(mTileEntity, 3, 62, 8).setCanPut(F)
                    .setCanTake(F));
            addSlotToContainer(
                new Slot_Normal(mTileEntity, 4, 80, 8).setCanPut(F)
                    .setCanTake(F));
            addSlotToContainer(
                new Slot_Normal(mTileEntity, 5, 98, 8).setCanPut(F)
                    .setCanTake(F));
            ...
            addSlotToContainer(
                new Slot_Normal(mTileEntity, 12, 62, 26).setCanPut(F)
                    .setCanTake(F));
            addSlotToContainer(new Slot_Normal(mTileEntity, 13, 80, 26).setCanTake(F));
            addSlotToContainer(
                new Slot_Normal(mTileEntity, 14, 98, 26).setCanPut(F)
                    .setCanTake(F));
            ...
            addSlotToContainer(
                new Slot_Normal(mTileEntity, 21, 62, 44).setCanPut(F)
                    .setCanTake(F));
            addSlotToContainer(new Slot_Normal(mTileEntity, 22, 80, 44).setCanTake(F));
            addSlotToContainer(
                new Slot_Normal(mTileEntity, 23, 98, 44).setCanPut(F)
                    .setCanTake(F));
    ...
    public class MultiTileEntityGUICommonBumbliaryScoop extends ContainerCommon {
        ...
        public MultiTileEntityGUICommonBumbliaryScoop(InventoryPlayer aInventoryPlayer,
            MultiTileEntityBumbliary aTileEntity, int aGUIID) {
            super(aInventoryPlayer, aTileEntity, aGUIID);
        }
    ...
    public class MultiTileEntityGUIClientBumbliary extends ContainerClient {
        ...
        public MultiTileEntityGUIClientBumbliary(InventoryPlayer aInventoryPlayer, MultiTileEntityBumbliary aTileEntity,
            ...
            super(
                ...
                RES_PATH_GUI + "machines/Bumbliary.png");
        }
    }
