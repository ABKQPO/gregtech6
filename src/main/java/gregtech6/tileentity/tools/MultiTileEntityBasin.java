...
public class MultiTileEntityBasin extends MultiTileEntityMold {
    ...
    public long onToolClick2(String aTool, long aRemainingDurability, long aQuality, Entity aPlayer,
        ...
        if (aTool.equals(TOOL_chisel) || aTool.equals(TOOL_softhammer)
            || aTool.equals(TOOL_magnifyingglass)
            || aTool.equals(TOOL_wrench)
            || aTool.equals(TOOL_monkeywrench)
            || aTool.equals(TOOL_screwdriver)
            || aTool.equals(TOOL_rotator)) {
            return 0;
        }
    ...
    public boolean setBlockBounds2(Block aBlock, int aRenderPass, boolean[] aShouldSideBeRendered) {
        switch (aRenderPass) {
            case 0:
                box(aBlock, PX_P[0], PX_P[0], PX_P[0], PX_N[15], PX_N[0], PX_N[0]);
                return T;
            case 1:
                box(aBlock, PX_P[0], PX_P[0], PX_P[0], PX_N[0], PX_N[0], PX_N[15]);
                return T;
            case 2:
                box(aBlock, PX_P[15], PX_P[0], PX_P[0], PX_N[0], PX_N[0], PX_N[0]);
                return T;
            case 3:
                box(aBlock, PX_P[0], PX_P[0], PX_P[15], PX_N[0], PX_N[0], PX_N[0]);
                return T;
            case 4:
                box(aBlock, PX_P[0], PX_P[0], PX_P[0], PX_N[0], PX_N[15], PX_N[0]);
                return T;
            case 5:
                box(aBlock, PX_P[0], PX_P[0], PX_P[0], PX_N[0], PX_N[1], PX_N[0]);
                return T;
        }
        return F;
    }
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool() {
        return box(PX_P[0], PX_P[0], PX_P[0], PX_N[0], PX_N[0], PX_N[0]);
    }
