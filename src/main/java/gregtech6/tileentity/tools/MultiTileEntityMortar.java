 ...
 */
public class MultiTileEntityMortar extends TileEntityBase07Paintable
    implements ITileEntityQuickObstructionCheck, IMTE_SetBlockBoundsBasedOnState, IMTE_GetCollisionBoundingBoxFromPool,
    ...
    public static final OreDictMaterial MORTAR_MATERIALS[] = { ANY.Steel, MT.Netherite, ANY.Sapphire, ANY.Diamond,
        ANY.Amethyst };
    ...
    public boolean setBlockBounds2(Block aBlock, int aRenderPass, boolean[] aShouldSideBeRendered) {
        switch (aRenderPass) {
            case 0:
                box(aBlock, PX_P[2], PX_P[0], PX_P[2], PX_N[12], PX_N[10], PX_N[2]);
                return T;
            case 1:
                box(aBlock, PX_P[2], PX_P[0], PX_P[2], PX_N[2], PX_N[10], PX_N[12]);
                return T;
            case 2:
                box(aBlock, PX_P[12], PX_P[0], PX_P[2], PX_N[2], PX_N[10], PX_N[2]);
                return T;
            case 3:
                box(aBlock, PX_P[2], PX_P[0], PX_P[12], PX_N[2], PX_N[10], PX_N[2]);
                return T;
            case 4:
                box(aBlock, PX_P[2], PX_P[0], PX_P[2], PX_N[2], PX_N[15], PX_N[2]);
                return T;
            case 5:
                box(aBlock, PX_P[6], PX_P[0], PX_P[6], PX_N[6], PX_N[7], PX_N[6]);
                return T;
            case 6:
                box(aBlock, PX_P[2], PX_P[0], PX_P[2], PX_N[12], PX_N[10] + 0.001F, PX_N[12]);
                return T;
        }
        return F;
    }
    ...
    public static IIconContainer sTextureSides = new Textures.BlockIcons.CustomIcon(
        "machines/tools/mortar/colored/sides"),
            ...
            case 5:
                return SIDE_TOP == aSide
                    ? BlockTextureMulti.get(
                        BlockTextureDefault
                            .get(sTextureMiddleTop, MORTAR_MATERIALS[mStyle % MORTAR_MATERIALS.length].fRGBaSolid),
                        BlockTextureDefault.get(sOverlayMiddleTop))
                    : SIDE_BOTTOM == aSide ? null
                        : BlockTextureMulti.get(
                            BlockTextureDefault
                                .get(sTextureMiddleSide, MORTAR_MATERIALS[mStyle % MORTAR_MATERIALS.length].fRGBaSolid),
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool() {
        return box(PX_P[2], PX_P[0], PX_P[2], PX_N[2], PX_N[10], PX_N[2]);
    }
    ...
    public void setBlockBoundsBasedOnState(Block aBlock) {
        box(aBlock, PX_P[2], PX_P[0], PX_P[2], PX_N[2], PX_N[10], PX_N[2]);
    }
    ...
    public float getSurfaceDistance(byte aSide) {
        return SIDES_TOP[aSide] ? PX_P[10] : PX_P[2];
    }
