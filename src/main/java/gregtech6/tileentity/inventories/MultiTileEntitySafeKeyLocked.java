...
public class MultiTileEntitySafeKeyLocked extends MultiTileEntitySafe implements ITileEntityKeyInteractable {
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        ...
        return BlockTextureMulti.get(
            BlockTextureDefault
                .get((mOpened ? sColoredsOpen : sColoreds)[aIndex], mRGBa, mMaterial.contains(TD.Properties.GLOWING)),
            BlockTextureDefault.get((mOpened ? sOverlaysOpen : sOverlays)[aIndex]));
    }
