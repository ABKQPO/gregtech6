...
public class MultiTileEntityLargeTurbineSteam extends MultiTileEntityLargeTurbine {
    ...
    public void readFromNBT2(NBTTagCompound aNBT) {
        ...
        mTanks[1].setCapacity(mEnergyIN.mMax * 4)
            .setVoidExcess();
    }
                ...
                for (int tY = tMinY; tY <= tMaxY; tY++) for (int tZ = tMinZ; tZ <= tMaxZ; tZ++) {
                    ...
                    if (tX == tOutX && tY == tOutY && tZ == tOutZ) {
                        ...
                        if (SIDES_AXIS_X[mFacing] && tX == xCoord || SIDES_AXIS_Y[mFacing] && tY == yCoord
                            ...
                            tBits = (tY == tMinY ? MultiTileEntityMultiBlockPart.ONLY_FLUID
                                : MultiTileEntityMultiBlockPart.ONLY_FLUID_IN);
                        } else {
                            tBits = (tY == tMinY ? MultiTileEntityMultiBlockPart.ONLY_FLUID_OUT
    ...
    public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
        ...
        aList.add(
            Chat.WHITE + LH.get("gt.tooltip.multiblock.steamturbine.1")
    ...
    protected IFluidTank getFluidTankFillable2(byte aSide, FluidStack aFluidToFill) {
        return !mStopped && FL.steam(aFluidToFill) ? mTanks[0] : null;
    }
