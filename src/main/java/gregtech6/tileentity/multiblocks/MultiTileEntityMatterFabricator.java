...
public class MultiTileEntityMatterFabricator extends TileEntityBase10MultiBlockMachine {
    ...
    public boolean checkStructure2(ChunkCoordinates aCoordinates, Entity aPlayer, IInventory aInventory) {
        ...
        if (worldObj.blockExists(tX, tY, tZ) && worldObj.blockExists(tX + 4, tY, tZ)
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                aPlayer,
                aInventory)) tSuccess = F;
            if (getAir(tX + 2, tY + 2, tZ + 2)) worldObj.setBlockToAir(tX + 2, tY + 2, tZ + 2);
            else tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                this,
                tX + 3,
    ...
    static {
        ...
        LH.add(
            "gt.tooltip.multiblock.matterfabricator.6",
            "1 Versatile Quadcore Processor Unit in the center of that Ring");
