...
public class MultiTileEntityFermenter extends TileEntityBase10MultiBlockMachine {
    ...
    static {
        ...
        LH.add(
            "gt.tooltip.multiblock.fermenter.4",
    ...
    public DelegatorTileEntity<IFluidHandler> getFluidOutputTarget(byte aSide, Fluid aOutput) {
        DelegatorTileEntity tDelegator = WD
            .te(worldObj, getOffsetX(OPOS[mFacing], 5), yCoord, getOffsetZ(OPOS[mFacing], 5), OPOS[mFacing], F);
    ...
    public DelegatorTileEntity<TileEntity> getItemOutputTarget(byte aSide) {
        return WD
            .te(worldObj, getOffsetX(OPOS[mFacing], 5), yCoord + 1, getOffsetZ(OPOS[mFacing], 5), OPOS[mFacing], F);
    }
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.multiblock.fermenter";
    }
}
