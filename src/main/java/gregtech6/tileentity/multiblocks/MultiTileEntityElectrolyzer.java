...
public class MultiTileEntityElectrolyzer extends TileEntityBase10MultiBlockMachine {
    ...
    static {
        ...
        LH.add(
            "gt.tooltip.multiblock.electrolyzer.3",
    ...
    public void updateAdjacentToggleableEnergySources() {
        DelegatorTileEntity<TileEntity> tDelegator = WD
            .te(worldObj, getOffsetXN(mFacing), yCoord - 1, getOffsetZN(mFacing), SIDE_TOP, F);
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.multiblock.electrolyzer";
    }
}
