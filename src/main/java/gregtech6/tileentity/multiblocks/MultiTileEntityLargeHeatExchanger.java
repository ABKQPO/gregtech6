 ...
 */
public class MultiTileEntityLargeHeatExchanger extends TileEntityBase10MultiBlockBase implements IFluidHandler,
    ITileEntityRunningActively, ITileEntityEnergy, IMultiBlockFluidHandler, IMultiBlockEnergy {
    ...
    public boolean checkStructure2(ChunkCoordinates aCoordinates, Entity aPlayer, IInventory aInventory) {
        ...
        if (worldObj.blockExists(tX - 1, tY, tZ - 1) && worldObj.blockExists(tX + 1, tY, tZ - 1)
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                0,
                MultiTileEntityMultiBlockPart.ONLY_ITEM_FLUID_ENERGY_IN,
                aCoordinates,
                aPlayer,
    ...
    static {
        LH.add(
            "gt.tooltip.multiblock.heatexchanger.1",
            "3x3 Ring of 8 Heat Transmitters with Dense Tungsten Wall inside");
