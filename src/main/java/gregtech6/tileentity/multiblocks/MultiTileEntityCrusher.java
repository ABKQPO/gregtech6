...
public class MultiTileEntityCrusher extends TileEntityBase10MultiBlockMachine {
    ...
    public boolean checkStructure2(ChunkCoordinates aCoordinates, Entity aPlayer, IInventory aInventory) {
        int tX = getOffsetXN(mFacing, 2) - 2, tY = yCoord, tZ = getOffsetZN(mFacing, 2) - 2,
            tD = (SIDES_AXIS_Z[mFacing] ? mRunning ? 1 : 0 : mRunning ? 3 : 2);
    ...
    public void onWalkOver2(EntityLivingBase aEntity) {
        ...
        if (mRunning && aEntity.posX >= getOffsetXN(mFacing, 2) - 1
            && aEntity.posZ >= getOffsetZN(mFacing, 2) - 1
            && aEntity.posX <= getOffsetXN(mFacing, 2) + 2
            && aEntity.posZ <= getOffsetZN(mFacing, 2) + 2) {
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.multiblock.crusher";
    }
}
