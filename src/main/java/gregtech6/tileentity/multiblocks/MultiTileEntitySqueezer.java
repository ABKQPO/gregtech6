...
public class MultiTileEntitySqueezer extends TileEntityBase10MultiBlockMachine {
    ...
    public boolean checkStructure2(ChunkCoordinates aCoordinates, Entity aPlayer, IInventory aInventory) {
        ...
        if (worldObj.blockExists(tX, tY, tZ) && worldObj.blockExists(tX + 4, tY, tZ)
            && worldObj.blockExists(tX, tY, tZ + 4)
            && worldObj.blockExists(tX + 4, tY, tZ + 4)) {
            boolean tSuccess = T;
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                0,
                MultiTileEntityMultiBlockPart.ONLY_ITEM_FLUID_OUT,
                aCoordinates,
                aPlayer,
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                18009,
                getMultiTileEntityRegistryID(),
                SIDES_AXIS_Z[mFacing] ? 0 : 3,
                SIDES_AXIS_Z[mFacing] ? MultiTileEntityMultiBlockPart.NOTHING
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                aPlayer,
                aInventory)) tSuccess = F;
            if (getAir(tX + 1, tY + 1, tZ + 1)) worldObj.setBlockToAir(tX + 1, tY + 1, tZ + 1);
            else tSuccess = F;
            if (getAir(tX + 2, tY + 1, tZ + 1)) worldObj.setBlockToAir(tX + 2, tY + 1, tZ + 1);
            else tSuccess = F;
            if (getAir(tX + 3, tY + 1, tZ + 1)) worldObj.setBlockToAir(tX + 3, tY + 1, tZ + 1);
            else tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                this,
                tX + 4,
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                18009,
                getMultiTileEntityRegistryID(),
                SIDES_AXIS_X[mFacing] ? 0 : 3,
                SIDES_AXIS_X[mFacing] ? MultiTileEntityMultiBlockPart.NOTHING
                    : MultiTileEntityMultiBlockPart.ONLY_ENERGY_IN,
                aCoordinates,
                aPlayer,
                aInventory)) tSuccess = F;
            if (getAir(tX + 1, tY + 1, tZ + 2)) worldObj.setBlockToAir(tX + 1, tY + 1, tZ + 2);
            else tSuccess = F;
            if (getAir(tX + 2, tY + 1, tZ + 2)) worldObj.setBlockToAir(tX + 2, tY + 1, tZ + 2);
            else tSuccess = F;
            if (getAir(tX + 3, tY + 1, tZ + 2)) worldObj.setBlockToAir(tX + 3, tY + 1, tZ + 2);
            else tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                this,
                tX + 4,
            ...
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                ...
                aPlayer,
                aInventory)) tSuccess = F;
            if (getAir(tX + 1, tY + 1, tZ + 3)) worldObj.setBlockToAir(tX + 1, tY + 1, tZ + 3);
            else tSuccess = F;
            if (getAir(tX + 2, tY + 1, tZ + 3)) worldObj.setBlockToAir(tX + 2, tY + 1, tZ + 3);
            else tSuccess = F;
            if (getAir(tX + 3, tY + 1, tZ + 3)) worldObj.setBlockToAir(tX + 3, tY + 1, tZ + 3);
            else tSuccess = F;
            if (!ITileEntityMultiBlockController.Util.checkAndSetTarget(
                this,
                tX + 4,
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.multiblock.squeezer";
    }
}
