...
public class MultiTileEntityAutoToolIgniter extends TileEntityBase09FacingSingle
    implements ITileEntityEnergyElectricityAcceptor, ITileEntitySwitchableOnOff {
            ...
            if (SERVER_TIME % 10 == 0) {
                ...
                if (mEnergy > 0) {
                    ...
                    if (IBlockToolable.Util.onToolClick(
                        ...
                        0.5F,
                        0.5F,
                        0.5F) > 0 || WD.fire(tD.mWorld, tD.getCoords(), F)) mSendSound = 1;
                    mEnergy = 0;
                    mCoolDown = 10;
                }
            }
    ...
    public long doInject(TagData aEnergyType, byte aSide, long aSize, long aAmount, boolean aDoInject) {
        ...
        if (aDoInject && mEnergy < mInput * 10) {
            ...
            else if (mCoolDown <= 0) mEnergy += aSize * aAmount;
        }
        return aAmount;
    }
    ...
    public boolean isEnergyAcceptingFrom(TagData aEnergyType, byte aSide, boolean aTheoretical) {
        return (aTheoretical || !mStopped) && aSide != mFacing
