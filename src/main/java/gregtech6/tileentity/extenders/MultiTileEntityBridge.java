 ...
 */
public class MultiTileEntityBridge extends TileEntityBase07Paintable implements ITileEntityDelegating,
    ITileEntityAdjacentInventoryUpdatable, IFluidHandler, IMTE_GetComparatorInputOverride, IMTE_AddToolTips {
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        ...
        return BlockTextureMulti
            .get(BlockTextureDefault.get(mTextures[0], mRGBa), BlockTextureDefault.get(mTextures[1]));
    }
    ...
    public int getComparatorInputOverride(byte aSide) {
        return (mModes & EXTENDER_REDSTONE) == 0 ? 0 : getComparatorIncoming(OPOS[aSide]);
    }

    @Override
    public byte isProvidingWeakPower2(byte aSide) {
        return (mModes & EXTENDER_REDSTONE) == 0 ? 0 : getRedstoneIncoming(OPOS[aSide]);
    }
