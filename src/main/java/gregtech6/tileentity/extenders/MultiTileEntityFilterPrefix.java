...
public class MultiTileEntityFilterPrefix extends MultiTileEntityExtender
    ...
    public void onTick2(long aTimer, boolean aIsServerSide) {
        ...
        if (aIsServerSide && aTimer % 10 == 1) {
            if (mFilter == null || mFilter.mRegisteredItems.isEmpty()) {
                ...
                mCycle = ST
                    .make(UT.Code.select(null, mFilter.mRegisteredItems.toArray(ZL_ISC)), mFilter.mNameInternal, null);
    ...
    public Object getGUIClient2(int aGUIID, EntityPlayer aPlayer) {
        return new MultiTileEntityGUIClientFilterPrefix(aPlayer.inventory, this, aGUIID);
    }

    @Override
    public Object getGUIServer2(int aGUIID, EntityPlayer aPlayer) {
        return new MultiTileEntityGUICommonFilterPrefix(aPlayer.inventory, this, aGUIID);
    }
    ...
    public class MultiTileEntityGUICommonFilterPrefix extends ContainerCommon {
        ...
        public MultiTileEntityGUICommonFilterPrefix(InventoryPlayer aInventoryPlayer,
            MultiTileEntityFilterPrefix aTileEntity, int aGUIID) {
        ...
        public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
            if (aSlotIndex < 0 || aSlotIndex >= mTileEntity.getSizeInventoryGUI())
            ...
            if (tStack == null) {
                ...
                if (tData == null || ((MultiTileEntityFilterPrefix) mTileEntity).mFilter == tData.mPrefix) {
                    for (OreDictPrefix tPrefix : OreDictPrefix.VALUES_SORTED)
                        if (((MultiTileEntityFilterPrefix) mTileEntity).mFilter != tPrefix
                            && !tPrefix.containsAny(TD.Prefix.UNIFICATABLE, TD.Prefix.NO_PREFIX_FILTERING)
                            && tPrefix.contains(tStack)) {
    ...
    public class MultiTileEntityGUIClientFilterPrefix extends ContainerClient {
        ...
        public MultiTileEntityGUIClientFilterPrefix(InventoryPlayer aInventoryPlayer,
            MultiTileEntityFilterPrefix aTileEntity, int aGUIID) {
            super(
                new MultiTileEntityGUICommonFilterPrefix(aInventoryPlayer, aTileEntity, aGUIID),
                RES_PATH_GUI + "machines/FilterPrefix.png");
        }
    }
}
