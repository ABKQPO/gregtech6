 ...
 */
public class MultiTileEntityExtender extends TileEntityBase10FacingDouble implements ITileEntityDelegating,
    ITileEntityAdjacentInventoryUpdatable, IFluidHandler, IMTE_GetComparatorInputOverride {
    ...
    public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
        if ((mModes & EXTENDER_ALL) == EXTENDER_ALL) {
            ...
            if ((mModes & EXTENDER_REDSTONE) == EXTENDER_REDSTONE)
                aList.add(Chat.CYAN + LH.get(TOOLTIP_EXTENDER_REDSTONE));
            if ((mModes & EXTENDER_CONTROL) == EXTENDER_CONTROL)
                aList.add(Chat.CYAN + LH.get(TOOLTIP_EXTENDER_CONTROL));
    ...
    public void onTick2(long aTimer, boolean aIsServerSide) {
        if (aIsServerSide) {
            ...
            if ((mModes & EXTENDER_REDSTONE) == 0) {
                ...
                mRedstoneOut = 0;
                for (byte tSide : ALL_SIDES_VALID_BUT[mFacing])
                    mRedstoneOut = (byte) Math.max(mRedstoneOut, getRedstoneIncoming(tSide));
            }
            if (oRedstoneIn != mRedstoneIn || oRedstoneOut != mRedstoneOut || oComparator != mComparator)
                causeBlockUpdate();
        }
    }
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        ...
        if (aSide == mFacing) return BlockTextureMulti
            .get(BlockTextureDefault.get(mTextures[0], mRGBa), BlockTextureDefault.get(mTextures[3]));
        if (aSide == mSecondFacing) return BlockTextureMulti
            .get(BlockTextureDefault.get(mTextures[1], mRGBa), BlockTextureDefault.get(mTextures[4]));
        return BlockTextureMulti
            .get(BlockTextureDefault.get(mTextures[2], mRGBa), BlockTextureDefault.get(mTextures[5]));
    }
    ...
    public void adjacentInventoryUpdated(byte aSide, IInventory aTileEntity) {
        if ((mModes & EXTENDER_INV) != 0) {
            ...
            if (tDelegate.mTileEntity instanceof ITileEntityAdjacentInventoryUpdatable)
                ((ITileEntityAdjacentInventoryUpdatable) tDelegate.mTileEntity)
                    .adjacentInventoryUpdated(tDelegate.mSideOfTileEntity, aTileEntity);
        }
    }
    ...
    public int[] getAccessibleSlotsFromSide2(byte aSide) {
        ...
        if ((mModes & EXTENDER_INV) != 0) {
            DelegatorTileEntity<IInventory> tTileEntity = getAdjacentInventory(getExtenderTargetSide(mLastSide), F, T);
            if (tTileEntity.mTileEntity instanceof ISidedInventory) return ((ISidedInventory) tTileEntity.mTileEntity)
                .getAccessibleSlotsFromSide(tTileEntity.mSideOfTileEntity);
            if (tTileEntity.mTileEntity != null)
                return UT.Code.getAscendingArray(tTileEntity.mTileEntity.getSizeInventory());
        }
        return ZL_INTEGER;
    }
    ...
    public boolean canInsertItem2(int aSlot, ItemStack aStack, byte aSide) {
        ...
        if ((mModes & EXTENDER_INV) != 0) {
            DelegatorTileEntity<IInventory> tTileEntity = getAdjacentInventory(getExtenderTargetSide(mLastSide), F, T);
            if (tTileEntity.mTileEntity instanceof ISidedInventory) return ((ISidedInventory) tTileEntity.mTileEntity)
                .canInsertItem(aSlot, aStack, tTileEntity.mSideOfTileEntity);
    ...
    public boolean canExtractItem2(int aSlot, ItemStack aStack, byte aSide) {
        ...
        if ((mModes & EXTENDER_INV) != 0) {
            DelegatorTileEntity<IInventory> tTileEntity = getAdjacentInventory(getExtenderTargetSide(mLastSide), F, T);
            if (tTileEntity.mTileEntity instanceof ISidedInventory) return ((ISidedInventory) tTileEntity.mTileEntity)
                .canExtractItem(aSlot, aStack, tTileEntity.mSideOfTileEntity);
            if (tTileEntity.mTileEntity != null) return T;
        }
        return F;
    }
    ...
    public int fill(ForgeDirection aDirection, FluidStack aFluid, boolean doFill) {
        if ((mModes & EXTENDER_TANK) != 0) {
            ...
            if (tTileEntity.mTileEntity != null)
                return tTileEntity.mTileEntity.fill(tTileEntity.getForgeSideOfTileEntity(), aFluid, doFill);
        }
        return 0;
    }
    ...
    public FluidStack drain(ForgeDirection aDirection, FluidStack aFluid, boolean doDrain) {
        if ((mModes & EXTENDER_TANK) != 0) {
            ...
            DelegatorTileEntity<IFluidHandler> tTileEntity = getAdjacentTank(getExtenderTargetSide(aSide), F, T);
            if (tTileEntity.mTileEntity != null)
                return tTileEntity.mTileEntity.drain(tTileEntity.getForgeSideOfTileEntity(), aFluid, doDrain);
        }
        return null;
    }
    ...
    public FluidStack drain(ForgeDirection aDirection, int maxDrain, boolean doDrain) {
        if ((mModes & EXTENDER_TANK) != 0) {
            ...
            DelegatorTileEntity<IFluidHandler> tTileEntity = getAdjacentTank(getExtenderTargetSide(aSide), F, T);
            if (tTileEntity.mTileEntity != null)
                return tTileEntity.mTileEntity.drain(tTileEntity.getForgeSideOfTileEntity(), maxDrain, doDrain);
        }
        return null;
    }
    ...
    public boolean canFill(ForgeDirection aDirection, Fluid aFluid) {
        if ((mModes & EXTENDER_TANK) != 0) {
            ...
            DelegatorTileEntity<IFluidHandler> tTileEntity = getAdjacentTank(getExtenderTargetSide(aSide), F, T);
            if (tTileEntity.mTileEntity != null)
                return tTileEntity.mTileEntity.canFill(tTileEntity.getForgeSideOfTileEntity(), aFluid);
        }
        return F;
    }
    ...
    public boolean canDrain(ForgeDirection aDirection, Fluid aFluid) {
        if ((mModes & EXTENDER_TANK) != 0) {
            ...
            DelegatorTileEntity<IFluidHandler> tTileEntity = getAdjacentTank(getExtenderTargetSide(aSide), F, T);
            if (tTileEntity.mTileEntity != null)
                return tTileEntity.mTileEntity.canDrain(tTileEntity.getForgeSideOfTileEntity(), aFluid);
        }
        return F;
    }
    ...
    public FluidTankInfo[] getTankInfo(ForgeDirection aDirection) {
        if ((mModes & EXTENDER_TANK) != 0) {
            DelegatorTileEntity<IFluidHandler> tTileEntity = getAdjacentTank(
                getExtenderTargetSide(UT.Code.side(aDirection)),
                F,
                T);
            if (tTileEntity.mTileEntity != null)
                return tTileEntity.mTileEntity.getTankInfo(tTileEntity.getForgeSideOfTileEntity());
        }
    ...
    public boolean getStateRunningPossible() {
        if ((mModes & EXTENDER_CONTROL) != 0) {
            DelegatorTileEntity<TileEntity> tTileEntity = getAdjacentTileEntity(
                getExtenderTargetSide(SIDE_UNDEFINED),
                F,
                T);
    ...
    public byte getExtenderTargetSide(byte aSide) {
        return aSide == mFacing ? mSecondFacing : mFacing;
    }

    @Override
    public boolean isUseableByPlayer(EntityPlayer aPlayer) {
        return aPlayer.getDistanceSq(xCoord + 0.5, yCoord + 0.5, zCoord + 0.5) <= 64;
    }
