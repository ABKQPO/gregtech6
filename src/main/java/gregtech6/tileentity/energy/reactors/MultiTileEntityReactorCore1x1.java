...
public class MultiTileEntityReactorCore1x1 extends MultiTileEntityReactorCore {
    ...
    public int getReactorRodNeutronReflection(int aSlot, int aNeutrons, boolean aModerated) {
        if (!mStopped && slotHas(0) && ST.item(slot(0)) instanceof IItemReactorRod)
            return ((IItemReactorRod) ST.item(slot(0)))
                .getReactorRodNeutronReflection(this, 0, slot(0), aNeutrons, aModerated);
        return 0;
    }
    ...
    public long onToolClick2(String aTool, long aRemainingDurability, long aQuality, Entity aPlayer,
        ...
        if (aTool.equals(TOOL_geigercounter)) {
            if (aChatReturn != null) {
                aChatReturn.add(
                    "Neutron Levels: " + (oNeutronCounts[0] + oNeutronCounts[1] + oNeutronCounts[2] + oNeutronCounts[3])
                        + "n");
    ...
    public int[] getAccessibleSlotsFromSide2(byte aSide) {
        return aSide == SIDE_DOWN || aSide == SIDE_TOP ? UT.Code.getAscendingArray(1) : ZL_INTEGER;
    }

    @Override
    public boolean canInsertItem2(int aSlot, ItemStack aStack, byte aSide) {
        return mStopped && aStack != null
            && aSlot == 0
            && !slotHas(aSlot)
    ...
    public boolean canExtractItem2(int aSlot, ItemStack aStack, byte aSide) {
        return mStopped && aStack != null && aSlot == 0;
    }
