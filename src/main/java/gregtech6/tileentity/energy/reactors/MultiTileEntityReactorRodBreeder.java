...
public class MultiTileEntityReactorRodBreeder extends MultiTileEntityReactorRodBase {
    ...
    public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
        ...
        aList.add(
            LH.Chat.CYAN + "Can't breed with Neutrons from " + LH.Chat.RED + "Moderated" + LH.Chat.CYAN + " Fuel Rods");
        aList.add(
            LH.Chat.CYAN + "The "
                + LH.Chat.YELLOW
                + "Loss"
                + LH.Chat.CYAN
                + " value gets subtracted from Neutrons entering this Rod");
        ...
        if (mProductName.equals("")) mProductName = ST.meta(aStack.copy(), mProduct)
            .getDisplayName();
