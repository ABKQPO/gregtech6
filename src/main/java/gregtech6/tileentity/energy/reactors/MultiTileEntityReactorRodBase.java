 ...
 */
public class MultiTileEntityReactorRodBase extends TileEntityBase07Paintable
    implements IItemReactorRod, ITileEntityQuickObstructionCheck, IMTE_AddToolTips, IMTE_SetBlockBoundsBasedOnState,
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        return SIDES_HORIZONTAL[aSide] ? getReactorRodTextureSides(null, 0, null, T)
            : getReactorRodTextureTop(null, 0, null, T);
    }
    ...
    public float getSurfaceDistance(byte aSide) {
        return SIDES_VERTICAL[aSide] ? 0.0F : PX_P[6];
    }
    ...
    public ITexture getReactorRodTextureSides(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack,
        ...
        return BlockTextureMulti.get(
            BlockTextureDefault.get(sColoreds[1], mRGBa, F),
    ...
    public ITexture getReactorRodTextureTop(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack,
        boolean aActive) {
        return BlockTextureMulti.get(
            BlockTextureDefault.get(sColoreds[0], mRGBa, F),
