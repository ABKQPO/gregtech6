...
public class MultiTileEntityReactorRodNuclear extends MultiTileEntityReactorRodBase {
    ...
    public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
        ...
        aList.add(
            LH.Chat.CYAN + "The "
                ...
                + "Emission"
                + LH.Chat.CYAN
                + " describes how many Neutrons are emitted to adjacent Rods");
        aList.add(
            LH.Chat.CYAN + "The "
                + LH.Chat.GREEN
                + "Self"
                + LH.Chat.CYAN
                + " describes how many Neutrons naturally onto this Rod");
        aList.add(
            LH.Chat.CYAN + "The "
                + LH.Chat.GREEN
                + "Maximum"
                + LH.Chat.CYAN
                + " describes how many Neutrons can be on this Rod while lasting the advertised duration");
        aList.add(
            LH.Chat.CYAN + "A greater "
                + LH.Chat.YELLOW
                + "Factor"
                + LH.Chat.CYAN
                + " means the Rod emits more extra Neutrons for the amount of Neutrons on it");
        ...
        switch ((int) ((CLIENT_TIME / 100) % 10)) {
            case 0:
                ...
                aList
                    .add(LH.Chat.GREEN + "Emission: " + LH.Chat.WHITE + mNeutronOther + LH.Chat.PURPLE + " Neutrons/t");
            ...
            case 1:
                ...
                aList.add(LH.Chat.GREEN + "Self: " + LH.Chat.WHITE + mNeutronSelf + LH.Chat.PURPLE + " Neutrons/t");
                aList.add(
                    LH.Chat.GREEN + "Maximum: "
                        + LH.Chat.WHITE
                        + UT.Code.divup(mNeutronMax, 8)
                        + LH.Chat.PURPLE
                        + " Neutrons/t");
                aList.add(LH.Chat.YELLOW + "Factor: " + LH.Chat.WHITE + "1/" + mNeutronDiv);
                aList.add(LH.Chat.GREEN + "Fuel rods will be " + LH.Chat.WHITE + "Moderated");
            ...
            case 5:
                ...
                aList.add(
                    LH.Chat.GREEN + "Emission: " + LH.Chat.WHITE + mNeutronOther * 4 + LH.Chat.PURPLE + " Neutrons/t");
            ...
            case 6:
                ...
                aList.add(
                    LH.Chat.GREEN + "Emission: "
                        + LH.Chat.WHITE
                        + (mNeutronOther - UT.Code.divup(mNeutronOther, 2))
                        + LH.Chat.PURPLE
                        + " Neutrons/t");
                aList.add(
                    LH.Chat.GREEN + "Self: " + LH.Chat.WHITE + (mNeutronSelf * 5) + LH.Chat.PURPLE + " Neutrons/t");
                aList.add(
                    LH.Chat.GREEN + "Maximum: "
                        + LH.Chat.WHITE
            ...
            case 7:
                ...
                aList.add(
                    LH.Chat.GREEN + "Emission: "
                        ...
                        + " Neutrons/t");
                aList.add(
                    LH.Chat.GREEN + "Self: " + LH.Chat.WHITE + (mNeutronSelf * 0) + LH.Chat.PURPLE + " Neutrons/t");
                aList.add(
                    LH.Chat.GREEN + "Maximum: " + LH.Chat.WHITE + (mNeutronMax * 4) + LH.Chat.PURPLE + " Neutrons/t");
                aList.add(LH.Chat.YELLOW + "Factor: " + LH.Chat.WHITE + "1/" + (mNeutronDiv - 1));
                if (mNeutronDiv <= 5) aList.add(LH.Chat.RED + "This Fuel is" + LH.Chat.BLINKING_RED + " Critical");
                break;
            case 8:
    ...
    public int getReactorRodNeutronEmission(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack) {
        ...
        if (FL.Coolant_IC2.is(aReactor.mTanks[0])) {
            ...
            tNeutronSelf = 0;
            tNeutronDiv -= 1;
        } else if (MT.Sn.mLiquid.isFluidEqual(aReactor.mTanks[0].getFluid())
            || MT.Na.mLiquid.isFluidEqual(aReactor.mTanks[0].getFluid())) {
                tNeutronDiv -= 1;
            }
        aReactor.mNeutronCounts[aSlot] += tNeutronSelf;
        long tEmission = tNeutronOther
            + UT.Code.divup(Math.max(aReactor.oNeutronCounts[aSlot] - tNeutronSelf, 0), tNeutronDiv);
    ...
    public boolean getReactorRodNeutronReaction(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack) {
        ...
        if (FL.distw(aReactor.mTanks[0]) || MT.HDO.mLiquid.isFluidEqual(aReactor.mTanks[0].getFluid())
        ...
        long tDurabilityLoss = aReactor.oNeutronCounts[aSlot] <= tNeutronMax ? 100
            : UT.Code.divup(400 * aReactor.oNeutronCounts[aSlot], tNeutronMax);
    ...
    public ITexture getReactorRodTextureSides(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack,
        ...
        return BlockTextureMulti.get(
            BlockTextureDefault.get(sColoreds[1], mRGBa, T),
            BlockTextureDefault.get(sOverlays[1], aActive ? UNCOLOURED : MT.Pb.fRGBaSolid));
    }
    ...
    public ITexture getReactorRodTextureTop(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack,
        boolean aActive) {
        return BlockTextureMulti.get(
            BlockTextureDefault.get(sColoreds[0], mRGBa, T),
            BlockTextureDefault.get(sOverlays[0], aActive ? UNCOLOURED : MT.Pb.fRGBaSolid));
    }
