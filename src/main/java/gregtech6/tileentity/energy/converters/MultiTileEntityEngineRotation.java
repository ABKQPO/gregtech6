...
public class MultiTileEntityEngineRotation extends TileEntityBase11Bipolar
    implements ITileEntityEnergyElectricityAcceptor {

    @Override
    public void doConversion(long aTimer) {
        mActivity.mActive = mConverter.doBipolar(
            aTimer,
            this,
            aTimer % 32 < 16 ? OPOS[mFacing] : mFacing,
            aTimer % 32 < 16 ? mFacing : OPOS[mFacing],
            mMode);
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        ...
        return BlockTextureMulti.get(
            BlockTextureDefault.get((mActivity.mState > 0 ? sColoredsActive : sColoreds)[aIndex], mRGBa),
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.engines.kinetic_rotation";
    }
}
