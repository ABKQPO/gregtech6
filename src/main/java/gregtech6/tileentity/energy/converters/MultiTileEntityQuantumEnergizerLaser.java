...
public class MultiTileEntityQuantumEnergizerLaser extends TileEntityBase10EnergyConverter
    implements ITileEntityEnergyElectricityAcceptor, ITileEntityAdjacentOnOff {

    @Override
    public boolean isInput(byte aSide) {
        return mFacing == OPOS[aSide];
    }

    @Override
    public boolean isOutput(byte aSide) {
        return mFacing == aSide;
    }
    ...
    public String getTileEntityName() {
        return "gt.multitileentity.quantumenergizer.quantum_laser";
    }
}
