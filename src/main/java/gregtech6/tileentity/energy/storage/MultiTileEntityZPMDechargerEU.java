...
public class MultiTileEntityZPMDechargerEU extends TileEntityBase10EnergyBatBox {
    ...
    public boolean isItemValidForSlot(int aSlot, ItemStack aStack) {
        return IL.ZPM.equal(aStack, F, T);
    }
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        ...
        if (aSide == OPOS[mFacing]) return BlockTextureMulti.get(
            ...
            BlockTextureDefault.get(sOverlays[mActiveState & 3][1]),
            (mActiveState & 4) == 0 ? null
                : BlockTextureDefault
                    .get(BlockIcons.ZPM_TOP, (mActiveState & 3) == 0 ? 0x804000 : 0xffdd00, (mActiveState & 3) != 0));
        return BlockTextureMulti.get(
            BlockTextureDefault.get(sColoreds[aSide == mFacing ? 0 : 2], mRGBa),
            BlockTextureDefault.get(sOverlays[mActiveState & 3][aSide == mFacing ? 0 : 2]));
    }
        ...
        sOverlays[][] = new IIconContainer[][] {
            ...
            { new Textures.BlockIcons.CustomIcon("machines/energystorages/zpm_electricity/overlay_blinking/front"),
                ...
                new Textures.BlockIcons.CustomIcon(
                    "machines/energystorages/zpm_electricity/overlay_blinking/side"), } };
