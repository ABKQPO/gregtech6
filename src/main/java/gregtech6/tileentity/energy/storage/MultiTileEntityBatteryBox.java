...
public class MultiTileEntityBatteryBox extends TileEntityBase10EnergyBatBox
        ...
        sOverlays[][] = new IIconContainer[][] {
            ...
            { new Textures.BlockIcons.CustomIcon("machines/energystorages/battery_electric/overlay_blinking/front"),
                new Textures.BlockIcons.CustomIcon(
                    "machines/energystorages/battery_electric/overlay_blinking/side"), } };

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.energystorages.battery_electric";
    }
}
