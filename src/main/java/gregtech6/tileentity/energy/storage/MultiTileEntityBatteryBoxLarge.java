...
public class MultiTileEntityBatteryBoxLarge extends MultiTileEntityBatteryBox {
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        ...
        return BlockTextureMulti.get(
            BlockTextureDefault.get(sColoreds[aSide == mFacing ? 0 : 1], mRGBa),
            BlockTextureDefault.get(sOverlays[mActiveState & 3][aSide == mFacing ? 0 : 1]));
    }
        ...
        sOverlays[][] = new IIconContainer[][] {
            ...
            { new Textures.BlockIcons.CustomIcon("machines/energystorages/battery_electric_large/overlay_active/front"),
                new Textures.BlockIcons.CustomIcon(
                    "machines/energystorages/battery_electric_large/overlay_active/side"), },
            { new Textures.BlockIcons.CustomIcon(
                "machines/energystorages/battery_electric_large/overlay_blinking/front"),
                new Textures.BlockIcons.CustomIcon(
                    "machines/energystorages/battery_electric_large/overlay_blinking/side"), } };

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.energystorages.battery_electric_large";
    }
}
