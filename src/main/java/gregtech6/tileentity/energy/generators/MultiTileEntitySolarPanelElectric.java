...
public class MultiTileEntitySolarPanelElectric extends TileEntityBase09FacingSingle
    implements ITileEntityEnergyElectricityEmitter, ITileEntityRunningActively, ITileEntitySwitchableOnOff {
    ...
    public static IIconContainer sColoreds[] = new IIconContainer[] {
        ...
        sOverlaysActive[] = new IIconContainer[] {
            new Textures.BlockIcons.CustomIcon(
                "machines/solarpanels/solarpanel_electric_8eu/overlay_active/side_facing"),
            new Textures.BlockIcons.CustomIcon("machines/solarpanels/solarpanel_electric_8eu/overlay_active/side"),
            new Textures.BlockIcons.CustomIcon(
                "machines/solarpanels/solarpanel_electric_8eu/overlay_active/bottom_facing"),
