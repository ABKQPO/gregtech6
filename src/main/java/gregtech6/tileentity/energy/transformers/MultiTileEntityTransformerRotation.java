...
public class MultiTileEntityTransformerRotation extends TileEntityBase11Bidirectional
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        ...
        return BlockTextureMulti.get(
            BlockTextureDefault.get(sColoreds[mActivity.mState == 1 ? 1 : 0][aIndex], mRGBa),
            BlockTextureDefault.get(sOverlays[mActivity.mState == 1 ? 1 : 0][aIndex]));
    }

    @Override
    public boolean isInput(byte aSide) {
        return mReversed ? aSide == OPOS[mFacing] : aSide == mFacing;
    }

    @Override
    public boolean isOutput(byte aSide) {
        return mReversed ? aSide == mFacing : aSide == OPOS[mFacing];
    }
        ...
        sOverlays[][] = new IIconContainer[][] {
            ...
            { new Textures.BlockIcons.CustomIcon("machines/transformers/transformer_rotation/overlay_active/front"),
                ...
                new Textures.BlockIcons.CustomIcon(
                    "machines/transformers/transformer_rotation/overlay_active/side"), } };

    @Override
    public String getTileEntityName() {
        return "gt.multitileentity.transformers.transformer_rotation";
    }
}
