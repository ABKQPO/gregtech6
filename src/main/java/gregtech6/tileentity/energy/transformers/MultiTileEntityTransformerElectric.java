...
public class MultiTileEntityTransformerElectric extends TileEntityBase11Bidirectional
    ...
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        ...
        return BlockTextureMulti.get(
            ...
            BlockTextureDefault.get(sOverlays[mActivity.mState][aIndex]));
    }
        ...
        sOverlays[][] = new IIconContainer[][] {
            ...
            { new Textures.BlockIcons.CustomIcon("machines/transformers/transformer_electric/overlay_blinking/front"),
                ...
                new Textures.BlockIcons.CustomIcon(
                    "machines/transformers/transformer_electric/overlay_blinking/side"), } };
