...
@Deprecated
/**
 * Required to exist in GT6 because Immersive Engineering does not work otherwise. This File is likely not in the actual
 * Builds of GT6!
 */
public interface IGregTechTileEntity {
    ...
    @Deprecated
    public Object getMetaTileEntity();

    @Deprecated
    public void setMetaTileEntity(Object aMetaTileEntity);
