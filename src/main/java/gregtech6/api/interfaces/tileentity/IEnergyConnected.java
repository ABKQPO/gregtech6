...
/**
 * Required to exist in GT6 because Immersive Engineering crashes otherwise. Also there is that GT5U+GT6 Mod that
 * basically needs this for Compat.
 */
    ...
    public static class Util {
        ...
        public static final long emitEnergyToNetwork(long aVoltage, long aAmperage, IEnergyConnected aEmitter) {
            ...
            for (byte aSideOutOf : ALL_SIDES_VALID) if (aEmitter.outputsEnergyTo(aSideOutOf)) {
                DelegatorTileEntity<TileEntity> tDelegator = WD.te(
                    aEmitter.getWorld(),
                    aEmitter.getOffsetX(aSideOutOf, 1),
                    aEmitter.getOffsetY(aSideOutOf, 1),
                    aEmitter.getOffsetZ(aSideOutOf, 1),
                    OPOS[aSideOutOf],
                    F);
                ...
                rUsedAmperage += ITileEntityEnergy.Util
                    .insertEnergyInto(TD.Energy.EU, aVoltage, aAmperage - rUsedAmperage, aEmitter, tDelegator);
