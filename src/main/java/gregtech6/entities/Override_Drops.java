...
public class Override_Drops {
    ...
    public static void handleDrops(EntityLivingBase aDead, String aClass, List<EntityItem> aDrops, DamageSource aDamage,
        int aLooting, boolean aBurn, boolean aPlayerKill) {
        if (UT.Code.stringInvalid(aClass) || "EntityTFLichMinion".equalsIgnoreCase(aClass)
            || "EntitySkeletonBoss".equalsIgnoreCase(aClass)) return;
        ...
        if (aDead instanceof EntityPlayer) {
            ...
            if (aPlayerKill) {
                ItemStack tGrass = UT.Code.select(IL.Grass, IL.Grass, IL.Grass_Dry, IL.Grass_Moldy, IL.Grass_Rotten)
                    .get(1);

                if (RNGSUS.nextInt(2) == 0)
                    aDrops.add(ST.entity(aDead, RNGSUS.nextBoolean() ? ST.copy(tGrass) : OP.rockGt.mat(MT.Stone, 1)));
                if (RNGSUS.nextInt(3) == 0)
                    aDrops.add(ST.entity(aDead, RNGSUS.nextBoolean() ? ST.copy(tGrass) : IL.Stick.get(1)));
                if (RNGSUS.nextInt(5) == 0)
                    aDrops.add(ST.entity(aDead, RNGSUS.nextBoolean() ? ST.copy(tGrass) : IL.Mud_Ball.get(1)));
                if (RNGSUS.nextInt(10) == 0)
                    aDrops.add(ST.entity(aDead, RNGSUS.nextBoolean() ? ST.copy(tGrass) : IL.Tool_Matches.get(1)));
                    ...
                    aDrops.add(
                        ST.entity(
                            ...
                            UT.Code.select(
                                ...
                                IL.KEYS_CHEAP[RNGSUS.nextInt(IL.KEYS_CHEAP.length)]
                                    .getWithName(1, "Random Useless Key"),
            ...
            if (aPlayerKill) {
                if (RNGSUS.nextInt(2) == 0) aDrops.add(
                    ST.entity(aDead, RNGSUS.nextBoolean() ? OP.rockGt.mat(MT.Stone, 1) : ST.make(Items.flint, 1, 0)));
                if (RNGSUS.nextInt(3) == 0) aDrops.add(ST.entity(aDead, IL.Stick.get(1)));
                if (RNGSUS.nextInt(5) == 0)
                    aDrops.add(ST.entity(aDead, OP.rockGt.mat(RNGSUS.nextBoolean() ? MT.Ag : MT.Au, 1)));
            ...
            if (aPlayerKill) {
                ...
                if (RNGSUS.nextInt(10) == 0) aDrops.add(ST.entity(aDead, IL.Tool_Matches.get(1)));
                if (RNGSUS.nextInt(10) == 0)
                    aDrops.add(ST.entity(aDead, OP.bulletGtSmall.mat(MT.Steel, 1 + RNGSUS.nextInt(2))));
            ...
            if (aPlayerKill) {
                ...
                List tList = aDead.worldObj
                    .getEntitiesWithinAABBExcludingEntity(aDead, aDead.boundingBox.expand(32, 32, 32));
                for (int i = 0; i < tList.size(); i++) if (tList.get(i) instanceof EntityPlayer) {
                    for (int j = 0; j < tList.size(); j++)
                        if (tList.get(j) instanceof EntityPigZombie) ((EntityPigZombie) tList.get(j))
                            .attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer) tList.get(i)), 0);
                    break;
                }
                ...
                if (RNGSUS.nextInt(2) == 0) aDrops.add(
                    ST.entity(
                        aDead,
                        RNGSUS.nextBoolean() ? OP.rockGt.mat(MT.Netherrack, 1) : ST.make(Items.flint, 1, 0)));
                ...
                if (RNGSUS.nextInt(10) == 0) aDrops.add(ST.entity(aDead, IL.Tool_Matches.get(1)));
                if (RNGSUS.nextInt(10) == 0)
                    aDrops.add(ST.entity(aDead, OP.bulletGtMedium.mat(MT.Steel, 1 + RNGSUS.nextInt(2))));
        ...
        } else if ("Commando".equalsIgnoreCase(aClass) || "StormTrooper".equalsIgnoreCase(aClass)
            || "Outcast".equalsIgnoreCase(aClass)) {
                tReplaceIron = T;
                ...
                if (aPlayerKill) {
                    if (RNGSUS.nextInt(2) == 0)
                        aDrops.add(ST.entity(aDead, OP.bulletGtSmall.mat(MT.Steel, 1 + RNGSUS.nextInt(8))));
                    if (RNGSUS.nextInt(3) == 0) aDrops.add(
                        ST.entity(
                            aDead,
                            IL.KEYS_FANCY[RNGSUS.nextInt(IL.KEYS_FANCY.length)].getWithName(1, "Fancy Useless Key")));
                    if (RNGSUS.nextInt(3) == 0) aDrops.add(ST.entity(aDead, IL.Compass_North.get(1)));
                    if (RNGSUS.nextInt(4) == 0) aDrops.add(
                        ST.entity(
                            aDead,
                            (RNGSUS.nextBoolean() ? IL.Tool_Lighter_Platinum_Empty : IL.Tool_Lighter_Platinum_Full)
                                .get(1)));
                }
                ...
                if (aPlayerKill) {
                    ...
                    if (RNGSUS.nextInt(3) == 0) aDrops.add(ST.entity(aDead, IL.Stick.get(1)));
                    if (RNGSUS.nextInt(5) == 0)
                        aDrops.add(ST.entity(aDead, IL.Tool_Matches.get(1 + RNGSUS.nextInt(4))));
                ...
                if (aPlayerKill) {
                    ...
                    if (MOBS_DROP_JUNK) {
                        if (RNGSUS.nextInt(2) == 0) aDrops.add(
                            ST.entity(
                                aDead,
                                RNGSUS.nextBoolean() ? OP.rockGt.mat(aSpace ? MT.STONES.SpaceRock : MT.Stone, 1)
                                    : aSpace ? OP.rockGt.mat(MT.MeteoricIron, 1) : ST.make(Items.flint, 1, 0)));
                        if (RNGSUS.nextInt(5) == 0)
                            aDrops.add(ST.entity(aDead, aSpace ? OP.stick.mat(MT.Plastic, 1) : IL.Stick.get(1)));
                        if (RNGSUS.nextInt(10) == 0)
                            aDrops.add(ST.entity(aDead, aSpace ? OP.scrapGt.mat(MT.Plastic, 1) : IL.Mud_Ball.get(1)));
                        if (RNGSUS.nextInt(20) == 0) aDrops
                            .add(ST.entity(aDead, aSpace ? OP.nugget.mat(MT.MeteoricIron, 1) : IL.Tool_Matches.get(1)));
                        ...
                        aDrops.add(
                            ST.entity(
                                ...
                                UT.Code.select(
                                    ...
                                    IL.Bottle_Milk.get(1),
                                    ST.update(
                                        aSpace ? OP.arrowGtPlastic.mat(MT.MeteoricIron, 1)
                                            : OP.arrowGtWood.mat(MT.Bronze, 1)),
                                    ST.update(
                                        aSpace ? OP.arrowGtPlastic.mat(MT.MeteoricIron, 1)
                                            : OP.arrowGtWood.mat(MT.Bronze, 1)),
                                    ST.update(
                                        aSpace ? OP.arrowGtPlastic.mat(MT.MeteoricSteel, 1)
                                            : OP.arrowGtWood.mat(MT.Bronze, 1)),
                                    ST.update(
                                        aSpace ? OP.arrowGtPlastic.mat(MT.MeteoricSteel, 1)
                                            : OP.arrowGtWood.mat(MT.DamascusSteel, 1)))));
                    }
                ...
                if (aClass.equalsIgnoreCase("EntityTFIceShooter") || aClass.equalsIgnoreCase("EntityTFIceExploder")) {
                    tReplaceIron = T;
                    ...
                    if (aLooting > 0) tAmount += RNGSUS.nextInt(aLooting + 1);
                    while (tAmount-- > 0)
                        aDrops.add(ST.entity(aDead, aBurn ? Items.cooked_porkchop : Items.porkchop, 1, 0));

                    for (int i = 0; i < 2; i++) if (RNGSUS.nextInt(100) <= 25 + aLooting * 5) {
                        aDrops.add(ST.entity(aDead, IL.Tusk_Boar.get(1)));
                    }
                } else if (aClass.equalsIgnoreCase("EntityElephant") || aClass.equalsIgnoreCase("EntityElefant")
                    || aClass.equalsIgnoreCase("MoCEntityElephant")) {
                        tReplaceIron = T;
                        for (int i = 0; i < 2; i++) if (RNGSUS.nextInt(100) <= 25 + aLooting * 5) {
                        ...
                        if (aClass.equalsIgnoreCase("MoCEntityHorse") || aClass.equalsIgnoreCase("MoCEntityHorseMob")) {
                            tReplaceIron = T;
                            int tAmount = 2 + RNGSUS.nextInt(3);
                            if (aLooting > 0) tAmount += RNGSUS.nextInt(aLooting + 1);
                            while (tAmount-- > 0) aDrops
                                .add(ST.entity(aDead, aBurn ? IL.Food_Horse_Cooked.get(1) : IL.Food_Horse_Raw.get(1)));
                            for (int i = 0; i < 4; i++) if (RNGSUS.nextInt(100) <= 25 + aLooting * 5) {
                                aDrops.add(ST.entity(aDead, IL.Hoof_Horse.get(1)));
                            }
                        } else if (aClass.equalsIgnoreCase("EntitySquirrel")
                            || aClass.equalsIgnoreCase("EntityTFSquirrel")) {
                                tReplaceIron = T;
                                int tAmount = 1 + RNGSUS.nextInt(3);
                                if (aLooting > 0) tAmount += RNGSUS.nextInt(aLooting + 1);
                                while (tAmount-- > 0) aDrops.add(
                                    ST.entity(
                                        aDead,
                                        RNGSUS.nextBoolean() ? IL.Food_Hazelnut.get(1) : IL.Food_Peanut.get(1)));
                                ...
                                while (tAmount-- > 0) aDrops.add(
                                    ST.entity(aDead, aBurn ? IL.Food_Mutton_Cooked.get(1) : IL.Food_Mutton_Raw.get(1)));
                                for (int i = 0; i < 2; i++) if (RNGSUS.nextInt(100) <= 25 + aLooting * 5) {
                                ...
                                if (!MD.EtFu.mLoaded && !MD.GaSu.mLoaded) {
                                    ...
                                    while (tAmount-- > 0) aDrops.add(
                                        ST.entity(
                                            aDead,
                                            aBurn ? IL.Food_Mutton_Cooked.get(1) : IL.Food_Mutton_Raw.get(1)));
                                }
                                for (int i = 0; i < 2; i++) if (RNGSUS.nextInt(100) <= 25 + aLooting * 5) {
                                    aDrops.add(ST.entity(aDead, IL.Horn_Sheep.get(1)));
                                }
                                ...
                                || aClass.equalsIgnoreCase("EntityAerbunny")) {
                                        ...
                                        if (MD.EtFu.mLoaded) {
                                            aDrops.add(
                                                ST.entity(
                                                    aDead,
                                                    MD.EtFu,
                                                    aBurn ? "rabbit_cooked" : "rabbit_raw",
                                                    1,
                                                    0));
                                        } else {
                                            aDrops.add(
                                                ST.entity(
                                                    aDead,
                                                    MD.HaC,
                                                    aBurn ? "rabbitcookedItem" : "rabbitrawItem",
                                                    1,
                                                    0));
                                        }
                                    }
                                ...
                                } else if (aClass.equalsIgnoreCase("EntityDireWolf")
                                    || aClass.equalsIgnoreCase("EntityWarg")
                                    || aClass.equalsIgnoreCase("EntityHellhound")
                                    || aClass.equalsIgnoreCase("MoCEntityWWolf")
                                    || aClass.equalsIgnoreCase("EntityTFMistWolf")
                                    || aClass.equalsIgnoreCase("EntityTFWinterWolf")) {
                                        tReplaceIron = T;
                                        ...
                                        while (tAmount-- > 0) aDrops.add(
                                            ST.entity(
                                                aDead,
                                                aBurn ? IL.Food_DogMeat_Cooked.get(1) : IL.Food_DogMeat_Raw.get(1)));
                                        ...
                                        if (RNGSUS.nextInt(
                                            Math.max(
                                                1,
                                                10 - (int) (((EntityHorse) aDead).getHorseJumpStrength() * 10.0)))
                                            == 0) tAmount += 1 + RNGSUS.nextInt(aLooting + 1) / 2;
                                        if (RNGSUS.nextInt(
                                            Math.max(1, 30 - (int) (((EntityHorse) aDead).getMaxHealth()))) == 0)
                                            tAmount += 1 + RNGSUS.nextInt(aLooting + 1) / 2;
                                        switch (((EntityHorse) aDead).getHorseType()) {
                                            default:
                                                while (tAmount-- > 0) aDrops.add(
                                                    ST.entity(
                                                        aDead,
                                                        aBurn ? IL.Food_Horse_Cooked.get(1)
                                                            : IL.Food_Horse_Raw.get(1)));
                                                for (int i = 0; i < 4; i++)
                                                    if (RNGSUS.nextInt(100) <= 25 + aLooting * 5)
                                                        aDrops.add(ST.entity(aDead, IL.Hoof_Horse.get(1)));
                                                break;
                                            case 1:
                                                while (tAmount-- > 0) aDrops.add(
                                                    ST.entity(
                                                        aDead,
                                                        aBurn ? IL.Food_Donkey_Cooked.get(1)
                                                            : IL.Food_Donkey_Raw.get(1)));
                                                for (int i = 0; i < 4; i++)
                                                    if (RNGSUS.nextInt(100) <= 25 + aLooting * 5)
                                                        aDrops.add(ST.entity(aDead, IL.Hoof_Donkey.get(1)));
                                                break;
                                            case 2:
                                                while (tAmount-- > 0) aDrops.add(
                                                    ST.entity(
                                                        aDead,
                                                        aBurn ? IL.Food_Mule_Cooked.get(1) : IL.Food_Mule_Raw.get(1)));
                                                for (int i = 0; i < 4; i++)
                                                    if (RNGSUS.nextInt(100) <= 25 + aLooting * 5)
                                                        aDrops.add(ST.entity(aDead, IL.Hoof_Mule.get(1)));
                                                break;
                                            case 3:
                                                while (tAmount-- > 0)
                                                    aDrops.add(ST.entity(aDead, ST.make(Items.rotten_flesh, 1, 0)));
                                                for (int i = 0; i < 4; i++)
                                                    if (RNGSUS.nextInt(200) <= 25 + aLooting * 5)
                                                        aDrops.add(ST.entity(aDead, IL.Hoof_Horse.get(1)));
                                                break;
                                            case 4:
                                                while (tAmount-- > 0)
                                                    aDrops.add(ST.entity(aDead, ST.make(Items.bone, 1, 0)));
                                                for (int i = 0; i < 4; i++)
                                                    if (RNGSUS.nextInt(200) <= 25 + aLooting * 5)
                                                        aDrops.add(ST.entity(aDead, IL.Hoof_Horse.get(1)));
                                                break;
        ...
        if (!(aDead instanceof EntityPlayer)) {
            for (EntityItem tEntity : aDrops) if (tEntity != null) {
                ItemStack tStack = tEntity.getEntityItem();
                if (ST.valid(tStack)) {
                    ...
                    if (!aPlayerKill) {
                        ...
                        if (tItem == Items.wooden_sword || tItem == Items.wooden_pickaxe
                            || tItem == Items.wooden_shovel
                            || tItem == Items.wooden_axe
                            || tItem == Items.wooden_hoe) {
                            ST.set(tStack, IL.Stick.get(1));
                        } else if (tItem == Items.stone_sword || tItem == Items.stone_pickaxe
                            || tItem == Items.stone_shovel
                            || tItem == Items.stone_axe
                            || tItem == Items.stone_hoe) {
                    ...
                    if (MOBS_DROP_MEAT && !OD.listAllmeatsubstitute.is(tStack)) {
                        if (RNGSUS.nextInt(3) == 0
                            && (OM.is("listAllmeatraw", tStack) || OM.is("listAllmeatcooked", tStack)))
                            tIntestinesAmount++;
                        if (ST.item_(tStack) == Items.fish) {
                            if (aBurn) ST.set(tStack, RM.get_smelting(tStack), F, F);
                            break;
                        }
                        if (ST.item_(tStack) == Items.porkchop) {
                            switch (tRandomNumber % 3) {
                                ...
                                case 1:
                                    ST.set(
                                        tStack,
                                        (aBurn ? IL.Food_Bacon_Cooked : IL.Food_Bacon_Raw)
                                            .get(UT.Code.bindStack(tStack.stackSize * (3 + RNGSUS.nextInt(3)))),
                                        T,
                                        F);
                                    break;
                            }
                        } else if (ST.item_(tStack) == Items.cooked_porkchop) {
                            switch (tRandomNumber % 3) {
                                case 0:
                                ...
                                case 1:
                                    ST.set(
                                        tStack,
                                        IL.Food_Bacon_Cooked
                                            .get(UT.Code.bindStack(tStack.stackSize * (3L + RNGSUS.nextInt(3)))),
                                        T,
                                        F);
                                    break;
                            }
                            ...
                            switch (tRandomNumber % 3) {
                                ...
                                case 1:
                                    ST.set(
                                        tStack,
                                        (aBurn ? IL.Food_RibEyeSteak_Cooked : IL.Food_RibEyeSteak_Raw).get(1),
                                        F,
                                        F);
                                    break;
                            }
        ...
        if (MOBS_DROP_NAME && aDead instanceof EntityLiving
            && ((EntityLiving) aDead).isNoDespawnRequired()
            && ((EntityLiving) aDead).hasCustomNameTag()) {
