...
public class BlockTreeLogC extends BlockBaseLogFlammable implements IBlockToolable {
    ...
    public int getLeavesRangeSide(byte aMeta) {
        return ((BlockBaseLeaves) BlocksGT.Leaves_CD).getLeavesRangeSide((byte) (aMeta & 3));
    }

    @Override
    public int getLeavesRangeYPos(byte aMeta) {
        return ((BlockBaseLeaves) BlocksGT.Leaves_CD).getLeavesRangeYNeg((byte) (aMeta & 3));
    } // Yes it has to be the Negative Range of the Leaves here

    @Override
    public int getLeavesRangeYNeg(byte aMeta) {
        return ((BlockBaseLeaves) BlocksGT.Leaves_CD).getLeavesRangeYPos((byte) (aMeta & 3));
