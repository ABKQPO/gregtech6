...
public class BlockTreeLeavesCD extends BlockBaseLeaves implements Runnable {
    ...
    public BlockTreeLeavesCD(String aUnlocalised, Block aSaplings) {
        super(
            ...
            soundTypeGrass,
            1,
            Textures.BlockIcons.LEAVES_CD,
            aSaplings,
            new Block[] { BlocksGT.LogC, BlocksGT.LogC, BlocksGT.LogC, BlocksGT.LogC, BlocksGT.LogD, BlocksGT.LogD,
                BlocksGT.LogD, BlocksGT.LogD },
    ...
    public ArrayList<ItemStack> getDrops(World aWorld, int aX, int aY, int aZ, int aMeta, int aFortune) {
        ...
        if (RNGSUS.nextInt(tChance) == 0 && ((aMeta & 7) != 0 || RNGSUS.nextInt(3) == 0)) {
            ...
            switch (aMeta & 7) {
                case 0:
                    if (RNGSUS.nextInt(tChance) < 2) rDrops.add(IL.BoP_Pinecone.get(1));
                    break;
            }
        }
        return rDrops;
