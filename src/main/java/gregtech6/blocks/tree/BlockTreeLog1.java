...
public class BlockTreeLog1 extends BlockBaseBeamFlammable implements IBlockToolable {
    ...
    public long onToolClick(String aTool, long aRemainingDurability, long aQuality, Entity aPlayer,
        ...
        if (aTool.equals(TOOL_axe) || aTool.equals(TOOL_saw) || aTool.equals(TOOL_knife)) {
            ...
            switch (aWorld.getBlockMetadata(aX, aY, aZ) & PILLAR_DATA) {
                case 0:
                    ST.give(aPlayer, IL.Bark_Dry.get(1), aWorld, aX + OFFX[aSide], aY + OFFY[aSide], aZ + OFFZ[aSide]);
                    break;
                case 1:
                    ST.give(
                        aPlayer,
                ...
                case 2:
                    ...
                    break;
                case 3:
                    ST.give(aPlayer, OM.dust(MT.Ice), aWorld, aX + OFFX[aSide], aY + OFFY[aSide], aZ + OFFZ[aSide]);
                    break;
            }
    ...
    public float getBlockHardness(World aWorld, int aX, int aY, int aZ) {
        return Blocks.log.getBlockHardness(aWorld, aX, aY, aZ) / 2;
    }
}
