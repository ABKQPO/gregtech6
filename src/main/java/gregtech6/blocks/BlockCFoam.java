...
public class BlockCFoam extends BlockColored implements IBlockFoamable {
    ...
    protected BlockCFoam(Class<? extends ItemBlock> aItemClass, Material aVanillaMaterial, SoundType aVanillaSoundType,
