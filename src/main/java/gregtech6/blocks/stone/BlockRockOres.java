...
public class BlockRockOres extends BlockBaseMeta {
    ...
    public static float[] HARDNESS_LEVELS = { 0.5F, 0.5F, 1.0F, 1.0F, 2.0F, 0.5F, 0.5F, 1.0F, 1.0F, 0.5F, 0.5F, 0.5F,
        0.5F, 0.5F, 0.5F, 0.5F };
    public static OreDictMaterial[] ORE_MATERIALS = { MT.Coal, MT.Lignite, MT.NaCl, MT.KCl, MT.OREMATS.Bauxite,
        MT.Oilshale, MT.Gypsum, MT.MilkyQuartz, MT.NetherQuartz, MT.NULL, MT.NULL, MT.NULL, MT.NULL, MT.NULL, MT.NULL,
        MT.NULL };
    ...
    public BlockRockOres(String aUnlocalised) {
        ...
        // StoneLayer.LAYERS.add(new StoneLayer(this, 8, ORE_MATERIALS[7]).setNoDeep()); Nope, Nether Quartz is not for
        // the Overworld.
    ...
    public ArrayList<ItemStack> getDrops(World aWorld, int aX, int aY, int aZ, int aMeta, int aFortune) {
        return ST
            .arraylist(OP.oreRaw.mat(ORE_MATERIALS[aMeta], aFortune > 0 ? 2 + RNGSUS.nextInt(aFortune * 2 + 2) : 2));
    }
