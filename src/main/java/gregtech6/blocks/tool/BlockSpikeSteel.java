...
public class BlockSpikeSteel extends BlockBaseSpike {
    ...
    public BlockSpikeSteel(String aNameInternal) {
        super(aNameInternal, ANY.BlueSteel, ANY.RedSteel); // If you were looking for the regular Steel Spike, that one
                                                           // is with the Sharp Spikes.
    ...
    public void onEntityCollidedWithBlock(World aWorld, int aX, int aY, int aZ, Entity aEntity) {
        ...
        if (aEntity instanceof EntityLivingBase && !(aEntity instanceof EntityIronGolem)) {
            aEntity.attackEntityFrom(
                ...
                TFC_DAMAGE_MULTIPLIER * ((aMeta & 7) < 6 ? 8.0F : 4.0F));
        }
    }
}
