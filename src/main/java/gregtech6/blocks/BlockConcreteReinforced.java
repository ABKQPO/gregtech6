...
public class BlockConcreteReinforced extends BlockColored {
    ...
    public BlockConcreteReinforced(String aUnlocalised) {
        super(
            ...
            4.0F,
            3,
            Textures.BlockIcons.CONCRETES_REINFORCED);
    ...
    protected BlockMetaType makeSlab(Class<? extends ItemBlock> aItemClass, Material aVanillaMaterial,
        ...
        return new BlockConcreteReinforced(
            aItemClass,
            aVanillaMaterial,
            aVanillaSoundType,
            aName,
    ...
    protected BlockConcreteReinforced(Class<? extends ItemBlock> aItemClass, Material aVanillaMaterial,
        SoundType aVanillaSoundType, String aName, String aDefaultLocalised, OreDictMaterial aMaterial,
        float aResistanceMultiplier, float aHardnessMultiplier, int aHarvestLevel, int aCount, IIconContainer[] aIcons,
        byte aSlabType, BlockMetaType aBlock) {
        super(
