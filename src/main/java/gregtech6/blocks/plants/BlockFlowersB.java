...
public class BlockFlowersB extends BlockBaseFlower implements Runnable {
    ...
    public BlockFlowersB(String aUnlocalised) {
        ...
        LH.add(getUnlocalizedName() + ".2", "Desert Trumpet"); // Gold, color might vary depending on other Minerals
                                                               // close by
    ...
    public void addInformation(ItemStack aStack, byte aMeta, EntityPlayer aPlayer, List<String> aList, boolean aF3_H) {
        switch (aMeta) {
            case 0:
                aList.add("Indicates presence of an Arsenic Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 1:
                aList.add("Indicates presence of an Antimony Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                aList.add("Indicates presence of a Redstone Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 5:
                ...
                break;
            case 6:
                aList.add("Indicates presence of a Diamond Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 7:
                aList.add("Indicates presence of a Tungsten Deposit nearby");
                break;
            case 8:
    ...
    public void run() {
        ...
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 2), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Yellow], OM.dust(MT.Yellow));
        RM.Squeezer.addRecipe1(T, 16, 16, ST.make(this, 1, 3), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Pink], OM.dust(MT.Pink));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 4), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Yellow], OM.dust(MT.Yellow));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 5), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Purple], OM.dust(MT.Purple));
        ...
        CR.shapeless(
            OP.stick.mat(MT.WOODS.Acacia, 1, IL.Stick.get(1)),
            CR.DEF_NCC,
            new Object[] { ST.make(this, 1, 0) });
        CR.shapeless(
            OP.stick.mat(MT.WOODS.Acacia, 1, IL.Stick.get(1)),
            CR.DEF_NCC,
            new Object[] { ST.make(this, 1, 1) });
    ...
    public boolean canBlockStay(World aWorld, int aX, int aY, int aZ) {
        return WD.oxygen(aWorld, aX, aY, aZ) && aWorld.getBlock(aX, aY - 1, aZ)
            .canSustainPlant(aWorld, aX, aY - 1, aZ, ForgeDirection.UP, (IPlantable) Blocks.cactus);
    }
