...
public class BlockFlowersA extends BlockBaseFlower implements Runnable {
    ...
    public void addInformation(ItemStack aStack, byte aMeta, EntityPlayer aPlayer, List<String> aList, boolean aF3_H) {
        switch (aMeta) {
            case 0:
                aList.add("Indicates presence of a Gold Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 1:
                aList.add("Indicates presence of a Silver Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 2:
                aList.add("Indicates presence of a Copper Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 3:
                aList.add("Indicates presence of a Zinc Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 4:
                aList.add("Indicates presence of a Nickel Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 5:
                aList.add("Indicates presence of an Uranium Deposit nearby");
                aList.add(LH.Chat.DGRAY + "* exists in Real Life");
                break;
            case 6:
                aList.add("Indicates presence of a Platinum Deposit nearby");
                break;
            case 7:
                aList.add("Indicates presence of an Ore Deposit nearby");
                break;
            case 8:
    ...
    public void run() {
        ...
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 0), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Yellow], OM.dust(MT.Wheat));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 1), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Yellow], OM.dust(MT.Wheat));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 2), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Magenta], OM.dust(MT.Magenta));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 3), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Yellow], OM.dust(MT.Yellow));
        RM.Squeezer.addRecipe1(T, 16, 16, ST.make(this, 1, 4), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Pink], OM.dust(MT.Pink));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 5), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_White], OM.dust(MT.White));
        RM.Squeezer.addRecipe1(
            ...
            OM.dust(MT.LightBlue));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(this, 1, 7), NF, DYE_FLUIDS_FLOWER[DYE_INDEX_Brown], OM.dust(MT.Brown));
