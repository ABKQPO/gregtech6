...
public class PlayerModelRenderer extends RenderPlayer {
    ...
    private final ResourceLocation[] mResources = new ResourceLocation[] {
        new ResourceLocation(RES_PATH_MODEL + "BrainTech.png"), new ResourceLocation(RES_PATH_MODEL + "Silver.png"),
        new ResourceLocation(RES_PATH_MODEL + "MrBrain.png"), new ResourceLocation(RES_PATH_MODEL + "Dev.png"),
        new ResourceLocation(RES_PATH_MODEL + "Gold.png"), new ResourceLocation(RES_PATH_MODEL + "Crazy.png"),
        new ResourceLocation(RES_PATH_MODEL + "Sus.png") };
    ...
    public void receiveRenderSpecialsEvent(RenderPlayerEvent.Specials.Pre aEvent) {
        ...
        try {
            ...
            if (tResource == null) tResource = getResource(
                aPlayer.getUniqueID()
                    .toString());
