...
public class Loader_Loot implements Runnable {
    ...
    public void run() {
        ...
        if (!MD.VN4.mLoaded) new ChestGenHooksChestReplacer(ChestGenHooks.VILLAGE_BLACKSMITH, 24);

        if (MD.TF.mLoaded) {
            TFTreasure.hill1 = TwilightTreasureReplacer
                .create(TFTreasure.hill1, 1, "hill1", ChestGenHooks.MINESHAFT_CORRIDOR, 509);
            TFTreasure.hill2 = TwilightTreasureReplacer
                .create(TFTreasure.hill2, 2, "hill2", ChestGenHooks.MINESHAFT_CORRIDOR, 558);
            TFTreasure.hill3 = TwilightTreasureReplacer
                .create(TFTreasure.hill3, 3, "hill3", ChestGenHooks.MINESHAFT_CORRIDOR, 58);
            TFTreasure.hedgemaze = TwilightTreasureReplacer
                .create(TFTreasure.hedgemaze, 4, "hedgemaze", ChestGenHooks.BONUS_CHEST, 516);
            TFTreasure.tree_cache = TwilightTreasureReplacer
                .create(TFTreasure.tree_cache, 14, "tree_cache", ChestGenHooks.BONUS_CHEST, 508);
            TFTreasure.basement = TwilightTreasureReplacer
                .create(TFTreasure.basement, 9, "basement", ChestGenHooks.STRONGHOLD_CROSSING, 9);
            TFTreasure.labyrinth_room = TwilightTreasureReplacer
                .create(TFTreasure.labyrinth_room, 5, "labyrinth_room", ChestGenHooks.PYRAMID_JUNGLE_CHEST, 8);
            TFTreasure.labyrinth_deadend = TwilightTreasureReplacer
                .create(TFTreasure.labyrinth_deadend, 6, "labyrinth_deadend", ChestGenHooks.PYRAMID_JUNGLE_CHEST, 508);
            TFTreasure.labyrinth_vault = TwilightTreasureReplacer
                .create(TFTreasure.labyrinth_vault, 10, "labyrinth_vault", ChestGenHooks.VILLAGE_BLACKSMITH, 16);
            TFTreasure.tower_room = TwilightTreasureReplacer
                .create(TFTreasure.tower_room, 7, "tower_room", ChestGenHooks.PYRAMID_DESERT_CHEST, 2);
            TFTreasure.tower_library = TwilightTreasureReplacer
                .create(TFTreasure.tower_library, 8, "tower_library", ChestGenHooks.STRONGHOLD_LIBRARY, 502);
            TFTreasure.darktower_cache = TwilightTreasureReplacer
                .create(TFTreasure.darktower_cache, 11, "darktower_cache", ChestGenHooks.STRONGHOLD_CORRIDOR, 525);
            TFTreasure.darktower_key = TwilightTreasureReplacer
                .create(TFTreasure.darktower_key, 12, "darktower_key", ChestGenHooks.DUNGEON_CHEST, 25);
            TFTreasure.darktower_boss = TwilightTreasureReplacer
                .create(TFTreasure.darktower_boss, 13, "darktower_boss", ChestGenHooks.PYRAMID_JUNGLE_DISPENSER, 59);
            TFTreasure.stronghold_cache = TwilightTreasureReplacer
                .create(TFTreasure.stronghold_cache, 15, "stronghold_cache", ChestGenHooks.STRONGHOLD_CORRIDOR, 510);
            TFTreasure.stronghold_room = TwilightTreasureReplacer
                .create(TFTreasure.stronghold_room, 16, "stronghold_room", ChestGenHooks.DUNGEON_CHEST, 10);
            TFTreasure.stronghold_boss = TwilightTreasureReplacer
                .create(TFTreasure.stronghold_boss, 17, "stronghold_boss", ChestGenHooks.VILLAGE_BLACKSMITH, 559);
            TFTreasure.aurora_cache = TwilightTreasureReplacer
                .create(TFTreasure.aurora_cache, 18, "aurora_cache", ChestGenHooks.DUNGEON_CHEST, 46);
            TFTreasure.aurora_room = TwilightTreasureReplacer
                .create(TFTreasure.aurora_room, 19, "aurora_room", ChestGenHooks.DUNGEON_CHEST, 13);
            //// TFTreasure.aurora_boss = TwilightTreasureReplacer.create(TFTreasure.aurora_boss , 20, "aurora_boss" ,
            //// ChestGenHooks.DUNGEON_CHEST , 32745);// This one is actually empty and unused.
            TFTreasure.troll_garden = TwilightTreasureReplacer
                .create(TFTreasure.troll_garden, 21, "troll_garden", ChestGenHooks.DUNGEON_CHEST, 524);
            TFTreasure.troll_vault = TwilightTreasureReplacer
                .create(TFTreasure.troll_vault, 22, "troll_vault", ChestGenHooks.VILLAGE_BLACKSMITH, 24);
        }

        ST.LOOT_TABLES.add("gt.flawless");
        ChestGenHooks.getInfo("gt.flawless")
            .setMin(8);
        ChestGenHooks.getInfo("gt.flawless")
            .setMax(24);
        ...
        for (OreDictMaterial tMaterial : OreDictMaterial.MATERIAL_ARRAY)
            if (tMaterial != null && tMaterial.contains(RANDOM_SMALL_GEM_ORE)) {
        ...
        ChestGenHooks.getInfo("gt.saplings")
            .setMin(8);
        ChestGenHooks.getInfo("gt.saplings")
            .setMax(24);
        ...
        for (SaplingEntry tEntry : WoodDictionary.LIST_SAPLINGS) {
            if (MD.MC.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.EtFu.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.GT.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.IC2.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.IC2C.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.MFR.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.TC.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.WTCH.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.EBXL.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.EB.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.BoP.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.HiL.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.HaC.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
            if (MD.MF2.owns(tEntry.mSapling)) {
                if (addLoot("gt.saplings", 144, tEntry.mCount, tEntry.mCount, ST.validMeta(tEntry.mSapling)))
                    tEntry.mBaggedSaplingLoot = T;
                continue;
            }
        ...
        ChestGenHooks.getInfo("gt.seeds")
            .setMin(8);
        ChestGenHooks.getInfo("gt.seeds")
            .setMax(24);
        ...
        for (int i = 0; i < 16; i++) addLoot("gt.seeds", 9, 8, 24, ST.make(BlocksGT.Glowtus, 1, i));
        ...
        ChestGenHooks.getInfo("gt.books")
            .setMin(8);
        ChestGenHooks.getInfo("gt.books")
            .setMax(24);
        ...
        addLoot(
            ...
            1,
            1,
            FL.Blood.exists() ? IL.Bottle_Blood.get(1) : ST.make(Items.experience_bottle, 1, 0));
        ...
        addLoot(
            ...
            1,
            1,
            FL.Slime_Pink.exists() ? IL.Bottle_Slime_Pink.get(1) : IL.Bottle_Slime_Green.get(1));
        addLoot(
            "gt.bottles",
            36,
            1,
            1,
            FL.Slime_Blue.exists() ? IL.Bottle_Slime_Blue.get(1) : IL.Bottle_Slime_Green.get(1));
