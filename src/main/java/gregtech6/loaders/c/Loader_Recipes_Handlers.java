...
public class Loader_Recipes_Handlers implements Runnable {
    ...
    public void run() {
        ...
        RM.Mortar.add(
            new RecipeMapHandlerPrefix(
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, MORTAR, new Or(BRITTLE, FOOD, gemChipped.NOT))));
        RM.Mortar.add(
            new RecipeMapHandlerPrefix(
                gem,
                1,
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, MORTAR, new Or(BRITTLE, FOOD, gemFlawed.NOT))));
        RM.Mortar.add(
            new RecipeMapHandlerPrefix(
                gemFlawless,
                1,
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, MORTAR, new Or(BRITTLE, FOOD, gem.NOT))));
        RM.Mortar.add(
            new RecipeMapHandlerPrefix(
                gemExquisite,
                1,
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, MORTAR, new Or(BRITTLE, FOOD, gemFlawless.NOT))));
        RM.Mortar.add(
            new RecipeMapHandlerPrefix(
                gemLegendary,
                1,
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, MORTAR, new Or(BRITTLE, FOOD, gemExquisite.NOT))));
        RM.Mortar.add(
            new RecipeMapHandlerPrefix(
                stick,
                1,
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, MORTAR, new Or(BRITTLE, FOOD, WOOD))));
        RM.Mortar.add(
            new RecipeMapHandlerPrefix(
                stickLong,
                1,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                dustImpure,
                1,
                null,
                0,
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, MORTAR.NOT, MT.Bedrock.NOT)));
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                dustPure,
                1,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, MORTAR.NOT)));
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                rubble,
                1,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, MORTAR, MT.Bedrock.NOT)));
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                dustPure,
                1,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                ...
                256,
                NF,
                new OreDictPrefix[] { dust, dustTiny, dustDiv72 },
                L12_LONG_1,
                NI,
                NI,
                T,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                new OreDictPrefix[] { crushedPurified },
                L12_LONG_1,
                NF,
                16,
                0,
                256,
                NF,
                new OreDictPrefix[] { dust, dustSmall },
                L12_LONG_1,
                NI,
                NI,
                T,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                new OreDictPrefix[] { crushedCentrifuged },
                L12_LONG_1,
                NF,
                16,
                0,
                256,
                NF,
                new OreDictPrefix[] { dust, dustSmall, dustTiny, dustDiv72 },
                L12_LONG_1,
                NI,
                NI,
                T,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                ...
                256,
                NF,
                new OreDictPrefix[] { dustTiny, dustDiv72 },
                L12_LONG_1,
                NI,
                NI,
                T,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                new OreDictPrefix[] { crushedPurifiedTiny },
                L12_LONG_1,
                NF,
                16,
                0,
                256,
                NF,
                new OreDictPrefix[] { dustTiny, dustDiv72, dustDiv72 },
                L12_LONG_1,
                NI,
                NI,
                T,
        ...
        RM.Shredder.add(
            new RecipeMapHandlerPrefixShredding(
                new OreDictPrefix[] { crushedCentrifugedTiny },
                L12_LONG_1,
                NF,
                16,
                0,
                256,
                NF,
                new OreDictPrefix[] { dustTiny, dustDiv72, dustDiv72, dustDiv72 },
                L12_LONG_1,
                NI,
                NI,
                T,
        ...
        for (OreDictPrefix tPrefix : OreDictPrefix.VALUES)
            if (tPrefix.mByProducts.isEmpty() && tPrefix.contains(RECYCLABLE)
                && !tPrefix.containsAny(ORE, ORE_PROCESSING_BASED, DUST_BASED, IS_CONTAINER)
                && !tPrefix.mNameInternal.startsWith("cableGt")
                && !tPrefix.mNameInternal.startsWith("wireGt")
                && !tPrefix.mNameInternal.startsWith("pipe")) {
                    RM.Shredder.add(
                        new RecipeMapHandlerPrefix(
                            tPrefix,
                            1,
        ...
        RM.Anvil.add(
            new RecipeMapHandlerPrefixShredding(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, MORTAR, selfcrush())));
        RM.Anvil.add(
            new RecipeMapHandlerPrefixShredding(
                crushed,
                1,
        ...
        RM.Anvil.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, selfforge(), fullforge(), COATED.NOT)));
        RM.Anvil.add(
            new RecipeMapHandlerPrefix(
                ingot,
                1,
        ...
        RM.AnvilBendBig.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, SMITHABLE)));
        RM.AnvilBendBig.add(
            new RecipeMapHandlerPrefix(
                stick,
                1,
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, SMITHABLE)).chances(10000, 9000));
        RM.AnvilBendBig.add(
            new RecipeMapHandlerPrefix(
                stickLong,
                1,
        ...
        RM.AnvilBendSmall.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, SMITHABLE, selfforge(), fullforge(), COATED.NOT)).chances(10000, 9000));
        RM.AnvilBendSmall.add(
            new RecipeMapHandlerPrefix(
                stick,
                1,
        ...
        RM.Compressor.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, tEasyWorkable.NOT)));
        RM.Compressor.add(
            new RecipeMapHandlerPrefix(
                plate,
                9,
        ...
        RM.Compressor.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, tEasyWorkable)));
        RM.Compressor.add(
            new RecipeMapHandlerPrefix(
                plate,
                9,
        ...
        for (OreDictMaterial tMat : ANY.Iron.mToThis)
            if (ST.valid(tStack = OP.toolHeadRawPickaxe.mat(tMat, 1))) RM.Press.add(
                new RecipeMapHandlerPrefix(
                    gemFlawed,
                    2,
                    NF,
                    ...
                    F,
                    F,
                    new And(ANTIMATTER.NOT, MT.Empty.NOT)));
        for (OreDictMaterial tMat : ANY.Iron.mToThis)
            if (ST.valid(tStack = OP.toolHeadPickaxe.mat(tMat, 1))) RM.Press.add(
                new RecipeMapHandlerPrefix(
                    gemFlawed,
                    2,
                    NF,
        ...
        RM.Press.add(
            new RecipeMapHandlerPrefix(
                ...
                toolHeadPickaxeGem,
                1,
                OP.toolHeadPickaxeGem.mat(MT.Empty, 1),
                NI,
                T,
                F,
                F,
        ...
        RM.Press.add(
            new RecipeMapHandlerPrefix(
                ...
                arrowGtPlastic,
                1,
                OP.arrowGtPlastic.mat(MT.Empty, 1),
                NI,
                T,
                F,
                F,
        ...
        RM.Press.add(
            new RecipeMapHandlerPrefix(
                ...
                bulletGtSmall,
                1,
                OP.bulletGtSmall.mat(MT.Empty, 1),
                NI,
                T,
                F,
                F,
        ...
        RM.Press.add(
            new RecipeMapHandlerPrefix(
                ...
                bulletGtMedium,
                1,
                OP.bulletGtMedium.mat(MT.Empty, 1),
                NI,
                T,
                F,
                F,
        ...
        RM.Press.add(
            new RecipeMapHandlerPrefix(
                ...
                bulletGtLarge,
                1,
                OP.bulletGtLarge.mat(MT.Empty, 1),
                NI,
                T,
                F,
                F,
        ...
        RM.RollingMill.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, SMITHABLE, tEasyWorkable.NOT)));
        RM.RollingMill.add(
            new RecipeMapHandlerPrefix(
                billet,
                1,
        ...
        RM.RollingMill.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, SMITHABLE, tEasyWorkable)));
        RM.RollingMill.add(
            new RecipeMapHandlerPrefix(
                billet,
                1,
        ...
        RM.RollBender.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, SMITHABLE, tEasyWorkable.NOT)));
        RM.RollBender.add(
            new RecipeMapHandlerPrefix(
                stick,
                1,
        ...
        RM.RollBender.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, SMITHABLE, tEasyWorkable)));
        RM.RollBender.add(
            new RecipeMapHandlerPrefix(
                stick,
                1,
        ...
        RM.Welder.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, tEasyHeatable.NOT, COATED.NOT)));
        RM.Welder.add(
            new RecipeMapHandlerPrefix(
                ingot,
                3,
        ...
        RM.Welder.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, tEasyHeatable.NOT)));
        RM.Welder.add(
            new RecipeMapHandlerPrefix(
                bolt,
                8,
        ...
        RM.Welder.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, tEasyHeatable, COATED.NOT)));
        RM.Welder.add(
            new RecipeMapHandlerPrefix(
                ingot,
                3,
        ...
        RM.Welder.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, FLAMMABLE.NOT, SMITHABLE, tEasyHeatable)));
        RM.Welder.add(
            new RecipeMapHandlerPrefix(
                bolt,
                8,
        ...
        RM.Lathe.add(
            new RecipeMapHandlerPrefix(
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, tEasyWorkable.NOT, LAYERED.NOT)));
        RM.Lathe.add(
            new RecipeMapHandlerPrefix(
                plateGem,
                1,
        ...
        RM.Lathe.add(
            new RecipeMapHandlerPrefix(
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, tEasyWorkable.NOT, lens.NOT)));
        RM.Lathe.add(
            new RecipeMapHandlerPrefix(
                lens,
                1,
        ...
        RM.Lathe.add(
            new RecipeMapHandlerPrefix(
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, tEasyWorkable, LAYERED.NOT)));
        RM.Lathe.add(
            new RecipeMapHandlerPrefix(
                plateGem,
                1,
        ...
        RM.Lathe.add(
            new RecipeMapHandlerPrefix(
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, tEasyWorkable, lens.NOT)));
        RM.Lathe.add(
            new RecipeMapHandlerPrefix(
                lens,
                1,
        ...
        RM.Sharpening.add(
            new RecipeMapHandlerPrefix(
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT)).chances(10000, 7500));
        RM.Sharpening.add(
            new RecipeMapHandlerPrefix(
                plateGem,
                1,
        ...
        RM.Sharpening.add(
            new RecipeMapHandlerPrefix(
                ...
                T,
                F,
                new And(ANTIMATTER.NOT, COATED.NOT, STONE)).chances(10000, 7500));
        RM.Sharpening.add(
            new RecipeMapHandlerPrefix(
                toolHeadRawArrow,
                1,
        ...
        toolHeadArrow.addListener(
            new OreProcessing_CraftFrom(
                ...
                null,
                null,
                new And(ANTIMATTER.NOT, COATED.NOT, STONE)));
        toolHeadArrow.addListener(
            new OreProcessing_CraftFrom(
                1,
                null,
        ...
        RM.Unboxinator.add(
            new RecipeMapHandlerPrefix(
                ...
                2,
                NI,
                toolHeadPickaxeGem.mat(MT.Empty, 1),
                F,
                F,
                F,
                new And(ANTIMATTER.NOT, MT.Empty.NOT)));
        ...
        RM.Unboxinator.add(
            new RecipeMapHandlerPrefix(
                ...
                F,
                F,
                new And(ANTIMATTER.NOT, EXPLODES_IN_NONVANILLA_CRAFTING_GRID.NOT)));
        RM.Unboxinator.add(
            new RecipeMapHandlerPrefix(
                blockDust,
                1,
        ...
        for (int i = 0; i < 4; i++) if (tFluids[i] != null) {
            RM.Cutter.add(
                new RecipeMapHandlerPrefix(
                    blockSolid,
                    1,
                    FL.mul(tFluids[i], tMultiplier[i] * 7 * 16, 1000, T),
                    32,
                    tMultiplier[i] * 7 * 16,
                    0,
                    NF,
            ...
            RM.Cutter.add(
                new RecipeMapHandlerPrefix(
                    stickLong,
                    1,
                    FL.mul(tFluids[i], tMultiplier[i] * 16, 1000, T),
                    32,
                    tMultiplier[i] * 16,
                    0,
                    NF,
            ...
            RM.Cutter.add(
                new RecipeMapHandlerPrefix(
                    stick,
                    1,
                    FL.mul(tFluids[i], tMultiplier[i] * 3 * 16, 1000, T),
                    32,
                    tMultiplier[i] * 3 * 16,
                    0,
                    NF,
            ...
            RM.Cutter.add(
                new RecipeMapHandlerPrefix(
                    plate,
                    1,
                    FL.mul(tFluids[i], tMultiplier[i] * 4 * 16, 1000, T),
                    32,
                    tMultiplier[i] * 4 * 16,
                    0,
                    NF,
            ...
            RM.Cutter.add(
                new RecipeMapHandlerPrefix(
                    gemFlawed,
                    1,
                    FL.mul(tFluids[i], tMultiplier[i] * 2 * 16, 1000, T),
                    32,
                    tMultiplier[i] * 2 * 16,
                    0,
                    NF,
        ...
        ICondition tConditionP = new Nor(
            PREFIX_UNUSED,
            PLANT_DROP,
            IS_CONTAINER,
            DUST_BASED,
            ORE,
            ORE_PROCESSING_BASED,
            scrapGt,
            ingotHot);

        RM.Polarizer
            .add(new RecipeMapHandlerMaterial(MT.Nd, NF, 128, 144, NF, MT.NeodymiumMagnetic, NI, T, tConditionP));

        for (OreDictMaterial tMaterial : ANY.WoodUntreated.mToThis) {
            RM.Bath.add(
                new RecipeMapHandlerMaterial(
                    tMaterial,
                    FL.Oil_Seed.make(100),
                    0,
                    144,
                    NF,
                    MT.WoodTreated,
        ...
        RM.Sluice.add(
            new RecipeMapHandlerPrefix(
                ...
                9,
                NI,
                OM.dust(MT.SluiceSand),
                T,
                F,
                T,
                ANTIMATTER.NOT).chances(10000, 5000, 10000));
        RM.Sluice.add(
            new RecipeMapHandlerPrefix(
                crushedTiny,
                1,
        ...
        if (FL.Mana_TE.exists()) {
            ...
            for (OreDictMaterial tMat : ANY.Fe.mToThis) RM.Bath.add(
                new RecipeMapHandlerMaterial(tMat, FL.Mana_TE.make(250), 0, 144, NF, MT.Thaumium, NI, T, tConditionP));
            for (OreDictMaterial tMat : ANY.Steel.mToThis) RM.Bath.add(
                new RecipeMapHandlerMaterial(tMat, FL.Mana_TE.make(125), 0, 144, NF, MT.Manasteel, NI, T, tConditionP));
            RM.Bath.add(
                new RecipeMapHandlerMaterial(
                    MT.Ag,
                    FL.Mana_TE.make(125),
            ...
            RM.Bath.add(
                new RecipeMapHandlerMaterial(
                    ...
                    tConditionP));
            RM.Bath.add(
                new RecipeMapHandlerMaterial(MT.Au, FL.Mana_TE.make(125), 0, 144, NF, MT.Midasium, NI, T, tConditionP));
            RM.Bath.add(
                new RecipeMapHandlerMaterial(MT.Pt, FL.Mana_TE.make(125), 0, 144, NF, MT.Mithril, NI, T, tConditionP));
            RM.Bath.add(
                new RecipeMapHandlerMaterial(MT.Sb, FL.Mana_TE.make(50), 0, 144, NF, MT.Ardite, NI, T, tConditionP));
            RM.Bath.add(
                new RecipeMapHandlerMaterial(
                    MT.MilkyQuartz,
                    FL.Mana_TE.make(1),
        ...
        RM.Bath
            .add(new RecipeMapHandlerMaterial(MT.Pb, MT.Midasium.liquid(U8, T), 0, 144, NF, MT.Au, NI, T, tConditionP));

        RM.Bath.add(
            new RecipeMapHandlerMaterial(
                MT.WOODS.Oak,
                FL.Holywater.make(50),
                0,
                144,
                NF,
                MT.Skyroot,
        ...
        RM.Bath.add(
            new RecipeMapHandlerMaterial(
                MT.MeteoricBlueSteel,
                FL.FieryBlood.make(L),
                0,
                144,
                NF,
                MT.MeteoflameBlueSteel,
                NI,
                T,
                tConditionP));
        RM.Bath.add(
        ...
        for (OreDictMaterial tMat : ANY.Fe.mToThis) {
            ...
            RM.Bath.add(
                new RecipeMapHandlerMaterial(tMat, MT.Au.liquid(U9, T), 0, 144, NF, MT.GildedIron, NI, T, tConditionP));
        ...
        for (OreDictMaterial tMat : ANY.Diamond.mToThis) {
            RM.Bath.add(
                new RecipeMapHandlerMaterial(
                    tMat,
                    MT.Netherite.liquid(U4, T),
                    0,
                    144,
                    NF,
                    MT.NetherizedDiamond,
                    NI,
                    T,
                    tConditionP));
        }
            ...
            if (tMaterial != tMaterial.mTargetGenerifying.mMaterial) {
                RM.Generifier.add(
                    new RecipeMapHandlerMaterial(
                        ...
                        1,
                        NF,
                        tMaterial.mTargetGenerifying.mMaterial,
                        NI,
                        T,
                        tConditionP));
            }
        ...
        // Since Gems and Ingots are sometimes mutually exclusive, I made sure that those are always possible Extruder
        // Fodder.
        for (OreDictPrefix tInput : OreDictPrefix.VALUES)
            if (tInput.containsAny(TD.Prefix.EXTRUDER_FODDER, TD.Prefix.INGOT_BASED, TD.Prefix.GEM_BASED)) {
        ...
        // Making sure that simple Stuff like Plastic can still be extruded using Dust even if Dusts are lacking the
        // EXTRUDER_FODDER Tag, since there is absolutely no other way to process these Materials losslessly other than
        // Dust in Extruder.
        // Yes I know this special case is exclusively using the Simple Extruder Shapes not the normal ones. Makes it
        // easier to code on my end, and people who wanna use Dusts will end up having to use the Simple Shapes, but
        // only in the event that Dusts no longer count as general Extruder Fodder for whatever reason at all. ;D
        for (OreDictPrefix tInput : OreDictPrefix.VALUES) if (tInput
            .containsAny(TD.Prefix.EXTRUDER_FODDER, TD.Prefix.INGOT_BASED, TD.Prefix.GEM_BASED, TD.Prefix.DUST_BASED)) {
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    private static ICondition<OreDictMaterial> sExtruderSimple = new And(
        ANTIMATTER.NOT,
        EXTRUDER_SIMPLE,
        EXTRUDER,
        fullforge()), sExtruderNormal = new And(ANTIMATTER.NOT, EXTRUDER_SIMPLE.NOT, EXTRUDER, fullforge());
    ...
    private static void addExtruderRecipe(OreDictPrefix aInput, OreDictPrefix aOutput, boolean aHot, ItemStack aShape) {
        ...
        if (aOutput.mAmount > aInput.mAmount) tInputAmount = UT.Code.divup(aOutput.mAmount, aInput.mAmount);
        else tOutputAmount = aInput.mAmount / aOutput.mAmount;
        if (tInputAmount > 64 || tOutputAmount < 1) return;
        if (tOutputAmount > 64) {
            if (aHot) RM.Extruder.add(
                new RecipeMapHandlerPrefixForging(
                    aInput,
                    tInputAmount,
                    null,
                    0,
                    ...
                    64,
                    aOutput,
                    UT.Code.bindStack(tOutputAmount - 64),
                    aShape,
                    NI,
                    aInput == OP.dust || aInput == OP.ingot || aInput == OP.gem,
                    F,
                    F,
                    sExtruderNormal));
            RM.Extruder.add(
                new RecipeMapHandlerPrefixForging(
                    ...
                    NF,
                    16,
                    UT.Code.units(aOutput.mAmount * tOutputAmount, U, 64, T),
                    0,
                    NF,
                    aOutput,
                    64,
        ...
        if (tOutputAmount > 64) {
            if (aHot) RM.Extruder.add(
                new RecipeMapHandlerPrefixForging(
                    ...
                    F,
                    F,
                    new And(aCondition, sExtruderNormal)));
            RM.Extruder.add(
                new RecipeMapHandlerPrefixForging(
                    aInput,
                    tInputAmount,
                    ...
                    F,
                    F,
                    new And(aCondition, sExtruderSimple)));
        } else {
            if (aHot) RM.Extruder.add(
                new RecipeMapHandlerPrefixForging(
                    aInput,
