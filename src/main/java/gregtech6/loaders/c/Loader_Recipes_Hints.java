    ...
    public void run() {
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                ST.make(
                    ...
                    1,
                    0,
                    "Use a Club to mine Vanilla or Deepslate Redstone Ore for Cinnabar")),
            ST.array(
                IL.Bottle_Mercury.get(1),
                ST.make(OP.ingot.mat(MT.Hg, 1), "Pouring this into Molds only works with additional Cooling!"),
                ST.make(OP.nugget.mat(MT.Hg, 1), "Pouring this into Molds only works with additional Cooling!")),
            null,
            ZL_LONG,
            FL.array(MT.Hg.liquid(1, T)),
            FL.array(MT.Hg.liquid(1, T)),
            0,
            0,
            0);
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                ST.make(Items.skull, 1, 1),
                ST.make(Items.skull, 1, 2),
                ST.make(Items.skull, 1, 3),
                ST.make(Items.skull, 1, 4)),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                OP.dust.mat(MT.Steel, 1),
                OP.ingot.mat(MT.Steel, 1),
                OP.plate.mat(MT.Steel, 1),
                OP.scrapGt.mat(MT.Steel, 1),
                OP.stick.mat(MT.Steel, 1),
                OP.gearGt.mat(MT.Steel, 1)),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                ST.make(aRegistry.getItem(1199), "Heat up the Crucible using a Burning Box")),
            ST.array(
                OP.plate.mat(MT.SteelGalvanized, 1),
                OP.plateCurved.mat(MT.SteelGalvanized, 1),
                OP.stick.mat(MT.SteelGalvanized, 1),
                OP.casingSmall.mat(MT.SteelGalvanized, 1),
                OP.gearGt.mat(MT.SteelGalvanized, 1),
                OP.screw.mat(MT.SteelGalvanized, 1)),
            null,
            ZL_LONG,
            FL.array(MT.Zn.liquid(1, T)),
            FL.array(MT.Zn.liquid(1, T)),
            0,
            0,
            0);
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                NI,
                NI),
            ST.array(ST.book("Manual_Printer", ST.make(Items.written_book, 1, 0))),
            null,
            ZL_LONG,
            FL.array(DYE_FLUIDS_CHEMICAL[DYE_INDEX_Black]),
            ZL_FS,
            0,
            0,
            0);
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(ST.make(Items.enchanted_book, 1, 0, "Get a more compact Enchantment Power Bonus!")),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(ST.make(Items.potionitem, 1, 0, "Ahh, bottled Tap Water!")),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ZL_LONG,
            ZL_FS,
            FL.array(FL.Helium.make(1), FL.Neon.make(1), FL.Argon.make(1)),
            0,
            0,
            0);
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                ST.make(
                    OP.dust.mat(MT.OREMATS.BasalticMineralSand, 9),
                    "Remember Dust Blocks can be crafted into 9 Dust"),
                ST.make(
                    OP.dust.mat(MT.OREMATS.GraniticMineralSand, 9),
                    "Remember Dust Blocks can be crafted into 9 Dust"),
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(IL.Resin.get(1), IL.IC2_Resin.get(1)),
            null,
            ZL_LONG,
            ZL_FS,
            FL.array(FL.Resin_Rubber.make(250)),
            0,
            0,
            0);
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                ST.make(
                    ...
                    1,
                    ToolsGT.HAND_DRILL,
                    "Drill only ONE Hole! Bronze is easiest to make this Tool"),
                ST.make(
                    ToolsGT.sMetaTool,
                    1,
                    ToolsGT.DRILL_LV,
                    "Drill only ONE Hole! Electric might be a bit Late-game"),
                IL.Bag_Sap_Resin.getWithName(1, "Place Sap Bag at the drilled Hole")),
            ZL_IS,
            null,
            ZL_LONG,
            ZL_FS,
            FL.array(FL.Sap_Maple.make(250)),
            0,
            0,
            0);
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                NI,
                NI),
            ST.array(OP.stick.mat(MT.WOODS.Willow, 1), OP.gem.mat(MT.Charcoal, 2), OP.ingot.mat(MT.Charcoal, 2)),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                NI,
                NI),
            ST.array(OP.stick.mat(MT.WOODS.BlueMahoe, 1)),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                NI,
                NI),
            ST.array(IL.Food_Hazelnut.get(1), OP.stick.mat(MT.WOODS.Hazel, 1)),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(OM.dust(MT.Cinnamon), IL.Food_Cinnamon.get(1), IL.HaC_Cinnamon.get(1)),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ST.array(
                ...
                NI,
                NI),
            ST.array(IL.Food_Coconut.get(1)),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        RM.DidYouKnow.addFakeRecipe(
            ...
            ZL_LONG,
            ZL_FS,
            FL.array(FL.Sap_Rainbow.make(250)),
            0,
            0,
            0);
        ...
        for (SaplingEntry tTree : WoodDictionary.LIST_SAPLINGS) {
            RM.Trees.addFakeRecipe(
                F,
                ST.array(
                    ST.amount(tTree.mCount, tTree.mSapling),
                    tTree.mLeafEntry == null ? NI : tTree.mLeafEntry.mLeaf,
                    tTree.mBaggedSaplingLoot ? IL.Bag_Loot_Sapling.getWithName(1, "Is in its Drop Table") : NI),
                tTree.mWoodEntry == null ? tTree.mLeafEntry == null ? ZL_IS : ST.array(tTree.mLeafEntry.mLeaf)
                    : ST.array(
                        tTree.mLeafEntry == null ? NI : tTree.mLeafEntry.mLeaf,
                        ...
                        tTree.mWoodEntry.mPlankEntry == null ? NI
                            : ST.validMeta_(
                                tTree.mWoodEntry.mPlankEntry.mStickCountLathe,
                                tTree.mWoodEntry.mPlankEntry.mStick),
                        tTree.mWoodEntry.mBeamEntry == null ? NI
                            : ST.validMeta_(
                                tTree.mWoodEntry.mBeamEntry.mStickCountLathe,
                                tTree.mWoodEntry.mBeamEntry.mStick),
                        tTree.mWoodEntry.mPlankEntry == null ? NI
                            : OP.crateGt64Plate.mat(tTree.mWoodEntry.mPlankEntry.mMaterialPlank, 1),
                        OM.dust(tTree.mWoodEntry.mMaterialWood.mTargetPulver, tTree.mWoodEntry.mPlankCountBuzz + 2, 1),
                        tTree.mWoodEntry.mBark,
                        tTree.mWoodEntry.mCharcoalCount <= 0 ? NI
                            : OP.gem.mat(MT.Charcoal, tTree.mWoodEntry.mCharcoalCount)),
                null,
                null,
                null,
                null,
