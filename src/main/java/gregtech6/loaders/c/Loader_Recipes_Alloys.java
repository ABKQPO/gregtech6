...
public class Loader_Recipes_Alloys implements Runnable {
    ...
    public void run() {
        ...
        for (String tIron : new String[] { "molten.iron", "molten.wroughtiron", "molten.pigiron",
            "molten.meteoriciron" }) {
            ...
            mix(
                ...
                "molten.manganese",
                4,
                "molten.stainlesssteel",
                36);
            mix(tIron, 1, "molten.nikolite", 8, "molten.electrotinealloy", 1);
        }
        for (String tSteel : new String[] { "molten.steel", "molten.meteoricsteel", "molten hsla",
            "molten.knightmetal" }) {
        ...
        for (OreDictMaterial tMat : ANY.Glowstone.mToThis) {
            mix(
                ...
                "molten.silver",
                1,
                "molten." + tMat.mNameInternal.toLowerCase(),
                4,
                "molten.lumium",
                4);
        }
