...
public class Loader_Recipes_OreDict extends OreDictListenerEvent_Names {
    ...
    public void addAllListeners() {
        addListener(
            new Object[] { OP.dust.dat(MT.Glass), OP.dust.dat(MT.Sand), OP.dust.dat(MT.RedSand),
                OP.dust.dat(MT.EndSandWhite), OP.dust.dat(MT.EndSandBlack) },
        ...
        addListener(
            new Object[] { OP.blockDust.dat(MT.Glass), OP.blockDust.dat(MT.Sand), OP.blockDust.dat(MT.RedSand),
                OP.blockDust.dat(MT.EndSandWhite), OP.blockDust.dat(MT.EndSandBlack) },
            new IOreDictListenerEvent() {
        ...
        addListener(OP.blockDust.dat(MT.Concrete), new IOreDictListenerEvent() {
            ...
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                RM.add_smelting(
                    aEvent.mStack,
                    ST.make(MD.CHSL, "concrete", 1, 0, ST.make(Blocks.stone, 1, 0)),
                    F,
                    F,
                    F);
            }
        ...
        addListener(OP.blockSolid.dat(MT.Obsidian), new IOreDictListenerEvent() {
            ...
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                RM.Hammer.addRecipe1(
                    ...
                    64,
                    aEvent.mStack,
                    IL.RC_Crushed_Obsidian.get(1, IL.HBM_Crushed_Obsidian.get(1, OP.dust.mat(MT.Obsidian, 8))));
        ...
        addListener(OD.craftingFur, new IOreDictListenerEvent() {

            @Override
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                RM.Slicer
                    .addRecipe2(T, 16, 16, aEvent.mStack, IL.Shape_Slicer_Flat.get(0), ST.make(Items.leather, 1, 0)); // shave
                                                                                                                      // off
                                                                                                                      // the
                                                                                                                      // Fur
            }
            ...
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                ...
                RM.Loom.addRecipeX(
                    ...
                    ST.array(
                        ST.tag(3),
                        aEvent.mStack,
                        ST.make((Item) OP.plantGtFiber.mRegisteredPrefixItems.get(0), 4, W)),
                    ST.make(Items.lead, 2, 0));
                RM.Loom.addRecipeX(
                    T,
                    16,
                    16,
                    ST.array(ST.tag(3), aEvent.mStack, ST.make(Items.string, 4, W)),
                    ST.make(Items.lead, 2, 0));
            }
        });
        addListener(OD.slimeball, new IOreDictListenerEvent() {
            ...
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                ...
                if (MD.TiC.owns(aEvent.mStack) || OD.slimeballSwet.is_(aEvent.mStack)
                    || OD.slimeballPink.is_(aEvent.mStack)
                    || OD.slimeballRice.is_(aEvent.mStack)
                    || OD.slimeballBorax.is_(aEvent.mStack)
                    || OD.slimeballAnimal.is_(aEvent.mStack)) return;
                ...
                RM.Drying.addRecipe1(
                    ...
                    NF,
                    FL.DistW.make(50),
                    ST.make(MD.SC2, "ItemSlimeRubber", 1, 0));
            }
        });
        addListener(OD.slimeballBlue, new IOreDictListenerEvent() {
        ...
        addListener(OD.slimeballAnimal, new IOreDictListenerEvent() {
        ...
        addListener(OD.record, new IOreDictListenerEvent() {
            ...
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                if (!BooksGT.BOOK_REGISTER.containsKey(aEvent.mStack, T))
                    BooksGT.BOOK_REGISTER.put(aEvent.mStack, (byte) 30);
            }
        });
        ...
        addListener(OD.logRubber, new IOreDictListenerEvent() {
            ...
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                ...
                if (FL.Resin_Rubber.exists()) RM.Squeezer.addRecipe1(
                    T,
                    16,
                    64,
                    5000,
        ...
        addListener(OD.logWood, OD.logRubber, new IOreDictListenerEvent() {
            ...
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                ...
                if (IL.MaCu_Polished_Logs.exists()) {
                    RM.Bath
                        .addRecipe1(T, 0, 144, aEvent.mStack, FL.Oil_Fish.make(3000), NF, IL.MaCu_Polished_Logs.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        144,
                        aEvent.mStack,
                        FL.Oil_Whale.make(1500),
                        NF,
                ...
                RM.CokeOven
                    .addRecipe1(T, 0, 3600, aEvent.mStack, NF, FL.Oil_Creosote.make(200), OP.gem.mat(MT.Charcoal, 1));
                ...
                if (ST.meta_(aEvent.mStack) == W) {
                    ...
                    for (int i = 0; i < W; i++) {
                        ...
                        RM.sawing(
                            ...
                            F,
                            5,
                            ST.make(ST.item_(aEvent.mStack), 1, i),
                            ST.copy(tPlanks),
                            dust.mat(tWood, 1),
                            OM.dust(MT.Bark, U2));
                        CR.remove(ST.make(ST.item_(aEvent.mStack), 1, i));
                        CR.shaped(
                            ST.amount(NERFED_WOOD ? tPlank.stackSize : (tPlank.stackSize * 5) / 4, tPlank),
                            CR.DEF_NCC | CR.ONLY_IF_HAS_RESULT,
                            "s",
                            "L",
                            'L',
                            ST.make(ST.item_(aEvent.mStack), 1, i));
                        CR.shapeless(
                            ST.amount(tPlank.stackSize / (NERFED_WOOD ? 2 : 1), tPlank),
                            CR.DEF_NCC | CR.ONLY_IF_HAS_RESULT,
                            new Object[] { ST.make(ST.item_(aEvent.mStack), 1, i) });
                    }
                } else {
        ...
        addListener(OD.plankSkyroot, OD.plankWeedwood, OD.plankWood, new IOreDictListenerEvent() {
            ...
            public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                ...
                RM.Assembler.addRecipe2(
                    ...
                    64,
                    ST.amount(8, aEvent.mStack),
                    gem.mat(MT.Diamond, 1),
                    ST.make(Blocks.jukebox, 1, 0));
                // RM.Assembler.addRecipe2(T, 16, 32, aEvent.mStack, screw.mat(MT.Fe, 1), IL.Crate_Empty.get(1));
                // RM.Assembler.addRecipe2(T, 16, 32, aEvent.mStack, screw.mat(MT.WroughtIron, 1),
                // IL.Crate_Empty.get(1));
                ...
                RM.Assembler.addRecipe2(
                    ...
                    ST.tag(2),
                    ST.make(Blocks.wooden_pressure_plate, 1, 0));
                RM.Assembler
                    .addRecipe2(T, 16, 48, ST.amount(3, aEvent.mStack), ST.tag(3), ST.make(Blocks.trapdoor, 1, 0));
                RM.Assembler.addRecipe2(
                    T,
                    16,
                    64,
                    ...
                    ST.tag(4),
                    ST.make(Blocks.crafting_table, 1, 0));
                RM.Assembler
                    .addRecipe2(T, 16, 96, ST.amount(2, aEvent.mStack), ST.tag(6), ST.make(Items.wooden_door, 1, 0));
                RM.Assembler
                    .addRecipe2(T, 16, 128, ST.amount(8, aEvent.mStack), ST.tag(8), ST.make(Blocks.chest, 1, 0));
                RM.Assembler.addRecipe2(
                    T,
                    16,
                    64,
