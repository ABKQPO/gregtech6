...
public class Loader_Recipes_Vanilla implements Runnable {
    ...
    public void run() {
        ...
        CR.remove(
            ST.make(Blocks.cobblestone, 1, 0),
            ST.make(Items.quartz, 1, 0),
            NI,
            ST.make(Items.quartz, 1, 0),
            ST.make(Blocks.cobblestone, 1, 0));
        ...
        CR.shapeless(
            ST.make(Items.book, 1, 0),
            DEF,
            new Object[] { OD.craftingLeather, OD.paperEmpty, OD.paperEmpty, OD.paperEmpty });

        CR.shaped(
            ST.make(Blocks.furnace, 1, 0),
            DEF_NCC,
            "XXX",
            "XFX",
            "XXX",
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.disabledrecipes, "enchantmenttable", F)) {
            OUT.println(
                "GT_Mod: Removing the Recipe of the Enchantment Table, to have Fun enchanting with the Anvil and Books from Dungeons.");
        } else {
            CR.shaped(
                ST.make(Blocks.enchanting_table, 1, 0),
                CR.DEF_NCC,
                " B ",
                "DOD",
                "OOO",
                'B',
                IL.TC_Thaumonomicon.get(1, ST.make(Items.book, 1, W)),
                'O',
                blockSolid.dat(MT.Obsidian),
                'D',
                gem.dat(ANY.Diamond));
        }
        ...
        CR.shaped(
            ...
            DEF | DEL_OTHER_SHAPED_RECIPES,
            "XhX",
            " Y ",
            'Y',
            plate.dat(ANY.Fe),
            'X',
            plateCurved.dat(ANY.Fe));
        if (!ConfigsGT.RECIPES.get(ConfigCategories.Recipes.recipereplacements, "Iron.Bucket", T)) CR
            .shaped(ST.make(Items.bucket, 1, 0), DEF | DEL_OTHER_SHAPED_RECIPES, "X X", " X ", 'X', ingot.dat(ANY.Fe));

        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.recipereplacements, "Iron.Anvil", T)) {
            CR.shaped(
                ST.make(Blocks.anvil, 1, 0),
                DEF | DEL_OTHER_SHAPED_RECIPES,
                "BBB",
                " Ih",
                "III",
                'B',
                blockIngot.dat(ANY.Fe),
                'I',
                ingot.dat(ANY.Fe));
        } else {
            CR.shaped(
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.recipereplacements, "Iron.Compass", T)) {
            CR.shaped(
                ST.make(Items.compass, 1, 0),
                DEF | DEL_OTHER_SHAPED_RECIPES | ONLY_IF_HAS_OTHER_RECIPES,
                "sSR",
                "CIC",
                "dPh",
                'P',
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.recipereplacements, "Iron.Hopper", T)) if (null
            != (tStack = CR.remove(tMat, null, tMat, tMat, ST.make(Blocks.chest, 1, 0), tMat, null, tMat, null))) {
                CR.shaped(
                    tStack,
                    DEF | DEL_OTHER_SHAPED_RECIPES,
                    "XwX",
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.recipereplacements, "Gold.Clock", T)) {
            CR.shaped(
                ...
                OD.itemRedstone,
                'C',
                plateCurved.dat(MT.Au),
                'Q',
                OD.craftingQuartz,
                'G',
                gearGtSmall.dat(MT.Au));
        } else {
            CR.shaped(
                ST.make(Items.clock, 1, 0),
                DEF | DEL_OTHER_SHAPED_RECIPES | ONLY_IF_HAS_OTHER_RECIPES,
        ...
        CR.shapeless(
            stick.mat(MT.IronMagnetic, 1),
            DEF,
            new Object[] { stick.dat(ANY.Fe), OD.itemRedstone, OD.itemRedstone, OD.itemRedstone, OD.itemRedstone });
        CR.shapeless(
            stickLong.mat(MT.IronMagnetic, 1),
            DEF,
            new Object[] { stickLong.dat(ANY.Fe), OD.itemRedstone, OD.itemRedstone, OD.itemRedstone, OD.itemRedstone,
                OD.itemRedstone, OD.itemRedstone, OD.itemRedstone, OD.itemRedstone });

        CR.shaped(IL.Dye_Bonemeal.get(1), DEF, "h", "X", 'X', Items.bone);
        CR.shaped(IL.Dye_Bonemeal.get(2), DEF, "h", "X", 'X', IL.WiMo_Thick_Bone);

        // Making sure Nether Quartz Blocks cannot be made using OreDict Nether Quartz to ensure Compat with Mods that
        // have different Quartzes.
        CR.remove(
            ST.make(Items.quartz, 1, 0),
            ST.make(Items.quartz, 1, 0),
            NI,
        ...
        // Making sure Glowstone Blocks cannot be made using OreDict Glowstone to ensure Compat with Mods that have
        // different Glowstones.
        CR.remove(
            ST.make(Items.glowstone_dust, 1, 0),
            ST.make(Items.glowstone_dust, 1, 0),
            NI,
            ST.make(Items.glowstone_dust, 1, 0),
            ST.make(Items.glowstone_dust, 1, 0));
        ...
        CR.shapeless(
            ST.make(Blocks.double_stone_slab, 1, 8),
            DEF,
            new Object[] { ST.make(Blocks.double_stone_slab, 1, 0) });
        CR.shapeless(
            ST.make(Blocks.double_stone_slab, 1, 0),
            DEF,
            new Object[] { ST.make(Blocks.double_stone_slab, 1, 8) });
        ...
        for (int i = 0; i < tItems.length; i++) if (tItems[i].exists()) {
            ...
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.disabledrecipes, "torchesFromCoal", F)) {
                ...
                CR.shaped(
                    ...
                    tSticks[i],
                    'X',
                    crushedCentrifuged.dat(MT.LigniteCoke));
        ...
        for (OreDictMaterial tCoal : new OreDictMaterial[] { MT.CoalCoke, MT.Lignite, MT.LigniteCoke, MT.PetCoke,
            MT.Anthracite, MT.Prismane, MT.Lonsdaleite }) {
        ...
        CR.shapeless(
            plateDouble.mat(MT.Paper, 2),
            DEF,
            new Object[] { OD.paperEmpty, OD.paperEmpty, OD.paperEmpty, OD.paperEmpty, OD.itemGlue });
        CR.shapeless(
            plateDouble.mat(MT.Paper, 3),
            DEF,
            new Object[] { OD.paperEmpty, OD.paperEmpty, OD.paperEmpty, OD.paperEmpty, OD.paperEmpty, OD.paperEmpty,
                OD.itemGlue });
        CR.shapeless(
            plateDouble.mat(MT.Paper, 4),
            DEF,
            new Object[] { OD.paperEmpty, OD.paperEmpty, OD.paperEmpty, OD.paperEmpty, OD.paperEmpty, OD.paperEmpty,
                OD.paperEmpty, OD.paperEmpty, OD.itemGlue });
        ...
        CR.shaped(
            ...
            OD.stickAnyWood,
            'D',
            gemFlawed.dat(MT.Redstone));
        CR.shaped(
            ST.make(Blocks.redstone_torch, 2, 0),
            DEF,
            "D",
            "W",
            "W",
        ...
        CR.shaped(
            ...
            plate.dat(ANY.Stone));
        CR.shaped(
            ST.make(Blocks.daylight_detector, 1, 0),
            DEF,
            "GGG",
            "QQQ",
            "PPP",
        ...
        CR.shaped(
            ST.make(Blocks.tnt, 1, 0),
            DEF,
            "GSG",
            "SGS",
            "GSG",
            'G',
            dust.dat(MT.Gunpowder),
            'S',
            dust.dat(ANY.SiO2));
        CR.shaped(
            ST.make(Blocks.tnt, 9, 0),
            DEF,
            "GSG",
            "SGS",
            "GSG",
            'G',
            blockDust.dat(MT.Gunpowder),
            'S',
            blockDust.dat(ANY.SiO2));

        CR.shaped(
            ST.make(Items.minecart, 1, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            " h ",
            "PwP",
            "WPW",
            ...
            plate.dat(ANY.Iron),
            'W',
            minecartWheels.dat(ANY.Iron));

        CR.shaped(
            ST.make(Items.chest_minecart, 1, 0),
            DEF_REV | DEL_OTHER_SHAPED_RECIPES,
            "X",
            "C",
            'C',
            Items.minecart,
            ...
            Blocks.chest);
        CR.shaped(
            ST.make(Items.furnace_minecart, 1, 0),
            DEF_REV | DEL_OTHER_SHAPED_RECIPES,
            "X",
            "C",
            'C',
            ...
            OD.craftingFurnace);
        CR.shaped(
            ST.make(Items.hopper_minecart, 1, 0),
            DEF_REV | DEL_OTHER_SHAPED_RECIPES,
            "X",
            "C",
            'C',
            ...
            Blocks.hopper);
        CR.shaped(
            ST.make(Items.tnt_minecart, 1, 0),
            DEF_REV | DEL_OTHER_SHAPED_RECIPES,
            "X",
            "C",
            'C',
        ...
        for (int i = 1; i < 16; i++) CR.shapeless(
            ST.make(Blocks.wool, 1, i),
            DEF,
            new Object[] { ST.make(Blocks.wool, 1, 0), DYE_OREDICTS[15 - i] });
        ...
        CR.shapeless(
            ST.make(Items.arrow, 2, 0),
            DEF_NCC,
            new Object[] { OD.itemFlint, arrowGtWood.dat(MT.Empty), arrowGtWood.dat(MT.Empty) });
        CR.shapeless(
            ST.make(Items.arrow, 3, 0),
            DEF_NCC,
            new Object[] { OD.itemFlint, arrowGtWood.dat(MT.Empty), arrowGtWood.dat(MT.Empty),
                arrowGtWood.dat(MT.Empty) });
        CR.shapeless(
            ST.make(Items.arrow, 4, 0),
            DEF_NCC,
            new Object[] { OD.itemFlint, arrowGtWood.dat(MT.Empty), arrowGtWood.dat(MT.Empty),
                arrowGtWood.dat(MT.Empty), arrowGtWood.dat(MT.Empty) });
        CR.shapeless(arrowGtWood.mat(MT.Empty, 1), DEF_NCC, new Object[] { Items.arrow });

        CR.shaped(
            arrowGtWood.mat(MT.Empty, 1),
            CR.DEF_NCC_MIR,
            " S",
            "F ",
            'S',
            ...
            OD.craftingFeather);
        CR.shaped(
            arrowGtPlastic.mat(MT.Empty, 1),
            CR.DEF_NCC_MIR,
            " S",
            "F ",
            'S',
            stick.dat(ANY.Plastic),
            'F',
            OD.craftingFeather);
        CR.shaped(
            arrowGtWood.mat(MT.Empty, 1),
        ...
        CR.shaped(
            ST.make(Blocks.stained_glass, 8, 0),
            DEF,
            "GGG",
            "GDG",
            "GGG",
            ...
            DYE_OREDICTS[15]);
        CR.shaped(
            ST.make(Items.speckled_melon, 1, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            "GGG",
            "GMG",
            "GGG",
        ...
        CR.remove(
            ST.make(Items.dye, 1, 1),
            ST.make(Items.dye, 1, 1),
            ST.make(Items.dye, 1, 4),
            ST.make(Items.dye, 1, 15));

        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_Purple),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Red], DYE_OREDICTS_MIXABLE[DYE_INDEX_Blue] });
        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_Cyan),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Green], DYE_OREDICTS_MIXABLE[DYE_INDEX_Blue] });
        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_Pink),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Red], DYE_OREDICTS_MIXABLE[DYE_INDEX_White] });
        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_Lime),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Green], DYE_OREDICTS_MIXABLE[DYE_INDEX_White] });
        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_LightBlue),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Blue], DYE_OREDICTS_MIXABLE[DYE_INDEX_White] });
        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_Magenta),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Purple], DYE_OREDICTS_MIXABLE[DYE_INDEX_Pink] });
        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_Orange),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Red], DYE_OREDICTS_MIXABLE[DYE_INDEX_Yellow] });
        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_Gray),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Black], DYE_OREDICTS_MIXABLE[DYE_INDEX_White] });
        CR.shapeless(
            ST.make(Items.dye, 2, DYE_INDEX_LightGray),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Gray], DYE_OREDICTS_MIXABLE[DYE_INDEX_White] });
        CR.shapeless(
            ST.make(Items.dye, 3, DYE_INDEX_LightGray),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Black], DYE_OREDICTS_MIXABLE[DYE_INDEX_White],
                DYE_OREDICTS_MIXABLE[DYE_INDEX_White] });
        CR.shapeless(
            ST.make(Items.dye, 3, DYE_INDEX_Magenta),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Blue], DYE_OREDICTS_MIXABLE[DYE_INDEX_Red],
                DYE_OREDICTS_MIXABLE[DYE_INDEX_Pink] });
        CR.shapeless(
            ST.make(Items.dye, 4, DYE_INDEX_Magenta),
            DEF,
            new Object[] { DYE_OREDICTS_MIXABLE[DYE_INDEX_Blue], DYE_OREDICTS_MIXABLE[DYE_INDEX_Red],
                DYE_OREDICTS_MIXABLE[DYE_INDEX_Red], DYE_OREDICTS_MIXABLE[DYE_INDEX_White] });
        ...
        RM.Sharpening.addRecipe1(
            T,
            16,
            64,
            ST.make(Items.flint, 1, W),
            toolHeadArrow.mat(MT.Flint, 8),
            dustTiny.mat(MT.Flint, 1));
        RM.Sharpening.addRecipe1(T, 16, 64, ST.make(Blocks.glass_pane, 1, W), lens.mat(MT.Glass, 1));

        RM.Lathe
            .addRecipe1(T, 16, 16, ST.make(Blocks.glass_pane, 1, W), lens.mat(MT.Glass, 1), dustSmall.mat(MT.Glass, 1));
        ...
        RM.Extruder.addRecipe2(
            ...
            16,
            32,
            IL.Module_Stone_Generator.get(0),
            dust.mat(MT.Redstone, 1),
            ST.make(Blocks.obsidian, 1, 0));
        ...
        RM.smash(
            IL.Module_Basalt_Generator.get(0),
            IL.NeLi_Basalt.get(1, IL.NePl_Basalt.get(1, ST.make(BlocksGT.Basalt, 1, BlockStones.COBBL))));
        RM.smash(
            IL.Module_Blackstone_Generator.get(0),
            IL.NeLi_Blackstone.get(1, IL.NePl_Blackstone.get(1, ST.make(BlocksGT.Basalt, 1, BlockStones.COBBL))));
        ...
        RM.Crusher.addRecipe1(
            T,
            16,
            64,
            new long[] { 10000, 9000, 8000, 7000 },
            ST.make(Blocks.brick_block, 1, W),
            ST.make(Items.brick, 1, 0),
            ST.make(Items.brick, 1, 0),
            ST.make(Items.brick, 1, 0),
            ST.make(Items.brick, 1, 0));
        RM.Crusher.addRecipe1(
            ...
            64,
            new long[] { 10000, 9000, 8000, 7000 },
            ST.make(Blocks.double_stone_slab, 1, 4),
            ST.make(Items.brick, 1, 0),
            ST.make(Items.brick, 1, 0),
            ST.make(Items.brick, 1, 0),
            ST.make(Items.brick, 1, 0));
        RM.Crusher.addRecipe1(
            ...
            16,
            64,
            new long[] { 10000, 9000, 8000 },
            ST.make(Blocks.brick_stairs, 1, W),
            ST.make(Items.brick, 1, 0),
            ST.make(Items.brick, 1, 0),
            ST.make(Items.brick, 1, 0));
        RM.Crusher.addRecipe1(
        ...
        RM.Crusher.addRecipe1(
            ...
            64,
            new long[] { 10000, 9000, 8000, 7000 },
            ST.make(Blocks.nether_brick, 1, W),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0));
        RM.Crusher.addRecipe1(
            ...
            64,
            new long[] { 10000, 9000, 8000, 7000 },
            ST.make(Blocks.double_stone_slab, 1, 6),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0));
        RM.Crusher.addRecipe1(
            ...
            64,
            new long[] { 10000, 9000, 8000 },
            ST.make(Blocks.nether_brick_stairs, 1, W),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0));
        RM.Crusher.addRecipe1(
            ...
            64,
            new long[] { 10000, 9000, 8000 },
            ST.make(Blocks.nether_brick_fence, 1, W),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0),
            ST.make(Items.netherbrick, 1, 0));
        RM.Crusher.addRecipe1(
        ...
        RM.sawing(16, 16, F, 100, IL.Module_Basalt_Generator.get(0), ST.make(Blocks.stone_slab, 1, 0)); // TODO Basalt
                                                                                                        // Slabs
        RM.sawing(16, 16, F, 100, IL.Module_Blackstone_Generator.get(0), ST.make(Blocks.stone_slab, 1, 0)); // TODO
                                                                                                            // Blackstone
                                                                                                            // Slabs
        ...
        RM.sawing(
            ...
            F,
            100,
            ST.make(Blocks.fence_gate, 1, W),
            IL.Plank.get(2),
            OM.dust(MT.Wood, stick.mAmount * 4));
        ...
        RM.sawing(
            ...
            F,
            100,
            ST.make(Blocks.trapped_chest, 1, W),
            IL.Plank.get(8),
            ST.make(Blocks.tripwire_hook, 1, 0));
        ...
        RM.sawing(
            ...
            T,
            50,
            ST.make(Blocks.melon_block, 1, W),
            ST.make(Items.melon, 8, 0),
        ...
        RM.Slicer.addRecipe2(
            ...
            16,
            16,
            ST.make(Items.leather_helmet, 1, W),
        ...
        RM.Slicer.addRecipe2(
            ...
            16,
            16,
            ST.make(Items.leather_chestplate, 1, W),
            IL.Shape_Slicer_Split.get(0),
            ST.make(Items.leather, 2, 0));
        RM.Slicer.addRecipe2(
            T,
            16,
            16,
            ST.make(Items.leather_leggings, 1, W),
            IL.Shape_Slicer_Split.get(0),
            ST.make(Items.leather, 2, 0));
        RM.Slicer.addRecipe2(
            T,
            16,
            16,
            ST.make(Items.leather_boots, 1, W),
            IL.Shape_Slicer_Split.get(0),
            ST.make(Items.leather, 1, 0));
        RM.Slicer.addRecipe2(
            T,
        ...
        for (FluidStack tWater : FL.waters(250)) {
            long tMul = FL.SpDew.is(tWater) ? 4 : 1;
        ...
        for (byte i = 0; i < 16; i++) {
            RM.Shredder.addRecipe1(
                T,
                16,
                16,
                9000,
                ST.make(Blocks.wool, 1, i),
                i == 0 ? ST.make(Items.string, 4, 0) : plantGtFiber.mat(MT.DATA.Dye_Materials[15 - i], 4));
            CR.shaped(
                ST.make(Blocks.wool, 1, i),
                DEF,
                "XX",
                "XX",
                'X',
                plantGtFiber.dat(MT.DATA.Dye_Materials[15 - i]));
            ...
            if (i != DYE_INDEX_White) {
                ...
                RM.Bath.addRecipe1(
                    ...
                    0,
                    16,
                    ST.make(Blocks.carpet, 1, 15 - i),
                    MT.Cl.fluid(U40, T),
                    NF,
                    ST.make(Blocks.carpet, 1, 0));
            }
            ...
            RM.Loom.addRecipe2(
                ...
                16,
                ST.tag(0),
                plantGtFiber.mat(MT.DATA.Dye_Materials[15 - i], 4),
                ST.make(Blocks.wool, 1, i));
        }
        ...
        RM.Bath.addRecipe1(
            ...
            0,
            16,
            ST.make(Blocks.stained_hardened_clay, 1, W),
            MT.Cl.fluid(U20, T),
            NF,
            ST.make(Blocks.hardened_clay, 1, 0));
        RM.Bath.addRecipe1(
        ...
        RM.Bath.addRecipe1(
            ...
            0,
            16,
            ST.make(Blocks.stained_glass_pane, 1, W),
            MT.Cl.fluid(U50, T),
            NF,
            ST.make(Blocks.glass_pane, 1, 0));
        ...
        RM.Loom.addRecipe2(
            ...
            16,
            ST.tag(0),
            plantGtFiber.mat(MT.Cu, 4),
            ST.make(Blocks.wool, 1, 1, "ORANGE WOOOOOOL!!!"));
        ...
        for (OreDictMaterial tMat2 : ANY.Iron.mToThis) RM.Loom.addRecipe2(
            T,
            64,
            128,
            ST.make(Items.leather, 6, W),
            (tMat2 == MT.Enori ? plateGem : plate).mat(tMat2, 8),
            ST.make(Items.iron_horse_armor, 1, 0));
        RM.Loom.addRecipe2(
            T,
            64,
            128,
            ST.make(Items.leather, 6, W),
            plate.mat(MT.Au, 8),
            ST.make(Items.golden_horse_armor, 1, 0));
        RM.Loom.addRecipe2(
            T,
            64,
            128,
            ST.make(Items.leather, 6, W),
            plateGem.mat(MT.Diamond, 8),
            ST.make(Items.diamond_horse_armor, 1, 0));
        for (OreDictMaterial tMat2 : ANY.Steel.mToThis) RM.Loom.addRecipeX(
            T,
            64,
            128,
            ST.array(ST.make(Items.leather, 6, W), ring.mat(tMat2, 2), stick.mat(tMat2, 3)),
            ST.make(Items.saddle, 1, 0));

        RM.Loom.addRecipe2(T, 16, 128, ST.tag(4), ST.make(Items.leather, 5, W), ST.make(Items.leather_helmet, 1, 0));
        RM.Loom
            .addRecipe2(T, 16, 128, ST.tag(5), ST.make(Items.leather, 8, W), ST.make(Items.leather_chestplate, 1, 0));
        ...
        for (OreDictMaterial tMat2 : ANY.Glowstone.mToThis) {
            RM.Press.addRecipeX(
                ...
                16,
                144,
                ST.array(ST.tag(1), blockDust.mat(MT.Redstone, 4), blockDust.mat(tMat2, 4)),
                ST.make(Blocks.redstone_lamp, 9, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 4), dust.mat(tMat2, 4)),
                ST.make(Blocks.redstone_lamp, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 16), dust.mat(tMat2, 4)),
                ST.make(Blocks.redstone_lamp, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 36), dust.mat(tMat2, 4)),
                ST.make(Blocks.redstone_lamp, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 4), dustSmall.mat(tMat2, 16)),
                ST.make(Blocks.redstone_lamp, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 16), dustSmall.mat(tMat2, 16)),
                ST.make(Blocks.redstone_lamp, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 36), dustSmall.mat(tMat2, 16)),
                ST.make(Blocks.redstone_lamp, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 4), dustTiny.mat(tMat2, 36)),
                ST.make(Blocks.redstone_lamp, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 16), dustTiny.mat(tMat2, 36)),
                ST.make(Blocks.redstone_lamp, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Redstone, 36), dustTiny.mat(tMat2, 36)),
                ST.make(Blocks.redstone_lamp, 1, 0));
        }
        for (OreDictMaterial tMat2 : ANY.SiO2.mToThis) {
            RM.Press.addRecipeX(
                ...
                16,
                144,
                ST.array(ST.tag(1), blockDust.mat(MT.Gunpowder, 4), blockDust.mat(tMat2, 4)),
                ST.make(Blocks.tnt, 9, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Gunpowder, 4), dust.mat(tMat2, 4)),
                ST.make(Blocks.tnt, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dustSmall.mat(MT.Gunpowder, 16), dust.mat(tMat2, 4)),
                ST.make(Blocks.tnt, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dustTiny.mat(MT.Gunpowder, 36), dust.mat(tMat2, 4)),
                ST.make(Blocks.tnt, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Gunpowder, 4), dustSmall.mat(tMat2, 16)),
                ST.make(Blocks.tnt, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dustSmall.mat(MT.Gunpowder, 16), dustSmall.mat(tMat2, 16)),
                ST.make(Blocks.tnt, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dustTiny.mat(MT.Gunpowder, 36), dustSmall.mat(tMat2, 16)),
                ST.make(Blocks.tnt, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dust.mat(MT.Gunpowder, 4), dustTiny.mat(tMat2, 36)),
                ST.make(Blocks.tnt, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dustSmall.mat(MT.Gunpowder, 16), dustTiny.mat(tMat2, 36)),
                ST.make(Blocks.tnt, 1, 0));
            RM.Press.addRecipeX(
                T,
                16,
                16,
                ST.array(ST.tag(1), dustTiny.mat(MT.Gunpowder, 36), dustTiny.mat(tMat2, 36)),
                ST.make(Blocks.tnt, 1, 0));
        }
        ...
        RM.Squeezer.addRecipe1(
            ...
            ST.make(Blocks.melon_block, 1, W),
            NF,
            FL.Juice_Melon.make(2250),
            IL.Remains_Fruit.get(9));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            2000,
            ST.make(Blocks.red_flower, 1, 0),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Red], 2),
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            2000,
            ST.make(Blocks.red_flower, 1, 1),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_LightBlue], 2),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            2000,
            ST.make(Blocks.red_flower, 1, 2),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Magenta], 2),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            2000,
            ST.make(Blocks.red_flower, 1, 3),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_LightGray], 2),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            2000,
            ST.make(Blocks.red_flower, 1, 5),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Orange], 2),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            2000,
            ST.make(Blocks.red_flower, 1, 7),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Pink], 2),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            2000,
            ST.make(Blocks.yellow_flower, 1, 0),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Yellow], 2),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            4000,
            ST.make(Blocks.double_plant, 1, 1),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Magenta], 3),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            4000,
            ST.make(Blocks.double_plant, 1, 4),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Red], 3),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            4000,
            ST.make(Blocks.double_plant, 1, 5),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Pink], 3),
            IL.Remains_Plant.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            10000,
            ST.make(Blocks.double_plant, 1, 0),
            NF,
            FL.Oil_Sunflower.make(100),
            ST.make(Items.dye, 2, DYE_INDEX_Yellow));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            7000,
            ST.make(Blocks.cactus, 1, W),
            NF,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            4000,
            ST.make(Items.reeds, 1, W),
            NF,
            FL.Juice_Reed.make(100),
            IL.Remains_Plant.get(1));
        ...
        RM.Squeezer
            .addRecipe1(T, 16, 16, 10000, ST.make(Blocks.red_mushroom, 1, W), NF, FL.Potion_Poison_1.make(250), NI);
        RM.Squeezer
            .addRecipe1(T, 16, 16, 10000, ST.make(Items.poisonous_potato, 1, W), NF, FL.Potion_Poison_1.make(250), NI);
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
        ...
        RM.Squeezer.addRecipe1(
            ...
            NF,
            FL.make("potion.idunsapplejuice", 250),
            OM.dust(MT.Au, U * 18));
        RM.Squeezer.addRecipe1(
            T,
            16,
            ...
            NF,
            FL.make("potion.goldenapplejuice", 250),
            OM.dust(MT.Au, U * 2));
        RM.Squeezer.addRecipe1(
            T,
            16,
            128,
            10000,
            ST.make(Items.golden_carrot, 1, 0),
            NF,
            FL.make("goldencarrotjuice", 250),
            OM.dust(MT.Au, 2 * U9));
        ...
        RM.Juicer.addRecipe1(
            ...
            ST.make(Blocks.red_flower, 1, 0),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Red], 1),
            IL.Remains_Plant.get(1));
        RM.Juicer.addRecipe1(
            T,
            16,
            ...
            ST.make(Blocks.red_flower, 1, 1),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_LightBlue], 1),
            IL.Remains_Plant.get(1));
        RM.Juicer.addRecipe1(
            T,
            16,
            ...
            ST.make(Blocks.red_flower, 1, 2),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Magenta], 1),
            IL.Remains_Plant.get(1));
        RM.Juicer.addRecipe1(
            T,
            16,
            ...
            ST.make(Blocks.red_flower, 1, 3),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_LightGray], 1),
            IL.Remains_Plant.get(1));
        RM.Juicer.addRecipe1(
            T,
            16,
        ...
        RM.Juicer.addRecipe1(
            ...
            ST.make(Blocks.red_flower, 1, 5),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Orange], 1),
            IL.Remains_Plant.get(1));
        RM.Juicer.addRecipe1(
            T,
            16,
        ...
        RM.Juicer.addRecipe1(
            ...
            ST.make(Blocks.red_flower, 1, 7),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Pink], 1),
            IL.Remains_Plant.get(1));
        RM.Juicer.addRecipe1(
            T,
            16,
        ...
        RM.Juicer.addRecipe1(
            ...
            ST.make(Blocks.yellow_flower, 1, 0),
            NF,
            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Yellow], 1),
            IL.Remains_Plant.get(1));
        RM.Juicer.addRecipe1(
            T,
            16,
        ...
        RM.Juicer.addRecipe1(
            ...
            ST.make(Blocks.double_plant, 1, 0),
            NF,
            FL.Oil_Sunflower.make(75),
            ST.make(Items.dye, 2, 11));
        RM.Juicer.addRecipe1(
            T,
            16,
            16,
        ...
        RM.Juicer
            .addRecipe1(T, 16, 16, 10000, ST.make(Blocks.red_mushroom, 1, W), NF, FL.Potion_Poison_1.make(125), NI);
        RM.Juicer
            .addRecipe1(T, 16, 16, 10000, ST.make(Items.poisonous_potato, 1, W), NF, FL.Potion_Poison_1.make(125), NI);
        RM.Juicer.addRecipe1(
            T,
            16,
            16,
        ...
        for (FluidStack tWater : FL.waters(50)) {
            ...
            if (FL.Lava_Volcanic.exists()) RM.Mixer.addRecipe0(
                T,
                16,
                16,
                FL.array(tWater, FL.Lava_Volcanic.make(1000)),
                NF,
                ST.make(BlocksGT.Basalt, 1, BlockStones.STONE));
            RM.Mixer.addRecipe0(
                T,
                16,
                16,
                FL.array(tWater, FL.Lava_Pahoehoe.make(1000)),
                NF,
                ST.make(BlocksGT.Basalt, 1, BlockStones.STONE));
        }
        ...
        RM.Mixer.addRecipeX(
            ...
            16,
            16,
            ST.array(OM.dust(MT.Sugar), ST.make(Items.spider_eye, 1, W), ST.make(Blocks.brown_mushroom, 1, W)),
            ST.make(Items.fermented_spider_eye, 1, 0));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
        ...
        RM.Mixer.addRecipeX(
            ...
            16,
            16,
            ST.array(OM.dust(MT.Coal), OM.dust(MT.Blaze, U9), OM.dust(MT.Gunpowder)),
            ST.make(Items.fire_charge, 3, 0));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Charcoal), OM.dust(MT.Blaze, U9), OM.dust(MT.Gunpowder)),
            ST.make(Items.fire_charge, 3, 0));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.CoalCoke), OM.dust(MT.Blaze, U9), OM.dust(MT.Gunpowder)),
            ST.make(Items.fire_charge, 3, 0));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.LigniteCoke), OM.dust(MT.Blaze, U9), OM.dust(MT.Gunpowder)),
            ST.make(Items.fire_charge, 3, 0));
        ...
        RM.Centrifuge.addRecipe1(
            ...
            NF,
            FL.Slime_Green.make(125),
            ST.make(Items.blaze_powder, 1, 0));
        for (String tFluid : FluidsGT.SLIME) if (FL.exists(tFluid)) {
            RM.Injector
                .addRecipe0(T, 16, 16, FL.array(FL.make(tFluid, 250), MT.CO2.gas(U4, T)), FL.BAWLS.make(250), ZL_IS);
            ...
            RM.Mixer.addRecipe1(
                ...
                FL.make(tFluid, 250),
                NF,
                ST.make(Items.magma_cream, 1, 0));
            RM.Mixer
                .addRecipe1(T, 16, 144, OM.dust(MT.Blaze), FL.make(tFluid, 2250), NF, ST.make(Items.magma_cream, 9, 0));
        }
