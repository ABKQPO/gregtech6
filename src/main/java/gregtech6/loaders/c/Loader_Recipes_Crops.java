    ...
    public void run() {
        ...
        new OreDictListenerEvent_Names() {
            ...
            public void addAllListeners() {
                ...
                addListener(new OreDictListenerEvent_TwoNames("flowerCerublossom", "flowerDesertNova") {
                    ...
                    public void onOreRegistration(ItemStack aStack1, ItemStack aStack2) {
                        RM.Mixer.addRecipeX(
                            ...
                            16,
                            16,
                            ST.array(aStack1, aStack2, OM.dust(MT.ArcaneAsh), OM.dust(MT.Vinteum)),
                            OM.dust(MT.VinteumPurified));
                    }
                });
                addListener("flowerCerublossom", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Squeezer.addRecipe1(
                            ...
                            aEvent.mStack,
                            NF,
                            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Blue], 2),
                            IL.Remains_Plant.get(1));
                        RM.Juicer.addRecipe1(
                            ...
                            aEvent.mStack,
                            NF,
                            FL.mul(DYE_FLUIDS_FLOWER[DYE_INDEX_Blue], 1),
                            IL.Remains_Plant.get(1));
                        RM.ic2_extractor(aEvent.mStack, dust.mat(MT.Blue, 3));
                    }
                });
                addListener("flowerDesertNova", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Juicer.addRecipe1(
                            ...
                            aEvent.mStack,
                            NF,
                            FL.Juice_Cactus.make(75),
                            IL.Dye_Cactus.get(2));
                        RM.ic2_extractor(aEvent.mStack, IL.Dye_Cactus.get(3));
                    }
                });
                addListener("flowerCinderpearl", new IOreDictListenerEvent() {
                ...
                addListener("flowerShimmerleaf", new IOreDictListenerEvent() {
                ...
                addListener(OD.bamboo, new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.CokeOven.addRecipe1(
                            ...
                            NF,
                            FL.Oil_Creosote.make(50),
                            IL.GrC_Bamboo_Charcoal.get(1, OP.stick.mat(MT.Charcoal, 1)));
                    }
                });

                addListener(OD.baleGrassRotten, new IOreDictListenerEvent() {
                ...
                addListener(OD.baleGrassMoldy, new IOreDictListenerEvent() {
                ...
                addListener(OD.baleGrassDry, new IOreDictListenerEvent() {
                ...
                addListener(OD.baleGrass, new IOreDictListenerEvent() {
                ...
                addListener(OD.itemGrassDry, "cropStraw", new IOreDictListenerEvent() {
                ...
                addListener(OD.itemGrass, new IOreDictListenerEvent() {
                ...
                addListener("cropRice", "cropWildRice", new IOreDictListenerEvent() {
                ...
                addListener("baleRice", new IOreDictListenerEvent() {
                ...
                addListener("cropOats", new IOreDictListenerEvent() {
                ...
                addListener("baleOats", new IOreDictListenerEvent() {
                ...
                addListener("cropAbyssalOats", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.compact(
                            aEvent.mStack,
                            9,
                            IL.Bale_AbyssalOats.exists() ? IL.Bale_AbyssalOats.get(1) : IL.Bale_Dry.get(1));
                    }
                });
                addListener("baleAbyssalOats", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        // Those things grow in the Nether, that's why dry.
                        RM.Shredder
                            .addRecipe1(T, 16, 144, aEvent.mStack, OM.dust(MT.OatAbyssal, U * 9), IL.Grass_Dry.get(9));
                        RM.Drying.addRecipe1(T, 16, 90, aEvent.mStack, NF, FL.DistW.make(45), IL.Bale_Dry.get(1));
                        RM.biomass(ST.amount(1, aEvent.mStack));
                        RM.unpack(
                            aEvent.mStack,
                            IL.Crop_AbyssalOats.exists() ? IL.Crop_AbyssalOats.get(9) : IL.Grass_Dry.get(9));
                    }
                });

                addListener("cropBarley", new IOreDictListenerEvent() {
                ...
                addListener("baleBarley", new IOreDictListenerEvent() {
                ...
                addListener("cropRye", new IOreDictListenerEvent() {
                ...
                addListener("baleRye", new IOreDictListenerEvent() {
                ...
                addListener("cropWheat", new IOreDictListenerEvent() {
                ...
                addListener("baleWheat", new IOreDictListenerEvent() {
                ...
                addListener(
                    new String[] { "seedSoybean", "seedCoffee", "seedCrop", "seedThistle", "seedFlower",
                        "seedWitherShrub", "seedHellderberry", "seedGhost", "seedQuartzBerry", "seedHellBush" },
                ...
                addListener(
                    new String[] { "seedMelon", "seedStrawberry", "seedTurnip", "seedBeet", "seedCorn", "seedsAcresia",
                        "seedMisc" },
                    new IOreDictListenerEvent() {
                ...
                addListener(
                    new String[] { "seedRice", "seedApple", "seedGrape", "seedTea", "seedCabbage", "seedPurplePear" },
                    new IOreDictListenerEvent() {
                ...
                addListener(
                    new String[] { "seedWheat", "seedBarley", "seedOats", "seedAbyssalOats", "seedRye",
                        "seedCamellia" },
                    new IOreDictListenerEvent() {
                ...
                addListener(
                    new String[] { "seedPumpkin", "seedDarkFruit", "seedAspectrus" },
                    new IOreDictListenerEvent() {
                ...
                addListener("seedCotton", "seedHemp", new IOreDictListenerEvent() {
                ...
                addListener("seedFlax", new IOreDictListenerEvent() {
                ...
                addListener("seedCanola", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        if (FL.Oil_Canola.exists()) {
                            ...
                            RM.Juicer.addRecipe1(
                                ...
                                aEvent.mStack,
                                NF,
                                FL.Oil_Canola.make(12),
                                IL.Remains_Plant.get(1));
                        } else {
                            RM.Squeezer
                                .addRecipe1(T, 16, 16, 3000, aEvent.mStack, NF, FL.lube(7), IL.Remains_Plant.get(1));
                            RM.Juicer
                                .addRecipe1(T, 16, 16, 4000, aEvent.mStack, NF, FL.lube(6), IL.Remains_Plant.get(1));
                        }
                    }
                });
                addListener("seedSunflower", new IOreDictListenerEvent() {
                ...
                addListener("cropHemp", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Loom.addRecipe2(T, 16, 16, ST.tag(10), ST.amount(4, aEvent.mStack), IL.Rope.get(1));
                        RM.Loom
                            .addRecipe2(T, 16, 16, ST.tag(0), ST.amount(9, aEvent.mStack), ST.make(Blocks.wool, 1, 0));
                        RM.Loom
                            .addRecipe2(T, 16, 16, ST.tag(1), ST.amount(3, aEvent.mStack), ST.make(Items.string, 1, 0));
                        RM.crop(
                            aEvent.mStack,
                            FL.Oil_Hemp,
                            100,
                ...
                addListener("cropFlax", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Loom
                            .addRecipe2(T, 16, 16, ST.tag(0), ST.amount(4, aEvent.mStack), ST.make(Blocks.wool, 1, 0));
                        RM.Loom
                            .addRecipe2(T, 16, 16, ST.tag(1), ST.amount(2, aEvent.mStack), ST.make(Items.string, 1, 0));
                        RM.Squeezer
                            .addRecipe1(T, 16, 16, 3000, aEvent.mStack, NF, FL.lube(30), IL.Remains_Plant.get(1));
                        RM.Juicer.addRecipe1(T, 16, 16, 4000, aEvent.mStack, NF, FL.lube(20), IL.Remains_Plant.get(1));
                    }
                });
                addListener("cropCanola", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (FL.Oil_Canola.exists()) {
                            ...
                            RM.Juicer.addRecipe1(
                                ...
                                aEvent.mStack,
                                NF,
                                FL.Oil_Canola.make(120),
                                IL.Remains_Plant.get(1));
                        } else {
                            RM.Squeezer
                                .addRecipe1(T, 16, 16, 3000, aEvent.mStack, NF, FL.lube(70), IL.Remains_Plant.get(1));
                            RM.Juicer
                                .addRecipe1(T, 16, 16, 4000, aEvent.mStack, NF, FL.lube(60), IL.Remains_Plant.get(1));
                        }
                    }
                });
                addListener("cropIvy", new IOreDictListenerEvent() {
                ...
                addListener("cropCandle", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Squeezer.addRecipe1(
                            ...
                            NF,
                            FL.Juice.make(25),
                            OP.dustSmall.mat(MT.WaxPlant, 1));
                        RM.Juicer.addRecipe1(
                            T,
                            16,
                            16,
                        ...
                        RM.ae_grinder(
                            4,
                            aEvent.mStack,
                            OP.dustSmall.mat(MT.WaxPlant, 2),
                            OP.dustSmall.mat(MT.WaxPlant, 1),
                            0.5F,
                            OP.dustSmall.mat(MT.WaxPlant, 1),
                            0.5F);
                ...
                addListener("cropCandleberry", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop(
                            ...
                            FL.Juice,
                            25,
                            OP.dustSmall.mat(MT.WaxPlant, 4),
                            3000,
                            "Canned Candleberries",
                            IL.CANS_FRUIT,
                            0,
                            0,
                            0,
                ...
                addListener("cropOlive", new IOreDictListenerEvent() {
                ...
                addListener("cropSunflower", new IOreDictListenerEvent() {
                ...
                addListener("cropStarAnise", new IOreDictListenerEvent() {
                ...
                addListener("cropCocoa", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.ae_grinder(
                            4,
                            aEvent.mStack,
                            OP.dustSmall.mat(MT.Cocoa, 2),
                            OP.dustSmall.mat(MT.Cocoa, 1),
                            0.5F,
                            OP.dustSmall.mat(MT.Cocoa, 1),
                            0.5F);
                    }
                });
                addListener("cropCoffee", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.ae_grinder(
                            4,
                            aEvent.mStack,
                            OP.dustSmall.mat(MT.Coffee, 2),
                            OP.dustSmall.mat(MT.Coffee, 1),
                            0.5F,
                            OP.dustSmall.mat(MT.Coffee, 1),
                            0.5F);
                    }
                });
                addListener("cropTea", new IOreDictListenerEvent() {
                ...
                addListener("cropHops", new IOreDictListenerEvent() {
                ...
                addListener("cropTobacco", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ItemStack tStack = OreDictManager.INSTANCE.getFirstOre("leafTobaccoDried", 1);
                        if (ST.valid(tStack))
                            RM.Drying.addRecipe1(T, 16, 50, aEvent.mStack, NF, FL.DistW.make(25), tStack);
                    }
                });
                addListener("cropCoca", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ItemStack tStack = OreDictManager.INSTANCE.getFirstOre("leafCocaDried", 1);
                        if (ST.valid(tStack))
                            RM.Drying.addRecipe1(T, 16, 50, aEvent.mStack, NF, FL.DistW.make(25), tStack);
                    }
                });
                addListener("budCannabis", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ItemStack tStack = OreDictManager.INSTANCE.getFirstOre("budCannabisDried", 1);
                        if (ST.valid(tStack))
                            RM.Drying.addRecipe1(T, 16, 50, aEvent.mStack, NF, FL.DistW.make(25), tStack);
                    }
                });
                addListener("leafCannabis", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ItemStack tStack = OreDictManager.INSTANCE.getFirstOre("leafCannabisDried", 1);
                        if (ST.valid(tStack))
                            RM.Drying.addRecipe1(T, 16, 50, aEvent.mStack, NF, FL.DistW.make(25), tStack);
                    }
                });

                addListener("cropPeanut", "cropPeanuts", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.ae_grinder(
                            4,
                            aEvent.mStack,
                            OP.dustSmall.mat(MT.Peanut, 2),
                            OP.dustSmall.mat(MT.Peanut, 1),
                            0.5F,
                            OP.dustSmall.mat(MT.Peanut, 1),
                            0.5F);
                    }
                });
                addListener("cropHazelnut", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.ae_grinder(
                            4,
                            aEvent.mStack,
                            OP.dustSmall.mat(MT.Hazelnut, 2),
                            OP.dustSmall.mat(MT.Hazelnut, 1),
                            0.5F,
                            OP.dustSmall.mat(MT.Hazelnut, 1),
                            0.5F);
                    }
                });
                addListener("cropPistachio", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.ae_grinder(
                            4,
                            aEvent.mStack,
                            OP.dustSmall.mat(MT.Pistachio, 2),
                            OP.dustSmall.mat(MT.Pistachio, 1),
                            0.5F,
                            OP.dustSmall.mat(MT.Pistachio, 1),
                            0.5F);
                    }
                });
                addListener("cropNutmeg", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.ae_grinder(
                            4,
                            aEvent.mStack,
                            OP.dustSmall.mat(MT.Nutmeg, 2),
                            OP.dustSmall.mat(MT.Nutmeg, 1),
                            0.5F,
                            OP.dustSmall.mat(MT.Nutmeg, 1),
                            0.5F);
                    }
                });
                addListener("cropAlmond", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.ae_grinder(
                            4,
                            aEvent.mStack,
                            OP.dustSmall.mat(MT.Almond, 2),
                            OP.dustSmall.mat(MT.Almond, 1),
                            0.5F,
                            OP.dustSmall.mat(MT.Almond, 1),
                            0.5F);
                    }
                });
                addListener("cropCandlenut", new IOreDictListenerEvent() {
                ...
                addListener("cropPecan", "cropPecannut", new IOreDictListenerEvent() {
                ...
                addListener("cropBeechnut", new IOreDictListenerEvent() {
                ...
                addListener("cropBrazilNut", new IOreDictListenerEvent() {
                ...
                addListener("cropGingkoNut", new IOreDictListenerEvent() {
                ...
                addListener("cropCashew", new IOreDictListenerEvent() {
                ...
                addListener("cropAcorn", new IOreDictListenerEvent() {
                ...
                addListener("cropButternut", new IOreDictListenerEvent() {
                ...
                addListener("cropWalnut", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.boxunbox(
                            ST.make(MD.FR, "crate", 1),
                            ST.make(MD.FR, "cratedWalnut", 1),
                            ST.amount(9, aEvent.mStack));
                    }
                });
                addListener("cropChestnut", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.boxunbox(
                            ST.make(MD.FR, "crate", 1),
                            ST.make(MD.FR, "cratedChestnut", 1),
                            ST.amount(9, aEvent.mStack));
                    }
                });
                ...
                addListener("cropDevilishMaize", new IOreDictListenerEvent() {
                ...
                addListener("cropCrabapple", new IOreDictListenerEvent() {
                ...
                addListener("cropAppleWhite", new IOreDictListenerEvent() {
                ...
                addListener("cropAppleGreen", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            16,
                            aEvent.mStack,
                            IL.Shape_Slicer_Quarters_Hollow.get(0),
                            IL.Food_Apple_Green_Sliced.get(4));
                    }
                });
                addListener("cropAppleYellow", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Quarters_Hollow.get(0),
                            IL.Food_Apple_Yellow_Sliced.get(4));
                    }
                });
                addListener("cropAppleDarkRed", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Quarters_Hollow.get(0),
                            IL.Food_Apple_DarkRed_Sliced.get(4));
                    }
                });
                addListener("cropAppleRed", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Quarters_Hollow.get(0),
                            IL.Food_Apple_Red_Sliced.get(4));
                    }
                });
                addListener("cropApple", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        if (OM.is("cropAppleDarkRed", aEvent.mStack) || OM.is("cropAppleRed", aEvent.mStack)
                            || OM.is("cropAppleYellow", aEvent.mStack)
                            || OM.is("cropAppleGreen", aEvent.mStack)) return;
                        RM.crop_fruit(aEvent.mStack, FL.Juice_Apple, 100, 7000, "Canned Apples", 0, 0, 0, 8, 0);
                    }
                });

                addListener("cropMelon", new IOreDictListenerEvent() {
                ...
                addListener("cropBerry", new IOreDictListenerEvent() {
                ...
                addListener("cropRowanberry", new IOreDictListenerEvent() {
                ...
                addListener("cropSwampberry", new IOreDictListenerEvent() {
                ...
                addListener("cropHeartberry", new IOreDictListenerEvent() {
                ...
                addListener("cropJuniper", new IOreDictListenerEvent() {
                ...
                addListener("cropBlackthorn", new IOreDictListenerEvent() {
                ...
                addListener("cropBlackberry", new IOreDictListenerEvent() {
                ...
                addListener("cropBlueberry", new IOreDictListenerEvent() {
                ...
                addListener("cropRaspberry", new IOreDictListenerEvent() {
                ...
                addListener("cropCranberry", new IOreDictListenerEvent() {
                ...
                addListener("cropGooseberry", new IOreDictListenerEvent() {
                ...
                addListener("fruitsAcresia", new IOreDictListenerEvent() {
                ...
                addListener("cropWyndberry", new IOreDictListenerEvent() {
                ...
                addListener("cropElderberry", new IOreDictListenerEvent() {
                ...
                addListener("cropHellderberry", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop_fruit(
                            aEvent.mStack,
                            FL.Juice_Hellderberry,
                            100,
                            4000,
                            "Canned Hellderberries",
                            0,
                            0,
                            0,
                            8,
                ...
                addListener("cropTorchberry", new IOreDictListenerEvent() {
                ...
                addListener("cropCurrantsRed", new IOreDictListenerEvent() {
                ...
                addListener("cropCurrantsWhite", new IOreDictListenerEvent() {
                ...
                addListener("cropCurrantsBlack", new IOreDictListenerEvent() {
                ...
                addListener("cropCurrants", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (OM.is("cropCurrantsRed", aEvent.mStack) || OM.is("cropCurrantsWhite", aEvent.mStack)
                            || OM.is("cropCurrantsBlack", aEvent.mStack)) return;
                        RM.crop_fruit(aEvent.mStack, FL.Juice_Currant, 100, 4000, "Canned Currants", 0, 0, 0, 8, 0);
                    }
                });

                addListener("cropBlackCherry", new IOreDictListenerEvent() {
                ...
                addListener("cropSourCherry", new IOreDictListenerEvent() {
                ...
                addListener("cropWildCherry", new IOreDictListenerEvent() {
                ...
                addListener("cropCherry", new IOreDictListenerEvent() {
                    ...
                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (OM.is("cropBlackCherry", aEvent.mStack) || OM.is("cropSourCherry", aEvent.mStack)
                            || OM.is("cropWildCherry", aEvent.mStack)) return;
                        RM.crop_fruit(aEvent.mStack, FL.Juice_Cherry, 100, 5000, "Canned Cherries", 0, 0, 0, 12, 0);
                        RM.boxunbox(
                            ST.make(MD.FR, "crate", 1),
                            ST.make(MD.FR, "cratedCherry", 1),
                            ST.amount(9, aEvent.mStack));
                    }
                });

                addListener("cropCactusfruit", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop_fruit(
                            aEvent.mStack,
                            FL.Juice_CactusFruit,
                            100,
                            7000,
                            "Canned Cactusfruits",
                            0,
                ...
                addListener("cropPricklyPair", new IOreDictListenerEvent() {
                ...
                addListener("cropDragonfruit", new IOreDictListenerEvent() {
                ...
                addListener("cropDarkFruit", new IOreDictListenerEvent() {
                ...
                addListener("cropKiwi", new IOreDictListenerEvent() {
                ...
                addListener("cropKeyLime", new IOreDictListenerEvent() {
                ...
                addListener("cropFingerLime", new IOreDictListenerEvent() {
                ...
                addListener("cropLime", new IOreDictListenerEvent() {
                ...
                addListener("cropBuddhaHand", new IOreDictListenerEvent() {
                ...
                addListener("cropCitron", new IOreDictListenerEvent() {
                ...
                addListener("cropLemon", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            IL.Food_Lemon_Sliced.get(4));
                    }
                });

                addListener("cropPersimmon", new IOreDictListenerEvent() {
                ...
                addListener("cropManderin", new IOreDictListenerEvent() {
                ...
                addListener("cropTangerine", new IOreDictListenerEvent() {
                ...
                addListener("cropSatsuma", new IOreDictListenerEvent() {
                ...
                addListener("cropOsangeOrange", new IOreDictListenerEvent() {
                ...
                addListener("cropOrange", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (OM.is("cropManderin", aEvent.mStack) || OM.is("cropPersimmon", aEvent.mStack)
                            || OM.is("cropSatsuma", aEvent.mStack)
                            || OM.is("cropTangerine", aEvent.mStack)) return;
                        RM.crop_fruit(aEvent.mStack, FL.Juice_Orange, 125, 8000, "Canned Oranges", 0, 0, 0, 4, 0);
                    }
                });

                addListener("cropPomelo", new IOreDictListenerEvent() {
                ...
                addListener("cropPear", new IOreDictListenerEvent() {
                ...
                addListener("cropSandPear", new IOreDictListenerEvent() {
                ...
                addListener("cropNectarine", new IOreDictListenerEvent() {
                ...
                addListener("cropPeach", new IOreDictListenerEvent() {
                ...
                addListener("cropCherryPlum", new IOreDictListenerEvent() {
                ...
                addListener("cropPlum", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.boxunbox(
                            ST.make(MD.FR, "crate", 1),
                            ST.make(MD.FR, "cratedPlum", 1),
                            ST.amount(9, aEvent.mStack));
                    }
                });

                addListener("cropMango", new IOreDictListenerEvent() {
                ...
                addListener("cropKumquat", new IOreDictListenerEvent() {
                ...
                addListener("cropAvocado", new IOreDictListenerEvent() {
                ...
                addListener("cropFig", new IOreDictListenerEvent() {
                ...
                addListener("cropPomegranate", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop_fruit(
                            aEvent.mStack,
                            FL.Juice_Pomegranate,
                            100,
                            9000,
                            "Canned Pomegranates",
                            0,
                            ...
                            0);
                        RM.Drying
                            .addRecipe1(T, 16, 100, aEvent.mStack, NF, FL.DistW.make(50), IL.Food_Pomeraisins.get(1));
                        RM.add_smelting(aEvent.mStack, IL.Food_Pomeraisins.get(1), F, T, F);
                    }
                });

                addListener("cropStarfruit", new IOreDictListenerEvent() {
                ...
                addListener("cropApricot", new IOreDictListenerEvent() {
                ...
                addListener("cropPapaya", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.boxunbox(
                            ST.make(MD.FR, "crate", 1),
                            ST.make(MD.FR, "cratedPapaya", 1),
                            ST.amount(9, aEvent.mStack));
                    }
                });

                addListener("cropGrapefruit", new IOreDictListenerEvent() {
                ...
                if (MD.HaC.mLoaded) RM.Drying.addRecipe1(
                    T,
                    16,
                    100,
                    ST.make(MD.HaC, "grapeItem", 1),
                    NF,
                    FL.DistW.make(50),
                    ST.make(MD.HaC, "raisinsItem", 1));

                addListener("cropGrapeRed", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop_fruit(aEvent.mStack, FL.Juice_Grape_Red, 125, 8000, "Canned Grapes", 0, 0, 0, 12, 0);
                        RM.Drying
                            .addRecipe1(T, 16, 100, aEvent.mStack, NF, FL.DistW.make(50), IL.Food_Raisins_Red.get(1));
                        if (!OM.is("foodRaisins", RM.get_smelting(aEvent.mStack)))
                            RM.add_smelting(aEvent.mStack, IL.Food_Raisins_Red.get(1), F, T, F);
                    }
                });
                addListener("cropGrapePurple", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Drying.addRecipe1(
                            ...
                            NF,
                            FL.DistW.make(50),
                            IL.Food_Raisins_Purple.get(1));
                        if (!OM.is("foodRaisins", RM.get_smelting(aEvent.mStack)))
                            RM.add_smelting(aEvent.mStack, IL.Food_Raisins_Purple.get(1), F, T, F);
                    }
                });
                addListener("cropGrapeWhite", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop_fruit(aEvent.mStack, FL.Juice_Grape_White, 125, 8000, "Canned Grapes", 0, 0, 0, 12, 0);
                        RM.Drying
                            .addRecipe1(T, 16, 100, aEvent.mStack, NF, FL.DistW.make(50), IL.Food_Raisins_White.get(1));
                        if (!OM.is("foodRaisins", RM.get_smelting(aEvent.mStack)))
                            RM.add_smelting(aEvent.mStack, IL.Food_Raisins_White.get(1), F, T, F);
                    }
                });
                addListener("cropGrapeGreen", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop_fruit(aEvent.mStack, FL.Juice_Grape_Green, 125, 8000, "Canned Grapes", 0, 0, 0, 12, 0);
                        RM.Drying
                            .addRecipe1(T, 16, 100, aEvent.mStack, NF, FL.DistW.make(50), IL.Food_Raisins_Green.get(1));
                        if (!OM.is("foodRaisins", RM.get_smelting(aEvent.mStack)))
                            RM.add_smelting(aEvent.mStack, IL.Food_Raisins_Green.get(1), F, T, F);
                    }
                });
                addListener("cropGrape", new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (OM.is("cropGrapeWhite", aEvent.mStack) || OM.is("cropGrapeGreen", aEvent.mStack)
                            || OM.is("cropGrapeRed", aEvent.mStack)
                            || OM.is("cropGrapePurple", aEvent.mStack)) return;
                        RM.crop_fruit(aEvent.mStack, FL.Juice_Grape_Green, 125, 8000, "Canned Grapes", 0, 0, 0, 12, 0);
                        if (!OM.is("foodRaisins", RM.get_smelting(aEvent.mStack)))
                            RM.add_smelting(aEvent.mStack, IL.Food_Raisins_Green.get(1), F, T, F);
                    }
                ...
                addListener("cropDate", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.boxunbox(
                            ST.make(MD.FR, "crate", 1),
                            ST.make(MD.FR, "cratedDates", 1),
                            ST.amount(9, aEvent.mStack));
                    }
                });

                addListener("cropBanana", "cropRedBanana", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Flat.get(0),
                            IL.Food_Banana_Sliced.get(4));
                    }
                });
                addListener("cropPlantain", new IOreDictListenerEvent() {
                ...
                addListener("cropAnanas", "cropPineapple", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Flat.get(0),
                            IL.Food_Ananas_Sliced.get(4));
                    }
                });

                addListener("cropBeet", "cropBeetroot", new IOreDictListenerEvent() {
                ...
                addListener("cropCarrot", "cropWildcarrots", new IOreDictListenerEvent() {
                ...
                addListener("cropPotato", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Flat.get(0),
                            IL.Food_PotatoChips_Raw.get(1));
                        RM.Slicer.addRecipe2(
                            T,
                            16,
                            16,
                            aEvent.mStack,
                            IL.Shape_Slicer_Grid.get(0),
                        ...
                        for (OreDictMaterial tMat : ANY.Wood.mToThis) {
                            ...
                            if (ST.valid(tStick)) {
                                RM.Boxinator.addRecipe2(
                                    ...
                                    aEvent.mStack,
                                    OP.stick.mat(tMat, 1),
                                    IL.Food_Potato_On_Stick.get(1));
                            }
                        }
                    }
                });

                addListener("cropTomato", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Flat.get(0),
                            IL.Food_Tomato_Sliced.get(4));
                        if (!IL.Food_MTomato.equal(aEvent.mStack)) RM.Bath
                            .addRecipe1(T, 0, 16, aEvent.mStack, FL.Sap_Rainbow.make(100), NF, IL.Food_MTomato.get(1));
                    }
                });

                addListener("cropCucumber", new IOreDictListenerEvent() {
                ...
                addListener("cropPickle", "foodPickles", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Flat.get(0),
                            IL.Food_Pickle_Sliced.get(4));
                    }
                });

                addListener("cropOnion", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Slicer.addRecipe2(
                            ...
                            aEvent.mStack,
                            IL.Shape_Slicer_Flat.get(0),
                            IL.Food_Onion_Sliced.get(4));
                    }
                });

                addListener("cropSoybean", new IOreDictListenerEvent() {
                ...
                addListener("cropChilipepper", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        if (!ST.isGT(aEvent.mStack) && !Sandwiches.INGREDIENTS.containsKey(aEvent.mStack, F))
                            Sandwiches.INGREDIENTS.put(aEvent.mStack, (byte) 20);
                    }
                });
                addListener("cropCinnamon", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop(
                            ...
                            null,
                            0,
                            OP.dustSmall.mat(MT.Cinnamon, 4),
                            9000,
                            null,
                            null,
                            0,
                ...
                addListener("cropCurryleaf", new IOreDictListenerEvent() {
                ...
                addListener("cropPeppercorn", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.crop(
                            ...
                            null,
                            0,
                            OP.dustSmall.mat(MT.PepperBlack, 4),
                            9000,
                            null,
                            null,
                            0,
                ...
                addListener("cropClove", new IOreDictListenerEvent() {
                ...
                addListener("cropAllspice", new IOreDictListenerEvent() {
                ...
                addListener("cropTruffle", new IOreDictListenerEvent() {
        ...
        crop.addListener(new IOreDictListenerEvent() {
        ...
        flower.addListener(new IOreDictListenerEvent() {
        ...
        treeLeaves.addListener(new IOreDictListenerEvent() {
        ...
        treeSapling.addListener(new IOreDictListenerEvent() {
