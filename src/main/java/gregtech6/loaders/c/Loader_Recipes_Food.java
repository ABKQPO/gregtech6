...
public class Loader_Recipes_Food implements Runnable {
    ...
    public void run() {
        ...
        for (ItemStack tStack : ST.array(
            dustTiny.mat(MT.FishCooked, 9),
            dustSmall.mat(MT.FishCooked, 4),
            dust.mat(MT.FishCooked, 1),
            nugget.mat(MT.FishCooked, 9),
            chunkGt.mat(MT.FishCooked, 4),
            billet.mat(MT.FishCooked, 2),
            ingot.mat(MT.FishCooked, 1))) RM.food_can(tStack, 2, "Canned Fish", IL.CANS_FISH);
        for (ItemStack tStack : ST.array(
            dustTiny.mat(MT.MeatCooked, 9),
            dustSmall.mat(MT.MeatCooked, 4),
            dust.mat(MT.MeatCooked, 1),
            nugget.mat(MT.MeatCooked, 9),
            chunkGt.mat(MT.MeatCooked, 4),
            billet.mat(MT.MeatCooked, 2),
            ingot.mat(MT.MeatCooked, 1))) RM.food_can(tStack, 2, "Canned Meat", IL.CANS_MEAT);
        for (ItemStack tStack : ST.array(
            dustTiny.mat(MT.Tofu, 9),
            dustSmall.mat(MT.Tofu, 4),
            dust.mat(MT.Tofu, 1),
            nugget.mat(MT.Tofu, 9),
            chunkGt.mat(MT.Tofu, 4),
            billet.mat(MT.Tofu, 2),
            ingot.mat(MT.Tofu, 1))) RM.food_can(tStack, 2, "Canned Tofu", IL.CANS_VEGGIE);
        for (ItemStack tStack : ST.array(
            dustTiny.mat(MT.SoylentGreen, 9),
            dustSmall.mat(MT.SoylentGreen, 4),
            dust.mat(MT.SoylentGreen, 1),
            nugget.mat(MT.SoylentGreen, 9),
            chunkGt.mat(MT.SoylentGreen, 4),
            billet.mat(MT.SoylentGreen, 2),
            ingot.mat(MT.SoylentGreen, 1))) RM.food_can(tStack, 2, "Canned Emerald Green", IL.CANS_VEGGIE);

        OreDictPrefix[] tPrefixListA = new OreDictPrefix[] { dustTiny, dustSmall, dust },
            tPrefixListB = new OreDictPrefix[] { nugget, chunkGt, ingot };
        OreDictMaterial[] tMaterialList = new OreDictMaterial[] { MT.MeatRotten, MT.MeatRaw, MT.MeatCooked,
            MT.FishRotten, MT.FishRaw, MT.FishCooked, MT.SoylentGreen, MT.Tofu };
        ...
        for (int i = 0; i < tPrefixListA.length; i++) for (int j = 0; j < tMaterialList.length; j++) {
            RM.Compressor.addRecipe1(
                ...
                16,
                16,
                tPrefixListA[i].mat(tMaterialList[j], 1),
                tPrefixListB[i].mat(tMaterialList[j], 1));
        ...
        new OreDictListenerEvent_Names() {
            ...
            public void addAllListeners() {
                ...
                addListener(dust.dat(MT.WaxBee), dust.dat(MT.WaxPlant), new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        // Annoying multi-registration that was necessary for Compat is causing Issues with Furnace
                        // Recipes.
                ...
                addListener("foodDough", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Mixer.addRecipe2(
                            ...
                            16,
                            aEvent.mStack,
                            gemChipped.mat(MT.Sugar, 4),
                            IL.Food_Dough_Sugar.get(2));
                        RM.Mixer.addRecipe2(T, 16, 16, aEvent.mStack, OM.dust(MT.Sugar), IL.Food_Dough_Sugar.get(2));
                        RM.Mixer
                            .addRecipe2(T, 16, 16, aEvent.mStack, OM.dust(MT.Cocoa), IL.Food_Dough_Chocolate.get(1));
                        RM.Mixer.addRecipe2(
                            T,
                            16,
                            16,
                            aEvent.mStack,
                            OM.dust(MT.Chocolate),
                            IL.Food_Dough_Chocolate.get(2));

                        RM.Press.addRecipe2(
                            T,
                            16,
                            16,
                            ST.amount(1, aEvent.mStack),
                            IL.Shape_Foodmold_Bun.get(0),
                            IL.Food_Bun_Raw.get(1));
                        RM.Press.addRecipe2(
                            T,
                            16,
                            32,
                            ST.amount(2, aEvent.mStack),
                            IL.Shape_Foodmold_Bread.get(0),
                            IL.Food_Bread_Raw.get(1));
                        RM.Press.addRecipe2(
                            T,
                            16,
                            48,
                            ST.amount(3, aEvent.mStack),
                            IL.Shape_Foodmold_Baguette.get(0),
                            IL.Food_Baguette_Raw.get(1));
                        RM.Press.addRecipe2(
                            T,
                            16,
                            64,
                            ST.amount(4, aEvent.mStack),
                            IL.Shape_Foodmold_Toast.get(0),
                ...
                addListener("foodSugarDough", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Press.addRecipe2(
                            ...
                            64,
                            ST.amount(4, aEvent.mStack),
                            IL.Shape_Foodmold_Cylinder.get(0),
                ...
                addListener("foodRaisins", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Mixer.addRecipe2(
                            ...
                            NF,
                            NF,
                            IL.Food_Ice_Cream_Raisin.get(1));
                    }
                });
                ...
                addListener(
                    new Object[] { dust.dat(MT.Snow), dust.dat(MT.Sugar), dust.dat(MT.PEZ), dust.dat(MT.Rice),
                        dust.dat(MT.NaCl), dust.dat(MT.KCl) },
                ...
                addListener(
                    new Object[] { dust.dat(MT.Nougat), dust.dat(MT.Vanilla), dust.dat(MT.Nutmeg), dust.dat(MT.Peanut),
                        dust.dat(MT.Hazelnut), dust.dat(MT.Almond), dust.dat(MT.Cocoa), dust.dat(MT.Chocolate),
                        dust.dat(MT.Cinnamon), dust.dat(MT.Coffee) },
                    new IOreDictListenerEvent() {
                    ...
                    new IOreDictListenerEvent() {
                        ...
                        public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                            if (!ST.isGT(aEvent.mStack)) {
                                ...
                                if (!Sandwiches.INGREDIENTS.containsKey(aEvent.mStack, F))
                ...
                addListener("foodCaramel", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Mixer.addRecipe2(
                            ...
                            NF,
                            NF,
                            IL.Food_Ice_Cream_Caramel.get(1));
                        if (!ST.isGT(aEvent.mStack)) {
                ...
                addListener("foodTaffy", new IOreDictListenerEvent() {
                ...
                addListener(new OreDictListenerEvent_TwoNames("foodSugarDough", "foodRaisins") {
                    ...
                    public void onOreRegistration(ItemStack aStack1, ItemStack aStack2) {
                        if (!IL.Food_Dough_Sugar_Raisins.equal(aStack1, F, T)
                            && !IL.Food_Dough_Sugar_Chocolate_Raisins.equal(aStack1, F, T))
                ...
                addListener(new OreDictListenerEvent_TwoNames("foodSugarDough", "foodChocolateraisins") {
                    ...
                    public void onOreRegistration(ItemStack aStack1, ItemStack aStack2) {
                        if (!IL.Food_Dough_Sugar_Raisins.equal(aStack1, F, T)
                            && !IL.Food_Dough_Sugar_Chocolate_Raisins.equal(aStack1, F, T))
                            RM.Mixer
                                .addRecipe2(T, 16, 16, aStack1, aStack2, IL.Food_Dough_Sugar_Chocolate_Raisins.get(1));
                    }
                });
                ...
                addListener(OD.itemEgg, new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        if (FL.Water_Hot.exists()) RM.Bath.addRecipe1(
                            T,
                            0,
                            128 * tAmount,
                            aEvent.mStack,
                            FL.Water_Hot.make(100 * tAmount),
                            FL.Water.make(100 * tAmount),
                            (ST.equal(aEvent.mStack, Items.egg) ? IL.Food_Brown_Egg_Boiled : IL.Food_White_Egg_Boiled)
                                .get(tAmount),
                            IL.Birb_Egg_Shell.get(tAmount, IL.Dye_Bonemeal.get(tAmount)));
                        if (FL.Hot_Water.exists()) RM.Bath.addRecipe1(
                            T,
                            0,
                            128 * tAmount,
                            aEvent.mStack,
                            FL.Hot_Water.make(100 * tAmount),
                            FL.Water.make(100 * tAmount),
                            (ST.equal(aEvent.mStack, Items.egg) ? IL.Food_Brown_Egg_Boiled : IL.Food_White_Egg_Boiled)
                                .get(tAmount),
                            IL.Birb_Egg_Shell.get(tAmount, IL.Dye_Bonemeal.get(tAmount)));
                        if (FL.Water_Boiling.exists()) RM.Bath.addRecipe1(
                            T,
                            0,
                            128 * tAmount,
                            aEvent.mStack,
                            FL.Water_Boiling.make(100 * tAmount),
                            FL.Water.make(100 * tAmount),
                            (ST.equal(aEvent.mStack, Items.egg) ? IL.Food_Brown_Egg_Boiled : IL.Food_White_Egg_Boiled)
                                .get(tAmount),
                            IL.Birb_Egg_Shell.get(tAmount, IL.Dye_Bonemeal.get(tAmount)));
                        RM.Bath.addRecipe1(
                            ...
                            128 * tAmount,
                            aEvent.mStack,
                            FL.Water_Geothermal.make(100 * tAmount),
                            FL.Water.make(100 * tAmount),
                            (ST.equal(aEvent.mStack, Items.egg) ? IL.Food_Brown_Egg_Boiled : IL.Food_White_Egg_Boiled)
                                .get(tAmount),
                            IL.Birb_Egg_Shell.get(tAmount, IL.Dye_Bonemeal.get(tAmount)));
                        RM.Autoclave.addRecipe2(
                            ...
                            aEvent.mStack,
                            ST.tag(0),
                            FL.Steam.make(800 * tAmount),
                            FL.DistW.make(5 * tAmount),
                            (ST.equal(aEvent.mStack, Items.egg) ? IL.Food_Brown_Egg_Boiled : IL.Food_White_Egg_Boiled)
                                .get(tAmount),
                            IL.Birb_Egg_Shell.get(tAmount, IL.Dye_Bonemeal.get(tAmount)));
                        RM.Juicer.addRecipe1(
                            ...
                            16 * tAmount,
                            aEvent.mStack,
                            IL.Food_Egg_White.get(tAmount),
                            IL.Food_Egg_Yolk.get(tAmount),
                            IL.Birb_Egg_Shell.get(tAmount, IL.Dye_Bonemeal.get(tAmount))); // There is not gonna be a
                                                                                           // Squeezer Recipe!
                ...
                addListener(OD.itemTusk, OD.itemIvory, new IOreDictListenerEvent() {
                ...
                addListener(OD.itemHoof, new IOreDictListenerEvent() {
                ...
                addListener(OD.itemHorn, new IOreDictListenerEvent() {
                ...
                addListener(OD.itemAntler, new IOreDictListenerEvent() {
                ...
                addListener("listAllmeatraw", "foodScrapmeat", new IOreDictListenerEvent() {
                    ...
                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (OD.listAllmeatsubstitute.is_(aEvent.mStack) || OM.is_("listAllfishraw", aEvent.mStack)
                            || !ST.ingredable(aEvent.mStack)) return;
                ...
                addListener("foodScrapmeat", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        for (ItemStack tStack : ST.array(
                            ...
                            IL.IE_Slag.get(1),
                            IL.TE_Slag.get(1),
                            IL.TE_Slag_Rich.get(1))) if (ST.valid(tStack)) {
                                RM.Mixer.addRecipeX(
                                    T,
                                    16,
                                    256,
                                    ST.array(
                                        aEvent.mStack,
                                        ST.make(Items.fermented_spider_eye, 1, W),
                                        OM.dust(MT.MeatRotten),
                                        OM.dust(MT.Bone),
                                        IL.Food_Potato_Poisonous.get(1),
                                        IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))),
                                    FL.array(FL.Purple_Drink.make(1000), FL.Oil_Fish.make(1000)),
                                    FL.Sludge.make(1000),
                                    IL.Food_Chum.get(8));
                                RM.Mixer.addRecipeX(
                                    T,
                                ...
                                RM.Mixer.addRecipeX(
                                    ...
                                    ST.array(
                                        ...
                                        IL.Food_Potato_Poisonous.get(1),
                                        IL.IC2_Scrap.get(1, ST.make(Blocks.red_mushroom, 1, W))),
                                    FL.array(FL.Purple_Drink.make(1000), FL.Oil_Whale.make(500)),
                                    FL.Sludge.make(1000),
                                    IL.Food_Chum.get(8));
                                RM.Mixer.addRecipeX(
                                    T,
                ...
                addListener("listAllfishraw", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.food_can(
                            aEvent.mStack,
                            Math.max(1, ST.food(aEvent.mStack)),
                            "Canned Fish",
                            ST.rotten(aEvent.mStack) ? IL.CANS_ROTTEN : IL.CANS_FISH);
                        if (!ST.ingredable(aEvent.mStack) || ST.meta_(aEvent.mStack) == W) return;
                        long tFishOilAmount = U;
                        OreDictMaterialStack tByProduct = null;
                        if (tData == null) tByProduct = OM.stack(MT.FishRaw, U);
                        else for (OreDictMaterialStack tMat : tData.getAllMaterialStacks()) {
                            if (tMat.mMaterial == MT.FishOil) tFishOilAmount = tMat.mAmount;
                        ...
                        RM.Squeezer.addRecipe1(
                            ...
                            aEvent.mStack,
                            NF,
                            MT.FishOil.liquid(tFishOilAmount, F),
                            OM.dust(tByProduct));
                        RM.Juicer.addRecipe1(
                            T,
                            16,
                            ...
                            aEvent.mStack,
                            NF,
                            MT.FishOil.liquid(tFishOilAmount / 2, F),
                            OM.dust(tByProduct));
                    }
                });
                ...
                addListener("listAllribraw", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.food_can(
                            ...
                            Math.max(1, ST.food(aEvent.mStack)),
                            "Canned Ribs",
                            ST.rotten(aEvent.mStack) ? IL.CANS_ROTTEN : IL.CANS_MEAT);
                ...
                addListener("listAllmushroom", new IOreDictListenerEvent() {
                    ...
                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (!ST.equal(aEvent.mStack, Blocks.brown_mushroom)) RM.Mixer.addRecipe2(
                            T,
                            16,
                            16,
                            aEvent.mStack,
                            ST.make(Blocks.brown_mushroom, 1, W),
                            NF,
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        for (OreDictMaterial tMat : ANY.Ash.mToThis) {
                            RM.Mixer.addRecipeX(
                                ...
                                16,
                                16,
                                ST.array(ingot.mat(MT.Peat, 2), OM.dust(tMat, U * 2), aEvent.mStack),
                                ingotDouble.mat(MT.PeatBituminous, 1));
                            RM.Mixer.addRecipeX(
                                T,
                                16,
                                16,
                                ST.array(dust.mat(MT.Peat, 1), OM.dust(tMat, U), aEvent.mStack),
                                dust.mat(MT.PeatBituminous, 1));
                        }
                    }
                });
                addListener(OD.itemTar, new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Mixer.addRecipe2(
                            ...
                            ingotDouble.mat(MT.PeatBituminous, 1));
                        RM.Mixer
                            .addRecipe2(T, 16, 16, dust.mat(MT.Peat, 1), aEvent.mStack, dust.mat(MT.PeatBituminous, 2));
                    }
                });

                addListener(OD.dropHoney, new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (!ST.ingredable(aEvent.mStack)) return;
                        RM.Squeezer
                            .addRecipe1(T, 16, 16, 500, aEvent.mStack, NF, FL.Honey.make(100), IL.FR_Propolis.get(1));
                        RM.Juicer
                            .addRecipe1(T, 16, 16, 500, aEvent.mStack, NF, FL.Honey.make(100), IL.FR_Propolis.get(1));
                    }
                });
                addListener(OD.dropHoneydew, new IOreDictListenerEvent() {
                ...
                addListener(OD.dropRoyalJelly, new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (!ST.ingredable(aEvent.mStack)) return;
                        RM.Mixer
                            .addRecipe1(T, 16, 16, aEvent.mStack, FL.Honeydew.make(200), FL.Ambrosia.make(400), ZL_IS);
        ...
        RM.Mixer.addRecipe0(
            ...
            16,
            16,
            FL.array(FL.RoyalJelly.make(100), FL.Honeydew.make(200)),
            FL.array(FL.Ambrosia.make(400)),
            ZL_IS);
        ...
        RM.Distillery
            .addRecipe1(T, 16, 80, ST.tag(0), FL.Sap_Maple.make(125), FL.Syrup_Maple.make(50), FL.DistW.make(50));
        ...
        RM.Distillery
            .addRecipe1(T, T, F, F, F, 16, 80, ST.tag(0), FL.Sap.make(125), FL.DistW.make(50), OM.dust(MT.Sugar));
        RM.Distillery
            .addRecipe1(T, 16, 128, OM.dust(MT.Chili), FL.Sauce_Hot.make(750), FL.Sauce_Diabolo.make(750), ZL_IS);
        RM.Distillery
            .addRecipe1(T, 64, 128, OM.dust(MT.Chili), FL.Sauce_Diabolo.make(750), FL.Sauce_Diablo.make(750), ZL_IS);
        RM.Distillery.addRecipe1(
            T,
            64,
            128,
            OM.dust(MT.Gunpowder),
            FL.Sauce_Diablo.make(250),
            FL.Sauce_Cow_Level.make(250),
            ZL_IS);
        RM.Distillery
            .addRecipe1(T, 64, 128, OM.dust(MT.Gunpowder), FL.Lemonade.make(250), FL.Grenade_Juice.make(250), ZL_IS);
        ...
        for (FluidStack tWater : FL.waters(1000)) {
            RM.Distillery.addRecipe1(
                ...
                OM.dust(MT.Coffee),
                FL.mul(tWater, 3, 4, T),
                FL.make("potion.darkcoffee", 750),
                ZL_IS);
            RM.Distillery.addRecipe1(
                T,
                16,
                16,
                OM.dust(MT.Coffee, U3),
                FL.mul(tWater, 1, 4, T),
                FL.make("potion.darkcoffee", 250),
                ZL_IS);
            ...
            RM.Mixer
                .addRecipe1(T, 16, 16, OM.dust(MT.Honeydew), FL.mul(tWater, 1, 2, T), FL.Honeydew.make(1000), ZL_IS);

            RM.Mixer.addRecipe1(T, 16, 16, OM.dust(MT.Tea, U9), FL.mul(tWater, 750, 1000, T), FL.Tea.make(750), ZL_IS);
            RM.Mixer
                .addRecipe1(T, 16, 36, OM.dust(MT.Tea, U4), FL.mul(tWater, 1687, 1000, T), FL.Tea.make(1687), ZL_IS);
            ...
            RM.Injector
                .addRecipe0(T, 16, 16, FL.array(FL.mul(tWater, 1, 4, T), MT.CO2.gas(U4, T)), FL.Soda.make(250), ZL_IS);
        }
        RM.Injector
            .addRecipe0(T, 16, 16, FL.array(FL.MnWtr.make(250), MT.CO2.gas(U4, T)), FL.Mineralsoda.make(250), ZL_IS);
        ...
        RM.Fermenter
            .addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Pear.make(50), FL.Cider_Pear.make(25, FL.Cider_Apple), ZL_IS);
        RM.Fermenter
            .addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Peach.make(50), FL.Cider_Peach.make(25, FL.Cider_Apple), ZL_IS);
        ...
        RM.Fermenter.addRecipe1(
            ...
            64,
            ST.tag(0),
            FL.make_("potion.goldenapplejuice", 50),
            FL.make("potion.goldencider", 25),
            ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            64,
            ST.tag(0),
            FL.make_("potion.idunsapplejuice", 50),
            FL.make("potion.notchesbrew", 25),
            ZL_IS);
        ...
        RM.Fermenter
            .addRecipe1(T, 16, 128, ST.tag(0), FL.Whiskey_Scotch.make(50), FL.Whiskey_GlenMcKenner.make(10), ZL_IS);
        ...
        RM.Fermenter
            .addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Grape_White.make(50), FL.Wine_Grape_White.make(25), ZL_IS);
        RM.Fermenter
            .addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Grape_Green.make(50), FL.Wine_Grape_Green.make(25), ZL_IS);
        RM.Fermenter
            .addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Grape_Purple.make(50), FL.Wine_Grape_Purple.make(25), ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            64,
            ST.tag(0),
            FL.Juice_Apricot.make(50),
            FL.Wine_Apricot.make(25, FL.Wine_Grape_Green),
            ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            ...
            FL.Wine_Banana.make(25, FL.Wine_Grape_Green),
            ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            64,
            ST.tag(0),
            FL.Juice_Carrot.make(50),
            FL.Wine_Carrot.make(25, FL.Wine_Grape_Green),
            ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            ...
            FL.Wine_Cherry.make(25, FL.Wine_Grape_Green),
            ZL_IS);
        RM.Fermenter.addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Lemon.make(50), FL.Wine_Lemon.make(25), ZL_IS);
        RM.Fermenter
            .addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Lime.make(50), FL.Wine_Citrus.make(25, FL.Wine_Lemon), ZL_IS);
        RM.Fermenter
            .addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Orange.make(50), FL.Wine_Citrus.make(25, FL.Wine_Lemon), ZL_IS);
        RM.Fermenter
            .addRecipe1(T, 16, 64, ST.tag(0), FL.Juice_Kiwi.make(50), FL.Wine_Citrus.make(25, FL.Wine_Lemon), ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            64,
            ...
            FL.Wine_Cranberry.make(25, FL.Wine_Grape_Green),
            ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            64,
            ST.tag(0),
            FL.Juice_Elderberry.make(50),
            FL.Wine_Elderberry.make(25, FL.Wine_Grape_Green),
            ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            64,
            ST.tag(0),
            FL.Juice_Plum.make(50),
            FL.Wine_Plum.make(25, FL.Wine_Grape_Green),
            ZL_IS);
        RM.Fermenter.addRecipe1(
            T,
            16,
            64,
            ST.tag(0),
            FL.Juice_Tomato.make(50),
            FL.Wine_Tomato.make(25, FL.Wine_Grape_Green),
            ZL_IS);
        ...
        if (FL.Sap.exists()) RM.Drying.addRecipe0(T, 16, 200, FL.Sap.make(250), FL.DistW.make(100), OM.dust(MT.Sugar));
        ...
        RM.Mixer.addRecipe1(
            ...
            16,
            16,
            OP.stick.mat(MT.WoodTreated, 0),
            FL.Juice_Coconut.make(50),
            FL.Cream_Coconut.make(50),
            ZL_IS);
        ...
        if (ST.valid(tOutput)) RM.Coagulator.addRecipe0(T, 0, 16, FL.Honeydew.make(200), NF, tOutput);
        tOutput = IL.FR_Royal_Jelly.get(1, IL.HaC_Royal_Jelly.get(1));
        if (ST.valid(tOutput)) RM.Coagulator.addRecipe0(T, 0, 16, FL.RoyalJelly.make(100), NF, tOutput);

        tOutput = ST.make(MD.TiC, "materials", 1, 36);
        if (ST.valid(tOutput)) RM.Coagulator.addRecipe0(T, 0, 16, FL.Glue.make(144), NF, tOutput);
        tOutput = ST.make(MD.TiC, "strangeFood", 1, 1);
        if (ST.valid(tOutput) && FL.Blood.exists()) RM.Coagulator.addRecipe0(T, 0, 16, FL.Blood.make(160), NF, tOutput);

        if (FL.Slime_Pink.exists()) {
            tOutput = OreDictManager.INSTANCE.getFirstOre("slimeballPink", 1);
            RM.Coagulator.addRecipe0(
                T,
                0,
                256,
                FL.Slime_Pink.make(250),
                NF,
                ST.valid(tOutput) ? tOutput : OP.nugget.mat(MT.MeatRaw, 1));
        }
        if (FL.Slime_Blue.exists()) {
            tOutput = OreDictManager.INSTANCE.getFirstOre("slimeballBlue", 1);
            RM.Coagulator.addRecipe0(
                T,
                0,
                256,
                FL.Slime_Blue.make(250),
                NF,
                ST.valid(tOutput) ? tOutput : ST.make(Items.slime_ball, 1, 0));
        }
        ...
        RM.Mixer.addRecipe1(
            ...
            16,
            16,
            OM.dust(MT.OatAbyssal),
            FL.Juice_Hellderberry.make(100),
            NF,
        ...
        RM.Mixer.addRecipe0(
            ...
            16,
            16,
            FL.array(FL.Mash_Wheat.make(50), FL.Mash_Hops.make(50)),
            FL.Mash_WheatHops.make(100),
            ZL_IS);

        RM.Mixer
            .addRecipe2(T, 16, 144, dust.mat(MT.NaCl, 1), IL.Food_Butter.get(9), NF, NF, IL.Food_Butter_Salted.get(9));
        RM.Mixer.addRecipe2(
            T,
            16,
            32,
            dustSmall.mat(MT.NaCl, 1),
            IL.Food_Butter.get(2),
            NF,
            NF,
            IL.Food_Butter_Salted.get(2));
        RM.Mixer.addRecipe2(
            T,
            16,
            16,
            dustTiny.mat(MT.NaCl, 1),
            IL.Food_Butter.get(1),
            NF,
            NF,
            IL.Food_Butter_Salted.get(1));
        ...
        RM.Mixer
            .addRecipe0(T, 16, 16, FL.array(FL.Lemonade.make(125), FL.Vodka.make(125)), FL.Leninade.make(250), ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Ananas.make(150), FL.Cream_Coconut.make(50), FL.Rum_White.make(50)),
            FL.Pina_Colada.make(250),
            ZL_IS);
        ...
        RM.Mixer.addRecipe0(
            ...
            16,
            16,
            FL.array(FL.make("potion.darkcoffee", 125), FL.Milk.make(125)),
            FL.make("potion.coffee", 250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.make("potion.darkcoffee", 125), FL.MilkGrC.make(125)),
            FL.make("potion.coffee", 250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.make("potion.darkcoffee", 125), FL.MilkSoy.make(125)),
            FL.make("potion.coffee", 250),
            ZL_IS);

        for (ItemStack tStack : ST.array(dust.mat(MT.Milk, 1), dustSmall.mat(MT.Milk, 4), dustTiny.mat(MT.Milk, 9))) {
            RM.Mixer
                .addRecipe1(T, 16, 48, tStack, FL.make("potion.darkcoffee", 750), FL.make("potion.coffee", 750), ZL_IS);
        }
        for (ItemStack tStack : ST
            .array(dust.mat(MT.Peanut, 1), dustSmall.mat(MT.Peanut, 4), dustTiny.mat(MT.Peanut, 9))) {
            RM.Mixer.addRecipe1(T, 16, 64, tStack, FL.Cream.make(250), FL.Nutbutter_Peanut.make(250), ZL_IS);
        }
        for (ItemStack tStack : ST
            .array(dust.mat(MT.Hazelnut, 1), dustSmall.mat(MT.Hazelnut, 4), dustTiny.mat(MT.Hazelnut, 9))) {
            RM.Mixer.addRecipe1(T, 16, 64, tStack, FL.Cream_Chocolate.make(250), FL.Cream_Nutella.make(250), ZL_IS);
        }
        for (ItemStack tStack : ST
            .array(dust.mat(MT.Chocolate, 1), dustSmall.mat(MT.Chocolate, 4), dustTiny.mat(MT.Chocolate, 9))) {
            RM.Mixer.addRecipe1(T, 16, 48, tStack, FL.Milk.make(750), FL.make("potion.darkchocolatemilk", 750), ZL_IS);
            RM.Mixer
                .addRecipe1(T, 16, 48, tStack, FL.MilkGrC.make(750), FL.make("potion.darkchocolatemilk", 750), ZL_IS);
            RM.Mixer
                .addRecipe1(T, 16, 48, tStack, FL.MilkSoy.make(750), FL.make("potion.darkchocolatemilk", 750), ZL_IS);
            RM.Mixer.addRecipe1(T, 16, 64, tStack, FL.Cream.make(250), FL.Cream_Chocolate.make(250), ZL_IS);
        }
        for (ItemStack tStack : ST.array(
            gemChipped.mat(MT.Sugar, 4),
            dust.mat(MT.Sugar, 1),
            dustSmall.mat(MT.Sugar, 4),
            dustTiny.mat(MT.Sugar, 9))) {
            RM.Mixer
                .addRecipe1(T, 16, 48, tStack, FL.make("potion.coffee", 750), FL.make("potion.cafeaulait", 750), ZL_IS);
            RM.Mixer.addRecipe1(
                T,
                16,
                48,
                tStack,
                FL.make("potion.cafeaulait", 750),
                FL.make("potion.laitaucafe", 750),
                ZL_IS);
            RM.Mixer.addRecipe1(
                T,
                16,
                ...
                tStack,
                FL.make("potion.darkcoffee", 750),
                FL.make("potion.darkcafeaulait", 750),
                ZL_IS);
            RM.Mixer.addRecipe1(
                T,
                16,
                48,
                tStack,
                FL.make("potion.darkchocolatemilk", 750),
                FL.make("chocolatemilk", 750),
                ZL_IS);
        ...
        for (ItemStack tStack : ST
            .array(dust.mat(MT.Chili, 1), dustSmall.mat(MT.Chili, 4), dustTiny.mat(MT.Chili, 9))) {
        ...
        for (String tCookingOil : FluidsGT.COOKING_OIL)
            if (FL.exists(tCookingOil)) for (String tVinegar : FluidsGT.VINEGAR) if (FL.exists(tVinegar)) {
                RM.Mixer.addRecipe1(
                    T,
                    16,
                    16,
                    OM.dust(MT.NaCl),
                    FL.array(FL.make(tCookingOil, 100), FL.make(tVinegar, 100)),
                    FL.Dressing.make(250),
                    ZL_IS);
                RM.Mixer.addRecipe2(
                    T,
                    16,
                    32,
                    OM.dust(MT.NaCl),
                    OM.dust(MT.PepperBlack),
                    FL.array(FL.Ketchup.make(250), FL.make(tVinegar, 125)),
                    FL.Sauce_BBQ.make(500),
                    ZL_IS);
            }
        ...
        RM.Mixer.addRecipe0(
            ...
            16,
            16,
            FL.array(FL.Juice_Plum.make(125), FL.Juice_Apple.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Grape_White.make(125), FL.Juice_Apple.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Grape_Green.make(125), FL.Juice_Apple.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Grape_Red.make(125), FL.Juice_Apple.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Grape_Purple.make(125), FL.Juice_Apple.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Grape_White.make(125), FL.Juice_Plum.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Grape_Green.make(125), FL.Juice_Plum.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Grape_Red.make(125), FL.Juice_Plum.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Juice_Grape_Purple.make(125), FL.Juice_Plum.make(125)),
            FL.Med_Laxative.make(250),
            ZL_IS);
        ...
        RM.Mixer.addRecipe0(
            ...
            16,
            16,
            FL.array(FL.Sap_Rainbow.make(125), FL.Ambrosia.make(125)),
            FL.Med_Heal.make(250),
            ZL_IS);

        RM.Mixer
            .addRecipe0(T, 16, 16, FL.array(FL.Ice.make(125), FL.Juice.make(125)), FL.Smoothie_Fruit.make(250), ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Ananas.make(125)),
            FL.Smoothie_Ananas.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Apple.make(125)),
            FL.Smoothie_Apple.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_AppleGrC.make(125)),
            FL.Smoothie_Apple.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Apricot.make(125)),
            FL.Smoothie_Apricot.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Banana.make(125)),
            FL.Smoothie_Banana.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Blackberry.make(125)),
            FL.Smoothie_Blackberry.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Blueberry.make(125)),
            FL.Smoothie_Blueberry.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Cherry.make(125)),
            FL.Smoothie_Cherry.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Cranberry.make(125)),
            FL.Smoothie_Cranberry.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Currant.make(125)),
            FL.Smoothie_Currant.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Elderberry.make(125)),
            FL.Smoothie_Elderberry.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Gooseberry.make(125)),
            FL.Smoothie_Gooseberry.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Grape_Red.make(125)),
            FL.Smoothie_Grape_Red.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Grape_White.make(125)),
            FL.Smoothie_Grape_White.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Grape_Green.make(125)),
            FL.Smoothie_Grape_Green.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Grape_Purple.make(125)),
            FL.Smoothie_Grape_Purple.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Grapefruit.make(125)),
            FL.Smoothie_Grapefruit.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Kiwi.make(125)),
            FL.Smoothie_Kiwi.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Lemon.make(125)),
            FL.Smoothie_Lemon.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Lime.make(125)),
            FL.Smoothie_Lime.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Melon.make(125)),
            FL.Smoothie_Melon.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Orange.make(125)),
            FL.Smoothie_Orange.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Persimmon.make(125)),
            FL.Smoothie_Persimmon.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Peach.make(125)),
            FL.Smoothie_Peach.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Pear.make(125)),
            FL.Smoothie_Pear.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Plum.make(125)),
            FL.Smoothie_Plum.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Raspberry.make(125)),
            FL.Smoothie_Raspberry.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Strawberry.make(125)),
            FL.Smoothie_Strawberry.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Mango.make(125)),
            FL.Smoothie_Mango.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Starfruit.make(125)),
            FL.Smoothie_Starfruit.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Fig.make(125)),
            FL.Smoothie_Fig.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Pomegranate.make(125)),
            FL.Smoothie_Pomegranate.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Papaya.make(125)),
            FL.Smoothie_Papaya.make(250),
            ZL_IS);
        RM.Mixer.addRecipe0(
            T,
            16,
            16,
            FL.array(FL.Ice.make(125), FL.Juice_Coconut.make(125)),
            FL.Smoothie_Coconut.make(250),
            ZL_IS);
        for (String tJuice : FluidsGT.FRUIT_JUICE) if (FL.exists(tJuice)) {
            RM.Mixer.addRecipe0(
                ...
                16,
                16,
                FL.array(FL.Ice.make(125), FL.make(tJuice, 125)),
                FL.Smoothie_Fruit.make(250),
                ZL_IS);
            RM.CryoMixer.addRecipe0(
                T,
                16,
                16,
                FL.array(FL.make(tJuice, 125), FL.Tea_Sweet.make(125)),
                FL.Tea_Ice.make(250),
                ZL_IS);
        }
    }
