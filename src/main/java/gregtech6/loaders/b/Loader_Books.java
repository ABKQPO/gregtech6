...
public class Loader_Books implements Runnable {
    ...
    public void run() {
        ...
        UT.Books.createWrittenBook(
            "Manual_Punch_Cards",
            "Punch Card Manual V0.0",
            "Gregorius Techneticies",
            ST.make(ItemsGT.BOOKS, 1, 1),
            new String[] {
                ...
                "(i1&&i2)?o1=15:o1=0;=10", "ignore all Whitespace Characters, use Long for saving the Numbers",
        ...
        UT.Books.createWrittenBook(
            "Manual_Portal_TF",
            "The Twilight Forest Guide",
            "Gregorius Techneticies",
            ST.make(ItemsGT.BOOKS, 1, 1005),
            new String[] {
                ...
                // Attacking the Minoshroom will result in breaking all Fences around it, making the Bow Method
                // completely useless, unless you replace the Fences with actual Blocks. The Cheese would still work if
                // it wasn't for GT6. This Line will stay to troll people.
                ,
                ...
                "Yeti Cave¶===================¶Should he grapple you like a Pinchbeetle, just hit him until he gives you up and lets you down, so you can run around and desert him."// never
                                                                                                                                                                                     // gonna
                                                                                                                                                                                     // give
                                                                                                                                                                                     // a
                                                                                                                                                                                     // fuck,
        ...
        UT.Books.createWrittenBook(
            "Manual_Enchantments",
            "The vexing World of Enchantments",
            "Evoker Number 42",
            ST.make(ItemsGT.BOOKS, 1, 10),
            new String[] {
        ...
        UT.Books.createWrittenBook(
            "Manual_Hunting_Creeper",
            "Hunting Guide for Creepers",
            "Alex Grylls, Survival Specialist",
            ST.make(ItemsGT.BOOKS, 1, 3),
            new String[] { tAlexGryllsIntro,
        ...
        UT.Books.createWrittenBook(
            "Manual_Hunting_Skeleton",
            "Hunting Guide for Skeletons",
            "Alex Grylls, Survival Specialist",
            ST.make(ItemsGT.BOOKS, 1, 3),
            new String[] { tAlexGryllsIntro,
        ...
        UT.Books.createWrittenBook(
            "Manual_Hunting_Zombie",
            "Hunting Guide for Zombies",
            "Alex Grylls, Survival Specialist",
            ST.make(ItemsGT.BOOKS, 1, 3),
            new String[] { tAlexGryllsIntro,
        ...
        UT.Books.createWrittenBook(
            "Manual_Hunting_Spider",
            "Hunting Guide for Spiders",
            "Alex Grylls, Survival Specialist",
            ST.make(ItemsGT.BOOKS, 1, 3),
            new String[] { tAlexGryllsIntro,
        ...
        UT.Books.createWrittenBook(
            "Manual_Hunting_Blaze",
            "Hunting Guide for Blazes and Ghasts",
            "Alex Grylls, Survival Specialist",
            ST.make(ItemsGT.BOOKS, 1, 3),
            new String[] { tAlexGryllsIntro,
        ...
        UT.Books.createWrittenBook(
            "Manual_Hunting_Witch",
            "Hunting Guide for Witches",
            "Alex Grylls, Survival Specialist",
            ST.make(ItemsGT.BOOKS, 1, 3),
            new String[] { tAlexGryllsIntro,
        ...
        // Having more health than the Ender Dragon or iron golems, the Wither can be quite hard to fight if one is not
        // prepared and taken the necessary precautions.
        // First of all, Withers do not naturally spawn.
        // You must get 4 soul sand from a Nether fortress and 3 wither skeleton skulls.
        // Wither skeleton skulls are dropped by wither skeletons when killed, however, they have only a 2.5% chance of
        // dropping it.
        ...
        // To spawn the wither, one needs to place the soul sand in a t-shaped arrangement (exactly like an iron golem's
        // iron block arrangement).
        // Then, the three wither skulls are placed on the top of each of the three soul sand blocks that are on the top
        // layer.
        // Beware however, once you place the last wither skeleton skull to complete the wither spawning arrangement,
        // the wither will start to spawn.
        ...
        // A bow with Power IV or V, punch, and infinity, Obviously an arrow (or many if you don't have the infinity
        // enchantment),
        ...
        // When you make the arrangement for spawning the wither correctly as said above, you should see a mob appear
        // that is black and has three heads.
        ...
        // Wither is basically the same as poison except you can be killed if your health bar is low and turns your
        // health bar black for its duration so it is slightly hard to see how much health you have.
        ...
        tBook
            .add("Saws" + "¶===================¶Bad for chopping Trees, but can easily cut wooden things like Planks.");
        tBook.add(
            "Chainsaws"
        ...
        UT.Books.createWrittenBook(
            "Manual_Tools",
            "Tool Index",
            "GITF (Gregorius Industrial Tool Factory)",
            ST.make(ItemsGT.BOOKS, 1, tBook.size() > 50 ? 32001 : 32000),
        ...
        tBook.add(
            "Tiny Plate"
                + "¶===================¶OOOOO¶OXXXO¶OXXXO¶OXXXO¶OOOOO¶===================¶0.111 Units required");
        tBook.add(
            "Bolt" + "¶===================¶XXOOO¶OOOOO¶OOOOO¶OOOOO¶OOOOO¶===================¶0.125 Units required");
        tBook
            .add("Rod" + "¶===================¶OOOOO¶OOOOO¶XXXXX¶OOOOO¶OOOOO¶===================¶0.500 Units required");
        tBook.add(
            "Long Rod" + "¶===================¶XOOOO¶OXOOO¶OOXOO¶OOOXO¶OOOOX¶===================¶1.000 Units required");
        tBook.add(
            "Item Casing"
                + "¶===================¶XXXOX¶XXXOX¶XXXOX¶OOOOX¶XXXOO¶===================¶0.500 Units required");
        tBook.add(
        ...
        tBook.add(
            "Small Gear"
                + "¶===================¶OXOXO¶XXXXX¶OXOXO¶XXXXX¶OXOXO¶===================¶1.000 Units required");
        tBook.add(
        ...
        tBook.add(
            "Universal Spade"
                + "¶===================¶OOXOO¶OXXXO¶OXXOO¶OXXXO¶OOOOO¶===================¶1.000 Units required");
        tBook
            .add("Axe" + "¶===================¶OOOOO¶OXXXO¶OXXXO¶OXOOO¶OOOOO¶===================¶3.000 Units required");
        tBook.add(
            "Double Axe"
                + "¶===================¶OOOOO¶XXXXX¶XXXXX¶XOOOX¶OOOOO¶===================¶5.000 Units required");
        tBook
            .add("Saw" + "¶===================¶OOOOO¶XXXXX¶XXXXX¶OOOOO¶OOOOO¶===================¶2.000 Units required");
        tBook.add(
        ...
        tBook.add(
            "Screwdriver"
                + "¶===================¶OOOOO¶OOXOO¶OOXOO¶OOXOO¶OOXOO¶===================¶1.000 Units required");
        tBook.add(
            "Chisel" + "¶===================¶OXXXO¶OOXOO¶OOXOO¶OOXOO¶OOXOO¶===================¶1.500 Units required");
        tBook.add(
            "Arrow" + "¶===================¶OOOOO¶OOXOO¶OOXOO¶OXXXO¶OOOOO¶===================¶0.125 Units required");
        tBook
            .add("Hoe" + "¶===================¶OOOOO¶OOXXO¶OXXXO¶OOOOO¶OOOOO¶===================¶2.000 Units required");
        tBook.add(
            "Sense/Scythe"
                + "¶===================¶OOOOO¶OXXXX¶XXXXX¶OOOOO¶OOOOO¶===================¶3.000 Units required");
        tBook.add(
            "Plow" + "¶===================¶XXXXX¶XXXXX¶XXXXX¶XXXXX¶OOXOO¶===================¶4.000 Units required");
        tBook.add(
            "Builder's Wand"
                + "¶===================¶OOXOO¶XXXXX¶OXXXO¶OXOXO¶OOOOO¶===================¶1.000 Units required");

        UT.Books.createWrittenBook(
            "Manual_Smeltery",
            "Smelting Crucible Manual",
            "GMWI (Gregorius Metal Working Industries)",
            ST.make(ItemsGT.BOOKS, 1, tBook.size() > 50 ? 32001 : 32000),
            tBook.toArray(ZL_STRING));
        ...
        tBook.clear();
        tBook.add(
            "This Book Contains Information about every Alloy, which can be created by using a Smelting Crucible.¶===================¶In order to make an Alloy you need to reach the Melting Point of the Alloy itself.");
        tBook.add(
            "And you need to reach the Melting Point of all but one of its Components. You can ofcourse also melt all of the Components, but you are free to 'not melt' one of the Components.");
        tBook.add(
            "In case you have to supply Air for the Crucible (for Steel), you need to point an Engine into it, which will act as a Fan. For Multiblock Crucibles the Engine has to be at the Bottom Row.");

        for (OreDictMaterial tMat : OreDictMaterial.ALLOYS) {
            for (IOreDictConfigurationComponent tComponents : tMat.mAlloyCreationRecipes) {
                tPage = "Alloy:¶" + tMat.getLocal()
                    + "¶===================¶Melting: "
                    + tMat.mMeltingPoint
                    + " K¶Boiling: "
                    + tMat.mBoilingPoint
                    + " K¶===================¶Components per "
                    + tComponents.getCommonDivider()
                    + "¶";
        ...
        UT.Books.createWrittenBook(
            "Manual_Alloys",
            "Book of Alloys, Smeltery Edition (" + (tBook.size() - 2) + ")",
            "GMWI (Gregorius Metal Working Industries)",
            ST.make(ItemsGT.BOOKS, 1, tBook.size() > 50 ? 32001 : 32000),
            tBook.toArray(ZL_STRING));
        ...
        for (OreDictMaterial tMat : OreDictMaterial.MATERIAL_ARRAY) {
            if (tMat != null && !tMat.mHidden
                && tMat.contains(TD.Atomic.ELEMENT)
                && !tMat.contains(TD.Atomic.ANTIMATTER)) {
                tBook.add(
                    tMat.getLocal() + "¶"
                        + tMat.mProtons
                        + "/"
                        ...
                        + tMat.mPlasmaPoint
                        + " K¶===================¶Density:¶"
                        + (tMat.mGramPerCubicCentimeter == 0 ? "???" : tMat.mGramPerCubicCentimeter)
                        + " g/cm3¶"
                        + tMat.getWeight(U)
                        + " kg/unit¶===================¶");
            }
        ...
        UT.Books.createWrittenBook(
            "Manual_Elements",
            "Book of Periods (" + tBook.size() + ")",
            "GCC (Gregorius Chemical Consortium)",
            ST.make(ItemsGT.BOOKS, 1, tBook.size() > 50 ? 32001 : 32000),
            tBook.toArray(ZL_STRING));
        ...
        UT.Books.createWrittenBook(
            "Manual_Extenders",
            "Extenders & Filters",
            "GAD (Gregorius Automation Distributions)",
            ST.make(ItemsGT.BOOKS, 1, 32000),
            new String[] {
        ...
        UT.Books.createWrittenBook(
            "Manual_Reactors",
            "Fission Reactor Manual",
            "Apature Atomics",
            ST.make(ItemsGT.BOOKS, 1, 32005),
            new String[] { "¶¶===================¶Introduction and Safety Instructions¶===================¶",
        ...
        for (int i = 1; i < OreDictMaterial.MATERIAL_ARRAY.length; i++) {
            if (OreDictMaterial.MATERIAL_ARRAY[i] != null && OreDictMaterial.MATERIAL_ARRAY[i].mID == i
                && (!OreDictMaterial.MATERIAL_ARRAY[i].mHidden
                    || OreDictMaterial.MATERIAL_ARRAY[i].mDescription != null)) {
                ...
                CR.shaped(
                    ...
                    " X ",
                    'B',
                    ST.make(Items.writable_book, 1, W),
                    'X',
                    OP.gem.dat(OreDictMaterial.MATERIAL_ARRAY[i]));
                CR.shaped(
                    tStack,
                    CR.DEF_NCC,
                    "lX ",
                    ...
                    ST.make(Items.writable_book, 1, W),
                    'X',
                    OP.dust.dat(OreDictMaterial.MATERIAL_ARRAY[i]));
                CR.shaped(
                    tStack,
                    CR.DEF_NCC,
                    "lX ",
                    ...
                    ST.make(Items.writable_book, 1, W),
                    'X',
                    OP.ingot.dat(OreDictMaterial.MATERIAL_ARRAY[i]));
                CR.shaped(
                    tStack,
                    CR.DEF_NCC,
                    "lX ",
                    ...
                    ST.make(Items.writable_book, 1, W),
                    'X',
                    OP.plate.dat(OreDictMaterial.MATERIAL_ARRAY[i]));
                CR.shaped(
                    tStack,
                    CR.DEF_NCC,
                    "lX ",
                    ...
                    ST.make(Items.writable_book, 1, W),
                    'X',
                    OP.plateGem.dat(OreDictMaterial.MATERIAL_ARRAY[i]));
                CR.shaped(
                    tStack,
                    CR.DEF_NCC,
                    "lX ",
                    ...
                    ST.make(Items.writable_book, 1, W),
                    'X',
                    OP.crushedCentrifuged.dat(OreDictMaterial.MATERIAL_ARRAY[i]));
                CR.shaped(
                    tStack,
                    CR.DEF_NCC,
                    "lX ",
                    ...
                    ST.make(Items.writable_book, 1, W),
                    'X',
                    OP.bucket.dat(OreDictMaterial.MATERIAL_ARRAY[i]));
                CR.shaped(
                    tStack,
                    CR.DEF_NCC,
                    "lX ",
                    ...
                    ST.make(Items.writable_book, 1, W),
                    'X',
                    OP.chemtube.dat(OreDictMaterial.MATERIAL_ARRAY[i]));
            }
        }
    }
}
