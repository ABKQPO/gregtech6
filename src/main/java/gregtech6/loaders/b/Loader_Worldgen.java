...
public class Loader_Worldgen implements Runnable {
    ...
    public void run() {
        ...
        new WorldgenStoneLayers(
            "stonelayers",
            T,
            GEN_GT,
            GEN_ENVM_GT,
            GEN_A97_GT,
            GEN_CW2_AquaCavern_GT,
            GEN_CW2_Caveland_GT,
            GEN_CW2_Cavenia_GT,
            GEN_CW2_Cavern_GT,
            GEN_CW2_Caveworld_GT); // MUST BE FIRST

        StoneLayer.DEEPSLATE = new StoneLayer(
            BlocksGT.Slate,
            MT.STONES.Deepslate,
            IL.EtFu_Deepslate.block(),
            0,
            IL.EtFu_Deepslate_Cobble.block(),
            0,
            ...
            new StoneLayerOres(
                ...
                0,
                12,
                ST.block(MD.EtFu, "deepslate_diamond_ore"),
                BIOMES_JUNGLE,
                BIOMES_VOLCANIC),
            new StoneLayerOres(
                MT.Lapis,
                ...
                16,
                24,
                ST.block(MD.EtFu, "deepslate_lapis_ore"),
                BIOMES_FROZEN,
                BIOMES_TAIGA),
            new StoneLayerOres(
                MT.Amethyst,
                ...
                0,
                32,
                ST.block(MD.EtFu, "deepslate_bluepower_ore"),
                3,
                BIOMES_FROZEN),
            ...
            new StoneLayerOres(
                MT.OREMATS.Malachite,
                F,
                U64,
                0,
                32,
                ST.block(MD.EtFu, "deepslate_bop_ore"),
                4,
                BIOMES_SWAMP),
            new StoneLayerOres(
                MT.BlueSapphire,
            ...
            new StoneLayerOres(
                ...
                16,
                24,
                ST.block(MD.EtFu, "deepslate_thaumcraft_ore"),
                7,
                BIOMES_OCEAN_BEACH),
            new StoneLayerOres(
                MT.BlueTopaz,
                ...
                0,
                32,
                ST.block(MD.EtFu, "deepslate_am2_ore"),
                2,
                BIOMES_DARK_FOREST),
            ...
            new StoneLayerOres(
                ...
                0,
                32,
                ST.block(MD.EtFu, "deepslate_copper_ore"),
                BIOMES_DESERT,
                BIOMES_SAVANNA),
            new StoneLayerOres(
                MT.OREMATS.Cassiterite,
                F,
                U16,
                0,
                32,
            ...
            new StoneLayerOres(
                ...
                BIOMES_SWAMP),
            new StoneLayerOres(
                MT.OREMATS.BrownLimonite,
                F,
                U16,
                0,
                32,
                ST.block(MD.EtFu, "deepslate_iron_ore"),
                BIOMES_SHROOM),
            new StoneLayerOres(
                MT.OREMATS.YellowLimonite,
                F,
                U16,
                0,
                32,
            ...
            new StoneLayerOres(
                ...
                0,
                32,
                ST.block(MD.EtFu, "deepslate_coal_ore"),
                BIOMES_PLAINS,
                BIOMES_SHROOM),
            ...
            !MT.Nikolite.mHidden
                ? new StoneLayerOres(
                    ...
                    0,
                    20,
                    ST.block(MD.EtFu, "deepslate_projred_ore"),
                    3,
                    ST.block(MD.EtFu, "deepslate_bluepower_ore"),
                    0)
                : null,
            MD.DE.mLoaded
                ? new StoneLayerOres(MT.Draconium, F, U64, 0, 7, ST.block(MD.EtFu, "deepslate_draconium_ore"), 0)
                : null,
        ...
        StoneLayer.LAYERS
            .add(new StoneLayer(null, MT.Stone, ST.block(MD.PFAA, "weakStone"), 0, ST.block(MD.PFAA, "weakRubble"), 0));
        StoneLayer.LAYERS
            .add(new StoneLayer(null, MT.Stone, ST.block(MD.PFAA, "weakStone"), 1, ST.block(MD.PFAA, "weakRubble"), 1));
        StoneLayer.LAYERS
            .add(new StoneLayer(null, MT.Stone, ST.block(MD.PFAA, "weakStone"), 2, ST.block(MD.PFAA, "weakRubble"), 2));
        StoneLayer.LAYERS
            .add(new StoneLayer(null, MT.Stone, ST.block(MD.PFAA, "weakStone"), 3, ST.block(MD.PFAA, "weakRubble"), 3));
        StoneLayer.LAYERS.add(
            new StoneLayer(null, MT.Stone, ST.block(MD.PFAA, "mediumStone"), 2, ST.block(MD.PFAA, "mediumCobble"), 2));
        StoneLayer.LAYERS.add(
            new StoneLayer(null, MT.Stone, ST.block(MD.PFAA, "mediumStone"), 4, ST.block(MD.PFAA, "mediumCobble"), 4));
        StoneLayer.LAYERS.add(
            new StoneLayer(null, MT.Stone, ST.block(MD.PFAA, "strongStone"), 6, ST.block(MD.PFAA, "strongCobble"), 6));
        StoneLayer.LAYERS.add(
            new StoneLayer(
                null,
                MT.Stone,
                ST.block(MD.PFAA, "veryStrongStone"),
                2,
                ST.block(MD.PFAA, "veryStrongCobble"),
                2));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                null,
                MT.STONES.Chert,
                ST.block(MD.EB, "enhancedbiomes.tile.stoneEB"),
                10,
                ST.block(MD.EB, "enhancedbiomes.tile.stoneCobbleEB"),
                10));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                null,
                MT.STONES.Eclogite,
                ST.block(MD.UB, "metamorphicStone"),
                1 + 8,
                ST.block(MD.UB, "metamorphicCobblestone"),
                1));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                null,
                MT.STONES.Dacite,
                ST.block(MD.UB, "igneousStone"),
                7 + 8,
                ST.block(MD.UB, "igneousCobblestone"),
                7,
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                ...
                MD.DRPG.mLoaded ? new StoneLayerOres(MT.UNUSED.Arlemite, U96, 5, 60, ST.block(MD.DRPG, "arlemiteOre"))
                    : null,
                MD.DRPG.mLoaded ? new StoneLayerOres(MT.UNUSED.Realmite, U96, 5, 60, ST.block(MD.DRPG, "realmiteOre"))
                    : null));
        StoneLayer.LAYERS.add(
            new StoneLayer(
                null,
                MD.HBM.mLoaded
                    ? new StoneLayerOres(MT.OREMATS.Uraninite, U16, 0, 48, ST.block(MD.HBM, "tile.ore_uranium"), 0)
                    : null,
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                null,
                MD.HEX.mLoaded ? new StoneLayerOres(MT.HexoriumRed, U64, 0, 64, ST.block(MD.HEX, "blockHexoriumOreRed"))
                    : null,
                MD.HEX.mLoaded
                    ? new StoneLayerOres(MT.HexoriumGreen, U64, 0, 64, ST.block(MD.HEX, "blockHexoriumOreGreen"))
                    : null,
                MD.HEX.mLoaded
                    ? new StoneLayerOres(MT.HexoriumBlue, U64, 0, 64, ST.block(MD.HEX, "blockHexoriumOreBlue"))
                    : null,
                MD.HEX.mLoaded
                    ? new StoneLayerOres(MT.HexoriumBlack, U64, 0, 20, ST.block(MD.HEX, "blockHexoriumOreBlack"))
                    : null,
                MD.HEX.mLoaded
                    ? new StoneLayerOres(MT.HexoriumWhite, U64, 0, 20, ST.block(MD.HEX, "blockHexoriumOreWhite"))
                    : null,
                MD.DRPG.mLoaded ? new StoneLayerOres(MT.UNUSED.Rupee, U96, 5, 60, ST.block(MD.DRPG, "rupeeOre")) : null,
                MD.DRPG.mLoaded ? new StoneLayerOres(MT.UNUSED.Arlemite, U96, 5, 60, ST.block(MD.DRPG, "arlemiteOre"))
                    : null,
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Basalt,
                MT.STONES.Basalt,
                ST.block(MD.PR_EXPLORATION, "projectred.exploration.stone"),
                3,
                ST.block(MD.PR_EXPLORATION, "projectred.exploration.stone"),
                2));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Basalt,
                MT.STONES.Basalt,
                ST.block(MD.PFAA, "strongStone"),
                1,
                ST.block(MD.PFAA, "strongCobble"),
                1));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Basalt,
                MT.STONES.Basalt,
                ST.block(MD.HBM, "tile.basalt_smooth"),
                0,
                ST.block(MD.HBM, "tile.basalt"),
                0,
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Limestone,
                MT.Dolomite,
                ST.block(MD.UB, "sedimentaryStone"),
                5 + 8,
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Limestone,
                MT.STONES.Limestone,
                ST.block(MD.PFAA, "mediumStone"),
                0,
                ST.block(MD.PFAA, "mediumCobble"),
                0));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Limestone,
                MT.STONES.Limestone,
                ST.block(MD.CHSL, "limestone"),
                new StoneLayerOres(
                    MT.NaCl,
                    U8,
                    40,
                    80,
                    ST.block(MD.CHSL, "limestone") == NB ? NB : ST.block(MD.HaC, "salt"))));
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Limestone,
                MT.STONES.Limestone,
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.GraniteBlack,
                MT.STONES.GraniteBlack,
                ST.block(MD.PFAA, "strongStone"),
                3,
                ST.block(MD.PFAA, "strongCobble"),
                3));
        ...
        StoneLayer.LAYERS
            .add(new StoneLayer(BlocksGT.Granite, MT.Lignite, ST.block(MD.UB, "sedimentaryStone"), 4 + 8).setNoDeep());
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                null,
                MT.STONES.Gneiss,
                ST.block(MD.HBM, "tile.stone_gneiss"),
                ...
                MD.HBM.mLoaded
                    ? new StoneLayerOres(MT.OREMATS.Uraninite, U16, 0, 48, ST.block(MD.HBM, "tile.ore_gneiss_uranium"))
                    : null));

        StoneLayer.LAYERS.add(
            new StoneLayer(
                null,
                MT.STONES.Pinkschist,
                ST.block(MD.PFAA, "mediumStone"),
                1,
                ST.block(MD.PFAA, "mediumCobble"),
                1));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.SchistGreen,
                MT.STONES.Greenschist,
                ST.block(MD.UB, "metamorphicStone"),
                5 + 8,
                ST.block(MD.UB, "metamorphicCobblestone"),
                5));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Shale,
                MT.STONES.Shale,
                ST.block(MD.PFAA, "weakStone"),
                4,
                ST.block(MD.PFAA, "weakRubble"),
                4));
        ...
        StoneLayer.LAYERS
            .add(new StoneLayer(BlocksGT.Shale, MT.STONES.Shale, ST.block(MD.UB, "sedimentaryStone"), 2 + 8));
        ...
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Slate,
                MT.STONES.Slate,
                ST.block(MD.SC2, "BlockLightSlate"),
                0,
                ST.block(MD.SC2, "BlockLightSlate"),
                3));
        StoneLayer.LAYERS.add(
        ...
        StoneLayer.LAYERS
            .add(new StoneLayer(BlocksGT.Quartzite, MT.STONES.Siltstone, ST.block(MD.UB, "sedimentaryStone"), 3 + 8));
        StoneLayer.LAYERS.add(
            new StoneLayer(
                BlocksGT.Quartzite,
                MT.STONES.Quartzite,
        ...
        StoneLayer.bothsides(
            ...
            new StoneLayerOres(MT.Amber, U8, 30, 70, BIOMES_RIVER_LAKE),
            new StoneLayerOres(MT.AmberDominican, U8, 30, 70, BIOMES_SHROOM));
        StoneLayer.bothsides(MT.STONES.Komatiite, MT.STONES.Basalt, new StoneLayerOres(MT.OREMATS.Perlite, U4, 0, 16));
        StoneLayer.bothsides(MT.STONES.Gabbro, MT.STONES.Basalt, new StoneLayerOres(MT.OREMATS.Perlite, U4, 0, 16));
        StoneLayer.bothsides(
            MT.STONES.Limestone,
            MT.STONES.Basalt,
            new StoneLayerOres(MT.OREMATS.Ilmenite, U8, 0, 32),
            new StoneLayerOres(MT.TiO2, U12, 0, 32));
        StoneLayer.topbottom(
            MT.Dolomite,
            MT.STONES.Diorite,
            new StoneLayerOres(MT.Opal, U64, 48, 64),
            new StoneLayerOres(MT.OREMATS.Diatomite, U16, 16, 64));
        StoneLayer.bothsides(MT.Dolomite, MT.KCl, new StoneLayerOres(MT.KIO3, U12, 32, 64));
        StoneLayer.bothsides(
            MT.Dolomite,
            MT.STONES.Quartzite,
        ...
        StoneLayer.bothsides(MT.Talc, MT.NaCl, new StoneLayerOres(MT.OREMATS.Borax, U8, 16, 48));
        StoneLayer.bothsides(
            MT.Chalk,
            MT.STONES.Quartzite,
        ...
        StoneLayer
            .bothsides(MT.STONES.Rhyolite, MT.STONES.Quartzite, new StoneLayerOres(MT.OREMATS.Alunite, U4, 32, 80));
        StoneLayer.bothsides(
            MT.STONES.Gneiss,
            MT.Gypsum,
            new StoneLayerOres(MT.OREMATS.Mirabilite, U8, 16, 64),
            new StoneLayerOres(MT.OREMATS.Trona, U8, 16, 64));
        // This Line was duplicated and I do not remember which part of it was supposed to be changed to a different
        // Material...
        // StoneLayer.bothsides(MT.STONES.Gneiss, MT.Gypsum
        // , new StoneLayerOres(MT.OREMATS.Mirabilite , U8 , 16, 64)
        // , new StoneLayerOres(MT.OREMATS.Trona , U8 , 16, 64)
        // );
        StoneLayer.bothsides(MT.STONES.Granite, MT.NaCl, new StoneLayerOres(MT.OREMATS.Zeolite, U8, 16, 48));
        StoneLayer.bothsides(MT.STONES.Granite, MT.KCl, new StoneLayerOres(MT.OREMATS.Pollucite, U8, 16, 48));
        StoneLayer.bothsides(
            MT.STONES.GraniteRed,
            MT.STONES.Gneiss,
        ...
        StoneLayer.bothsides(MT.STONES.GraniteBlack, MT.STONES.Granite, new StoneLayerOres(MT.Zircon, U24, 0, 32));
        StoneLayer.bothsides(MT.STONES.GraniteBlack, MT.STONES.GraniteRed, new StoneLayerOres(MT.Zircon, U24, 0, 32));

        new WorldgenOcean("ocean.seawater", T, GEN_OVERWORLD, GEN_GT, GEN_PFAA); // IT IS IMPORTANT THAT OCEAN COMES
                                                                                 // BEFORE RIVER AND SWAMP!!!
        new WorldgenRiver("river.riverwater", T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT); // IT IS IMPORTANT THAT
                                                                                                 // RIVER COMES AFTER
                                                                                                 // OCEAN AND BEFORE
                                                                                                 // SWAMP!!!
        new WorldgenSwamp("swamp.dirtywater", T, GEN_OVERWORLD, GEN_GT, GEN_PFAA, GEN_TWILIGHT, GEN_EREBUS); // IT IS
                                                                                                             // IMPORTANT
                                                                                                             // THAT
                                                                                                             // SWAMP
                                                                                                             // COMES
        ...
        if (MD.PFAA.mLoaded) {
            tChance = 512;
            new WorldgenPit(
                "pit.clay.pfaa.lateric",
                T,
                ST.block(MD.PFAA, "weakClay"),
                0,
                1,
                tChance,
                GEN_OVERWORLD,
                ...
                GEN_ALFHEIM);
            new WorldgenPit(
                "pit.clay.pfaa.bentonite",
                T,
                ST.block(MD.PFAA, "weakOreClay"),
                1,
                1,
                tChance,
                GEN_OVERWORLD,
        ...
        new WorldgenPit(
            ...
            GEN_TWILIGHT,
            GEN_TROPICS,
            GEN_ALFHEIM); // Disabled by default because it's supposed to be only in the Nether
        new WorldgenPit(
            "pit.clay.yellow",
            T,
            BlocksGT.Diggables,
        ...
        for (BlockBase tStone : BlocksGT.stones)
            if (tStone != BlocksGT.PrismarineDark && tStone != BlocksGT.PrismarineLight) {
                new WorldgenStone(
                    "overworld.stone." + ((BlockStones) tStone).mMaterial.mNameInternal.toLowerCase(),
                    F,
                    tStone,
                    0,
                    1,
                    ...
                    GEN_CW2_Caveworld);
                new WorldgenStone(
                    "nether.stone." + ((BlockStones) tStone).mMaterial.mNameInternal.toLowerCase(),
                    F,
                    tStone,
                    0,
                    1,
                    ...
                    GEN_NETHER);
                new WorldgenStone(
                    "twilight.stone." + ((BlockStones) tStone).mMaterial.mNameInternal.toLowerCase(),
                    T,
                    tStone,
                    0,
                    1,
                    ...
                    GEN_TWILIGHT);
                new WorldgenStone(
                    "erebus.stone." + ((BlockStones) tStone).mMaterial.mNameInternal.toLowerCase(),
                    T,
                    tStone,
                    0,
                    1,
                    ...
                    GEN_EREBUS);
                new WorldgenStone(
                    "atum.stone." + ((BlockStones) tStone).mMaterial.mNameInternal.toLowerCase(),
                    T,
                    tStone,
                    0,
                    1,
                    ...
                    GEN_ATUM);
                new WorldgenStone(
                    "tropics.stone." + ((BlockStones) tStone).mMaterial.mNameInternal.toLowerCase(),
                    T,
                    tStone,
                    0,
                    1,
        ...
        Block tBlock = BlocksGT.RockOres;
        if (tBlock != null && tBlock != NB) {
            new WorldgenOresVanilla(
                "twilight.ore.anthracite",
                T,
                tBlock,
                0,
                1,
        ...
        new WorldgenOresBedrock(
            "ore.bedrock.tungstate",
            T,
            T,
            96000,
            MT.OREMATS.Tungstate,
            BlocksGT.FlowersB,
            7,
            GEN_FLOOR);
        new WorldgenOresBedrock(
            "ore.bedrock.ferberite",
            T,
            T,
            96000,
            MT.OREMATS.Ferberite,
            BlocksGT.FlowersB,
            7,
            GEN_FLOOR);
        new WorldgenOresBedrock(
            "ore.bedrock.wolframite",
            T,
            T,
            96000,
            MT.OREMATS.Wolframite,
            BlocksGT.FlowersB,
            7,
            GEN_FLOOR);
        new WorldgenOresBedrock(
            "ore.bedrock.stolzite",
            T,
            T,
            96000,
            MT.OREMATS.Stolzite,
        ...
        new WorldgenOresBedrock(
            ...
            GEN_FLOOR);
        new WorldgenOresBedrock(
            "ore.bedrock.huebnerite",
            T,
            T,
            96000,
            MT.OREMATS.Huebnerite,
            BlocksGT.FlowersB,
            7,
            GEN_FLOOR);
        new WorldgenOresBedrock(
            "ore.bedrock.russelite",
            T,
            T,
            96000,
            MT.OREMATS.Russellite,
            BlocksGT.FlowersB,
            7,
            GEN_FLOOR);
        new WorldgenOresBedrock(
            "ore.bedrock.pinalite",
            T,
            T,
            96000,
            MT.OREMATS.Pinalite,
        ...
        new WorldgenOresBedrock(
            ...
            GEN_FLOOR);
        new WorldgenOresBedrock(
            "ore.bedrock.pitchblende",
            T,
            T,
            60000,
            MT.OREMATS.Pitchblende,
            BlocksGT.FlowersB,
            5,
            GEN_FLOOR);
        ...
        new WorldgenOresBedrock("ore.bedrock.monazite", T, T, 16000, MT.Monazite, BlocksGT.FlowersA, 7, GEN_FLOOR); // TODO
                                                                                                                    // Rare
                                                                                                                    // Earth
                                                                                                                    // Flower
        new WorldgenOresBedrock(
            "ore.bedrock.powellite",
            T,
            T,
            14000,
            MT.OREMATS.Powellite,
            BlocksGT.FlowersA,
            7,
            GEN_FLOOR); // Molybdenum Flower? I think I should just keep this one as Orechid.
        new WorldgenOresBedrock(
            "ore.bedrock.bastnasite",
            T,
            T,
            8000,
            MT.OREMATS.Bastnasite,
            BlocksGT.FlowersA,
            7,
            GEN_FLOOR); // TODO Rare Earth Flower
        new WorldgenOresBedrock(
            "ore.bedrock.stibnite",
            T,
            T,
            8000,
            MT.OREMATS.Arsenopyrite,
            BlocksGT.FlowersB,
            0,
            GEN_FLOOR);
        new WorldgenOresBedrock("ore.bedrock.redstone", T, T, 7000, MT.Redstone, BlocksGT.FlowersB, 4, GEN_FLOOR);
        new WorldgenOresBedrock("ore.bedrock.vanadium", T, T, 6000, MT.V2O5, BlocksGT.FlowersA, 7, GEN_FLOOR); // TODO
                                                                                                               // Vanadium
                                                                                                               // Flower
        new WorldgenOresBedrock("ore.bedrock.galena", T, T, 6000, MT.OREMATS.Galena, BlocksGT.FlowersA, 1, GEN_FLOOR);
        new WorldgenOresBedrock("ore.bedrock.coal", T, T, 5000, MT.Coal, BlocksGT.FlowersA, 7, GEN_FLOOR); // TODO
                                                                                                           // Coal/Carbon
                                                                                                           // Flower
        new WorldgenOresBedrock("ore.bedrock.graphite", T, T, 5000, MT.Graphite, BlocksGT.FlowersA, 7, GEN_FLOOR); // TODO
                                                                                                                   // Coal/Carbon
                                                                                                                   // Flower
        new WorldgenOresBedrock(
            "ore.bedrock.stibnite",
            ...
            1,
            GEN_FLOOR);
        new WorldgenOresBedrock("ore.bedrock.hematite", T, T, 4000, MT.Fe2O3, BlocksGT.FlowersA, 7, GEN_FLOOR); // TODO
                                                                                                                // Iron
                                                                                                                // Flower
        new WorldgenOresBedrock(
            "ore.bedrock.sphalerite",
            T,
            T,
            3000,
            MT.OREMATS.Sphalerite,
        ...
        new WorldgenOresBedrock(
            ...
            4,
            GEN_FLOOR);
        new WorldgenOresBedrock("ore.bedrock.saltpeter", T, T, 3000, MT.Niter, BlocksGT.FlowersA, 7, GEN_FLOOR); // TODO
                                                                                                                 // Niter
                                                                                                                 // Flower
        new WorldgenOresBedrock("ore.bedrock.bauxite", T, T, 2000, MT.OREMATS.Bauxite, BlocksGT.FlowersA, 7, GEN_FLOOR); // TODO
                                                                                                                         // Aluminium
                                                                                                                         // Flower
        new WorldgenOresBedrock(
            "ore.bedrock.cassiterite",
            T,
            T,
            2000,
            MT.OREMATS.Cassiterite,
            BlocksGT.FlowersA,
            7,
            GEN_FLOOR); // TODO Tin Flower
        new WorldgenOresBedrock(
            "ore.bedrock.chalcopyrite",
            T,
            T,
            2000,
        ...
        for (int i = 0, j = ConfigsGT.WORLDGEN.get(ConfigCategories.general, "AmountOfCustomBedrockOreSlots", 0); i
            < j; i++) {
            new WorldgenOresBedrock(
                "ore.bedrock.custom" + (i < 10 ? "0" : "") + i,
                F,
                T,
                100000,
                MT.NULL,
        ...
        new WorldgenFluidSpring(
            "overworld.fluid.oil.extraheavy",
            T,
            BlocksGT.OilExtraHeavy,
            15,
            400,
            2,
            tInfiniteOil ? FL.Oil_ExtraHeavy.make(6000) : NF,
            GEN_OVERWORLD,
            GEN_GT,
            GEN_PFAA,
            GEN_A97,
            ...
            GEN_TFC);
        new WorldgenFluidSpring(
            "overworld.fluid.oil.heavy",
            T,
            BlocksGT.OilHeavy,
            15,
            400,
            2,
            tInfiniteOil ? FL.Oil_Heavy.make(6000) : NF,
            GEN_OVERWORLD,
            GEN_GT,
            GEN_PFAA,
            GEN_A97,
            ...
            GEN_TFC);
        new WorldgenFluidSpring(
            "overworld.fluid.oil.medium",
            T,
            BlocksGT.OilMedium,
            15,
            400,
            2,
            tInfiniteOil ? FL.Oil_Medium.make(6000) : NF,
            GEN_OVERWORLD,
            GEN_GT,
            GEN_PFAA,
            GEN_A97,
            ...
            GEN_TFC);
        new WorldgenFluidSpring(
            "overworld.fluid.oil.light",
            T,
            BlocksGT.OilLight,
            15,
            400,
            2,
            tInfiniteOil ? FL.Oil_Light.make(6000) : NF,
            GEN_OVERWORLD,
            GEN_GT,
            GEN_PFAA,
            GEN_A97,
            ...
            GEN_TFC);
        new WorldgenFluidSpring(
            "overworld.fluid.gas.natural",
            T,
            BlocksGT.GasNatural,
            15,
            200,
            1,
            tInfiniteGas ? FL.Gas_Natural.make(3000) : NF,
            GEN_OVERWORLD,
            GEN_GT,
            GEN_PFAA,
            GEN_A97,
            ...
            GEN_TFC);
        new WorldgenFluidSpring(
            "overworld.fluid.water",
            T,
            BlocksGT.WaterGeothermal,
            15,
            100,
            3,
            FL.Water_Geothermal.make(500),
            GEN_OVERWORLD,
            GEN_GT,
            GEN_PFAA,
            GEN_A97,
        ...
        new WorldgenFluidSpring(
            ...
            GEN_ENVM);
        new WorldgenFluidSpring(
            "atum.fluid.oil.extraheavy",
            T,
            BlocksGT.OilExtraHeavy,
            15,
            200,
            2,
            tInfiniteOil ? FL.Oil_ExtraHeavy.make(2000) : NF,
            GEN_ATUM);
        new WorldgenFluidSpring(
            "atum.fluid.oil.heavy",
            T,
            BlocksGT.OilHeavy,
            15,
            200,
            2,
            tInfiniteOil ? FL.Oil_Heavy.make(2000) : NF,
            GEN_ATUM);
        new WorldgenFluidSpring(
            "atum.fluid.oil.medium",
            T,
            BlocksGT.OilMedium,
            15,
            200,
            2,
            tInfiniteOil ? FL.Oil_Medium.make(2000) : NF,
            GEN_ATUM);
        new WorldgenFluidSpring(
            "atum.fluid.oil.light",
            T,
            BlocksGT.OilLight,
            15,
            200,
            2,
            tInfiniteOil ? FL.Oil_Light.make(2000) : NF,
            GEN_ATUM);
        new WorldgenFluidSpring(
            "erebus.fluid.gas.natural",
            T,
            BlocksGT.GasNatural,
            15,
            200,
            1,
            tInfiniteGas ? FL.Gas_Natural.make(1000) : NF,
            GEN_EREBUS);
        new WorldgenFluidSpring(
            "betweenlands.fluid.gas.natural",
            T,
            BlocksGT.GasNatural,
            15,
            200,
        ...
        new WorldgenOresSmall(
            ...
            GEN_AETHER);
        new WorldgenOresSmall(
            "ore.small.sperrylite",
            T,
            20,
            40,
            4,
            MT.OREMATS.Sperrylite,
            GEN_END,
            GEN_ASTEROIDS,
            GEN_ALFHEIM,
            GEN_AETHER);
        ...
        new WorldgenOresSmall(
            "ore.small.ancientdebris",
            !IL.Ancient_Debris.exists(),
            5,
            90,
            16,
            MT.AncientDebris,
        ...
        new WorldgenOresSmall(
            ...
            GEN_END);
        new WorldgenOresSmall(
            "ore.small.bischofite",
            MD.IHL.mLoaded,
            40,
            80,
            1,
            MT.OREMATS.Bischofite,
            GEN_OVERWORLD,
            GEN_GT,
            GEN_PFAA,
            GEN_A97,
        ...
        new WorldgenOresSmall(
            ...
            GEN_ATUM);
        new WorldgenOresSmall(
            "ore.small.potassiumfeldspar",
            MD.IHL.mLoaded,
            40,
            80,
            1,
            MT.PotassiumFeldspar,
            GEN_OVERWORLD,
            GEN_GT,
            GEN_PFAA,
            GEN_A97,
        ...
        for (OreDictMaterial tGem : OreDictMaterial.MATERIAL_ARRAY)
            if (tGem != null && tGem.contains(TD.Properties.RANDOM_SMALL_GEM_ORE)) {
                new WorldgenOresSmall("ore.small." + tGem.mNameInternal.toLowerCase(), T, 5, 250, 1, tGem, GEN_GEMS);
                if (ConfigsGT.WORLDGEN.get("ore.random_small_gem_ores", tGem.mNameInternal, T))
                    StoneLayer.RANDOM_SMALL_GEM_ORES.add(tGem);
            }

        for (int i = 0, j = ConfigsGT.WORLDGEN.get(ConfigCategories.general, "AmountOfCustomSmallOreSlots", 0); i
            < j; i++) {
            new WorldgenOresSmall("ore.small.custom" + (i < 10 ? "0" : "") + i, F, 0, 0, 0, MT.NULL, GEN_ALL);
        }

        new WorldgenOresLarge(
            "ore.large.lignite",
            T,
            T,
            50,
        ...
        new WorldgenOresLarge(
            ...
            MT.KCl,
            MT.OREMATS.Coltan,
            MT.OREMATS.Lepidolite,
            MT.OREMATS.Spodumene,
            ORE_OVERWORLD,
            ORE_A97,
            ORE_ENVM,
            ORE_CW2_AquaCavern,
        ...
        new WorldgenOresLarge(
            ...
            3,
            16,
            MT.OREMATS.Wulfenite,
            MT.OREMATS.Molybdenite,
            MT.Mo,
            MT.OREMATS.Powellite,
            ORE_OVERWORLD,
            ORE_A97,
        ...
        new WorldgenOresLarge(
            ...
            3,
            16,
            MT.OREMATS.DuraniumHexaiodide,
            MT.OREMATS.DuraniumHexafluoride,
            MT.OREMATS.DuraniumHexachloride,
            MT.Dolamide,
            ORE_MARS,
            ORE_PLANETS,
            ORE_ASTEROIDS);
        ...
        new WorldgenOresLarge(
            ...
            3,
            16,
            MT.OREMATS.TritaniumHexafluoride,
            MT.OREMATS.DuraniumHexaastatide,
            MT.OREMATS.DuraniumHexabromide,
            MT.Desh,
            ORE_MARS);
        new WorldgenOresLarge(
            "ore.large.syrmorite",
        ...
        for (int i = 0, j = ConfigsGT.WORLDGEN_GT5.get(ConfigCategories.general, "AmountOfCustomLargeVeinSlots", 0); i
            < j; i++) {
            new WorldgenOresLarge(
                "ore.large.custom" + (i < 10 ? "0" : "") + i,
                F,
                T,
                0,
                0,
