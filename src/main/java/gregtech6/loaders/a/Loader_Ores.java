...
public class Loader_Ores implements Runnable {
    ...
    @Override
    public void run() {
        BlocksGT.oreBedrock = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.bedrock",
            OP.oreBedrock,
            null,
            null,
            new Drops_None(),
            BlockTextureCopied.get(Blocks.bedrock, 0),
            Material.rock,
        ...
        BlocksGT.oreSmallBedrock = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.bedrock",
            OP.oreSmall,
            null,
            null,
            new Drops_None(),
        ...
        BlocksGT.oreBroken = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken.default",
            OP.oreVanillastone,
            null,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreBrokenSandstone = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken.sandstone",
            OP.oreSandstone,
            null,
            BlockTextureCopied.get(Blocks.sandstone, 0),
            Material.rock,
            Block.soundTypeStone,
            TOOL_pickaxe,
            0.30F,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreBrokenNetherrack = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken.netherrack",
            OP.oreNetherrack,
            null,
            BlockTextureCopied.get(Blocks.netherrack, 0),
            Material.rock,
            Block.soundTypeStone,
            TOOL_pickaxe,
            0.20F,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreBrokenEndstone = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken.endstone",
            OP.oreEndstone,
            null,
            BlockTextureCopied.get(Blocks.end_stone, 0),
            Material.rock,
            Block.soundTypeStone,
            TOOL_pickaxe,
            0.50F,
        ...
        BlocksGT.ore = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.default",
            OP.oreVanillastone,
            null,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSandstone = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.sandstone",
            OP.oreSandstone,
            null,
            BlockTextureCopied.get(Blocks.sandstone, 0),
            Material.rock,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreNetherrack = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.netherrack",
            OP.oreNetherrack,
            null,
            BlockTextureCopied.get(Blocks.netherrack, 0),
            Material.rock,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreEndstone = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.endstone",
            OP.oreEndstone,
            null,
            BlockTextureCopied.get(Blocks.end_stone, 0),
            Material.rock,
            ...
            T,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreGravel = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.gravel",
            OP.oreGravel,
            null,
            BlockTextureCopied.get(Blocks.gravel, 0),
            Material.sand,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSand = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.sand",
            OP.oreSand,
            null,
            BlockTextureCopied.get(Blocks.sand, 0),
            Material.sand,
            Block.soundTypeSand,
            TOOL_shovel,
            0.40F,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreRedSand = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.redsand",
            OP.oreRedSand,
            null,
            BlockTextureCopied.get(Blocks.sand, 1),
            Material.sand,
            Block.soundTypeSand,
            TOOL_shovel,
            0.40F,
        ...
        BlocksGT.oreSmall = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.default",
            OP.oreSmall,
            new Drops_SmallOre(MT.Stone),
            BlockTextureCopied.get(Blocks.stone, 0),
            Material.rock,
            Block.soundTypeStone,
            TOOL_pickaxe,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSmallSandstone = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.sandstone",
            OP.oreSmall,
            new Drops_SmallOre(MT.Sand),
            BlockTextureCopied.get(Blocks.sandstone, 0),
            Material.rock,
            Block.soundTypeStone,
            TOOL_pickaxe,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSmallNetherrack = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.netherrack",
            OP.oreSmall,
            new Drops_SmallOre(MT.Netherrack),
            BlockTextureCopied.get(Blocks.netherrack, 0),
            Material.rock,
            Block.soundTypeStone,
            TOOL_pickaxe,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSmallEndstone = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.endstone",
            OP.oreSmall,
            new Drops_SmallOre(MT.Endstone),
            BlockTextureCopied.get(Blocks.end_stone, 0),
            Material.rock,
            Block.soundTypeStone,
            TOOL_pickaxe,
            ...
            T,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSmallGravel = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.gravel",
            OP.oreSmall,
            new Drops_SmallOre(MT.Stone),
            BlockTextureCopied.get(Blocks.gravel, 0),
            Material.sand,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSmallSand = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.sand",
            OP.oreSmall,
            new Drops_SmallOre(MT.Sand),
            BlockTextureCopied.get(Blocks.sand, 0),
            Material.sand,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSmallRedSand = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.redsand",
            OP.oreSmall,
            new Drops_SmallOre(MT.RedSand),
            BlockTextureCopied.get(Blocks.sand, 1),
            Material.sand,
            Block.soundTypeSand,
            TOOL_shovel,
        ...
        ((PrefixBlock) BlocksGT.ore).mDrops = new Drops(
            BlocksGT.oreBroken,
            BlocksGT.ore,
            OP.oreRaw.mRegisteredPrefixItems.get(0),
            0,
            1);
        ((PrefixBlock) BlocksGT.oreSandstone).mDrops = new Drops(
            BlocksGT.oreBrokenSandstone,
            BlocksGT.oreSandstone,
            OP.oreRaw.mRegisteredPrefixItems.get(0),
            0,
            1);
        ((PrefixBlock) BlocksGT.oreNetherrack).mDrops = new Drops(
            BlocksGT.oreBrokenNetherrack,
            BlocksGT.oreNetherrack,
            OP.oreRaw.mRegisteredPrefixItems.get(0),
            0,
            1);
        ((PrefixBlock) BlocksGT.oreEndstone).mDrops = new Drops(
            BlocksGT.oreBrokenEndstone,
            BlocksGT.oreEndstone,
            OP.oreRaw.mRegisteredPrefixItems.get(0),
            2,
            3);
        ((PrefixBlock) BlocksGT.oreGravel).mDrops = new Drops(
            BlocksGT.oreGravel,
            BlocksGT.oreGravel,
            OP.oreRaw.mRegisteredPrefixItems.get(0),
            0,
            1);
        ((PrefixBlock) BlocksGT.oreSand).mDrops = new Drops(
            BlocksGT.oreSand,
            BlocksGT.oreSand,
            OP.oreRaw.mRegisteredPrefixItems.get(0),
            0,
            1);
        ((PrefixBlock) BlocksGT.oreRedSand).mDrops = new Drops(
            BlocksGT.oreRedSand,
            BlocksGT.oreRedSand,
            OP.oreRaw.mRegisteredPrefixItems.get(0),
            0,
        ...
        BlocksGT.oreMud = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.mud",
            OP.oreMud,
            null,
            BlockTextureCopied.get(BlocksGT.Diggables, 0),
            Material.ground,
            Block.soundTypeGravel,
            TOOL_shovel,
            0.30F,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.oreSmallMud = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.mud",
            OP.oreSmall,
            new Drops_SmallOre(null),
            BlockTextureCopied.get(BlocksGT.Diggables, 0),
            Material.ground,
            Block.soundTypeGravel,
            TOOL_shovel,
        ...
        ((PrefixBlock) BlocksGT.oreMud).mDrops = new Drops(
            BlocksGT.oreMud,
            BlocksGT.oreMud,
            OP.oreRaw.mRegisteredPrefixItems.get(0),
            0,
        ...
        for (Object tBlock : new Object[] { BlocksGT.ore, BlocksGT.oreSandstone, BlocksGT.oreNetherrack,
            BlocksGT.oreEndstone, BlocksGT.oreGravel, BlocksGT.oreMud, BlocksGT.oreSand, BlocksGT.oreRedSand,
            BlocksGT.oreBroken, BlocksGT.oreBrokenSandstone, BlocksGT.oreBrokenNetherrack, BlocksGT.oreBrokenEndstone,
            BlocksGT.oreSmall, BlocksGT.oreSmallSandstone, BlocksGT.oreSmallNetherrack, BlocksGT.oreSmallEndstone,
            BlocksGT.oreSmallGravel, BlocksGT.oreSmallMud, BlocksGT.oreSmallSand, BlocksGT.oreSmallRedSand }) {
            for (int i = 0; i < 10; i++) {
        ...
        tPrefix = new OreDictPrefix[] { OP.oreBasalt, OP.oreShale, OP.oreSandstone, OP.oreLimestone, OP.oreSlate,
            OP.oreAndesite, OP.oreMarble, OP.oreMarble, OP.oreLimestone, OP.oreGrayschist, OP.oreVanillastone,
            OP.oreBasalt, OP.oreVanillastone };
        tDrops = new OreDictMaterial[] { MT.STONES.Basalt, MT.STONES.Shale, MT.Sand, MT.STONES.Limestone,
            MT.STONES.Slate, MT.STONES.Rhyolite, MT.Chalk, MT.STONES.Marble, MT.Dolomite, MT.STONES.Grayschist,
            MT.STONES.Chert, MT.STONES.Gabbro, MT.STONES.Dacite };
        for (int i = 0; i < 13; i++) rockset(
            MD.EB,
            "enhancedbiomes.tile.stoneEB",
            i,
            i,
            "enhancedbiomes.tile.stoneCobbleEB",
            i,
            "eb.stone." + i,
            tPrefix[i],
            tDrops[i]);

        tPrefix = new OreDictPrefix[] { OP.oreVanillagranite, OP.oreBlackgranite, OP.oreAndesite, OP.oreAndesite,
            OP.oreBasalt, OP.oreBasalt, OP.oreKomatiite, OP.oreVanillastone };
        tDrops = new OreDictMaterial[] { MT.STONES.Granite, MT.STONES.GraniteBlack, MT.STONES.Rhyolite,
            MT.STONES.Andesite, MT.STONES.Gabbro, MT.STONES.Basalt, MT.STONES.Komatiite, MT.STONES.Dacite };
        for (int i = 0; i < 8; i++)
            rockset(MD.UB, "igneousStone", i, i + 8, "igneousCobblestone", i, "ub.igneous." + i, tPrefix[i], tDrops[i]);

        tPrefix = new OreDictPrefix[] { OP.oreGneiss, OP.oreVanillastone, OP.oreMarble, OP.oreQuartzite,
            OP.oreBlueschist, OP.oreGreenschist, OP.oreVanillastone, OP.oreVanillastone };
        tDrops = new OreDictMaterial[] { MT.STONES.Gneiss, MT.STONES.Eclogite, MT.STONES.Marble, MT.STONES.Quartzite,
            MT.STONES.Blueschist, MT.STONES.Greenschist, MT.Talc, MT.STONES.Migmatite };
        for (int i = 0; i < 8; i++) rockset(
            MD.UB,
            "metamorphicStone",
            i,
            i + 8,
        ...
        tPrefix = new OreDictPrefix[] { OP.oreLimestone, OP.oreMarble, OP.oreShale, OP.oreSiltstone, OP.oreVanillastone,
            OP.oreLimestone, OP.oreVanillastone, OP.oreVanillastone };
        tDrops = new OreDictMaterial[] { MT.STONES.Limestone, MT.Chalk, MT.STONES.Shale, MT.STONES.Siltstone,
            MT.Lignite, MT.Dolomite, MT.STONES.Greywacke, MT.STONES.Chert };
        for (int i = 0; i < 8; i++) rockset(
            MD.UB,
            "sedimentaryStone",
            i,
        ...
        tPrefix = new OreDictPrefix[] { OP.oreVanillastone, OP.oreVanillastone, OP.oreVanillastone, OP.oreVanillastone,
            OP.oreShale };
        tDrops = new OreDictMaterial[] { MT.Stone, MT.Stone, MT.Stone, MT.Stone, MT.STONES.Shale };
        for (int i = 0; i < 5; i++) rockset(
            MD.PFAA,
            "weakStone",
            i,
            i,
        ...
        tPrefix = new OreDictPrefix[] { OP.oreLimestone, OP.orePinkschist, OP.oreVanillastone, OP.oreVanillastone,
            OP.oreVanillastone };
        tDrops = new OreDictMaterial[] { MT.STONES.Limestone, MT.STONES.Pinkschist, MT.Stone, MT.STONES.Slate,
            MT.Stone };
        for (int i = 0; i < 5; i++) rockset(
            MD.PFAA,
            "mediumStone",
        ...
        tPrefix = new OreDictPrefix[] { OP.oreAndesite, OP.oreBasalt, OP.oreGneiss, OP.oreBlackgranite,
            OP.oreGreenschist, OP.oreMarble, OP.oreVanillastone, OP.oreAndesite, OP.oreSandstone, OP.oreSandstone };
        tDrops = new OreDictMaterial[] { MT.STONES.Andesite, MT.STONES.Basalt, MT.STONES.Gneiss, MT.STONES.GraniteBlack,
            MT.STONES.Greenschist, MT.STONES.Marble, MT.Stone, MT.STONES.Rhyolite, MT.Sand, MT.RedSand };
        for (int i = 0; i < 10; i++) rockset(
            MD.PFAA,
            "strongStone",
            i,
            i,
        ...
        tPrefix = new OreDictPrefix[] { OP.oreDiorite, OP.oreBasalt, OP.oreVanillastone, OP.oreVanillastone,
            OP.oreQuartzite };
        ...
        if (MD.BOTA.mLoaded) {
            rockset(
                MD.BOTA,
                ST.block(MD.BOTA, "livingrock"),
                0,
                0,
                ST.block(MD.ALF, "LivingCobble"),
                0,
                "botania.livingrock",
                OP.oreLivingrock,
                MT.STONES.Livingrock,
                1.0F,
                1.0F,
                0,
                F,
        ...
        if (MD.GC_EXTRAPLANETS.mLoaded) {
            // The Topmost Layers should not have Ores and are therefore commented out. Would not want to make finding
            // Ores THAT easy.
            // rockset(MD.GC_EXTRAPLANETS,"tile.phobos" , 0, "ep.phobos.surface" , OP.orePhobos , MT.STONES.PhobosRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.phobos" , 1, "ep.phobos.subsurface" , OP.orePhobos ,
            // MT.STONES.PhobosRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.deimos" , 1, "ep.deimos.subsurface" , OP.oreDeimos ,
            // MT.STONES.DeimosRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.mercury" , 0, "ep.mercury.surface" , OP.oreMercury ,
            // MT.STONES.MercuryRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.mercury" , 1, "ep.mercury.subsurface" , OP.oreMercury ,
            // MT.STONES.MercuryRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.jupiter" , 0, "ep.jupiter.surface" , OP.oreJupiter ,
            // MT.STONES.JupiterRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.jupiter" , 1, "ep.jupiter.subsurface" , OP.oreJupiter ,
            // MT.STONES.JupiterRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.europa" , 1, "ep.europa.subsurface" , OP.oreEuropa ,
            // MT.STONES.EuropaRock);
            rockset(MD.GC_EXTRAPLANETS, "tile.europa", 2, "ep.europa.rock", OP.oreEuropa, MT.STONES.EuropaRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.ganymede" , 0, "ep.ganymede.surface" , OP.oreGanymede ,
            // MT.STONES.GanymedeRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.ganymede" , 1, "ep.ganymede.subsurface" , OP.oreGanymede ,
            // MT.STONES.GanymedeRock);
            rockset(MD.GC_EXTRAPLANETS, "tile.ganymede", 2, "ep.ganymede.rock", OP.oreGanymede, MT.STONES.GanymedeRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.callisto" , 0, "ep.callisto.surface" , OP.oreCallisto ,
            // MT.STONES.CallistoRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.callisto" , 1, "ep.callisto.subsurface" , OP.oreCallisto ,
            // MT.STONES.CallistoRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.saturn" , 1, "ep.saturn.subsurface" , OP.oreSaturn ,
            // MT.STONES.SaturnRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.oberon" , 1, "ep.oberon.subsurface" , OP.oreOberon ,
            // MT.STONES.OberonRock);
            rockset(MD.GC_EXTRAPLANETS, "tile.oberon", 2, "ep.oberon.rock", OP.oreOberon, MT.STONES.OberonRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.iapetus" , 0, "ep.iapetus.surface" , OP.oreIapetus ,
            // MT.STONES.IapetusRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.iapetus" , 1, "ep.iapetus.subsurface" , OP.oreIapetus ,
            // MT.STONES.IapetusRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.uranus" , 1, "ep.uranus.subsurface" , OP.oreUranus ,
            // MT.STONES.UranusRock);
            rockset(MD.GC_EXTRAPLANETS, "tile.uranus", 2, "ep.uranus.rock", OP.oreUranus, MT.STONES.UranusRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.titania" , 0, "ep.titania.surface" , OP.oreTitania ,
            // MT.STONES.TitaniaRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.titania" , 1, "ep.titania.subsurface" , OP.oreTitania ,
            // MT.STONES.TitaniaRock);
            rockset(MD.GC_EXTRAPLANETS, "tile.titania", 2, "ep.titania.rock", OP.oreTitania, MT.STONES.TitaniaRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.neptune" , 0, "ep.neptune.surface" , OP.oreNeptune ,
            // MT.STONES.NeptuneRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.neptune" , 1, "ep.neptune.subsurface" , OP.oreNeptune ,
            // MT.STONES.NeptuneRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.triton" , 1, "ep.triton.subsurface" , OP.oreTriton ,
            // MT.STONES.TritonRock);
            ...
            // rockset(MD.GC_EXTRAPLANETS,"tile.kepler22b" , 0, "ep.kepler22b.surface" , OP.oreKepler22b ,
            // MT.STONES.Kepler22bRock);
            // rockset(MD.GC_EXTRAPLANETS,"tile.kepler22b" , 1, "ep.kepler22b.subsurface", OP.oreKepler22b ,
            // MT.STONES.Kepler22bRock);
            rockset(
                MD.GC_EXTRAPLANETS,
                "tile.kepler22b",
         ...
         * rockset(MD.GC_GALAXYSPACE, "ganymedeblocks" , 1, "gs.ganymede.rock" , OP.oreGanymede ,
         * MT.STONES.GanymedeRock);
         * rockset(MD.GC_GALAXYSPACE, "barnardaEsubgrunt" , 0, "gs.barnarda.e.rock" , OP.oreBarnardaE ,
         * MT.STONES.BarnardaERock);
         * }
         */
    ...
    public static boolean rockset(ModData aMod, String aRock, int aMeta, String aName, OreDictPrefix aPrefix,
        OreDictMaterial aDrops) {
        return rockset(aMod, aRock, aMeta, aName, aPrefix, aDrops, 1, 1, 0, F, F, T);
    }

    public static boolean rockset(ModData aMod, String aRock, int aMeta, String aName, OreDictPrefix aPrefix,
        OreDictMaterial aDrops, float aBaseHardness, float aBaseResistance, int aHarvestLevelMinimum, boolean aGravity,
        boolean aEnderDragonProof, boolean aStoneOverrideable) {
        return rockset(
            aMod,
            ST.block(aMod, aRock),
            aMeta,
    ...
    public static boolean rockset(ModData aMod, Block aRock, int aMeta, String aName, OreDictPrefix aPrefix,
        OreDictMaterial aDrops, float aBaseHardness, float aBaseResistance, int aHarvestLevelMinimum, boolean aGravity,
        boolean aEnderDragonProof, boolean aStoneOverrideable) {
        return rockset(
            aMod,
    ...
    public static boolean rockset(ModData aMod, String aRock, int aMetaA, int aMetaB, String aCobble, int aMeta,
        String aName, OreDictPrefix aPrefix, OreDictMaterial aDrops) {
        return rockset(aMod, aRock, aMetaA, aMetaB, aCobble, aMeta, aName, aPrefix, aDrops, 1.0F, 1.0F, 0, F, F, T);
    }

    public static boolean rockset(ModData aMod, String aRock, int aMetaA, int aMetaB, String aCobble, int aMeta,
        String aName, OreDictPrefix aPrefix, OreDictMaterial aDrops, float aBaseHardness, float aBaseResistance,
        int aHarvestLevelMinimum, boolean aGravity, boolean aEnderDragonProof, boolean aStoneOverrideable) {
        return rockset(
            aMod,
            ST.block(aMod, aRock),
            aMetaA,
            aMetaB,
            ST.block(aMod, aCobble),
            aMeta,
            aName,
            aPrefix,
            aDrops,
    ...
    public static boolean rockset(ModData aMod, Block aRock, int aMetaA, int aMetaB, Block aCobble, int aMeta,
        String aName, OreDictPrefix aPrefix, OreDictMaterial aDrops, float aBaseHardness, float aBaseResistance,
        int aHarvestLevelMinimum, boolean aGravity, boolean aEnderDragonProof, boolean aStoneOverrideable) {
        boolean tHidden = F;
        ...
        if (aMod.mLoaded) {
            if (aRock == NB || aRock == null) {
                if (D1) throw new IllegalArgumentException(
                    "The Stone of the Mod '" + aMod.mID
                        + "' with the Category '"
                        + aName
                        + "' is missing despite the Mod being loaded. Maybe an old/wrong Version of the Mod is used?");
        ...
        PrefixBlock tOre1 = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal." + aName,
            aPrefix,
            aMod.mLoaded ? null : ((PrefixBlock) BlocksGT.ore).mDrops,
            BlockTextureCopied.get(aRock, aMetaA == W ? 0 : aMetaA),
            aRock.getMaterial(),
            aRock.stepSound,
            TOOL_pickaxe,
            aBaseHardness,
            ...
            tOre2 = new PrefixBlock_(
                MD.GT,
                "gt.meta.ore.broken." + aName,
                aPrefix,
                aMod.mLoaded ? null : ((PrefixBlock) BlocksGT.oreBroken).mDrops,
                BlockTextureCopied.get(aCobble, aMeta == W ? 0 : aMeta),
                aCobble.getMaterial(),
                aCobble.stepSound,
                TOOL_pickaxe,
                aBaseHardness / 2,
                ...
                aEnderDragonProof,
                OreDictMaterial.MATERIAL_ARRAY).setHidden(tHidden),
            tOre3 = new PrefixBlock_(
                MD.GT,
                "gt.meta.ore.small." + aName,
                OP.oreSmall,
                aMod.mLoaded ? new Drops_SmallOre(aDrops) : ((PrefixBlock) BlocksGT.oreSmall).mDrops,
                BlockTextureCopied.get(aRock, aMetaA == W ? 0 : aMetaA),
                aRock.getMaterial(),
                aRock.stepSound,
                TOOL_pickaxe,
    ...
    public static PrefixBlock normal(Block aRock, int aMeta, String aName, OreDictPrefix aPrefix,
        Material aVanillaMaterial, SoundType aSoundType, String aTool, float aBaseHardness, float aBaseResistance,
        int aHarvestLevelMinimum, boolean aGravity, boolean aEnderDragonProof) {
        if (aRock == NB || aRock == null) return null;
        PrefixBlock rOre = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal." + aName,
            aPrefix,
            null,
            BlockTextureCopied.get(aRock, aMeta),
            aVanillaMaterial,
            aSoundType,
            aTool,
            aBaseHardness,
            ...
            aEnderDragonProof,
            OreDictMaterial.MATERIAL_ARRAY);
        if (aRock != Blocks.stone)
            if (aMeta != W) BlocksGT.stoneToNormalOres.put(new ItemStackContainer(aRock, 1, aMeta), rOre);
            else for (int i = 0; i < 16; i++) BlocksGT.stoneToNormalOres.put(new ItemStackContainer(aRock, 1, i), rOre);
        return rOre;
    }

    public static PrefixBlock broken(Block aRock, int aMeta, String aName, OreDictPrefix aPrefix,
        Material aVanillaMaterial, SoundType aSoundType, String aTool, float aBaseHardness, float aBaseResistance,
        int aHarvestLevelMinimum, boolean aEnderDragonProof) {
        if (aRock == NB || aRock == null) return null;
        PrefixBlock rOre = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken." + aName,
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        if (aRock != Blocks.stone)
            if (aMeta != W) BlocksGT.stoneToBrokenOres.put(new ItemStackContainer(aRock, 1, aMeta), rOre);
            else for (int i = 0; i < 16; i++) BlocksGT.stoneToBrokenOres.put(new ItemStackContainer(aRock, 1, i), rOre);
        return rOre;
    }

    public static PrefixBlock small(Block aRock, int aMeta, String aName, OreDictMaterial aDrops,
        Material aVanillaMaterial, SoundType aSoundType, String aTool, float aBaseHardness, float aBaseResistance,
        int aHarvestLevelMinimum, boolean aGravity, boolean aEnderDragonProof) {
        if (aRock == NB || aRock == null) return null;
        PrefixBlock rOre = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        if (aRock != Blocks.stone)
            if (aMeta != W) BlocksGT.stoneToSmallOres.put(new ItemStackContainer(aRock, 1, aMeta), rOre);
            else for (int i = 0; i < 16; i++) BlocksGT.stoneToSmallOres.put(new ItemStackContainer(aRock, 1, i), rOre);
        return rOre;
    }
}
