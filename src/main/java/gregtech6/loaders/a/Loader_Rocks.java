...
public class Loader_Rocks implements Runnable {
    ...
    public void run() {
        ...
        int n = 0;
        BlocksGT.stones[n] = BlocksGT.GraniteBlack = tStone = new BlockStonesGT(
            "gt.stone.granite.black",
            MT.STONES.GraniteBlack,
            6.00F,
            3.00F,
            3,
            T);
        BlocksGT.ores_normal[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.blackgranite",
            OP.oreBlackgranite,
            null,
        ...
        BlocksGT.ores_broken[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken.blackgranite",
            OP.oreBlackgranite,
            null,
            ...
            F,
            OreDictMaterial.MATERIAL_ARRAY);
        BlocksGT.ores_small[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.blackgranite",
            OP.oreSmall,
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.GraniteRed = tStone = new BlockStonesGT(
            "gt.stone.granite.red",
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Basalt = tStone = new BlockStonesGT(
            "gt.stone.basalt",
            MT.STONES.Basalt,
            3.00F,
            2.00F,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Marble = tStone = new BlockStonesGT(
            "gt.stone.marble",
            MT.STONES.Marble,
            0.75F,
            0.50F,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Limestone = tStone = new BlockStonesGT(
            "gt.stone.limestone",
            MT.STONES.Limestone,
            0.75F,
            0.50F,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Granite = tStone = new BlockStonesGT(
            "gt.stone.granite",
            MT.STONES.Granite,
            2.00F,
            1.00F,
        ...
        BlocksGT.ores_normal[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.granite",
            OP.oreVanillagranite,
            null,
            BlockTextureDefault.get(tStone.mIcons[0]),
            Material.rock,
            Block.soundTypeStone,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Diorite = tStone = new BlockStonesGT(
            "gt.stone.diorite",
            MT.STONES.Diorite,
            0.75F,
            0.50F,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Andesite = tStone = new BlockStonesGT(
            "gt.stone.andesite",
            MT.STONES.Andesite,
            0.75F,
            0.50F,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Komatiite = tStone = new BlockStonesGT(
            "gt.stone.komatiite",
            MT.STONES.Komatiite,
            3.00F,
            2.00F,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.SchistGreen = tStone = new BlockStonesGT(
            "gt.stone.greenschist",
        ...
        BlocksGT.ores_normal[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.greenschist",
            OP.oreGreenschist,
            null,
            BlockTextureDefault.get(tStone.mIcons[0]),
            Material.rock,
        ...
        BlocksGT.ores_broken[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken.greenschist",
            OP.oreGreenschist,
            null,
            BlockTextureDefault.get(tStone.mIcons[1]),
            Material.rock,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.SchistBlue = tStone = new BlockStonesGT(
            "gt.stone.blueschist",
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Kimberlite = tStone = new BlockStonesGT(
            "gt.stone.kimberlite",
            MT.STONES.Kimberlite,
            3.00F,
            2.00F,
            2,
            F);
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Quartzite = tStone = new BlockStonesGT(
            "gt.stone.quartzite",
            MT.STONES.Quartzite,
            0.75F,
            0.50F,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.PrismarineLight = tStone = new BlockStonesGT(
            "gt.stone.prismarine.light",
            MT.PrismarineLight,
            0.75F,
            0.50F,
            0,
        ...
        BlocksGT.ores_normal[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.prismarine.light",
            OP.oreLightprismarine,
            null,
            BlockTextureDefault.get(tStone.mIcons[0]),
            Material.rock,
            Block.soundTypeStone,
        ...
        BlocksGT.ores_broken[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken.prismarine.light",
            OP.oreLightprismarine,
            null,
            BlockTextureDefault.get(tStone.mIcons[1]),
            Material.rock,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.prismarine.light",
            OP.oreSmall,
            new Drops_SmallOre(tStone.mMaterial),
            BlockTextureDefault.get(tStone.mIcons[0]),
            Material.rock,
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.PrismarineDark = tStone = new BlockStonesGT(
            "gt.stone.prismarine.dark",
            MT.PrismarineDark,
            0.75F,
            0.50F,
            1,
        ...
        BlocksGT.ores_normal[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.normal.prismarine.dark",
            OP.oreDarkprismarine,
            null,
            BlockTextureDefault.get(tStone.mIcons[0]),
            Material.rock,
            Block.soundTypeStone,
        ...
        BlocksGT.ores_broken[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.broken.prismarine.dark",
            OP.oreDarkprismarine,
            null,
            BlockTextureDefault.get(tStone.mIcons[1]),
            Material.rock,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            MD.GT,
            "gt.meta.ore.small.prismarine.dark",
            OP.oreSmall,
            new Drops_SmallOre(tStone.mMaterial),
            BlockTextureDefault.get(tStone.mIcons[0]),
            Material.rock,
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Slate = tStone = new BlockStonesGT(
            "gt.stone.slate",
            MT.STONES.Slate,
            0.75F,
            0.50F,
        ...
        BlocksGT.ores_small[n] = new PrefixBlock_(
            ...
            OreDictMaterial.MATERIAL_ARRAY);
        n++;
        BlocksGT.stones[n] = BlocksGT.Shale = tStone = new BlockStonesGT(
            "gt.stone.shale",
            MT.STONES.Shale,
            0.75F,
            0.50F,
        ...
        for (int i = 0; i < BlocksGT.stones.length; i++) {
            ...
            ((PrefixBlock) BlocksGT.ores_normal[i]).mDrops = new Drops(
                BlocksGT.ores_broken[i],
                BlocksGT.ores_normal[i],
                OP.oreRaw.mRegisteredPrefixItems.get(0),
                0,
                Math.max(1, BlocksGT.stones[n].getHarvestLevel(0)));
            ...
            BlocksGT.drillableDynamite.add(BlocksGT.ores_normal[i]);
            BlocksGT.stoneOverridable.add(BlocksGT.ores_broken[i]);
            BlocksGT.drillableDynamite.add(BlocksGT.ores_broken[i]);
            BlocksGT.stoneOverridable.add(BlocksGT.ores_small[i]);
            BlocksGT.drillableDynamite.add(BlocksGT.ores_small[i]);
        }
        ...
        ItemsGT.addNEIRedirects(
            ST.make(BlocksGT.stones[5], 1, 0),
            IL.CHSL_Granite.get(1),
            IL.GaSu_Granite.get(1),
            IL.EtFu_Granite.get(1),
            IL.BOTA_Granite.get(1));
        ItemsGT.addNEIRedirects(
            ST.make(BlocksGT.stones[6], 1, 0),
            IL.CHSL_Diorite.get(1),
            IL.GaSu_Diorite.get(1),
            IL.EtFu_Diorite.get(1),
            IL.BOTA_Diorite.get(1));
        ItemsGT.addNEIRedirects(
            ST.make(BlocksGT.stones[7], 1, 0),
            IL.CHSL_Andesite.get(1),
            IL.GaSu_Andesite.get(1),
            IL.EtFu_Andesite.get(1),
            IL.BOTA_Andesite.get(1));
        ItemsGT.addNEIRedirects(
            ST.make(BlocksGT.stones[5], 1, 7),
            IL.CHSL_Granite_Smooth.get(1),
            IL.GaSu_Granite_Smooth.get(1),
            IL.EtFu_Granite_Smooth.get(1),
            IL.BOTA_Granite_Smooth.get(1));
        ItemsGT.addNEIRedirects(
            ST.make(BlocksGT.stones[6], 1, 7),
            IL.CHSL_Diorite_Smooth.get(1),
            IL.GaSu_Diorite_Smooth.get(1),
            IL.EtFu_Diorite_Smooth.get(1),
            IL.BOTA_Diorite_Smooth.get(1));
        ItemsGT.addNEIRedirects(
            ST.make(BlocksGT.stones[7], 1, 7),
            IL.CHSL_Andesite_Smooth.get(1),
            IL.GaSu_Andesite_Smooth.get(1),
            IL.EtFu_Andesite_Smooth.get(1),
            IL.BOTA_Andesite_Smooth.get(1));
        ...
        if (MD.CHSL.mLoaded) {
            ...
            CR.shapeless(
                IL.CHSL_Andesite_Smooth.get(1),
                CR.DEF_NCC,
                new Object[] { ST.make(BlocksGT.stones[7], 1, 7) });
            ...
            CR.shapeless(
                ST.make(BlocksGT.stones[7], 1, 7),
                CR.DEF_NCC,
                new Object[] { IL.CHSL_Andesite_Smooth.get(1) });
            ...
            try {
                for (int i = 0; i < 16; i++) if (BlockStones.JUSTSTONE[i]) {
                    for (ItemStackContainer tStack : (ItemStackSet<ItemStackContainer>) (((BlockStones) BlocksGT.stones[5]).mEqualBlocks[i]))
                        if (!MD.CHSL.owns(tStack.toStack())) Carving.chisel.getGroup(IL.CHSL_Granite.block(), 0)
                            .addVariation(
                                CarvingUtils.getDefaultVariationFor(tStack.mBlock, tStack.mMetaData, 1111 + i));
                    for (ItemStackContainer tStack : (ItemStackSet<ItemStackContainer>) (((BlockStones) BlocksGT.stones[6]).mEqualBlocks[i]))
                        if (!MD.CHSL.owns(tStack.toStack())) Carving.chisel.getGroup(IL.CHSL_Diorite.block(), 0)
                            .addVariation(
                                CarvingUtils.getDefaultVariationFor(tStack.mBlock, tStack.mMetaData, 1111 + i));
                    for (ItemStackContainer tStack : (ItemStackSet<ItemStackContainer>) (((BlockStones) BlocksGT.stones[7]).mEqualBlocks[i]))
                        if (!MD.CHSL.owns(tStack.toStack())) Carving.chisel.getGroup(IL.CHSL_Andesite.block(), 0)
                            .addVariation(
                                CarvingUtils.getDefaultVariationFor(tStack.mBlock, tStack.mMetaData, 1111 + i));
                }
            } catch (Throwable e) {
