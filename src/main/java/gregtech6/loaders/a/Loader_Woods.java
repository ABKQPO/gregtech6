...
public class Loader_Woods implements Runnable {
    ...
    public void run() {
        ...
        // VISUALLY_OPAQUE_BLOCKS.add(BlocksGT.BeamDFireProof = new BlockTreeBeamDFireProof
        // ("gt.block.beam.d.fireproof"));
        ...
        VISUALLY_OPAQUE_BLOCKS
            .add(BlocksGT.PlanksFireProof = new BlockTreePlanksFireProof("gt.block.planks.fireproof"));
        VISUALLY_OPAQUE_BLOCKS.add(BlocksGT.Planks2 = new BlockTreePlanks2("gt.block.planks2"));
        VISUALLY_OPAQUE_BLOCKS
            .add(BlocksGT.Planks2FireProof = new BlockTreePlanks2FireProof("gt.block.planks2.fireproof"));
