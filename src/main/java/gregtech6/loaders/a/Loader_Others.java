    ...
    public void run() {
        ...
        MultiTileEntityBlock
            .getOrCreate(
                ...
                F,
                F)
            .setMapColor(Material.iron.getMaterialMapColor());
        MultiTileEntityBlock
            .getOrCreate(
                MD.GT.mID,
                "redstoneLight",
                ...
                F,
                F)
            .setMapColor(Material.rock.getMaterialMapColor());
        MultiTileEntityBlock
            .getOrCreate(
                MD.GT.mID,
                "redstoneLight",
                ...
                F,
                F)
            .setMapColor(Material.wood.getMaterialMapColor());
        MultiTileEntityBlock
            .getOrCreate(
                MD.GT.mID,
                "redstoneLight",
                ...
                F,
                F)
            .setMapColor(Material.cloth.getMaterialMapColor());
        MultiTileEntityBlock.getOrCreate(
            MD.GT.mID,
            "rock",
        ...
        BooksGT.BOOK_TEXTURES_BACK[255] = BooksGT.BOOK_TEXTURES_SIDE[255] = BlockTextureDefault
            .get(new IconContainerCopied(Blocks.cobblestone, 0, 0));
