...
public class Compat_Recipes_BiomesOPlenty extends CompatMods {
    ...
    public Compat_Recipes_BiomesOPlenty(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }

    @Override
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        OUT.println("GT_Mod: Doing BoP Recipes.");
        ...
        CR.shapeless(
            ST.make(MD.BoP, "dart", 8, 1),
            CR.DEF_NCC,
            new Object[] { OD.container1000poison, ST.make(MD.BoP, "dart", 1, 0), ST.make(MD.BoP, "dart", 1, 0),
                ST.make(MD.BoP, "dart", 1, 0), ST.make(MD.BoP, "dart", 1, 0), ST.make(MD.BoP, "dart", 1, 0),
                ST.make(MD.BoP, "dart", 1, 0), ST.make(MD.BoP, "dart", 1, 0), ST.make(MD.BoP, "dart", 1, 0) });
        CR.shapeless(
            ST.make(MD.BoP, "dart", 4, 1),
            CR.DEF_NCC,
            new Object[] { OD.container500poison, ST.make(MD.BoP, "dart", 1, 0), ST.make(MD.BoP, "dart", 1, 0),
                ST.make(MD.BoP, "dart", 1, 0), ST.make(MD.BoP, "dart", 1, 0) });
        CR.shapeless(
            ST.make(MD.BoP, "dart", 2, 1),
            CR.DEF_NCC,
            new Object[] { OD.container250poison, ST.make(MD.BoP, "dart", 1, 0), ST.make(MD.BoP, "dart", 1, 0) });
        CR.shapeless(
            ST.make(MD.BoP, "dart", 1, 1),
            CR.DEF_NCC,
            new Object[] { OD.itemPoison, ST.make(MD.BoP, "dart", 1, 0) });
        RM.Bath.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "dart", 1, 0),
            FL.Poison.make(50),
            NF,
            ST.make(MD.BoP, "dart", 1, 1));
        RM.Bath.addRecipe1(
        ...
        RM.Centrifuge
            .addRecipe1(T, 16, 256, ST.make(MD.BoP, "hive", 1, 3), NF, FL.Honey.make(360), OM.dust(MT.WaxBee, U * 4));
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.BoP, "mushrooms", 1, 2),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Blue],
            IL.BoP_Dye_Blue.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "mushrooms", 1, 3),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Lime],
            ST.make(Items.dye, 1, DYE_INDEX_Lime));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "mushrooms", 1, 4),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Brown],
            IL.BoP_Dye_Brown.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "mushrooms", 1, 5),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Black],
            IL.BoP_Dye_Black.get(1));

        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "plants", 1, 7),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Brown],
            IL.BoP_Dye_Brown.get(1));
        RM.Squeezer.addRecipe1(
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.BoP, "moss", 1, 0),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Green],
            IL.BoP_Dye_Green.get(1));

        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "flowers", 1, 1),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Cyan],
            ST.make(Items.dye, 1, DYE_INDEX_Cyan));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "flowers", 1, 2),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Black],
            IL.BoP_Dye_Black.get(1));
        RM.Squeezer.addRecipe1(
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.BoP, "flowers", 1, 5),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Orange],
            ST.make(Items.dye, 1, DYE_INDEX_Orange));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "flowers", 1, 6),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Pink],
            ST.make(Items.dye, 1, DYE_INDEX_Pink));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "flowers", 1, 7),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Magenta],
            ST.make(Items.dye, 1, DYE_INDEX_Magenta));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "flowers", 1, 8),
            NF,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.BoP, "flowers", 1, 9),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_White],
            IL.BoP_Dye_White.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "flowers", 1, 15),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_LightGray],
            ST.make(Items.dye, 1, DYE_INDEX_LightGray));

        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "flowers2", 1, 0),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Pink],
            ST.make(Items.dye, 1, DYE_INDEX_Pink));
        RM.Squeezer.addRecipe1(
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.BoP, "flowers2", 1, 4),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Yellow],
            ST.make(Items.dye, 1, DYE_INDEX_Yellow));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.BoP, "flowers2", 1, 5),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Blue],
            IL.BoP_Dye_Blue.get(1));
        RM.Squeezer.addRecipe1(
        ...
        RM.stonetypes(
            MT.STONES.Siltstone,
            F,
            OP.rockGt.mat(MT.STONES.Siltstone, 4),
            OP.blockDust.mat(MT.STONES.Siltstone, 1),
        ...
        RM.stonetypes(
            MT.STONES.Shale,
            F,
            OP.rockGt.mat(MT.STONES.Shale, 4),
            OP.blockDust.mat(MT.STONES.Shale, 1),
