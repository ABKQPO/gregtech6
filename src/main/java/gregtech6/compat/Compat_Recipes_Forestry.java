...
public class Compat_Recipes_Forestry extends CompatMods {
    ...
    public Compat_Recipes_Forestry(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        ...
        OM.data(
            CR.get(
                ...
                null,
                null),
            new OreDictItemData(MT.Sn, U * 3));

        CR.shapeless(ST.make(MD.FR, "gearTin", 1, 0), new Object[] { OP.gearGt.dat(MT.Sn), OP.gear.dat(ANY.Stone) });
        CR.shapeless(
            ST.make(MD.FR, "gearCopper", 1, 0),
            new Object[] { OP.gearGt.dat(ANY.Cu), OP.gear.dat(ANY.Stone) });
        CR.shapeless(
            ST.make(MD.FR, "gearBronze", 1, 0),
            new Object[] { OP.gearGt.dat(MT.Bronze), OP.gear.dat(ANY.Stone) });

        CR.shapeless(
            IL.FR_Mulch.get(1),
            CR.DEF_NCC,
            new Object[] { OD.itemPlantRemains, OD.itemPlantRemains, OD.itemPlantRemains, OD.itemPlantRemains });
        ...
        CR.shapeless(
            ST.make(MD.FR, "honeyedSlice", 1, 0),
            CR.DEF_NCC,
            new Object[] { IL.Food_Bread_Sliced, OD.container250honey });
        ...
        RM.Printer.addRecipe2(
            F,
            16,
            128,
            ST.make(Items.paper, 1, W),
            ST.tag(0),
            FL.Glue.make(200),
            NF,
            ST.make(MD.FR, "letters", 1, 0));
        ...
        if (CR.has(ST.make(MD.FR, "stamps", 1, 0))) {
            RM.Printer.addRecipe2(
                ...
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OM.dust(MT.Apatite, U9),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 0));
            RM.Printer.addRecipe2(
                F,
                16,
                128,
                OP.plateTiny.mat(MT.Paper, 9),
                OM.dust(MT.Apatite, U),
                FL.Glue.make(225),
                NF,
                ST.make(MD.FR, "stamps", 9, 0));
            RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Zn, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 0));
        }
        if (CR.has(ST.make(MD.FR, "stamps", 1, 1))) {
            RM.Printer.addRecipe2(
                ...
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Pb, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 1));
            for (OreDictMaterial tMat : ANY.Cu.mToThis) RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(tMat, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 1));
        }
        if (CR.has(ST.make(MD.FR, "stamps", 1, 2))) {
            RM.Printer.addRecipe2(
                ...
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Sn, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 2));
            RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Bi, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 2));
            RM.Printer.addRecipe2(
        ...
        if (CR.has(ST.make(MD.FR, "stamps", 1, 3))) {
            RM.Printer.addRecipe2(
                ...
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Au, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 3));
            RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Ag, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 3));
            RM.Printer.addRecipe2(
                ...
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Electrum, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 3));
        }
        if (CR.has(ST.make(MD.FR, "stamps", 1, 4))) {
            RM.Printer.addRecipe2(
                ...
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Pt, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 4));
            for (OreDictMaterial tMat : ANY.W.mToThis) RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                ...
                NF,
                ST.make(MD.FR, "stamps", 1, 4));
            for (OreDictMaterial tMat : ANY.Diamond.mToThis) RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateGemTiny.mat(tMat, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 4));
        }
        if (CR.has(ST.make(MD.FR, "stamps", 1, 5))) {
            RM.Printer.addRecipe2(
                ...
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Os, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 5));
            RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Ir, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 5));
            for (OreDictMaterial tMat : ANY.Emerald.mToThis) RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
        ...
        if (CR.has(ST.make(MD.FR, "stamps", 1, 6))) {
            RM.Printer.addRecipe2(
                ...
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Nq, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 6));
            RM.Printer.addRecipe2(
                F,
                16,
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateTiny.mat(MT.Ke, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 6));
            RM.Printer.addRecipe2(
                ...
                16,
                OP.plateTiny.mat(MT.Paper, 1),
                OP.plateGemTiny.mat(MT.NetherStar, 1),
                FL.Glue.make(25),
                NF,
                ST.make(MD.FR, "stamps", 1, 6));
        }
        ...
        for (int i = 0; i < 29; i++) {
            ItemStack tLogA = ST.make(MD.FR, "logs", 1, i), tLogB = ST.make(MD.FR, "logsFireproof", 1, i),
            ...
            RM.Laminator
                .addRecipe2(T, 16, 32, OP.plate.mat(MT.WaxRefractory, 1), ST.amount(2, tSlabA), ST.amount(2, tSlabB));
            RM.Laminator
                .addRecipe2(T, 16, 96, OP.plate.mat(MT.WaxRefractory, 3), ST.amount(2, tStairA), ST.amount(2, tStairB));
        ...
        RM.Squeezer
            .addRecipe1(T, 16, 64, ST.make(MD.FR, "logs", 1, 22), NF, FL.Sap_Maple.make(25), OM.dust(MT.WOODS.Maple));
        RM.Squeezer.addRecipe1(
            T,
            16,
            64,
            ST.make(MD.FR, "logsFireproof", 1, 22),
            NF,
            FL.Sap_Maple.make(25),
            OM.dust(MT.WOODS.Maple));
        ...
        RM.Press.addRecipe2(
            ...
            16,
            64,
            OP.plate.mat(MT.Bronze, 3),
            OM.dust(MT.Redstone, U * 6),
            IL.FR_Chipset_Bronze.get(1));
        for (OreDictMaterial tMat : ANY.Iron.mToThis) RM.Press.addRecipe2(
            T,
            16,
            64,
            (tMat == MT.Enori ? OP.plateGem : OP.plate).mat(tMat, 3),
            OM.dust(MT.Redstone, U * 6),
            IL.FR_Chipset_Iron.get(1));
        ...
        RM.Laminator.addRecipe2(
            ...
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Copper.get(8),
            IL.FR_ElectronTube_Copper.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Copper.get(4),
            IL.FR_ElectronTube_Copper.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ST.make(Blocks.glass_pane, 1, W),
            IL.Electrode_FR_Copper.get(1),
            IL.FR_ElectronTube_Copper.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Tin.get(8),
            IL.FR_ElectronTube_Tin.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Tin.get(4),
            IL.FR_ElectronTube_Tin.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Tin.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Bronze.get(8),
            IL.FR_ElectronTube_Bronze.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Bronze.get(4),
            IL.FR_ElectronTube_Bronze.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Bronze.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Iron.get(8),
            IL.FR_ElectronTube_Iron.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Iron.get(4),
            IL.FR_ElectronTube_Iron.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Iron.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Gold.get(8),
            IL.FR_ElectronTube_Gold.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Gold.get(4),
            IL.FR_ElectronTube_Gold.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Gold.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Diamond.get(8),
            IL.FR_ElectronTube_Diamond.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Diamond.get(4),
            IL.FR_ElectronTube_Diamond.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Diamond.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Obsidian.get(8),
            IL.FR_ElectronTube_Obsidian.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Obsidian.get(4),
            IL.FR_ElectronTube_Obsidian.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Obsidian.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Blaze.get(8),
            IL.FR_ElectronTube_Blaze.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Blaze.get(4),
            IL.FR_ElectronTube_Blaze.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Blaze.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Rubber.get(8),
            IL.FR_ElectronTube_Rubber.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Rubber.get(4),
            IL.FR_ElectronTube_Rubber.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Rubber.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Emerald.get(8),
            IL.FR_ElectronTube_Emerald.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Emerald.get(4),
            IL.FR_ElectronTube_Emerald.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Emerald.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Apatite.get(8),
            IL.FR_ElectronTube_Apatite.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Apatite.get(4),
            IL.FR_ElectronTube_Apatite.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Apatite.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Lapis.get(8),
            IL.FR_ElectronTube_Lapis.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            OP.casingSmall.mat(MT.Glass, 1),
            IL.Electrode_FR_Lapis.get(4),
            IL.FR_ElectronTube_Lapis.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Lapis.get(1));
        RM.Laminator.addRecipe2(
            T,
            16,
            128,
            OP.plateGem.mat(MT.Glass, 1),
            IL.Electrode_FR_Ender.get(8),
            IL.FR_ElectronTube_Ender.get(8));
        RM.Laminator.addRecipe2(
            T,
            16,
            64,
            ...
            IL.FR_ElectronTube_Ender.get(4));
        RM.Laminator.addRecipe2(
            T,
            16,
            48,
            ...
            IL.FR_ElectronTube_Ender.get(1));
        ...
        RM.Centrifuge
            .addRecipe1(T, 16, 64, IL.FR_Propolis.get(1), ZL_FS, FL.array(FL.Latex.make(L), FL.Glue.make(250)), ZL_IS);
        RM.Centrifuge.addRecipe1(
            T,
            16,
            64,
            IL.FR_Propolis_Sticky.get(1),
            ZL_FS,
            FL.array(FL.Latex.make(L / 4), FL.Glue.make(1000)),
            ZL_IS);
        RM.Centrifuge.addRecipe1(
            T,
            16,
            ...
            ZL_FS,
            FL.array(FL.Latex.make(L / 4), FL.Glue.make(125)),
            OM.dust(MT.EnderPearl, U72));
        RM.Centrifuge.addRecipe1(
            T,
            16,
            64,
            6000,
            IL.FR_Propolis_Silky.get(1),
            ZL_FS,
            FL.array(FL.Latex.make(L / 4), FL.Glue.make(125)),
            IL.FR_Silk.get(1));
        ...
        RM.Centrifuge.addRecipe1(
            ...
            64,
            new long[] { 10000, 7000 },
            IL.FR_Comb_Simmering.get(1),
            OM.dust(MT.WaxRefractory),
            OP.dust.mat(MT.PhosphorusBlue, 2));
        RM.Centrifuge.addRecipe1(T, 16, 64, IL.FR_Comb_Stringy.get(1), NF, FL.Honey.make(40), IL.FR_Propolis.get(1));
        RM.Centrifuge.addRecipe1(
            T,
            16,
            64,
            new long[] { 10000, 10000, 2000 },
            IL.FR_Comb_Frozen.get(1),
            NF,
            FL.Honey.make(70),
            OM.dust(MT.WaxBee, 3 * U4),
            OM.dust(MT.Snow, U9),
            IL.FR_Pollen_Cluster_Crystalline.get(1));
        RM.Centrifuge
            .addRecipe1(T, 16, 64, IL.FR_Comb_Dripping.get(1), NF, FL.Honeydew.make(100), IL.FR_Propolis_Sticky.get(1));
        RM.Centrifuge
            .addRecipe1(T, 16, 64, 8000, IL.FR_Comb_Silky.get(1), NF, FL.Honey.make(100), IL.FR_Propolis_Silky.get(1));
        RM.Centrifuge.addRecipe1(
            T,
            16,
            64,
            IL.FR_Comb_Parched.get(1),
            NF,
            FL.Honey.make(60),
            OM.dust(MT.WaxBee, U2),
            ST.make(Blocks.sand, 1, 0));
        RM.Centrifuge.addRecipe1(
            T,
            16,
            64,
            IL.FR_Comb_Mysterious.get(1),
            NF,
            FL.Honey.make(40),
            OM.dust(MT.WaxMagic, U9),
            IL.FR_Propolis_Pulsating.get(1));
        RM.Centrifuge.addRecipe1(
            T,
            16,
        ...
        RM.Centrifuge.addRecipe1(
            ...
            16,
            64,
            IL.FR_Comb_Powdery.get(1),
            NF,
            FL.Honey.make(20),
            OM.dust(MT.WaxBee, U4),
            OM.dust(MT.Gunpowder, U));
        RM.Centrifuge
            .addRecipe1(T, 16, 64, IL.FR_Comb_Reddened.get(1), NF, FL.Honey.make(60), OM.dust(MT.WaxAmnesic, 2 * U3));
        RM.Centrifuge
            .addRecipe1(T, 16, 64, IL.FR_Comb_Darkened.get(1), NF, FL.Honey.make(60), OM.dust(MT.WaxAmnesic, U3));
        RM.Centrifuge.addRecipe1(T, 16, 64, IL.FR_Comb_Omega.get(1), NF, FL.Honey.make(60), OM.dust(MT.WaxAmnesic));
        RM.Centrifuge.addRecipe1(
            T,
            16,
            64,
            IL.FR_Comb_Wheaten.get(1),
            NF,
            FL.Honey.make(20),
            OM.dust(MT.WaxBee, U4),
            OM.dust(MT.Wheat, U));
        RM.Centrifuge.addRecipe1(
            ...
            16,
            64,
            IL.FR_Comb_Mossy.get(1),
            NF,
            FL.Honey.make(60),
            OM.dust(MT.WaxBee, U2),
            ST.make(Blocks.vine, 2, 0));
        RM.Centrifuge.addRecipe1(
            T,
            16,
            64,
            new long[] { 10000, 10000, 6000 },
            IL.FR_Comb_Mellow.get(1),
            NF,
            FL.Honeydew.make(100),
            OM.dust(MT.WaxBee, U4),
            OM.dust(MT.NetherQuartz, U3));
        ...
        RM.Loom.addRecipe2(
            ...
            16,
            IL.FR_Stick.get(8),
            ST.make((Item) OP.plantGtFiber.mRegisteredPrefixItems.get(0), 1, W),
            ST.make(MD.FR, "frameImpregnated", 1, 0));
        RM.Loom.addRecipe2(
            T,
            16,
            16,
            IL.FR_Stick.get(8),
            ST.make(Items.string, 1, W),
            ST.make(MD.FR, "frameImpregnated", 1, 0));
            ...
            public void addAllListeners() {
                addListener("dropHoney", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (FL.getFluid(aEvent.mStack, T) != null || OM.is_("bucketHoney", aEvent.mStack)
                            || OM.is_("bottleHoney", aEvent.mStack)) return;
                        RM.Canner.addRecipe2(
                            T,
                            16,
                            16,
                            ST.amount(4, aEvent.mStack),
                            IL.FR_WaxCapsule.get(1),
                            IL.FR_HoneyPot.get(1));
                    }
                });
                ...
                addListener(OD.logWood, new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Bath
                            .addRecipe1(T, 0, 128, aEvent.mStack, FL.Oil_Sunflower.make(100), NF, IL.FR_Stick.get(1));
                        ...
                        RM.Assembler.addRecipe2(
                            ...
                            ST.tag(8),
                            MT.SeedOil.liquid(U4, T),
                            NF,
                            IL.FR_Casing_Impregnated.get(1));
                    }
                });

                addListener(OD.itemMulch, new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Mixer.addRecipeX(
                            ...
                            16,
                            64,
                            ST.array(ST.make(Blocks.sand, 4, W), ST.make(Blocks.dirt, 4, W), aEvent.mStack),
                            ST.make(MD.FR, "soil", 8, 1));

                        for (FL tWater : new FL[] { FL.Water, FL.MnWtr, FL.DistW, FL.SpDew, FL.Ocean, FL.OceanGrC,
                            FL.Tropics_Water })
                            if (tWater.exists()) RM.Mixer.addRecipe2(
                                T,
                                16,
                                64,
                                aEvent.mStack,
                                ST.make(Blocks.dirt, 8, W),
                                tWater.make(1000),
                                NF,
                                ST.make(MD.FR, "soil", 9, 0));
                        for (FL tWater : new FL[] { FL.Dirty_Water, FL.Swampwater, FL.Stagnant_Water })
                            if (tWater.exists()) RM.Mixer.addRecipe2(
                                T,
                                16,
                                64,
                                ...
                                tWater.make(2000),
                                NF,
                                ST.make(MD.FR, "soil", 10, 0));
                    }
                });
                addListener(new OreDictListenerEvent_TwoNames(OD.itemMulch, OD.itemMud) {
                ...
                addListener(new OreDictListenerEvent_TwoNames(OD.itemMulch, OD.blockMud) {
                ...
                addListener(OD.itemCompost, new IOreDictListenerEvent() {
                ...
                addListener(new OreDictListenerEvent_TwoNames(OD.itemCompost, OD.itemMud) {
                ...
                addListener(new OreDictListenerEvent_TwoNames(OD.itemCompost, OD.blockMud) {
                ...
                addListener(OD.itemMud, new IOreDictListenerEvent() {

                    @Override
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        if (IL.IC2_Fertilizer.exists()) RM.Mixer.addRecipe2(
                            T,
                            16,
                            64,
                            IL.IC2_Fertilizer.get(1),
                            ST.amount(32, aEvent.mStack),
                            ST.make(MD.FR, "soil", 8, 0));
                        RM.Mixer.addRecipe2(
                            T,
                            16,
                            64,
                            IL.FR_Fertilizer.get(1),
                            ST.amount(32, aEvent.mStack),
                            ST.make(MD.FR, "soil", 8, 0));
                        RM.Mixer.addRecipe2(
                            T,
                            16,
                            16,
                            ST.make(Blocks.sand, 1, W),
                            ST.amount(4, aEvent.mStack),
                            ST.make(MD.FR, "soil", 2, 1));
                    }
                });
                addListener(OD.blockMud, new IOreDictListenerEvent() {
                ...
                addListener(OP.stick.dat(ANY.WoodNormal), new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Loom.addRecipe2(
                            ...
                            ST.amount(8, aEvent.mStack),
                            ST.make((Item) OP.plantGtFiber.mRegisteredPrefixItems.get(0), 1, W),
                            ST.make(MD.FR, "frameUntreated", 1, 0));
                        RM.Loom.addRecipe2(
                            T,
                            16,
                            16,
        ...
        RM.Mixer
            .addRecipe2(T, 16, 16, OM.dust(MT.VolcanicAsh, 2 * U), ST.make(Blocks.dirt, 1, W), IL.FR_Compost.get(1));
        ...
        RM.Mixer.addRecipe1(
            ...
            FL.array(FL.Honey.make(600), FL.Honeydew.make(200), FL.Potion_Awkward.make(750)),
            FL.array(FL.Potion_Heal_1.make(750)),
            ZL_IS);
        RM.Mixer.addRecipe1(
            T,
            16,
            64,
            ST.make(Items.melon, 1, W),
            FL.array(FL.Honey.make(600), FL.Honeydew.make(200), FL.Potion_Thick.make(750)),
            FL.array(FL.Potion_Heal_2.make(750)),
            ZL_IS);
        RM.Mixer.addRecipe1(
            T,
            16,
            64,
            ST.make(Items.melon, 1, W),
            FL.array(FL.HoneyGrC.make(600), FL.Honeydew.make(200), FL.Potion_Awkward.make(750)),
            FL.array(FL.Potion_Heal_1.make(750)),
            ZL_IS);
        RM.Mixer.addRecipe1(
            T,
            ...
            64,
            ST.make(Items.melon, 1, W),
            FL.array(FL.HoneyGrC.make(600), FL.Honeydew.make(200), FL.Potion_Thick.make(750)),
            FL.array(FL.Potion_Heal_2.make(750)),
            ZL_IS);
        RM.Mixer.addRecipe1(
            T,
            ...
            64,
            ST.make(Items.melon, 1, W),
            FL.array(FL.HoneyBoP.make(600), FL.Honeydew.make(200), FL.Potion_Awkward.make(750)),
            FL.array(FL.Potion_Heal_1.make(750)),
            ZL_IS);
        RM.Mixer.addRecipe1(
            T,
            ...
            64,
            ST.make(Items.melon, 1, W),
            FL.array(FL.HoneyBoP.make(600), FL.Honeydew.make(200), FL.Potion_Thick.make(750)),
            FL.array(FL.Potion_Heal_2.make(750)),
            ZL_IS);
        ...
        RM.Mixer.addRecipe2(
            ...
            16,
            64,
            IL.FR_Pollen_Cluster.get(3),
            IL.FR_Propolis.get(6),
            ZL_FS,
            FL.Slime_Green.make(250),
            ZL_IS);
        ...
        RM.Mixer
            .addRecipe2(T, 16, 16, OP.gem.mat(MT.Apatite, 1), OM.dust(MT.VolcanicAsh, U * 2), IL.FR_Fertilizer.get(16));

        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.NaNO3), OM.dust(MT.SoylentGreen), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.KNO3), OM.dust(MT.SoylentGreen), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Niter), OM.dust(MT.SoylentGreen), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.NaNO3), OM.dust(MT.MeatRaw), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.KNO3), OM.dust(MT.MeatRaw), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Niter), OM.dust(MT.MeatRaw), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.NaNO3), OM.dust(MT.FishRaw), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.KNO3), OM.dust(MT.FishRaw), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Niter), OM.dust(MT.FishRaw), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.NaNO3), OM.dust(MT.MeatCooked), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.KNO3), OM.dust(MT.MeatCooked), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Niter), OM.dust(MT.MeatCooked), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.NaNO3), OM.dust(MT.FishCooked), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.KNO3), OM.dust(MT.FishCooked), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Niter), OM.dust(MT.FishCooked), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.NaNO3), OM.dust(MT.MeatRotten), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.KNO3), OM.dust(MT.MeatRotten), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Niter), OM.dust(MT.MeatRotten), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.NaNO3), OM.dust(MT.FishRotten), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.KNO3), OM.dust(MT.FishRotten), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Niter), OM.dust(MT.FishRotten), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.NaNO3), ST.make(Blocks.dirt, 2, W), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.KNO3), ST.make(Blocks.dirt, 2, W), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            16,
            ST.array(OM.dust(MT.Niter), ST.make(Blocks.dirt, 2, W), ST.make(Blocks.sand, 2, W)),
            IL.FR_Fertilizer.get(2));
        ...
        for (FL tWater : new FL[] { FL.Water, FL.MnWtr, FL.DistW, FL.SpDew, FL.Ocean, FL.OceanGrC, FL.Tropics_Water })
            if (tWater.exists()) {
                if (IL.IC2_Fertilizer.exists()) RM.Mixer.addRecipe2(
                    T,
                    16,
        ...
        RM.Mixer.addRecipe2(
            ...
            16,
            16,
            ST.make(Blocks.sand, 4, W),
            ST.make(Blocks.dirt, 4, W),
            FL.Dirty_Water.make(2000),
            NF,
            ST.make(MD.FR, "soil", 9, 1));
    }
}
