...
public class Compat_Recipes_SaltyMod extends CompatMods {
    ...
    public Compat_Recipes_SaltyMod(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }

    @Override
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        OUT.println("GT_Mod: Doing Salty Mod Recipes.");
        ...
        CR.shaped(
            ST.make(MD.Salt, "mudBrickWet", 2, 0),
            CR.DEF_NCC_MIR,
            "XY",
            "YX",
            'X',
        ...
        RM.Mixer.addRecipeX(
            ...
            16,
            144,
            ST.array(OP.dust.mat(MT.NaHCO3, 4), OP.dust.mat(MT.NaCl, 4), OP.dust.mat(MT.Gunpowder, 1)),
            ST.make(MD.Salt, "saltStar", 1, 0));
        for (OreDictMaterial tCarbon : ANY.C.mToThis)
            if (ST.valid(OP.dust.mat(tCarbon, 1))) for (OreDictMaterial tClay : ANY.Clay.mToThis) {
                RM.Mixer.addRecipeX(
                    T,
                    16,
                    16,
                    ST.array(
                        OP.dustSmall.mat(MT.NaHCO3, 1),
                        OP.dustSmall.mat(MT.NaCl, 1),
                        OP.dustSmall.mat(tClay, 1),
                        OP.dustSmall.mat(tCarbon, 1)),
                ...
                RM.Mixer.addRecipeX(
                    ...
                    64,
                    ST.array(
                        OP.dust.mat(MT.NaHCO3, 1),
                        OP.dust.mat(MT.NaCl, 1),
                        OP.dust.mat(tClay, 1),
                        OP.dust.mat(tCarbon, 1)),
                    IL.Salt_Mud_Ball.get(4));
            }
    }
}
