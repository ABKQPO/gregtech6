...
public class Compat_Recipes_Highlands extends CompatMods {
    ...
    public Compat_Recipes_Highlands(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }

    @Override
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        OUT.println("GT_Mod: Doing Highlands Recipes.");
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.HiL, "tile.hl_blueFlower", 1, W),
            NF,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.HiL, "tile.hl_lavender", 1, W),
            NF,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.HiL, "tile.hl_whiteFlower", 1, W),
            NF,
