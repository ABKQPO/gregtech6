...
public class Compat_Recipes_Railcraft extends CompatMods {
    ...
    public Compat_Recipes_Railcraft(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        ...
        CR.shaped(
            ...
            OP.nugget.dat(MT.Au),
            'G',
            ST.make(MD.RC, "part.gear", 1, 3));
        CR.shaped(
            ST.make(MD.RC, "part.gear", 1, 1),
            tBits,
            tHammer + "X ",
            "XGX",
            " X" + tFile,
            ...
            ST.make(MD.RC, "part.gear", 1, 3));
        CR.shaped(
            ST.make(MD.RC, "part.gear", 1, 2),
            tBits,
            tHammer + "X ",
            "XGX",
            " X" + tFile,
            'X',
            tIngot.dat(ANY.Steel),
            'G',
            ST.make(MD.RC, "part.gear", 1, 3));

        CR.shaped(
            ST.make(MD.RC, "part.circuit", 1, 0),
            tBits,
            "dCW",
            "GAR",
            "WRL",
            'W',
            ST.make(Blocks.wool, 1, 14),
            'L',
            OP.gem.dat(MT.Lapis),
            'A',
            tIngot.dat(MT.Au),
            ...
            OD.itemGlue);
        CR.shaped(
            ST.make(MD.RC, "part.circuit", 1, 1),
            tBits,
            "dCW",
            "GAR",
            "WRL",
            'W',
            ST.make(Blocks.wool, 1, 13),
            'L',
            OP.gem.dat(MT.Lapis),
            'A',
            tIngot.dat(MT.Au),
            ...
            OD.itemGlue);
        CR.shaped(
            ST.make(MD.RC, "part.circuit", 1, 2),
            tBits,
            "dCW",
            "GAR",
            "WRL",
            'W',
            ST.make(Blocks.wool, 1, 4),
            'L',
            OP.gem.dat(MT.Lapis),
            'A',
            tIngot.dat(MT.Au),
        ...
        CR.shapeless(
            ST.make(MD.RC, "tool.notepad", 1, 0),
            tBits,
            new Object[] { OD.itemFeather, DYE_OREDICTS[DYE_INDEX_Black], OD.paperEmpty,
                ST.make(MD.RC, "tool.magnifying.glass", 1, 0) });

        CR.shapeless(
            ST.make(MD.RC, "part.gear", 1, 1),
            CR.DEF_NCC,
            new Object[] { OP.gearGt.dat(ANY.Fe), ST.make(MD.RC, "part.gear", 1, 3) });
        CR.shapeless(
            ST.make(MD.RC, "part.gear", 1, 2),
            CR.DEF_NCC,
            new Object[] { OP.gearGt.dat(ANY.Steel), ST.make(MD.RC, "part.gear", 1, 3) });
        ...
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 8, 0),
            tBits | DEL_IF_NO_DYES,
            tHammer + "PP",
            tWrench + "PP",
            'P',
            OP.plate.dat(ANY.Fe));
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 8, 1),
            tBits | DEL_IF_NO_DYES,
            "GPG",
            "PGP",
            "GPG",
            ...
            OP.plate.dat(ANY.Fe),
            'G',
            OD.paneGlassColorless);
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 8, 2),
            tBits | DEL_IF_NO_DYES,
            "BPB",
            "PLP",
            "BPB",
            ...
            OD.lever);
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 3),
            tBits | DEL_IF_NO_DYES,
            tWrench + "P",
            tHammer + "P",
            'P',
            OP.plate.dat(ANY.Fe));
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 4),
            tBits | DEL_IF_NO_DYES,
            tWrench + "P",
            tHammer + "P",
            'P',
            OP.plate.dat(ANY.Steel));
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 5),
            tBits,
            "BBB",
            "BFB",
            "BOB",
            'B',
            OP.ingot.dat(MT.Brick),
            'F',
            Items.fire_charge,
            'O',
            OD.craftingFurnace);
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 6),
            tBits,
            "PUP",
            "BFB",
            "POP",
            ...
            OD.craftingFurnace);
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 7),
            tBits | MIR,
            "PPP",
            tHammer + "G" + tWrench,
            "OTO",
            ...
            OD.craftingPiston);
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 8),
            tBits | MIR,
            "PPP",
            tHammer + "G" + tWrench,
            "OTO",
            ...
            OD.craftingPiston);
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 9),
            tBits | MIR,
            "PPP",
            tHammer + "G" + tWrench,
            "OTO",
            ...
            OD.craftingPiston);
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 10),
            tBits,
            " E ",
            " O ",
            "OIO",
            ...
            'O',
            OP.blockSolid.dat(MT.Obsidian));
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 1, 12),
            tBits,
            "GPG",
            "PAP",
            "GPG",
            ...
            ST.make(MD.RC, "part.gear", 1, 2));
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 8, 13),
            tBits | DEL_IF_NO_DYES,
            tHammer + "PP",
            tWrench + "PP",
            'P',
            OP.plate.dat(ANY.Steel));
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 8, 14),
            tBits | DEL_IF_NO_DYES,
            "GPG",
            "PGP",
            "GPG",
            ...
            OD.paneGlassColorless);
        CR.shaped(
            ST.make(MD.RC, "machine.beta", 8, 15),
            tBits | DEL_IF_NO_DYES,
            "BPB",
            "PLP",
            "BPB",
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.disabledrecipes, "railcraft-void-chests", T)) {
            ...
            CR.shaped(
                ST.make(MD.RC, "machine.beta", 1, 11),
                tBits,
                "OOO",
                "OEO",
                "OOO",
        ...
        CR.shaped(
            IL.RC_ShuntingWire.get(1),
            DEF_REV,
            "P" + tHammer,
            "WI",
            'P',
            OP.casingSmall.dat(MT.Pb),
            'W',
        ...
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 0),
            tBits,
            "IOI",
            "GEG",
            "IOI",
            ...
            OP.blockSolid.dat(MT.Obsidian));
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 3, 1),
            tBits,
            "BPB",
            "P" + tWrench + "P",
            "BPB",
            ...
            OP.plate.dat(ANY.Steel),
            'B',
            OP.blockSolid.dat(ANY.Steel));
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 2),
            tBits,
            "IOI",
            "GEG",
            "IOI",
            ...
            OP.blockSolid.dat(MT.Obsidian));
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 4, 3),
            tBits,
            "PPP",
            "PFP",
            "PPP",
            ...
            OD.craftingFurnace);
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 5),
            tBits,
            " N ",
            "RCR",
            'R',
            OD.itemRedstone,
            'N',
            OP.stone.dat(MT.Netherrack),
            'C',
            Items.cauldron);
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 6),
            tBits,
            "PGP",
            "EDE",
            "PGP",
            ...
            Blocks.dispenser);
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 8),
            tBits,
            "IPI",
            "PCP",
            "IPI",
            ...
            tIngot.dat(ANY.Fe),
            'C',
            OD.craftingWorkBench);
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 9),
            tBits,
            " I ",
            " T ",
            " D ",
            ...
            Blocks.dispenser);
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 10),
            tBits,
            " I ",
            "RTR",
            " D ",
        ...
        CR.shaped(
            ...
            ST.make(MD.RC, "machine.alpha", 1, 9));
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 11),
            tBits,
            "PCP",
            "CSC",
            "PCP",
            ...
            Items.golden_carrot);
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 1, 13),
            tBits,
            "IOI",
            "GEG",
            "IOI",
            ...
            OP.blockSolid.dat(MT.Obsidian));
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 6, 14),
            tBits,
            "PPP",
            "ISI",
            "PPP",
            ...
            OD.itemGlue);
        CR.shaped(
            ST.make(MD.RC, "machine.alpha", 4, 15),
            tBits,
            "PDP",
            "DBD",
            "PDP",
        ...
        CR.shaped(
            ST.make(MD.RC, "machine.epsilon", 1, 0),
            tBits,
            "PWP",
            "WWW",
            "PWP",
        ...
        CR.shaped(
            ST.make(MD.RC, "machine.epsilon", 1, 5),
            tBits,
            "TSB",
            "SCS",
            "PSP",
        ...
        CR.shaped(
            ST.make(MD.RC, "tool.crowbar", 1, 0),
            tBits,
            tHammer + "DS",
            "DSD",
            "SD" + tFile,
        ...
        CR.shaped(
            ...
            "SD" + tFile,
            'S',
            OP.ingot.dat(ANY.Steel),
            'D',
            DYE_OREDICTS[DYE_INDEX_Red]);
        CR.shaped(
            ST.make(MD.RC, "tool.whistle.tuner", 1, 0),
            tBits | MIR,
            "S" + tHammer + "S",
            "SSS",
            " S" + tFile,
            'S',
            OP.nugget.dat(ANY.Fe));
        CR.shaped(
            ST.make(MD.RC, "part.turbine.blade", 1, 0),
            tBits,
            "S" + tFile,
            "S ",
            "S" + tHammer,
            ...
            tIngot.dat(ANY.Steel));
        CR.shaped(
            ST.make(MD.RC, "part.turbine.disk", 1, 0),
            tBits,
            "SSS",
            "SBS",
            "SSS",
            ...
            ST.make(MD.RC, "part.turbine.blade", 1, 0));
        CR.shaped(
            ST.make(MD.RC, "part.turbine.rotor", 1, 0),
            tBits,
            "SSS",
            " " + tWrench + " ",
            'S',
            ST.make(MD.RC, "part.turbine.disk", 1, 0));
        CR.shaped(
            ST.make(MD.RC, "borehead.iron", 1, 0),
            tBits,
            "SSS",
            "SBS",
            "SSS",
            'B',
            OP.blockSolid.dat(ANY.Fe),
            'S',
            tIngot.dat(ANY.Steel));
        CR.shaped(
            ST.make(MD.RC, "borehead.steel", 1, 0),
            tBits,
            "SSS",
            "SBS",
            "SSS",
            ...
            tIngot.dat(ANY.Steel));
        CR.shaped(
            ST.make(MD.RC, "borehead.diamond", 1, 0),
            tBits,
            "SSS",
            "SBS",
            "SSS",
            'B',
            OP.blockGem.dat(ANY.Diamond),
            'S',
            tIngot.dat(ANY.Steel));

        CR.shaped(
            ST.make(MD.RC, "cart.loco.steam.solid", 1, 0),
            tBits | DEL_IF_NO_DYES | DEL_OTHER_RECIPES_IF_SAME_NBT,
            "TTF",
            "TTF",
            "BCC",
            'C',
            ...
            Blocks.iron_bars);
        CR.shaped(
            ST.make(MD.RC, "cart.loco.electric", 1, 0),
            tBits | DEL_IF_NO_DYES | DEL_OTHER_RECIPES_IF_SAME_NBT,
            "LP" + tWrench,
            "PEP",
            "GCG",
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "railcraft_admin_anchor_recipe", F)) {
            CR.shaped(
                ST.make(MD.RC, "machine.alpha", 1, 4),
                tBits,
                "IOI",
                "GEG",
                "IOI",
        ...
        RM.pulverizing(
            ST.make(MD.RC, "cube.crushed.obsidian", 1),
            OP.dust.mat(MT.Obsidian, 7),
        ...
        RM.Drying
            .addRecipe1(T, 16, 16, IL.RC_Rebar.get(1), FL.Concrete.make(L), FL.DistW.make(8), IL.RC_Concrete.get(2));

        RM.Injector.addRecipe1(
            T,
            16,
            4096,
            IL.RC_Firestone_Refined.getWithMeta(1, 5000),
            FL.Coolant_IC2_Hot.make(20000000),
            FL.Coolant_IC2.make(20000000),
            IL.RC_Firestone_Refined.get(1));
        RM.Injector.addRecipe1(
            T,
            16,
            8192,
            IL.RC_Firestone_Cracked.getWithMeta(1, 5000),
            FL.Coolant_IC2_Hot.make(20000000),
            FL.Coolant_IC2.make(20000000),
            IL.RC_Firestone_Cracked.get(1));
        RM.Injector.addRecipe1(
            T,
            16,
            4096,
            IL.RC_Firestone_Refined.getWithMeta(1, 4999),
            FL.Coolant_IC2_Hot.make(19996000),
            FL.Coolant_IC2.make(19996000),
            IL.RC_Firestone_Refined.get(1));
        RM.Injector.addRecipe1(
            T,
            16,
            8192,
            IL.RC_Firestone_Cracked.getWithMeta(1, 4999),
            FL.Coolant_IC2_Hot.make(19996000),
            FL.Coolant_IC2.make(19996000),
            IL.RC_Firestone_Cracked.get(1));
        RM.Injector.addRecipe1(
            ...
            2048,
            IL.RC_Firestone_Refined.getWithMeta(1, 5000),
            FL.Lava.make(5000000),
            FL.Lava_Pahoehoe.make(5000000),
            IL.RC_Firestone_Refined.get(1));
        RM.Injector.addRecipe1(
            T,
            16,
        ...
        RM.Injector.addRecipe1(
            ...
            2048,
            IL.RC_Firestone_Refined.getWithMeta(1, 4999),
            FL.Lava.make(4999000),
            FL.Lava_Pahoehoe.make(4999000),
            IL.RC_Firestone_Refined.get(1));
        RM.Injector.addRecipe1(
            T,
            16,
        ...
        if (FL.Lava_Volcanic.exists()) {
            RM.Injector.addRecipe1(
                ...
                128,
                IL.RC_Firestone_Refined.getWithMeta(1, 5000),
                FL.Lava_Volcanic.make(312500),
                FL.Lava_Pahoehoe.make(312500),
                IL.RC_Firestone_Refined.get(1));
            RM.Injector.addRecipe1(
                T,
                16,
        ...
        for (OreDictPrefix tPrefix : OreDictPrefix.VALUES)
            if (tPrefix.contains(TD.Prefix.ORE)) tPrefix.addListener(new IOreDictListenerEvent() {
        ...
        new OreDictListenerEvent_Names() {
            ...
            public void addAllListeners() {
                addListener(
                    new Object[] { OP.stone, OP.cobblestone, OP.treeSapling, OP.treeLeaves, OP.tree, OP.log, OP.plank,
                        OP.beam },
                ...
                addListener(OD.itemClay, new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.Mixer.addRecipe2(
                            ...
                            aEvent.mStack,
                            OM.dust(MT.Bone, U * 3),
                            ST.make(MD.RC, "part.bleached.clay", 1, 0));
                    }
                });
                addListener(DYE_OREDICTS_LENS[DYE_INDEX_Cyan], new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        RM.LaserEngraver.addRecipe2(
                            ...
                            16,
                            2048,
                            OP.gem.mat(MT.Firestone, 1),
                            ST.amount(0, aEvent.mStack),
                            IL.RC_Firestone_Cut.get(1));
                    }
                });
            }
        };
        ...
        for (byte i = 0; i < 16; i++) for (FluidStack tDye : DYE_FLUIDS[i]) {
            RM.Bath.addRecipe1(
                ...
                0,
                16,
                ST.make(MD.RC, "glass", 1, W),
                FL.mul(tDye, 1, 16, T),
                NF,
                ST.make(MD.RC, "glass", 1, 15 - i));
            RM.Bath.addRecipe1(
                T,
                0,
                16,
                IL.RC_Post_Metal.get(1),
                FL.mul(tDye, 1, 16, T),
                NF,
                ST.make(MD.RC, "post.metal", 1, i));
            RM.Bath.addRecipe1(
                T,
                0,
                16,
                ST.make(MD.RC, "post.metal", 1, W),
                FL.mul(tDye, 1, 16, T),
                NF,
                ST.make(MD.RC, "post.metal", 1, i));
            RM.Bath.addRecipe1(
                ...
                0,
                16,
                IL.RC_Platform_Metal.get(1),
                FL.mul(tDye, 1, 16, T),
                NF,
                ST.make(MD.RC, "post.metal.platform", 1, i));
            RM.Bath.addRecipe1(
                T,
                0,
                16,
                ST.make(MD.RC, "post.metal.platform", 1, W),
                FL.mul(tDye, 1, 16, T),
                NF,
                ST.make(MD.RC, "post.metal.platform", 1, i));
        }
        RM.Bath.addRecipe1(
            ...
            MT.Cl.fluid(U20, T),
            NF,
            ST.make(MD.RC, "glass", 1, 0));
        RM.Bath
            .addRecipe1(T, 0, 16, ST.make(MD.RC, "post.metal", 1, W), MT.Cl.fluid(U20, T), NF, IL.RC_Post_Metal.get(1));
        RM.Bath.addRecipe1(
            T,
            0,
            16,
        ...
        for (OreDictMaterial tMat : ANY.Fe.mToThis) if (tMat != MT.Enori) {
            ...
            RM.Press.addRecipe2(
                ...
                64,
                IL.RC_Post_Metal.get(1),
                OP.plateDouble.mat(tMat, 2),
                IL.RC_Platform_Metal.get(4));
            RM.Press.addRecipe2(
                F,
                16,
                64,
                IL.RC_Post_Metal.get(1),
                OP.plateQuadruple.mat(tMat, 1),
                IL.RC_Platform_Metal.get(4));
        }
        ...
        RM.Press.addRecipeX(
            ...
            16,
            64,
            ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Ag, 4), OP.dust.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(4));
        RM.Press.addRecipeX(
            F,
            16,
            16,
            ST.array(IL.RC_Rail_Standard.get(1), OP.railGt.mat(MT.Ag, 1), OP.dustSmall.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(1));
        RM.Press.addRecipeX(
            F,
            16,
            64,
            ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Au, 4), OP.dust.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(4));
        RM.Press.addRecipeX(
            F,
            16,
            16,
            ST.array(IL.RC_Rail_Standard.get(1), OP.railGt.mat(MT.Au, 1), OP.dustSmall.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(1));
        RM.Press.addRecipeX(
            F,
            16,
            64,
            ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Electrum, 4), OP.dust.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(4));
        RM.Press.addRecipeX(
            F,
            16,
            16,
            ST.array(IL.RC_Rail_Standard.get(1), OP.railGt.mat(MT.Electrum, 1), OP.dustSmall.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(1));
        RM.Press.addRecipeX(
            F,
            16,
            64,
            ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Pt, 4), OP.dust.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(8));
        RM.Press.addRecipeX(
            F,
            16,
            16,
            ST.array(IL.RC_Rail_Standard.get(1), OP.railGt.mat(MT.Pt, 1), OP.dustSmall.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(2));
        RM.Press.addRecipeX(
            F,
            16,
            64,
            ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Os, 4), OP.dust.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(16));
        RM.Press.addRecipeX(
            F,
            16,
            16,
            ST.array(IL.RC_Rail_Standard.get(1), OP.railGt.mat(MT.Os, 1), OP.dustSmall.mat(MT.Redstone, 1)),
            IL.RC_Rail_Adv.get(4));
        for (OreDictMaterial tMat : ANY.Cu.mToThis) RM.Press.addRecipeX(
            F,
            16,
            16,
            ST.array(IL.RC_Rail_Standard.get(1), OP.railGt.mat(tMat, 1)),
            IL.RC_Rail_Electric.get(1));
        for (OreDictMaterial tMat : ANY.Blaze.mToThis) {
            RM.Press.addRecipeX(
                F,
                16,
                64,
                ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Ag, 4), OP.dustTiny.mat(tMat, 1)),
                IL.RC_Rail_HS.get(4));
            RM.Press.addRecipeX(
                F,
                16,
                64,
                ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Au, 4), OP.dustTiny.mat(tMat, 1)),
                IL.RC_Rail_HS.get(4));
            RM.Press.addRecipeX(
                F,
                16,
                64,
                ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Electrum, 4), OP.dustTiny.mat(tMat, 1)),
                IL.RC_Rail_HS.get(4));
            RM.Press.addRecipeX(
                F,
                16,
                64,
                ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Pt, 4), OP.dustTiny.mat(tMat, 1)),
                IL.RC_Rail_HS.get(8));
            RM.Press.addRecipeX(
                F,
                16,
                64,
                ST.array(IL.RC_Rail_Standard.get(4), OP.railGt.mat(MT.Os, 4), OP.dustTiny.mat(tMat, 1)),
                IL.RC_Rail_HS.get(16));
        }
