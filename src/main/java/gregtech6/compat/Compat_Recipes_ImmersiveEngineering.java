...
public class Compat_Recipes_ImmersiveEngineering extends CompatMods {
    ...
    public Compat_Recipes_ImmersiveEngineering(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        OUT.println("GT_Mod: Doing Immersive Engineering Recipes.");
        ...
        CR.shapeless(
            ...
            CR.DEF,
            new Object[] { ST.make(BlocksGT.PlanksFireProof, 1, 10) });
        ...
        new OreDictListenerEvent_Names() {
            ...
            public void addAllListeners() {
                addListener(new OreDictListenerEvent_TwoNames("cropHemp", OP.stick.dat(ANY.Wood)) {
