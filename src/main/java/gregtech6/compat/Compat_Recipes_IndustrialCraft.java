...
public class Compat_Recipes_IndustrialCraft extends CompatMods {
    ...
    public Compat_Recipes_IndustrialCraft(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        if (MD.IC2C.mLoaded) OUT.println("GT_Mod: Doing IC2-Classic Things.");
        else OUT.println("GT_Mod: Doing IC2-Exp Things.");
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "generator"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "TDC",
                "BMR",
                "FwW",
                'M',
                ...
                "gt:re-battery1",
                'T',
                aRegistry.getItem(1522),
                'B',
                aRegistry.getItem(1204),
                'F',
                aRegistry.getItem(1104),
                'D',
                aRegistry.getItem(10111));
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "electrolyzer"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "WwW",
                ...
                OD_CIRCUITS[2],
                'W',
                OP.wireGt01.dat(MT.Pt));
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "electroFurnace"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "WWW",
                ...
                OD_CIRCUITS[1],
                'W',
                OP.wireGt01.dat(MT.AnnealedCopper));
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "inductionFurnace"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "WWW",
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "extractor"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                " w ",
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "macerator"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "DwD",
                ...
                'G',
                OP.gearGt.dat(ANY.Steel));
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "compressor"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                " w ",
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "recycler"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "GwG",
                ...
                IL.PISTONS[3],
                'G',
                OP.dust.dat(ANY.Glowstone));
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "massFabricator"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "CXC",
                ...
                OD_CIRCUITS[6],
                'X',
                aRegistry.getItem(20413));
        }

        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "lvTransformer"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "MwM",
                ...
                OD_CIRCUITS[1],
                'X',
                aRegistry.getItem(10041));
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "mvTransformer"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                " w ",
                ...
                OD_CIRCUITS[2],
                'X',
                aRegistry.getItem(10042));
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "hvTransformer"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                " w ",
                ...
                OD_CIRCUITS[3],
                'X',
                aRegistry.getItem(10043));
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "evTransformer"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                " w ",
                ...
                OD_CIRCUITS[4],
                'X',
                aRegistry.getItem(10044));
        }

        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "batBox"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "MBM",
                ...
                OD.plankAnyWood,
                'X',
                aRegistry.getItem(10081),
                'B',
                "gt:re-battery1");
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "mfeUnit"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "BCB",
                ...
                IL.IC2_Machine,
                'X',
                aRegistry.getItem(10083),
                'B',
                "gt:re-battery3",
                'C',
                OD_CIRCUITS[3]);
        }
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "mfsUnit"), T)) {
            CR.shaped(
                ST.mkic(tName, 1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                "BCB",
        ...
        CR.shapeless(
            ST.mkic("barrel", 1),
            CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
            new Object[] { aRegistry.getItem(32714) });

        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.recipereplacements, "ic2_mininglaser", T)) CR.shaped(
            ST.mkic("miningLaser", 1),
            CR.DEF_REV_NCC | CR.DEL_OTHER_SHAPED_RECIPES,
            "LOE",
            "PPC",
            "dTA",
            'L',
            DYE_OREDICTS_LENS[DYE_INDEX_Red],
            'O',
            ...
            OP.plate.dat(MT.Ti),
            'E',
            IL.IC2_EnergyCrystal.wild(1),
            'A',
            IL.IC2_Advanced_Alloy);
        CR.shaped(
            ST.mkic("ironFence", 6),
            CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
            "XXX",
        ...
        try {
            ...
            UT.removeSimpleIC2MachineRecipe(
                ST.make(Items.snowball, 1, W),
            ...
            UT.removeSimpleIC2MachineRecipe(
                ...
                NI);
            UT.removeSimpleIC2MachineRecipe(
                ST.make(Blocks.ice, 1, W),
                ic2.api.recipe.Recipes.compressor.getRecipes(),
                NI);
            UT.removeSimpleIC2MachineRecipe(
                ST.make(Blocks.packed_ice, 1, W),
                ic2.api.recipe.Recipes.compressor.getRecipes(),
                NI);
        } catch (Throwable e) {
        ...
        if (MD.IC2C.mLoaded) { // IC2 Classic
            ...
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "windMill"), T)) {
                CR.shaped(
                    ST.mkic(tName, 1),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                    "PCP",
                    ...
                    'P',
                    OP.plateCurved.dat(MT.Magnalium));
            }
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "waterMill"), T)) {
                CR.shaped(
                    ST.mkic(tName, 1),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                    "PCP",
                    ...
                    OP.stick.dat(MT.IronMagnetic),
                    'P',
                    OP.plateCurved.dat(MT.Al));
            }
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "solarPanel"), T)) {
                CR.shaped(
                    ST.mkic(tName, 1),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                    "wGd",
                    ...
                    OP.cableGt01.dat(ANY.Cu),
                    'S',
                    OP.plateGem.dat(ANY.Si),
                    'G',
                    OP.plateGem.dat(MT.Glass));
            }
            ...
            try {
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.compressor.getRecipes(),
                    ST.make(MD.IC2, "item.itemPartDCP", 1, 0));
            } catch (Throwable e) {
                e.printStackTrace(ERR);
            }
            ...
            RM.Massfab.addRecipe1(
                T,
                1,
                32768,
                ST.make(MD.IC2, "item.itemScrapMetal", 2, 0),
                ST.make(MD.IC2, "item.itemMatter", 1, 0));
            ...
            RM.Generifier
                .addRecipe1(T, F, F, F, F, 0, 1, ST.make(MD.IC2, "item.itemMatter", 1, 0), NF, FL.UUM.make(1), ZL_IS);
            ...
            RM.Mixer.addRecipeX(
                ...
                16,
                48,
                ST.array(IL.IC2_Scrap.get(2), IL.IC2_Fertilizer.get(1), IL.Dye_Bonemeal.get(1)),
                FL.Potion_Poison_2.make(250),
                NF,
                ST.make(MD.IC2, "item.itemSpecialFertilizer", 3, 0));
            RM.Mixer.addRecipeX(
                T,
                16,
                192,
                ST.array(IL.IC2_Scrap.get(8), IL.IC2_Fertilizer.get(4), OM.dust(MT.Ca)),
                FL.Potion_Poison_2.make(1000),
                NF,
                ST.make(MD.IC2, "item.itemSpecialFertilizer", 12, 0));
            for (OreDictMaterial tMat : ANY.Clay.mToThis) {
                for (FluidStack tWater : FL.waters(1000)) RM.Mixer.addRecipeX(
                    T,
                    16,
                    48,
                    ST.array(OM.dust(MT.Coal), OM.dust(tMat), OM.dust(MT.Redstone)),
                    tWater,
                    NF,
                    ST.make(MD.IC2, "constructionFoam", 3, 0));
            }

            RM.Compressor.addRecipe1(
                T,
                16,
                32,
                ST.make(MD.IC2, "item.itemScrapMetal", 8, 0),
                ST.make(MD.IC2, "item.scrapMetalChunk", 1, 0));
            RM.Compressor
                .addRecipe1(T, 16, 32, IL.IC2_Plantball.get(1), ST.make(MD.IC2, "item.itemFuelPlantCmpr", 1, 0));
            RM.Compressor
                .addRecipe1(T, 16, 32, OM.dust(MT.HydratedCoal), ST.make(MD.IC2, "item.itemFuelCoalCmpr", 1, 0));
            RM.Compressor.addRecipe1(T, 16, 16, ST.make(MD.IC2, "item.itemOreUran", 1, 0), OM.ingot(MT.U_238));
            RM.Compressor.addRecipe1(
                T,
                16,
                16,
                ST.make(MD.IC2, "constructionFoam", 1, 0),
                ST.make(MD.IC2, "item.itemPartPellet", 1, 0));
            ...
            for (ItemStack tStack : ST.array(
                ...
                ST.make(MD.IC2, "item.itemEnrichedUranStuff", 1, 204))) if (ST.valid(tStack)) {
            ...
            for (ItemStack tStack : ST.array(
                ...
                ST.make(MD.IC2, "item.itemFuelCoalCmpr", 1, 0))) if (ST.valid(tStack)) {
                    ...
                    if (ST.valid(rStack)) {
                        ...
                        if (temp) {
                            temp = F;
                            RM.Canner
                                .addRecipe2(T, 16, 32, OM.ingot(MT.U_235), IL.Cell_Empty.get(2), ST.mul_(2, rStack));
                        }
                    }
                }
            ...
            CR.shaped(
                ST.make(MD.IC2, "item.itemRawObsidianBlade", 1, 0),
                CR.DEF_REV,
                "OOO",
                "OFO",
                "OOO",
                'O',
                OP.blockDust.dat(MT.Obsidian),
                'F',
                OD.itemFlint);
            ...
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.BONUS_CHEST)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CROSSING)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_LIBRARY)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CORRIDOR)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_DISPENSER)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_CHEST)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_DESERT_CHEST)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Iridium_Shard.get(1), F, T);
            for (WeightedRandomChestContent tContent : ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR)
                .getItems(RNGSUS))
                if (IL.IC2_Iridium_Shard.equal(tContent.theItemId, F, T))
                    ST.set(tContent.theItemId, IL.IC2_Scrapbox.get(1), F, T);
                else if (IL.IC2_Iridium_Ore.equal(tContent.theItemId, F, T))
            ...
            try {
                ...
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    IL.IC2_Fuel_Rod_Empty.get(1));
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    IL.IC2_Food_Can_Empty.get(1));
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    IL.IC2_ShaftIron.get(1));
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    IL.IC2_ShaftSteel.get(1));
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    ST.mkic("ironFence", 1));
                UT.removeSimpleIC2MachineRecipe(
                    ...
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.ingot.mat(MT.Au, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.ingot.mat(MT.Fe, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.ingot.mat(MT.Cu, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.ingot.mat(MT.Pb, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.ingot.mat(MT.Sn, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.ingot.mat(MT.Steel, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.ingot.mat(MT.Bronze, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    ...
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.plate.mat(MT.Fe, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    OP.plate.mat(MT.Cu, 1),
                    ic2.api.recipe.Recipes.metalformerExtruding.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                ...
                UT.removeSimpleIC2MachineRecipe(
                    ...
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    ST.mkic("reactorDepletedUraniumSimple", 1),
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    ST.mkic("reactorDepletedUraniumDual", 1),
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    ST.mkic("reactorDepletedUraniumQuad", 1),
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    ST.mkic("reactorDepletedMOXSimple", 1),
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    ST.mkic("reactorDepletedMOXDual", 1),
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    ST.mkic("reactorDepletedMOXQuad", 1),
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    ST.mkic("RTGPellets", 1),
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    NI);
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                ...
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    ST.mkic("smallUran235", 1));
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    ST.mkic("smallPlutonium", 1));
                UT.removeSimpleIC2MachineRecipe(
                    NI,
                    ic2.api.recipe.Recipes.centrifuge.getRecipes(),
                    ST.mkic("Plutonium", 1));
                ...
                Object tCrop;
                UT.Reflection.getField(tCrop = Crops.instance.getCropList()[13], "mDrop")
                    .set(tCrop, OP.plantGtBlossom.mat(MT.Fe, 1));
                UT.Reflection.getField(tCrop = Crops.instance.getCropList()[14], "mDrop")
                    .set(tCrop, OP.plantGtBlossom.mat(MT.Au, 1));
            } catch (Throwable e) {
                e.printStackTrace(ERR);
            }
            ...
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "metalformer"), T)) {
                CR.shaped(
                    ST.mkic(tName, 1),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                    "XYZ",
                    ...
                    OD_CIRCUITS[4],
                    'X',
                    aRegistry.getItem(20122),
                    'Y',
                    aRegistry.getItem(20201),
                    'Z',
                    aRegistry.getItem(20152));
            }
            if (ConfigsGT.RECIPES
                .get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "orewashingplant"), T)) {
                CR.shaped(
                    ST.mkic(tName, 1),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                    "CXC",
                    ...
                    OD_CIRCUITS[4],
                    'X',
                    aRegistry.getItem(20292));
            }
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "blockcutter"), T)) {
                CR.shaped(
                    ST.mkic(tName, 1),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                    "CXC",
                    ...
                    OD_CIRCUITS[4],
                    'X',
                    aRegistry.getItem(20062));
            }
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "centrifuge"), T)) {
                CR.shaped(
                    ST.mkic(tName, 1),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                    "WWW",
                    ...
                    OD_CIRCUITS[4],
                    'X',
                    aRegistry.getItem(20082),
                    'W',
                    OP.wireGt04.dat(ANY.Cu));
            }

            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.harderrecipes, "ic2_" + (tName = "cesuUnit"), T)) {
                CR.shaped(
                    ST.mkic(tName, 1),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES,
                    "MBM",
                    ...
                    "MBM",
                    'M',
                    OP.plate.dat(MT.Bronze),
                    'X',
                    aRegistry.getItem(10082),
                    'B',
                    "gt:re-battery2");
            }

            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.disabledrecipes, "ic2_" + (tName = "fermenter"), T))
                CR.delate(ST.mkic(tName, 1));
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.disabledrecipes, "ic2_" + (tName = "blastfurnace"), T))
                CR.delate(ST.mkic(tName, 1));
            if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.disabledrecipes, "ic2_forgehammer", T))
                CR.delate(IL.IC2_ForgeHammer.wild(1));
            ...
            CR.shaped(
                ST.make(MD.IC2, "blockreactorvessel", 1, 0),
                CR.DEF_REV_NCC,
                "PSP",
                "SPS",
                "PSP",
                ...
                OP.stone);
            CR.shaped(
                ST.make(MD.IC2, "blockReactorFluidPort", 1, 0),
                CR.DEF_REV_NCC,
                "XXX",
                "XCX",
                "XXX",
                'C',
                OP.cell.dat(MT.Empty),
                'X',
                ST.make(MD.IC2, "blockreactorvessel", 1, 0));
            CR.shaped(
                ST.make(MD.IC2, "blockMachine3", 1, 3),
                CR.DEF_REV_NCC,
                "GGG",
                "G G",
                "CXC",
                ...
                OP.plateGem.dat(MT.Glass));
            CR.shaped(
                ST.make(MD.IC2, "blockGenerator", 1, 7),
                CR.DEF_REV_NCC,
                "PCP",
                "CXC",
                "PCP",
                ...
                OP.cell.dat(MT.Empty),
                'P',
                OP.casingSmall.dat(ANY.Iron),
                'X',
                ST.make(MD.IC2, "blockGenerator", 1, 1));
            CR.shaped(
                ST.make(MD.IC2, "blockHeatGenerator", 1, 1),
                CR.DEF_REV_NCC,
                "PCP",
                "CXC",
                "PCP",
                ...
                OP.casingSmall.dat(ANY.Iron),
                'X',
                ST.make(MD.IC2, "itemRecipePart", 1, 5));
            CR.shaped(
                ST.make(MD.IC2, "blockKineticGenerator", 1, 1),
                CR.DEF_REV_NCC,
                "PPP",
                "XSS",
                "CPP",
                ...
                OP.casingSmall.dat(ANY.Iron),
                'X',
                ST.make(MD.IC2, "itemRecipePart", 1, 6),
                'S',
                IL.IC2_ShaftIron);
            CR.shaped(
                ST.make(MD.IC2, "itemArmorCFPack", 1, 0),
                CR.DEF_REV_NCC,
                "PXP",
                "CPC",
                "CPC",
                ...
                OD_CIRCUITS[1]);
            CR.shaped(
                ST.make(MD.IC2, "itemArmorJetpack", 1, 18001),
                CR.DEF_REV_NCC,
                "PXP",
                "PCP",
                "R R",
                ...
                OD.itemRedstone);
            CR.shaped(
                ST.make(MD.IC2, "itemFoamSprayer", 1, 0),
                CR.DEF_REV_NCC,
                "P  ",
                " P ",
                " CP",
            ...
            for (FluidStack tWater : FL.waters(1000)) {
                RM.Mixer
                    .addRecipe1(T, 16, 16, ST.mkic("constructionFoamPowder", 1), tWater, FL.CFoam.make(1000), ZL_IS);
            }
            ...
            RM.Press
                .addRecipe2(T, 64, 192, OP.ingot.mat(MT.U_238, 18), OP.ingot.mat(MT.U_235, 1), ST.mkic("UranFuel", 3));
            RM.Press
                .addRecipe2(T, 64, 64, OP.ingot.mat(MT.U_238, 6), OP.nugget.mat(MT.U_235, 3), ST.mkic("UranFuel", 1));
            RM.Press.addRecipe2(T, 64, 64, OP.ingot.mat(MT.U_238, 6), OP.ingot.mat(MT.Pu, 3), ST.mkic("MOXFuel", 1));

            RM.Canner.addRecipe2(
                T,
                16,
                16,
                ST.mkic("UranFuel", 1),
                IL.IC2_Fuel_Rod_Empty.get(1),
                ST.mkic("reactorUraniumSimple", 1, 1));
            RM.Canner.addRecipe2(
                T,
                16,
                16,
                ST.mkic("UranFuel", 1),
                IL.Reactor_Rod_Empty.get(1),
                ST.mkic("reactorUraniumSimple", 1, 1));
            RM.Canner.addRecipe2(
                T,
                16,
            ...
            RM.Centrifuge.addRecipe1(
                ...
                ST.mkic("reactorDepletedUraniumSimple", 1),
                OP.dust.mat(MT.Zr, 1),
                OP.crushedCentrifugedTiny.mat(MT.Pu, 1),
                OP.crushedCentrifuged.mat(MT.U_238, 3));
            RM.Centrifuge.addRecipe1(
                T,
                512,
                256,
                ST.mkic("reactorDepletedUraniumDual", 1),
                OP.dust.mat(MT.Zr, 2),
                OP.crushedCentrifugedTiny.mat(MT.Pu, 2),
                OP.crushedCentrifuged.mat(MT.U_238, 6),
                OP.dust.mat(MT.Fe, 1));
            RM.Centrifuge.addRecipe1(
                T,
                512,
                ...
                ST.mkic("reactorDepletedUraniumQuad", 1),
                OP.dust.mat(MT.Zr, 4),
                OP.crushedCentrifugedTiny.mat(MT.Pu, 4),
                OP.crushedCentrifuged.mat(MT.U_238, 12),
                OP.dust.mat(MT.Fe, 3),
                OP.dust.mat(MT.Cu, 2));
            RM.Centrifuge.addRecipe1(
                T,
                ...
                ST.mkic("reactorDepletedMOXSimple", 1),
                OP.dust.mat(MT.Zr, 1),
                OP.crushedCentrifugedTiny.mat(MT.Pu, 21));
            RM.Centrifuge.addRecipe1(
                T,
                512,
                256,
                ST.mkic("reactorDepletedMOXDual", 1),
                OP.dust.mat(MT.Zr, 2),
                OP.crushedCentrifugedTiny.mat(MT.Pu, 42),
                OP.dust.mat(MT.Fe, 1));
            RM.Centrifuge.addRecipe1(
                T,
                512,
                ...
                ST.mkic("reactorDepletedMOXQuad", 1),
                OP.dust.mat(MT.Zr, 4),
                OP.crushedCentrifugedTiny.mat(MT.Pu, 64),
                OP.dust.mat(MT.Fe, 3),
                OP.dust.mat(MT.Cu, 2),
                OP.crushedCentrifugedTiny.mat(MT.Pu, 20));
            RM.Centrifuge
                .addRecipe1(T, 512, 512, ST.mkic("RTGPellets", 1), OP.dust.mat(MT.Fe, 54), OP.dust.mat(MT.Pu, 3));

            new OreDictListenerEvent_Names() {

                @Override
                public void addAllListeners() {
                    addListener("plateDenseAnyIron", "plateDenseAnyIronSteel", new IOreDictListenerEvent() {
                        ...
                        public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                            RM.Press.addRecipe2(
                                ...
                                64,
                                128,
                                ST.amount(6, aEvent.mStack),
                                ST.mkic("smallPlutonium", 27),
                                ST.mkic("RTGPellets", 1));
                            RM.Press.addRecipe2(
                                T,
                                64,
        ...
        if (IL.IC2_Sapling_Rubber.exists()) RM.ic2_extractor(IL.IC2_Sapling_Rubber.get(1), OM.ingot(MT.Rubber, 2 * U9));
        ...
        RM.Autoclave.addRecipe2(
            ...
            0,
            3000,
            OM.dust(MT.EnergiumRed, U * 9),
            ST.tag(9),
            FL.Steam.make(96000),
            FL.DistW.make(450),
            IL.IC2_EnergyCrystal.get(1));

        RM.Boxinator.addRecipe2(T, 16, 16, IL.IC2_Scrap.get(9), ST.tag(9), IL.IC2_Scrapbox.get(1));
        RM.Unboxinator.addFakeRecipe(
            F,
            ST.array(IL.IC2_Scrapbox.get(1)),
            ST.array(IL.IC2_Scrapbox.getWithName(1, "Random Drops, see Scrapbox Handler")),
            null,
            ZL_LONG,
            ZL_FS,
            ZL_FS,
        ...
        for (OreDictMaterial tMat : ANY.Diamond.mToThis) RM.Press.addRecipeX(
            ...
            64,
            256,
            ST.array(IL.IC2_Advanced_Alloy.get(4), OP.plate.mat(MT.Ir, 4), OP.gem.mat(tMat, 1)),
            IL.IC2_Iridium_Alloy.get(1));
        RM.Press.addRecipe2(
            T,
            16,
            64,
            IL.IC2_Compressed_Coal_Ball.get(8),
            OP.dust.mat(MT.Obsidian, 9),
            IL.IC2_Compressed_Coal_Chunk.get(1));
        ...
        for (OreDictMaterial tMat : ANY.Iron.mToThis) RM.Wiremill.addRecipe1(
            T,
            16,
            128,
            (tMat == MT.Enori ? OP.plateGem : OP.plate).mat(tMat, 1),
            ST.mkic("ironCableItem", 6));
        ...
        for (OreDictMaterial tMat : ANY.Rubber.mToThis) {
            RM.Laminator.addRecipe2(
                ...
                64,
                OP.plate.mat(tMat, 1),
                ST.mkic("tinCableItem", 1),
                ST.mkic("insulatedTinCableItem", 1));
            RM.Laminator.addRecipe2(
                T,
                16,
                64,
                OP.plate.mat(tMat, 1),
                ST.mkic("copperCableItem", 1),
                ST.mkic("insulatedCopperCableItem", 1));
            RM.Laminator.addRecipe2(
                T,
                16,
                128,
                OP.plate.mat(tMat, 2),
                ST.mkic("goldCableItem", 1),
                ST.mkic("insulatedGoldCableItem", 1));
            RM.Laminator.addRecipe2(
                T,
                16,
                192,
                OP.plate.mat(tMat, 3),
                ST.mkic("ironCableItem", 1),
                ST.mkic("insulatedIronCableItem", 1));
        }
        ...
        RM.Drying
            .addRecipe1(T, 16, 16, IL.IC2_Scaffold_Iron.get(1), FL.CFoam.make(100), NF, IL.IC2_Wall_Reinforced.get(1));
        ...
        if (IL.HBM_Poison_Powder.exists()) RM.Canner
            .addRecipe2(T, 16, 16, IL.HBM_Poison_Powder.get(1), IL.Spray_Empty.get(1), IL.IC2_Spray_WeedEx.get(1));
        RM.Canner.addRecipe2(T, 16, 16, IL.IC2_Grin_Powder.get(1), IL.Spray_Empty.get(1), IL.IC2_Spray_WeedEx.get(1));
        RM.Canner
            .addRecipe1(T, 16, 16, IL.Spray_Empty.get(1), FL.Potion_Poison_2.make(250), NF, IL.IC2_Spray_WeedEx.get(1));
        if (FL.Poison.exists())
        ...
        RM.Mixer.addRecipeX(
            ...
            16,
            32,
            ST.array(ST.tag(2), IL.IC2_Scrap.get(1), OM.dust(MT.SoylentGreen)),
            IL.IC2_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            32,
            ST.array(ST.tag(2), IL.IC2_Scrap.get(1), OM.dust(MT.MeatRaw)),
            IL.IC2_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            32,
            ST.array(ST.tag(2), IL.IC2_Scrap.get(1), OM.dust(MT.FishRaw)),
            IL.IC2_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            32,
            ST.array(ST.tag(2), IL.IC2_Scrap.get(1), OM.dust(MT.MeatCooked)),
            IL.IC2_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            32,
            ST.array(ST.tag(2), IL.IC2_Scrap.get(1), OM.dust(MT.FishCooked)),
            IL.IC2_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            32,
            ST.array(ST.tag(2), IL.IC2_Scrap.get(1), OM.dust(MT.MeatRotten)),
            IL.IC2_Fertilizer.get(2));
        RM.Mixer.addRecipeX(
            T,
            16,
            32,
            ST.array(ST.tag(2), IL.IC2_Scrap.get(1), OM.dust(MT.FishRotten)),
            IL.IC2_Fertilizer.get(2));
        ...
        RM.Mixer
            .addRecipe2(T, 16, 64, OM.dust(MT.OREMATS.Glauconite), OM.dust(MT.Phosphorus), IL.IC2_Fertilizer.get(4));
        RM.Mixer.addRecipe2(
            T,
            16,
            64,
            OM.dust(MT.OREMATS.Glauconite),
            OM.dust(MT.PhosphorusBlue),
            IL.IC2_Fertilizer.get(4));
        RM.Mixer
            .addRecipe2(T, 16, 64, OM.dust(MT.OREMATS.Glauconite), OM.dust(MT.PhosphorusRed), IL.IC2_Fertilizer.get(4));
        RM.Mixer.addRecipe2(
            T,
            16,
            64,
            OM.dust(MT.OREMATS.Glauconite),
            OM.dust(MT.PhosphorusWhite),
            IL.IC2_Fertilizer.get(4));
        RM.Mixer.addRecipe2(T, 16, 48, OM.dust(MT.OREMATS.Glauconite), OM.dust(MT.PO4), IL.IC2_Fertilizer.get(3));
        RM.Mixer
            .addRecipe2(T, 16, 32, OM.dust(MT.OREMATS.Glauconite), OM.dust(MT.Ash, 3 * U), IL.IC2_Fertilizer.get(2));
        RM.Mixer.addRecipe2(T, 16, 32, OM.dust(MT.OREMATS.Glauconite), OM.dust(MT.DarkAsh), IL.IC2_Fertilizer.get(2));
        RM.Mixer
            .addRecipe2(T, 16, 32, OM.dust(MT.OREMATS.Glauconite), OM.dust(MT.VolcanicAsh), IL.IC2_Fertilizer.get(4));
        ...
        for (OreDictMaterial tMat : ANY.Iron.mToThis) if (tMat != MT.Enori) {
            RM.Welder.addRecipeX(
                ...
                16,
                128,
                ST.array(OP.ingot.mat(tMat, 1), OP.ingot.mat(MT.Bronze, 1), OP.ingot.mat(MT.Sn, 1)),
                IL.IC2_Mixed_Metal_Ingot.get(1));
            RM.Welder.addRecipeX(
                T,
                16,
                256,
                ST.array(OP.plate.mat(tMat, 1), OP.plate.mat(MT.Bronze, 1), OP.plate.mat(MT.Sn, 1)),
                IL.IC2_Mixed_Metal_Ingot.get(1));
        }
        RM.Welder.addRecipeX(
            T,
            16,
            128,
            ST.array(OP.ingot.mat(MT.HSLA, 1), OP.ingot.mat(MT.Bronze, 1), OP.ingot.mat(MT.Sn, 1)),
            IL.IC2_Mixed_Metal_Ingot.get(1));
        RM.Welder.addRecipeX(
            T,
            16,
            256,
            ST.array(OP.plate.mat(MT.HSLA, 1), OP.plate.mat(MT.Bronze, 1), OP.plate.mat(MT.Sn, 1)),
            IL.IC2_Mixed_Metal_Ingot.get(1));
        ...
        new OreDictListenerEvent_Names() {
            ...
            @Override
            public void addAllListeners() {
                addListener("blockSolidObsidian", "blockDustObsidian", new IOreDictListenerEvent() {
        ...
        new GT_BaseCrop(
            "Indigo",
            "Eloraam",
            OP.plantGtBlossom.mat(MT.Indigo, 1),
            null,
            OP.plantGtBlossom.mat(MT.Indigo, 4),
            2,
            4,
            0,
            1,
            ...
            4,
            0,
            new String[] { "Flower", "Color", "Ingredient" });
        new GT_BaseCrop(
            "Flax",
            "Eloraam",
            ST.make(Items.string, 1, 0),
            null,
            null,
            2,
            4,
            ...
            0,
            1,
            new String[] { "Vine", "Silk", "Addictive" });
        new GT_BaseCrop(
            "Oil Berries",
            "Spacetoad",
            OP.plantGtBerry.mat(MT.Oil, 1),
            null,
            null,
            9,
            4,
            ...
            1,
            12,
            new String[] { "Reed", "Fire", "Dark", "Rotten", "Coal", "Oil", "Berry" });
        new GT_BaseCrop(
            "Bobsyeruncle Ranks",
            "GenerikB",
            OP.plantGtBerry.mat(MT.Emerald, 1),
            null,
            null,
            11,
            4,
            ...
            2,
            9,
            new String[] { "Vine", "Shiny", "Emerald", "Berylium", "Crystal" });
        new GT_BaseCrop(
            "Diareed",
            "Direwolf20",
            OP.dustTiny.mat(MT.Diamond, 1),
            null,
            null,
            12,
            4,
            ...
            2,
            10,
            new String[] { "Reed", "Fire", "Shiny", "Coal", "Diamond", "Crystal" });
        new GT_BaseCrop(
            "Withereed",
            "CovertJaguar",
            OP.dust.mat(MT.Coal, 1),
            ST.array(ST.make(Items.coal, 1, 0), ST.make(Items.coal, 1, 0)),
            null,
            8,
            4,
            24000,
            ...
            1,
            6,
            new String[] { "Reed", "Fire", "Undead", "Coal", "Rotten", "Wither" });
        new GT_BaseCrop(
            "Blaze Reed",
            "Mr. Brain",
            ST.make(Items.blaze_powder, 1, 0),
            ST.array(ST.make(Items.blaze_rod, 1, 0)),
            null,
            10,
            4,
            9000,
            ...
            2,
            10,
            new String[] { "Reed", "Fire", "Blaze", "Sulfur" });
        new GT_BaseCrop(
            "Eggplant",
            "Link",
            ST.make(Items.egg, 1, 0),
            ST.array(
                ST.make(Items.chicken, 1, 0),
                ST.make(Items.feather, 1, 0),
                ST.make(Items.feather, 1, 0),
                ST.make(Items.feather, 1, 0)),
            null,
            6,
            ...
            0,
            0,
            new String[] { "Flower", "Food", "Chicken", "Egg", "Feather", "Addictive" });
        new GT_BaseCrop(
            "Corium",
            "Gregorius Techneticies",
            ST.make(Items.leather, 1, 0),
            null,
            null,
            6,
            4,
            ...
            1,
            0,
            new String[] { "Vine", "Cow", "Silk" });
        new GT_BaseCrop(
            "Corpse Plant",
            "Mr. Kenny",
            ST.make(Items.rotten_flesh, 1, 0),
            ST.array(IL.Dye_Bonemeal.get(1), IL.Dye_Bonemeal.get(1), ST.make(Items.bone, 1, 0)),
            null,
            5,
            4,
            0,
            ...
            0,
            3,
            new String[] { "Vine", "Food", "Toxic", "Undead", "Rotten" });
        new GT_BaseCrop(
            "Creeper Weed",
            "General Spaz",
            OP.dust.mat(MT.Gunpowder, 1),
            null,
            null,
            7,
            4,
            ...
            1,
            3,
            new String[] { "Vine", "Creeper", "Explosive", "Fire", "Sulfur", "Saltpeter", "Coal" });
        new GT_BaseCrop(
            "Ender Bloom",
            "RichardG",
            OP.dust.mat(MT.EnderPearl, 1),
            ST.array(
            ...
            1,
            6,
            new String[] { "Flower", "Shiny", "Ender" });
        new GT_BaseCrop(
            "Meat Rose",
            "VintageBeef",
            ST.make(Items.dye, 1, 9),
            ST.array(
                ST.make(Items.beef, 1, 0),
                ST.make(Items.porkchop, 1, 0),
                ST.make(Items.chicken, 1, 0),
                ST.make(Items.fish, 1, 0)),
            null,
            7,
            4,
            1500,
            ...
            3,
            0,
            new String[] { "Flower", "Food", "Cow", "Fish", "Chicken", "Pig" });
        new GT_BaseCrop(
            "Milkwart",
            "Mr. Brain",
            OP.plantGtWart.mat(MT.Milk, 1),
            null,
            OP.plantGtWart.mat(MT.Milk, 1),
            6,
            3,
            ...
            1,
            0,
            new String[] { "Wart", "Food", "Milk", "Cow", "Ingredient" });
        new GT_BaseCrop(
            "Glowshrooms",
            "Speiger",
            OP.plantGtWart.mat(MT.Glowstone, 1),
            null,
            OP.plantGtWart.mat(MT.Glowstone, 1),
            6,
            3,
            ...
            2,
            0,
            new String[] { "Wart", "Shiny", "Ingredient" });
        new GT_BaseCrop(
            "Slime Plant",
            "Neowulf",
            ST.make(Items.slime_ball, 1, 0),
            null,
            null,
            6,
            4,
            ...
            0,
            2,
            new String[] { "Bush", "Slime", "Bouncy", "Sticky" });
        new GT_BaseCrop(
            "Spidernip",
            "Ms. Muffet",
            ST.make(Items.string, 1, 0),
            ST.array(ST.make(Items.spider_eye, 1, 0), ST.make(Blocks.web, 1, 0)),
            null,
            4,
            4,
            600,
            ...
            1,
            3,
            new String[] { "Flower", "Toxic", "Silk", "Spider", "Ingredient", "Addictive" });
        new GT_BaseCrop(
            "Tear Stalks",
            "Neowulf",
            ST.make(Items.ghast_tear, 1, 0),
            null,
            null,
            8,
            4,
            ...
            0,
            0,
            new String[] { "Reed", "Healing", "Nether", "Ingredient", "Ghast" });
        new GT_BaseCrop(
            "Tine",
            "Gregorius Techneticies",
            OP.plantGtTwig.mat(MT.Sn, 1),
            null,
            null,
            5,
            3,
            ...
            0,
            0,
            new String[] { "Bush", "Shiny", "Metal", "Pine", "Tin" });
        new GT_BaseCrop(
            "Coppon",
            "Mr. Brain",
            OP.plantGtFiber.mat(MT.Cu, 1),
            null,
            null,
            6,
            3,
            ...
            1,
            1,
            new String[] { "Bush", "Shiny", "Metal", "Cotton", "Copper" });
        new GT_BaseCrop(
            "Argentia",
            "Eloraam",
            OP.plantGtBlossom.mat(MT.Ag, 1),
            null,
            null,
            7,
            4,
            ...
            0,
            0,
            new String[] { "Reed", "Shiny", "Metal", "Silver" });
        new GT_BaseCrop(
            "Plumbilia",
            "KingLemming",
            OP.plantGtBlossom.mat(MT.Pb, 1),
            null,
            null,
            6,
            4,
            ...
            1,
            1,
            new String[] { "Reed", "Heavy", "Metal", "Lead" });
        new GT_BaseCrop(
            "Steeleaf Ranks",
            "Benimatic",
            OP.nugget.mat(MT.Steeleaf, 1),
            ST.array(OP.ingot.mat(MT.Steeleaf, 1)),
            null,
            10,
            4,
            30000,
            ...
            2,
            8,
            new String[] { "Vine", "Metal", "Iron" });
        new GT_BaseCrop(
            "Liveroots",
            "Benimatic",
            OP.dust.mat(MT.LiveRoot, 1),
            ST.array(IL.TF_LiveRoot.get(1)),
            null,
            8,
            4,
            0,
        ...
        new GT_BaseCrop(
            ...
            0,
            2,
            new String[] { "Wheat", "Food", "Grain" });
        new GT_BaseCrop(
            "Barley",
            "Glitchfiend",
            IL.Crop_Barley.get(1),
            null,
            IL.Crop_Barley.get(1),
            1,
            7,
        ...
        new GT_BaseCrop(
            "Tea",
            "Pam",
            OP.plantGtBlossom.mat(MT.Tea, 1),
            null,
            OP.plantGtBlossom.mat(MT.Tea, 4),
            2,
            4,
            0,
            1,
            ...
            0,
            1,
            new String[] { "Leaves", "Food", "Addictive" });
        new GT_BaseCrop(
            "Mint",
            "Gregorius Techneticies",
            OP.plantGtBlossom.mat(MT.Mint, 1),
            null,
            OP.plantGtBlossom.mat(MT.Mint, 4),
            2,
            4,
            0,
            1,
        ...
        new GT_BaseCrop(
            ...
            1,
            2,
            new String[] { "Bush", "Food", "Fruit", "Explosive" });
        new GT_BaseCrop(
            "Green Apple Tree",
            "The Guy",
            IL.Food_Apple_Green.get(1),
            null,
            IL.Food_Apple_Green.get(4),
            3,
            4,
            0,
            3,
            ...
            1,
            2,
            new String[] { "Bush", "Food", "Fruit", "Apple" });
        new GT_BaseCrop(
            "Yellow Apple Tree",
            "The Guy",
            IL.Food_Apple_Yellow.get(1),
            null,
            IL.Food_Apple_Yellow.get(4),
            3,
            4,
            0,
            3,
        ...
        new GT_BaseCrop(
            "Red Apple Tree",
            "The Guy",
            IL.Food_Apple_Red.get(1),
            null,
            IL.Food_Apple_Red.get(4),
            3,
            4,
            0,
            3,
        ...
        new GT_BaseCrop(
            "Dark Red Apple Tree",
            "The Guy",
            IL.Food_Apple_DarkRed.get(1),
            null,
            IL.Food_Apple_DarkRed.get(4),
            3,
            4,
            0,
            3,
        ...
        new GT_BaseCrop(
            "Chili",
            "Gregorius Techneticies",
            IL.Food_Chili_Pepper.get(1),
            null,
            IL.Food_Chili_Pepper.get(4),
            3,
            4,
            0,
            3,
            ...
            2,
            1,
            new String[] { "Vine", "Food", "Fruit", "Fire" });
        new GT_BaseCrop(
            "Tomato Plant",
            "Kirby",
            IL.Food_Tomato.get(1),
            null,
            IL.Food_Tomato.get(4),
            2,
            4,
            0,
            3,
            ...
            1,
            3,
            new String[] { "Vine", "Food", "Fruit", "Vegetable" });
        new GT_BaseCrop(
            "Red Grapes",
            "Pam",
            IL.Food_Grapes_Red.get(1),
            null,
            IL.Food_Grapes_Red.get(4),
            3,
            4,
            0,
            3,
            ...
            2,
            3,
            new String[] { "Vine", "Food", "Fruit" });
        new GT_BaseCrop(
            "White Grapes",
            "Binnie",
            IL.Food_Grapes_White.get(1),
            null,
            IL.Food_Grapes_White.get(4),
            3,
            4,
            0,
            3,
        ...
        new GT_BaseCrop(
            "Green Grapes",
            "Gwafu",
            IL.Food_Grapes_Green.get(1),
            null,
            IL.Food_Grapes_Green.get(4),
            3,
            4,
            0,
            3,
        ...
        new GT_BaseCrop(
            "Purple Grapes",
            "Gregorius Techneticies",
            IL.Food_Grapes_Purple.get(1),
            ST.array(IL.Food_Grapes_Purple.getWithName(1, "Member Berries")),
            IL.Food_Grapes_Purple.get(4),
            3,
            4,
            0,
            3,
            ...
            2,
            3,
            new String[] { "Vine", "Food", "Fruit", "Member?" });
        new GT_BaseCrop(
            "Blueberry Bush",
            "Pam",
            IL.Food_Blueberry.get(1),
            null,
            IL.Food_Blueberry.get(4),
            3,
            5,
            0,
            4,
            ...
            4,
            2,
            new String[] { "Bush", "Food", "Fruit", "Berry", "Color" });
        new GT_BaseCrop(
            "Gooseberry Bush",
            "Pam",
            IL.Food_Gooseberry.get(1),
            null,
            IL.Food_Gooseberry.get(4),
            3,
            5,
            0,
            4,
            ...
            1,
            2,
            new String[] { "Bush", "Food", "Fruit", "Berry" });
        new GT_BaseCrop(
            "Candleberry Bush",
            "Pam",
            IL.Food_Candleberry.get(1),
            null,
            IL.Food_Candleberry.get(4),
            3,
            5,
            0,
            4,
            ...
            0,
            2,
            new String[] { "Bush", "Food", "Fruit", "Berry", "Wax" });
        new GT_BaseCrop(
            "Cranberries",
            "Pam",
            IL.Food_Cranberry.get(1),
            null,
            IL.Food_Cranberry.get(4),
            3,
            4,
            0,
            3,
            ...
            2,
            3,
            new String[] { "Vine", "Food", "Fruit", "Berry" });
        new GT_BaseCrop(
            "Black Currants",
            "Gregorius Techneticies",
            IL.Food_Currants_Black.get(1),
            null,
            IL.Food_Currants_Black.get(4),
            3,
            5,
            0,
            4,
        ...
        new GT_BaseCrop(
            "White Currants",
            "Gregorius Techneticies",
            IL.Food_Currants_White.get(1),
            null,
            IL.Food_Currants_White.get(4),
            3,
            5,
            0,
            4,
        ...
        new GT_BaseCrop(
            "Red Currants",
            "Gregorius Techneticies",
            IL.Food_Currants_Red.get(1),
            null,
            IL.Food_Currants_Red.get(4),
            3,
            5,
            0,
            4,
        ...
        new GT_BaseCrop(
            "Blackberries",
            "Pam",
            IL.Food_Blackberry.get(1),
            null,
            IL.Food_Blackberry.get(4),
            3,
            4,
            0,
            3,
        ...
        new GT_BaseCrop(
            "Raspberries",
            "Pam",
            IL.Food_Raspberry.get(1),
            null,
            IL.Food_Raspberry.get(4),
            3,
            4,
            0,
            3,
        ...
        new GT_BaseCrop(
            "Strawberries",
            "Pam",
            IL.Food_Strawberry.get(1),
            null,
            IL.Food_Strawberry.get(4),
            3,
            4,
            0,
            1,
        ...
        new GT_BaseCrop(
            ...
            0,
            1,
            new String[] { "Vegetable", "Food", "Ingredient" });
        new GT_BaseCrop(
            "Cucumber",
            "Pam",
            IL.Food_Cucumber.get(1),
            null,
            IL.Food_Cucumber.get(4),
            2,
            4,
            0,
            1,
        ...
        new GT_BaseCrop(
            "Peanuts",
            "Snoopy",
            IL.Food_Peanut.get(1),
            null,
            IL.Food_Peanut.get(4),
            3,
            4,
            0,
            1,
            ...
            2,
            4,
            new String[] { "Bush", "Food", "Nut" });
        new GT_BaseCrop(
            "Ananas",
            "Spongebob",
            IL.Food_Ananas.get(1),
            null,
            IL.Food_Ananas.get(4),
            4,
            3,
            0,
            1,
            ...
            1,
            1,
            new String[] { "Bush", "Food", "Fruit", "Pine", "Apple" });
        // TIER,SIZE, ,AH,HA,CH,FD,DF,CO,WD
        new GT_BaseCrop(
            "Desert Nova",
            "Mithion",
            IL.ARS_DesertNova.get(1, IL.DesertNova.get(1)),
            null,
            IL.ARS_DesertNova.get(4, IL.DesertNova.get(4)),
            6,
            4,
            0,
            1,
            ...
            4,
            10,
            new String[] { "Cactus", "Magic", "Fire", "Explosive" });
        new GT_BaseCrop(
            "Cerublossom",
            "Mithion",
            IL.ARS_Cerublossom.get(1, IL.Cerublossom.get(1)),
            null,
            IL.ARS_Cerublossom.get(4, IL.Cerublossom.get(4)),
            6,
            4,
            0,
            1,
            ...
            4,
            10,
            new String[] { "Flower", "Magic", "Shiny" });
        new GT_BaseCrop(
            "Shimmerleaf",
            "Azanor",
            OP.chunkGt.mat(MT.Hg, 1),
            null,
            IL.TC_Shimmerleaf.get(4),
            11,
            4,
            0,
            1,
            ...
            1,
            8,
            new String[] { "Flower", "Magic", "Shiny", "Metal", "Mercury" });
        new GT_BaseCrop(
            "Cinderpearl",
            "Azanor",
            ST.make(Items.blaze_powder, 1, 0),
            null,
            IL.TC_Cinderpearl.get(4),
            8,
            4,
            0,
            1,
            ...
            2,
            8,
            new String[] { "Flower", "Magic", "Fire", "Blaze", "Sulfur", "Ingredient" });
    }
}
