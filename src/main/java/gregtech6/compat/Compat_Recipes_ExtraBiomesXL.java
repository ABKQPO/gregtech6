...
public class Compat_Recipes_ExtraBiomesXL extends CompatMods {
    ...
    public Compat_Recipes_ExtraBiomesXL(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }

    @Override
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        OUT.println("GT_Mod: Doing EBXL Recipes.");
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.EBXL, "vines", 1, 0),
            NF,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.EBXL, "waterplant1", 1, 0),
            NF,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.EBXL, "flower1", 1, 6),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Brown],
            IL.EBXL_Dye_Brown.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.EBXL, "flower1", 1, 7),
            NF,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.EBXL, "flower2", 1, 3),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_White],
            IL.EBXL_Dye_White.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.EBXL, "flower2", 1, 4),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Blue],
            IL.EBXL_Dye_Blue.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.EBXL, "flower2", 1, 5),
            NF,
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.EBXL, "flower2", 1, 7),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Black],
            IL.EBXL_Dye_Black.get(1));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.EBXL, "flower2", 1, 8),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_White],
            IL.EBXL_Dye_White.get(1));
        RM.Squeezer.addRecipe1(
