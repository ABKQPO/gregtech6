...
public class Compat_Recipes_Botania extends CompatMods {
    ...
    public Compat_Recipes_Botania(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        ...
        CR.shaped(
            ST.make(MD.BOTA, "openBucket", 1, 0),
            DEF_REV | DEL_OTHER_SHAPED_RECIPES,
            "XhX",
            " Y ",
            'Y',
            OP.plate.dat(MT.ElvenElementium),
            'X',
            OP.plateCurved.dat(MT.ElvenElementium));
        ...
        RM.Hammer
            .addRecipe1(T, 16, 48, 8000, ST.make(MD.BOTA, "livingrock", 1, W), OP.rockGt.mat(MT.STONES.Livingrock, 4));
        RM.Hammer.addRecipe1(
            T,
            16,
            48,
            8000,
            ST.make(MD.BOTA, "livingrock0SlabFull", 1, W),
            OP.rockGt.mat(MT.STONES.Livingrock, 4));
        RM.Hammer.addRecipe1(
            T,
            16,
            48,
            8000,
            ST.make(MD.BOTA, "livingrock1SlabFull", 1, W),
            OP.rockGt.mat(MT.STONES.Livingrock, 4));
        RM.Hammer.addRecipe1(
            T,
            16,
            48,
            8000,
            ST.make(MD.BOTA, "livingrock0Wall", 1, W),
            OP.rockGt.mat(MT.STONES.Livingrock, 4));
        RM.Hammer.addRecipe1(
            T,
            16,
            48,
            8000,
            ST.make(MD.BOTA, "livingrock0Stairs", 1, W),
            OP.rockGt.mat(MT.STONES.Livingrock, 6));
        RM.Hammer.addRecipe1(
            T,
            16,
            48,
            8000,
            ST.make(MD.BOTA, "livingrock1Stairs", 1, W),
            OP.rockGt.mat(MT.STONES.Livingrock, 6));
        RM.Hammer.addRecipe1(
            T,
            16,
            48,
            8000,
            ST.make(MD.BOTA, "livingrock0Slab", 1, W),
            OP.rockGt.mat(MT.STONES.Livingrock, 2));
        RM.Hammer.addRecipe1(
            T,
            16,
            48,
            8000,
            ST.make(MD.BOTA, "livingrock1Slab", 1, W),
            OP.rockGt.mat(MT.STONES.Livingrock, 2));
        ...
        RM.Crusher.addRecipe1(
            ...
            OP.rockGt.mat(MT.STONES.Livingrock, 4));
        RM.Crusher
            .addRecipe1(T, 16, 48, ST.make(MD.BOTA, "livingrock0Wall", 1, W), OP.rockGt.mat(MT.STONES.Livingrock, 4));
        RM.Crusher
            .addRecipe1(T, 16, 48, ST.make(MD.BOTA, "livingrock0Stairs", 1, W), OP.rockGt.mat(MT.STONES.Livingrock, 6));
        RM.Crusher
            .addRecipe1(T, 16, 48, ST.make(MD.BOTA, "livingrock1Stairs", 1, W), OP.rockGt.mat(MT.STONES.Livingrock, 6));
        RM.Crusher
            .addRecipe1(T, 16, 48, ST.make(MD.BOTA, "livingrock0Slab", 1, W), OP.rockGt.mat(MT.STONES.Livingrock, 2));
        RM.Crusher
            .addRecipe1(T, 16, 48, ST.make(MD.BOTA, "livingrock1Slab", 1, W), OP.rockGt.mat(MT.STONES.Livingrock, 2));
    }
}
