...
public class Compat_Recipes_ActuallyAdditions extends CompatMods {
    ...
    public Compat_Recipes_ActuallyAdditions(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }

    @Override
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        OUT.println("GT_Mod: Actually Adding Recipes.");
        ...
        CR.shapeless(
            ST.make(MD.AA, "itemFood", 1, 19),
            CR.DEF_REM_NCC,
            new Object[] { ST.make(MD.AA, "itemFood", 1, 10), "foodChocolatecream" });
        CR.shapeless(
            ST.make(MD.AA, "itemFood", 1, 6),
            CR.DEF_REM_NCC,
            new Object[] { Items.bowl, ST.make(MD.AA, "itemFood", 1, 7), ST.make(MD.AA, "itemFood", 1, 7),
                ST.make(MD.AA, "itemFood", 1, 7), "foodKetchup", OP.dust.dat(MT.MeatCooked) });
        CR.shapeless(
            ST.make(MD.AA, "itemFood", 1, 14),
            CR.DEF_REM_NCC,
            new Object[] { IL.Food_Dough_Flat_Ketchup, "listAllfishcooked", "listAllmushroom", IL.Food_Carrot_Sliced,
                IL.Food_Carrot_Sliced, IL.Food_Carrot_Sliced, IL.Food_Cheese_Sliced, IL.Food_Cheese_Sliced,
                IL.Food_Cheese_Sliced });
        CR.shapeless(
            ST.make(MD.AA, "itemFood", 1, 13),
            CR.DEF_REM_NCC,
            new Object[] { IL.Food_Buns_Sliced, "listAllbeefcooked", IL.Food_Cheese_Sliced, IL.Food_Cheese_Sliced,
                IL.Food_Cucumber_Sliced, IL.Food_Tomato_Sliced, IL.Food_Onion_Sliced });
        CR.shapeless(
            ST.make(MD.AA, "itemFood", 1, 13),
            CR.DEF_REM_NCC,
            new Object[] { IL.Food_Bun_Sliced, IL.Food_Bun_Sliced, "listAllbeefcooked", IL.Food_Cheese_Sliced,
                IL.Food_Cheese_Sliced, IL.Food_Cucumber_Sliced, IL.Food_Tomato_Sliced, IL.Food_Onion_Sliced });
        CR.shapeless(
            ST.make(MD.AA, "itemFood", 1, 11),
            CR.DEF_REM_NCC,
            new Object[] { IL.Food_Baguettes_Sliced, "listAllfishcooked", IL.Food_Cheese_Sliced, IL.Food_Cheese_Sliced,
                IL.Food_Cucumber_Sliced, IL.Food_Tomato_Sliced, OD.paperEmpty, OD.paperEmpty });
        CR.shapeless(
            ST.make(MD.AA, "itemFood", 1, 11),
            CR.DEF_REM_NCC,
            new Object[] { IL.Food_Baguette_Sliced, IL.Food_Baguette_Sliced, "listAllfishcooked", IL.Food_Cheese_Sliced,
                IL.Food_Cheese_Sliced, IL.Food_Cucumber_Sliced, IL.Food_Tomato_Sliced, OD.paperEmpty, OD.paperEmpty });
        ...
        RM.Replicator
            .addRecipe2(T, 16, 144, OP.blockDust.mat(MT.Redstone, 1), ST.tag(0), OP.blockGem.mat(MT.Redstonia, 1));
        RM.Replicator.addRecipe2(T, 16, 144, OP.blockGem.mat(MT.Lapis, 1), ST.tag(0), OP.blockGem.mat(MT.Palis, 1));
        RM.Replicator
            .addRecipe2(T, 16, 144, OP.blockGem.mat(MT.Coal, 1), ST.tag(0), OP.blockGem.mat(MT.VoidCrystal, 1));
        for (OreDictMaterial tMat : ANY.Diamond.mToThis) if (tMat != MT.Diamantine) {
            ...
            RM.Replicator
                .addRecipe2(T, 16, 144, OP.blockGem.mat(tMat, 1), ST.tag(0), OP.blockGem.mat(MT.Diamantine, 1));
        }
        ...
        RM.Squeezer.addRecipe1(
            ...
            16,
            16,
            ST.make(MD.AA, "blockBlackLotus", 1, 0),
            NF,
            DYE_FLUIDS_FLOWER[DYE_INDEX_Black],
            IL.AA_Dye_Black.get(2));
