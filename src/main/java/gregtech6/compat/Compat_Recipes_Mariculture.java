...
public class Compat_Recipes_Mariculture extends CompatMods {
    ...
    public Compat_Recipes_Mariculture(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }

    @Override
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        OUT.println("GT_Mod: Doing Mariculture Recipes.");
        ...
        RM.Bath.addRecipe1(
            ...
            MT.Au.liquid(4 * U, T),
            NF,
            ST.make(MD.MaCu, "crafting", 1, 0));
        RM.Bath.addRecipe1(
            T,
            0,
            16,
            ST.make(MD.MaCu, "crafting", 1, 19),
            FL.Oil_Fish.make(6500),
            NF,
            ST.make(MD.MaCu, "crafting", 1, 2));
        RM.Bath.addRecipe1(
            T,
            0,
            16,
            ST.make(MD.MaCu, "crafting", 1, 19),
            FL.Oil_Whale.make(3250),
            NF,
            ST.make(MD.MaCu, "crafting", 1, 2));
        RM.Bath.addRecipe1(
            T,
            0,
            16,
            ST.make(Items.netherbrick, 1, W),
            FL.Lava.make(100),
            NF,
            ST.make(MD.MaCu, "crafting", 1, 14));
        RM.Bath.addRecipe1(
            T,
            0,
            16,
            ST.make(Items.brick, 1, W),
            FL.Lava.make(250),
            NF,
            ST.make(MD.MaCu, "crafting", 1, 14));
        RM.Bath.addRecipe1(
        ...
        RM.Mixer
            .addRecipe1(T, 16, 16, OP.gemChipped.mat(MT.Sugar, 1), FL.Milk.make(125), FL.make("custard", 125), ZL_IS);
        ...
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_static", 1, 2), ST.make(Items.dye, 2, DYE_INDEX_Pink));
        RM.Squeezer.addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_static", 1, 3), IL.MaCu_Dye_Red.get(2));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_static", 1, 4), ST.make(Items.dye, 2, DYE_INDEX_LightBlue));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_static", 1, 5), ST.make(Items.dye, 2, DYE_INDEX_Magenta));
        ...
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_static", 1, 8), ST.make(Items.dye, 2, DYE_INDEX_Orange));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_static", 1, 9), ST.make(Items.dye, 2, DYE_INDEX_Purple));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_static", 1, 10), ST.make(Items.dye, 2, DYE_INDEX_Gray));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_static", 1, 11), ST.make(Items.dye, 2, DYE_INDEX_LightGray));
        ...
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_growable", 1, 2), ST.make(Items.dye, 2, DYE_INDEX_Pink));
        RM.Squeezer.addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_growable", 1, 3), IL.MaCu_Dye_Red.get(2));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.MaCu, "plant_growable", 1, 4),
            ST.make(Items.dye, 2, DYE_INDEX_LightBlue));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_growable", 1, 5), ST.make(Items.dye, 2, DYE_INDEX_Magenta));
        ...
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_growable", 1, 8), ST.make(Items.dye, 2, DYE_INDEX_Orange));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_growable", 1, 9), ST.make(Items.dye, 2, DYE_INDEX_Purple));
        RM.Squeezer
            .addRecipe1(T, 16, 16, ST.make(MD.MaCu, "plant_growable", 1, 10), ST.make(Items.dye, 2, DYE_INDEX_Gray));
        RM.Squeezer.addRecipe1(
            T,
            16,
            16,
            ST.make(MD.MaCu, "plant_growable", 1, 11),
