...
public class Compat_Recipes_Ganys extends CompatMods {
    ...
    public Compat_Recipes_Ganys(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        if (MD.EtFu.mLoaded) {
            ...
            ItemStack tEtFuturumPurpur = ST.make(MD.EtFu, "purpur_block", 1, 0),
                tEtFuturumPurpurPillar = ST.make(MD.EtFu, "purpur_pillar", 1, 0);
            ...
            CR.shaped(
                IL.EtFu_Block_Honey.get(1),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES | CR.DEL_OTHER_NATIVE_RECIPES,
                "XX",
                "XX",
                'X',
            ...
            CR.shaped(
                ST.make(MD.EtFu, "slime", 1, 0),
                CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES | CR.DEL_OTHER_NATIVE_RECIPES,
                "XXX",
                "XXX",
                "XXX",
                'X',
                ST.make(Items.slime_ball, 1, W));
            ...
            RM.Boxinator
                .addRecipe2(T, 16, 16, ST.make(Items.slime_ball, 9, W), ST.tag(9), ST.make(MD.EtFu, "slime", 1, 0));
            ...
            RM.Squeezer.addRecipe1(
                ...
                16,
                16,
                ST.make(MD.EtFu, "sponge", 1, 1),
                NF,
                FL.Water.make(125),
                ST.make(MD.EtFu, "sponge", 1, 0));
            ...
            RM.sawing(
                ...
                F,
                100,
                ST.make(MD.EtFu, "red_sandstone", 1, W),
                ST.make(MD.EtFu, "red_sandstone_slab", 2, 0));
            ...
            RM.Mixer.addRecipe1(
                ...
                FL.Potion_FireResistance_1.make(125),
            ...
            RM.Mixer.addRecipe1(
                ...
                16,
                IL.EtFu_Chorus_Fruit.get(1),
                FL.Potion_FireResistance_1L.make(125),
                FL.Dragon_Breath.make(125),
                ZL_IS);
            RM.Mixer.addRecipe1(
                T,
                ...
                16,
                IL.EtFu_Chorus_Fruit.get(1),
                FL.Potion_FireResistance_1S.make(125),
                FL.Dragon_Breath.make(125),
                ZL_IS);
            RM.Mixer.addRecipe1(
                T,
                ...
                16,
                IL.EtFu_Chorus_Fruit.get(1),
                FL.Potion_FireResistance_1LS.make(125),
                FL.Dragon_Breath.make(125),
                ZL_IS);
            RM.Mixer.addRecipe1(
                T,
                ...
                16,
                IL.EtFu_Chorus_Fruit.get(1),
                FL.Potion_FireResistance_1D.make(125),
                FL.Dragon_Breath.make(125),
                ZL_IS);
            RM.Mixer.addRecipe1(
                T,
                ...
                16,
                IL.EtFu_Chorus_Fruit.get(1),
                FL.Potion_FireResistance_1LD.make(125),
                FL.Dragon_Breath.make(125),
                ZL_IS);
            ...
            RM.Squeezer.addRecipe1(
                ...
                16,
                16,
                ST.make(MD.EtFu, "rose", 1, 0),
                NF,
                DYE_FLUIDS_FLOWER[DYE_INDEX_Red],
                ST.make(Items.dye, 1, DYE_INDEX_Red));
            ...
            RM.Squeezer.addRecipe1(
                ...
                16,
                16,
                ST.make(MD.EtFu, "lily_of_the_valley", 1, 0),
                NF,
                DYE_FLUIDS_FLOWER[DYE_INDEX_White],
                ST.make(MD.EtFu, "dye", 1, 0));
            RM.Juicer.addRecipe1(
                T,
                16,
                16,
            ...
            RM.Squeezer.addRecipe1(
                ...
                16,
                16,
                ST.make(MD.EtFu, "cornflower", 1, 0),
                NF,
                DYE_FLUIDS_FLOWER[DYE_INDEX_Blue],
                ST.make(MD.EtFu, "dye", 1, 1));
            RM.Juicer.addRecipe1(
                T,
                16,
                16,
            ...
            RM.Squeezer.addRecipe1(
                ...
                16,
                16,
                ST.make(MD.EtFu, "wither_rose", 1, 0),
                NF,
                DYE_FLUIDS_FLOWER[DYE_INDEX_Black],
                ST.make(MD.EtFu, "dye", 1, 3));
            RM.Juicer.addRecipe1(
                T,
                16,
                16,
            ...
            RM.Bath.addRecipe1(
                ...
                NF,
                ST.make(MD.EtFu, "netherite_sword", 1, 0));
            RM.Bath.addRecipe1(
                T,
                0,
                128,
                ...
                NF,
                ST.make(MD.EtFu, "netherite_pickaxe", 1, 0));
            RM.Bath.addRecipe1(
                T,
                0,
                128,
                ...
                NF,
                ST.make(MD.EtFu, "netherite_spade", 1, 0));
            RM.Bath.addRecipe1(
                T,
                0,
                128,
                ...
                MT.Netherite.liquid(3 * U4, T),
                NF,
                ST.make(MD.EtFu, "netherite_axe", 1, 0));
            RM.Bath.addRecipe1(
                T,
                0,
                128,
                ...
                MT.Netherite.liquid(2 * U4, T),
                NF,
                ST.make(MD.EtFu, "netherite_hoe", 1, 0));
            RM.Bath.addRecipe1(
                T,
                0,
                128,
                ...
                NF,
                ST.make(MD.EtFu, "netherite_helmet", 1, 0));
            RM.Bath.addRecipe1(
                T,
                0,
                128,
                ...
                NF,
                ST.make(MD.EtFu, "netherite_chestplate", 1, 0));
            RM.Bath.addRecipe1(
                T,
                0,
                128,
                ...
                NF,
                ST.make(MD.EtFu, "netherite_leggings", 1, 0));
            RM.Bath.addRecipe1(
                T,
                0,
                128,
                ...
                NF,
                ST.make(MD.EtFu, "netherite_boots", 1, 0));
            ...
            if (IL.EtFu_Block_Copper.exists()) {
                ...
                CR.shaped(
                    IL.EtFu_Slabs_Copper_Cut_Exposed.get(2),
                    CR.DEF_MIR,
                    "sX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Exposed);
                CR.shaped(
                    IL.EtFu_Slabs_Copper_Cut_Weathered.get(2),
                    CR.DEF_MIR,
                    "sX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Weathered);
                CR.shaped(
                    IL.EtFu_Slabs_Copper_Cut_Oxidized.get(2),
                    CR.DEF_MIR,
                    "sX",
                    'X',
                ...
                CR.shaped(
                    IL.EtFu_Slabs_Copper_Cut_Exposed_Waxed.get(2),
                    CR.DEF_MIR,
                    "sX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Exposed_Waxed);
                CR.shaped(
                    IL.EtFu_Slabs_Copper_Cut_Weathered_Waxed.get(2),
                    CR.DEF_MIR,
                    "sX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Weathered_Waxed);
                CR.shaped(
                    IL.EtFu_Slabs_Copper_Cut_Oxidized_Waxed.get(2),
                    CR.DEF_MIR,
                    "sX",
                    'X',
                ...
                CR.shaped(
                    IL.EtFu_Stair_Copper_Cut_Exposed.get(4),
                    CR.DEF_MIR,
                    "sX",
                    "XX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Exposed);
                CR.shaped(
                    IL.EtFu_Stair_Copper_Cut_Weathered.get(4),
                    CR.DEF_MIR,
                    "sX",
                    "XX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Weathered);
                CR.shaped(
                    IL.EtFu_Stair_Copper_Cut_Oxidized.get(4),
                    CR.DEF_MIR,
                    "sX",
                    "XX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Oxidized);
                CR.shaped(
                    IL.EtFu_Stair_Copper_Cut_Waxed.get(4),
                    CR.DEF_MIR,
                    "sX",
                    "XX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Waxed);
                CR.shaped(
                    IL.EtFu_Stair_Copper_Cut_Exposed_Waxed.get(4),
                    CR.DEF_MIR,
                    "sX",
                    "XX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Exposed_Waxed);
                CR.shaped(
                    IL.EtFu_Stair_Copper_Cut_Weathered_Waxed.get(4),
                    CR.DEF_MIR,
                    "sX",
                    "XX",
                    'X',
                    IL.EtFu_Block_Copper_Cut_Weathered_Waxed);
                if (IL.EtFu_Stair_Copper_Cut_Oxidized_Waxed.exists()) CR.shaped(
                    IL.EtFu_Stair_Copper_Cut_Oxidized_Waxed.get(4),
                    CR.DEF_MIR,
                    "sX",
                    "XX",
                    'X',
                ...
                for (OreDictPrefix tPrefix : OP.array_dust_ingot_plate) {
                    CR.shapeless(
                        IL.EtFu_Block_Copper_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Block_Copper, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Block_Copper_Exposed_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Block_Copper_Exposed, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Block_Copper_Weathered_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Block_Copper_Weathered, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Block_Copper_Oxidized_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Block_Copper_Oxidized, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Block_Copper_Cut_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Block_Copper_Cut, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Block_Copper_Cut_Exposed_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Block_Copper_Cut_Exposed, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Block_Copper_Cut_Weathered_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Block_Copper_Cut_Weathered, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Block_Copper_Cut_Oxidized_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Block_Copper_Cut_Oxidized, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Slabs_Copper_Cut_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Slabs_Copper_Cut, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Slabs_Copper_Cut_Exposed_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Slabs_Copper_Cut_Exposed, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Slabs_Copper_Cut_Weathered_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Slabs_Copper_Cut_Weathered, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Slabs_Copper_Cut_Oxidized_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Slabs_Copper_Cut_Oxidized, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Stair_Copper_Cut_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Stair_Copper_Cut, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Stair_Copper_Cut_Exposed_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Stair_Copper_Cut_Exposed, tPrefix.dat(ANY.Wax) });
                    CR.shapeless(
                        IL.EtFu_Stair_Copper_Cut_Weathered_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Stair_Copper_Cut_Weathered, tPrefix.dat(ANY.Wax) });
                    if (IL.EtFu_Stair_Copper_Cut_Oxidized_Waxed.exists()) CR.shapeless(
                        IL.EtFu_Stair_Copper_Cut_Oxidized_Waxed.get(1),
                        CR.DEF_NCC,
                        new Object[] { IL.EtFu_Stair_Copper_Cut_Oxidized, tPrefix.dat(ANY.Wax) });
                }
                ...
                for (FluidStack tWater : FL.waters(100)) {
                    RM.Bath.addRecipe1(
                        ...
                        0,
                        64,
                        IL.EtFu_Block_Copper.get(1),
                        tWater,
                        NF,
                        IL.EtFu_Block_Copper_Exposed.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        ...
                        tWater,
                        NF,
                        IL.EtFu_Block_Copper_Weathered.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        ...
                        tWater,
                        NF,
                        IL.EtFu_Block_Copper_Oxidized.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        IL.EtFu_Block_Copper_Cut.get(1),
                        tWater,
                        NF,
                        IL.EtFu_Block_Copper_Cut_Exposed.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        ...
                        tWater,
                        NF,
                        IL.EtFu_Block_Copper_Cut_Weathered.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        ...
                        tWater,
                        NF,
                        IL.EtFu_Block_Copper_Cut_Oxidized.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        IL.EtFu_Stair_Copper_Cut.get(1),
                        tWater,
                        NF,
                        IL.EtFu_Stair_Copper_Cut_Exposed.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        ...
                        tWater,
                        NF,
                        IL.EtFu_Stair_Copper_Cut_Weathered.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        ...
                        tWater,
                        NF,
                        IL.EtFu_Stair_Copper_Cut_Oxidized.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        IL.EtFu_Slabs_Copper_Cut.get(1),
                        tWater,
                        NF,
                        IL.EtFu_Slabs_Copper_Cut_Exposed.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        ...
                        tWater,
                        NF,
                        IL.EtFu_Slabs_Copper_Cut_Weathered.get(1));
                    RM.Bath.addRecipe1(
                        T,
                        0,
                        64,
                        ...
                        tWater,
                        NF,
                        IL.EtFu_Slabs_Copper_Cut_Oxidized.get(1));
                }
                ...
                for (OreDictMaterial tMat : ANY.Wax.mToThis) {
                    ...
                    RM.Laminator.addRecipe2(
                        ...
                        32,
                        OP.plate.mat(tMat, 1),
                        IL.EtFu_Slabs_Copper_Cut.get(2),
                        IL.EtFu_Slabs_Copper_Cut_Waxed.get(2));
                    RM.Laminator.addRecipe2(
                        T,
                        16,
                        32,
                    ...
                    RM.Laminator.addRecipe2(
                        ...
                        IL.EtFu_Stair_Copper_Cut_Weathered.get(1),
                        IL.EtFu_Stair_Copper_Cut_Weathered_Waxed.get(1));
                    if (IL.EtFu_Stair_Copper_Cut_Oxidized_Waxed.exists()) RM.Laminator.addRecipe2(
                        T,
                        16,
                        24,
                        OP.plate.mat(tMat, 1),
            ...
            if (MD.CHSL.mLoaded) {
                ...
                CR.shaped(
                    ST.make(MD.EtFu, "purpur_stairs", 4, 0),
                    CR.DEF_MIR,
                    new Object[] { "P  ", "PP ", "PPP", 'P', ST.make(MD.CHSL, "purpur", 1, W) });
                CR.shaped(
                    ST.make(MD.EtFu, "purpur_slab", 6, 0),
                    CR.DEF_MIR,
                    new Object[] { "PPP", 'P', ST.make(MD.CHSL, "purpur", 1, W) });
        ...
        if (MD.GaSu.mLoaded) {
            ...
            if (MD.EtFu.mLoaded) {
                ...
                CR.shaped(
                    ST.make(MD.GaSu, "slimeBlock", 1, 0),
                    CR.DEF | CR.DEL_OTHER_SHAPED_RECIPES | CR.DEL_OTHER_NATIVE_RECIPES,
                    "XXX",
                    "XXX",
                    "XXX",
                ...
                RM.Compressor
                    .addRecipe1(T, 16, 16, ST.make(Items.slime_ball, 9, W), ST.make(MD.GaSu, "slimeBlock", 1, 0));
                RM.Boxinator.addRecipe2(
                    T,
                    16,
                    16,
                    ST.make(Items.slime_ball, 9, W),
                    ST.tag(9),
                    ST.make(MD.GaSu, "slimeBlock", 1, 0));
                RM.Unboxinator
                    .addRecipe1(T, 16, 16, ST.make(MD.GaSu, "slimeBlock", 1, 0), ST.make(Items.slime_ball, 9, 0));
                RM.ic2_extractor(ST.make(MD.GaSu, "slimeBlock", 1, 0), ST.make(Items.slime_ball, 9, 0));
                CR.shapeless(
                    ST.make(Items.slime_ball, 9, 0),
                    CR.DEF,
                    new Object[] { ST.make(MD.GaSu, "slimeBlock", 1, 0) });
            }

            RM.Boxinator
                .addRecipe2(T, 16, 16, ST.make(Items.flint, 9, W), ST.tag(9), ST.make(MD.GaSu, "storage", 1, 0));
            ...
            RM.Boxinator
                .addRecipe2(T, 16, 16, ST.make(Items.carrot, 9, W), ST.tag(9), ST.make(MD.GaSu, "storage", 1, 1));
        ...
        if (MD.GaNe.mLoaded) {
            ...
            RM.Mixer.addRecipe2(
                ...
                16,
                32,
                ST.make(MD.GaNe, "spookyFlour", 2, 0),
                ST.make(Blocks.sand, 1, W),
                ST.make(Blocks.soul_sand, 2, 0));
        }
        if (MD.GaEn.mLoaded) {
