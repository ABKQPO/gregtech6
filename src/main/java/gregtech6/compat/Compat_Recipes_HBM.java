...
public class Compat_Recipes_HBM extends CompatMods {
    ...
    public Compat_Recipes_HBM(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        ...
        RM.Crusher.addRecipe1(
            ...
            16,
            512,
            ST.make(MD.HBM, "tile.ore_nether_coal", 1, 0),
            ST.make(MD.HBM, "item.coal_infernal", 1, 0),
            ST.make(MD.HBM, "item.coal_infernal", 1, 0),
            ST.make(MD.HBM, "item.coal_infernal", 1, 0),
            OP.dust.mat(MT.Netherrack, 1),
            OP.dust.mat(MT.Netherrack, 1));
        ...
        RM.Bath.addRecipe1(
            ...
            0,
            128,
            ST.make(MD.HBM, "item.apple_lead", 1, 0),
            MT.Pb.liquid(64 * U9, T),
            NF,
            ST.make(MD.HBM, "item.apple_lead", 1, 1));
        RM.Bath.addRecipe1(
            T,
            0,
            128,
            ...
            MT.Pb.liquid(64 * U, T),
            NF,
            ST.make(MD.HBM, "item.apple_lead", 1, 2));

        RM.Bath.addRecipe1(
            T,
            0,
            128,
            ST.make(MD.HBM, "item.apple_schrabidium", 1, 0),
            MT.UNUSED.Schrabidium.liquid(64 * U9, T),
            NF,
            ST.make(MD.HBM, "item.apple_schrabidium", 1, 1));
        RM.Bath.addRecipe1(
            T,
            0,
            128,
            ST.make(MD.HBM, "item.apple_schrabidium", 1, 1),
            MT.UNUSED.Schrabidium.liquid(64 * U, T),
            NF,
            ST.make(MD.HBM, "item.apple_schrabidium", 1, 2));

        RM.Bath.addRecipe1(
            T,
            0,
            512,
            ST.make(MD.HBM, "item.powder_desh_ready", 1, 0),
            MT.H2O2.fluid(U2, T),
            NF,
            OM.dust(MT.DeshAlloy, U * 1));

        RM.Mixer.addRecipe2(
            T,
            16,
            32,
            OP.dust.mat(MT.Desh, 1),
            OP.dust.mat(MT.C, 1),
            MT.Hg.fluid(U4, T),
            NF,
            ST.make(MD.HBM, "item.powder_desh_ready", 1, 0));
        RM.Mixer.addRecipe2(
            ...
            16,
            32,
            ST.make(MD.HBM, "item.powder_desh_mix", 1, 0),
            OP.dust.mat(MT.C, 1),
            MT.Hg.fluid(U4, T),
            NF,
            ST.make(MD.HBM, "item.powder_desh_ready", 1, 0));
                ...
                addListener("cropApple", new IOreDictListenerEvent() {
                    ...
                    public void onOreRegistration(OreDictRegistrationContainer aEvent) {
                        ...
                        RM.Bath.addRecipe1(
                            ...
                            128,
                            aEvent.mStack,
                            MT.UNUSED.Schrabidium.liquid(8 * U9, T),
                            NF,
                            ST.make(MD.HBM, "item.apple_schrabidium", 1, 0));
                        RM.Bath.addRecipe1(
                            T,
                            ...
                            128,
                            aEvent.mStack,
                            MT.UNUSED.Euphemium.liquid(8 * U9, T),
                            NF,
                            ST.make(MD.HBM, "item.apple_euphemium", 1, 0));
                    }
                });
            }
        };
