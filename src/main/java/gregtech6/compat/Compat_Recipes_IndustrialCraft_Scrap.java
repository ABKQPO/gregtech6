...
public class Compat_Recipes_IndustrialCraft_Scrap extends CompatMods {
    ...
    public Compat_Recipes_IndustrialCraft_Scrap(ModData aMod, Abstract_Mod aGTMod) {
        super(aMod, aGTMod);
    }
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        ...
        if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.disabledrecipes, "easystonerecycling", T)) {
            ...
            COMPAT_IC2
                .blacklist(CR.get(ST.make(Blocks.cobblestone, 1, 0), null, null, ST.make(Blocks.cobblestone, 1, 0)));
            COMPAT_IC2.blacklist(
                CR.get(
                    ...
                    ST.make(Blocks.stone, 1, 0)));
            COMPAT_IC2.blacklist(
                CR.get(ST.make(Blocks.stone, 1, 0), ST.make(Blocks.glass, 1, 0), ST.make(Blocks.stone, 1, 0)));
            COMPAT_IC2.blacklist(
                CR.get(
                    ...
                    ST.make(Blocks.cobblestone, 1, 0)));
            COMPAT_IC2.blacklist(
                CR.get(ST.make(Blocks.sandstone, 1, 0), ST.make(Blocks.glass, 1, 0), ST.make(Blocks.sandstone, 1, 0)));
            COMPAT_IC2
                .blacklist(CR.get(ST.make(Blocks.sand, 1, 0), ST.make(Blocks.glass, 1, 0), ST.make(Blocks.sand, 1, 0)));
            COMPAT_IC2.blacklist(
                CR.get(
                    ST.make(Blocks.sandstone, 1, 0),
                    ST.make(Blocks.sandstone, 1, 0),
                    ST.make(Blocks.sandstone, 1, 0),
                    ST.make(Blocks.sandstone, 1, 0),
                    ST.make(Blocks.sandstone, 1, 0),
