...
public class Compat_Recipes_Betweenlands extends CompatMods {
    ...
    public void onPostLoad(FMLPostInitializationEvent aInitEvent) {
        ...
        CR.shaped(
            IL.BTL_Mud_Bricks.get(3),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            "BB",
            "BB",
            'B',
            ST.make(MD.BTL, "mudBrickStairs", 1, 0));
        CR.shaped(
            ...
            "B",
            'B',
            ST.make(MD.BTL, "Mud Brick Slab", 1, 0));
        CR.shaped(
            ST.make(MD.BTL, "mudBrickStairs", 2, 0),
            DEF_MIR | DEL_OTHER_SHAPED_RECIPES,
            " B",
            "BB",
            'B',
            ST.make(MD.BTL, "Mud Brick Slab", 1, 0));
        CR.shaped(
            ...
            OD.itemMudBrick);
        CR.shaped(
            ST.make(MD.BTL, "mudBrickStairs", 4, 0),
            DEF_MIR | DEL_OTHER_SHAPED_RECIPES,
            " B",
            "BB",
            'B',
        ...
        CR.shaped(
            ST.make(MD.BTL, "Mud Brick Slab", 4, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            "BB",
            'B',
            OD.blockMudBricks);
        CR.shaped(
            ST.make(MD.BTL, "mudBrickWall", 1, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            " B ",
            "BBB",
            'B',
            OD.itemMudBrick);
        CR.shaped(
            ST.make(MD.BTL, "mudBrickWall", 4, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            " B ",
            "BBB",
            'B',
            OD.blockMudBricks);
        CR.shaped(
            ST.make(MD.BTL, "mudFlowerPotItem", 1, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            "B B",
            " B ",
            'B',
            OD.itemMudBrick);
        CR.shaped(
            ST.make(MD.BTL, "mudFlowerPotItem", 4, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            "B B",
            " B ",
            'B',
        ...
        // Thatch Blocks
        CR.shaped(
            ST.make(MD.BTL, "thatch", 4, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            "BB",
            "BB",
            'B',
            ST.make(MD.BTL, "unknownGeneric", 1, 9));
        CR.shaped(
            ST.make(MD.BTL, "thatchSlope", 4, 0),
            DEF_MIR | DEL_OTHER_SHAPED_RECIPES,
            " B",
            "BB",
            'B',
            ST.make(MD.BTL, "unknownGeneric", 1, 9));
        CR.shaped(
            ST.make(MD.BTL, "Thatch Slab", 4, 0),
            DEF | DEL_OTHER_SHAPED_RECIPES,
            "BB",
            'B',
            ST.make(MD.BTL, "unknownGeneric", 1, 9));
        ...
        CR.shapeless(
            ST.make(MD.BTL, "unknownGeneric", 1, 9),
            CR.DEF_NCC,
            new Object[] { ST.make(MD.BTL, "thatch", 1, 0) });
        CR.shapeless(
            ST.make(MD.BTL, "thatch", 1, 0),
            CR.DEF_NCC,
            new Object[] { ST.make(MD.BTL, "Thatch Slab", 1, 0), ST.make(MD.BTL, "Thatch Slab", 1, 0) });
        CR.shapeless(
            ST.make(MD.BTL, "thatch", 3, 0),
            CR.DEF_NCC,
            new Object[] { ST.make(MD.BTL, "thatchSlope", 1, 0), ST.make(MD.BTL, "thatchSlope", 1, 0),
                ST.make(MD.BTL, "thatchSlope", 1, 0), ST.make(MD.BTL, "thatchSlope", 1, 0) });
        CR.shapeless(
            ST.make(MD.BTL, "Thatch Slab", 3, 0),
            CR.DEF_NCC,
            new Object[] { ST.make(MD.BTL, "thatchSlope", 1, 0), ST.make(MD.BTL, "thatchSlope", 1, 0) });
        // Peat from Peat Blocks
        CR.shapeless(OP.ingot.mat(MT.Peat, 4), CR.DEF_NCC, new Object[] { IL.BTL_Peat });
        CR.shapeless(
            IL.BTL_Bucket_Tar.get(1),
            CR.DEF_NCC,
            new Object[] { IL.BTL_Bucket_Empty, OD.itemTar, OD.itemTar, OD.itemTar, OD.itemTar });
        ...
        RM.moss(
            ST.make(MD.BTL, "betweenstoneTilesCollapsing", 1, 0),
            ST.make(MD.BTL, "betweenstoneTilesMossyCollapsing", 1, 0));
        RM.moss(
        ...
        RM.stonetypes(
            MT.STONES.Limestone,
            F,
            OP.rockGt.mat(MT.STONES.Limestone, 4),
            OP.blockDust.mat(MT.STONES.Limestone, 1),
            RM.stoneshapes(
                MT.STONES.Limestone,
                F,
        ...
        RM.stonetypes(
            MT.STONES.Betweenstone,
            T,
            OP.rockGt.mat(MT.STONES.Betweenstone, 4),
            OP.blockDust.mat(MT.STONES.Betweenstone, 1),
            RM.stoneshapes(
                MT.STONES.Betweenstone,
                F,
        ...
        RM.stonetypes(
            MT.STONES.Pitstone,
            T,
            OP.rockGt.mat(MT.STONES.Pitstone, 4),
            OP.blockDust.mat(MT.STONES.Pitstone, 1),
        ...
        RM.stonetypes(
            MT.STONES.Cragrock,
            T,
            OP.rockGt.mat(MT.STONES.Cragrock, 4),
            OP.blockDust.mat(MT.STONES.Cragrock, 1),
            RM.stoneshapes(
                MT.STONES.Cragrock,
                F,
        ...
        RM.stonetypes(
            MT.STONES.Templerock,
            T,
            OP.rockGt.mat(MT.STONES.Templerock, 4),
            OP.blockDust.mat(MT.STONES.Templerock, 1),
            NI,
            NI,
            RM.stoneshapes(
                MT.STONES.Templerock,
        ...
        RM.Drying.addRecipe1(
            ...
            16,
            128,
            ST.make(MD.BTL, "unknownGeneric", 1, 8),
            NF,
            FL.DistW.make(50),
            ST.make(MD.BTL, "unknownGeneric", 1, 9));
        ...
        RM.sawing(
            ...
            F,
            100,
            ST.make(MD.BTL, "walkway", 1, W),
            IL.BTL_Weedwood_Planks.get(1),
            OM.dust(MT.Weedwood, U3));
        ...
        RM.sawing(
            ...
            F,
            100,
            ST.make(MD.BTL, "weedwoodSign", 1, W),
            IL.BTL_Weedwood_Planks.get(2),
            OM.dust(MT.Weedwood, OP.stick.mAmount / 3));
        RM.sawing(
            16,
            32,
            F,
            100,
            ST.make(MD.BTL, "weedwoodPlanksFenceGate", 1, W),
            IL.BTL_Weedwood_Planks.get(2),
            OM.dust(MT.Weedwood, OP.stick.mAmount * 4));
        ...
        RM.sawing(
            ...
            F,
            100,
            ST.make(MD.BTL, "weedwoodJukebox", 1, W),
            IL.BTL_Weedwood_Planks.get(8),
            OP.gem.mat(MT.Valonite, 1));

        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(1),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "walkway") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(1),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodPlanksButton") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(2),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodPlanksPressurePlate") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(2),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodSign") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(2),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodPlanksFenceGate") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(3),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "mossBedItem") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(3),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodTrapDoor") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(4),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodCraftingTable") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(5),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodRowboat") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(6),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "door_weedwood") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(8),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodChest") });
        CR.shapeless(
            IL.BTL_Weedwood_Planks.get(8),
            CR.DEF_NCC,
            new Object[] { OreDictToolNames.saw, ST.item(MD.BTL, "weedwoodJukebox") });
        ...
        RM.Mortar.addRecipe1(
            T,
            16,
            16,
            1000,
            IL.BTL_Weedwood_RottenBark.get(1),
            IL.FR_Mulch.exists() ? IL.FR_Mulch.get(9) : OP.dust.mat(MT.Weedwood, 9));
