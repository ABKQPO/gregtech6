...
public abstract class BlockBaseBale extends BlockBaseMeta {
    ...
    public BlockBaseBale(Class<? extends ItemBlock> aItemClass, String aNameInternal, Material aMaterial,
    ...
    public float getBlockHardness(World aWorld, int aX, int aY, int aZ) {
        return Blocks.hay_block.getBlockHardness(aWorld, aX, aY, aZ);
    }

    @Override
    public float getExplosionResistance(byte aMeta) {
        return Blocks.hay_block.getExplosionResistance(null);
    }

    @Override
    public int getItemStackLimit(ItemStack aStack) {
        return ST.make(Blocks.hay_block, 1, 0)
            .getMaxStackSize();
    }
