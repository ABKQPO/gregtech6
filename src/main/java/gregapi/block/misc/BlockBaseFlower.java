...
public abstract class BlockBaseFlower extends BlockFlower
    implements IBlockBase, IBlockSealable, IOxygenReliantBlock, IGrowable {
    ...
    public BlockBaseFlower(Class<? extends ItemBlockBase> aItemClass, String aNameInternal, long aMaxMeta,
    ...
    public void getSubBlocks(Item aItem, CreativeTabs aTab, @SuppressWarnings("rawtypes") List aList) {
        for (int i = 0; i < maxMeta(); i++) aList.add(ST.make(aItem, 1, i));
    }
    ...
    public IIcon getIcon(int aSide, int aMeta) {
        return mIcons[aMeta % mIcons.length].getIcon(0);
    }
    ...
    public boolean canBlockStay(World aWorld, int aX, int aY, int aZ) {
        return WD.oxygen(aWorld, aX, aY, aZ) && aWorld.getBlock(aX, aY - 1, aZ)
            .canSustainPlant(aWorld, aX, aY - 1, aZ, ForgeDirection.UP, Blocks.yellow_flower);
    }
    ...
    public void func_149853_b(World aWorld, Random aRandom, int aX, int aY, int aZ) {
        ST.drop(aWorld, aX + 0.5, aY + 0.5, aZ + 0.5, this, 1, WD.meta(aWorld, aX, aY, aZ));
    }
    ...
    public boolean onItemUse(ItemBlockBase aItem, ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY,
        ...
        if (tTileEntity instanceof TileEntityFlowerPot) {
            if (((TileEntityFlowerPot) tTileEntity).getFlowerPotItem() == null) {
                ...
                if (!aWorld.setBlockMetadataWithNotify(aX, aY, aZ, ST.meta(aStack), 2))
        ...
        if (aItem.placeBlockAt(
            ...
            aHitY,
            aHitZ,
            onBlockPlaced(aWorld, aX, aY, aZ, aSide, aHitX, aHitY, aHitZ, aItem.getMetadata(aStack.getItemDamage())))) {
