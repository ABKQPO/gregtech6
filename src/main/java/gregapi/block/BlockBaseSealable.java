...
public abstract class BlockBaseSealable extends BlockBase implements IBlockSealable {
    ...
    public BlockBaseSealable(Class<? extends ItemBlock> aItemClass, String aNameInternal, Material aMaterial,
    ...
    public boolean isSealed(World aWorld, int aX, int aY, int aZ, ForgeDirection aDirection) {
        return isSealable(WD.meta(aWorld, aX, aY, aZ), (byte) (UT.Code.side(aDirection) ^ 1));
    }
}
