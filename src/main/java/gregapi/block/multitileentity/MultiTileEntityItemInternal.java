...
@Optional.InterfaceList(
    value = { @Optional.Interface(iface = "squeek.applecore.api.food.IEdible", modid = ModIDs.APC),
...
public class MultiTileEntityItemInternal extends ItemBlock
    implements squeek.applecore.api.food.IEdible, IItemReactorRod, IItemUpdatable, IItemColorableRGB,
    IOreDictItemDataOverrideItem, IItemGT, IItemNoGTOverride, IFluidContainerItem, ISpecialElectricItem,
    ...
    public String getItemStackDisplayName(ItemStack aStack) {
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_GetItemName)
            return ((IMTE_GetItemName) tTileEntityContainer.mTileEntity)
                .getItemName(aStack, super.getItemStackDisplayName(aStack));
        return StatCollector.translateToLocal(getUnlocalizedName(aStack));
    }

    @Override
    @SuppressWarnings("unchecked")
    public void addInformation(ItemStack aStack, EntityPlayer aPlayer, @SuppressWarnings("rawtypes") List aList,
        boolean aF3_H) {
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        ...
        if (tTileEntityContainer.mTileEntity instanceof IMTE_AddToolTips) try {
            ((IMTE_AddToolTips) tTileEntityContainer.mTileEntity).addToolTips(aList, aStack, aF3_H);
        } catch (Throwable e) {
            e.printStackTrace(ERR);
        }
        if (tTileEntityContainer.mTileEntity instanceof IMTE_GetFlammability
            ? ((IMTE_GetFlammability) tTileEntityContainer.mTileEntity).getFlammability(
                SIDE_ANY,
                tTileEntityContainer.mBlock.getMaterial()
                    .getCanBurn())
                > 0
            : tTileEntityContainer.mBlock.getMaterial()
                .getCanBurn())
        ...
        if (tTileEntityContainer.mTileEntity instanceof ITileEntityCoverable) {
            ...
            if (tCoverData != null) for (byte tSide : ALL_SIDES_VALID) if (tCoverData.mBehaviours[tSide] != null) {
        ...
        if (tTileEntityContainer.mTileEntity instanceof IMTE_GetExplosionResistance) {
            float tResistance = ((IMTE_GetExplosionResistance) tTileEntityContainer.mTileEntity)
        ...
        aList.add(
            LH.getToolTipHarvest(
                tTileEntityContainer.mBlock.getMaterial(),
                tTileEntityContainer.mBlock.getHarvestTool(tTileEntityContainer.mBlockMetaData),
                tTileEntityContainer.mBlock.getHarvestLevel(tTileEntityContainer.mBlockMetaData)));
        ...
        // for (int i = 0, j = aList.size(); i < j; i++) if (aList.get(i) == null) {aList.remove(i--); j--;} else
        // aList.set(i, LH.Chat.GRAY + aList.get(i) + LH.Chat.RESET_TOOLTIP);
    }

    public int onDespawn(EntityItem aEntity, ItemStack aStack) {
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_OnDespawn) try {
            return ((IMTE_OnDespawn) tTileEntityContainer.mTileEntity).onDespawn(aEntity, aStack);
        } catch (Throwable e) {
            e.printStackTrace(ERR);
        }
        return 0;
    ...
    public int getEntityLifespan(ItemStack aStack, World aWorld) {
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_GetLifeSpan) try {
            return ((IMTE_GetLifeSpan) tTileEntityContainer.mTileEntity).getLifeSpan(aWorld, aStack);
        } catch (Throwable e) {
            e.printStackTrace(ERR);
        }
    ...
    public void getSubItems(Item aItem, CreativeTabs aTab, @SuppressWarnings("rawtypes") List aList) {
        if (aTab instanceof CreativeTab) {
            for (MultiTileEntityClassContainer tClass : mBlock.mMultiTileEntityRegistry.mRegistrations)
                if (!tClass.mHidden || SHOW_HIDDEN_ITEMS) if (((CreativeTab) aTab).mMetaData == tClass.mCreativeTabID)
                    if (!(tClass.mCanonicalTileEntity instanceof IMTE_GetSubItems)
                        || ((IMTE_GetSubItems) tClass.mCanonicalTileEntity)
                            .getSubItems(mBlock, aItem, aTab, aList, tClass.mID))
                        aList.add(mBlock.mMultiTileEntityRegistry.getItem(tClass.mID));
        } else {
            for (MultiTileEntityClassContainer tClass : mBlock.mMultiTileEntityRegistry.mRegistrations)
                if (!tClass.mHidden || SHOW_HIDDEN_ITEMS) if (!(tClass.mCanonicalTileEntity instanceof IMTE_GetSubItems)
                    || ((IMTE_GetSubItems) tClass.mCanonicalTileEntity)
                        .getSubItems(mBlock, aItem, aTab, aList, tClass.mID))
                    aList.add(mBlock.mMultiTileEntityRegistry.getItem(tClass.mID));
        }
    ...
    public CreativeTabs[] getCreativeTabs() {
        return mBlock.mMultiTileEntityRegistry.mCreativeTabs.values()
            .toArray(new CreativeTabs[mBlock.mMultiTileEntityRegistry.mCreativeTabs.size()]);
    }
    ...
    public boolean onItemUse(ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ, int aSide,
        ...
        try {
            ...
            if (!tReplacedBlock.isReplaceable(aWorld, aX, aY, aZ)
                || !mBlock.canReplace(aWorld, aX, aY, aZ, aSide, aStack)) return F;
            if (aStack.stackSize == 0 || (aPlayer != null && !aPlayer.canPlayerEdit(aX, aY, aZ, aSide, aStack)))
                return F;

            MultiTileEntityContainer aMTEContainer = mBlock.mMultiTileEntityRegistry
            ...
            if (aMTEContainer != null
                ...
                && ((aMTEContainer.mTileEntity instanceof IMTE_IgnorePlayerCollisionWhenPlacing
                    && ((IMTE_IgnorePlayerCollisionWhenPlacing) aMTEContainer.mTileEntity)
                        .ignorePlayerCollisionWhenPlacing(
                            aStack,
                            aPlayer,
                            aWorld,
                            aX,
                ...
                try {
                    if (!(aMTEContainer.mTileEntity instanceof IMTE_OnPlaced)
                        || ((IMTE_OnPlaced) aMTEContainer.mTileEntity).onPlaced(
                            aStack,
                            aPlayer,
                            aMTEContainer,
                            aWorld,
                ...
                try {
                    if (aMTEContainer.mTileEntity instanceof IMTE_HasMultiBlockMachineRelevantData) {
                        if (((IMTE_HasMultiBlockMachineRelevantData) aMTEContainer.mTileEntity)
                            ...
                            ITileEntityMachineBlockUpdateable.Util.causeMachineUpdate(
                                aWorld,
                                aX,
                                aY,
                                aZ,
                                aMTEContainer.mBlock,
                                aMTEContainer.mBlockMetaData,
                                F);
                    }
                } catch (Throwable e) {
                    e.printStackTrace(ERR);
    ...
    public int getItemStackLimit(ItemStack aStack) {
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_GetMaxStackSize) {
            return UT.Code.bindStack(
                ((IMTE_GetMaxStackSize) tTileEntityContainer.mTileEntity)
    ...
    public OreDictItemData getOreDictItemData(ItemStack aStack) {
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof ITileEntityFoamable
            && ((ITileEntityFoamable) tTileEntityContainer.mTileEntity).hasFoam(SIDE_ANY)) {
    ...
    public FluidStack drain(ItemStack aStack, int aMaxDrain, boolean aDoDrain) {
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IFluidContainerItem) {
            FluidStack rFluid = ((IFluidContainerItem) tTileEntityContainer.mTileEntity)
    ...
    public boolean onItemUseFirst(ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ,
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_OnItemUseFirst) {
            boolean rReturn = ((IMTE_OnItemUseFirst) tTileEntityContainer.mTileEntity)
                .onItemUseFirst(this, aStack, aPlayer, aWorld, aX, aY, aZ, (byte) aSide, hitX, hitY, hitZ);
            updateItemStack(aStack);
            return rReturn;
        }
        return F;
    ...
    public ItemStack onItemRightClick(ItemStack aStack, World aWorld, EntityPlayer aPlayer) {
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_OnItemRightClick) {
            ItemStack rStack = ((IMTE_OnItemRightClick) tTileEntityContainer.mTileEntity)
                .onItemRightClick(this, aStack, aWorld, aPlayer);
    ...
    public int getMaxItemUseDuration(ItemStack aStack) {
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_GetMaxItemUseDuration) {
            int rDuration = ((IMTE_GetMaxItemUseDuration) tTileEntityContainer.mTileEntity)
                .getMaxItemUseDuration(this, aStack);
            updateItemStack(aStack);
            return rDuration;
        }
        return 0;
    ...
    public EnumAction getItemUseAction(ItemStack aStack) {
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_GetItemUseAction) {
            EnumAction rAction = ((IMTE_GetItemUseAction) tTileEntityContainer.mTileEntity)
                .getItemUseAction(this, aStack);
            updateItemStack(aStack);
            return rAction;
        }
    ...
    public squeek.applecore.api.food.FoodValues getFoodValues(ItemStack aStack) {
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IMTE_GetFoodValues)
            return ((IMTE_GetFoodValues) tTileEntityContainer.mTileEntity).getFoodValues(this, aStack);
        return null;
    }
    ...
    public int getReactorRodNeutronEmission(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack) {
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemReactorRod)
            return ((IItemReactorRod) tTileEntityContainer.mTileEntity)
                .getReactorRodNeutronEmission(aReactor, aSlot, aStack);
        return 0;
    }
    ...
    public boolean getReactorRodNeutronReaction(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack) {
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemReactorRod)
            return ((IItemReactorRod) tTileEntityContainer.mTileEntity)
                .getReactorRodNeutronReaction(aReactor, aSlot, aStack);
        return F;
    }

    @Override
    public int getReactorRodNeutronReflection(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack,
        int aNeutrons, boolean aModerated) {
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemReactorRod)
            return ((IItemReactorRod) tTileEntityContainer.mTileEntity)
                .getReactorRodNeutronReflection(aReactor, aSlot, aStack, aNeutrons, aModerated);
        return 0;
    }
    ...
    public int getReactorRodNeutronMaximum(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack) {
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemReactorRod)
            return ((IItemReactorRod) tTileEntityContainer.mTileEntity)
                .getReactorRodNeutronMaximum(aReactor, aSlot, aStack);
        return 0;
    }
    ...
    public ITexture getReactorRodTextureSides(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack,
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemReactorRod)
            return ((IItemReactorRod) tTileEntityContainer.mTileEntity)
                .getReactorRodTextureSides(aReactor, aSlot, aStack, aActive);
    ...
    public ITexture getReactorRodTextureTop(MultiTileEntityReactorCore aReactor, int aSlot, ItemStack aStack,
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemReactorRod)
            return ((IItemReactorRod) tTileEntityContainer.mTileEntity)
                .getReactorRodTextureTop(aReactor, aSlot, aStack, aActive);
        return BlockTextureCopied.get(Blocks.cobblestone);
    }
    ...
    public long doEnergyInjection(TagData aEnergyType, ItemStack aStack, long aSize, long aAmount,
        ...
        MultiTileEntityContainer tTileEntityContainer = mBlock.mMultiTileEntityRegistry
            .getNewTileEntityContainer(aStack);
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemEnergy)
            return ((IItemEnergy) tTileEntityContainer.mTileEntity)
                .doEnergyInjection(aEnergyType, aStack, aSize, aAmount, aInventory, aWorld, aX, aY, aZ, aDoInject);
        return 0;
    }
    ...
    public long doEnergyExtraction(TagData aEnergyType, ItemStack aStack, long aSize, long aAmount,
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemEnergy)
            return ((IItemEnergy) tTileEntityContainer.mTileEntity)
                .doEnergyExtraction(aEnergyType, aStack, aSize, aAmount, aInventory, aWorld, aX, aY, aZ, aDoExtract);
        return 0;
    }
    ...
    public boolean useEnergy(TagData aEnergyType, ItemStack aStack, long aEnergyAmount, EntityLivingBase aPlayer,
        ...
        if (tTileEntityContainer != null && tTileEntityContainer.mTileEntity instanceof IItemEnergy)
            return ((IItemEnergy) tTileEntityContainer.mTileEntity)
                .useEnergy(aEnergyType, aStack, aEnergyAmount, aPlayer, aInventory, aWorld, aX, aY, aZ, aDoUse);
        return F;
    }
    ...
    public double charge(ItemStack aStack, double aCharge, int aTier, boolean aIgnoreTransferLimit, boolean aSimulate) {
        ...
        return V[aTier] * doEnergyInjection(
            TD.Energy.EU,
            aStack,
            V[aTier],
            (long) (aCharge / V[aTier]),
            null,
            null,
            0,
            0,
    ...
    @Override
    public double discharge(ItemStack aStack, double aCharge, int aTier, boolean aIgnoreTransferLimit,
        boolean aBatteryAlike, boolean aSimulate) {
        if (aCharge < V[aTier = UT.Code.bind4(aTier)]) return 0;
        return V[aTier] * doEnergyExtraction(
            TD.Energy.EU,
            aStack,
            V[aTier],
            (long) (aCharge / V[aTier]),
    ...
    public float discharge(ItemStack aStack, float aEnergy, boolean aDoExtract) {
        ...
        return useEnergy(TD.Energy.EU, aStack, tAmount, null, null, null, 0, 0, 0, F)
            && useEnergy(TD.Energy.EU, aStack, tAmount, null, null, null, 0, 0, 0, T)
                ? tAmount * EnergyConfigHandler.IC2_RATIO
                : 0;
    }
    ...
    @Optional.Method(modid = ModIDs.BOTA)
    @Override
    ...
    @Override
    public boolean func_150936_a(World aWorld, int aX, int aY, int aZ, int aSide, EntityPlayer aPlayer,
        ItemStack aStack) {
        return T;
    }
    ...
    public float getElectricityStored(ItemStack aStack) {
        return getEnergyStored(TD.Energy.EU, aStack) * EnergyConfigHandler.IC2_RATIO;
    }

    @Override
    public float getMaxElectricityStored(ItemStack aStack) {
        return getEnergyCapacity(TD.Energy.EU, aStack) * EnergyConfigHandler.IC2_RATIO;
    }
    ...
    public double getCharge(ItemStack aStack) {
        return getEnergyStored(TD.Energy.EU, aStack);
    }

    @Override
    public boolean canUse(ItemStack aStack, double aAmount) {
        return useEnergy(TD.Energy.EU, aStack, (long) aAmount, null, null, null, 0, 0, 0, F);
    }

    @Override
    public boolean use(ItemStack aStack, double aAmount, EntityLivingBase aPlayer) {
        return useEnergy(TD.Energy.EU, aStack, (long) aAmount, aPlayer, null, null, 0, 0, 0, T);
    }
    ...
    public double getMaxCharge(ItemStack aStack) {
        return getEnergyCapacity(TD.Energy.EU, aStack);
    }

    @Override
    public double getTransferLimit(ItemStack aStack) {
        return getEnergySizeInputRecommended(TD.Energy.EU, aStack);
    }

    @Override
    public int getTier(ItemStack aStack) {
        return UT.Code.tierMax(getEnergySizeInputMax(TD.Energy.EU, aStack));
    }
    ...
    public IIcon getIconFromDamage(int aMeta) {
        ...
        return itemIcon;
        /* Fixes Eating Animation Particles. */}
