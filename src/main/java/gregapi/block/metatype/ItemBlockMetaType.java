...
public class ItemBlockMetaType extends ItemBlockBase implements IItemUpdatable {
    ...
    public boolean placeBlockAt(ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ, int aSide,
        ...
        if (((BlockMetaType) mPlaceable).mBlock == mPlaceable)
    ...
    public void updateItemStack(ItemStack aStack) {
        if (((BlockMetaType) mPlaceable).mBlock.mSlabs[1] == mPlaceable
            || ((BlockMetaType) mPlaceable).mBlock.mSlabs[2] == mPlaceable
            || ((BlockMetaType) mPlaceable).mBlock.mSlabs[3] == mPlaceable
            || ((BlockMetaType) mPlaceable).mBlock.mSlabs[4] == mPlaceable
            || ((BlockMetaType) mPlaceable).mBlock.mSlabs[5] == mPlaceable) {
     ...
     * @Override
     * public boolean onItemUseFirst(ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ, int
     * aSide, float aHitX, float aHitY, float aHitZ) {
     ...
     * aWorld.playSoundEffect(aX+0.5F, aY+0.5F, aZ+0.5F, mBlock.mBlock.stepSound.func_150496_b(),
     * (mBlock.mBlock.stepSound.getVolume() + 1.0F) / 2.0F, mBlock.mBlock.stepSound.getPitch() * 0.8F);
