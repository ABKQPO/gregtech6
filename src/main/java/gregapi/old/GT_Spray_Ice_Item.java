...
public class GT_Spray_Ice_Item extends GT_Tool_Item {
    ...
    public GT_Spray_Ice_Item(String aUnlocalized, String aEnglish, int aMaxDamage, int aEntityDamage) {
        super(
            ...
            true);/*
                   ...
                   */
        /*
         * for (Object tName : Arrays.asList(UT.Stacks.make(Items.water_bucket, 1, W), OP.cell.dat(MT.Water),
         * OP.capsule.dat(MT.Water))) {
         * GT_ModHandler.addShapelessCraftingRecipe(UT.Stacks.make(Blocks.ice, 1, 0), new Object[] {UT.Stacks.make(this,
         * 1, W), tName});
         * }
         */
    }
     ...
     * aSide, float hitX, float hitY, float hitZ) {
