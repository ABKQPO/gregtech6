    ...
    public void onTick(int[] aCircuitData, IRedstoneCircuitBlock aRedstoneCircuitBlock) {
        if (aCircuitData[0] < 2) {
            aRedstoneCircuitBlock.setRedstone(
                aCircuitData[0] % 2 == (getAnyRedstone(aRedstoneCircuitBlock) ? 0 : 1) ? (byte) 15 : 0,
                aRedstoneCircuitBlock.getOutputFacing());
        } else if (aCircuitData[0] < 4) {
            aRedstoneCircuitBlock.setRedstone(
                aCircuitData[0] % 2 == (getOneRedstone(aRedstoneCircuitBlock) ? 0 : 1) ? (byte) 15 : 0,
                aRedstoneCircuitBlock.getOutputFacing());
        } else if (aCircuitData[0] < 6) {
            aRedstoneCircuitBlock.setRedstone(
                aCircuitData[0] % 2 == (getAllRedstone(aRedstoneCircuitBlock) ? 0 : 1) ? (byte) 15 : 0,
                aRedstoneCircuitBlock.getOutputFacing());
            ...
            aRedstoneCircuitBlock.setRedstone(
                (byte) (getStrongestRedstone(aRedstoneCircuitBlock) ^ 15),
                aRedstoneCircuitBlock.getOutputFacing());
        }
    }
