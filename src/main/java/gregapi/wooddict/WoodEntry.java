...
public class WoodEntry {
    ...
    public WoodEntry(ItemStack aLog, int aCharcoalCount, int aCreosoteAmount, ItemStack aBark,
        OreDictMaterial aMaterialBark) {
        this(aLog, aCharcoalCount, aCreosoteAmount, 2, 4, 6, aBark, MT.Wood, aMaterialBark);
    }

    public WoodEntry(ItemStack aLog, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand, int aPlankCountSaw,
        int aPlankCountBuzz) {
        this(
            aLog,
            aCharcoalCount,
            ...
            aPlankCountSaw,
            aPlankCountBuzz,
            OP.dust.mat(MT.Bark, 1));
    }

    public WoodEntry(ItemStack aLog, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand, int aPlankCountSaw,
        int aPlankCountBuzz, ItemStack aBark) {
        this(
            aLog,
            aCharcoalCount,
            aCreosoteAmount,
    ...
    public WoodEntry(ItemStack aLog, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand, int aPlankCountSaw,
        int aPlankCountBuzz, ItemStack aBark, OreDictMaterial aMaterialWood, OreDictMaterial aMaterialBark) {
        this(
            aLog,
            aCharcoalCount,
            aCreosoteAmount,
    ...
    public WoodEntry(ItemStack aLog, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand, int aPlankCountSaw,
        int aPlankCountBuzz, ItemStack aBark, OreDictMaterial aMaterialWood, OreDictMaterial aMaterialBark,
        ItemStack aStick, int aStickCountSaw, int aStickCountLathe) {
        this(
            aLog,
            WoodDictionary.DEFAULT_PLANK,
            aCharcoalCount,
            aCreosoteAmount,
            aPlankCountHand,
            aPlankCountSaw,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, int aCharcoalCount, int aCreosoteAmount, ItemStack aBark,
        OreDictMaterial aMaterialBark) {
        this(aLog, aBeam, aCharcoalCount, aCreosoteAmount, 2, 4, 6, aBark, aBeam.mMaterialBeam, aMaterialBark);
    }

    public WoodEntry(ItemStack aLog, BeamEntry aBeam, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand,
        int aPlankCountSaw, int aPlankCountBuzz, ItemStack aBark) {
        this(
            aLog,
            aBeam,
            aCharcoalCount,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand,
        int aPlankCountSaw, int aPlankCountBuzz, ItemStack aBark, OreDictMaterial aMaterialWood,
        OreDictMaterial aMaterialBark) {
        this(
            aLog,
            aBeam,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand,
        int aPlankCountSaw, int aPlankCountBuzz, ItemStack aBark, OreDictMaterial aMaterialWood,
        OreDictMaterial aMaterialBark, ItemStack aStick) {
        this(
            aLog,
            aBeam,
            aCharcoalCount,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand,
        int aPlankCountSaw, int aPlankCountBuzz, ItemStack aBark, OreDictMaterial aMaterialWood,
        OreDictMaterial aMaterialBark, ItemStack aStick, int aStickCountSaw, int aStickCountLathe) {
        this(
            aLog,
            aBeam,
            aBeam.mPlankEntry,
    ...
    public WoodEntry(ItemStack aLog, PlankEntry aPlank, int aCharcoalCount, int aCreosoteAmount, ItemStack aBark,
        OreDictMaterial aMaterialBark) {
        this(aLog, aPlank, aCharcoalCount, aCreosoteAmount, 2, 4, 6, aBark, aPlank.mMaterialPlank, aMaterialBark);
    }

    public WoodEntry(ItemStack aLog, PlankEntry aPlank, int aCharcoalCount, int aCreosoteAmount, int aPlankCountHand,
        int aPlankCountSaw, int aPlankCountBuzz) {
        this(
            aLog,
            aPlank,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, PlankEntry aPlank, ItemStack aBark,
        OreDictMaterial aMaterialBark) {
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, PlankEntry aPlank, int aCharcoalCount, int aCreosoteAmount,
        ItemStack aBark, OreDictMaterial aMaterialBark) {
        this(
            aLog,
            aBeam,
            aPlank,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, PlankEntry aPlank, int aCharcoalCount, int aCreosoteAmount,
        int aPlankCountHand, int aPlankCountSaw, int aPlankCountBuzz) {
        this(
            aLog,
            aBeam,
            aPlank,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, PlankEntry aPlank, int aCharcoalCount, int aCreosoteAmount,
        int aPlankCountHand, int aPlankCountSaw, int aPlankCountBuzz, ItemStack aBark) {
        this(
            aLog,
            aBeam,
            aPlank,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, PlankEntry aPlank, int aCharcoalCount, int aCreosoteAmount,
        int aPlankCountHand, int aPlankCountSaw, int aPlankCountBuzz, ItemStack aBark, OreDictMaterial aMaterialWood,
        OreDictMaterial aMaterialBark) {
        this(
            aLog,
            aBeam,
    ...
    public WoodEntry(ItemStack aLog, BeamEntry aBeam, PlankEntry aPlank, int aCharcoalCount, int aCreosoteAmount,
        ...
        if (ST.valid(mLog) && !WoodDictionary.WOODS.containsKey(new ItemStackContainer(mLog))) {
            if (ST.meta(mLog) == W) for (int i = 0; i < 16; i++) {
                ...
                if (OM.materialcontained(tLog, T, MT.Wood, MT.WoodRubber, ANY.Wood))
                    OreDictManager.INSTANCE.setItemData_(
                        tLog,
                        mMaterialBark == mMaterialWood ? new OreDictItemData(mMaterialWood, (mPlankCountBuzz + 3) * U)
                            : mMaterialBark == null ? new OreDictItemData(mMaterialWood, (mPlankCountBuzz + 2) * U)
                                : new OreDictItemData(mMaterialWood, (mPlankCountBuzz + 2) * U, mMaterialBark, U));
            }
            if (OM.materialcontained(mLog, T, MT.Wood, MT.WoodRubber, ANY.Wood)) OreDictManager.INSTANCE.setItemData_(
                mLog,
                mMaterialBark == mMaterialWood ? new OreDictItemData(mMaterialWood, (mPlankCountBuzz + 3) * U)
                    : mMaterialBark == null ? new OreDictItemData(mMaterialWood, (mPlankCountBuzz + 2) * U)
                        : new OreDictItemData(mMaterialWood, (mPlankCountBuzz + 2) * U, mMaterialBark, U));
