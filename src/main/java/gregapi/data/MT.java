...
public class MT {
    ...
    public static final OreDictMaterial NULL = create(-1, "NULL").setStatsElement(0, 0, 0, 0, 0)
        .put(INVALID_MATERIAL, DONT_SHOW_THIS_COMPONENT);

    /** Material for empty Containers. */
    public static final OreDictMaterial Empty = create(0, "Empty").setStatsElement(0, 0, 0, 0, 0)
        .put(EMPTY, AUTO_BLACKLIST, DONT_SHOW_THIS_COMPONENT);

    /**
     * Some subatomic Particles and, this might be useful if Projectile Materials have to be determined and you shoot a
     * Laser (Photons in that case) or something Radioactive.
     */
    public static final OreDictMaterial y, Photon = y = create(1, "Photon").setStatsElement(0, 0, 0, 0, 0)
        .heat(0, 0, 0)
        .setRGBa(255, 255, 255, 255)
        .put(PARTICLE)
        .tooltip("y")
        .hide(), v,
        Neutrino = v = create(2, "Neutrino").setStatsElement(0, 0, 0, 0, 0)
            .heat(0, 0, 0)
            .setRGBa(180, 180, 180, 0)
            .put(PARTICLE)
            .tooltip("v")
            .hide(),
        n, Neutron = n = create(3, "Neutron").setStatsElement(0, 0, 1, 0, 0)
            .heat(0, 0, 0)
            .setRGBa(128, 128, 128, 0)
            .put(PARTICLE)
            .tooltip("n")
            .hide(),
        p, Proton = p = create(4, "Proton").setStatsElement(1, 0, 0, 0, 0)
            .heat(0, 0, 0)
            .setRGBa(255, 0, 0, 0)
            .put(PARTICLE)
            .tooltip("p")
            .hide(),
        e, Electron = e = create(5, "Electron").setStatsElement(0, 1, 0, 0, 0)
            .heat(0, 0, 0)
            .setRGBa(0, 0, 255, 0)
            .put(PARTICLE)
            .tooltip("e")
    ...
    /**
     * Yes, I consider Magic as some kind of Element. I placed it at the Spot of "Anti-Empty", since Slot 0 is for the
     * "Empty" Material, and "Anti-Empty" = "Magically-Full", or some crazy shit like that. Also Magic has negative
     * Mass.
     */
    public static final OreDictMaterial Ma, Magic = Ma = create(4000, "Magic").setStatsElement(0, 0, 0, -1, 0)
        .heat(0, 0, 0)
        .setRGBa(255, 0, 255, 0)
     ...
     */
    public static final OreDictMaterial H = hydrogen(), D = deuterium(), H_2 = D, T = tritium(), H_3 = T, He = helium(),
        He_3 = helium3(), Li = lithium(), Li_6 = lithium6(), Be = beryllium().qual(2, 14.0, 64, 2), Be_7 = beryllium7(),
        Be_8 = beryllium8(), B = boron(), B_11 = boron11(), C = carbon(), C_13 = carbon13(), C_14 = carbon14(),
        N = nitrogen(), O = oxygen(), F = fluorine(), Ne = neon(), Na = sodium(), Mg = magnesium(),
        Al = aluminium().qual(2, 10.0, 128, 2), Si = silicon().setPriorityPrefix(5), P = phosphor(),
        S = sulfur().setPriorityPrefix(2), Cl = chlorine(), Ar = argon(), K = potassium(), Ca = calcium(),
        Sc = scandium(), Ti = titanium().qual(3, 8.0, 2560, 3), V = vanadium(), Cr = chromium().qual(3, 11.0, 256, 3),
        Mn = manganese().qual(3, 7.0, 256, 2), Fe = iron().qual(3, 6.0, 256, 2)
            .setRGBaLiquid(255, 64, 32, 255),
        Co = cobalt().qual(3, 5.0, 256, 3), Co_60 = cobalt60().qual(3, 5.0, 256, 3), Ni = nickel().qual(2, 6.0, 64, 2),
        Cu = copper().qual(2, 4.0, 64, 0), Zn = zinc(), Ga = gallium(), Ge = germanium().qual(2, 6.0, 256, 2),
        As = arsenic(), Se = selenium(), Br = bromine(), Kr = krypton(), Rb = rubidium(), Sr = strontium(),
        Y = yttrium(), Zr = zirconium().qual(3, 8.0, 1280, 3)
            .lens(DYE_INDEX_White),
        Nb = niobium(), Mo = molybdenum().qual(3, 7.0, 512, 2), Tc = technetium().qual(3, 10.0, 1280, 1),
        Gregorium = Tc, Ru = ruthenium(), Rh = rhodium(), Pd = palladium().qual(3, 8.0, 512, 2),
        Ag = silver().qual(3, 10.0, 64, 2), Cd = cadmium(), In = indium(), Sn = tin(), Sb = antimony(),
        Te = tellurium(), I = iodine(), Xe = xenon(), Cs = caesium(), Ba = barium(), La = lanthanium(), Ce = cerium(),
        Pr = praseodymium(), Nd = neodymium().qual(3, 6.0, 512, 3), Pm = promethium(), Sm = samarium(), Eu = europium(),
        Gd = gadolinium(), Tb = terbium(), Dy = dysprosium(), Ho = holmium(), Er = erbium(), Tm = thulium(),
        Yb = ytterbium(), Lu = lutetium(), Hf = hafnium(), Ta = tantalum(), W = tungsten().qual(3, 8.0, 5120, 3),
        Re = rhenium(), Os = osmium().qual(3, 16.0, 1280, 4)
            .setLocal("Osmium"),
        Ir = iridium().qual(3, 6.0, 5120, 4)
            .setRGBaLiquid(255, 128, 200, 255),
        Pt = platinum().qual(3, 15.0, 64, 2), Au = gold().qual(3, 12.5, 64, 2), Au_198 = gold198(), Hg = mercury(),
        Tl = thallium(), Pb = lead().qual(2, 8.0, 64, 1), Bi = bismuth().qual(2, 6.0, 64, 1), Po = polonium(),
        At = astatine(), Rn = radon(), Fr = francium(), Ra = radium(), Ac = actinium(),
        Th = thorium().qual(3, 6.0, 512, 2), Pa = protactinium(), U_238 = uranium().qual(3, 6.0, 512, 3), // No, I could
                                                                                                          // not make a
                                                                                                          // Variable
                                                                                                          // named "U"
                                                                                                          // here. That
                                                                                                          ...
                                                                                                          // Material
                                                                                                          // Unit.
        U_235 = uranium235().qual(3, 6.0, 512, 3), U_233 = uranium233().qual(3, 6.0, 512, 3), Np = neptunium(),
        Pu = plutonium().qual(3, 6.0, 512, 3), Pu_240 = plutonium240().qual(3, 6.0, 512, 3),
        Pu_241 = plutonium241().qual(3, 6.0, 512, 3), Pu_243 = plutonium243().qual(3, 6.0, 512, 3),
        Pu_238 = plutonium238().qual(3, 6.0, 512, 3), Pu_239 = plutonium239().qual(3, 6.0, 512, 3),
        Am = americium().qual(3, 4.0, 256, 2), Am_241 = americium241().qual(3, 4.0, 256, 2),
        Am_242 = americium242().qual(3, 4.0, 256, 2), Cm = curium(), Bk = berkelium(), Cf = californium(),
        ...
        Fl_298 = flerovium298(), Mc = moscovium(), Lv = livermorium(), Fa = farnsium(), Ts = Fa, Og = oganesson(),
        Uue = ununennium(), Ubn = unbinilium(),

        // The following Data is in no way reliable, but it is there in case someone wants to use it.
        Ubu = unknown(1210, 182), Ubb = unknown(1220, 184), Ubt = unknown(1230, 186), Ubq = unknown(1240, 188),
        Tn = element(
            1250,
            "TritaniumElemental",
            "Tn",
            ...
            MOLTEN,
            EXTRUDER,
            "Unbipentium").aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.VITREUS, 1)
        ...
        Ke = element(
            ...
            MOLTEN,
            EXTRUDER,
            "Unbihexium").aspects(TC.METALLUM, 3, TC.TUTAMEN, 1, TC.VITREUS, 1)
                .qual(3, 12.0, 2560, 4),
        Ubh = Ke, Ubs = unknown(1270, 194), Ubo = unknown(1280, 196), Ube = unknown(1290, 198),
        Utn = unknown(1300, 200), Utu = unknown(1310, 203), Utb = unknown(1320, 206), Utt = unknown(1330, 209),
        Utq = unknown(1340, 212), Utp = unknown(1350, 215), Uth = unknown(1360, 218), Uts = unknown(1370, 221),
        Uto = unknown(1380, 224), Ute = unknown(1390, 227), Uqn = unknown(1400, 230), Uqu = unknown(1410, 233),
        Uqb = unknown(1420, 236), Uqt = unknown(1430, 239), Uqq = unknown(1440, 242),
        Dn = element(
            1450,
            "DuraniumElemental",
            "Dn",
            ...
            MOLTEN,
            EXTRUDER,
            "Unquadpentium").aspects(TC.METALLUM, 2, TC.TUTAMEN, 1)
                .setLocal("Elemental Duranium"),
        Uqp = Dn, // material refined from dolamide ore
        Uqh = unknown(1460, 248), Uqs = unknown(1470, 251), Uqo = unknown(1480, 254), Uqe = unknown(1490, 257),
        Upn = unknown(1500, 260), Upu = unknown(1510, 263),
        Vb = element(
            1520,
            "Vibranium",
            "Vb",
            ...
            GLOWING,
            UNBURNABLE,
            "Unpentbium").aspects(TC.VITREUS, 10, TC.SENSUS, 10)
                .setPriorityPrefix(1)
                .qual(3, 1000.0, 512, 15),
        Upb = Vb, Upt = unknown(1530, 269), Upq = unknown(1540, 272), Upp = unknown(1550, 276),
        Uph = unknown(1560, 280), Ups = unknown(1570, 284), Upo = unknown(1580, 288), Upe = unknown(1590, 292),
        Uhn = unknown(1600, 296), Uhu = unknown(1610, 300), Uhb = unknown(1620, 304), Uht = unknown(1630, 308),
        Uhq = unknown(1640, 312), Uhp = unknown(1650, 316), Uhh = unknown(1660, 320), Uhs = unknown(1670, 324),
        Uho = unknown(1680, 328), Uhe = unknown(1690, 332), Usn = unknown(1700, 336), Usu = unknown(1710, 340),
        Usb = unknown(1720, 344), Ust = unknown(1730, 348),
        Nq = element(
            1740,
            "Naquadah",
            "Nq",
            ...
            MOLTEN,
            EXTRUDER,
            "Unseptquadium").aspects(TC.METALLUM, 3, TC.RADIO, 1, TC.NEBRISUM, 1)
        ...
        Nq_528 = element(
            ...
            MOLTEN,
            EXTRUDER,
            EXPLOSIVE).aspects(TC.METALLUM, 3, TC.RADIO, 2, TC.NEBRISUM, 2)
        ...
        Nq_522 = element(
            ...
            MOLTEN,
            EXTRUDER,
            EXPLOSIVE).aspects(TC.METALLUM, 4, TC.RADIO, 3, TC.NEBRISUM, 3)
                .setRGBaLiquid(128, 255, 128, 255)
                .qual(3, 1.0, 512, 4),
        Usp = unknown(1750, 356), Ush = unknown(1760, 360), Uss = unknown(1770, 364), Uso = unknown(1780, 368),
        Use = unknown(1790, 372), Uon = unknown(1800, 376), Uou = unknown(1810, 380), Uob = unknown(1820, 384),
        Uot = unknown(1830, 388), Uoq = unknown(1840, 392),
        An = element(
            1850,
            "Abyssalnite",
            "An",
            ...
            MOLTEN,
            EXTRUDER,
            "Unoctpentium").qual(3, 8.0, 1600, 3)
        ...
        Cor = element(
            ...
            G_GEM_ORES,
            "Unocthexium",
            "LiquifiedCoralium").qual(3, 12.0, 3200, 3)
        ...
        Dr = element(
            ...
            MOLTEN,
            EXTRUDER,
            "Unoctseptium").qual(3, 16.0, 4800, 4)
        ...
        Etx = element(
            ...
            MOLTEN,
            EXTRUDER,
            "Unoctoctium").qual(3, 20.0, 6400, 4)
                .aspects(TC.METALLUM, 3, TC.VITIUM, 2),
        Uoo = Etx, Uoe = unknown(1890, 415), Uen = unknown(1900, 420), Ueu = unknown(1910, 425),
        Ueb = unknown(1920, 430), Uet = unknown(1930, 435), Ueq = unknown(1940, 440), Uep = unknown(1950, 445),
        Ueh = unknown(1960, 450), Ues = unknown(1970, 455), Ueo = unknown(1980, 460), Uee = unknown(1990, 465),
        Bnn = unknown(2000, 470), Bnu = unknown(2010, 475), Bnb = unknown(2020, 480), Bnt = unknown(2030, 485),
        Bnq = unknown(2040, 490), Bnp = unknown(2050, 495), Bnh = unknown(2060, 500), Bns = unknown(2070, 505),
        Bno = unknown(2080, 510), Bne = unknown(2090, 515), Bun = unknown(2100, 520), Buu = unknown(2110, 525),
        Bub = unknown(2120, 530), But = unknown(2130, 535), Buq = unknown(2140, 540), Bup = unknown(2150, 545),
        Buh = unknown(2160, 550), Bus = unknown(2170, 555), Buo = unknown(2180, 560), Bue = unknown(2190, 565),
        ...
        Ad = element(
            ...
            RAILS,
            "Adamant",
            "Bibibium").qual(3, 10.0, 5120, 5)
                .aspects(TC.METALLUM, 10, TC.PRAECANTIO, 10),
        Bbb = Ad, Bbt = unknown(2230, 585), Bbq = unknown(2240, 590), Bbp = unknown(2250, 595),
        Bbh = unknown(2260, 600), Bbs = unknown(2270, 605), Bbo = unknown(2280, 610), Bbe = unknown(2290, 615),
        Btn = unknown(2300, 620), Btu = unknown(2310, 625), Btb = unknown(2320, 630), Btt = unknown(2330, 635),
        Btq = unknown(2340, 640), Btp = unknown(2350, 645), Bth = unknown(2360, 650), Bts = unknown(2370, 655),
        ...
        Mcg = element(
            ...
            "Bitriennium").aspects(
                ...
                TC.STRONTIO,
                8),
        Bte = Mcg, Bqn = unknown(2400, 670), Bqu = unknown(2410, 675), Bqb = unknown(2420, 680),
        Bqt = unknown(2430, 685), Bqq = unknown(2440, 690), Bqp = unknown(2450, 695), Bqh = unknown(2460, 700),
        Bqs = unknown(2470, 705), Bqo = unknown(2480, 710), Bqe = unknown(2490, 715), Bpn = unknown(2500, 720),
        Bpu = unknown(2510, 725), Bpb = unknown(2520, 730), Bpt = unknown(2530, 735), Bpq = unknown(2540, 740),
        Bpp = unknown(2550, 745), Bph = unknown(2560, 750), Bps = unknown(2570, 755), Bpo = unknown(2580, 760),
        Bpe = unknown(2590, 765), Bhn = unknown(2600, 770), Bhu = unknown(2610, 775), Bhb = unknown(2620, 780),
        Bht = unknown(2630, 785), Bhq = unknown(2640, 790), Bhp = unknown(2650, 795), Bhh = unknown(2660, 800),
        Bhs = unknown(2670, 805), Bho = unknown(2680, 810), Bhe = unknown(2690, 815), Bsn = unknown(2700, 820),
        Bsu = unknown(2710, 825), Bsb = unknown(2720, 830), Bst = unknown(2730, 835), Bsq = unknown(2740, 840),
        Bsp = unknown(2750, 845), Bsh = unknown(2760, 850), Bss = unknown(2770, 855), Bso = unknown(2780, 860),
        Bse = unknown(2790, 865), Bon = unknown(2800, 870), Bou = unknown(2810, 875), Bob = unknown(2820, 880),
        Bot = unknown(2830, 885), Boq = unknown(2840, 890), Bop = unknown(2850, 895), Boh = unknown(2860, 900),
        Bos = unknown(2870, 905), Boo = unknown(2880, 910), Boe = unknown(2890, 915), Ben = unknown(2900, 920),
        Beu = unknown(2910, 925), Beb = unknown(2920, 930), Bet = unknown(2930, 935), Beq = unknown(2940, 940),
        Bep = unknown(2950, 945), Beh = unknown(2960, 950), Bes = unknown(2970, 955), Beo = unknown(2980, 960),
        Bee = unknown(2990, 965), Tnn = unknown(3000, 970), Tnu = unknown(3010, 975), Tnb = unknown(3020, 980),
        Tnt = unknown(3030, 985), Tnq = unknown(3040, 990), Tnp = unknown(3050, 995), Tnh = unknown(3060, 1000),
        Tns = unknown(3070, 1005), Tno = unknown(3080, 1010), Tne = unknown(3090, 1015), Tun = unknown(3100, 1020),
        Tuu = unknown(3110, 1025), Tub = unknown(3120, 1030), Tut = unknown(3130, 1035), Tuq = unknown(3140, 1040),
        Tup = unknown(3150, 1045), Tuh = unknown(3160, 1050), Tus = unknown(3170, 1055), Tuo = unknown(3180, 1060),
        Tue = unknown(3190, 1065), Tbn = unknown(3200, 1070), Tbu = unknown(3210, 1075), Tbb = unknown(3220, 1080),
        Tbt = unknown(3230, 1085), Tbq = unknown(3240, 1090), Tbp = unknown(3250, 1095), Tbh = unknown(3260, 1100),
        Tbs = unknown(3270, 1105), Tbo = unknown(3280, 1110), Tbe = unknown(3290, 1115), Ttn = unknown(3300, 1120),
        Ttu = unknown(3310, 1125), Ttb = unknown(3320, 1130), Ttt = unknown(3330, 1135), Ttq = unknown(3340, 1140),
        Ttp = unknown(3350, 1145), Tth = unknown(3360, 1150), Tts = unknown(3370, 1155), Tto = unknown(3380, 1160),
        Tte = unknown(3390, 1165), Tqn = unknown(3400, 1170), Tqu = unknown(3410, 1175), Tqb = unknown(3420, 1180),
        Tqt = unknown(3430, 1185), Tqq = unknown(3440, 1190), Tqp = unknown(3450, 1195), Tqh = unknown(3460, 1200),
        Tqs = unknown(3470, 1205), Tqo = unknown(3480, 1210), Tqe = unknown(3490, 1215), Tpn = unknown(3500, 1220),
        Tpu = unknown(3510, 1225), Tpb = unknown(3520, 1230), Tpt = unknown(3530, 1235), Tpq = unknown(3540, 1240),
        Tpp = unknown(3550, 1245), Tph = unknown(3560, 1250), Tps = unknown(3570, 1255), Tpo = unknown(3580, 1260),
        Tpe = unknown(3590, 1265), Thn = unknown(3600, 1270), Thu = unknown(3610, 1275), Thb = unknown(3620, 1280),
        Tht = unknown(3630, 1285), Thq = unknown(3640, 1290), Thp = unknown(3650, 1295), Thh = unknown(3660, 1300),
        Ths = unknown(3670, 1305), Tho = unknown(3680, 1310), The = unknown(3690, 1315), Tsn = unknown(3700, 1320),
        ...
        Gt = element(
            ...
            G_CONTAINERS,
            UUM,
            "Triseptbium").aspects(TC.TERRA, 10, TC.POTENTIA, 10),
        Tsb = Gt, Tst = unknown(3730, 1335), Tsq = unknown(3740, 1340), Tsp = unknown(3750, 1345),
        Tsh = unknown(3760, 1350), Tss = unknown(3770, 1355), Tso = unknown(3780, 1360), Tse = unknown(3790, 1365),
        Ton = unknown(3800, 1370), Tou = unknown(3810, 1375), Tob = unknown(3820, 1380), Tot = unknown(3830, 1385),
        Toq = unknown(3840, 1390), Top = unknown(3850, 1395), Toh = unknown(3860, 1400), Tos = unknown(3870, 1405),
        Too = unknown(3880, 1410), Toe = unknown(3890, 1415), Ten = unknown(3900, 1420), Teu = unknown(3910, 1425),
        Teb = unknown(3920, 1430), Tet = unknown(3930, 1435), Teq = unknown(3940, 1440), Tep = unknown(3950, 1445),
        Teh = unknown(3960, 1450), Tes = unknown(3970, 1455), Teo = unknown(3980, 1460), Tee = unknown(3990, 1465),

        Neutronium = unused("Neutronium").qual(3, 6.0, 81920, 6)
            .put(IGNORE_IN_COLOR_LOG)
            .tooltip("Nt"),

        Primitive = tier("Primitive").aspects(TC.MACHINA, 1), Basic = tier("Basic").aspects(TC.MACHINA, 2),
        Good = tier("Good").aspects(TC.MACHINA, 3), Advanced = tier("Advanced").aspects(TC.MACHINA, 4),
        Data = tier("Data").aspects(TC.MACHINA, 4), Elite = tier("Elite").aspects(TC.MACHINA, 5),
        Master = tier("Master").aspects(TC.MACHINA, 6), Ultimate = tier("Ultimate").aspects(TC.MACHINA, 7),
        Quantum = tier("Quantum").aspects(TC.ORDO, 8), Superconductor = tier("Superconductor").aspects(TC.ELECTRUM, 8),
        Infinite = tier("Infinite"),

        Black = dye(8250, "Black", 32, 32, 32), Red = dye(8251, "Red", 255, 0, 0),
        Green = dye(8252, "Green", 0, 255, 0), Brown = dye(8253, "Brown", 96, 64, 0),
        Blue = dye(8254, "Blue", 0, 0, 255), Purple = dye(8255, "Purple", 128, 0, 128),
        Cyan = dye(8256, "Cyan", 0, 255, 255), LightGray = dye(8257, "Light Gray", 192, 192, 192),
        Gray = dye(8258, "Gray", 128, 128, 128), Pink = dye(8259, "Pink", 255, 192, 192),
        Lime = dye(8260, "Lime", 128, 255, 128), Yellow = dye(8261, "Yellow", 255, 255, 0),
        LightBlue = dye(8262, "Light Blue", 128, 128, 255), Magenta = dye(8263, "Magenta", 255, 0, 255),
        Orange = dye(8264, "Orange", 255, 128, 0), White = dye(8265, "White", 255, 255, 255),

        H2O = lquddcmp(9800, "Water", 100, 100, 255, 255, UNRECYCLABLE, FOOD, MELTING).uumMcfg(0, H, 2 * U, O, 1 * U)
            .aspects(TC.AQUA, 2)
            .heat(CS.C, CS.C + 100)
            .setDensity(1.0000)
            .liquid(FL.Water.make(1000)),
        Water = H2O,
        HDO = lquddcmp(9811, "Semiheavy Water", 200, 200, 155, 255, UNRECYCLABLE, FOOD, MELTING, LIQUID)
            .setMcfg(0, H, 1 * U, D, 1 * U, O, 1 * U)
            .aspects(TC.AQUA, 2, TC.TEMPESTAS, 1)
            .heat(CS.C + 2, CS.C + 101)
            .setDensity(1.0540),
        D2O = lquddcmp(9812, "Heavy Water", 255, 255, 100, 255, UNRECYCLABLE, FOOD, MELTING, LIQUID)
            .setMcfg(0, D, 2 * U, O, 1 * U)
            .aspects(TC.AQUA, 2, TC.TEMPESTAS, 2)
            .heat(CS.C + 4, CS.C + 102)
            .setDensity(1.1056),
        T2O = lquddcmp(9813, "Tritiated Water", 255, 100, 100, 255, UNRECYCLABLE, FOOD, MELTING, LIQUID)
            .setMcfg(0, T, 2 * U, O, 1 * U)
            .aspects(TC.AQUA, 2, TC.RADIO, 1)
            .heat(CS.C + 7, CS.C + 104)
            .setDensity(1.2112),
        Steam = gasdcmp(9814, "Steam", 200, 200, 200, 255, UNRECYCLABLE).uumMcfg(0, H, 2 * U, O, 1 * U)
            .aspects(TC.AQUA, 2, TC.AER, 1)
            .heat(CS.C, CS.C + 100)
            .setDensity(0.0010),
        Snow = dust(9801, "Snow", SET_FINE, 250, 250, 250, 255, UNRECYCLABLE, FOOD, MORTAR)
            .uumMcfg(0, H, 2 * U, O, 1 * U)
            .aspects(TC.GELUM, 1)
            .setSmelting(H2O, U)
            .heat(CS.C, CS.C + 100)
            .setDensity(1.0),
        Ice = create(
            ...
            BRITTLE,
            MORTAR,
            COOL2CRYSTAL).uumMcfg(0, H, 2 * U, O, 1 * U)
                .aspects(TC.GELUM, 2)
                .setSmelting(H2O, U)
                .heat(CS.C, CS.C + 100)
                .setDensity(1.0)
                .qual(1, 2.0, 4, 0),
        FreshWater = lqud(9803, "Fresh Water", 110, 110, 255, 255, UNRECYCLABLE, FOOD).uumMcfg(0, H, 2 * U, O, 1 * U)
            .aspects(TC.AQUA, 2)
            .heat(CS.C, CS.C + 100)
            .setDensity(1.0),
        HolyWater = lqud(9805, "Holy Water", 120, 120, 255, 255, GLOWING).setMcfg(0, H, 2 * U, O, 1 * U)
            .aspects(TC.AQUA, 2, TC.AURAM, 1)
            .heat(CS.C, CS.C + 100)
            .setDensity(1.0),
        SeaWater = lqud(9806, "Sea Water", 90, 90, 255, 255, UNRECYCLABLE, LIQUID).setMcfg(0, H, 2 * U, O, 1 * U)
            .aspects(TC.TEMPESTAS, 2)
            .heat(CS.C, CS.C + 100)
            .setDensity(1.0),
        DirtyWater = lqud(9807, "WaterDirty", 70, 150, 200, 255, UNRECYCLABLE, LIQUID).setMcfg(0, H, 2 * U, O, 1 * U)
            .aspects(TC.AQUA, 2)
            .heat(CS.C, CS.C + 100)
            .setDensity(1.0)
            .setLocal("Dirty Water"),
        DistWater = lquddcmp(9808, "WaterDistilled", 110, 110, 255, 255, UNRECYCLABLE, FOOD, MELTING)
            .uumMcfg(0, H, 2 * U, O, 1 * U)
            .aspects(TC.AQUA, 2)
            .heat(CS.C, CS.C + 100)
            .setDensity(1.0)
        ...
        H2O2 = lquddcmp(9809, "Hydrogen Peroxide GT6", 20, 20, 255, 255, LIQUID).uumMcfg(0, H, 2 * U, O, 2 * U)
            ...
            .setDensity(1.0)
            .heat(CS.C, CS.C + 150),
        HCl = gasaciddcmp(9826, "Hydrochloric Acid", 0, 255, 128, 255, GASES).uumMcfg(0, H, 1 * U, Cl, 1 * U)
            .heat(100, 200),
        HF = gasaciddcmp(9829, "Hydrogen Fluoride", 0, 240, 240, 255, GASES).uumMcfg(0, H, 1 * U, F, 1 * U)
            .heat(189, 292),

        HeNe = gaschemcent(9839, "Helium-Neon", 255, 0, 128, 255, GASES).uumMcfg(0, He, 1 * U, Ne, 1 * U),
        HeliumNeon = HeNe,

        Air = gas(9830, "Air", 169, 208, 245, 15, TRANSPARENT, GASES).uumMcfg(0, N, 40 * U, O, 11 * U, Ar, 1 * U)
            .heat(100, 200)
            .setDensity(WEIGHT_AIR_G_PER_CUBIC_CENTIMETER),
        NO = gaschemelec(9837, "Nitrogen Monoxide", 100, 175, 255, 15, GASES).uumMcfg(0, N, 1 * U, O, 1 * U)
            .heat(100, 200),
        NO2 = gaschemelec(9831, "Nitrogen Dioxide", 120, 190, 255, 15, GASES).uumMcfg(0, N, 1 * U, O, 2 * U)
            .heat(100, 200),
        NH3 = gasaciddcmp(8025, "Ammonia", 114, 223, 232, 255, GASES).uumMcfg(0, N, 1 * U, H, 3 * U)
            .heat(195, 239),
        HNO3 = lqudaciddcmp(9825, "Nitric Acid", 128, 255, 0, 255, LIQUID).uumMcfg(0, H, 1 * U, N, 1 * U, O, 3 * U)
            .setDensity(1.5)
            .heat(231, 356),
        NitricAcid = HNO3,

        CO = gaschemelec(9838, "Carbon Monoxide", 10, 10, 10, 15, GASES).uumMcfg(0, C, 1 * U, O, 1 * U)
            .heat(100, 200),
        CO2 = gaschemelec(9836, "Carbon Dioxide", 40, 40, 40, 15, GASES).uumMcfg(0, C, 1 * U, O, 2 * U)
            .heat(100, 200),
        CO3 = gaschemelec(9843, "Carbon Trioxide", 45, 45, 45, 15, GASES, ACID).uumMcfg(0, C, 1 * U, O, 3 * U)
            .heat(100, 200),
        CH4 = gaschemelec(9832, "Methane", 250, 200, 250, 15, GASES, FLAMMABLE).uumMcfg(0, C, 1 * U, H, 4 * U)
            .heat(100, 200),
        Sugar = dustdcmp(
            9703,
            "Sugar",
            ...
            BRITTLE,
            MORTAR,
            FOOD).uumMcfg(0, C, 12 * U, H, 22 * U, O, 11 * U)
        ...
        Vanilla = dustfood(9787, "Vanilla", 110, 80, 40, 255, DECOMPOSABLE).uumMcfg(0, C, 8 * U, H, 8 * U, O, 3 * U)
            .aspects(TC.FAMES, 1),
        Glycerol = lqudchemelec(9828, "Glycerol", 0, 180, 180, 255, LIQUID, FLAMMABLE)
            .uumMcfg(0, C, 3 * U, H, 8 * U, O, 3 * U)
            .setDensity(1.5)
            .heat(291, 563),
        Glyceryl = lqudchemelec(9821, "Glyceryl", 0, 150, 150, 255, LIQUID, FLAMMABLE, EXPLOSIVE)
            .uumMcfg(0, C, 3 * U, H, 5 * U, N, 3 * U, O, 9 * U)
            .setDensity(1.5)
            .heat(287, 323),

        SO2 = gaschemdcmp(9834, "Sulfur Dioxide", 255, 200, 0, 120, GASES, "SulphurDioxide")
            .uumMcfg(0, S, 1 * U, O, 2 * U)
            .heat(100, 200),
        SO3 = gaschemdcmp(9835, "Sulfur Trioxide", 255, 220, 0, 120, GASES, "SulphurTrioxide")
            .uumMcfg(0, S, 1 * U, O, 3 * U)
            .heat(100, 200),
        H2S = gasaciddcmp(8024, "Hydrosulfuric Acid", 241, 188, 133, 255, GASES, FLAMMABLE)
            .uumMcfg(0, H, 2 * U, S, 1 * U)
            .heat(191, 213),
        H2SO4 = lqudaciddcmp(9824, "Sulfuric Acid", 255, 128, 0, 255, LIQUID, "SulphuricAcid")
            .uumMcfg(0, H, 2 * U, S, 1 * U, O, 4 * U)
            .setDensity(1.5)
            .heat(200, 400),
        SulfuricAcid = H2SO4,
        H2S2O7 = lqudaciddcmp(9844, "Disulfuric Acid", 255, 150, 0, 255, LIQUID)
            .uumMcfg(0, H, 2 * U, S, 2 * U, O, 7 * U)
            .setDensity(1.5)
            .heat(200, 400),

        AgI = oredustelec(8243, "Silver Iodide", SET_CUBE, 240, 200, 100, 255, BRITTLE, MORTAR)
            .uumMcfg(0, Ag, 1 * U, I, 1 * U)
            .aspects(TC.TEMPESTAS, 2)
            .heat(831, 1779),
        SilverIodide = AgI,

        H2SiF6 = lqudacidelec(8011, "Hexafluorosilicic Acid", 190, 200, 190, 255, LIQUID)
            .uumMcfg(0, H, 2 * U, Si, 1 * U, F, 6 * U)
            .setDensity(1.5)
            .heat(250, 381),
        HexafluorosilicicAcid = H2SiF6,
        SiC = metalore(8003, "Carborundum", SET_QUARTZ, 77, 77, 77, BRITTLE, QUARTZ, DECOMPOSABLE)
            .uumMcfg(0, Si, 1 * U, C, 1 * U)
        ...
        SiO2 = oredustdcmp(
            ...
            CRYSTALLISABLE,
            FURNACE,
            UNRECYCLABLE).uumMcfg(0, Si, 1 * U, O, 2 * U)
        ...
        Glass = gemcent(
            ...
            MELTING,
            EXTRUDER,
            EXTRUDER_SIMPLE).lens(DYE_INDEX_White)
                .uumMcfg(0, SiO2, 1 * U)
                .aspects(TC.VITREUS, 2)
                .qual(1, 1.0, 1, 0)
                .heat(1200),
        Flint = cent(8002, "Flint", SET_FLINT, 0, 32, 64, 255, UNRECYCLABLE, BRITTLE, MORTAR, G_GEM, STONE)
            .uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.TERRA, 1, TC.INSTRUMENTUM, 1)
            .qual(1, 2.5, 48, 1)
            .setSmelting(SiO2, U),

        H3BO3 = dustelec(8007, "Hydrogen Borate", SET_FINE, 234, 234, 255, 255, "BoricAcid")
            .uumMcfg(0, H, 3 * U, B, 1 * U, O, 3 * U),
        HydrogenBorate = H3BO3, BoricAcid = H3BO3,
        Datolite = oredustelec(8006, "Datolite", SET_ROUGH, 222, 255, 222, 255)
            .uumMcfg(0, H, 2 * U, Ca, 2 * U, B, 2 * U, Si, 2 * U, O, 10 * U),
        H2Ca2B2Si2O10 = Datolite,

        V2O5 = oredustelec(8234, "Vanadium Pentoxide", SET_FINE, 50, 50, 50, 255, WASHING_FIRESTONE, MAGNETIC_PASSIVE)
            .uumMcfg(0, V, 2 * U, O, 5 * U)
            .addSourceOf(V)
            .setSmelting(V, U7),
        VanadiumPentoxide = V2O5,

        Nb2O5 = oredustdcmp(8461, "Niobium Pentoxide", SET_FINE, 50, 64, 10, 255, WASHING_FIRESTONE)
            .uumMcfg(0, Nb, 2 * U, O, 5 * U)
            .addSourceOf(Nb),

        Ta2O5 = oredustdcmp(8462, "Tantalum Pentoxide", SET_FINE, 64, 50, 10, 255, WASHING_FIRESTONE)
            .uumMcfg(0, Ta, 2 * U, O, 5 * U)
            .addSourceOf(Ta),

        PO4 = oredustelec(8207, "Phosphate", SET_DULL, 255, 255, 0, 255, FLAMMABLE, EXPLOSIVE, BRITTLE, MORTAR)
            .uumMcfg(0, P, 1 * U, O, 4 * U)
            .heat(400, 800)
            .addSourceOf(P),
        ...
        WO3 = oredustdcmp(
            ...
            MORTAR,
            WASHING_FIRESTONE,
            "TungstenOxide").uumMcfg(0, W, 1 * U, O, 3 * U)
                .heat(1746, 1970)
                .addSourceOf(W),
        H2WO4 = dustdcmp(8027, "Tungstic Acid", SET_SHINY, 188, 200, 0, 255, MELTING, ACID)
            .uumMcfg(0, H, 2 * U, W, 1 * U, O, 4 * U)
            .heat(373, 1746)
            .addSourceOf(W)
            .setSmelting(WO3, 4 * U7),

        Al2O3 = oredustdcmp(8008, "Alumina", SET_METALLIC, 120, 195, 235, 255, MELTING, INGOTS, "NaturalAluminum")
            .uumMcfg(0, Al, 2 * U, O, 3 * U)
            .heat(2345, 3250)
            .addSourceOf(Al),
        AlF3 = dustdcmp(8010, "Aluminium Fluoride", SET_DULL, 200, 190, 190, 255, MELTING, MOLTEN, INGOTS, ACID)
            .uumMcfg(0, Al, 1 * U, F, 3 * U)
            .heat(1560),
        AlO3H3 = oredustdcmp(8014, "Aluminium Hydroxide", SET_DULL, 190, 190, 200, 255, MELTING, "Gibbsite")
            .uumMcfg(0, Al, 1 * U, O, 3 * U, H, 3 * U)
            .heat(573)
            .addSourceOf(Al)
            .setSmelting(Al2O3, 5 * U14),

        TiO2 = oredustdcmp(9192, "Rutile", SET_METALLIC, 110, 80, 120, 255, MELTING, MOLTEN, INGOTS)
            .uumMcfg(1, Ti, 1 * U, O, 2 * U)
            .heat(Ti.mMeltingPoint + 100, Ti.mBoilingPoint)
            .qual(2)
            .addSourceOf(Ti),
        TiCl4 = lqudaciddcmp(8413, "Titanium Tetrachloride", 233, 244, 222, 255, LIQUID)
            .uumMcfg(0, Ti, 1 * U, Cl, 4 * U)
            .heat(249, 409),
        TitaniumTetrachloride = TiCl4,

        MnO2 = oredustdcmp(9126, "Pyrolusite", SET_DULL, 50, 50, 70, 255, MELTING, INGOTS, MORTAR, MAGNETIC_PASSIVE)
            .setSmelting(Mn, 3 * U4)
            .uumMcfg(1, Mn, 1 * U, O, 2 * U)
            .heat(808, 2334)
            .addSourceOf(Mn),
        MnCl2 = dustdcmp(8031, "Manganese Chloride", SET_CUBE, 255, 213, 213, 255, MELTING, MOLTEN, INGOTS)
            .uumMcfg(0, Mn, 1 * U, Cl, 2 * U)
            .heat(927, 1498),
        ...
        Fe2O3 = oredustdcmp(
            ...
            MAGNETIC_PASSIVE,
            "BandedIron",
            "IronOxide").uumMcfg(0, Fe, 2 * U, O, 3 * U)
                .heat(2 * Fe.mMeltingPoint / 3)
                .addSourceOf(Fe)
                .qual(0),
        FeCl2 = dustelec(
            8030,
            ...
            MOLTEN,
            INGOTS,
            MAGNETIC_PASSIVE).uumMcfg(0, Fe, 1 * U, Cl, 2 * U)
                .heat(950, 1296),
        FeCl3 = dustdcmp(8017, "Ferric Chloride", SET_METALLIC, 180, 180, 120, 255, MELTING)
            .uumMcfg(0, Fe, 1 * U, Cl, 3 * U)
            .heat(580, 589),
        FeO3H3 = dustdcmp(8035, "Ferric Oxyhydroxide", SET_FINE, 137, 62, 40, 255, MELTING)
            .uumMcfg(0, Fe, 1 * U, O, 3 * U, H, 3 * U)
            .heat(Fe2O3.mMeltingPoint)
            .addSourceOf(Fe)
            .setSmelting(Fe2O3, 5 * U14),

        MgCl2 = oredustdcmp(8018, "Magnesium Chloride", SET_CUBE, 235, 235, 250, 255, MELTING, MOLTEN, INGOTS)
            .uumMcfg(0, Mg, 1 * U, Cl, 2 * U)
            .aspects(TC.FAMES, 1)
            .heat(987, 1685), // Can be electrolyzed for real
        MgCO3 = oredustdcmp(
            8016,
            "Magnesium Carbonate",
            SET_DULL,
            ...
            MOLTEN,
            INGOTS,
            "Magnesite").uumMcfg(0, Mg, 1 * U, CO3, 4 * U)
                .heat(623, 3000),

        CaCl2 = oredustdcmp(8028, "Calcium Chloride", SET_CUBE, 235, 235, 250, 255, MELTING, MOLTEN, INGOTS)
            .uumMcfg(0, Ca, 1 * U, Cl, 2 * U)
            .aspects(TC.FAMES, 1)
            .heat(1048, 2208), // Can be electrolyzed for real
        CaSO4 = dustdcmp(8274, "Calcium Sulfate", SET_CUBE, 240, 220, 210, 255, MORTAR, "CalciumSulphate")
            .uumMcfg(0, Ca, 1 * U, S, 1 * U, O, 4 * U)
            .heat(1730, 3000),
        Gypsum = oredustdcmp(9161, "Gypsum", SET_POWDER, 240, 240, 240, 255, MORTAR)
            .uumMcfg(6, CaSO4, 6 * U, H2O, 6 * U)
            .heat(1730, 3000),
        Quicklime = oredustdcmp(9271, "Quicklime", SET_POWDER, 240, 230, 210, 255, MORTAR)
            .uumMcfg(0, Ca, 1 * U, O, 1 * U)
            .heat(2886, 3120),
        CaCO3 = oredustdcmp(
            9107,
            "Calcite",
        ...
        LiCl = oredustdcmp(
            ...
            MOLTEN,
            INGOTS,
            WASHING_MERCURY).uumMcfg(0, Li, 1 * U, Cl, 1 * U)
                .addSourceOf(Li)
                .aspects(TC.FAMES, 1)
                .setPriorityPrefix(2)
                .heat(880, 1655), // Can be electrolyzed for real
        LiClO3 = dustdcmp(8033, "Lithium Chlorate", SET_ROUGH, 222, 233, 250, 255, MELTING, MOLTEN, INGOTS)
            .uumMcfg(0, Li, 1 * U, Cl, 1 * U, O, 3 * U)
            .addSourceOf(Li)
            .heat(400),
        LiClO4 = dustdcmp(8034, "Lithium Perchlorate", SET_ROUGH, 222, 244, 250, 255, MELTING, MOLTEN, INGOTS)
            .uumMcfg(0, Li, 1 * U, Cl, 1 * U, O, 4 * U)
            .addSourceOf(Li)
            .heat(509, 703),
        Li2O = dustelec(8004, "Lithium Oxide", SET_ROUGH, 222, 222, 234, 255).uumMcfg(0, Li, 2 * U, O, 1 * U)
            .addSourceOf(Li),
        Li2Fe2O4 = metalore(8005, "Ferrite", SET_METALLIC, 120, 120, 130, DECOMPOSABLE, ELECTROLYSER, MAGNETIC_PASSIVE)
            .uumMcfg(0, Li, 2 * U, Fe, 2 * U, O, 4 * U)
            .addSourceOf(Li, Fe),
        LiOH = dustelec(8032, "Lithium Hydroxide", SET_CUBE, 222, 202, 250, 255)
            .uumMcfg(0, Li, 1 * U, O, 1 * U, H, 1 * U)
            .addSourceOf(Li)
            .heat(735, 1197),

        NaCl = oredustdcmp(8204, "Salt", SET_CUBE, 250, 250, 250, 255, BRITTLE, MORTAR, FOOD)
            .uumMcfg(0, Na, 1 * U, Cl, 1 * U)
            .aspects(TC.FAMES, 1)
            .addSourceOf(Na)
            .setPriorityPrefix(2)
            .heat(1074, 1686),
        NaNO3 = oredustelec(8019, "Sodium Nitrate", SET_FINE, 230, 230, 230, 255, FLAMMABLE, BRITTLE, MORTAR)
            .uumMcfg(0, Na, 1 * U, N, 1 * U, O, 3 * U)
            .aspects(TC.IGNIS, 2)
            .setPriorityPrefix(2)
            .heat(607),
        NaOH = dustelec(8268, "Sodium Hydroxide", SET_CUBE, 220, 250, 220, 255)
            .uumMcfg(0, Na, 1 * U, O, 1 * U, H, 1 * U)
            .heat(596, 1661),
        NaHCO3 = oredustdcmp(8039, "Sodium Hydrogencarbonate", SET_FINE, 230, 235, 240, 255, "Soda").setLocal("Soda")
            .uumMcfg(0, Na, 1 * U, H, 1 * U, C, 1 * U, O, 3 * U),
        Soda = NaHCO3,
        NaHSO4 = dustdcmp(
            8230,
            "Sodium Bisulfate",
            ...
            "SodiumHydrogenSulphate").uumMcfg(0, Na, 1 * U, H, 1 * U, S, 1 * U, O, 4 * U),
        NaSO4 = dustdcmp(9822, "Sodium Persulfate", SET_CUBE, 130, 180, 250, 255, "SodiumPersulphate")
            .uumMcfg(0, Na, 1 * U, S, 1 * U, O, 4 * U),
        Na2S = dustdcmp(9823, "Sodium Sulfide", SET_CUBE, 220, 220, 100, 255, "SodiumSulphide")
            .uumMcfg(0, Na, 2 * U, S, 1 * U),
        Na2SO3 = dustdcmp(8269, "Sodium Sulfite", SET_CUBE, 190, 190, 140, 255, "SodiumSulphite")
            .uumMcfg(0, Na, 2 * U, S, 1 * U, O, 3 * U)
            .heat(306),
        Na2SO4 = dustdcmp(8270, "Sodium Sulfate", SET_CUBE, 190, 190, 140, 255, "SodiumSulphate")
            .uumMcfg(0, Na, 2 * U, S, 1 * U, O, 4 * U)
            .heat(1157, 1702), // Can be used to store Heat very well.
        Na2S2O7 = dustdcmp(8231, "Sodium Pyrosulfate", SET_FINE, 240, 240, 255, 255, "SodiumPyrosulphate")
            .uumMcfg(0, Na, 2 * U, S, 2 * U, O, 7 * U)
            .heat(674),
        Na2CO3 = dustdcmp(8013, "Sodium Carbonate", SET_FINE, 230, 230, 230, 255, MELTING, MOLTEN, INGOTS)
            .uumMcfg(0, Na, 2 * U, CO3, 4 * U)
            .heat(1124),
        NaAlO2 = dustdcmp(8012, "Sodium Aluminate", SET_CUBE, 230, 230, 250, 255)
            .uumMcfg(0, Na, 1 * U, Al, 1 * U, O, 2 * U)
            .heat(1920),
        NaF = dustelec(8037, "Sodium Fluoride", SET_CUBE, 64, 200, 225, 255).uumMcfg(0, Na, 1 * U, F, 1 * U)
            .heat(1266),
        Na3AlF6 = oredustdcmp(8009, "Cryolite", SET_DULL, 200, 190, 190, 255, MELTING, MOLTEN, INGOTS, ACID)
            .uumMcfg(0, Na, 3 * U, Al, 1 * U, F, 6 * U)
            .heat(1285)
            .addSourceOf(Na, F),
        Cryolite = Na3AlF6,
        SaltWater = lqudelec(9804, "Saltwater", 255, 0, 255, 255, LIQUID, UNRECYCLABLE, "SaltWater", "Brine")
            .uumMcfg(0, H2O, 3 * U, NaCl, 1 * U)
            .aspects(TC.AQUA, 2)
            .heat(CS.C, CS.C + 90)
            .setDensity(1.0),

        KIO3 = oredustelec(8242, "Iodine Salt", SET_CUBE, 240, 200, 240, 255, BRITTLE, MORTAR)
            .uumMcfg(0, K, 1 * U, I, 1 * U, O, 3 * U)
            .aspects(TC.TEMPESTAS, 1)
            .addSourceOf(K)
            .heat(300, 370),
        IodineSalt = KIO3,
        KCl = oredustdcmp(8203, "Sylvite", SET_CUBE, 240, 200, 200, 255, BRITTLE, MORTAR, "RockSalt", "Sylvine")
            .uumMcfg(0, K, 1 * U, Cl, 1 * U)
            .aspects(TC.FAMES, 1)
            .addSourceOf(K)
            .setPriorityPrefix(2)
            .heat(1040, 1690),
        KNO3 = oredustelec(
            ...
            "Saltpeter",
            "Nitrate",
            "Salpeter").uumMcfg(0, K, 1 * U, N, 1 * U, O, 3 * U)
                .aspects(TC.IGNIS, 2)
                .setPriorityPrefix(2)
                .heat(607),
        KOH = dustelec(8015, "Potassium Hydroxide", SET_CUBE, 250, 220, 220, 255)
            .uumMcfg(0, K, 1 * U, O, 1 * U, H, 1 * U)
            .heat(633, 1600),
        KHSO4 = dustdcmp(8232, "Potassium Bisulfate", SET_FINE, 255, 240, 240, 255, "PotassiumBisulphate")
            .uumMcfg(0, K, 1 * U, H, 1 * U, S, 1 * U, O, 4 * U),
        KSO4 = dustdcmp(8022, "Potassium Persulfate", SET_CUBE, 250, 180, 130, 255, "PotassiumPersulphate")
            .uumMcfg(0, K, 1 * U, S, 1 * U, O, 4 * U),
        K2S = dustdcmp(8272, "Potassium Sulfide", SET_CUBE, 100, 220, 220, 255, "PotassiumSulphide")
            .uumMcfg(0, K, 2 * U, S, 1 * U),
        K2SO3 = dustdcmp(8021, "Potassium Sulfite", SET_CUBE, 140, 190, 190, 255, "PotassiumSulphite")
            .uumMcfg(0, K, 2 * U, S, 1 * U, O, 3 * U)
            .heat(306),
        K2SO4 = dustdcmp(8271, "Potassium Sulfate", SET_CUBE, 140, 190, 190, 255, "PotassiumSulphate")
            .uumMcfg(0, K, 2 * U, S, 1 * U, O, 4 * U)
            .heat(1342, 1962),
        K2S2O7 = dustdcmp(8233, "Potassium Pyrosulfate", SET_FINE, 255, 240, 240, 255, "PotassiumPyrosulphate")
            .uumMcfg(0, K, 2 * U, S, 2 * U, O, 7 * U)
            .heat(598),
        K2CO3 = dustdcmp(8020, "Potassium Carbonate", SET_FINE, 230, 225, 225, 255, MELTING, MOLTEN, INGOTS)
            .uumMcfg(0, K, 2 * U, CO3, 4 * U)
            .heat(1164),
        KAlO2 = dustdcmp(8023, "Potassium Aluminate", SET_CUBE, 250, 230, 230, 255)
            .uumMcfg(0, K, 1 * U, Al, 1 * U, O, 2 * U)
            .heat(1920),
        KF = dustelec(8036, "Potassium Fluoride", SET_CUBE, 200, 64, 225, 255).uumMcfg(0, K, 1 * U, F, 1 * U)
            .heat(1131),
        K2TaF7 = dustdcmp(8038, "Potassium Heptafluorotantalate", SET_FINE, 164, 200, 225, 255)
            .uumMcfg(0, K, 2 * U, Ta, 1 * U, F, 7 * U),
        SaltedWater = lqudelec(9815, "Salted Water", 255, 0, 200, 255, LIQUID, UNRECYCLABLE, "Saltedwater")
            .uumMcfg(0, H2O, 3 * U, KCl, 1 * U)
            .aspects(TC.AQUA, 2)
            .heat(CS.C, CS.C + 90)
            .setDensity(1.0),

        ChloroauricAcid = lqudaciddcmp(8400, "Chloroauric Acid", 255, 200, 70, 255, LIQUID)
            .uumMcfg(0, Au, 1 * U, Cl, 4 * U, H, 1 * U)
            .heat(200, 400),
        ChloroplatinicAcid = lqudaciddcmp(8401, "Chloroplatinic Acid", 255, 70, 70, 255, LIQUID)
            .uumMcfg(0, Pt, 1 * U, Cl, 6 * U, H, 2 * U)
            .heat(200, 400),
        StannicChloride = lqudaciddcmp(8402, "Stannic Chloride", 210, 250, 250, 255, LIQUID)
            .uumMcfg(0, Sn, 1 * U, Cl, 4 * U)
            .heat(200, 400),

        BlackVitriol = lqudacidelec(8403, "Black Vitriol", 66, 66, 66, 255, LIQUID).uumMcfg(0, Fe, 1 * U, S, 1 * U)
            .heat(200, 400),
        BlueVitriol = lqudaciddcmp(
            8404,
            "Blue Vitriol",
            66,
            66,
            ...
            "RomanVitriol",
            "CyprusVitriol",
            "SolutionBlueVitriol").uumMcfg(0, Cu, 1 * U, S, 1 * U, O, 4 * U)
                .heat(200, 400),
        GreenVitriol = lqudaciddcmp(8405, "Green Vitriol", 66, 222, 66, 255, LIQUID)
            .uumMcfg(0, Fe, 1 * U, S, 1 * U, O, 4 * U)
            .heat(200, 400),
        RedVitriol = lqudaciddcmp(8406, "Red Vitriol", 222, 66, 66, 255, LIQUID)
            .uumMcfg(0, Co, 1 * U, S, 1 * U, O, 4 * U)
            .heat(200, 400),
        PinkVitriol = lqudaciddcmp(8407, "Pink Vitriol", 222, 111, 111, 255, LIQUID)
            .uumMcfg(0, Mg, 1 * U, S, 1 * U, O, 4 * U)
            .heat(200, 400),
        CyanVitriol = lqudaciddcmp(
            8408,
            "Cyan Vitriol",
            111,
            222,
            ...
            "SolutionNickelSulphate").uumMcfg(0, Ni, 1 * U, S, 1 * U, O, 4 * U)
                .heat(200, 400),
        WhiteVitriol = lqudaciddcmp(8409, "White Vitriol", 222, 222, 222, 255, LIQUID)
            .uumMcfg(0, Zn, 1 * U, S, 1 * U, O, 4 * U)
            .heat(200, 400),
        GrayVitriol = lqudaciddcmp(8410, "Gray Vitriol", 111, 111, 111, 255, LIQUID)
            .uumMcfg(0, Mn, 1 * U, S, 1 * U, O, 4 * U)
            .heat(200, 400),
        MartianVitriol = lqudaciddcmp(8411, "Martian Vitriol", 222, 66, 222, 255, LIQUID)
            .uumMcfg(18, Fe, 2 * U, S, 3 * U, O, 12 * U)
            .heat(200, 400),
        VitriolOfClay = lqudaciddcmp(8412, "Vitriol Of Clay", 66, 222, 222, 255, LIQUID)
            .uumMcfg(0, Al2O3, 5 * U, S, 3 * U, O, 9 * U)
            .heat(200, 400),

        UF4 = dustdcmp(9007, "Uranium Tetrafluoride", SET_SHARDS, 86, 118, 105, 255, MELTING, MOLTEN)
            .setMcfg(0, U_238, 1 * U, F, 4 * U)
            .tooltip("UF\u2084")
            .aspects(TC.RADIO, 1, TC.PERDITIO, 2)
            .heat(1309, 1690),
        UF6 = gaschemdcmp(9008, "Uranium Hexafluoride", 66, 98, 85, 255, GASES).setMcfg(0, U_238, 1 * U, F, 6 * U)
            .tooltip("UF\u2086")
            .aspects(TC.RADIO, 1, TC.PERDITIO, 3)
            .heat(100, 329),
        U238F4 = dustdcmp(9009, "Uranium-238 Tetrafluoride", SET_SHARDS, 86, 118, 105, 255, MELTING, MOLTEN)
            .setMcfg(0, U_238, 1 * U, F, 4 * U)
            .tooltip("U-238F\u2084")
            .aspects(TC.RADIO, 1, TC.PERDITIO, 2)
            .heat(1309, 1690),
        U238F6 = gaschemdcmp(9010, "Uranium-238 Hexafluoride", 66, 98, 85, 255, GASES)
            .setMcfg(0, U_238, 1 * U, F, 6 * U)
            .tooltip("U-238F\u2086")
            .aspects(TC.RADIO, 1, TC.PERDITIO, 3)
            .heat(100, 329),
        U235F4 = dustdcmp(9011, "Uranium-235 Tetrafluoride", SET_SHARDS, 86, 118, 105, 255, MELTING, MOLTEN)
            .setMcfg(0, U_235, 1 * U, F, 4 * U)
            .tooltip("U-235F\u2084")
            .aspects(TC.RADIO, 1, TC.PERDITIO, 2)
            .heat(1309, 1690),
        U235F6 = gaschemdcmp(9012, "Uranium-235 Hexafluoride", 66, 98, 85, 255, GASES)
            .setMcfg(0, U_235, 1 * U, F, 6 * U)
            .tooltip("U-235F\u2086")
            .aspects(TC.RADIO, 1, TC.PERDITIO, 3)
            .heat(100, 329),

        AquaRegia = lqudacidcent(9827, "Aqua Regia", 64, 255, 64, 255, LIQUID).uumMcfg(0, HNO3, 5 * U, HCl, 8 * U)
            .heat(200, 400),
        CobaltHexahydrate = dustcent(8229, "Cobalt Hexahydrate", SET_ROUGH, 80, 80, 250, 255)
            .uumMcfg(0, Co, 1 * U, H2O, 6 * U),
        MethaneIce = dustcent(9833, "Methane Ice", SET_SHINY, 225, 200, 250, 255, G_CONTAINERS, FLAMMABLE)
            .setMcfg(2, CH4, 1 * U, Ice, 2 * U),
        NitroCarbon = elec(9820, "Nitro Carbon", SET_FLUID, 0, 75, 100, 255, G_CONTAINERS, EXPLOSIVE, FLAMMABLE)
            .uumMcfg(0, N, 1 * U, C, 1 * U),
        ...
        Biomass = lqudflam(9840, "Biomass", 0, 255, 0, 255, TICKS_PER_SMELT * 30, "BioMass").heat(200, 400)
            .aspects(TC.HERBA, 2),
        BioFuel = lqudflam(9841, "Bio Fuel", 200, 128, 0, 255, TICKS_PER_SMELT * 360).heat(100, 400)
        ...
        CrudeOil = oredust(9852, "Crude Oil", SET_DULL, 10, 10, 10, 255, TICKS_PER_SMELT * 60).heat(100, 400)
            .aspects(TC.MORTUUS, 2, TC.LUX, 1),
        Fuel = lqudexpl(9860, "Fuel", 255, 255, 0, 255, TICKS_PER_SMELT * 360, "FuelOil").heat(100, 400)
            .aspects(TC.MORTUUS, 1, TC.POTENTIA, 1)
            .setLocal("Fuel Oil"),
        NitroFuel = lqudexpl(9861, "Nitro-Fuel", 200, 255, 0, 255, TICKS_PER_SMELT * 360)
            .setMcfg(0, Glyceryl, 1 * U, Fuel, 4 * U)
            .heat(100, 400)
        ...
        FryingOilHot = lqudflam(9880, "FryingOilHot", 200, 196, 0, 255, FOOD).heat(100, 400)
        ...
        ConstructionFoam = lqud(9883, "Construction Foam", SET_DULL, 128, 128, 128, 255, DUSTS, STONE, BRITTLE, MELTING)
            .heat(500, 2000)
            .setLocal("C-Foam"),
        ...
        DarkAsh = dust(
            ...
            "DarkAsh",
            "AshDark",
            "AshesDark").aspects(TC.IGNIS, 1, TC.PERDITIO, 1),
        VolcanicAsh = dustcent(
            8202,
            "Volcanic Ashes",
            SET_FLINT,
            60,
            ...
            "VolcanicAsh",
            "AshVolcanic",
            "AshesVolcanic").setMcfg(0, Flint, 6 * U, Fe2O3, 1 * U, Mg, 1 * U)
                .aspects(TC.IGNIS, 2, TC.PERDITIO, 1),

        Chalk = oredustelec(9112, "Chalk", SET_FINE, 250, 250, 250, 255, FURNACE, MORTAR).setSmelting(CaCO3, 2 * U3)
            .setMcfg(0, CaCO3, 1 * U),
        Dolomite = oredustcent(9163, "Dolomite", SET_FLINT, 225, 205, 205, 255, FURNACE, MORTAR).setSmelting(CaCO3, U2)
            .setMcfg(0, CaCO3, 1 * U, MgCO3, 1 * U), // CaMg(CO3)2
        Asbestos = oredustelec(
            9103,
            "Asbestos",
            SET_LAPIS,
            230,
            ...
            EXTRUDER,
            EXTRUDER_SIMPLE,
            "Chrysotile").uumMcfg(0, Mg, 3 * U, SiO2, 6 * U, H2O, 6 * U, O, 3 * U), // Mg3Si2O5(OH)4
        Talc = oredustelec(9169, "Talc", SET_DULL, 95, 145, 95, 255, "Soapstone")
            .uumMcfg(0, Mg, 3 * U, SiO2, 12 * U, H2O, 3 * U, O, 3 * U), // H2Mg3(SiO3)4
        Pyrite = oredustdcmp(
            9125,
            "Pyrite",
            SET_SHINY,
            ...
            BLACKLISTED_SMELTER,
            MORTAR,
            MAGNETIC_PASSIVE).uumMcfg(0, Fe, 1 * U, S, 2 * U)
                .aspects(TC.IGNIS, 1, TC.METALLUM, 1, TC.STRONTIO, 1)
                .qual(0)
                .addSourceOf(Fe),
        PotassiumFeldspar = oredustelec(9140, "Potassium Feldspar", SET_FINE, 120, 40, 40, 255)
            .uumMcfg(0, K, 2 * U, Al2O3, 5 * U, SiO2, 18 * U, O, 1 * U),
        Biotite = oredustelec(9141, "Biotite", SET_METALLIC, 20, 30, 20, 255)
            .setMcfg(0, K, 2 * U, Mg, 6 * U, Al2O3, 15 * U, F, 4 * U, SiO2, 18 * U)
            .addSourceOf(Ar, K, F, Al), // releases Argon when heated.
        Emery = oredust(9183, "Emery", SET_STONE, 128, 128, 128, 255).aspects(TC.TERRA, 1),

        Bark = dust(8275, "Bark", SET_ROUGH, 80, 40, 0, 255, TICKS_PER_SMELT / 2, WOOD, MORTAR, FLAMMABLE, APPROXIMATE)
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.ARBOR, 1)
            .setBurning(Ash, U9)
            .setSmelting(Ash, U4)
            .heat(400, 500),
        Wood = wood(8221, "Wood", 100, 50, 0, 255, TICKS_PER_SMELT / 2, FLAMMABLE, APPROXIMATE)
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.ARBOR, 1)
            .setBurning(Ash, U9)
            .setSmelting(Ash, U4)
            .qual(1, 2.0, 16, 0)
            .heat(400, 500),
        WoodTreated = wood(8222, "WoodTreated", 80, 40, 0, 255, TICKS_PER_SMELT / 2, FLAMMABLE, COATED, "WoodSealed")
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.ARBOR, 1, TC.FABRICO, 1)
            .setAllToTheOutputOf(Wood)
            .qual(1, 3.0, 24, 0)
            .heat(500, 600)
            .setLocal("Treated Wood"),
        WoodPolished = wood(8267, "WoodPolished", 60, 30, 0, 255, TICKS_PER_SMELT / 2, FLAMMABLE, COATED)
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.ARBOR, 1, TC.FABRICO, 1)
            .setAllToTheOutputOf(Wood)
            .qual(1, 3.0, 24, 0)
        ...
        WoodRubber = wood(8224, "WoodRubber", 180, 150, 0, 255, TICKS_PER_SMELT / 4, FLAMMABLE, APPROXIMATE)
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.ARBOR, 1)
            .setBurning(Ash, U4)
            .setSmelting(Ash, U2)
        ...
        Bamboo = wood(8418, "Bamboo", 100, 200, 100, 255, TICKS_PER_SMELT / 2, FLAMMABLE, APPROXIMATE)
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.HERBA, 1)
            .setBurning(Ash, U4)
            .setSmelting(Ash, U2)
            .qual(1, 2.0, 32, 0)
            .heat(350, 450),
        Skyroot = wood(8291, "Skyroot", 50, 80, 80, 255, TICKS_PER_SMELT / 2, FLAMMABLE, APPROXIMATE)
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            ...
            .qual(1, 4.0, 64, 0)
            .heat(350, 450),
        Weedwood = wood(8286, "Weedwood", 80, 50, 0, 255, TICKS_PER_SMELT / 2, FLAMMABLE, APPROXIMATE)
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            ...
            .qual(1, 2.0, 32, 0)
            .heat(350, 450),
        Livingwood = wood(8289, "Livingwood", 60, 30, 0, 255, TICKS_PER_SMELT, FLAMMABLE, APPROXIMATE, MAGICAL)
            .setMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.ARBOR, 1, TC.VICTUS, 1)
            .setBurning(Ash, U4)
            .setSmelting(Ash, U2)
            .qual(1, 4.0, 64, 0)
            .heat(350, 500),
        Dreamwood = wood(8290, "Dreamwood", 200, 240, 240, 255, TICKS_PER_SMELT * 2, FLAMMABLE, APPROXIMATE, MAGICAL)
            .setMcfg(0, C, 6 * U, H2O, 15 * U)
        ...
        Shimmerwood = wood(
            ...
            FLAMMABLE,
            APPROXIMATE,
            MAGICAL).setMcfg(0, C, 6 * U, H2O, 15 * U)
                .aspects(TC.ARBOR, 1, TC.LUX, 1)
                .setBurning(Ash, U4)
                .setSmelting(Ash, U2)
                .qual(1, 4.0, 128, 1)
                .heat(350, 550),
        Greatwood = wood(8296, "Greatwood", 60, 30, 25, 255, TICKS_PER_SMELT * 2, FLAMMABLE, APPROXIMATE, MAGICAL)
            .setMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.ARBOR, 1)
            .setBurning(Ash, U4)
            .setSmelting(Ash, U2)
            .qual(1, 6.0, 64, 1)
            .heat(400, 600),
        Silverwood = wood(8297, "Silverwood", 234, 222, 210, 255, TICKS_PER_SMELT * 4, FLAMMABLE, APPROXIMATE, MAGICAL)
            .setMcfg(0, C, 6 * U, H2O, 15 * U)
            ...
            .qual(1, 8.0, 128, 1)
            .heat(450, 650),
        Peanutwood = wood(8227, "Peanut Wood", 120, 60, 0, 255, TICKS_PER_SMELT / 2, FLAMMABLE, "Peanutwood")
            .uumMcfg(0, C, 6 * U, H2O, 15 * U)
            .aspects(TC.ARBOR, 1)
            .steal(Wood)
            .heat(350, 450),
        Marshmallow = wood(9715, "Marshmallow", SET_FINE, 255, 220, 220, 255, FOOD).aspects(TC.FAMES, 1)
            .qual(1, 3.0, 24, 0),
        LiveRoot = dustcent(
            8223,
            "LiveRoot",
            ...
            MORTAR,
            MAGICAL,
            MORTAR).setMcfg(3, Wood, 3 * U, Ma, 1 * U)
                .aspects(TC.ARBOR, 1, TC.VICTUS, 1)
                .setLocal("Liveroot")
                .setBurning(Ash, U9)
                .heat(1178, 2465),
        PetrifiedWood = create(
            8277,
            "Petrified Wood",
            SET_WOOD,
            110,
            ...
            WOOD,
            MORTAR,
            FLAMMABLE).setMcfg(0, Wood, 1 * U)
                .aspects(TC.ARBOR, 1, TC.TERRA, 1)
                .qual(1, 2.0, 24, 1)
                .heat(350, 450),

        Wax = wax(8235, "Wax", 250, 250, 250, 255).aspects(TC.PERDITIO, 1)
            .heat(350),
        WaxBee = wax(8236, "WaxBee", 250, 220, 110, 255, FOOD, "BeesWax", "Beeswax", "BeeWax", "Beewax")
            .aspects(TC.BESTIA, 1)
            .heat(350)
            .setLocal("Bees Wax"),
        WaxRefractory = wax(8237, "WaxRefractory", 250, 50, 50, 255, UNBURNABLE, "RefractoryWax", "Refractorywax")
            .aspects(TC.GELUM, 1)
            .heat(2600)
            .setLocal("Refractory Wax"),
        WaxParaffin = wax(8238, "WaxParaffin", 210, 210, 250, 255, "ParaffinWax", "Paraffinwax").aspects(TC.FABRICO, 1)
            .heat(400)
            .setLocal("Paraffin Wax"),
        WaxPlant = wax(8239, "WaxPlant", 210, 250, 210, 255, FOOD).aspects(TC.HERBA, 1)
            .heat(350)
            .setLocal("Plant Wax"),
        WaxMagic = wax(8240, "WaxMagic", 200, 80, 200, 255, MAGICAL).aspects(TC.PRAECANTIO, 1)
            .heat(350)
            .setLocal("Magic Wax"),
        WaxAmnesic = wax(8280, "WaxAmnesic", 180, 70, 250, 255, MAGICAL).aspects(TC.STRONTIO, 1)
            .heat(350)
            .setLocal("Amnesic Wax"),
        WaxSoulful = wax(8281, "WaxSoulful", 90, 40, 10, 255, MAGICAL).aspects(TC.SPIRITUS, 1)
            .heat(350)
        ...
        Blaze = blaze(8211, "Blaze", 255, 200, 0, UNBURNABLE, BURNING, MELTING, TICKS_PER_SMELT * 24)
            .aspects(TC.IGNIS, 4)
            .heat(4000),
        Breeze = blaze(8471, "Breeze", 170, 155, 203).aspects(TC.VOLATUS, 4),

        Ceramic = dustelec(8225, "Ceramic", SET_ROUGH, 220, 130, 70, 255, MORTAR, PLATES, BRITTLE)
            .uumMcfg(18, Al2O3, 5 * U, SiO2, 12 * U)
            .heat(2000)
            .setCompressing(null, 0)
            .setBending(null, 0)
            .setForging(null, 0)
            .setSmashing(null, 0),
        Brick = create(9243, "Clay Brick", SET_ROUGH, 183, 90, 64, 255, MORTAR, BRITTLE, "Brick")
            .uumMcfg(1, Ceramic, 1 * U)
            .heat(2000)
            .steal(Ceramic)
            .setAllToTheOutputOf(Ceramic),
        Clay = oredustdcmp(8215, "Clay", SET_ROUGH, 200, 200, 220, 255, MORTAR, PLATES)
            .uumMcfg(2, Ceramic, 2 * U, H2O, 1 * U)
            .heat(2000)
            .setSmelting(Ceramic, U), // please do note that I had to make it easier to generify Clays without causing
        ...
        Bentonite = clay(9153, "Bentonite", 255, 192, 4, NaOH).setLocal("Bentonite Clay"), // (Na,Ca)0.33(Al,Mg)2(Si4O10)(OH)2
                                                                                           // + n(H2O)
        Palygorskite = clay(9154, "Palygorskite", 114, 157, 179, Mg, "FullersEarth").setLocal("Palygorskite Clay"), // (Al,Mg)2(Si4O10)(OH)
                                                                                                                    // +
                                                                                                                    // 4(H2O)
        Kaolinite = clay(9167, "Kaolinite", 245, 235, 235, Ca).setLocal("Kaolinite Clay"), // Al2Si2O5(OH)4

        Porcelain = mixdust(8273, "Porcelain", SET_FINE, 235, 235, 245, 255, PLATES, BRITTLE, MORTAR)
            .uumMcfg(0, Ceramic, 2 * U, SiO2, 1 * U, PotassiumFeldspar, 1 * U)
            .heat(1800)
            .setCompressing(null, 0)
            .setBending(null, 0)
            .setForging(null, 0)
        ...
        Graphite = oredustdcmp(
            ...
            BRITTLE,
            MORTAR,
            STICKS).uumMcfg(0, C, 1 * U)
                .qual(1, 5.0, 32, 2)
                .setSmelting(C, U2)
                .setBurning(Ash, U4)
                .heat(1700, C.mBoilingPoint),
        Niter = oredustcent(
            8206,
            "Niter",
            SET_FLINT,
            ...
            MORTAR,
            CRYSTAL,
            "Nitre").uumMcfg(0, KNO3, 1 * U, NaNO3, 1 * U)
                .addSourceOf(Na, K)
                .heat(607),
        Phosphorus = cent(
            8208,
            ...
            MORTAR,
            EXPLOSIVE,
            "Phosphorous").uumMcfg(0, Ca, 3 * U, PO4, 2 * U)
                .addSourceOf(P),
        PhosphorusBlue = cent(
            8458,
            "Blue Phosphorus",
            ...
            BRITTLE,
            MORTAR,
            EXPLOSIVE).uumMcfg(0, Ca, 3 * U, PO4, 2 * U)
                .addSourceOf(P),
        PhosphorusRed = cent(
            8459,
            "Red Phosphorus",
        ...
        Apatite = elec(
            ...
            MORTAR,
            CRYSTAL,
            CRYSTALLISABLE).uumMcfg(0, Ca, 5 * U, PO4, 3 * U, Cl, 1 * U)
                .addSourceOf(P)
                .aspects(TC.MESSIS, 2),
        Phosphorite = elec(
            8226,
            ...
            MORTAR,
            CRYSTAL,
            CRYSTALLISABLE).uumMcfg(0, Ca, 5 * U, PO4, 3 * U, F, 1 * U)
                .addSourceOf(P, F)
                .aspects(TC.MESSIS, 2),
        Paper = dust(8216, "Paper", SET_PAPER, 250, 250, 250, 255, TICKS_PER_SMELT / 8, MULTIPLATES, MORTAR)
        ...
        Polycarbonate = create(
            ...
            BRITTLE,
            FURNACE,
            "Polycarbonate").uumMcfg(0, C, 1 * U, H, 2 * U)
                .aspects(TC.MOTUS, 2)
                .heat(423)
                .setBurning(Ash, U9)
                .setSmelting(null, 2 * U3)
                .qual(1, 3.0, 256, 1),
        Bone = oredustelec(8219, "Bone", SET_DULL, 250, 250, 250, 255, MORTAR, "Fossil").uumMcfg(8, Ca, 1 * U)
            .aspects(TC.MORTUUS, 2, TC.CORPUS, 1)
            .qual(1, 4.0, 64, 1),
        BoneWither = Bone,
        SlimyBone = gem(8287, "Slimy Bone", SET_DULL, 230, 250, 230, 255, MORTAR).uumMcfg(8, Ca, 1 * U)
            .aspects(TC.MORTUUS, 2, TC.LIMUS, 1)
            .qual(1, 5.0, 128, 1),
        Gunpowder = dust(8220, "Gunpowder", SET_DULL, 128, 128, 128, 255, EXPLOSIVE, FLAMMABLE)
            .uumMcfg(4, C, 2 * U, S, 1 * U, NaNO3, 1 * U)
            .aspects(TC.PERDITIO, 3, TC.IGNIS, 4)
            .setBurning(Ash, U9),
        Dynamite = dust(8249, "Dynamite", SET_ROUGH, 111, 131, 111, 255, EXPLOSIVE, FLAMMABLE)
            .uumMcfg(0, Glyceryl, 1 * U, Wood, 1 * U)
        ...
        Tallow = dust(8244, "Tallow", SET_FOOD, 220, 200, 100, 255, MELTING, MOLTEN)
            .aspects(TC.CORPUS, 2, TC.HUMANUS, 1, TC.PRAECANTIO, 1)
            .heat(350)
            .setLocal("Magic Tallow"),
        Leather = create(8241, "Leather", SET_ROUGH, 141, 65, 37, 255, FLAMMABLE).aspects(TC.PANNUS, 1, TC.TUTAMEN, 1)
            .setBurning(Ash, U9)
            .setSmelting(Ash, U9),
        Indigo = dust(8228, "Indigo", SET_LEAF, 255, 128, 255, 255, FLAMMABLE).aspects(TC.SENSUS, 1),

        MeatCooked = meat(9701, "MeatCooked", 150, 60, 20, 255, "Meat").aspects(TC.CORPUS, 2)
            .heat(477, 550)
            .setLocal("Cooked Meat"),
        MeatRaw = meat(9700, "MeatRaw", 255, 100, 100, 255, FURNACE).aspects(TC.CORPUS, 1)
            .heat(477, 550)
            .setLocal("Raw Meat")
            .setSmelting(MeatCooked, U)
            .setForging(MeatCooked, U),
        MeatRotten = meat(9710, "MeatRotten", 255, 150, 100, 255, ROTTEN).aspects(TC.CORPUS, 1, TC.MORTUUS, 1)
            .heat(477, 550)
            .setLocal("Rotten Meat"),
        FishCooked = meat(9711, "FishCooked", 150, 120, 20, 255).aspects(TC.CORPUS, 2)
            .heat(477, 550)
            .setLocal("Cooked Fishmeal"),
        FishRaw = meat(9712, "FishRaw", 255, 150, 100, 255, FURNACE).aspects(TC.CORPUS, 1)
            .heat(477, 550)
            .setLocal("Raw Fishmeal")
            .setSmelting(FishCooked, U)
            .setForging(FishCooked, U),
        FishRotten = meat(9713, "FishRotten", 220, 200, 100, 255, ROTTEN).aspects(TC.CORPUS, 1, TC.MORTUUS, 1)
            .heat(477, 550)
            .setLocal("Rotten Fishmeal"),
        Wheat = grain(9702, "Wheat", 255, 255, 196, 255, "Flour"), Barley = grain(9704, "Barley", 196, 255, 196, 255),
        Rye = grain(9705, "Rye", 255, 230, 180, 255), Rice = grain(9706, "Rice", 252, 252, 240, 255),
        ...
        Potato = dustfood(9709, "Potato", SET_POWDER, 240, 240, 164, 255).aspects(TC.MESSIS, 2)
            .setBurning(Ash, U9),
        Tofu = dustfood(9778, "Tofu", SET_FOOD, 222, 222, 222, 255, INGOTS, MELTING, EXTRUDER, EXTRUDER_SIMPLE)
            .aspects(TC.FAMES, 1, TC.HERBA, 1)
            .heat(422, 500),
        SoylentGreen = dustfood(
            9779,
            "Soylent Green",
            SET_FOOD,
            0,
            ...
            MELTING,
            EXTRUDER,
            EXTRUDER_SIMPLE).aspects(TC.FAMES, 1, TC.CORPUS, 1)
                .heat(422, 500)
                .setLocal("Emerald Green"),
        Cheese = orefood(9780, "Cheese", 255, 234, 0, 255, INGOTS, MELTING, EXTRUDER, EXTRUDER_SIMPLE, FURNACE)
            .aspects(TC.FAMES, 1)
            .heat(320, 500),
        Chili = dustfood(9781, "Chili", 200, 0, 0, 255).aspects(TC.IGNIS, 1),
        Cocoa = dustfood(9782, "Cocoa", 190, 95, 0, 255).aspects(TC.SANO, 1),
        Chocolate = mixfood(9783, "Chocolate", 100, 50, 0, 255, FURNACE, INGOTS, MELTING, EXTRUDER, EXTRUDER_SIMPLE)
            .setMcfg(0, Cocoa, 1 * U, Sugar, 1 * U)
        ...
        PEZ = orefood(9716, "PEZ", 210, 210, 210, 255).aspects(TC.FAMES, 1)
            .qual(2, 8.0, 512, 3),
        Licorice = orefood(9717, "Licorice", 30, 30, 30, 255).aspects(TC.FAMES, 1)
            .qual(2, 6.0, 128, 2),
        Nougat = orefood(9718, "Nougat", 240, 200, 150, 255).aspects(TC.FAMES, 1),
        PepperBlack = dustfood(9788, "PepperBlack", 40, 40, 40, 255, "Pepper").aspects(TC.FAMES, 1)
            .setLocal("Black Pepper"),
        Curry = dustfood(9789, "Curry", 240, 190, 100, 255).aspects(TC.FAMES, 1),
        Milk = food(9790, "Milk", SET_FINE, 254, 254, 254, 255, G_CONTAINERS, DUSTS).aspects(TC.SANO, 2)
            .heat(CS.C, CS.C + 100),
        Butter = food(9798, "Butter", 230, 230, 100, 255, INGOTS, MELTING).setMcfg(1, Milk, 1 * U)
            .aspects(TC.FAMES, 3)
            .heat(CS.C + 40, 500),
        ButterSalted = food(9799, "Salted Butter", 230, 230, 110, 255, INGOTS, MELTING)
            .setMcfg(1, Milk, 1 * U, NaCl, 1 * U)
            .aspects(TC.FAMES, 3)
            .heat(CS.C + 40, 500),
        Honey = orefood(9791, "Honey", 250, 200, 0, 255, (Object[]) G_CONTAINERS).aspects(TC.SANO, 1)
            .heat(CS.C, CS.C + 100),
        Honeydew = orefood(9793, "Honeydew", 210, 100, 0, 255, (Object[]) G_CONTAINERS).aspects(TC.SANO, 1)
            .heat(CS.C, CS.C + 100),
        ...
        Diamond = diamond(8300, "Diamond", 200, 255, 255, DYE_INDEX_White).uumMcfg(1, C, 4 * U)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint),
        DiamondBlue = diamond(8464, "Blue Diamond", 30, 60, 240, DYE_INDEX_Blue).uumMcfg(1, C, 4 * U)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint),
        DiamondGreen = diamond(8465, "Green Diamond", 0, 240, 0, DYE_INDEX_Green).uumMcfg(1, C, 4 * U)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint),
        DiamondPurple = diamond(8466, "Purple Diamond", 120, 0, 240, DYE_INDEX_Purple).uumMcfg(1, C, 4 * U)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint),
        DiamondRed = diamond(8467, "Red Diamond", 240, 0, 0, DYE_INDEX_Red).uumMcfg(1, C, 4 * U)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint),
        DiamondYellow = diamond(8468, "Yellow Diamond", 240, 240, 0, DYE_INDEX_Yellow).uumMcfg(1, C, 4 * U)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint),
        DiamondPink = diamond(8424, "Pink Diamond", 240, 160, 160, DYE_INDEX_Pink).uumMcfg(1, C, 4 * U)
            .aspects(TC.AURAM, 4)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint)
            .qual(3, 12.0, 1600, 3),
        DiamondIndustrial = diamond(8423, "DiamondIndustrial", 255, 255, 210, DYE_INDEX_Yellow).uumMcfg(1, C, 4 * U)
            .aspects(TC.FABRICO, 2)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint)
            .qual(3, 9.0, 1440, 3)
            .setLocal("Industrial Diamond"),
        ManaDiamond = diamond(8278, "Mana Diamond", 128, 255, 255, DYE_INDEX_Cyan, MAGICAL, UNBURNABLE)
            .setMcfg(1, C, 4 * U, Ma, 1 * U)
            .aspects(TC.PRAECANTIO, 2)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint)
            .qual(3, 10.0, 1280, 3),
        ElvenDragonstone = diamond(8279, "Elven Dragonstone", 240, 140, 240, DYE_INDEX_Magenta, MAGICAL, UNBURNABLE)
            .setMcfg(1, C, 4 * U, Ma, 2 * U)
            .aspects(TC.PRAECANTIO, 4)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint)
            .qual(3, 12.0, 1280, 3)
            .setLocal("Dragonstone"),
        Gravitite = diamond(8294, "Gravitite", 182, 91, 159, DYE_INDEX_Magenta, MAGICAL, CRYSTALLISABLE)
            .setMcfg(1, C, 4 * U, Gt, 1 * U, Ma, 1 * U)
            .aspects(TC.VOLATUS, 4)
            .setDensity(3.53)
            .heat(4200, C.mBoilingPoint)
            .qual(3, 9.0, 1280, 3),

        Emerald = emerald(8301, "Emerald", 80, 255, 80, DYE_INDEX_Green)
            .uumMcfg(0, Al2O3, 5 * U, Be, 3 * U, SiO2, 18 * U, O, 3 * U)
            .aspects(TC.LUCRUM, 2),
        Aquamarine = emerald(8323, "Aquamarine", 200, 220, 255, DYE_INDEX_Cyan)
            .uumMcfg(0, Al2O3, 5 * U, Be, 3 * U, SiO2, 18 * U, O, 3 * U)
            .aspects(TC.AQUA, 2),
        Morganite = emerald(8324, "Morganite", 255, 200, 200, DYE_INDEX_Pink)
            .uumMcfg(0, Al2O3, 5 * U, Be, 3 * U, SiO2, 18 * U, O, 3 * U)
            .aspects(TC.TEMPESTAS, 2),
        Heliodor = emerald(8384, "Heliodor", 255, 255, 150, DYE_INDEX_Yellow)
            .uumMcfg(0, Al2O3, 5 * U, Be, 3 * U, SiO2, 18 * U, O, 3 * U)
            .aspects(TC.LUX, 2),
        Goshenite = emerald(8385, "Goshenite", 240, 240, 240, DYE_INDEX_White)
            .uumMcfg(0, Al2O3, 5 * U, Be, 3 * U, SiO2, 18 * U, O, 3 * U)
            .aspects(TC.VACUOS, 2),
        Bixbite = emerald(8386, "Bixbite", 255, 80, 80, DYE_INDEX_Red, "ScarletEmerald")
            .uumMcfg(0, Al2O3, 5 * U, Be, 3 * U, SiO2, 18 * U, O, 3 * U)
            .aspects(TC.SANO, 2),
        Maxixe = emerald(8387, "Maxixe", 80, 80, 255, DYE_INDEX_Blue)
            .uumMcfg(0, Al2O3, 5 * U, Be, 3 * U, SiO2, 18 * U, O, 3 * U)
            .aspects(TC.RADIO, 2),
        ...
        BlueSapphire = sapphire(8328, "Blue Sapphire", 100, 100, 200, DYE_INDEX_Blue)
            .uumMcfg(6, Al2O3, 5 * U, Fe, 1 * U)
            .aspects(TC.METALLUM, 1),
        GreenSapphire = sapphire(8305, "Green Sapphire", 100, 200, 130, DYE_INDEX_Green)
            .uumMcfg(6, Al2O3, 5 * U, Mg, 1 * U)
            .aspects(TC.SANO, 1),
        PurpleSapphire = sapphire(8383, "Purple Sapphire", 220, 50, 255, DYE_INDEX_Purple)
            .uumMcfg(6, Al2O3, 5 * U, V, 1 * U)
            .aspects(TC.ELECTRUM, 1),
        YellowSapphire = sapphire(8315, "Yellow Sapphire", 220, 220, 50, DYE_INDEX_Yellow)
            .uumMcfg(6, Al2O3, 5 * U, TiO2, 1 * U)
            .aspects(TC.TUTAMEN, 1),
        OrangeSapphire = sapphire(8314, "Orange Sapphire", 220, 150, 50, DYE_INDEX_Orange)
            .uumMcfg(6, Al2O3, 5 * U, Cu, 1 * U)
            .aspects(TC.PERMUTATIO, 1),

        Spinel = valgemelec(8326, "Spinel", SET_GEM_VERTICAL, 0, 100, 0, 127, RANDOM_SMALL_GEM_ORE)
            .lens(DYE_INDEX_Green)
            .uumMcfg(0, Al2O3, 5 * U, Mg, 1 * U, O, 1 * U)
            .aspects(TC.VITREUS, 2, TC.LUCRUM, 3)
            .qual(3, 7.0, 384, 2),
        BalasRuby = valgemelec(
            8303,
            "Balas Ruby",
            SET_GEM_VERTICAL,
            255,
            ...
            100,
            127,
            RANDOM_SMALL_GEM_ORE,
            "FoolsRuby").setLocal("Ruby")
                .steal(Ruby)
                .lens(DYE_INDEX_Red)
                .uumMcfg(0, Cr, 2 * U, Mg, 1 * U, O, 4 * U)
                .aspects(TC.VITREUS, 2, TC.LUCRUM, 2, TC.STRONTIO, 2)
                .qual(3, 7.0, 384, 2),

        Almandine = garnet(9101, "Almandine", 255, 0, 0, DYE_INDEX_Red, "GarnetRed")
            .uumMcfg(0, Al2O3, 5 * U, Fe, 3 * U, SiO2, 9 * U, O, 3 * U)
            .aspects(TC.METALLUM, 1),
        Grossular = garnet(9119, "Grossular", 200, 100, 0, DYE_INDEX_Orange, "GarnetOrange")
            .uumMcfg(0, Al2O3, 5 * U, Ca, 3 * U, SiO2, 9 * U, O, 3 * U)
            .aspects(TC.VOLATUS, 1),
        Pyrope = garnet(9127, "Pyrope", 120, 50, 100, DYE_INDEX_Purple, "GarnetPurple")
            .uumMcfg(0, Al2O3, 5 * U, Mg, 3 * U, SiO2, 9 * U, O, 3 * U)
            .aspects(TC.SANO, 1),
        Spessartine = garnet(9129, "Spessartine", 255, 100, 100, DYE_INDEX_Red, "Garnet")
            .uumMcfg(0, Al2O3, 5 * U, Mn, 3 * U, SiO2, 9 * U, O, 3 * U)
            .aspects(TC.METALLUM, 1),
        Andradite = garnet(9102, "Andradite", 150, 120, 0, DYE_INDEX_Yellow, "GarnetYellow")
            .uumMcfg(0, Ca, 3 * U, Fe, 2 * U, SiO2, 9 * U, O, 6 * U)
            .aspects(TC.TUTAMEN, 1),
        Uvarovite = garnet(9135, "Uvarovite", 180, 255, 180, DYE_INDEX_Lime, "GarnetGreen")
            .uumMcfg(0, Ca, 3 * U, Cr, 2 * U, SiO2, 9 * U, O, 6 * U)
            .aspects(TC.MACHINA, 1),
        ...
        Topaz = valgemelec(8306, "Topaz", SET_GEM_HORIZONTAL, 255, 128, 0, 127, RANDOM_SMALL_GEM_ORE)
            .lens(DYE_INDEX_Orange)
            .uumMcfg(0, Al2O3, 5 * U, SiO2, 3 * U, F, 2 * U, H2O, 3 * U)
            .aspects(TC.VITREUS, 4, TC.LUCRUM, 4, TC.POTENTIA, 2)
            .qual(3, 7.0, 256, 3),
        BlueTopaz = valgemelec(8307, "Blue Topaz", SET_GEM_HORIZONTAL, 123, 150, 220, 127, RANDOM_SMALL_GEM_ORE)
            .lens(DYE_INDEX_Blue)
            .uumMcfg(0, Al2O3, 5 * U, SiO2, 3 * U, F, 2 * U, H2O, 3 * U)
            .aspects(TC.VITREUS, 4, TC.LUCRUM, 4, TC.POTENTIA, 2)
            .qual(3, 7.0, 256, 3)
            .setGenerifying(Topaz),
        Tanzanite = valgemelec(8308, "Tanzanite", SET_GEM_HORIZONTAL, 64, 0, 200, 127, RANDOM_SMALL_GEM_ORE)
            .lens(DYE_INDEX_Purple)
            .uumMcfg(0, Al2O3, 15 * U, SiO2, 18 * U, Ca, 4 * U, H2O, 3 * U, O, 4 * U)
            .aspects(TC.VITREUS, 3, TC.LUCRUM, 5)
            .qual(3, 7.0, 256, 2),
        Zanite = valgemelec(8292, "Zanite", SET_REDSTONE, 146, 73, 255, 127, CRYSTALLISABLE).lens(DYE_INDEX_Purple)
            .uumMcfg(0, Al2O3, 15 * U, SiO2, 18 * U, Ca, 4 * U, H2O, 3 * U, O, 4 * U)
            .aspects(TC.VITREUS, 3, TC.PERFODIO, 4)
            .qual(3, 16.0, 512, 2)
            .setGenerifying(Tanzanite),
        Amazonite = valgemelec(8417, "Amazonite", SET_LAPIS, 71, 241, 170, 255, RANDOM_SMALL_GEM_ORE, MD.VOLTZ)
            .lens(DYE_INDEX_Green)
            .uumMcfg(0, Al2O3, 5 * U, SiO2, 18 * U, K, 2 * U, O, 1 * U)
            .aspects(TC.VITREUS, 3, TC.LUCRUM, 5)
            .qual(3, 7.0, 256, 2),
        Alexandrite = valgemelec(8388, "Alexandrite", SET_OPAL, 200, 255, 170, 127 /* no small ores for this */ )
            .lens(DYE_INDEX_Lime)
            .uumMcfg(0, Al2O3, 1 * U, Be, 1 * U, O, 1 * U)
            .aspects(TC.VITREUS, 4, TC.LUCRUM, 2, TC.AURAM, 1)
            .qual(3, 7.0, 512, 3),
        Opal = valgemelec(8312, "Opal", SET_OPAL, 0, 0, 255, 127, RANDOM_SMALL_GEM_ORE).lens(DYE_INDEX_Blue)
            .uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.VITREUS, 4, TC.LUCRUM, 2, TC.AURAM, 1)
            .qual(3, 7.0, 256, 2),
        OnyxRed = valgemelec(8415, "OnyxRed", SET_LAPIS, 255, 88, 77, 255, RANDOM_SMALL_GEM_ORE, MD.VOLTZ)
            .lens(DYE_INDEX_Red)
            .uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.VITREUS, 4, TC.LUCRUM, 2)
            .qual(3, 7.0, 256, 2)
            .setLocal("Red Onyx"),
        OnyxBlack = valgemelec(8416, "OnyxBlack", SET_LAPIS, 50, 50, 50, 255, RANDOM_SMALL_GEM_ORE, MD.VOLTZ, "Onyx")
            .lens(DYE_INDEX_Black)
            .uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.VITREUS, 4, TC.LUCRUM, 2)
            .qual(3, 7.0, 256, 2)
            .setLocal("Black Onyx"),
        Sugilite = valgemelec(8463, "Sugilite", SET_LAPIS, 153, 100, 196, 255).lens(DYE_INDEX_Purple)
            .uumMcfg(0, K, 1 * U, Na, 2 * U, MnO2, 2 * U, Li, 3 * U, SiO2, 36 * U, O, 2 * U)
            .aspects(TC.VITREUS, 2, TC.LUCRUM, 2, TC.ALIENIS, 2)
            .qual(3, 9.0, 512, 3), // KNa2(Fe,Mn,Al)2Li3Si12O30
        Peridot = valgemelec(8311, "Peridot", SET_RUBY, 150, 255, 150, 127, RANDOM_SMALL_GEM_ORE, "Olivine")
            .lens(DYE_INDEX_Lime)
            .uumMcfg(0, SiO2, 2 * U, Fe, 1 * U, Mg, 2 * U)
            .aspects(TC.VITREUS, 2, TC.LUCRUM, 4)
            .qual(3, 7.0, 256, 2),
        Amethyst = valgemelec(8313, "Amethyst", SET_RUBY, 166, 120, 241, 127, RANDOM_SMALL_GEM_ORE).lens(DYE_INDEX_Pink)
            .uumMcfg(0, SiO2, 4 * U, Fe, 1 * U)
            .aspects(TC.VITREUS, 4, TC.LUCRUM, 6)
            .qual(3, 6.0, 128, 3),
        Dioptase = valgemelec(8325, "Dioptase", SET_EMERALD, 0, 180, 180, 127, RANDOM_SMALL_GEM_ORE)
            .lens(DYE_INDEX_Cyan)
            .uumMcfg(0, SiO2, 3 * U, Cu, 1 * U, O, 1 * U, H2O, 3 * U)
            .aspects(TC.VITREUS, 3, TC.LUCRUM, 3, TC.PERMUTATIO, 2)
            .qual(3, 7.0, 256, 2),
        Carminite = valgem(8470, "Carminite", SET_FINE, 150, 0, 0, 255, MORTAR, CRYSTALLISABLE)
            .aspects(TC.VITREUS, 1, TC.PERMUTATIO, 2)
            .qual(3, 7.0, 384, 3),
        Amber = valgem(8310, "Amber", SET_RUBY, 255, 180, 0, 127, MORTAR, CRYSTALLISABLE).lens(DYE_INDEX_Orange)
            .aspects(TC.VITREUS, 1, TC.VINCULUM, 2)
            .qual(3, 4.0, 256, 3)
            .heat(473),
        AmberGolden = valgem(8469, "Golden Amber", SET_RUBY, 255, 230, 80, 127, MORTAR, CRYSTALLISABLE)
            .lens(DYE_INDEX_Yellow)
            .aspects(TC.VITREUS, 1, TC.VINCULUM, 2, TC.VOLATUS, 2)
            .qual(3, 5.0, 384, 3)
            .heat(473)
            .setGenerifying(Amber),
        AmberDominican = valgem(8422, "Dominican Amber", SET_RUBY, 80, 80, 240, 127, MORTAR, CRYSTALLISABLE)
            .lens(DYE_INDEX_Blue)
            ...
            .setGenerifying(Amber)
            .setLocal("Blue Amber"),
        Craponite = valgem(8322, "Craponite", SET_FLINT, 255, 170, 185, 127, MORTAR, CRYSTALLISABLE)
            .lens(DYE_INDEX_Magenta)
            .aspects(TC.VITREUS, 3, TC.LUCRUM, 3, TC.STRONTIO, 2)
            .qual(3, 7.0, 256, 2),
        Jade = valgem(8321, "Jade", SET_LAPIS, 100, 255, 125, 255, RANDOM_SMALL_GEM_ORE, MORTAR, CRYSTALLISABLE)
            .lens(DYE_INDEX_Green)
        ...
        Vinteum = dcmp(
            ...
            MORTAR,
            BRITTLE,
            UNBURNABLE).setMcfg(0, Ma, 1 * U)
                .aspects(TC.VITREUS, 1, TC.PRAECANTIO, 2)
                .qual(3, 10.0, 128, 3),
        VinteumPurified = dcmp(
            8327,
            "VinteumPurified",
            SET_EMERALD,
            230,
        ...
        ArcaneCompound = dust(8366, "Arcane Compound", SET_ROUGH, 180, 140, 50, 255, MAGICAL, FURNACE)
            .aspects(TC.PRAECANTIO, 3)
            .setSmelting(ArcaneAsh, U * 2),
        Moonstone = gem(8452, "Moonstone", SET_RUBY, 210, 210, 255, 255)
        ...
        Valonite = gem(8285, "Valonite", SET_SHARDS, 255, 205, 240, 127).lens(DYE_INDEX_Pink)
            .aspects(TC.VITREUS, 3, TC.LUCRUM, 4)
            .qual(3, 9.0, 2560, 3),
        Scabyst = gem(8288, "Scabyst", SET_SHARDS, 110, 165, 165, 127).lens(DYE_INDEX_Cyan)
            .aspects(TC.VITREUS, 2, TC.SANO, 2),

        Ambrosium = gem(8293, "Ambrosium", SET_DIAMOND, 244, 242, 96, 127, CRYSTALLISABLE, GLOWING, LIGHTING)
            .lens(DYE_INDEX_Yellow)
            .aspects(TC.VITREUS, 2, TC.LUX, 2, TC.PRAECANTIO, 2)
            .qual(3, 4.0, 16, 2),
        Continuum = gem(8295, "Continuum", SET_RUBY, 222, 129, 40, 127, CRYSTALLISABLE).lens(DYE_INDEX_Orange)
            .aspects(TC.VITREUS, 4, TC.NEBRISUM, 4)
            .qual(3, 4.0, 64, 3),

        EnderAmethyst = valgemelec(8329, "AmethystEnder", SET_FLINT, 210, 50, 210, 127).lens(DYE_INDEX_Pink)
            .setMcfg(5, SiO2, 4 * U, Fe, 1 * U, Ma, 1 * U)
            .aspects(TC.VITREUS, 4, TC.LUCRUM, 4, TC.ALIENIS, 2)
            .qual(3, 10.0, 2560, 3)
            .setGenerifying(Amethyst)
        ...
        EnderPearl = elec(
            ...
            PEARL,
            MELTING,
            "Ender").setMcfg(10, Be, 1 * U, K, 4 * U, N, 5 * U, Ma, 6 * U)
        ...
        EnderEye = cent(
            ...
            MAGICAL,
            PEARL,
            MELTING).setMcfg(9, EnderPearl, 9 * U, Blaze, 1 * U)
        ...
        NetherStar = crystal(
            ...
            MAGICAL,
            GLOWING,
            MELTING).qual(3, 8.0, 5120, 4)
                .heat(3896, 5127),

        Frezarite = create(8391, "Frezarite", SET_NETHERSTAR, 255, 255, 255, 255, G_GEM, CRYSTAL, BRITTLE, MAGICAL)
            .aspects(TC.VITREUS, 3, TC.GELUM, 3)
            .qual(3, 4.0, 128, 2),
        RedMeteor = create(8392, "Red Meteor", SET_RUBY, 255, 60, 60, 255, G_GEM, MAGICAL, GLOWING, UNBURNABLE)
            .aspects(TC.VITREUS, 3, TC.ALIENIS, 3)
            .qual(3, 8.0, 512, 3),

        Dilithium = crystal(8317, "Dilithium", SET_DIAMOND, 153, 255, 255, 127, CRYSTALLISABLE, QUARTZ)
            .lens(DYE_INDEX_White)
            .setSmelting(null, 0),

        Zircon = valgemelec(8419, "Zircon", SET_EMERALD, 99, 24, 29, 255, WASHING_FIRESTONE).lens(DYE_INDEX_Red)
            .uumMcfg(0, Zr, 1 * U, SiO2, 3 * U, O, 2 * U)
            .aspects(TC.VITREUS, 4)
            .setSmelting(Zr, U9)
            .qual(3, 8.0, 384, 2),
        Azurite = elec(8420, "Azurite", SET_QUARTZ, 109, 164, 247, 255, G_GEM_ORES, CRYSTAL, MORTAR, BRITTLE, FURNACE)
            .uumMcfg(0, Cu, 3 * U, CO3, 8 * U, O, 1 * U, H2O, 3 * U)
            .aspects(TC.SENSUS, 1)
            .setSmelting(Cu, U9),
        Eudialyte = dcmp(8421, "Eudialyte", SET_LAPIS, 155, 96, 114, 255, G_GEM_ORES, CRYSTAL, MORTAR, BRITTLE)
            .setMcfg(0, Zircon, 18 * U, MnO2, 3 * U, Na, 15 * U, Ca, 6 * U, Cl, U * 2, SiO2, 75 * U, O, 12 * U)
            .aspects(TC.VITREUS, 2), // Na15Ca6(Fe,Mn)3Zr3SiO(O,OH,H2O)3 (Si3O9)2(Si9O27)2(OH,Cl)2
        ...
        Lazurite = elec(
            ...
            CRYSTALLISABLE,
            MORTAR,
            BRITTLE).uumMcfg(0, Al2O3, 6 * U, SiO2, 6 * U, Ca, 8 * U, Na, 8 * U)
                .aspects(TC.SENSUS, 1),
        Sodalite = elec(
            8331,
            "Sodalite",
            ...
            CRYSTALLISABLE,
            MORTAR,
            BRITTLE).uumMcfg(0, Al2O3, 3 * U, SiO2, 3 * U, Na, 4 * U, Cl, 1 * U)
                .aspects(TC.SENSUS, 1),
        Lapis = cent(
            8332,
            "Lapis",
            ...
            CRYSTALLISABLE,
            MORTAR,
            BRITTLE).uumMcfg(0, Lazurite, 12 * U, Sodalite, 2 * U, Pyrite, 1 * U, CaCO3, 1 * U)
                .aspects(TC.SENSUS, 1),

        Charcoal = coal(8336, "Charcoal", SET_LIGNITE, 100, 70, 70, 255, TICKS_PER_SMELT * 8).setBurning(Ash, U4)
            .uumMcfg(0, C, 1 * U)
            .setSmelting(C, U2)
            .heat(1700, C.mBoilingPoint)
            .setDensity(0.929)
            .aspects(TC.POTENTIA, 2, TC.IGNIS, 2),
        Coal = coal(8334, "Coal", SET_LIGNITE, 70, 70, 70, 255, TICKS_PER_SMELT * 8).setBurning(DarkAsh, U4)
            .uumMcfg(0, C, 1 * U)
            .setSmelting(C, U2)
            .heat(1700, C.mBoilingPoint)
            .setDensity(0.929)
            .aspects(TC.POTENTIA, 2, TC.IGNIS, 2),
        CoalCoke = coal(8349, "Coal Coke", SET_LIGNITE, 140, 140, 170, 255, TICKS_PER_SMELT * 16, "Coke")
            .setBurning(DarkAsh, U9)
            .uumMcfg(0, C, 1 * U)
            .setSmelting(C, U)
            .heat(1700, C.mBoilingPoint)
            .setDensity(0.929)
            ...
            .steal(Coal),
        Anthracite = coal(8362, "Anthracite", SET_LIGNITE, 90, 90, 90, 255, TICKS_PER_SMELT * 24)
            .setBurning(DarkAsh, U2)
            .uumMcfg(1, C, 2 * U)
            .setSmelting(C, U2)
            .heat(1700, C.mBoilingPoint)
            .aspects(TC.POTENTIA, 3, TC.IGNIS, 3),
        Prismane = coal(8363, "Prismane", SET_LIGNITE, 115, 110, 110, 255, TICKS_PER_SMELT * 48).setBurning(DarkAsh, U)
            .uumMcfg(1, C, 4 * U)
            .aspects(TC.POTENTIA, 4, TC.IGNIS, 4),
        Lonsdaleite = coal(8364, "Lonsdaleite", SET_DIAMOND, 140, 130, 130, 255, TICKS_PER_SMELT * 96)
            .setBurning(DarkAsh, U * 2)
            .uumMcfg(1, C, 8 * U)
            .aspects(TC.POTENTIA, 6, TC.IGNIS, 6),
        Lignite = coal(8337, "Lignite", SET_LIGNITE, 100, 70, 70, 255, TICKS_PER_SMELT * 4).setBurning(DarkAsh, U4)
            .setMcfg(7, C, 2 * U, H2O, 4 * U, DarkAsh, 1 * U)
            .setDensity(0.865)
            .setLocal("Lignite Coal"),
        LigniteCoke = coal(8365, "Lignite Coke", SET_LIGNITE, 140, 100, 100, 255, TICKS_PER_SMELT * 8)
            .setBurning(DarkAsh, U9)
            .setMcfg(7, C, 2 * U, DarkAsh, 1 * U)
            .setDensity(0.865),
        PetCoke = coal(8390, "Petroleum Coke", SET_LIGNITE, 150, 150, 180, 255, TICKS_PER_SMELT * 32, "PetCoke")
            .setBurning(DarkAsh, U9)
            .uumMcfg(1, C, 2 * U, S, 1 * U)
            .setDensity(0.929)
            .aspects(TC.POTENTIA, 3, TC.IGNIS, 1)
            .steal(Coal),
        Peat = dust(
        ...
        PeatBituminous = dust(
            ...
            BRITTLE,
            FLAMMABLE,
            MORTAR).aspects(TC.POTENTIA, 3, TC.IGNIS, 3, TC.PERDITIO, 3)
                .setLocal("Bituminous Peat"),

        HydratedCoal = mixdust(8335, "Hydrated Coal", SET_LIGNITE, 70, 70, 100, 255, BRITTLE, FURNACE, MORTAR, COAL)
            .uumMcfg(8, Coal, 8 * U, H2O, 1 * U),
        Graphene = dcmp(9175, "Graphene", SET_DULL, 128, 128, 128, 255, G_MACHINE, BLACKLISTED_SMELTER, MORTAR, STICKS)
            .setBurning(Ash, U4)
            .uumMcfg(0, C, 1 * U)
            .setSmelting(C, U2)
            .heat(4300, 4400)
            .setPulver(C, U),
        Ectoplasm = dust(8373, "Ectoplasm", SET_FOOD, 220, 255, 255, 200, MAGICAL, LIQUID, GLOWING)
        ...
        Firestone = create(
            ...
            QUARTZ,
            UNBURNABLE,
            BURNING).qual(3, 6.0, 1280, 3)
                .aspects(TC.IGNIS, 8)
                .heat(3000, 3700),

        Redstone = redstone(8333, "Redstone", SET_REDSTONE, 200, 0, 0, 255, PULVERIZING_CINNABAR).lens(DYE_INDEX_Red)
            .uumMcfg(0, Pyrite, 5 * U, Hg, 3 * U, SiO2, 1 * U, Ruby, 1 * U)
            .aspects(TC.MACHINA, 1, TC.POTENTIA, 2)
            .heat(500, 1500)
            .qual(0),
        Nikolite = redstone(8340, "Nikolite", SET_REDSTONE, 60, 180, 200, 255, MOLTEN, "Electrotine", "Teslatite")
            .lens(DYE_INDEX_Cyan)
            .uumMcfg(0, Sodalite, 5 * U, Cu, 3 * U, SiO2, 1 * U, Ar, 1 * U)
            .aspects(TC.ELECTRUM, 2)
            .heat(1500, 3000)
            .qual(0),

        Glowstone = glowstone(8341, "Glowstone", SET_REDSTONE, 255, 255, 0, 255)
            .uumMcfg(0, Phosphorite, 5 * U, Au, 3 * U, SiO2, 1 * U, He, 1 * U)
            .aspects(TC.LUX, 2, TC.SENSUS, 1)
            .heat(500, 600),
        GlowstoneCeres = glowstone(8368, "GlowstoneCeres", SET_REDSTONE, 70, 90, 70, 255)
            .uumMcfg(0, Phosphorite, 5 * U, Au, 3 * U, SiO2, 1 * U, He, 1 * U)
            .aspects(TC.LUX, 2, TC.SENSUS, 1, TC.HERBA, 1)
            .heat(500, 600)
            .setGenerifying(Glowstone)
            .setLocal("Ceres Glowstone"),
        GlowstoneIo = glowstone(8369, "GlowstoneIo", SET_REDSTONE, 180, 20, 0, 255)
            .uumMcfg(0, Phosphorite, 5 * U, Au, 3 * U, SiO2, 1 * U, He, 1 * U)
            .aspects(TC.LUX, 2, TC.SENSUS, 1, TC.IGNIS, 1)
            .heat(500, 600)
            .setGenerifying(Glowstone)
            .setLocal("Io Glowstone"),
        GlowstoneEnceladus = glowstone(8370, "GlowstoneEnceladus", SET_REDSTONE, 0, 250, 250, 255)
            .uumMcfg(0, Phosphorite, 5 * U, Au, 3 * U, SiO2, 1 * U, He, 1 * U)
            .aspects(TC.LUX, 2, TC.SENSUS, 1, TC.AQUA, 1)
            .heat(500, 600)
            .setGenerifying(Glowstone)
            .setLocal("Enceladus Glowstone"),
        GlowstoneProteus = glowstone(8371, "GlowstoneProteus", SET_REDSTONE, 62, 62, 62, 255)
            .uumMcfg(0, Phosphorite, 5 * U, Au, 3 * U, SiO2, 1 * U, He, 1 * U)
            .aspects(TC.LUX, 2, TC.SENSUS, 1, TC.TENEBRAE, 1)
            .heat(500, 600)
            .setGenerifying(Glowstone)
            .setLocal("Proteus Glowstone"),
        GlowstonePluto = glowstone(8372, "GlowstonePluto", SET_REDSTONE, 123, 150, 220, 255)
            .uumMcfg(0, Phosphorite, 5 * U, Au, 3 * U, SiO2, 1 * U, He, 1 * U)
            .aspects(TC.LUX, 2, TC.SENSUS, 1, TC.GELUM, 1)
            .heat(500, 600)
            .setGenerifying(Glowstone)
            .setLocal("Pluto Glowstone"),
        Gloomstone = glowstone(8456, "Gloomstone", SET_REDSTONE, 19, 250, 255, 255)
            .uumMcfg(0, Phosphorite, 5 * U, Au, 3 * U, SiO2, 1 * U, He, 1 * U)
            .aspects(TC.LUX, 2, TC.SENSUS, 1, TC.SPIRITUS, 1)
            .heat(500, 600)
            .setGenerifying(Glowstone),

        MilkyQuartz = quartz(8445, "Milky Quartz", 210, 210, 210, 255, CRYSTALLISABLE).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1)
            .qual(1, 2.5, 32, 3),
        NetherQuartz = quartz(8346, "Nether Quartz", 230, 210, 210, 255, CRYSTALLISABLE).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1)
            .qual(1, 2.5, 32, 3)
            .setGenerifying(MilkyQuartz),
        VoidQuartz = quartz(8457, "Void Quartz", 183, 120, 212, 255, CRYSTALLISABLE).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.VACUOS, 1)
            .qual(1, 2.5, 48, 3)
            .setGenerifying(NetherQuartz),
        SunnyQuartz = quartz(8393, "Sunny Quartz", 255, 255, 200, 255, CRYSTALLISABLE).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.LUX, 1)
            .qual(1, 2.5, 32, 3)
            .setGenerifying(MilkyQuartz),
        LavenderQuartz = quartz(8394, "Lavender Quartz", 255, 200, 255, 255, CRYSTALLISABLE).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.SENSUS, 1)
            .qual(1, 2.5, 32, 3)
            .setGenerifying(MilkyQuartz),
        RedQuartz = quartz(8395, "Red Quartz", 255, 210, 210, 255, CRYSTALLISABLE).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.MACHINA, 1)
            .qual(1, 2.5, 32, 3)
            .setGenerifying(MilkyQuartz),
        BlazeQuartz = quartz(8396, "Blaze Quartz", 255, 230, 200, 255, CRYSTALLISABLE).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.IGNIS, 1)
            .qual(1, 2.5, 32, 3)
            .setGenerifying(MilkyQuartz),
        SmokeyQuartz = quartz(8397, "Smokey Quartz", 20, 20, 20, 255, CRYSTALLISABLE, "QuartzSmoky", "SmokyQuartz")
            .uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.TENEBRAE, 1)
            .qual(1, 2.5, 32, 3)
            .setGenerifying(MilkyQuartz),
        ManaQuartz = quartz(8398, "Mana Quartz", 210, 210, 255, 255, CRYSTALLISABLE).setMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.PRAECANTIO, 1)
            .qual(1, 2.5, 64, 3)
            .setGenerifying(MilkyQuartz),
        ElvenQuartz = quartz(8399, "Elven Quartz", 210, 255, 210, 255, CRYSTALLISABLE).setMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.ALIENIS, 1)
            .qual(1, 2.5, 64, 3)
            .setGenerifying(MilkyQuartz),
        BlackQuartz = quartz(8374, "QuartzBlack", 20, 20, 20, 255, CRYSTALLISABLE, DECOMPOSABLE, CENTRIFUGE)
            .uumMcfg(1, SiO2, 1 * U, C, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1, TC.TENEBRAE, 1)
            .qual(1, 2.5, 32, 3)
            .setGenerifying(MilkyQuartz)
            .setLocal("Black Quartz"),
        CertusQuartz = quartz(8347, "Certus Quartz", 210, 210, 230, 255, CRYSTALLISABLE).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 1, TC.VITREUS, 1)
            .qual(1, 5.0, 32, 3)
            .setGenerifying(MilkyQuartz),
        ChargedCertusQuartz = quartz(8348, "Charged Certus Quartz", 210, 210, 230, 255, GLOWING).uumMcfg(0, SiO2, 1 * U)
            .aspects(TC.POTENTIA, 2, TC.VITREUS, 1)
            .steal(CertusQuartz)
            .setPulver(CertusQuartz, U)
            .setGenerifying(CertusQuartz),
        ...
        Redstonia = gem_aa(8375, "Redstonia", SET_EMERALD, 255, 0, 0, 127, Redstone)
            .aspects(TC.VITREUS, 2, TC.MACHINA, 2)
            .qual(3, 6.0, 300, 2)
            .setGenerifying(Redstone),
        Palis = gem_aa(8376, "Palis", SET_EMERALD, 0, 0, 255, 127, Lapis).aspects(TC.VITREUS, 2, TC.SENSUS, 2)
            .qual(3, 6.0, 300, 2)
            .setGenerifying(Lapis),
        Diamantine = gem_aa(8377, "Diamantine", SET_DIAMOND, 128, 128, 255, 127, Diamond, VALUABLE)
            .aspects(TC.VITREUS, 2, TC.LUCRUM, 2)
            .qual(3, 10.0, 1600, 4)
            .setGenerifying(Diamond),
        VoidCrystal = gem_aa(8378, "VoidCrystal", SET_RUBY, 10, 10, 10, 127, Coal, TICKS_PER_SMELT * 16)
            .aspects(TC.VITREUS, 2, TC.POTENTIA, 2)
            .qual(3, 6.0, 280, 2)
            .setGenerifying(Coal)
            .setDensity(0.929)
            .setLocal("Void"),
        Emeradic = gem_aa(8379, "Emeradic", SET_EMERALD, 0, 255, 0, 127, Emerald, VALUABLE)
            .aspects(TC.VITREUS, 2, TC.LUCRUM, 2)
            .qual(3, 8.0, 2200, 3)
            .setGenerifying(Emerald),
        Enori = gem_aa(8380, "Enori", SET_NETHERSTAR, 255, 255, 255, 127, Fe).aspects(TC.VITREUS, 2, TC.METALLUM, 2)
            .qual(3, 6.0, 280, 3)
            .setGenerifying(Fe),

        DarkMatter = create(8381, "Dark Matter", SET_RUBY, 40, 20, 40, 255, G_GEM, MAGICAL, UNBURNABLE, VALUABLE)
            .aspects(TC.POTENTIA, 10, TC.TENEBRAE, 10)
            .qual(3, 20.0, 12800, 5),
        RedMatter = create(8382, "Red Matter", SET_RUBY, 255, 0, 0, 255, G_GEM, MAGICAL, UNBURNABLE, VALUABLE)
            .aspects(TC.POTENTIA, 10, TC.LUX, 10)
            .qual(3, 30.0, 25600, 6),

        EnergiumRed = crystalcent(8298, "EnergiumRed", SET_DIAMOND, 255, 0, 0, 255, CRYSTALLISABLE)
            .uumMcfg(0, Sapphire, 4 * U, Redstone, 5 * U)
            .aspects(TC.LUX, 2, TC.POTENTIA, 2)
            .setLocal("Red Energium"),
        EnergiumCyan = crystalcent(8299, "EnergiumCyan", SET_DIAMOND, 0, 255, 255, 255, CRYSTALLISABLE)
            .uumMcfg(0, Sapphire, 4 * U, Nikolite, 5 * U)
            .aspects(TC.LUX, 2, TC.POTENTIA, 4)
            .setLocal("Cyan Energium"),

        InfusedDull = crystal_tc(8350, "Infused Dull", 100, 100, 100, DYE_INDEX_Gray)
            .aspects(TC.PRAECANTIO, 1, TC.VACUOS, 2)
            .qual(3, 32.0, 64, 3),
        InfusedVis = crystal_tc(8351, "Infused Vis", 255, 0, 255, DYE_INDEX_Magenta, GLOWING)
            .aspects(TC.PRAECANTIO, 1, TC.AURAM, 2)
            .qual(3, 8.0, 64, 3),
        InfusedAir = crystal_tc(8352, "Infused Air", 255, 255, 0, DYE_INDEX_Yellow, GLOWING)
            .aspects(TC.PRAECANTIO, 1, TC.AER, 2)
            .qual(3, 8.0, 64, 3),
        InfusedFire = crystal_tc(8353, "Infused Fire", 255, 0, 0, DYE_INDEX_Red, GLOWING)
            .aspects(TC.PRAECANTIO, 1, TC.IGNIS, 2)
            .qual(3, 8.0, 64, 3),
        InfusedEarth = crystal_tc(8354, "Infused Earth", 0, 255, 0, DYE_INDEX_Green, GLOWING)
            .aspects(TC.PRAECANTIO, 1, TC.TERRA, 2)
            .qual(3, 8.0, 256, 3),
        InfusedWater = crystal_tc(8355, "Infused Water", 0, 0, 255, DYE_INDEX_Blue, GLOWING)
            .aspects(TC.PRAECANTIO, 1, TC.AQUA, 2)
            .qual(3, 8.0, 64, 3),
        InfusedEntropy = crystal_tc(8356, "Infused Entropy", 62, 62, 62, DYE_INDEX_Black, GLOWING)
            .aspects(TC.PRAECANTIO, 1, TC.PERDITIO, 2)
            .qual(3, 32.0, 64, 4),
        InfusedOrder = crystal_tc(8357, "Infused Order", 252, 252, 252, DYE_INDEX_White, GLOWING)
            .aspects(TC.PRAECANTIO, 1, TC.ORDO, 2)
            .qual(3, 8.0, 64, 3),
        InfusedBalance = crystal_tc(8358, "Infused Balance", 252, 252, 252, DYE_INDEX_LightGray, GLOWING)
        ...
        Sand = dust(8100, "Sand", SET_SAND, 250, 250, 200, 255, FURNACE, UNRECYCLABLE).aspects(TC.TERRA, 1)
            .stealStatsElement(SiO2)
            .setSmelting(Glass, U)
            .setForging(Glass, U),
        RedSand = dust(8104, "Red Sand", SET_SAND, 170, 86, 35, 255, FURNACE).aspects(TC.METALLUM, 1)
            .stealStatsElement(SiO2)
            .setSmelting(Glass, U)
            .setForging(Glass, U),
        EndSandWhite = dust(8105, "White End Sand", SET_SAND, 230, 250, 250, 255, FURNACE).aspects(TC.ALIENIS, 1)
            .stealStatsElement(SiO2)
            .setSmelting(Glass, U)
            .setForging(Glass, U),
        EndSandBlack = dust(8106, "Black End Sand", SET_SAND, 40, 60, 60, 255, FURNACE).aspects(TC.ALIENIS, 1)
            .stealStatsElement(SiO2)
            .setSmelting(Glass, U)
            .setForging(Glass, U),
        SoulSand = oredust(8101, "Soulsand", SET_SAND, 100, 100, 80, 255).aspects(TC.SPIRITUS, 1, TC.VINCULUM, 1)
            .stealStatsElement(SiO2),
        SluiceSand = dust(8102, "Sluice Sand", SET_SAND, 165, 165, 120, 255).aspects(TC.TERRA, 1, TC.LUCRUM, 1)
            .stealStatsElement(SiO2),
        PlatinumGroupSludge = oredust(8103, "Platinum Group Sludge", SET_SAND, 50, 50, 80, 255)
            .aspects(TC.LIMUS, 2, TC.NEBRISUM, 2)
            .stealStatsElement(Pt)
            .addSourceOf(Ru, Rh, Pd, Os, Ir, Pt),
        RareEarth = oredust(9100, "Rare Earth", SET_FINE, 128, 128, 100, 255).aspects(TC.VITREUS, 2, TC.NEBRISUM, 1)
            .stealStatsElement(Nd)
            .addSourceOf(Nd, Y, La, Ce, Cd, Cs),
        Monazite = elec(
            8338,
            "Monazite",
            SET_REDSTONE,
            ...
            BRITTLE,
            CRYSTALLISABLE,
            BLACKLISTED_SMELTER).setMcfg(0, RareEarth, 1 * U, PO4, 1 * U)
                .aspects(TC.POTENTIA, 1, TC.NEBRISUM, 1)
                .addSourceOf(He), // Wikipedia: (Ce, La, Nd, Th, Sm, Gd)PO4 Monazite also smelt-extract to Helium, it is
        ...
        Stone = stone(8500, "Stone", 205, 205, 205, 255, MELTING, MOLTEN, UNRECYCLABLE).aspects(TC.TERRA, 1)
            .stealStatsElement(SiO2)
            .qual(1, 2.0, 16, 1)
            .heat(1100)
            .setRGBaLiquid(192, 96, 64, 255),
        Gravel = Stone,
        Concrete = stone(8501, "Concrete", SET_BRICK, 100, 100, 100, 255, MELTING).setMcfg(0, Stone, 1 * U)
            .aspects(TC.TERRA, 1)
            .stealStatsElement(SiO2)
            .qual(1, 2.5, 32, 0)
            .heat(500)
            .setSmelting(Stone, U)
            .setGenerifying(Stone),
        Netherrack = stone(8502, "Netherrack", 200, 0, 0, 255, UNBURNABLE, FLAMMABLE, BLACKLISTED_SMELTER)
            .aspects(TC.IGNIS, 1)
            .stealStatsElement(SiO2)
            .qual(1, 2.0, 8, 0)
            .heat(1500, 3000),
        NetherBrick = stone(8503, "Nether Brick", SET_BRICK, 100, 0, 0, 255, UNBURNABLE, "BrickNether")
            .aspects(TC.IGNIS, 1)
            .stealStatsElement(SiO2)
            .qual(1, 2.0, 24, 1)
            .heat(1800, 3000)
            .setPulver(Netherrack, U)
            .setGenerifying(Netherrack),
        Endstone = stone(8504, "Endstone", 217, 222, 158, 255, ENDER_DRAGON_PROOF).aspects(TC.TENEBRAE, 1)
            .stealStatsElement(SiO2)
            .qual(1, 3.0, 16, 1)
            .heat(1200)
            .setGenerifying(EndSandWhite)
            .addSourceOf(He, He_3),
        Obsidian = elec(8214, "Obsidian", SET_STONE, 80, 50, 100, 255, G_STONE, STONE, BRITTLE, MORTAR, UNBURNABLE)
            .setMcfg(64, Mg, 1 * U, Fe, 1 * U, SiO2, 6 * U, O, 4 * U)
            .aspects(TC.TENEBRAE, 1, TC.IGNIS, 2, TC.TERRA, 2)
            .setSmelting(Lava, U)
            .heat(1300, 4000)
            .qual(1, 3.0, 32, 3),
        Bedrock = create(8599, "Bedrock", SET_STONE, 64, 64, 64, 255, G_STONE, STONE, BRITTLE, MELTING, UNBURNABLE)
            .aspects(TC.TERRA, 5)
            .stealStatsElement(Ad)
            .qual(1, 8.0, 2048, 5)
            .heat(4000)
            .setRGBaLiquid(128, 96, 64, 255)
            .addSourceOf(Ad, Atl, RareEarth)
            .setGenerifying(Stone),

        PrismarineLight = stone(
            9219,
            "Prismarine",
            SET_PRISMARINE,
            110,
            ...
            G_GEM_ORES,
            CRYSTAL,
            CRYSTALLISABLE).aspects(TC.TEMPESTAS, 1)
                .qual(1, 4.0, 48, 1)
                .setLocal("Light Prismarine"),
        PrismarineDark = stone(
            9220,
            "PrismarineDark",
            SET_PRISMARINE,
            88,
        ...
        Oilshale = oredustcent(
            ...
            FLAMMABLE,
            TICKS_PER_SMELT * 2,
            "Oilshale").setBurning(Stone, U2)
                .setMcfg(0, CaCO3, 2 * U, MilkyQuartz, 1 * U, Clay, 1 * U)
                .heat(500, 1000)
                .aspects(TC.MORTUUS, 2, TC.LUX, 1)
                .setGenerifying(Stone),

        Petrotheum = mixdust(8245, "Petrotheum", SET_DULL, 86, 76, 82, 255, CONTAINERS, MELTING, MORTAR)
            .setMcfg(18, Clay, 9 * U, Obsidian, 9 * U, Redstone, 9 * U, Basalz, 1 * U)
            .aspects(TC.PRAECANTIO, 2, TC.POTENTIA, 1)
            .heat(400, 2000),
        Aerotheum = dust(8246, "Aerotheum", SET_SHINY, 250, 226, 83, 255, CONTAINERS, MELTING, MORTAR)
            .setMcfg(18, Sand, 9 * U, KNO3, 9 * U, Redstone, 9 * U, Blitz, 1 * U)
        ...
        Pyrotheum = mixdust(
            ...
            MELTING,
            MORTAR,
            TICKS_PER_SMELT * 120).setMcfg(18, Coal, 9 * U, S, 9 * U, Redstone, 9 * U, Blaze, 1 * U)
                .aspects(TC.PRAECANTIO, 2, TC.IGNIS, 1)
                .heat(3800, 6400),
        Cryotheum = dust(8213, "Cryotheum", SET_SHINY, 100, 220, 255, 255, CONTAINERS, MELTING, MORTAR)
            .setMcfg(18, Snow, 2 * U, KNO3, 9 * U, Redstone, 9 * U, Blizz, 1 * U)
        ...
        WroughtIron = metalmachnd(
            ...
            MOLTEN,
            NEVER_FURNACE,
            "WrougtIron").uumAloy(0, Fe, 1 * U)
                .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1)
                .setPulver(Fe, U)
                .steal(Fe)
                .heat(Fe.mMeltingPoint + 200, Fe.mBoilingPoint)
                .setGenerifying(Fe)
                .qual(3, 6.0, 384, 2)
                .setRGBaLiquid(255, 80, 40, 255),
        AnnealedCopper = metalmachnd(
            8640,
            "Annealed Copper",
            SET_COPPER,
            255,
            ...
            WIRES,
            RAILS,
            SOFT).uumAloy(0, Cu, 1 * U)
                .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1)
                .setPulver(Cu, U)
                .steal(Cu)
                .heat(2800, Cu.mBoilingPoint)
                .setGenerifying(Cu),

        Alduorite = setalore(8760, "Alduorite", 159, 180, 180, "Adluorite").steal(Al)
            .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1)
            .qual(3, 5.0, 256, 2)
            .heat(1567),
        Infuscolium = metalore(8761, "Infuscolium", 146, 33, 86).steal(Cu)
            .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 1)
            .qual(3, 5.0, 256, 2)
            .heat(1828),
        Rubracium = metalore(8762, "Rubracium", 151, 45, 45).steal(W)
            .aspects(TC.METALLUM, 2, TC.LUCRUM, 1)
            .qual(3, 5.0, 256, 2)
            .heat(1847),
        Meutoite = metalore(8763, "Meutoite", 95, 82, 105).steal(Ni)
            .aspects(TC.METALLUM, 2, TC.ALIENIS, 1)
            .qual(3, 5.0, 256, 2)
            .heat(1837),
        Lemurite = metalore(8764, "Lemurite", 219, 219, 219).steal(Mg)
            .aspects(TC.METALLUM, 2, TC.MOTUS, 1)
            .qual(3, 5.0, 256, 2)
            .heat(1179),
        Aredrite = metalore(8701, "Aredrite", 255, 255, 0, "Ardaite").steal(Pb)
            .aspects(TC.METALLUM, 2, TC.STRONTIO, 1)
            .qual(3, 6.0, 1440, 3)
            .heat(2240), // Pb19Sb13S35Cl7
        Ceruclase = metalore(8765, "Ceruclase", 140, 189, 208).steal(Sb)
            .aspects(TC.METALLUM, 2, TC.TEMPESTAS, 1)
            .qual(3, 6.0, 1280, 2)
            .heat(1867),
        Oureclase = metalore(8767, "Oureclase", 183, 98, 21).steal(Ni)
            .aspects(TC.METALLUM, 2, TC.AER, 1)
            .qual(3, 6.0, 1920, 3)
            .heat(2789),
        Kalendrite = metalore(8768, "Kalendrite", 170, 91, 189).steal(Pt)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1)
            .qual(3, 5.0, 2560, 3)
            .heat(2679),
        Carmot = metalore(8770, "Carmot", 217, 205, 140, SOFT).steal(Zn)
            .aspects(TC.METALLUM, 2, TC.NEBRISUM, 1)
            .qual(3, 16.0, 128, 1)
            .heat(1178),
        Sanguinite = metalore(8771, "Sanguinite", 185, 0, 0, "Fettelite").steal(Hg)
            .aspects(TC.METALLUM, 2, TC.SANO, 1)
            .qual(3, 3.0, 4480, 4)
            .heat(3104), // Ag16HgAs4S15
        Vyroxeres = metalore(8772, "Vyroxeres", 85, 224, 1).steal(Cu)
            .aspects(TC.METALLUM, 2, TC.VENEMUM, 1)
            .qual(3, 9.0, 768, 3)
            .heat(2348),
        Eximite = metalore(8773, "Eximite", 124, 90, 150).steal(Mn)
            .aspects(TC.METALLUM, 2, TC.ITER, 1)
            .qual(3, 5.0, 2560, 3)
            .heat(2758),
        Ignatius = metalore(8775, "Ignatius", 255, 169, 83).steal(Sn)
            .aspects(TC.METALLUM, 2, TC.IGNIS, 1)
            .qual(3, 12.0, 512, 2)
            .heat(1978),
        DeepIron = metalore(8641, "Deep Iron", 73, 91, 105, MAGNETIC_PASSIVE).steal(Fe)
            .aspects(TC.METALLUM, 2, TC.MAGNETO, 1)
            .qual(3, 6.0, 384, 2)
            .heat(Fe),
        ShadowIron = metalore(8670, "Shadow Iron", 95, 76, 63, MAGNETIC_PASSIVE).steal(Fe)
        ...
        Adamantine = metalore(
            ...
            DECOMPOSABLE,
            WITHER_PROOF,
            ENDER_DRAGON_PROOF).uumMcfg(0, Ad, 3 * U, O, 4 * U)
                .aspects(TC.METALLUM, 5, TC.PRAECANTIO, 5)
                .qual(3, 10.0, 4500, 5)
                .heat(Ad)
                .addSourceOf(Ad),
        Prometheum = metalore(8774, "Prometheum", 90, 129, 86, CENTRIFUGE, DECOMPOSABLE, SOFT)
            .setMcfg(0, Pm, 3 * U, O, 4 * U)
            .aspects(TC.METALLUM, 2, TC.POTENTIA, 1)
            .qual(3, 8.0, 512, 1)
            .heat(Pm),
        Vulcanite = metalore(8776, "Vulcanite", 255, 132, 72, CENTRIFUGE, DECOMPOSABLE).uumMcfg(0, Cu, 1 * U, Te, 1 * U)
            .aspects(TC.METALLUM, 2, TC.VITREUS, 1)
            .qual(3, 5.0, 3840, 3),
        Orichalcum = alloymachore(
            8769,
            "Orichalcum",
            84,
            122,
            ...
            WASHING_MERCURY,
            VALUABLE,
            CENTRIFUGE).setMcfg(4, Cu, 3 * U, Zn, 1 * U, Ma, 2 * U)
                .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 2, TC.PRAECANTIO, 1)
                .qual(3, 4.5, 3456, 3)
                .heat(Cu),
        AstralSilver = slloymachore(
            8676,
            "Astral Silver",
            230,
            230,
            ...
            VALUABLE,
            CENTRIFUGE,
            ENDER_DRAGON_PROOF).setMcfg(2, Ag, 2 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.PRAECANTIO, 1)
                .qual(3, 10.0, 64, 2)
                .heat(Ag)
                .setGenerifying(Ag),
        Midasium = slloymachore(
            8677,
            "Midasium",
            255,
            200,
            ...
            WASHING_MERCURY,
            VALUABLE,
            WITHER_PROOF).setMcfg(2, Au, 2 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.LUCRUM, 2, TC.PRAECANTIO, 1)
                .qual(3, 12.0, 64, 2)
                .heat(Au)
                .setGenerifying(Au),
        Mithril = slloymachore(
            8678,
            "Mithril",
            100,
            140,
            ...
            VALUABLE,
            CENTRIFUGE,
            "Mythril").setMcfg(2, Pt, 2 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.LUCRUM, 3, TC.PRAECANTIO, 1)
                .qual(3, 14.0, 64, 3)
                .heat(Pt)
                .setGenerifying(Pt),
        Celenegil = alloymachore(
            8779,
            "Celenegil",
            148,
            204,
            ...
            WASHING_MERCURY,
            VALUABLE,
            CENTRIFUGE).setAloy(0, Pt, 1 * U, Orichalcum, 1 * U)
                .aspects(TC.METALLUM, 2, TC.NEBRISUM, 1, TC.VITREUS, 1)
                .qual(3, 10.0, 4096, 3),
        ShadowSteel = alloy(8671, "Shadow Steel", 136, 115, 98, MAGNETIC_PASSIVE)
            .setAloy(0, ShadowIron, 1 * U, Lemurite, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TENEBRAE, 1, TC.TELUM, 1)
            .qual(3, 6.0, 768, 2)
            .visDefault(ShadowIron, Lemurite),
        Inolashite = alloy(8777, "Inolashite", 148, 216, 187).setAloy(0, Alduorite, 1 * U, Ceruclase, 1 * U)
            .aspects(TC.METALLUM, 2, TC.AER, 1, TC.AQUA, 1)
            .qual(3, 8.0, 2304, 3)
            .visDefault(Alduorite, Ceruclase),
        Haderoth = alloy(8778, "Haderoth", 119, 52, 30, MAGICAL).setAloy(0, Mithril, 1 * U, Rubracium, 1 * U)
            .aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.PRAECANTIO, 1)
            .qual(3, 10.0, 3200, 3)
            .visDefault(Rubracium),
        Desichalkos = alloy(8781, "Desichalkos", 114, 47, 168).setAloy(0, Eximite, 1 * U, Meutoite, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ITER, 1, TC.ALIENIS, 1)
            .qual(3, 11.0, 4608, 4)
            .visDefault(Eximite, Meutoite),
        Tartarite = alloy(8782, "Tartarite", 255, 118, 60, MAGNETIC_PASSIVE, WITHER_PROOF, ENDER_DRAGON_PROOF)
            .uumAloy(0, Adamantine, 1 * U, Atl, 1 * U)
            .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1, TC.COGNITIO, 1)
            .qual(3, 20.0, 7680, 5),
        Amordrine = alloy(8783, "Amordrine", 169, 141, 177).setAloy(0, Prometheum, 1 * U, Kalendrite, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.POTENTIA, 1)
            .qual(3, 7.0, 3328, 3)
            .visDefault(Prometheum, Kalendrite),

        Electrum = slloymachore(
            8600,
            "Electrum",
            255,
            255,
            ...
            RAILS,
            WASHING_MERCURY,
            WITHER_PROOF).qual(3, 12.0, 64, 2)
                .uumAloy(0, Ag, 1 * U, Au, 1 * U)
                .aspects(TC.METALLUM, 2, TC.LUCRUM, 2),
        SterlingSilver = slloymachine(
            8601,
            "Sterling Silver",
            250,
            220,
            ...
            VALUABLE,
            SOFT,
            ENDER_DRAGON_PROOF).qual(3, 13.0, 128, 2)
                .uumAloy(0, Cu, 1 * U, Ag, 4 * U)
                .aspects(TC.METALLUM, 2, TC.LUCRUM, 2),
        RoseGold = slloymachine(
            8602,
            "Rose Gold",
            255,
            230,
            ...
            SOFT,
            WITHER_PROOF,
            "Tumbaga").qual(3, 14.0, 128, 2)
                .uumAloy(0, Cu, 1 * U, Au, 4 * U)
                .aspects(TC.METALLUM, 2, TC.LUCRUM, 2),
        Angmallen = slloymachine(8603, "Angmallen", 215, 225, 138, MORTAR, MOLTEN, MAGNETIC_PASSIVE)
            .qual(3, 10.0, 128, 2)
            .uumAloy(0, Au, 1 * U, WroughtIron, 1 * U)
            .aspects(TC.METALLUM, 2, TC.LUCRUM, 1),
        InductiveAlloy = slloymachine(8604, "GoldInductive", 255, 150, 75, MORTAR, MAGNETIC_PASSIVE, MOLTEN, SOFT)
            .uumAloy(0, Au, 1 * U, Redstone, 1 * U)
            .aspects(TC.METALLUM, 2, TC.MAGNETO, 1)
            .setLocal("Inductive Alloy"),
        Cd_In_Ag_Alloy = alloymachine(8605, "Cd-In-Ag-Alloy", 100, 100, 128).uumAloy(0, Cd, 1 * U, In, 1 * U, Ag, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TENEBRAE, 1),
        GildedIron = slloymachine(8606, "Gilded Iron", 255, 230, 80, COATED, CENTRIFUGE, MAGNETIC_PASSIVE, WITHER_PROOF)
            .qual(3, 12.0, 256, 2)
            .setMcfg(9, Fe, 9 * U, Au, 1 * U)
            .aspects(TC.METALLUM, 3, TC.LUCRUM, 1)
            .setSmelting(Fe, U)
            .setForging(Fe, U), // from Flaxbeard, obviously not an Alloy, but coated in Gold. This also gives an
                                // example on how to make such things as coated metals.

        Brass = clloymachine(8620, "Brass", 255, 180, 0, FURNACE, SOFT, EXTRUDER_SIMPLE, MORTAR, MOLTEN)
            .qual(2, 7.0, 96, 1)
            .uumAloy(0, Cu, 3 * U, Zn, 1 * U)
            .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1)
            .heat(1160, Cu.mBoilingPoint),
        CobaltBrass = clloymachine(8621, "Cobalt Brass", 180, 180, 160, FURNACE, SOFT, EXTRUDER_SIMPLE, MORTAR, MOLTEN)
            .qual(3, 8.0, 256, 2)
            .uumAloy(0, Brass, 7 * U, Al, 1 * U, Co, 1 * U)
            .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
        AluminiumAlloy = clloymachine(8622, "Aluminium Alloy", 200, 200, 180, CENTRIFUGE)
            .uumMcfg(45, Al, 45 * U, Si, 1 * U)
            .aspects(TC.METALLUM, 2, TC.FABRICO, 1)
            .qual(Al),

        Bronze = clloymachine(8610, "Bronze", 210, 130, 60, RAILS, FURNACE, SOFT, EXTRUDER_SIMPLE, MORTAR, MOLTEN)
            .qual(3, 5.5, 448, 2)
            .uumAloy(0, Cu, 3 * U, Sn, 1 * U)
            .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1)
            .heat(Cu.mMeltingPoint, Cu.mBoilingPoint),
        BlackBronze = clloymachine(8611, "Black Bronze", 100, 50, 125, MORTAR, MOLTEN, SOFT).qual(3, 12.0, 512, 2)
            .uumAloy(0, Cu, 3 * U, Electrum, 2 * U)
            .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1),
        BismuthBronze = clloymachine(
            8612,
            "Bismuth Bronze",
            100,
            125,
            ...
            EXTRUDER_SIMPLE,
            MORTAR,
            MOLTEN).qual(3, 8.0, 512, 2)
                .setAloy(0, Bi, 1 * U, Brass, 4 * U)
                .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1),
        Hepatizon = alloymachine(8613, "Hepatizon", 117, 94, 117, MORTAR, MOLTEN).qual(3, 12.0, 256, 2)
            .uumAloy(0, Au, 1 * U, Bronze, 1 * U)
            .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1),
        ArsenicCopper = clloymachine(
            8614,
            "Arsenic Copper",
            210,
            160,
            ...
            EXTRUDER_SIMPLE,
            MORTAR,
            MOLTEN).qual(3, 5.5, 448, 2)
                .uumAloy(0, Cu, 3 * U, As, 1 * U)
                .aspects(TC.METALLUM, 2, TC.VENEMUM, 1)
                .heat(Cu.mMeltingPoint, Cu.mBoilingPoint),
        ArsenicBronze = clloymachine(
            8615,
            "Arsenic Bronze",
            200,
            200,
            ...
            EXTRUDER_SIMPLE,
            MORTAR,
            MOLTEN).qual(3, 6.0, 480, 2)
                .uumAloy(0, As, 1 * U, Bronze, 4 * U)
                .aspects(TC.METALLUM, 2, TC.VENEMUM, 1)
                .heat(Cu.mMeltingPoint, Cu.mBoilingPoint),

        Steel = alloymachore(8630, "Steel", 130, 130, 130, MOLTEN, RAILS, MORTAR, MAGNETIC_PASSIVE, NEVER_FURNACE)
            .qual(3, 6.0, 512, 2)
            .uumMcfg(0, WroughtIron, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1)
            .heat(2046, Fe.mBoilingPoint, Fe.mPlasmaPoint)
            .setRGBaLiquid(255, 20, 10, 255),
        BlackSteel = alloymachine(8631, "Black Steel", 90, 90, 90, MOLTEN).qual(3, 6.5, 768, 2)
            .uumAloy(0, Ni, 1 * U, BlackBronze, 1 * U, Steel, 3 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1),
        BlueSteel = alloymachine(8632, "Blue Steel", 100, 100, 140, MOLTEN).qual(3, 7.0, 896, 2)
            .setAloy(0, SterlingSilver, 1 * U, BismuthBronze, 1 * U, Steel, 2 * U, BlackSteel, 4 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1),
        RedSteel = alloymachine(8633, "Red Steel", 140, 100, 100, MOLTEN).qual(3, 7.5, 1024, 2)
            .uumAloy(0, RoseGold, 1 * U, Brass, 1 * U, Steel, 2 * U, BlackSteel, 4 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1),
        DamascusSteel = alloymachine(8634, "Damascus Steel", 110, 110, 110, MOLTEN, CENTRIFUGE, MAGNETIC_PASSIVE)
            .qual(3, 8.0, 1280, 2)
            .uumMcfg(50, Steel, 50 * U, V, 1 * U, W, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1, TC.TELUM, 1),
        VanadiumSteel = alloymachine(8653, "VanadiumSteel", 100, 100, 100, MOLTEN, MAGNETIC_PASSIVE)
            .qual(3, 7.0, 512, 3)
            .uumAloy(0, Steel, 4 * U, V, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.INSTRUMENTUM, 1)
            .setLocal("Vanadiumsteel"),
        TungstenSteel = alloymachine(
            8635,
            "Tungstensteel",
            100,
            100,
            ...
            "TungstenSteel",
            "Wolframsteel",
            "WolframSteel").qual(3, 10.0, 5120, 4)
                .uumAloy(0, Steel, 1 * U, W, 1 * U)
                .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.TUTAMEN, 1),
        TungstenCarbide = alloymachine(
            8638,
            "Tungsten Carbide",
            123,
            123,
            ...
            UNBURNABLE,
            "Carbide",
            "WolframCarbide").qual(3, 10.0, 5120, 4)
                .uumAloy(0, W, 1 * U, C, 1 * U)
                .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.TUTAMEN, 1)
                .setDensity(15.6)
                .heat(3070, 6270),
        HSLA = alloymachine(8637, "HSLA-Steel", 210, 210, 255, RAILS, CENTRIFUGE, MORTAR, MAGNETIC_PASSIVE, "HSLA")
            .uumMcfg(2, WroughtIron, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1)
            .steal(Steel)
            .heat(1873, Fe.mBoilingPoint, Fe.mPlasmaPoint)
            .setRGBaLiquid(180, 80, 30, 255),
        SpringSteel = alloymachine(8639, "HSLA-Spring-Steel", 220, 100, 100, CENTRIFUGE, MAGNETIC_PASSIVE)
            .uumMcfg(45, HSLA, 45 * U, Redstone, 2 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1)
            .steal(HSLA)
            .setLocal("Spring Steel"),
        TungstenAlloy = alloymachine(8766, "HSLA-Tungsten-Alloy", 179, 119, 190, CENTRIFUGE, MAGNETIC_PASSIVE)
            .uumMcfg(180, SpringSteel, 180 * U, W, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1)
            .steal(SpringSteel)
            .qual(3, 7.0, 1024, 2)
            .setLocal("Tungsten Alloy"),
        PigIron = metalmachore(8642, "Pig Iron", 200, 180, 180, MOLTEN, MORTAR, MAGNETIC_PASSIVE)
            .uumMcfg(0, WroughtIron, 1 * U)
            .aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1)
            .setPulver(Fe, U)
            .setSmelting(WroughtIron, U)
            .steal(WroughtIron)
            .setGenerifying(Fe)
            .qual(3, 6.0, 384, 2),
        IronCompressed = alloymachnd(
            8644,
            "IronCompressed",
            SET_METALLIC,
            128,
            ...
            CENTRIFUGE,
            MORTAR,
            MAGNETIC_PASSIVE).uumMcfg(0, Fe, 1 * U)
        ...
        IronCast = alloymachnd(8803, "Cast Iron", SET_METALLIC, 64, 64, 64, CENTRIFUGE, MORTAR, MAGNETIC_PASSIVE)
            .uumMcfg(0, Fe, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TERRA, 1)
            .setPulver(Fe, U)
            .steal(Fe)
            .setGenerifying(Fe),
        IronMagnetic = metalmachnd(
            8645,
            "IronMagnetic",
            SET_MAGNETIC,
            200,
            ...
            MORTAR,
            MAGNETIC_ACTIVE,
            AUTO_COLLECTING).uumMcfg(0, Fe, 1 * U)
                .aspects(TC.METALLUM, 2, TC.MAGNETO, 1)
                .setBending(Fe, U)
                .setCompressing(Fe, U)
                .setPulver(Fe, U)
        ...
        SteelMagnetic = metalmachnd(
            ...
            MORTAR,
            MAGNETIC_ACTIVE,
            AUTO_COLLECTING).uumMcfg(0, Steel, 1 * U)
                .aspects(TC.METALLUM, 1, TC.ORDO, 1, TC.MAGNETO, 1)
                .setBending(Steel, U)
                .setCompressing(Steel, U)
                .setPulver(Steel, U)
                .setSmashing(Steel, U)
                .setSmelting(Steel, U)
                .setWorking(Steel, U)
                .setForging(Steel, U)
                .steal(Steel)
                .setGenerifying(Steel)
                .setLocal("Magnetic Steel"),
        NeodymiumMagnetic = metalmachnd(
            8647,
            "NeodymiumMagnetic",
            SET_MAGNETIC,
            100,
            ...
            MORTAR,
            MAGNETIC_ACTIVE,
            AUTO_COLLECTING).uumMcfg(0, Nd, 1 * U)
        ...
        DarkIron = metalmachore(8648, "Dark Iron", SET_DULL, 55, 40, 60, MAGNETIC_PASSIVE, "FzDarkIron", "FZDarkIron")
            .setMcfg(0, Fe, 1 * U)
            .aspects(TC.METALLUM, 2, TC.IGNIS, 1)
            .steal(Fe)
            .qual(3, 7.0, 384, 3)
            .heat(Steel.mMeltingPoint + 200, Fe.mBoilingPoint),
        SteelGalvanized = clloymachine(8651, "SteelGalvanized", 250, 240, 240, COATED, CENTRIFUGE).qual(3, 7.0, 768, 2)
            .setMcfg(9, Steel, 9 * U, Zn, 1 * U)
            .aspects(TC.METALLUM, 3, TC.SANO, 1)
            .setSmelting(Steel, U)
            .setForging(Steel, U)
            .setLocal("Galvanized Steel"),
        TungstenSintered = alloymachnd(8652, "TungstenSintered", SET_METALLIC, 70, 70, 70, RAILS, UNBURNABLE)
            .qual(3, 8.0, 5120, 3)
            .uumMcfg(0, W, 1 * U)
            .aspects(TC.METALLUM, 3, TC.TUTAMEN, 1)
            .steal(W)
            .setAllToTheOutputOf(W)
            .setForging(null, U)
            .setCutting(null, U)
            .setWorking(null, U)
            .setSmashing(null, U)
        ...
        TitaniumGold = alloymachine(8654, "Titanium-Gold", 222, 222, 255, MOLTEN).qual(3, 12.0, 5120, 4)
            .uumAloy(0, Ti, 3 * U, Au, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 3, TC.LUCRUM, 1),
        Ta4HfC5 = alloymachine(8802, "Tantalum Hafnium Carbide", 32, 128, 32, UNBURNABLE)
            .uumAloy(0, Ta, 4 * U, Hf, 1 * U, C, 5 * U)
        ...
        MeteoricIron = metalmachore(
            ...
            AUTO_COLLECTING,
            RAILS,
            DECOMPOSABLE).uumMcfg(0, Fe, 1 * U)
                .aspects(TC.METALLUM, 2, TC.MAGNETO, 1)
                .steal(WroughtIron)
                .qual(3, 7.0, 896, 2)
                .heat(Fe.mMeltingPoint + 200, Fe.mBoilingPoint + 200)
                .setGenerifying(Fe),
        MeteoricSteel = alloymachine(
            ...
            MAGNETIC_ACTIVE,
            AUTO_COLLECTING,
            RAILS).uumMcfg(0, MeteoricIron, 1 * U)
                .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1)
                .steal(Steel)
                .qual(3, 8.0, 1280, 2)
                .heat(Steel.mMeltingPoint + 200, Steel.mBoilingPoint + 200)
                .setGenerifying(Steel),
        MeteoricBlackSteel = alloymachine(
            8690,
            "Meteoric Black Steel",
            85,
            85,
            85,
            MOLTEN,
            MAGNETIC_ACTIVE,
            AUTO_COLLECTING).qual(3, 8.0, 1280, 2)
                .uumAloy(0, Ni, 1 * U, BlackBronze, 1 * U, MeteoricSteel, 3 * U)
                .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1)
                .setGenerifying(BlackSteel),
        MeteoricBlueSteel = alloymachine(
            8691,
            "Meteoric Blue Steel",
            95,
            95,
            ...
            MOLTEN,
            MAGNETIC_ACTIVE,
            AUTO_COLLECTING).qual(3, 8.5, 1408, 2)
                .setAloy(
                    0,
                    SterlingSilver,
                    1 * U,
                    ...
                    4 * U)
                .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1)
                .setGenerifying(BlueSteel),
        MeteoricRedSteel = alloymachine(
            8692,
            "Meteoric Red Steel",
            135,
            95,
            ...
            MOLTEN,
            MAGNETIC_ACTIVE,
            AUTO_COLLECTING).qual(3, 9.0, 1536, 2)
                .uumAloy(0, RoseGold, 1 * U, Brass, 1 * U, MeteoricSteel, 2 * U, MeteoricBlackSteel, 4 * U)
                .aspects(TC.METALLUM, 2, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1)
                .setGenerifying(RedSteel),

        RedAlloy = clloy(8660, "Red Alloy", 200, 0, 0, MORTAR, WIRES, FURNACE, SOFT, EXTRUDER_SIMPLE, MOLTEN)
            .uumAloy(1, Cu, 1 * U, Redstone, 4 * U)
            .aspects(TC.MACHINA, 3)
            .stealStatsElement(Cu)
            .heat(1400, Cu.mBoilingPoint),
        BlueAlloy = clloy(8659, "Blue Alloy", 100, 180, 255, MORTAR, WIRES, FURNACE, SOFT, EXTRUDER_SIMPLE, MOLTEN)
            .uumAloy(1, Ag, 1 * U, Nikolite, 4 * U)
            .aspects(TC.ELECTRUM, 3)
            .stealStatsElement(Ag)
            .heat(1400, Ag.mBoilingPoint),
        PurpleAlloy = clloy(8657, "Purple Alloy", 255, 120, 255, MORTAR, WIRES, FURNACE, SOFT, EXTRUDER_SIMPLE, MOLTEN)
            .uumAloy(1, RedAlloy, 1 * U, BlueAlloy, 1 * U)
            .aspects(TC.MACHINA, 3, TC.ELECTRUM, 3)
            .heat(1400, Ag.mBoilingPoint),
        Mingrade = clloy(8804, "Mingrade", 255, 80, 20, MORTAR, WIRES, FURNACE, SOFT, EXTRUDER_SIMPLE)
            .uumMcfg(0, Cu, 1 * U, Redstone, 1 * U)
            .aspects(TC.MACHINA, 2)
            .heat(1400, Cu.mBoilingPoint)
            .setLocal("Red Copper"),
        RedstoneAlloy = clloy(8733, "Redstone Alloy", 140, 50, 50, MOLTEN).uumAloy(1, Si, 1 * U, Redstone, 1 * U)
            .aspects(TC.METALLUM, 3, TC.MACHINA, 1)
            .stealStatsElement(Si)
            .setPriorityPrefix(5),
        NikolineAlloy = clloy(8737, "Nikoline Alloy", 50, 90, 140, MOLTEN, "TeslatineAlloy")
            .uumAloy(1, Si, 1 * U, Nikolite, 1 * U)
            .aspects(TC.METALLUM, 3, TC.POTENTIA, 1)
            .stealStatsElement(Si)
            .setPriorityPrefix(5),
        ElectrotineAlloy = clloy(
            8658,
            "Electrotine Alloy",
            100,
            180,
            ...
            MOLTEN,
            FURNACE,
            EXTRUDER_SIMPLE).uumAloy(1, WroughtIron, 1 * U, Nikolite, 8 * U)
                .aspects(TC.ELECTRUM, 3)
                .stealStatsElement(Fe)
                .heat(1400, Fe.mBoilingPoint),
        ElectrumFlux = slloy(8711, "Electrum Flux", 255, 255, 120, SOFT).qual(3, 14.0, 64, 2)
            .uumAloy(1, Electrum, 1 * U, Redstone, 2 * U)
            .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 2)
            .stealStatsElement(Electrum),
        ConductiveIron = alloy(8727, "Conductive Iron", 170, 140, 140, MAGNETIC_PASSIVE).qual(WroughtIron)
            .uumAloy(1, WroughtIron, 1 * U, Redstone, 1 * U)
            .aspects(TC.METALLUM, 3, TC.POTENTIA, 1)
            .stealStatsElement(Fe),
        EnergeticSilver = alloy(8808, "Energetic Silver", 93, 126, 151, SOFT)
            .uumAloy(1, Ag, 1 * U, Redstone, 1 * U, Glowstone, 1 * U)
            .aspects(TC.METALLUM, 2, TC.POTENTIA, 1)
            .stealStatsElement(Ag),
        Invar = alloymachine(8661, "Invar", 220, 220, 150, MORTAR, MAGNETIC_PASSIVE, MOLTEN).qual(3, 6.0, 256, 2)
            .uumAloy(0, WroughtIron, 2 * U, Ni, 1 * U)
            .aspects(TC.METALLUM, 2, TC.GELUM, 1),
        Constantan = clloymachine(8662, "Constantan", 150, 100, 85, MORTAR, MAGNETIC_PASSIVE, MOLTEN, "Cupronickel")
            .qual(3, 6.0, 64, 1)
            .uumAloy(0, Cu, 1 * U, Ni, 1 * U),
        Cupronickel = Constantan, Nichrome = alloymachine(8663, "Nichrome", 205, 206, 246, MOLTEN).qual(3, 6.0, 64, 2)
            .uumAloy(0, Ni, 4 * U, Cr, 1 * U),
        Kanthal = alloymachine(8664, "Kanthal", 194, 210, 223, MOLTEN).qual(3, 6.0, 64, 2)
            .uumAloy(0, WroughtIron, 1 * U, Al, 1 * U, Cr, 1 * U),
        Magnalium = alloymachine(8665, "Magnalium", SET_DULL, 200, 190, 255, MOLTEN, FURNACE, EXTRUDER_SIMPLE, RAILS)
            .qual(3, 6.0, 256, 2)
            .uumAloy(0, Mg, 1 * U, Al, 2 * U),
        StainlessSteel = slloymachine(8636, "Stainless Steel", 200, 200, 220, MOLTEN, RAILS).qual(3, 7.0, 480, 2)
            .uumAloy(0, WroughtIron, 4 * U, Invar, 3 * U, Cr, 1 * U, Mn, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ORDO, 1, TC.VITREUS, 1),
        Ultimet = slloymachine(8666, "Ultimet", 180, 180, 230, MOLTEN).qual(3, 8.0, 1024, 3)
            .uumAloy(0, Co, 5 * U, Ni, 1 * U, Cr, 2 * U, Mo, 1 * U), // 54% Co, 26% Cr, 9% Ni, 5% Mo, 3% Fe, 2% W, 0.8%
        ...
        TinAlloy = clloymachine(8667, "Tin Alloy", 200, 200, 200, MORTAR, MOLTEN, FURNACE, EXTRUDER_SIMPLE, SOFT)
            .qual(3, 6.5, 96, 2)
            .uumAloy(0, Sn, 1 * U, WroughtIron, 1 * U)
            .aspects(TC.METALLUM, 2, TC.FABRICO, 1),
        BatteryAlloy = alloy(
            8668,
            "Battery Alloy",
            ...
            FURNACE,
            EXTRUDER_SIMPLE,
            SOFT).uumAloy(0, Pb, 4 * U, Sb, 1 * U),
        SolderingAlloy = clloy(
            8669,
            "Soldering Alloy",
            220,
            220,
            ...
            FURNACE,
            WIRES).uumAloy(0, Sn, 9 * U, Sb, 1 * U),
        IronWood = alloymachine(
            8672,
            "Ironwood",
            SET_WOOD,
            150,
            ...
            MAGNETIC_PASSIVE,
            MOLTEN,
            "IronWood").qual(2, 6.5, 512, 2)
                .setAloy(18, WroughtIron, 8 * U, LiveRoot, 9 * U, Angmallen, 2 * U)
                .aspects(TC.METALLUM, 2, TC.ARBOR, 1, TC.PRAECANTIO, 1),
        Steeleaf = alloymachine(
            8673,
            "Steeleaf",
            SET_LEAF,
            50,
            ...
            MORTAR,
            AUTO_COLLECTING,
            SOFT).qual(2, 8.0, 144, 3)
                .setMcfg(1, Steel, 1 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.HERBA, 1, TC.PRAECANTIO, 1)
                .setSmelting(Steel, U4),
        Knightmetal = alloymachine(
            8674,
            "Knightmetal",
            210,
            240,
            ...
            MOLTEN,
            MORTAR,
            "KnightMetal").qual(3, 8.0, 512, 3)
                .setMcfg(2, Steel, 2 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.TELUM, 1, TC.PRAECANTIO, 1)
                .heat(Steel.mMeltingPoint + 100, Steel.mBoilingPoint + 100)
                .setGenerifying(Steel),
        FierySteel = alloymachine(
            8675,
            "Fiery Steel",
            SET_FIERY,
            64,
            ...
            BURNING,
            GLOWING,
            "Fiery").qual(3, 9.0, 1024, 4)
                .setMcfg(1, Steel, 1 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1)
                .heat(Steel.mBoilingPoint - 200, Steel.mBoilingPoint + 500)
                .setGenerifying(Steel),
        Fireleaf = alloymachine(
            8698,
            "Fireleaf",
            SET_LEAF,
            127,
            ...
            GLOWING,
            AUTO_COLLECTING,
            SOFT).qual(2, 12.0, 288, 4)
                .setMcfg(1, Steel, 1 * U, Ma, 2 * U)
                .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.HERBA, 1)
                .setSmelting(FierySteel, U4)
                .heat(Steel.mBoilingPoint - 200, Steel.mBoilingPoint + 500)
                .setGenerifying(Steel)
                .setGenerifying(Steeleaf),
        MeteoflameSteel = alloymachine(
            8693,
            "Meteoflame Steel",
            SET_FIERY,
            130,
            ...
            BURNING,
            GLOWING,
            AUTO_COLLECTING).qual(3, 12.0, 1280, 4)
                .setMcfg(1, MeteoricSteel, 1 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.MAGNETO, 1, TC.ORDO, 1)
                .heat(MeteoricSteel.mBoilingPoint - 200, MeteoricSteel.mBoilingPoint + 500)
                .setGenerifying(MeteoricSteel),
        MeteoflameBlackSteel = alloymachine(
            8694,
            ...
            GLOWING,
            AUTO_COLLECTING).qual(3, 12.0, 1280, 4)
                .setMcfg(1, MeteoricBlackSteel, 1 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1)
                .heat(MeteoricBlackSteel.mBoilingPoint - 200, MeteoricBlackSteel.mBoilingPoint + 500)
                .setGenerifying(MeteoricBlackSteel),
        MeteoflameBlueSteel = alloymachine(
            8695,
            ...
            BURNING,
            GLOWING,
            AUTO_COLLECTING).qual(3, 13.0, 1408, 4)
                .setMcfg(1, MeteoricBlueSteel, 1 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1)
                .heat(MeteoricBlueSteel.mBoilingPoint - 200, MeteoricBlueSteel.mBoilingPoint + 500)
                .setGenerifying(MeteoricBlueSteel),
        MeteoflameRedSteel = alloymachine(
            8696,
            ...
            BURNING,
            GLOWING,
            AUTO_COLLECTING).qual(3, 14.0, 1536, 4)
                .setMcfg(1, MeteoricRedSteel, 1 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.MAGNETO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1)
                .heat(MeteoricRedSteel.mBoilingPoint - 200, MeteoricRedSteel.mBoilingPoint + 500)
                .setGenerifying(MeteoricRedSteel),
        FlamascusSteel = alloymachine(
            8697,
            "Flamascus Steel",
            SET_FIERY,
            110,
            ...
            UNBURNABLE,
            BURNING,
            GLOWING).qual(3, 12.0, 1280, 4)
                .setMcfg(1, DamascusSteel, 1 * U, Ma, 1 * U)
                .aspects(TC.METALLUM, 2, TC.IGNIS, 3, TC.PRAECANTIO, 1, TC.ORDO, 1, TC.INSTRUMENTUM, 1, TC.TELUM, 1)
                .heat(DamascusSteel.mBoilingPoint - 200, DamascusSteel.mBoilingPoint + 500)
                .setGenerifying(DamascusSteel),
        Thaumium = alloymachore(8679, "Thaumium", 150, 100, 200, MAGICAL, CENTRIFUGE, MAGNETIC_PASSIVE, MOLTEN)
            .qual(3, 12.0, 256, 3)
            .setMcfg(1, Fe, 1 * U, Ma, 1 * U)
            .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 1)
            .heat(Fe.mMeltingPoint + 500, Fe.mBoilingPoint + 1000)
            .setGenerifying(Fe),
        DarkThaumium = alloymachine(
            8680,
            "Dark Thaumium",
            100,
            75,
            ...
            MAGNETIC_PASSIVE,
            MOLTEN,
            WARPING).qual(3, 12.0, 512, 3)
                .aspects(TC.METALLUM, 2, TC.TENEBRAE, 1)
                .heat(Thaumium)
                .setGenerifying(Thaumium),
        VoidMetal = alloymachine(8681, "Void Metal", 30, 10, 30, MAGICAL, CENTRIFUGE, "Void", MOLTEN, WARPING)
            .qual(3, 12.0, 2048, 4)
            .aspects(TC.METALLUM, 7, TC.TENEBRAE, 8, TC.VACUOS, 8, TC.ALIENIS, 2, TC.HERBA, 1)
            .heat(3000, 5000),
        Osmiridium = alloymachine(8682, "Osmiridium", 100, 100, 255, VALUABLE, MOLTEN).qual(3, 11.0, 3840, 4)
            .uumAloy(0, Os, 1 * U, Ir, 1 * U)
            .aspects(TC.METALLUM, 2, TC.MACHINA, 2, TC.NEBRISUM, 1),
        Sunnarium = slloymachine(8683, "Sunnarium", 255, 255, 0, GLOWING, LIGHTING),
        ChromiumDioxide = alloy(8685, "Chromium Dioxide", SET_DULL, 10, 20, 10, ELECTROLYSER, MAGNETIC_PASSIVE)
            .uumMcfg(1, Cr, 1 * U, O, 2 * U)
            .aspects(TC.METALLUM, 2, TC.FABRICO, 1)
            .qual(3, 11.0, 256, 3)
            .heat(650),
        CrO2 = ChromiumDioxide,
        VanadiumGallium = slloy(8686, "Vanadium-Gallium", 128, 128, 140, BRITTLE).uumAloy(0, V, 3 * U, Ga, 1 * U),
        YttriumBariumCuprate = alloy(8687, "Yttrium-Barium-Cuprate", 80, 64, 70, BRITTLE, ELECTROLYSER, LAYERED)
            .uumMcfg(6, Y, 1 * U, Ba, 2 * U, Cu, 3 * U, O, 7 * U)
            .heat(1200),
        NiobiumNitride = alloy(8688, "Niobium Nitride", SET_DULL, 29, 41, 29, BRITTLE, ELECTROLYSER)
            .uumMcfg(0, Nb, 1 * U, N, 1 * U)
            .heat(2573), // Anti-Reflective Material
        NiobiumTitanium = alloy(8689, "Niobium Titanium", SET_DULL, 29, 29, 41, BRITTLE)
            .uumAloy(0, Nb, 1 * U, Ti, 1 * U),
        AluminiumBrass = clloymachine(
            8700,
            "Aluminium Brass",
            220,
            220,
            ...
            MORTAR,
            MOLTEN,
            "AluminumBrass").qual(2, 6.0, 64, 2)
                .uumAloy(0, Al, 3 * U, Cu, 1 * U)
                .aspects(TC.STRONTIO, 1),
        Ardite = cetalore(8707, "Ardite", 200, 120, 20, MOLTEN).qual(2, 6.0, 64, 3)
            .aspects(TC.STRONTIO, 1),
        Alumite = clloymachine(8702, "Alumite", 230, 100, 230, MOLTEN).qual(2, 1.5, 64, 3)
            .setAloy(9, Al2O3, 5 * U, WroughtIron, 2 * U, Obsidian, 18 * U)
            .aspects(TC.STRONTIO, 2),
        Manyullyn = clloymachine(8703, "Manyullyn", 175, 100, 175, MOLTEN).qual(2, 2.0, 96, 3)
            .setAloy(0, Co, 1 * U, Ardite, 1 * U)
            .aspects(TC.STRONTIO, 2),
        VibraniumSteel = slloymachine(8704, "Vibranium Steel", 40, 24, 50, CENTRIFUGE, UNBURNABLE, MAGNETIC_PASSIVE)
            .qual(3, 50.0, 2048, 10)
            .uumAloy(0, Vb, 1 * U, Steel, 3 * U)
            .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.METALLUM, 1),
        VibraniumSilver = slloy(8705, "Vibranium Silver", 240, 240, 255, CENTRIFUGE, UNBURNABLE, ENDER_DRAGON_PROOF)
            .qual(3, 100.0, 512, 9)
            .uumAloy(0, Vb, 1 * U, Ag, 3 * U)
            .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.LUCRUM, 1),
        Vibramantium = slloymachine(8706, "Vibramantium", 250, 250, 250, CENTRIFUGE, UNBURNABLE, MAGNETIC_PASSIVE)
            .qual(3, 1000.0, 5120, 15)
            .uumAloy(0, Vb, 1 * U, Ad, 3 * U)
            .aspects(TC.SENSUS, 1, TC.VITREUS, 1, TC.PRAECANTIO, 1, TC.METALLUM, 1),
        Signalum = clloymachine(8708, "Signalum", 255, 64, 0, MOLTEN, FURNACE, EXTRUDER_SIMPLE, SOFT)
            .uumAloy(8, Cu, 1 * U, Ag, 2 * U, RedAlloy, 5 * U)
            .aspects(TC.METALLUM, 3, TC.POTENTIA, 1),
        Lumium = clloymachine(8709, "Lumium", 255, 255, 80, MOLTEN, FURNACE, EXTRUDER_SIMPLE, SOFT, LIGHTING, GLOWING)
            .uumAloy(4, Sn, 3 * U, Ag, 1 * U, Glowstone, 4 * U)
            .aspects(TC.METALLUM, 3, TC.LUX, 1),
        EnderiumBase = clloymachine(8729, "Enderium Base", 53, 85, 108, MOLTEN)
            .uumAloy(4, Sn, 2 * U, Ag, 1 * U, Pt, 1 * U)
            .aspects(TC.METALLUM, 3),
        Enderium = clloymachine(8710, "Enderium", 60, 125, 115, MAGICAL, MOLTEN).qual(3, 8.0, 256, 3)
            .setAloy(1, EnderiumBase, 1 * U, EnderPearl, 1 * U)
            .aspects(TC.METALLUM, 3, TC.ALIENIS, 1),
        // InfusedGold = slloymachore ( 8712, "Infused Gold" , 255, 200, 60 , SOFT).qual(2, 12.0, 64, 3) ,
        RefinedGlowstone = alloynd(8713, "GlowstoneRefined", SET_REDSTONE, 255, 240, 100, GLOWING)
            .setLocal("Refined Glowstone")
            .qual(2, 8.0, 256, 2)
            .setMcfg(1, Glowstone, 1 * U, Ge, 1 * U)
            .aspects(TC.METALLUM, 4, TC.LUX, 4)
            .setAllToTheOutputOf(Glowstone),
        RefinedObsidian = alloy(8714, "ObsidianRefined", SET_REDSTONE, 120, 90, 140).setLocal("Refined Obsidian")
            .qual(2, 8.0, 512, 3)
            .setMcfg(1, Obsidian, 1 * U, Diamond, 1 * U)
            .aspects(TC.VITREUS, 4, TC.IGNIS, 4)
            .setAllToTheOutputOf(Obsidian),
        ...
        Yellorite = oredustelec(8724, "Yellorite", SET_METALLIC, 150, 140, 40, 255, BLACKLISTED_SMELTER)
            .setSmelting(Yellorium, U3)
            .setMcfg(1, Yellorium, 1 * U, O, 2 * U)
            .aspects(TC.RADIO, 1),
        Bedrock_HSLA_Alloy = alloy(8718, "Bedrock-HSLA-Alloy", SET_BRICK, 64, 64, 64, CENTRIFUGE, MAGNETIC_PASSIVE)
            .setMcfg(1, Bedrock, 4 * U, HSLA, 1 * U)
            .aspects(TC.TERRA, 5)
            .qual(3, 10.0, 2560, 5)
            .heat(4000),
        ...
        ObsidianSteel = alloy(
            ...
            "DarkSteel",
            MD.TG).qual(Steel)
                .setAloy(1, Steel, 1 * U, Obsidian, 9 * U)
                .aspects(TC.METALLUM, 3, TC.TENEBRAE, 1),
        PulsatingIron = alloy(8725, "Pulsating Iron", 100, 160, 110, MAGNETIC_PASSIVE, "PhasedIron").qual(WroughtIron)
            .setAloy(1, WroughtIron, 1 * U, EnderPearl, 1 * U)
            .aspects(TC.METALLUM, 3, TC.ALIENIS, 1),
        EnergeticAlloy = alloy(8728, "Energetic Alloy", SET_DULL, 200, 120, 50).qual(Au)
            .uumAloy(1, InductiveAlloy, 2 * U, Glowstone, 1 * U)
            .aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.LUX, 1),
        VibrantAlloy = slloy(8726, "Vibrant Alloy", 160, 170, 70, "PhasedGold", "Vibrant").qual(EnergeticAlloy)
            .setAloy(1, EnergeticAlloy, 1 * U, EnderPearl, 1 * U)
            .aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.LUX, 1, TC.ALIENIS, 1),
        ElectricalSteel = alloy(8730, "Electrical Steel", 140, 140, 140, MAGNETIC_PASSIVE).qual(Steel)
            .uumAloy(1, Steel, 1 * U, Si, 1 * U)
            .aspects(TC.METALLUM, 3, TC.ELECTRUM, 1),
        Soularium = alloy(8732, "Soularium", SET_DULL, 90, 70, 50).qual(3, 15.0, 128, 2)
            .setAloy(1, SoulSand, 9 * U, Au, 1 * U)
            .aspects(TC.METALLUM, 3, TC.SPIRITUS, 1),
        CrudeSteel = alloy(8806, "Clay Compound", SET_BRICK, 132, 127, 123, "CrudeSteel")
            .setAloy(1, Stone, 2 * U, Ceramic, 1 * U)
            .aspects(TC.TERRA, 4),
        EndSteel = alloy(8807, "End Steel", 164, 157, 116)
            .setAloy(1, Endstone, 1 * U, ObsidianSteel, 1 * U, Obsidian, 9 * U)
            .aspects(TC.METALLUM, 2, TC.ALIENIS, 1),
        MelodicAlloy = alloy(8809, "Melodic Alloy", 138, 92, 138).setAloy(1, EndSteel, 1 * U, EnderEye, 1 * U)
            .aspects(TC.METALLUM, 2, TC.SENSUS, 1),
        StellarAlloy = alloy(8810, "Stellar Alloy", 170, 181, 164)
            .setAloy(2, MelodicAlloy, 1 * U, NetherStar, 1 * U, Clay, 4 * U)
        ...
        SpectreIron = clloymachine_(
            ...
            MAGICAL,
            MOLTEN,
            GLOWING).qual(3, 8.5, 768, 2)
                .setAloy(1, WroughtIron, 1 * U, Ectoplasm, 1 * U)
                .aspects(TC.METALLUM, 3, TC.SPIRITUS, 3)
                .heat(Fe)
                .setGenerifying(Fe),
        Manasteel = slloymachine(8720, "Manasteel", 110, 200, 250, MAGICAL).setMcfg(1, Fe, 1 * U, Ma, 1 * U)
            .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2)
            .steal(Steel)
            .qual(3, 12.0, 256, 3)
            .heat(Fe.mMeltingPoint + 500, Fe.mBoilingPoint + 1000)
            .setGenerifying(Fe),
        Terrasteel = slloymachine(8721, "Terrasteel", 110, 200, 50, MAGICAL, UNBURNABLE)
            .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2)
            .steal(Steel)
            .qual(3, 16.0, 2048, 4)
            .heat(Fe.mMeltingPoint + 750, Fe.mBoilingPoint + 1500),
        ElvenElementium = slloymachore(8722, "Elven Elementium", 250, 120, 250, MAGICAL, UNBURNABLE, "Elementium")
            .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 2)
            .steal(Steel)
            .qual(3, 14.0, 512, 3)
            .heat(Fe.mMeltingPoint + 1000, Fe.mBoilingPoint + 2000)
            .setLocal("Elementium"),
        GaiaSpirit = slloymachine(8735, "Gaia Spirit", 250, 250, 250, MAGICAL, UNBURNABLE, GLOWING)
            .qual(3, 20.0, 2048, 4)
            .aspects(TC.AURAM, 4, TC.SPIRITUS, 4, TC.PRAECANTIO, 4)
            .heat(W.mMeltingPoint + 250, W.mBoilingPoint + 500),
        Endium = metalore(8736, "Endium", SET_SHINY, 169, 215, 254, MAGICAL, "HeeEndium").qual(3, 12.0, 256, 3)
            .aspects(TC.METALLUM, 1, TC.ALIENIS, 3),
        Mauftrium = slloymachore(8739, "Mauftrium", 250, 225, 121, MAGICAL).qual(3, 12.0, 1024, 3)
            .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 1)
            .heat(Fe.mMeltingPoint, Fe.mBoilingPoint),
        Elvorium = slloymachore(8740, "Elvorium", 235, 164, 77, MAGICAL).qual(3, 14.0, 2048, 3)
            .setMcfg(1, ElvenElementium, 1 * U, ElvenDragonstone, 1 * U)
            .aspects(TC.METALLUM, 2, TC.PRAECANTIO, 4)
            .heat(Fe.mMeltingPoint + 1000, Fe.mBoilingPoint + 2000),
        NiflheimPower = slloy(8741, "Niflheim Power", 94, 94, 174, MAGICAL, GLOWING, UNBURNABLE).qual(3, 18.0, 2048, 3)
            .setMcfg(1, Elvorium, 1 * U)
            .aspects(TC.METALLUM, 2, TC.GELUM, 2, TC.POTENTIA, 2),
        MuspelheimPower = slloy(8742, "Muspelheim Power", 174, 94, 94, MAGICAL, GLOWING, UNBURNABLE, BURNING)
            .qual(3, 18.0, 2048, 3)
            .setMcfg(1, Elvorium, 1 * U)
        ...
        AncientDebris = metalore(
            ...
            MOLTEN,
            VALUABLE,
            WASHING_MERCURY).qual(0, 1.0, 16, 3)
                .aspects(TC.METALLUM, 2, TC.ALIENIS, 2)
                .heat(MeteoricIron),
        Netherite = alloymachine(
            8745,
            "Netherite",
            80,
            70,
            ...
            MOLTEN,
            VALUABLE,
            AUTO_COLLECTING).qual(2, 10.0, 500, 4)
                .setAloy(1, Au, 4 * U, AncientDebris, 4 * U)
                .aspects(TC.METALLUM, 2, TC.ALIENIS, 2, TC.LUCRUM, 2)
                .heat(MeteoricSteel),
        NetherizedDiamond = alloymachine(
            8746,
            "Netherized Diamond",
            SET_DIAMOND,
            90,
            ...
            COATED,
            VALUABLE,
            AUTO_COLLECTING).qual(3, 12.0, 2560, 4)
                .setMcfg(4, Netherite, 1 * U, Diamond, 4 * U)
        ...
        Efrine = metalore(
            ...
            WITHER_PROOF,
            MOLTEN,
            WASHING_MERCURY).qual(3, 9.0, 500, 3)
                .aspects(TC.METALLUM, 2, TC.GELUM, 2)
                .heat(MeteoricSteel),

        Desh = alloymachore(8750, "Desh", SET_DULL, 40, 40, 40, MOLTEN).qual(3, 4.0, 1280, 3)
            .uumAloy(0, B, 2 * U, La, 2 * U, Nd, 1 * U, Nb, 1 * U, Co, 1 * U, Ce, 1 * U, Li, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ALIENIS, 1, TC.TELUM, 1),
        DeshAlloy = alloymachine(8780, "Workers Alloy", 216, 42, 42, MOLTEN).qual(3, 7.0, 2560, 2)
            .uumMcfg(4, Desh, 4 * U, Hg, 1 * U)
            .aspects(TC.METALLUM, 2, TC.ALIENIS, 1, TC.TELUM, 1),
        DuraniumAlloy = alloymachine(8751, "Duranium", 75, 175, 175).qual(3, 8.0, 1280, 4)
            .uumAloy(0, Dn, 7 * U, Mg, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2)
            .setLocal("Duranium Alloy"), // That Info with Magnesium/Magnesite was pretty hard to find, but I found it!
        TritaniumAlloy = alloymachine(8752, "Tritanium", 55, 155, 155).qual(3, 12.0, 2560, 5)
            .uumAloy(0, Tn, 3 * U, Dn, 1 * U)
        ...
        Adamantite = metalmachore(8755, "Adamantite", 255, 255, 190).qual(3, 6.0, 2560, 3)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2),
        Duralumin = alloymachine(8756, "Duralumin", SET_DULL, 255, 255, 220).qual(3, 10.0, 512, 2)
            .uumMcfg(0, Al, 1 * U, Cu, 1 * U)
            .aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1, TC.VOLATUS, 1),
        Meteorite = metalmachore(
            8757,
            "Meteorite",
            SET_SPACE,
            222,
            ...
            DECOMPOSABLE).uumMcfg(0, Fe, 1 * U)
                ...
                .qual(3, 8.0, 1200, 3)
                .setGenerifying(Fe),
        FrozenIron = metalmachore(8758, "Frozen Iron", SET_DULL, 235, 235, 255, DECOMPOSABLE, MAGNETIC_PASSIVE)
            .uumMcfg(0, Fe, 1 * U)
            .aspects(TC.METALLUM, 2, TC.GELUM, 2)
            .steal(Fe)
            .setSmelting(Fe, U)
            .setForging(Fe, U),
        Kreknorite = metalmachore(8759, "Kreknorite", SET_SPACE, 128, 0, 0, MOLTEN, TICKS_PER_SMELT * 18)
            .aspects(TC.METALLUM, 2, TC.IGNIS, 2)
            .qual(3, 8.0, 1200, 3)
            .heat(MeteoricSteel.mMeltingPoint + 200, MeteoricSteel.mBoilingPoint + 200),
        Syrmorite = metalmachore(8785, "Syrmorite", SET_DULL, 80, 80, 199, MOLTEN, SOFT)
            .aspects(TC.METALLUM, 2, TC.MORTUUS, 1)
            .qual(2, 6.0, 500, 1)
            .heat(Au),
        Octine = metalmachore(8786, "Octine", 255, 128, 32, MOLTEN, MAGICAL, GLOWING, UNBURNABLE, BURNING)
            .aspects(TC.METALLUM, 2, TC.MORTUUS, 1)
            .qual(3, 8.0, 900, 2)
            .heat(Steel.mBoilingPoint - 200, Steel.mBoilingPoint + 500),

        HSSG = alloymachine(8796, "HSS-G", 153, 153, 0, RAILS, MOLTEN, UNBURNABLE).qual(3, 10.0, 4000, 3)
            .uumAloy(0, TungstenSteel, 5 * U, Cr, 1 * U, Mo, 2 * U, V, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.MACHINA, 1),
        HSSE = alloymachine(8797, "HSS-E", 51, 102, 0, RAILS, MOLTEN, UNBURNABLE).qual(3, 10.0, 5120, 4)
            .uumAloy(0, HSSG, 6 * U, Co, 1 * U, Mn, 1 * U, Si, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2),
        HSSS = alloymachine(8798, "HSS-S", 102, 0, 51, RAILS, MOLTEN, UNBURNABLE).qual(3, 14.0, 3000, 4)
            .uumAloy(0, HSSG, 6 * U, Osmiridium, 2 * U, Ir, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.MACHINA, 2, TC.NEBRISUM, 1),

        Bedrockium = metalmachore(
            8795,
            "Bedrockium",
            SET_ROUGH,
            88,
            ...
            UNBURNABLE,
            WITHER_PROOF,
            ENDER_DRAGON_PROOF).aspects(TC.METALLUM, 1, TC.TERRA, 10)
                .heat(2000),

        Draconium = metalmachore(
            8791,
            "Draconium",
            150,
            50,
            ...
            ENDER_DRAGON_PROOF,
            VALUABLE,
            MOLTEN).qual(3, 16.0, 5000, 4)
                .aspects(TC.METALLUM, 2, TC.ALIENIS, 1)
                .heat(4500),
        DraconiumAwakened = alloymachine(
            8792,
            "DraconiumAwakened",
            250,
            150,
            ...
            VALUABLE,
            MOLTEN,
            GLOWING).qual(3, 24.0, 10000, 5)
                .setMcfg(1, Draconium, 1 * U)
        ...
        CrystalMatrix = slloymachine(
            ...
            ENDER_DRAGON_PROOF,
            VALUABLE,
            MAGICAL).qual(3, 20.0, 25600, 4)
                .setMcfg(1, Diamond, 20 * U, NetherStar, 2 * U)
                .aspects(TC.VITREUS, 8, TC.PRAECANTIO, 4, TC.NEBRISUM, 4)
                .heat(3896, 5127),
        CosmicNeutronium = setalmachine(
            8800,
            "Cosmic Neutronium",
            30,
            10,
        ...
        Infinity = setalmachine(
            ...
            LIGHTING,
            MAGNETIC_ACTIVE,
            AUTO_COLLECTING).qual(3, 1000000000.0, 1000000000, 15)
                .aspects(
                    TC.POTENTIA,
                    10,
                    TC.NEBRISUM,
        ...
        Unstable = setal(
            ...
            "Unstableingot").aspects(TC.PERDITIO, 4),

        Trinaquadalloy = alloymachine(8684, "Trinaquadalloy", 146, 186, 146, CENTRIFUGE, "NaquadahAlloy")
            .qual(3, 14.0, 20480, 5)
            .uumAloy(0, Ke, 6 * U, Nq, 2 * U, C, 1 * U)
            .aspects(TC.METALLUM, 3, TC.TUTAMEN, 3, TC.NEBRISUM, 1),
        Trinitanium = clloymachine(8790, "Trinitanium", 235, 175, 255).qual(3, 16.0, 5120, 4)
            .uumAloy(0, Ke, 2 * U, Ti, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.VITREUS, 2),

        Iritanium = alloymachine(8793, "Titanium Iridium", 220, 220, 255, "Iritanium").qual(3, 8.0, 7680, 4)
            .uumAloy(0, Ir, 1 * U, Ti, 1 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.MACHINA, 1)
            .setLocal("Iritanium"),
        TitaniumAluminide = alloymachine(8794, "Titanium Aluminide", 200, 200, 255).qual(3, 12.0, 3840, 3)
            .uumAloy(3, Ti, 3 * U, Al, 7 * U)
            .aspects(TC.METALLUM, 2, TC.TUTAMEN, 1, TC.VOLATUS, 1);

    static {
        H2O.setSolidifying(Ice, U);
        Lava.setSolidifying(Obsidian, U)
            .setDensity(Obsidian.mGramPerCubicCentimeter);
    ...
    /**
     * I had to remove the full length names of Elements from this List, but in order to keep Compat with Mods that used
     * some, such as IHL or Tinkers Gregworks, I got a few of them here.
     */
    @Deprecated
    public static final OreDictMaterial Trinium = Ke, Vibranium = Vb, Naquadah = Nq, NaquadahEnriched = Nq_528,
        Naquadria = Nq_522, FakeOsmium = Ge, Adamantium = Ad, Silver = Ag, Aluminium = Al, Bismuth = Bi, Lead = Pb,
        Argon = Ar, Copper = Cu, Gold = Au, Iron = Fe, Titanium = Ti, Calcite = CaCO3, Tungsten = W, Beryllium = Be,
        Chromium = Cr, Manganese = Mn, Cobalt = Co, Cobalt60 = Co_60, Nickel = Ni, Arsenic = As, Zirconium = Zr,
        Molybdenum = Mo, Technetium = Tc, Palladium = Pd, Neodymium = Nd, Osmium = Os, Iridium = Ir, Platinum = Pt,
        Thorium = Th, Uranium = U_238, Uranium235 = U_235, Plutonium = Pu, Plutonium241 = Pu_241, Plutonium243 = Pu_243,
        Americium = Am, Americium241 = Am_241, Alumina = Al2O3, AluminiumFluoride = AlF3, AluminiumHydroxide = AlO3H3,
        Gibbsite = AlO3H3, Fluorite = CaF2, Soapstone = Talc, WoodSealed = WoodTreated, TeslatineAlloy = NikolineAlloy,
        Teslatite = Nikolite, Electrotine = Nikolite, Olivine = Peridot;

    /** Moved most Stones to their own Class. */
    @Deprecated
    public static final OreDictMaterial SpaceRock = STONES.SpaceRock, MoonRock = STONES.MoonRock,
        MoonTurf = STONES.MoonTurf, MarsRock = STONES.MarsRock, MarsSand = STONES.MarsSand,
        Holystone = STONES.Holystone, Livingrock = STONES.Livingrock, Deadrock = STONES.Deadrock,
        Betweenstone = STONES.Betweenstone, Pitstone = STONES.Pitstone, Umber = STONES.Umber, Redrock = STONES.Redrock,
        Komatiite = STONES.Komatiite, Pumice = STONES.Pumice, Gabbro = STONES.Gabbro, Basalt = STONES.Basalt,
        Marble = STONES.Marble, Limestone = STONES.Limestone, Greenschist = STONES.Greenschist,
        Blueschist = STONES.Blueschist, Kimberlite = STONES.Kimberlite, Quartzite = STONES.Quartzite,
        GraniteRed = STONES.GraniteRed, GraniteBlack = STONES.GraniteBlack, Granite = STONES.Granite,
        Andesite = STONES.Andesite, Diorite = STONES.Diorite, Blackstone = STONES.Blackstone, Gneiss = STONES.Gneiss,
        Greywacke = STONES.Greywacke, Siltstone = STONES.Siltstone, Rhyolite = STONES.Rhyolite,
        Migmatite = STONES.Migmatite, Chert = STONES.Chert, Dacite = STONES.Dacite, Shale = STONES.Shale,
        Slate = STONES.Slate, Eclogite = STONES.Eclogite;
    ...
    public static class TECH {
        ...
        @Deprecated
        public static final OreDictMaterial Brick = MT.Brick, AnyGlowstone = ANY.Glowstone, AnyWax = ANY.Wax,
            AnyWood = ANY.Wood, AnyStone = ANY.Stone, AnyClay = ANY.Clay, AnyIron = ANY.Fe, AnyIronSteel = ANY.Steel,
            AnyCopper = ANY.Cu, AnySilicon = ANY.Si, AnyTungsten = ANY.W, AnyThaumicCrystal = ANY.ThaumCrystal,
            AnySalt = ANY.Salt, AnySteel = ANY._Steel, AnyBronze = ANY._Bronze, AnyMetal = ANY._Metal;

        public static final OreDictMaterial Organic = invalid("Organic")
            ...
            RefinedIron = invalid("RefinedIron").stealLooks(HSLA)
                .steal(WroughtIron)
                .setLocal("Refined Iron")
                .setAllToTheOutputOf(Fe)
                .put(IGNORE_IN_COLOR_LOG, SMITHABLE, MELTING)
                .addReRegistrationToThis(WroughtIron);
    ...
    public static class DATA {
        ...
        public static final OreDictItemData[] WIRES_01 = { OP.wireGt01.dat(Pb), OP.wireGt01.dat(Sn),
            OP.wireGt01.dat(ANY.Cu), OP.wireGt01.dat(Au), OP.wireGt01.dat(Al), OP.wireGt01.dat(Pt),
            OP.wireGt01.dat(Graphene), OP.wireGt01.dat(Graphene), OP.wireGt01.dat(Graphene), OP.wireGt01.dat(Graphene),
            OP.wireGt01.dat(Graphene), OP.wireGt01.dat(Superconductor), OP.wireGt01.dat(Superconductor),
            OP.wireGt01.dat(Superconductor), OP.wireGt01.dat(Superconductor), OP.wireGt01.dat(Superconductor) },
            WIRES_04 = { OP.wireGt04.dat(Pb), OP.wireGt04.dat(Sn), OP.wireGt04.dat(ANY.Cu), OP.wireGt04.dat(Au),
                OP.wireGt04.dat(Al), OP.wireGt04.dat(Pt), OP.wireGt04.dat(Graphene), OP.wireGt04.dat(Graphene),
                OP.wireGt04.dat(Graphene), OP.wireGt04.dat(Graphene), OP.wireGt04.dat(Graphene),
                OP.wireGt04.dat(Superconductor), OP.wireGt04.dat(Superconductor), OP.wireGt04.dat(Superconductor),
                OP.wireGt04.dat(Superconductor), OP.wireGt04.dat(Superconductor) },
            CABLES_01 = { OP.cableGt01.dat(Pb), OP.cableGt01.dat(Sn), OP.cableGt01.dat(ANY.Cu), OP.cableGt01.dat(Au),
                OP.cableGt01.dat(Al), OP.cableGt01.dat(Pt), OP.wireGt01.dat(Graphene), OP.wireGt01.dat(Graphene),
                OP.wireGt01.dat(Graphene), OP.wireGt01.dat(Graphene), OP.wireGt01.dat(Graphene),
                OP.wireGt01.dat(Superconductor), OP.wireGt01.dat(Superconductor), OP.wireGt01.dat(Superconductor),
                OP.wireGt01.dat(Superconductor), OP.wireGt01.dat(Superconductor) },
            CABLES_04 = { OP.cableGt04.dat(Pb), OP.cableGt04.dat(Sn), OP.cableGt04.dat(ANY.Cu), OP.cableGt04.dat(Au),
                OP.cableGt04.dat(Al), OP.cableGt04.dat(Pt), OP.wireGt04.dat(Graphene), OP.wireGt04.dat(Graphene),
                OP.wireGt04.dat(Graphene), OP.wireGt04.dat(Graphene), OP.wireGt04.dat(Graphene),
                OP.wireGt04.dat(Superconductor), OP.wireGt04.dat(Superconductor), OP.wireGt04.dat(Superconductor),
                OP.wireGt04.dat(Superconductor), OP.wireGt04.dat(Superconductor) },
            CIRCUITS = { OP.circuit.dat(Primitive), OP.circuit.dat(Basic), OP.circuit.dat(Good),
        ...
        public static final OreDictMaterial[] Dye_Materials = { Black, Red, Green, Brown, Blue, Purple, Cyan, LightGray,
            Gray, Pink, Lime, Yellow, LightBlue, Magenta, Orange, White },

            Heat_T = { ANY.Stone, ANY.Steel, Invar, Ti, TungstenCarbide, ANY.W, ANY.W, ANY.W, ANY.W, ANY.W, ANY.W,
                ANY.W, ANY.W, ANY.W, ANY.W, ANY.W },
            Kinetic_T = { ANY.Wood, Bronze, ANY.Steel, Ti, TungstenSteel, Ir, Os, Os, Os, Os, Os, Os, Os, Os, Os, Os },
            Electric_T = { TinAlloy, SteelGalvanized, Al, StainlessSteel, Cr, Ti, Ir, Os, Trinitanium, Trinaquadalloy,
                Neutronium, Neutronium, Neutronium, Neutronium, Neutronium, Neutronium },
            Flux_T = { Sn, Pb, Invar, Electrum, EnderiumBase, Enderium, TungstenCarbide, TungstenCarbide,
    ...
    public static class OREMATS {
        ...
        @Deprecated
        @SuppressWarnings("hiding")
        public static final OreDictMaterial Pyrolusite = MnO2, Rutile = TiO2, Hematite = Fe2O3, Magnesite = MgCO3,
            Gypsum = MT.Gypsum, Bentonite = MT.Bentonite, FullersEarth = Palygorskite, Kaolinite = MT.Kaolinite;

        public static final OreDictMaterial Cassiterite = oredustelec(
            9108,
            "Cassiterite",
            SET_METALLIC,
            220,
            ...
            MORTAR,
            FURNACE,
            "CassiteriteSand").setSmelting(Sn, 3 * U4)
                .addSourceOf(Sn)
                .setMcfg(1, Sn, 1 * U, O, 2 * U)
                .heat(3 * Sn.mMeltingPoint / 2),
            CassiteriteSand = Cassiterite,
            Garnierite = oredustelec(
                9118,
                "Garnierite",
                SET_METALLIC,
                50,
                ...
                BLACKLISTED_SMELTER,
                MAGNETIC_PASSIVE,
                WASHING_PERSULFATE).setSmelting(Ni, 3 * U4)
                    .addSourceOf(Ni)
                    .setMcfg(1, Ni, 1 * U, O, 1 * U)
                    .qual(0),
            Uraninite = oredustdcmp(9134, "Uraninite", SET_RAD, 35, 35, 35, 255, BLACKLISTED_SMELTER)
                .setSmelting(U_238, U3)
                .addSourceOf(U_238)
                .setMcfg(1, U_238, 1 * U, O, 2 * U),
            Magnetite = oredustdcmp(9122, "Magnetite", SET_METALLIC, 30, 30, 30, 255, MORTAR, MELTING, MAGNETIC_PASSIVE)
                .addSourceOf(Fe)
                .setMcfg(0, Fe, 3 * U, O, 4 * U)
                .qual(0)
                .heat(Fe.mMeltingPoint)
                .aspects(TC.METALLUM, 2, TC.MAGNETO, 1),
            BasalticMineralSand = oredustdcmp(
                9003,
                ...
                MORTAR,
                MELTING,
                MAGNETIC_PASSIVE).addSourceOf(Fe)
                    .setMcfg(0, Fe, 3 * U, O, 4 * U)
                    .qual(0)
                    .heat(Fe.mMeltingPoint)
                    .aspects(TC.METALLUM, 2, TC.MAGNETO, 1),
            GraniticMineralSand = oredustdcmp(
                9004,
            ...
            Realgar = oredustdcmp(
                ...
                BRITTLE,
                FURNACE,
                CRYSTAL).setSmelting(As, U3)
                    .addSourceOf(As)
                    .uumMcfg(0, As, 1 * U, S, 1 * U)
                    .qual(0)
                    .lens(DYE_INDEX_Red),
            Cinnabar = oredustcent(
                9114,
                "Cinnabar",
                SET_REDSTONE,
                150,
                ...
                BRITTLE,
                CRYSTAL,
                PULVERIZING_CINNABAR).setSmelting(Hg, U3)
                    .addSourceOf(Hg)
                    .uumMcfg(0, Hg, 1 * U, S, 1 * U),
            Molybdenite = oredustdcmp(
                9123,
                "Molybdenite",
                SET_METALLIC,
                25,
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).setSmelting(Mo, U4)
                    .addSourceOf(Mo)
                    .uumMcfg(0, Mo, 1 * U, S, 2 * U),
            Sphalerite = oredustdcmp(
                9130,
                "Sphalerite",
                SET_DULL,
                222,
                ...
                MORTAR,
                FURNACE,
                WASHING_PERSULFATE).setSmelting(Zn, U3)
                    .addSourceOf(Zn)
                    .uumMcfg(0, Zn, 1 * U, S, 1 * U),
            Stibnite = oredustdcmp(
                9131,
                "Stibnite",
                SET_METALLIC,
                70,
                ...
                G_GEM_ORES,
                MORTAR,
                BLACKLISTED_SMELTER).setSmelting(Sb, U4)
                    .addSourceOf(Sb)
                    .uumMcfg(0, Sb, 2 * U, S, 3 * U)
                    .heat(823),
            Pentlandite = oredustdcmp(
                9145,
                "Pentlandite",
                SET_DULL,
                165,
                ...
                BLACKLISTED_SMELTER,
                MAGNETIC_PASSIVE,
                WASHING_PERSULFATE).setSmelting(Ni, U3)
                    .addSourceOf(Ni)
                    .uumMcfg(0, Ni, 9 * U, S, 8 * U)
                    .qual(0), // (Fe,Ni)9S8
            Chalcopyrite = oredustdcmp(9111, "Chalcopyrite", SET_DULL, 160, 120, 40, 255, G_GEM_ORES, MORTAR, FURNACE)
                .setSmelting(Cu, 2 * U9)
                .addSourceOf(Cu, Fe)
                .uumMcfg(0, Cu, 1 * U, Fe, 1 * U, S, 2 * U)
                .qual(0),
            Arsenopyrite = oredustdcmp(
                9216,
                "Arsenopyrite",
                SET_CUBE_SHINY,
                250,
                ...
                G_GEM_ORES,
                MORTAR,
                BLACKLISTED_SMELTER).setSmelting(As, U4)
                    .addSourceOf(Fe, As)
                    .uumMcfg(0, Fe, 1 * U, As, 1 * U, S, 1 * U)
                    .qual(0),
            Cobaltite = oredustdcmp(
                9115,
                "Cobaltite",
                SET_METALLIC,
                80,
                ...
                BLACKLISTED_SMELTER,
                MAGNETIC_PASSIVE,
                WASHING_PERSULFATE).setSmelting(Co, U4)
                    .addSourceOf(Co, As)
                    .uumMcfg(0, Co, 1 * U, As, 1 * U, S, 1 * U)
                    .qual(0),
            Galena = oredustdcmp(9117, "Galena", SET_DULL, 100, 60, 100, 255, G_GEM_ORES, MORTAR, FURNACE)
                .setSmelting(Pb, U3)
                .addSourceOf(Pb, Ag)
                .uumMcfg(0, Pb, 3 * U, Ag, 3 * U, S, 2 * U),
            Cooperite = oredustdcmp(
                9116,
                "Cooperite",
                SET_METALLIC,
                130,
                ...
                BLACKLISTED_SMELTER,
                WASHING_MERCURY,
                "Sheldonite").setSmelting(Pt, U3)
                    .addSourceOf(Pt, Ni, Pd)
                    .uumMcfg(0, Pt, 3 * U, Ni, 1 * U, Pd, 1 * U, S, 1 * U)
                    .setLocal("Sheldonite"),
            Tetrahedrite = oredustdcmp(
                9132,
                "Tetrahedrite",
                SET_DULL,
                200,
                ...
                MORTAR,
                FURNACE,
                WASHING_PERSULFATE).setSmelting(Cu, U4)
                    .addSourceOf(Cu, Sb, Fe)
                    .uumMcfg(0, Cu, 3 * U, Sb, 1 * U, Fe, 1 * U, S, 3 * U), // Cu3SbS3 + x(Fe,Zn)6Sb2S9
            Kesterite = oredustdcmp(
                9213,
                "Kesterite",
                SET_DULL,
                105,
                ...
                G_GEM_ORES,
                MORTAR,
                BLACKLISTED_SMELTER).setSmelting(Cu, U9)
                    .addSourceOf(Cu, Zn, Sn)
                    .uumMcfg(0, Cu, 2 * U, Zn, 1 * U, Sn, 1 * U, S, 4 * U),
            Stannite = oredustdcmp(
                9214,
                "Stannite",
                SET_METALLIC,
                155,
                ...
                MORTAR,
                BLACKLISTED_SMELTER).setSmelting(Cu, U9)
                    .addSourceOf(Cu, Fe, Sn)
                    .uumMcfg(0, Cu, 2 * U, Fe, 1 * U, Sn, 1 * U, S, 4 * U),
            Barite = oredustelec(9160, "Barite", SET_DULL, 230, 235, 255, 255, G_GEM_ORES, MORTAR, BLACKLISTED_SMELTER)
                .setSmelting(Ba, U9)
                .addSourceOf(Ba)
                .uumMcfg(0, Ba, 1 * U, S, 1 * U, O, 4 * U)
                .heat(1853),
            Celestine = oredustelec(
                9110,
                "Celestine",
                SET_DULL,
                200,
                ...
                G_GEM_ORES,
                MORTAR,
                BLACKLISTED_SMELTER).setSmelting(Sr, U9)
                    .addSourceOf(Sr)
                    .uumMcfg(0, Sr, 1 * U, S, 1 * U, O, 4 * U),

            Scheelite = oredustdcmp(
                9128,
                "Scheelite",
                SET_DULL,
                200,
                ...
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE,
                "CalciumTungstate").addSourceOf(W)
                    .uumMcfg(0, Ca, 1 * U, WO3, 4 * U, O, 1 * U)
                    .qual(3),
            Wolframite = oredustdcmp(
                9217,
                "Wolframite",
                SET_DULL,
                55,
                ...
                255,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).addSourceOf(W)
                    .uumMcfg(0, Mg, 1 * U, WO3, 4 * U, O, 1 * U)
                    .qual(3),
            Ferberite = oredustdcmp(
                9194,
                "Ferberite",
                SET_DULL,
                55,
                ...
                255,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).addSourceOf(W, Fe)
                    .uumMcfg(0, Fe, 1 * U, WO3, 4 * U, O, 1 * U)
                    .qual(3),
            Huebnerite = oredustdcmp(
                9195,
                "Huebnerite",
                SET_DULL,
                55,
                ...
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE,
                "Gyubnera").addSourceOf(W, Mn)
                    .uumMcfg(0, Mn, 1 * U, WO3, 4 * U, O, 1 * U)
                    .qual(3),
            Tungstate = oredustdcmp(
                9133,
                "Tungstate",
                SET_DULL,
                55,
                ...
                255,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).addSourceOf(W, Li)
                    .uumMcfg(0, Li, 2 * U, WO3, 4 * U, O, 1 * U)
                    .qual(3),
            // TODO Actual Processing, but I don't know what could do it
            Stolzite = oredustdcmp(
                9193,
                "Stolzite",
                SET_DULL,
                55,
                ...
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE,
                "Raspite").setSmelting(WO3, 4 * U6)
                    .addSourceOf(W, Pb)
                    .uumMcfg(0, Pb, 1 * U, WO3, 4 * U, O, 1 * U)
                    .qual(3),
            Russellite = oredustdcmp(
                9196,
                "Russellite",
                SET_DULL,
                55,
                ...
                255,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).setSmelting(WO3, 4 * U9)
                    .addSourceOf(W, Bi)
                    .setMcfg(0, Bi, 2 * U, WO3, 4 * U, O, 3 * U)
                    .qual(3),
            Pinalite = oredustdcmp(9197, "Pinalite", SET_DULL, 55, 50, 35, 255, BLACKLISTED_SMELTER, WASHING_FIRESTONE)
                .setSmelting(WO3, 4 * U11)
                .addSourceOf(W, Pb)
                .uumMcfg(0, Pb, 3 * U, WO3, 4 * U, Cl, 2 * U, O, 2 * U)
                .qual(3),

            Wollastonite = oredustelec(9164, "Wollastonite", SET_DULL, 240, 240, 240, 255, BLACKLISTED_SMELTER)
                .setMcfg(0, Ca, 1 * U, SiO2, 3 * U, O, 1 * U), // CaSiO3

            Zeolite = oredustelec(9165, "Zeolite", SET_DULL, 240, 230, 230, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(Na, Al)
                .setMcfg(0, Al2O3, 5 * U, Na, 2 * U, SiO2, 12 * U, H2O, 6 * U, O, 1 * U), // Na2Al2Si4O12 2H2O
            Pollucite = oredustelec(9147, "Pollucite", SET_DULL, 240, 210, 210, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(Cs, Al)
                .setMcfg(0, Al2O3, 5 * U, Cs, 2 * U, SiO2, 12 * U, H2O, 6 * U, O, 1 * U), // Cs2Al2Si4O12 2H2O (also a
                                                                                          // source of Rb)

            BrownLimonite = oredustdcmp(
                9106,
                "Brown Limonite",
                SET_METALLIC,
                200,
                ...
                MORTAR,
                MELTING,
                MAGNETIC_PASSIVE).setSmelting(Fe2O3, U2)
                    .addSourceOf(Fe)
                    .setMcfg(0, Fe, 1 * U, H, 1 * U, O, 2 * U)
                    .qual(0)
                    .heat(1523), // FeO(OH)
            YellowLimonite = oredustdcmp(
                9137,
                "Yellow Limonite",
                SET_METALLIC,
                200,
                ...
                MELTING,
                MAGNETIC_PASSIVE,
                "BogIron").setSmelting(Fe2O3, U2)
                    .addSourceOf(Fe)
                    .setMcfg(0, Fe, 1 * U, H, 1 * U, O, 2 * U)
                    .qual(0)
                    .heat(1523), // FeO(OH) + a bit Ni and Co

            Ferrovanadium = oredustcent(
                9143,
                "Vanadium Magnetite",
                SET_METALLIC,
                35,
                ...
                MAGNETIC_PASSIVE,
                WASHING_FIRESTONE,
                "Ferrovanadium").addSourceOf(V, Fe)
                    .setMcfg(0, Magnetite, 1 * U, V2O5, 1 * U)
                    .aspects(TC.METALLUM, 2, TC.MAGNETO, 1), // Mixture of Fe3O4 and V2O5. Technically Ferrovanadium is
                                                             // an Alloy of Iron and Vanadium. I should not have blindly
                                                             // copied PFAA and assumed it was an Ore.
            Tantalite = oredustelec(
                9148,
                "Tantalite",
                SET_METALLIC,
                145,
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).addSourceOf(Ta, Mn)
                    .setMcfg(0, Ta2O5, 7 * U, MnO2, 1 * U), // (Fe, Mn)Ta2O6
            Columbite = oredustelec(
                9246,
                "Columbite",
                SET_METALLIC,
                65,
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).addSourceOf(Nb, Mn)
                    .setMcfg(0, Nb2O5, 7 * U, MnO2, 1 * U), // (Fe, Mn)Nb2O6
            Coltan = oredustcent(
                9247,
                "Coltan",
                SET_METALLIC,
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).addSourceOf(Ta, Nb, Mn)
                    .setMcfg(0, Tantalite, 1 * U, Columbite, 1 * U),

            Ilmenite = oredustdcmp(
                9120,
                "Ilmenite",
                SET_METALLIC,
                70,
                ...
                WASHING_FIRESTONE,
                "Illmenite",
                "TitaniumIron").addSourceOf(Ti, Fe)
                    .uumMcfg(0, Fe, 1 * U, Ti, 1 * U, O, 3 * U)
                    .qual(2),
            Bauxite = oredustdcmp(9105, "Bauxite", SET_DULL, 200, 100, 0, 255, MORTAR, BLACKLISTED_SMELTER, APPROXIMATE)
                .addSourceOf(Al, Ti)
                .setMcfg(0, TiO2, 1 * U, Ilmenite, 2 * U, Al2O3, 2 * U)
                .qual(2)
                .heat(2800),
            Chromite = oredustelec(
                9113,
                "Chromite",
                SET_METALLIC,
                35,
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                WASHING_FIRESTONE).setSmelting(Cr, 2 * U9)
                    .addSourceOf(Cr, Fe)
                    .setMcfg(0, Fe, 1 * U, Cr, 2 * U, O, 4 * U)
                    .qual(0),
            Powellite = oredustcent(9124, "Powellite", SET_DULL, 255, 255, 0, 255, MORTAR, BLACKLISTED_SMELTER)
                .setSmelting(Mo, U9)
                .addSourceOf(Mo)
                .setMcfg(0, Ca, 1 * U, Mo, 1 * U, O, 4 * U),
            Wulfenite = oredustcent(9136, "Wulfenite", SET_DULL, 255, 128, 0, 255, MORTAR, BLACKLISTED_SMELTER)
                .setSmelting(Mo, U9)
                .addSourceOf(Mo, Pb)
                .setMcfg(0, Pb, 1 * U, Mo, 1 * U, O, 4 * U),
            Bastnasite = oredustelec(9144, "Bastnasite", SET_FINE, 200, 110, 45, 255, MORTAR, BLACKLISTED_SMELTER)
                .setSmelting(Ce, U9)
                .addSourceOf(Ce, F)
                .setMcfg(0, Ce, 1 * U, C, 1 * U, F, 1 * U, O, 3 * U), // (Ce, La, Y)CO3F
            Pitchblende = oredustcent(9155, "Pitchblende", SET_RAD, 100, 110, 0, 255, MORTAR, BLACKLISTED_SMELTER)
                .setSmelting(U_238, U5)
                .addSourceOf(U_238, Th)
                .setMcfg(0, Uraninite, 3 * U, Th, 1 * U, Pb, 1 * U),
            Malachite = oredustelec(
                9156,
                "Malachite",
                SET_LAPIS,
                5,
                ...
                G_GEM_ORES,
                FURNACE,
                WASHING_PERSULFATE).setSmelting(Cu, U6)
                    .addSourceOf(Cu)
                    .setMcfg(0, Cu, 2 * U, CO3, 4 * U, H, 2 * U, O, 2 * U), // Cu2CO3(OH)2
            Bromargyrite = oredustelec(
                9210,
                "Bromargyrite",
                SET_DULL,
                90,
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                WASHING_MERCURY).setSmelting(Ag, U3)
                    .addSourceOf(Ag, Br)
                    .setMcfg(0, Ag, 1 * U, Br, 1 * U),
            Smithsonite = oredustelec(
                9211,
                "Smithsonite",
                SET_DULL,
                110,
                ...
                BLACKLISTED_SMELTER,
                WASHING_MERCURY,
                WASHING_PERSULFATE).setSmelting(Zn, U6)
                    .addSourceOf(Zn)
                    .setMcfg(0, Zn, 1 * U, C, 1 * U, O, 3 * U),
            Sperrylite = oredustelec(
                9212,
                "Sperrylite",
                SET_SHINY,
                105,
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                WASHING_MERCURY).setSmelting(Pt, U4)
                    .addSourceOf(Pt, As)
                    .setMcfg(0, Pt, 1 * U, As, 2 * U),

            Perlite = oredustdcmp(9138, "Perlite", SET_DULL, 30, 20, 30, 255, MORTAR, BLACKLISTED_SMELTER)
                .setMcfg(1, Obsidian, 1 * U, H2O, 1 * U),
            Trona = oredustelec(9159, "Trona", SET_METALLIC, 135, 135, 95, 255, MORTAR, BLACKLISTED_SMELTER)
                .setMcfg(6, Na2CO3, 6 * U, H2O, 6 * U),
            Mirabilite = oredustdcmp(9157, "Mirabilite", SET_DULL, 240, 250, 210, 255, MORTAR, BLACKLISTED_SMELTER)
                .setMcfg(7, Na2SO4, 7 * U, H2O, 30 * U),
            Bischofite = oredustdcmp(9221, "Bischofite", SET_ROUGH, 99, 104, 118, 255, MORTAR, BLACKLISTED_SMELTER)
                .setMcfg(3, MgCl2, 3 * U, H2O, 6 * U),

            Borax = oredustdcmp(9139, "Borax", SET_FINE, 250, 250, 250, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(B, Na)
                .setMcfg(0, Na, 2 * U, B, 4 * U, H2O, 30 * U, O, 7 * U),
            Diatomite = oredustcent(9001, "Diatomite", SET_DULL, 225, 225, 225, 255, MORTAR, BLACKLISTED_SMELTER)
                .setMcfg(0, Flint, 8 * U, Fe2O3, 1 * U, Sapphire, 1 * U),

            Spodumene = oredustelec(9146, "Spodumene", SET_DULL, 190, 170, 170, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(Al, Li)
                .setMcfg(0, Al2O3, 5 * U, Li, 2 * U, SiO2, 12 * U, O, 1 * U), // LiAl(SiO3)2
            Lepidolite = oredustelec(9149, "Lepidolite", SET_FINE, 240, 50, 140, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(Al, K, Li, F)
                .setMcfg(0, Al2O3, 10 * U, K, 1 * U, Li, 3 * U, F, 2 * U, O, 6 * U), // K(Li,Al,Rb)3(Al,Si)4O10(F,OH)2
            Glauconite = oredustelec(
                9150,
                "Glauconite",
                SET_DULL,
                130,
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                "GlauconiteSand").addSourceOf(Al, K)
                    .setMcfg(0, Al2O3, 10 * U, K, 1 * U, Mg, 2 * U, H2O, 3 * U, O, 7 * U),
            GlauconiteSand = Glauconite, // (K,Na)(Fe3+,Al,Mg)2(Si,Al)4O10(OH)2
            ...
            Vermiculite = oredustelec(9152, "Vermiculite", SET_METALLIC, 200, 180, 15, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(Al)
                .setMcfg(0, Al2O3, 10 * U, Fe, 3 * U, SiO2, 12 * U, H2O, 12 * U, H, 2 * U), // (Mg+2, Fe+2, Fe+3)3
                                                                                            // [(AlSi)4O10] (OH)2 4H2O)
            Mica = oredustelec(9158, "Mica", SET_FINE, 195, 195, 205, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(Al, K, F)
                .setMcfg(0, Al2O3, 15 * U, K, 2 * U, SiO2, 18 * U, F, 4 * U), // KAl2(AlSi3O10)(F,OH)2
            Kyanite = oredustelec(9166, "Kyanite", SET_FLINT, 110, 110, 250, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(Al)
                .setMcfg(0, Al2O3, 5 * U, SiO2, 3 * U), // Al2SiO5
            Alunite = oredustelec(9162, "Alunite", SET_METALLIC, 225, 180, 65, 255, MORTAR, BLACKLISTED_SMELTER)
                .addSourceOf(Al, K)
                .setMcfg(0, Al2O3, 15 * U, KOH, 6 * U, SO3, 16 * U, H2O, 15 * U, O, 9 * U), // KAl3(SO4)2(OH)6

            GarnetSand = oredustcent(9005, "Garnet Sand", SET_SAND, 200, 100, 0, 255, MORTAR, BLACKLISTED_SMELTER)
                .setMcfg(
                    0,
                    Almandine,
                    1 * U,
            ...
            QuartzSand = oredustcent(
                ...
                MORTAR,
                BLACKLISTED_SMELTER,
                QUARTZ).setSmelting(SiO2, U3)
                    .setMcfg(0, CertusQuartz, 1 * U, MilkyQuartz, 1 * U),

            DiduraniumTrioxide = oredustelec(
                9198,
                "Diduranium Trioxide",
                SET_DULL,
                45,
                ...
                145,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Dn)
                    .setMcfg(0, Dn, 2 * U, O, 3 * U)
                    .qual(4),
            DuraniumHexafluoride = oredustelec(
                9199,
                ...
                125,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Dn, F)
                    .setMcfg(0, Dn, 1 * U, F, 6 * U)
                    .qual(4),
            DuraniumHexachloride = oredustelec(
                9200,
                ...
                255,
                BLACKLISTED_SMELTER).addSourceOf(Dn)
                    .setMcfg(0, Dn, 1 * U, Cl, 6 * U)
                    .qual(4),
            DuraniumHexabromide = oredustelec(
                9201,
                ...
                175,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Dn, Br)
                    .setMcfg(0, Dn, 1 * U, Br, 6 * U)
                    .qual(4),
            DuraniumHexaiodide = oredustelec(
                9202,
                "Duranium Hexaiodide",
                SET_DULL,
                75,
                ...
                175,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Dn, I)
                    .setMcfg(0, Dn, 1 * U, I, 6 * U)
                    .qual(4),
            DuraniumHexaastatide = oredustelec(
                9203,
                ...
                175,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Dn, At)
                    .setMcfg(0, Dn, 1 * U, At, 6 * U)
                    .qual(4),
            TritaniumDioxide = oredustelec(9204, "Tritanium Dioxide", SET_DULL, 25, 185, 125, 255, BLACKLISTED_SMELTER)
                .addSourceOf(Tn)
                .setMcfg(0, Tn, 1 * U, O, 2 * U)
                .qual(4),
            TritaniumHexafluoride = oredustelec(
                9205,
                ...
                125,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Tn, F)
                    .setMcfg(0, Tn, 1 * U, F, 6 * U)
                    .qual(4),
            TritaniumHexachloride = oredustelec(
                9206,
                ...
                155,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Tn)
                    .setMcfg(0, Tn, 1 * U, Cl, 6 * U)
                    .qual(4),
            TritaniumHexabromide = oredustelec(
                9207,
                ...
                155,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Tn, Br)
                    .setMcfg(0, Tn, 1 * U, Br, 6 * U)
                    .qual(4),
            TritaniumHexaiodide = oredustelec(
                9208,
                ...
                185,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Tn, I)
                    .setMcfg(0, Tn, 1 * U, I, 6 * U)
                    .qual(4),
            TritaniumHexaastatide = oredustelec(
                9209,
                ...
                185,
                255,
                BLACKLISTED_SMELTER).addSourceOf(Tn, At)
                    .setMcfg(0, Tn, 1 * U, At, 6 * U)
                    .qual(4);
    }
    ...
    public static class STONES {
        ...
        @SuppressWarnings("hiding")
        public static final OreDictMaterial SpaceRock = stone(
            8512,
            "Space Stone",
            SET_SPACE,
            99,
            ...
            255,
            MELTING,
            MOLTEN).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 32, 1)
                .setGenerifying(Stone)
                .addSourceOf(He, He_3)
                .setLocal("Space"),
            MoonRock = stone(8513, "Moon Stone", 189, 189, 189, 255, MELTING, MOLTEN).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 32, 1)
                .setGenerifying(Stone)
                .setLocal("Moon"),
            MoonTurf = stone(8514, "Moon Turf", 207, 207, 207, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 3.0, 16, 1)
                .setGenerifying(Stone)
                .addSourceOf(He, He_3),
            MarsRock = stone(8515, "Mars Stone", 189, 77, 77, 255, MELTING, MOLTEN).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 32, 1)
                .setGenerifying(Stone)
                .setLocal("Mars"),
            MarsSand = stone(8516, "Mars Sand", 207, 66, 66, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 3.0, 16, 1)
                .setGenerifying(Stone),
            SkyStone = stonecent(8528, "Sky Stone", 81, 92, 96, 255)
                .setMcfg(0, Peridot, 2 * U, RareEarth, 1 * U, MeteoricIron, 1 * U, Obsidian, 5 * U)
                .aspects(TC.VOLATUS, 1)
                .qual(1, 5.0, 64, 2)
                .setGenerifying(Stone)
                .heat(2200),
            Holystone = stone(8522, "Holystone", 172, 172, 172, 255).aspects(TC.LUX, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .heat(2000),
            Livingrock = stone(8521, "Livingrock", 195, 205, 195, 255).aspects(TC.VICTUS, 1)
                .qual(1, 5.0, 128, 2)
                .setGenerifying(Stone)
                .heat(1800),
            Deadrock = stone(8523, "Deadrock", 153, 153, 168, 255, UNBURNABLE).aspects(TC.MORTUUS, 1)
                .qual(1, 5.0, 128, 2)
                .setGenerifying(Stone)
                .heat(1800),
            Betweenstone = stone(8519, "Betweenstone", 100, 160, 110, 255).aspects(TC.MORTUUS, 1)
                .qual(1, 4.0, 32, 1)
                .setGenerifying(Stone)
                .heat(1000),
            Pitstone = stone(8520, "Pitstone", 40, 50, 30, 255).aspects(TC.TENEBRAE, 1)
                .qual(1, 4.0, 32, 1)
                .setGenerifying(Stone)
                .heat(1200),
            Cragrock = stone(8524, "Cragrock", 93, 96, 107, 255).aspects(TC.VENEMUM, 1)
                .qual(1, 4.0, 32, 1)
                .setGenerifying(Stone)
                .heat(1400),
            Templerock = brick(8525, "Templerock", 171, 158, 106, 255, WITHER_PROOF).aspects(TC.VINCULUM, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .heat(1600),
            Mazestone = brick(8526, "Mazestone", 110, 120, 110, 255, WITHER_PROOF).aspects(TC.ITER, 1)
                .qual(1, 5.0, 128, 3)
                .setGenerifying(Stone)
                .heat(2000),
            Castlerock = brick(8527, "Castlerock", 198, 185, 186, 255, WITHER_PROOF).aspects(TC.TUTAMEN, 1)
                .qual(1, 5.0, 128, 3)
                .setGenerifying(Stone)
                .heat(2000),
            Umber = stone(8517, "Umber", 111, 77, 11, 255).aspects(TC.BESTIA, 1)
                .qual(1, 3.0, 32, 1)
                .setGenerifying(Stone)
                .heat(987)
                .setLocal("Umberstone"),
            Shale = stonecent(9190, "Shale", 142, 142, 168, 255)
                .setMcfg(0, CaCO3, 2 * U, MilkyQuartz, 1 * U, Clay, 1 * U)
                .aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 0)
                .setGenerifying(Stone),
            Redrock = stonecent(8509, "Redrock", 255, 80, 50, 255, "RedRock")
                .setMcfg(0, CaCO3, 2 * U, Flint, 1 * U, ClayRed, 1 * U)
                .aspects(TC.TERRA, 1)
                .qual(1, 2.5, 16, 1)
                .setGenerifying(Stone),
            Komatiite = stonecent(9177, "Komatiite", 190, 190, 105, 255, UNBURNABLE)
                .setMcfg(0, Peridot, 1 * U, MgCO3, 2 * U, Flint, 6 * U, DarkAsh, 3 * U)
                .aspects(TC.SANO, 1)
                .qual(1, 3.0, 32, 2)
                .setGenerifying(Stone)
                .heat(1673),
            Pumice = stonecent(9000, "Pumice", SET_DULL, 220, 216, 127, 255, UNBURNABLE)
                .setMcfg(0, Peridot, 3 * U, MgCO3, 2 * U, Flint, 4 * U, DarkAsh, 2 * U)
                .aspects(TC.VITREUS, 1)
                .qual(1, 3.0, 32, 2)
                .setGenerifying(Stone)
                .heat(1673),
            Gabbro = stonecent(9176, "Gabbro", 65, 60, 60, 255, UNBURNABLE)
                .setMcfg(0, Peridot, 1 * U, CaCO3, 3 * U, Flint, 8 * U, DarkAsh, 4 * U)
                .aspects(TC.TENEBRAE, 1)
                .qual(1, 3.0, 32, 2)
                .setGenerifying(Stone)
                .heat(1673),
            Basalt = stonecent(8505, "Basalt", 60, 50, 50, 255, UNBURNABLE, UNRECYCLABLE)
                .setMcfg(0, Peridot, 1 * U, CaCO3, 3 * U, Flint, 8 * U, DarkAsh, 4 * U)
                .aspects(TC.TENEBRAE, 1)
                .qual(1, 3.0, 32, 2)
                .setGenerifying(Stone)
                .heat(1673),
            Marble = stonecent(8506, "Marble", 200, 200, 200, 255).setMcfg(0, Mg, 1 * U, CaCO3, 7 * U)
                .aspects(TC.PERFODIO, 1)
                .qual(1, 2.5, 16, 1)
                .setGenerifying(Stone)
                .setSmelting(CaCO3, 2 * U3),
            Limestone = stonecent(9189, "Limestone", 230, 200, 130, 255, BETWEENLANDS).setMcfg(0, CaCO3, 1 * U)
                .aspects(TC.TERRA, 1)
                .qual(1, 2.5, 16, 1)
                .setGenerifying(Stone)
                .setSmelting(CaCO3, U2),
            Greenschist = stone(9171, "Greenschist", 105, 190, 105, 255, MD.UB).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 24, 1)
                .setGenerifying(Stone)
                .setLocal("Green Schist"),
            Blueschist = stone(9184, "Blueschist", 105, 105, 190, 255, MD.UB).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 24, 1)
                .setGenerifying(Stone)
                .setLocal("Blue Schist"),
            Grayschist = stone(9244, "Grayschist", 145, 140, 145, 255, MD.EB).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 24, 1)
                .setGenerifying(Stone)
                .setLocal("Gray Schist"),
            Pinkschist = stone(9245, "Pinkschist", 220, 195, 195, 255, MD.PFAA).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 24, 1)
                .setGenerifying(Stone)
                .setLocal("Pink Schist"),
            Gneiss = stone(9170, "Gneiss", 255, 201, 134, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 24, 1)
                .setGenerifying(Stone),
            Kimberlite = stone(9218, "Kimberlite", 100, 70, 10, 255).aspects(TC.VITREUS, 1)
                .qual(1, 2.0, 24, 2)
                .setGenerifying(Stone),
            Quartzite = stone(
                9180,
                ...
                CRYSTALLISABLE,
                QUARTZ,
                BLACKLISTED_SMELTER).aspects(TC.POTENTIA, 1)
                    .qual(1, 1.7, 32, 1)
                    .setGenerifying(Stone)
                    .setSmelting(SiO2, U),
            GraniteRed = stoneelec(8507, "GraniteRed", 160, 60, 70, 255)
                .setMcfg(0, Biotite, 1 * U, PotassiumFeldspar, 1 * U, Flint, 1 * U)
                .aspects(TC.TUTAMEN, 1)
                .qual(1, 3.0, 64, 3)
                .setGenerifying(Stone)
                .heat(1500)
                .setLocal("Red Granite"),
            GraniteBlack = stoneelec(8508, "GraniteBlack", 20, 20, 20, 255)
                .setMcfg(0, Biotite, 1 * U, PotassiumFeldspar, 1 * U, Flint, 1 * U)
                .aspects(TC.TUTAMEN, 1)
                .qual(1, 3.0, 64, 3)
                .setGenerifying(Stone)
            ...
            Granite = stoneelec(8518, "Granite", 160, 120, 130, 255)
                .setMcfg(0, Biotite, 1 * U, PotassiumFeldspar, 1 * U, Flint, 1 * U)
                .aspects(TC.TERRA, 1)
                .qual(1, 3.0, 64, 1)
                .setGenerifying(Stone)
                .heat(1500),
            Andesite = stone(9188, "Andesite", 191, 191, 191, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.5, 16, 1)
                .setGenerifying(Stone),
            Diorite = stone(8511, "Diorite", 240, 240, 240, 255, UNBURNABLE).aspects(TC.TERRA, 1)
                .qual(1, 2.5, 16, 1)
                .setGenerifying(Stone),
            Blackstone = brick(9223, "Blackstone", 30, 20, 20, 255, UNRECYCLABLE).aspects(TC.TENEBRAE, 1)
                .qual(1, 5.0, 64, 1)
                .setGenerifying(Stone),
            Greywacke = stone(9173, "Greywacke", 176, 176, 176, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 1)
                .setGenerifying(Stone),
            Siltstone = stone(9178, "Siltstone", 250, 205, 205, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 0)
                .setGenerifying(Stone),
            Rhyolite = stone(9179, "Rhyolite", 121, 121, 121, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 1)
                .setGenerifying(Stone),
            Migmatite = stone(9181, "Migmatite", 70, 40, 40, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 1)
                .setGenerifying(Stone),
            Chert = stone(9186, "Chert", 105, 10, 10, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 0)
                .setGenerifying(Stone),
            Dacite = stone(9187, "Dacite", 131, 131, 131, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 1)
                .setGenerifying(Stone),
            Slate = stone(9222, "Slate", 148, 151, 156, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 0)
                .setGenerifying(Stone),
            Deepslate = stone(9248, "Deepslate", 57, 59, 61, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 32, 1)
                .setGenerifying(Stone),
            Eclogite = stone(9191, "Eclogite", 90, 40, 40, 255).aspects(TC.TERRA, 1)
                .qual(1, 2.0, 16, 1)
                .setGenerifying(Stone),
            PhobosRock = stone(9249, "PhobosRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Phobos"),
            DeimosRock = stone(9250, "DeimosRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Deimos"),
            VenusRock = stone(9251, "VenusRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Venus"),
            MercuryRock = stone(9252, "MercuryRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Mercury"),
            CeresRock = stone(9253, "CeresRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Ceres"),
            JupiterRock = stone(9254, "JupiterRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Jupiter"),
            IoRock = stone(9255, "IoRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Io"),
            EuropaRock = stone(9256, "EuropaRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Europa"),
            GanymedeRock = stone(9257, "GanymedeRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Ganymede"),
            CallistoRock = stone(9258, "CallistoRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Callisto"),
            SaturnRock = stone(9259, "SaturnRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Saturn"),
            RheaRock = stone(9260, "RheaRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Rhea"),
            TitanRock = stone(9261, "TitanRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Titan"),
            OberonRock = stone(9262, "OberonRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Oberon"),
            IapetusRock = stone(9263, "IapetusRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Iapetus"),
            UranusRock = stone(9264, "UranusRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Uranus"),
            TitaniaRock = stone(9265, "TitaniaRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Titania"),
            NeptuneRock = stone(9266, "NeptuneRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Neptune"),
            TritonRock = stone(9267, "TritonRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Triton"),
            PlutoRock = stone(9268, "PlutoRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Pluto"),
            ErisRock = stone(9269, "ErisRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Eris"),
            Kepler22bRock = stone(9270, "Kepler22bRock", 189, 189, 189, 255).aspects(TC.ALIENIS, 1)
                .qual(1, 5.0, 128, 1)
                .setGenerifying(Stone)
                .setLocal("Kepler22b");
    }
    ...
    public static class WOODS {
        ...
        @SuppressWarnings("hiding")
        public static final OreDictMaterial Oak = woodnormal(9300, "Oak", "Oak", 180, 144, 90, 3.0, 32, MD.MC),
            ...
            Compressed = woodnormal(9308, "WoodCompressed", "Compressed Wood", 94, 60, 25, 1.5, 8, MD.GT)
                .setPulver(Wood, U),
    ...
    public static class UNUSED {
        ...
        public static final OreDictMaterial OsmiumTetroxide = unused("Osmium Tetroxide")
            .setMcfg(0, Os, 1 * U, O, 4 * U),
            SodiumPeroxide = unused("Sodium Peroxide").setMcfg(0, Na, 2 * U, O, 2 * U), // Yellowish
            IridiumSodiumOxide = unused("Iridium Sodium Oxide"), Iridiron = unused("IridiumIron").setPriorityPrefix(3)
                .put(G_INGOT)
                .setMcfg(0, Ir, 1 * U, Fe, 1 * U)
                .setLocal("Iridiron"),
            IridironReinforced = unused("IridiumIronReinforced").setPriorityPrefix(3)
                .put(G_INGOT)
                .setMcfg(0, Ir, 1 * U, Fe, 1 * U)
                .setLocal("Reinforced Iridiron"),
            LimePure = unused("LimePure").setLocal("Pure Lime"), TNT = unused("TNT").put(EXPLOSIVE, FLAMMABLE, MD.MC)
                .aspects(TC.PERDITIO, 3, TC.IGNIS, 1),
            TerrasteelAlloyRaw = unused("TerrasteelAlloyRaw").setPriorityPrefix(3)
                .put(G_INGOT, MAGICAL, "RawTerrasteelAlloy")
                .setLocal("Raw Terrasteel Alloy"),
            TerrasteelAlloyStrengthened = unused("TerrasteelAlloyStrengthened").setPriorityPrefix(3)
                .put(G_INGOT, MAGICAL, "StrengthenedTerrasteelAlloy")
                .setLocal("Strengthened Terrasteel Alloy"),
            Vis = unused("Vis").put(DECOMPOSABLE)
                .setMcfg(0, Ma, 1 * U)
                .aspects(TC.AURAM, 2, TC.PRAECANTIO, 1),
            Voidstone = unused("Voidstone").aspects(TC.VITREUS, 1, TC.VACUOS, 1),
            Mercassium = unused("Mercassium").setPriorityPrefix(3)
                .qual(3, 6.0, 64, 1)
                .put(G_INGOT_ORES),
            Osmonium = unused("Osmonium").setPriorityPrefix(3)
                .qual(3, 6.0, 64, 1)
                .put(G_INGOT_ORES),
            Phoenixite = unused("Phoenixite").setPriorityPrefix(3)
                .qual(3, 6.0, 64, 1)
                .put(G_INGOT_ORES),
            Antimatter = unused("Antimatter").put(ANTIMATTER), Starconium = unused("Starconium").setPriorityPrefix(3)
                .put(G_INGOT_ORES),
            Thyrium = unused("Thyrium").setPriorityPrefix(3)
                .put(G_INGOT_ORES),
            Zectium = unused("Zectium").setPriorityPrefix(3)
                .put(G_INGOT_ORES),
            Draconic = deprecated("Draconic").setPriorityPrefix(2)
                .put(G_DUST),
            Teslatite = unused("InfusedTeslatite").setPriorityPrefix(2)
                .put(G_DUST)
                .setLocal("Teslatite"), // 1 Redstone + 1 Nikolite = 1 Teslatite; and 8 Teslatite + 1 Gold = 1 Purple
                                        // Alloy;
            IrridantUranium = unused("Irridant Uranium").setPriorityPrefix(3)
                .put(G_INGOT),
            IrridantReinforced = unused("IrridantReinforced").setPriorityPrefix(3)
                .put(G_INGOT),
            IronSharp = unused("IronSharp").setPriorityPrefix(3)
                .put(G_INGOT)
                .setLocal("Sharp Iron"),
            ObsidianFlux = unused("Obsidian Flux").setPriorityPrefix(3)
                .put(G_INGOT),
            CrystalFlux = unused("Crystal Flux").setPriorityPrefix(1)
                .put(G_GEM, CRYSTAL, BRITTLE),
            Mimichite = unused("Mimichite").setPriorityPrefix(1)
                .put(G_GEM_ORES, CRYSTAL, BRITTLE),
            Infernal = unused("Infernal"), Invisium = unused("Invisium").setPriorityPrefix(2)
                .put(G_DUST),
            Lodestone = unused("Lodestone").setPriorityPrefix(2)
                .put(G_DUST_ORES),
            Luminite = unused("Luminite").setPriorityPrefix(2)
                .put(G_DUST_ORES),
            Magma = unused("Magma"), Mawsitsit = unused("Mawsitsit").setPriorityPrefix(2)
                .put(G_DUST),
            Nether = unused("Nether"), Painite = unused("Painite"), Petroleum = unused("Petroleum").setPriorityPrefix(2)
                .put(G_DUST_ORES),
            Pewter = unused("Pewter"), Potash = unused("Potash"), Randomite = unused("Randomite").setPriorityPrefix(2)
                .put(G_DUST_ORES),
            RyuDragonRyder = unused("RyuDragonRyder"), Tar = unused("Tar"), TarPitch = unused("Tar Pitch"),
            Cavenium = unused("Cavenium"), CaveniumRefined = unused("CaveniumRefined").put("RefinedCavenium")
                .setLocal("Refined Cavenium"),
            Infitite = unused("Infitite"), Magnite = unused("Magnite"), Hexcite = unused("Hexcite"),
            Tapazite = unused("Tapazite").setPriorityPrefix(2)
                .put(G_DUST),
            Tourmaline = unused("Tourmaline").setPriorityPrefix(2)
                .put(G_DUST),
            Turquoise = unused("Turquoise").setPriorityPrefix(2)
                .put(G_DUST),
            Wimalite = unused("Wimalite").setPriorityPrefix(2)
                .put(G_DUST_ORES),
            Adamite = unused("Adamite").setPriorityPrefix(2)
                .put(G_DUST_ORES),
            Adluorite = unused("Adluorite").setPriorityPrefix(2)
                .put(G_DUST_ORES),
            Agate = unused("Agate").setPriorityPrefix(2)
                .put(G_DUST),
            Ammonium = unused("Ammonium").setPriorityPrefix(2)
                .put(G_DUST),
            Bitumen = unused("Bitumen").setPriorityPrefix(2)
                .put(G_DUST_ORES),
            Bloodstone = unused("Bloodstone").setPriorityPrefix(2)
                .put(G_DUST),
            Citrine = unused("Citrine").setPriorityPrefix(2)
                .put(G_DUST),
            Coral = unused("Coral").setPriorityPrefix(2)
                .put(G_DUST),
            Chrysocolla = unused("Chrysocolla").setPriorityPrefix(2)
                .put(G_DUST),
            DarkStone = unused("Dark Stone").setPriorityPrefix(2)
                .put(G_DUST),
            Demonite = unused("Demonite").setPriorityPrefix(2)
                .put(G_DUST),
            InfusedGold = unused("Infused Gold").setPriorityPrefix(3)
                .put(G_INGOT),
            Daffergon = unused("Daffergon").setPriorityPrefix(3)
                .put(G_INGOT_ORES, MD.HBM), // Dellite Ore
            Reiium = unused("Reiium").setPriorityPrefix(3)
                .put(G_INGOT_ORES, MD.HBM), // Reiite Ore
            Weidanium = unused("Weidanium").setPriorityPrefix(3)
                .put(G_INGOT_ORES, MD.HBM), // Weidite Ore
            Verticium = unused("Verticium").setPriorityPrefix(3)
                .put(G_INGOT_ORES, MD.HBM),
            Australium = unused("Australium").setPriorityPrefix(3)
                .put(G_INGOT_ORES, MD.HBM),
            Schrabidium = unused("Schrabidium").setPriorityPrefix(3)
                .put(G_INGOT_ORES, MD.HBM, MAGNETIC_ACTIVE, AUTO_COLLECTING, MELTING, MOLTEN)
                .setRGBa(50, 255, 255, 255),
            Starmetal = unused("Starmetal").setPriorityPrefix(3)
                .put(G_INGOT_MACHINE_ORES, MD.HBM),
            Unobtainium = unused("Unobtainium").setPriorityPrefix(3)
                .put(G_INGOT_MACHINE_ORES, MD.HBM),
            CMBSteel = unused("CMB Steel").setPriorityPrefix(3)
                .put(G_INGOT_MACHINE, MD.HBM),
            DuraSteel = unused("DuraSteel").setPriorityPrefix(3)
                .put(G_INGOT_MACHINE, MD.HBM)
                .setLocal("High-Speed Steel"),
            AdvancedAlloy = unused("Advanced Alloy").setPriorityPrefix(3)
                .put(G_INGOT_MACHINE, MD.HBM),
            Saturnite = unused("Saturnite").setPriorityPrefix(3)
                .put(G_INGOT_MACHINE, MD.HBM),
            Dineutronium = unused("Dineutronium").setPriorityPrefix(3)
                .put(G_INGOT_MACHINE, MD.HBM),
            MagnetizedTungsten = unused("Magnetized Tungsten").setPriorityPrefix(3)
                .put(G_INGOT, MD.HBM, MAGNETIC_ACTIVE, AUTO_COLLECTING),
            Euphemium = unused("Euphemium").setPriorityPrefix(3)
                .put(G_INGOT, MD.HBM, MELTING, MOLTEN)
                .setRGBa(255, 150, 255, 255),
            Rupee = unused("Rupee").put(MD.DRPG), Arlemite = unused("Arlemite").put(MD.DRPG),
            Realmite = unused("Realmite").put(MD.DRPG), Bloodgem = unused("Bloodgem").put(MD.DRPG),
            Netheryte = unused("Netheryte").put(MD.DRPG), Eden = unused("Eden").put(MD.DRPG),
            Wildwood = unused("Wildwood").put(MD.DRPG), Apalachia = unused("Apalachia").put(MD.DRPG),
            Skythern = unused("Skythern").put(MD.DRPG), Mortum = unused("Mortum").put(MD.DRPG),
            Arcanium = unused("Arcanium").put(MD.DRPG), Energized = unused("Energized"),
            Reinforced = unused("Reinforced"), Mud = unused("Mud").put(IGNORE_IN_COLOR_LOG),
            Cream = unused("Cream").put(IGNORE_IN_COLOR_LOG), Cluster = unused("Cluster"), Sweet = unused("Sweet"),
            Gelatine = unused("Gelatine"), Satinspar = unused("Satinspar"), Selenite = unused("Selenite"),
            Jet = unused("Jet"), Microcline = unused("Microcline"), Serpentine = unused("Serpentine"), // byproduct
                                                                                                       // pietersite,
                                                                                                       // which is a
                                                                                                       // fake? Tiger
                                                                                                       // eye
            Sylvite = unused("Sylvite"), Goshen = unused("Goshen"), Joshen = unused("Joshen"),
            Itarius = unused("Itarius"), Legendary = unused("Legendary"), MutatedIron = unused("Mutated Iron"),
            Witheria = unused("Witheria"), RubberTreeSap = unused("Rubber Tree Sap"),
            GraveyardDirt = unused("Graveyard Dirt"), Cocaine = unused("Cocaine"), Vile = unused("Vile"),
            Dull = unused("Dull"), Dark = unused("Dark"), Soulium = unused("Soulium"),
            Tennantite = unused("Tennantite"), Alfium = unused("Alfium"), Ryu = unused("Ryu"),
            Mutation = unused("Mutation"), HOPGraphite = unused("HOPGraphite"),
            EnrichedCopper = unused("Enriched Copper"), DiamondCopper = unused("Diamond Copper"),
            Fairy = unused("Fairy"), Pokefennium = unused("Pokefennium");
    }
}
