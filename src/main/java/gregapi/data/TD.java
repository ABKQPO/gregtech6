...
public class TD {
    ...
    public static class Connectors {
        ...
        public static final TagData PNEUMATIC_ITEM = TagData
            .createTagData("CONNECTORS.PNEUMATIC_ITEM", "Pneumatic Item Pipe");
        ...
        public static final TagData WIRE_LOGISTICS = TagData
            .createTagData("CONNECTORS.WIRE_LOGISTICS", "Logistics Wire");
        public static final TagData AXLE_ROTATION = TagData
            .createTagData("CONNECTORS.AXLE_ROTATION", "Rotational Axle");
    ...
    /**
     * For Energy Systems. You can create your own kind of Energy too of course, but I have added some Defaults in order
    ...
    public static class Energy {
         ...
         * Amount = Amperage
         */
        public static final TagData ELECTRICITY = TagData
            .createTagData("ENERGY.ELECTRICITY", "EU", "Electric Energy", LH.Chat.BLUE), EU = ELECTRICITY;
         ...
         * 
         * Note:
         * If an Emitter (Motor) looks visually like being clockwise, it will emit counterclockwise Energy and vice
         * versa.
         * This is because it is clockwise from the perspective of the Receiver and a Z-Mirroring would invert the
         * direction!
         * And all of that will be very confusing to normal people... Yeah I don't like it too, but I had to do it.
         */
        public static final TagData KINETIC_ROTATION = TagData
            .createTagData("ENERGY.KINETIC_ROTATION", "RU", "Rotation Energy", LH.Chat.GREEN), RU = KINETIC_ROTATION;
         ...
         * Amount = Power
         */
        public static final TagData KINETIC_PUSH = TagData
            .createTagData("ENERGY.KINETIC_PUSH", "KU", "Kinetic Energy", LH.Chat.DGREEN), KU = KINETIC_PUSH;
         ...
         * Most converters have an Energy Loss of about 50% when converting from or to EU.
         * Size = Strength of the Field. Positive for Electron Charge aka South, Negative for Proton Charge aka North.
         * (Yes, I am again fixing the American stupidness of giving Electrons the negative charge!)
         * Amount = unused (always 1)
         */
        public static final TagData MAGNETIC = TagData
            .createTagData("ENERGY.MAGNETIC", "MU", "Magnetic Energy", LH.Chat.DGRAY), MU = MAGNETIC;
         ...
         * Amount = Temperature
         */
        public static final TagData NEUTRON = TagData
            .createTagData("ENERGY.NEUTRON", "NU", "Neutron Energy", LH.Chat.BLACK), NU = NEUTRON;
         ...
         * Amount = Nobody knows
         */
        public static final TagData QUANTUM = TagData
            .createTagData("ENERGY.QUANTUM", "QU", "Quantum Energy", LH.Chat.PURPLE), QU = QUANTUM;

        /**
         * Energy Tag for Time. Machines which simply run on time use this token. This can for example also be used to
         * make a "Time"-Energy emitting thing that accelerates chemical procedures.
         * Size = unused (always 1)
         * Amount = Ticks
         */
        public static final TagData TIME = TagData.createTagData("ENERGY.TIME", "TU", "Time", LH.Chat.DBLUE), TU = TIME,
            TICK = TIME;
         ...
         * Amount = RF
         */
        public static final TagData REDSTONE_FLUX = TagData
            .createTagData("ENERGY.REDSTONE_FLUX", "RF", "Redstone Flux", LH.Chat.DRED), RF = REDSTONE_FLUX;
         ...
         * Amount = MJ
         */
        public static final TagData MINECRAFT_JOULES = TagData
            .createTagData("ENERGY.MINECRAFT_JOULES", "MJ", "Minecraft Joules", LH.Chat.DRED), MJ = MINECRAFT_JOULES;
        ...
        public static final TagData VIS_ORDO = TagData
            .createTagData("ENERGY.VIS_ORDO", "Ordo", "Ordo Vis", LH.Chat.WHITE);
        ...
        public static final TagData VIS_AQUA = TagData
            .createTagData("ENERGY.VIS_AQUA", "Aqua", "Aqua Vis", LH.Chat.CYAN);
        /** Energy Tag for Terra Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
        public static final TagData VIS_TERRA = TagData
            .createTagData("ENERGY.VIS_TERRA", "Terra", "Terra Vis", LH.Chat.GREEN);
        /** Energy Tag for Ignis Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
        public static final TagData VIS_IGNIS = TagData
            .createTagData("ENERGY.VIS_IGNIS", "Ignis", "Ignis Vis", LH.Chat.RED);
        /** Energy Tag for Perditio Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
        public static final TagData VIS_PERDITIO = TagData
            .createTagData("ENERGY.VIS_PERDITIO", "Perditio", "Perditio Vis", LH.Chat.BLACK);
        /**
         * Set of Energy Tags which are of the Vis Type. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. The
         * Acronym "VIS" stands for "Very Interesting Stuff"
         */
        public static final List<TagData> VIS = new ArrayListNoNulls<>(
            F,
            VIS_ORDO,
            VIS_AER,
            VIS_AQUA,
        ...
        public static final List<TagData> ALL = new ArrayListNoNulls<>(
            F,
            VIS_ORDO,
            VIS_AER,
            VIS_AQUA,
        ...
        public static final List<TagData> ALL_GT = new ArrayListNoNulls<>(
            F,
            AU,
            QU,
            MU,
        ...
        public static final List<TagData> ALL_COMSUMPTION_LIMITED = new ArrayListNoNulls<>(
            F,
            EU,
            RF,
            VIS_ORDO,
        ...
        public static final List<TagData> ALL_EXPLODING = new ArrayListNoNulls<>(
            F,
            AU,
            QU,
            MU,
            ...
            STEAM);
        /**
         * Contains all known Energy Tags, which use alternating positive and negative Energy. Used in the Basic
         * Machines to determine if Progress can be made.
         */
        public static final List<TagData> ALL_ALTERNATING = new ArrayListNoNulls<>(F, KU);
        /**
         * Contains all known Energy Tags, which have an irrelevant packet Size. Used in TileEntityBase1 to check if the
         * Energy can be accepted even with a too low Size.
         */
        public static final List<TagData> ALL_SIZE_IRRELEVANT = new ArrayListNoNulls<>(
            F,
            VIS_ORDO,
            VIS_AER,
            VIS_AQUA,
    ...
    public static class Prefix {
        ...
        public static final TagData TOOLTIP_MATERIAL = TagData
            .createTagData("PREFIX.TOOLTIP_MATERIAL", "Material Tooltip");
        /** If this Prefix has the Enchantment Tooltip */
        public static final TagData TOOLTIP_ENCHANTS = TagData
            .createTagData("PREFIX.TOOLTIP_ENCHANTS", "Enchantment Tooltip");
        /** If this Prefix is not Filterable inside the Prefix Filter */
        public static final TagData NO_PREFIX_FILTERING = TagData
            .createTagData("PREFIX.NO_PREFIX_FILTERING", "Not Prefix Filterable");
        ...
        public static final TagData UNIFICATABLE_RECIPES = TagData
            .createTagData("PREFIX.UNIFICATABLE_RECIPES", "Recipe Unificatable");
        /** If this Prefix can be used in an Extruder. */
        public static final TagData EXTRUDER_FODDER = TagData
            .createTagData("PREFIX.EXTRUDER_FODDER", "Extruder Fodder");
        ...
        public static final TagData ORE_PROCESSING_DIRTY = TagData
            .createTagData("PREFIX.ORE_PROCESSING_DIRTY", "Ore Processing Dirty");
        /** If this Prefix is used for Ore Processing */
        public static final TagData ORE_PROCESSING_CLEAN = TagData
            .createTagData("PREFIX.ORE_PROCESSING_CLEAN", "Ore Processing Clean");
        /** If this Prefix is used for Ore Processing */
        public static final TagData ORE_PROCESSING_REFINED = TagData
            .createTagData("PREFIX.ORE_PROCESSING_REFINED", "Ore Processing Refined");
        /** If this Prefix is used for Ore Processing, like "crushed" for example */
        public static final TagData ORE_PROCESSING_BASED = TagData
            .createTagData("PREFIX.ORE_PROCESSING_BASED", "Ore Processing Based");
        ...
        public static final TagData NEEDS_SHARPENING = TagData
            .createTagData("PREFIX.NEEDS_SHARPENING", "Needs Sharpening");
        ...
        public static final TagData SELF_REFERENCING = TagData
            .createTagData("PREFIX.SELF_REFERENCING", "Self Referencing");
    }
    ...
    public static class Atomic {
        ...
        public static final TagData ALKALINE_EARTH_METAL = TagData
            .createTagData("ATOMIC.ALKALINE_EARTH_METAL", "Alkaline Earth Metal");
        ...
        public static final TagData TRANSITION_METAL = TagData
            .createTagData("ATOMIC.TRANSITION_METAL", "Transition Metal");
        /** If this Material is a Post Transition Metal according to the periodic Table of Elements */
        public static final TagData POST_TRANSITION_METAL = TagData
            .createTagData("ATOMIC.POST_TRANSITION_METAL", "Post Transition Metal");
        ...
        public static final TagData POLYATOMIC_NONMETAL = TagData
            .createTagData("ATOMIC.POLYATOMIC_NONMETAL", "Polyatomic Non-Metal");
        /** If this Material is a Diatomic Nonmetal according to the periodic Table of Elements */
        public static final TagData DIATOMIC_NONMETAL = TagData
            .createTagData("ATOMIC.DIATOMIC_NONMETAL", "Diatomic Non-Metal");
        ...
        public static final TagData MANGANESE_GROUP = TagData
            .createTagData("ATOMIC.MANGANESE_GROUP", "Manganese Group");
        ...
        /**
         * If this Material is a Noble Metal according to the periodic Table of Elements: Only for Gold, Silver and
         * Copper
         */
        ...
        public static final TagData REFRACTORY_METAL = TagData
            .createTagData("ATOMIC.REFRACTORY_METAL", "Refractory Metal");
    ...
    public static class Properties {
        ...
        public static final TagData MAGNETIC_PASSIVE = TagData
            .createTagData("PROPERTIES.MAGNETIC_PASSIVE", "Passively Magnetic");
        /** If this Material is actively Magnetic */
        public static final TagData MAGNETIC_ACTIVE = TagData
            .createTagData("PROPERTIES.MAGNETIC_ACTIVE", "Actively Magnetic");
        /** If this Material is making Tools auto-collect */
        public static final TagData AUTO_COLLECTING = TagData
            .createTagData("PROPERTIES.AUTO_COLLECTING", "Auto-Collecting");
        /** If this Material is Ender Dragon Proof. */
        public static final TagData ENDER_DRAGON_PROOF = TagData
            .createTagData("PROPERTIES.ENDER_DRAGON_PROOF", "Ender Dragon Proof");
        ...
        public static final TagData NO_ADVANCED_TOOLS = TagData
            .createTagData("PROPERTIES.NO_ADVANCED_TOOLS", "No Advanced Tools");
        /** If this Material has Tool Stats. */
        public static final TagData HAS_TOOL_STATS = TagData
            .createTagData("PROPERTIES.HAS_TOOL_STATS", "Has Tool Stats");
        ...
        public static final TagData EXPLODES_IN_NONVANILLA_CRAFTING_GRID = TagData.createTagData(
            "PROPERTIES.EXPLODES_IN_NONVANILLA_CRAFTING_GRID",
            "Explodes in Non-Vanilla Crafting Tables!");
        /** If this Material is generated among the random small Gem Ores. */
        public static final TagData RANDOM_SMALL_GEM_ORE = TagData
            .createTagData("PROPERTIES.RANDOM_SMALL_GEM_ORE", "Random Small Gem Ore");
        /**
         * If this Material is only Unificatable in Recipes (for example Wood, which has many variations depending on
         * from which Tree it comes from)
         */
        public static final TagData AUTO_BLACKLIST = TagData
            .createTagData("PROPERTIES.AUTO_BLACKLIST", "Auto Blacklist");
        /**
         * If this Material is not a valid Material Name and therefore doesn't get unificated at all. This mainly gets
         * used for technical Materials.
         */
        public static final TagData AUTO_MATERIAL = TagData
            .createTagData("PROPERTIES.AUTO_MATERIAL", "Automatic Material");
        /**
         * If this Material is not a valid Material Name and therefore doesn't get unificated at all. This mainly gets
         * used for technical Materials.
         */
        public static final TagData INVALID_MATERIAL = TagData
            .createTagData("PROPERTIES.INVALID_MATERIAL", "Invalid Material");
        public static final TagData UNUSED_MATERIAL = TagData
            .createTagData("PROPERTIES.UNUSED_MATERIAL", "Unused Material");
        public static final TagData IGNORE_IN_COLOR_LOG = TagData
            .createTagData("PROPERTIES.IGNORE_IN_COLOR_LOG", "Ignored in Color Log");
        /** If this Material should not be shown with the Contains X Tooltip. */
        public static final TagData DONT_SHOW_THIS_COMPONENT = TagData
            .createTagData("PROPERTIES.DONT_SHOW_THIS_COMPONENT", "Not shown as Component");
        ...
        public static final List<TagData> ALL = new ArrayListNoNulls<>(
            Arrays.asList(
                ...
                IGNORE_IN_COLOR_LOG,
                UNUSED_MATERIAL,
                DONT_SHOW_THIS_COMPONENT));
        /** Contains all relevant Property Tags. */
        public static final List<TagData> ALL_RELEVANTS = new ArrayListNoNulls<>(
            Arrays.asList(
                ACID,
                WOOD,
                FOOD,
    ...
    public static class Compounds {
        ...
        /**
         * If this Material is some kind of Metallurgic Alloy (For Mods which automatically create Alloys in Smelteries
         * or similar if the Components are there)
         */
        ...
        /**
         * If this Material is only vaguely decomposable. An example for that would be Gravel, Dirt or Clay, where no
         * one knows the exact Components or hidden things.
         */
        public static final TagData APPROXIMATE = TagData
            .createTagData("COMPOUNDS.APPROXIMATE", "Approximate Components");

        /**
         * If this Material is decomposable by any means. This must be added when the Material can be reversed by any
         * means, to prevent people from making it acquirable by cheaper means, causing exploits.
         */
    ...
    public static class Processing {
        ...
        /**
         * If this Material is not recyclable in the IC2 Recycler or similar. This means it is blacklisted
         * automatically.
         */
        ...
        public static final TagData CRUCIBLE_ALLOY = TagData
            .createTagData("PROCESSING.CRUCIBLE_ALLOY", "Crucible Alloyable");
        ...
        public static final TagData EXTRUDER_SIMPLE = TagData
            .createTagData("PROCESSING.EXTRUDABLE_SIMPLE", "Extrudable (Low Tech)");
        ...
        public static final TagData FUSION = TagData
            .createTagData("PROCESSING.FUSION_SYNTHESISABLE", "Fusion Synthesisable");
        ...
        public static final TagData COOL2CRYSTAL = TagData
            .createTagData("PROCESSING.COOL2CRYSTAL", "Cools into Crystalline Form");
        ...
        public static final TagData NEVER_FURNACE = TagData
            .createTagData("PROCESSING.NEVER_FURNACE", "Never Furnace Smeltable");
        ...
        public static final TagData BLACKLISTED_SMELTER = TagData
            .createTagData("PROCESSING.BLACKLISTED_SMELTER", "Not Meltable in a Smelter");

        public static final TagData CRYSTALLISABLE = TagData
            .createTagData("PROCESSING.CRYSTALLISABLE", "Crystallisable");

        public static final TagData REACTS_WITH_GLASS = TagData
            .createTagData("PROCESSING.REACTS_WITH_GLASS", "Reacts with Glass");

        public static final TagData SOLDERING_MATERIAL = TagData
            .createTagData("PROCESSING.SOLDERING_MATERIAL", "Soldering Metal");
        public static final TagData SOLDERING_MATERIAL_BAD = TagData
            .createTagData("PROCESSING.SOLDERING_MATERIAL_BAD", "Bad Soldering Metal");
        public static final TagData SOLDERING_MATERIAL_GOOD = TagData
            .createTagData("PROCESSING.SOLDERING_MATERIAL_GOOD", "Good Soldering Metal");

        public static final TagData WASHING_FIRESTONE = TagData
            .createTagData("PROCESSING.WASHING_FIRESTONE", "Firestone Washable");
        public static final TagData WASHING_PERSULFATE = TagData
            .createTagData("PROCESSING.WASHING_PERSULFATE", "Persulfate Washable"),
            WASHING_SODIUMPERSULFATE = WASHING_PERSULFATE;
        public static final TagData WASHING_MERCURY = TagData
            .createTagData("PROCESSING.WASHING_MERCURY", "Mercury Washable");

        public static final TagData PULVERIZING_CINNABAR = TagData
            .createTagData("PROCESSING.PULVERIZING_CINNABAR", "Cinnabar Crystal from Pulverisation");

        public static final List<TagData> ALL_MACHINES = new ArrayListNoNulls<>(
            Arrays.asList(
                CRYSTALLISABLE,
                CRUCIBLE_ALLOY,
                FURNACE,
                ...
                UNRECYCLABLE,
                SOLDERING_MATERIAL));
        public static final List<TagData> ALL_ORES = new ArrayListNoNulls<>(
            Arrays
                .asList(CRYSTALLISABLE, WASHING_FIRESTONE, WASHING_PERSULFATE, WASHING_MERCURY, PULVERIZING_CINNABAR));
    }
    ...
    public static class ItemGenerator {
        ...
        public static final TagData LIQUID = TagData.createTagData("ITEMGENERATOR.LIQUID"),
            ...
            GEMS = TagData.createTagData("ITEMGENERATOR.GEMS"), ORES = TagData.createTagData("ITEMGENERATOR.ORES"),
            EMPTY = TagData.createTagData("ITEMGENERATOR.EMPTY"), DUSTS = TagData.createTagData("ITEMGENERATOR.DUSTS"),
            TOOLS = TagData.createTagData("ITEMGENERATOR.TOOLS"), // NO LONGER USED
            PARTS = TagData.createTagData("ITEMGENERATOR.PARTS"), PIPES = TagData.createTagData("ITEMGENERATOR.PIPES"),
            WIRES = TagData.createTagData("ITEMGENERATOR.WIRES"), FOILS = TagData.createTagData("ITEMGENERATOR.FOILS"),
        ...
        public static final TagData[] G_ALL = new TagData[] { GEMS, ORES, EMPTY, DUSTS, PARTS, PIPES, WIRES, FOILS,
            RAILS, LENSES, STICKS, ARMORS, INGOTS, INGOTS_HOT, PLATES, PLANTS, PROJECTILES, CONTAINERS, MULTIINGOTS,
            MULTIPLATES, DENSEPLATES, CONTAINERS_GAS, CONTAINERS_SOLID, CONTAINERS_FLUID, CONTAINERS_PLASMA },
            G_CONTAINERS = new TagData[] { CONTAINERS, PLANTS }, G_DUST = new TagData[] { DUSTS, PLANTS },
            ...
            G_PEARL_TRANSPARENT = new TagData[] { PROJECTILES, DUSTS, PLANTS, PLATES, GEMS, LENSES,
                TD.Properties.TRANSPARENT },
            G_GLASS = new TagData[] { PROJECTILES, DUSTS, PLANTS, PLATES, STICKS, GEMS, ARMORS, LENSES,
                TD.Properties.TRANSPARENT },
            ...
            G_GEM_TRANSPARENT = new TagData[] { PROJECTILES, DUSTS, PLANTS, PLATES, STICKS, GEMS, ARMORS, LENSES,
                TD.Properties.TRANSPARENT },
            G_GEM_ORES_TRANSPARENT = new TagData[] { PROJECTILES, DUSTS, PLANTS, PLATES, STICKS, GEMS, ARMORS, LENSES,
                TD.Properties.TRANSPARENT, ORES },
            ...
            G_INGOT = new TagData[] { PROJECTILES, DUSTS, PLANTS, PLATES, STICKS, ARMORS, INGOTS, INGOTS_HOT,
                MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS },
            G_INGOT_ORES = new TagData[] { PROJECTILES, DUSTS, PLANTS, PLATES, STICKS, ARMORS, INGOTS, INGOTS_HOT,
                MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS, ORES },
            G_INGOT_MACHINE = new TagData[] { PROJECTILES, DUSTS, PLANTS, PLATES, STICKS, ARMORS, INGOTS, INGOTS_HOT,
                MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS, PARTS },
            G_INGOT_MACHINE_ORES = new TagData[] { PROJECTILES, DUSTS, PLANTS, PLATES, STICKS, ARMORS, INGOTS,
                INGOTS_HOT, MULTIINGOTS, DENSEPLATES, MULTIPLATES, FOILS, PARTS, ORES },
            G_INGOT_ND = new TagData[] { PROJECTILES, PLATES, STICKS, ARMORS, INGOTS, INGOTS_HOT, MULTIINGOTS,
                DENSEPLATES, MULTIPLATES, FOILS },
            G_INGOT_ND_MACHINE = new TagData[] { PROJECTILES, PLATES, STICKS, ARMORS, INGOTS, INGOTS_HOT, MULTIINGOTS,
                DENSEPLATES, MULTIPLATES, FOILS, PARTS },
