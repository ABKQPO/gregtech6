...
public enum FL {
    ...
    public static FluidStack lube(long aAmount) {
        return LubRoCant.make(aAmount, Lubricant);
    }

    public int id() {
        return FluidRegistry.getFluidID(mName);
    }
    ...
    public ItemStack display() {
        return display(make(0), F, F);
    }

    public ItemStack display(long aAmount) {
        return display(make(aAmount), aAmount, F, F);
    }

    public FluidStack make(long aAmount) {
        return make(mName, aAmount);
    }

    public FluidStack make_(long aAmount) {
        return make_(mName, aAmount);
    }

    public FluidStack make(long aAmount, String aReplacement) {
        return make(mName, aAmount, aReplacement);
    }

    public FluidStack make_(long aAmount, String aReplacement) {
        return make_(mName, aAmount, aReplacement);
    }

    public FluidStack make(long aAmount, FL aReplacement) {
        return make(mName, aAmount, aReplacement.mName);
    }

    public FluidStack make_(long aAmount, FL aReplacement) {
        return make_(mName, aAmount, aReplacement.mName);
    }

    public FluidStack make(long aAmount, String aReplacement, long aReplacementAmount) {
        return make(mName, aAmount, aReplacement, aReplacementAmount);
    }

    public FluidStack make_(long aAmount, String aReplacement, long aReplacementAmount) {
        return make_(mName, aAmount, aReplacement, aReplacementAmount);
    }

    public FluidStack make(long aAmount, FL aReplacement, long aReplacementAmount) {
        return make(mName, aAmount, aReplacement.mName, aReplacementAmount);
    }

    public FluidStack make_(long aAmount, FL aReplacement, long aReplacementAmount) {
        return make_(mName, aAmount, aReplacement.mName, aReplacementAmount);
    }

    public boolean is(IFluidTank aTank) {
        return is(aTank.getFluid());
    }

    public boolean is(FluidStack aFluid) {
        return aFluid != null && is(aFluid.getFluid());
    }

    public boolean is(Fluid aFluid) {
        return aFluid != null && is(aFluid.getName());
    }

    public boolean is(String aFluidName) {
        return mName.equalsIgnoreCase(aFluidName);
    }

    public boolean is(Collection<String> aFluidSet) {
        return aFluidSet.contains(mName);
    }

    public ItemStack fill(ItemStack aStack) {
        return fill(make(Integer.MAX_VALUE), aStack, F, T, T, F);
    }
    ...
    public static ArrayListNoNulls<FluidStack> arraylist(FluidStack... aFluids) {
        return new ArrayListNoNulls<>(F, aFluids);
    }

    public static FluidStack[] array(FluidStack... aFluids) {
        return aFluids;
    }

    public static String regName(IFluidTank aTank) {
        return aTank == null ? null : regName_(aTank);
    }

    public static String regName_(IFluidTank aTank) {
        return regName(aTank.getFluid());
    }

    public static String regName(FluidStack aFluid) {
        return aFluid == null ? null : regName_(aFluid);
    }

    public static String regName_(FluidStack aFluid) {
        return regName(aFluid.getFluid());
    }
    ...
    public static String regName_(Fluid aFluid) {
        return aFluid.getName();
    }

    public static short id(IFluidTank aTank) {
        return aTank == null ? -1 : id_(aTank);
    }

    public static short id_(IFluidTank aTank) {
        return id(aTank.getFluid());
    }

    public static short id(FluidStack aFluid) {
        return aFluid == null ? -1 : id_(aFluid);
    }

    public static short id_(FluidStack aFluid) {
        return id(aFluid.getFluid());
    }

    public static short id(Fluid aFluid) {
        return aFluid == null ? -1 : id_(aFluid);
    }

    public static short id_(Fluid aFluid) {
        return (short) FluidRegistry.getFluidID(aFluid);
    } // catch(Throwable e) {ERR.println("What the fuck?! Why does the Fluid Registry Crash!? Who is responsible for
      // this?!"); e.printStackTrace(ERR);} return -1;}
    ...
    public static boolean valid(Fluid aFluid) {
        return aFluid != null && !FL.Error.is(aFluid.getName());
    }

    public static boolean invalid(Fluid aFluid) {
        return aFluid == null || FL.Error.is(aFluid.getName());
    }

    public static boolean valid(FluidStack aFluid) {
        return aFluid != null && valid(aFluid.getFluid());
    }

    public static boolean invalid(FluidStack aFluid) {
        return aFluid == null || invalid(aFluid.getFluid());
    }

    public static boolean nonzero(FluidStack aFluid) {
        return aFluid != null && aFluid.amount > 0 && valid(aFluid.getFluid());
    }

    public static boolean zero(FluidStack aFluid) {
        return aFluid == null || aFluid.amount < 1 || invalid(aFluid.getFluid());
    }
    ...
    public static boolean exists(String aFluidName) {
        return aFluidName != null && fluid_(aFluidName) != null;
    }

    public static ItemStack display(Fluid aFluid) {
        return aFluid == null ? null : display(make(aFluid, 0), F, F, T);
    }

    public static ItemStack display(FluidStack aFluid, boolean aUseStackSize, boolean aLimitStackSize) {
        return display(aFluid, aUseStackSize, aLimitStackSize, T);
    }

    public static ItemStack display(FluidStack aFluid, boolean aUseStackSize, boolean aLimitStackSize,
        boolean aUseBucketSize) {
        return display(aFluid, aFluid == null ? 0 : aFluid.amount, aUseStackSize, aLimitStackSize, aUseBucketSize);
    }
    ...
    public static ItemStack display(FluidStack aFluid, long aAmount, boolean aUseStackSize, boolean aLimitStackSize) {
        return display(aFluid, aAmount, aUseStackSize, aLimitStackSize, T);
    }
    ...
    public static ItemStack display(FluidStack aFluid, long aAmount, boolean aUseStackSize, boolean aLimitStackSize,
        ...
        ItemStack rStack = IL.Display_Fluid.getWithMeta(
            Math.max(
                1,
                aUseStackSize
                    ? aUseBucketSize ? aLimitStackSize ? UT.Code.bind7(aAmount / 1000) : aAmount / 1000
                        : aLimitStackSize ? UT.Code.bind7(aAmount) : aAmount
                    : 1),
            aID);
    ...
    public static FluidStack[] waters(long aWater) {
        return waters(aWater, aWater, aWater);
    }

    public static FluidStack[] waters(long aWater, long aDistilled) {
        return waters(aWater, aDistilled, aWater);
    }

    public static FluidStack[] waters(long aWater, long aDistilled, long aSpectralDew) {
        return FL.array(
            FL.Water.make(aWater),
            FL.MnWtr.make(aWater),
            FL.DistW.make(aDistilled),
            FL.SpDew.make(aSpectralDew));
    }
    ...
    public static boolean water(Fluid aFluid) {
        return aFluid != null && WATER.contains(aFluid.getName());
    }
    ...
    public static boolean lava(Fluid aFluid) {
        return aFluid == FluidRegistry.LAVA;
    }
    ...
    public static boolean milk(Fluid aFluid) {
        return FL.Milk.is(aFluid) || FL.MilkGrC.is(aFluid);
    }
    ...
    public static boolean magic(IFluidTank aFluid) {
        return aFluid != null && magic(aFluid.getFluid());
    }

    public static boolean magic(FluidStack aFluid) {
        return aFluid != null && magic(aFluid.getFluid());
    }

    public static boolean magic(Fluid aFluid) {
        return aFluid != null && FluidsGT.MAGIC.contains(aFluid.getName());
    }
    ...
    public static boolean heavier(BlockFluidBase aFluid) {
        return aFluid != null && heavier(aFluid.getFluid());
    }

    public static boolean heavier(IFluidTank aFluid) {
        return aFluid != null && heavier(aFluid.getFluid());
    }

    public static boolean heavier(FluidStack aFluid) {
        return aFluid != null && aFluid.getFluid() != null
            && aFluid.getFluid()
                .getDensity(aFluid) > 0;
    }

    public static boolean heavier(Fluid aFluid) {
        return aFluid != null && aFluid.getDensity(make(aFluid, 1000)) > 0;
    }
    ...
    public static FluidStack make(int aFluid, long aAmount) {
        return aFluid < 0 ? null : make(fluid(aFluid), Code.bindInt(aAmount));
    }
    ...
    public static FluidStack make(String aFluidName, long aAmount) {
        return make(fluid(aFluidName), aAmount);
    }
    ...
    public static FluidStack make_(int aFluid, long aAmount) {
        return aFluid < 0 ? FL.Error.make(0) : make(fluid(aFluid), Code.bindInt(aAmount));
    }
    ...
    public static FluidStack make_(String aFluidName, long aAmount) {
        return make_(fluid(aFluidName), aAmount);
    }
    ...
    public static long move_(@SuppressWarnings("rawtypes") DelegatorTileEntity aFrom,
        ...
        FluidStack tDrained = ((IFluidHandler) aFrom.mTileEntity).drain(aFrom.getForgeSideOfTileEntity(), aMoved, F);
        if (tDrained == null || tDrained.amount <= 0) return 0;
        tDrained.amount = Code.bindInt(fill_(aTo, tDrained.copy(), T));
        if (tDrained.amount <= 0) return 0;
        ((IFluidHandler) aFrom.mTileEntity).drain(aFrom.getForgeSideOfTileEntity(), tDrained, T);
    ...
    public static long move(IFluidTank aFrom, @SuppressWarnings("rawtypes") DelegatorTileEntity aTo, long aMaxMoved) {
        return aFrom != null && aTo != null && aTo.mTileEntity instanceof IFluidHandler ? move_(aFrom, aTo, aMaxMoved)
            : 0;
    }
    ...
    public static long move_(IFluidTank[] aFrom, @SuppressWarnings("rawtypes") DelegatorTileEntity aTo,
        ...
        if (aMaxMoved <= 0) return 0;
        long rAmount = 0;
        for (IFluidTank tFrom : aFrom) if (tFrom != null) rAmount += move_(tFrom, aTo, aMaxMoved - rAmount);
        return rAmount;
    }
    ...
    public static long move_(@SuppressWarnings("rawtypes") Iterable aFrom,
        ...
        for (Object tFrom : aFrom)
            if (tFrom instanceof IFluidTank) rAmount += move_((IFluidTank) tFrom, aTo, aMaxMoved - rAmount);
        return rAmount;
    }
    ...
    public static String name(Fluid aFluid, boolean aLocalized) {
        ...
        if (rName.startsWith("fluid.") || rName.startsWith("tile.") || rName.startsWith("rc ")) {
            rName = Code.capitaliseWords(
                rName.replaceFirst("fluid.", "")
                    .replaceFirst("tile.", "")
                    .replaceFirst("rc ", ""));
        }
        return aFluid.getName()
            .startsWith("rc ") ? "Reika's " + rName : rName;
    }
    ...
    public static void reg(FluidStack aFluid, ItemStack aFull, ItemStack aEmpty, boolean aOverrideFillingEmpty,
    ...
    public static ItemStack fill(FluidStack aFluid, ItemStack aStack, boolean aRemoveFluidDirectly,
    ...
    public static ItemStack fill(FluidStack aFluid, ItemStack aStack, boolean aRemoveFluidDirectly,
        ...
        if (aCheckIFluidContainerItems && aStack.getItem() instanceof IFluidContainerItem
            ...
            && (((IFluidContainerItem) aStack.getItem()).getFluid(aStack) == null
                || (equal(((IFluidContainerItem) aStack.getItem()).getFluid(aStack), aFluid)
    ...
    public static ItemStack fill(IFluidTank aTank, ItemStack aStack, boolean aRemoveFluidDirectly,
        boolean aCheckIFluidContainerItems) {
    ...
    public static FluidStack load(NBTTagCompound aNBT) {
        return aNBT == null || aNBT.hasNoTags() ? null : load_(aNBT);
    }
    ...
    public static NBTTagCompound save(FluidStack aFluid) {
        return aFluid == null || aFluid.getFluid() == null ? null : save_(aFluid);
    }

    /** Saves a FluidStack properly. */
    public static NBTTagCompound save_(FluidStack aFluid) {
        return aFluid.writeToNBT(NBT.make());
    }
    ...
    public static Fluid createLiquid(OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {
        return create(
            ...
            aMaterial.mMeltingPoint <= 0 ? 1000
                : aMaterial.mMeltingPoint < 300 ? Math.min(300, aMaterial.mBoilingPoint - 1) : aMaterial.mMeltingPoint,
            null,
            null,
            0,
            aFluidList);
    ...
    public static Fluid createGas(OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {
        return create(
            ...
            aMaterial.mBoilingPoint <= 0 ? 3000
                : aMaterial.mBoilingPoint < 300 ? Math.min(300, aMaterial.mPlasmaPoint - 1) : aMaterial.mBoilingPoint,
            null,
            null,
            0,
            aFluidList);
    ...
    public static Fluid create(String aName, String aLocalized, OreDictMaterial aMaterial, int aState,
        Set<String>... aFluidList) {
        return create(aName, aLocalized, aMaterial, aState, 1000, 300, null, null, 0, aFluidList);
    }

    @SafeVarargs
    public static Fluid create(String aName, String aLocalized, OreDictMaterial aMaterial, int aState,
        long aAmountPerUnit, long aTemperatureK, Set<String>... aFluidList) {
        return create(aName, aLocalized, aMaterial, aState, aAmountPerUnit, aTemperatureK, null, null, 0, aFluidList);
    }

    @SafeVarargs
    public static Fluid create(String aName, String aLocalized, OreDictMaterial aMaterial, int aState,
        long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer, int aFluidAmount,
        Set<String>... aFluidList) {
        return create(
            aName,
    ...
    public static Fluid create(String aName, IIconContainer aTexture, String aLocalized, OreDictMaterial aMaterial,
        ...
        aLocalized = (aLocalized == null
            ? aMaterial == null || aMaterial == MT.NULL ? UT.Code.capitaliseWords(aName) : aMaterial.getLocal()
            : aLocalized);
        ...
        if (aMaterial != null) {
            ...
            switch (aState) {
                case STATE_LIQUID:
                    aMaterial.liquid(make(rFluid, UT.Code.bindInt(aAmountPerUnit)));
                    break;
                case STATE_GASEOUS:
                    aMaterial.gas(make(rFluid, UT.Code.bindInt(aAmountPerUnit)));
                    break;
                case STATE_PLASMA:
                    aMaterial.plasma(make(rFluid, UT.Code.bindInt(aAmountPerUnit)));
                    break;
            }
        ...
        if (aFullContainer != null && aEmptyContainer != null
            && !FluidContainerRegistry
                .registerFluidContainer(make(rFluid, aFluidAmount), aFullContainer, aEmptyContainer)) {
