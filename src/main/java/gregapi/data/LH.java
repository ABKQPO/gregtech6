...
public class LH {
    ...
    public static final String EFFICIENCY = "gt.lang.efficiency", RECIPE = "gt.lang.recipe",
        RECIPES = "gt.lang.recipes", RECIPES_MOLD = "gt.lang.recipes.mold",
        RECIPES_MOLD_SELECT = "gt.lang.recipes.mold.select", RECIPES_MOLD_COINAGE = "gt.lang.recipes.mold.coinage",
        RECIPES_ANVIL_USAGE = "gt.lang.recipes.anvil.usage", RECIPES_SIFTER_USAGE = "gt.lang.recipes.sifter.usage",
        RECIPES_JUICER_USAGE = "gt.lang.recipes.juicer.usage", RECIPES_MORTAR_USAGE = "gt.lang.recipes.mortar.usage",
        ...
        RECIPES_GRINDSTONE_INIT = "gt.lang.recipes.grindstone.init", RECIPES_DUSTFUNNEL = "gt.lang.recipes.dustfunnel",
        RECIPES_AUTOHAMMER = "gt.lang.recipes.autohammer", RECIPES_IGNITER = "gt.lang.recipes.igniter",
        RECIPES_QUALITY = "gt.lang.recipes.quality", STRUCTURE = "gt.lang.structure", RANGE = "gt.lang.range",
        ENERGY_CONTAINED = "gt.lang.energy.contained", ENERGY_CAPACITY = "gt.lang.energy.capacity",
        ENERGY_OUTPUT = "gt.lang.energy.output", ENERGY_INPUT = "gt.lang.energy.input",
        ITEM_OUTPUT = "gt.lang.item.output", ITEM_INPUT = "gt.lang.item.input", FLUID_OUTPUT = "gt.lang.fluid.output",
        FLUID_INPUT = "gt.lang.fluid.input", CONVERTS_FROM_X = "gt.lang.energy.convert.from",
        CONVERTS_TO_Y = "gt.lang.energy.convert.to", CONVERTS_USING_Z = "gt.lang.energy.convert.using",
        CONVERTS_PER_Z = "gt.lang.energy.convert.per", FACE_ANY = "gt.lang.face.any",
        FACE_BOTTOM = "gt.lang.face.bottom", FACE_TOP = "gt.lang.face.top", FACE_LEFT = "gt.lang.face.left",
        FACE_FRONT = "gt.lang.face.front", FACE_RIGHT = "gt.lang.face.right", FACE_BACK = "gt.lang.face.back",
        FACE_NONE = "gt.lang.face.none",
        FACES[] = { FACE_BOTTOM, FACE_TOP, FACE_LEFT, FACE_FRONT, FACE_RIGHT, FACE_BACK, FACE_NONE },
        FACE_SIDES = "gt.lang.face.sides", FACE_FRONT_BACK = "gt.lang.face.front.back",
        FACE_ANYBUT_FRONT_BACK = "gt.lang.face.any.but.front.back", FACE_ANYBUT_BOTTOM = "gt.lang.face.any.but.bottom",
        FACE_ANYBUT_TOP = "gt.lang.face.any.but.top", FACE_ANYBUT_LEFT = "gt.lang.face.any.but.left",
        FACE_ANYBUT_FRONT = "gt.lang.face.any.but.front", FACE_ANYBUT_RIGHT = "gt.lang.face.any.but.right",
        FACE_ANYBUT_BACK = "gt.lang.face.any.but.back", FACE_ANYBUT_SIDES = "gt.lang.face.any.but.sides",
        ...
        REQUIREMENT_WATER = "gt.lang.requirement.water", REQUIREMENT_WATER_ANY = "gt.lang.requirement.water.any",
        ...
        REQUIREMENT_UNSTACKED = "gt.lang.requirement.unstacked", EMITS_USED_STEAM = "gt.lang.emits.used.steam",
        ...
        NO_GUI_FUNNEL_TO_TANK = "gt.lang.nogui.funnel.tank", NO_GUI_TAP_TO_TANK = "gt.lang.nogui.tap.tank",
        NO_POWER_CONDUCTING_FLUIDS = "gt.lang.no.powerconducting.fluids", OWNER_CONTROLLED = "gt.lang.owner.controlled",
        CHEAP_OVERCLOCKING = "gt.lang.cheap.overclocking", KEY_CONTROLLED = "gt.lang.key.controlled",
        COVER_TOOLTIP = "gt.lang.cover.tooltip", TOOL_TO_SET_FACING_PRE = "gt.lang.use.x.to.toggle.facing.pre",
        ...
        TOOL_TO_RESET_SOFT_HAMMER = "gt.lang.use.soft.hammer.to.reset", TOOL_TO_TAPE = "gt.lang.use.tape",
        TOOL_TO_UNTAPE = "gt.lang.use.untape", TOOL_TO_OPEN_CROWBAR = "gt.lang.use.crowbar.to.open",
        ...
        TOOL_TO_ACCESS_SCOOP = "gt.lang.use.scoop.to.access", TOOL_TO_REMOVE_SHOVEL = "gt.lang.use.shovel.to.empty",
        TOOL_TO_CHANGE_DESIGN_CHISEL = "gt.lang.use.chisel.to.switch.design",
        TOOL_TO_HARVEST = "gt.lang.tool.to.harvest", TOOL_TO_TAKE_PINCERS = "gt.lang.use.pincers.to.take",
        TOOL_HINT_USE_SNEAK = "gt.lang.tool.hint.use.sneak",
        WEAPON_SNEAK_RIGHTCLICK_TO_RELOAD = "gt.weapon.sneak.rightclick.reload",
        WIRE_STATS_LOSSLESS = "gt.lang.wire.stats.lossless", WIRE_STATS_LOSS = "gt.lang.wire.stats.loss",
        WIRE_STATS_VOLTAGE = "gt.lang.wire.stats.voltage", WIRE_STATS_AMPERAGE = "gt.lang.wire.stats.amperage",
        PIPE_STATS_LOSS = "gt.lang.pipe.stats.loss", PIPE_STATS_RANGE = "gt.lang.pipe.stats.range",
        PIPE_STATS_STEPSIZE = "gt.lang.pipe.stats.stepsize", PIPE_STATS_BANDWIDTH = "gt.lang.pipe.stats.bandwidth",
        PIPE_STATS_CAPACITY = "gt.lang.pipe.stats.capacity", PIPE_STATS_AMOUNT = "gt.lang.pipe.stats.amount",
        AXLE_STATS_SPEED = "gt.lang.axle.stats.speed", AXLE_STATS_POWER = "gt.lang.axle.stats.power",
        HAZARD_FIRE = "gt.lang.hazard.fire", HAZARD_EXPLOSION_STEAM = "gt.lang.hazard.explosion.steam",
        HAZARD_MELTDOWN = "gt.lang.hazard.meltdown", HAZARD_CONTACT = "gt.lang.hazard.contact",
        HAZARD_LEAKING_GAS = "gt.lang.hazard.leak.gas", TOOLTIP_GASPROOF = "gt.lang.proof.gas",
        TOOLTIP_ACIDPROOF = "gt.lang.proof.acid", TOOLTIP_MAGICPROOF = "gt.lang.proof.magic",
        TOOLTIP_LIQUIDPROOF = "gt.lang.proof.liquid", TOOLTIP_PLASMAPROOF = "gt.lang.proof.plasma",
        TOOLTIP_HEATPROOF = "gt.lang.proof.heat", TOOLTIP_THERMALMASS = "gt.lang.thermal.mass",
        TOOLTIP_ONLY_SIMPLE = "gt.lang.only.simple", TOOLTIP_REMINDER_EXTENDERS = "gt.lang.reminder.extenders",
        TOOLTIP_SEALABLE_ANY = "gt.lang.sealable.any", TOOLTIP_SEALABLE_SOME = "gt.lang.sealable.some",
        TOOLTIP_SEALABLE_BUGGED = "gt.lang.sealable.bug", TOOLTIP_PISTONPUSHABLE = "gt.lang.pistonpush",
        TOOLTIP_SPAWNPROOF = "gt.lang.spawnproof", TOOLTIP_SPAWNPROOF_OPTIFINE = "gt.lang.spawnproof.optifine",
        ...
        TOOLTIP_SPAWNPROOF_SP_BROKEN = "gt.lang.spawnproof.sp.broken", TOOLTIP_BLASTPOWER = "gt.lang.blastpower",
        TOOLTIP_BLASTRANGE = "gt.lang.blastrange", TOOLTIP_BLASTFORTUNE = "gt.lang.blastfortune",
        TOOLTIP_BLASTRESISTANCE = "gt.lang.blastresistance", TOOLTIP_FURNACE_FUEL = "gt.lang.furnacefuel",
        TOOLTIP_RAILSPEED = "gt.lang.railspeed", TOOLTIP_WALKSPEED = "gt.lang.walkspeed",
        TOOLTIP_GRAVITY = "gt.lang.gravity", TOOLTIP_NEEDS_HANDLE = "gt.lang.needs.handle",
        TOOLTIP_NEEDS_SHARPENING = "gt.lang.needs.sharpening", TOOLTIP_SHAPELESS_CRAFT = "gt.lang.has.shapeless",
        TOOLTIP_AUTOCOLLECT = "gt.lang.autocollect", TOOLTIP_ARMOR_PENETRATING = "gt.lang.armorpenetrating",
        TOOLTIP_BEACON_PAYMENT = "gt.lang.beacon.payment", TOOLTIP_SHELFABLE = "gt.lang.shelfable",
        TOOLTIP_SANDWICHABLE = "gt.lang.sandwichable", TOOLTIP_POSSIBLE_ENCHANTS = "gt.lang.tool.possible.enchants",
        ...
        TOOLTIP_FLAMMABLE_AND_EXPLOSIVE = "gt.lang.flammable.explosive", TOOLTIP_FLAMMABLE = "gt.lang.flammable",
        TOOLTIP_EXPLOSIVE = "gt.lang.explosive", TOOLTIP_UNBURNABLE = "gt.lang.unburnable",
        ...
        TOOLTIP_ENCHANT_BONUS = "gt.lang.enchantment.bonus", TOOLTIP_THAUMCRAFT_WARP = "gt.lang.thaumcraft.warp",
        ...
        PROSPECTING_LAVA = "gt.lang.prospecting.lava", PROSPECTING_LIQUID = "gt.lang.prospecting.liquid",
        PROSPECTING_AIR = "gt.lang.prospecting.air", PROSPECTING_CHANGE = "gt.lang.prospecting.change",
        PROSPECTING_TRACES = "gt.lang.prospecting.traces", PROSPECTING_NOTHING = "gt.lang.prospecting.nothing",
        ...
        ADVCRAFTING_NEUTRAL_SLOT = "gt.advcrafting.neutral.slot", ADVCRAFTING_DROP_SLOT = "gt.advcrafting.drop.slot",
        TIME_TICK = "gt.lang.time.tick", TIME_SEC = "gt.lang.time.second", TIME_MIN = "gt.lang.time.minute",
        TIME_HOUR = "gt.lang.time.hour", TIME_DAY = "gt.lang.time.day", TIME_WEEK = "gt.lang.time.week",
        TIME_TICKS = "gt.lang.time.ticks", TIME_SECS = "gt.lang.time.seconds", TIME_MINS = "gt.lang.time.minutes",
        TIME_HOURS = "gt.lang.time.hours", TIME_DAYS = "gt.lang.time.days", TIME_WEEKS = "gt.lang.time.weeks",
        ADMIN_ONLY_CREATION = "gt.lang.admin.only.creation", WIP = "gt.lang.work.in.progress";

    public static final String add(String aKey, String aEnglish) {
        LanguageHandler.add(aKey, aEnglish);
        return aKey;
    }

    public static final String get(String aKey) {
        return LanguageHandler.translate(aKey);
    }

    public static final String get(String aKey, String aDefault) {
        return LanguageHandler.translate(aKey, aDefault);
    }

    public static final String percent(long aNumber) {
        return (aNumber / 100) + ((aNumber % 100) > 9 ? "." + aNumber % 100 : ".0" + (aNumber % 100));
    }

    public static final String getToolTipBlastResistance(Block aBlock, double aResistance) {
        return Chat.WHITE + get(LH.TOOLTIP_BLASTRESISTANCE)
            + Chat.ORANGE
            + ((int) aResistance)
            + "."
            + (((int) (aResistance * 10)) % 10)
            + (aResistance < 4 ? Chat.BLINKING_RED + " " + get(LH.TOOLTIP_BLAST_RESISTANCE_TERRIBLE)
                : aResistance < 12 ? Chat.RED + " " + get(LH.TOOLTIP_BLAST_RESISTANCE_GHAST)
                    : aResistance < 16 ? Chat.YELLOW + " " + get(LH.TOOLTIP_BLAST_RESISTANCE_CREEPER)
                        : aResistance <= 40 ? Chat.GREEN + " " + get(LH.TOOLTIP_BLAST_RESISTANCE_TNT)
                            : aResistance < 3330 || COMPAT_IC2 == null || COMPAT_IC2.isExplosionWhitelisted(aBlock)
                                ? Chat.GREEN + " " + get(LH.TOOLTIP_BLAST_RESISTANCE_DYNAMITE)
                                : Chat.BLINKING_CYAN + " " + get(LH.TOOLTIP_BLAST_RESISTANCE_NOT_NUKE));
    }
    ...
    public static final String getToolTipHarvest(Material aMaterial, String aHarvestTool, int aHarvestLevel) {
        if (aMaterial.isAdventureModeExempt()) {
            if (UT.Code.stringValid(aHarvestTool)) return LH.Chat.DGRAY + "Hand-Harvestable, but "
                + LH.Chat.WHITE
                + LH.get(TOOL_LOCALISER_PREFIX + aHarvestTool, UT.Code.capitalise(aHarvestTool))
                + LH.Chat.DGRAY
                + " is faster";
        ...
        if (UT.Code.stringValid(aHarvestTool)) {
            if (aHarvestLevel > 1) switch (aHarvestLevel) {
                case 1:
                    return LH.Chat.DGRAY + LH.get(LH.TOOL_TO_HARVEST)
                        + ": "
                        + LH.Chat.WHITE
                        + LH.get(TOOL_LOCALISER_PREFIX + aHarvestTool, UT.Code.capitalise(aHarvestTool))
                        + " ("
        ...
        if (aMaterial == Material.rock || aMaterial == Material.iron
            || aMaterial == Material.anvil
            || aMaterial == Material.glass)
            return LH.Chat.DGRAY + LH
                .get(LH.TOOL_TO_HARVEST) + ": " + LH.Chat.WHITE + LH.get(TOOL_LOCALISER_PREFIX + "pickaxe") + "?";
        if (aMaterial == Material.craftedSnow || aMaterial == Material.snow
            || aMaterial == Material.sand
            || aMaterial == Material.grass
            || aMaterial == Material.ground
            || aMaterial == Material.clay)
            return LH.Chat.DGRAY + LH
                .get(LH.TOOL_TO_HARVEST) + ": " + LH.Chat.WHITE + LH.get(TOOL_LOCALISER_PREFIX + "shovel") + "?";
        if (aMaterial == Material.wood || aMaterial == Material.plants
            || aMaterial == Material.vine
            || aMaterial == Material.gourd
            || aMaterial == Material.cactus)
            return LH.Chat.DGRAY + LH
                .get(LH.TOOL_TO_HARVEST) + ": " + LH.Chat.WHITE + LH.get(TOOL_LOCALISER_PREFIX + "axe") + "?";
        if (aMaterial == Material.leaves || aMaterial == Material.cloth
            || aMaterial == Material.carpet
            || aMaterial == Material.web)
            return LH.Chat.DGRAY + LH
                .get(LH.TOOL_TO_HARVEST) + ": " + LH.Chat.WHITE + LH.get(TOOL_LOCALISER_PREFIX + "sword") + "?";
        return LH.Chat.DGRAY + LH.get(LH.TOOL_TO_HARVEST) + ": " + LH.Chat.WHITE + "Unknown";
    }

    public static final String getToolTipEfficiency(long aEfficiency) {
        aEfficiency = Math.abs(aEfficiency);
        return Chat.YELLOW + get(EFFICIENCY) + ": " + Chat.WHITE + percent(aEfficiency) + "%";
    }

    public static final void addToolTipsEfficiency(List<String> aList, ItemStack aStack, boolean aF3_H,
        TE_Behavior_Energy_Converter aConverter) {
        addToolTipsEfficiency(
            aList,
            aStack,
            aF3_H,
            aConverter.mEnergyIN,
            aConverter.mEnergyOUT,
            aConverter.mMultiplier);
    }

    public static final void addToolTipsEfficiency(List<String> aList, ItemStack aStack, boolean aF3_H,
        TE_Behavior_Energy_Stats aEnergyIN, TE_Behavior_Energy_Stats aEnergyOUT, long aMultiplier) {
        if (TD.Energy.ALL_EU.contains(aEnergyIN.mType)) {
            if (TD.Energy.ALL_EU.contains(aEnergyOUT.mType)) {
                aList.add(
                    LH.getToolTipEfficiency(UT.Code.units(10000, aEnergyIN.mRec, aEnergyOUT.mRec * aMultiplier, F)));
            } else {
                if (aEnergyOUT.mType == TD.Energy.RF) aList.add(
                    LH.getToolTipEfficiency(
                        UT.Code.units(10000, aEnergyIN.mRec * RF_PER_EU, aEnergyOUT.mRec * aMultiplier, F)));
            }
        } else {
            if (TD.Energy.ALL_EU.contains(aEnergyOUT.mType)) {
                if (aEnergyIN.mType == TD.Energy.RF) aList.add(
                    LH.getToolTipEfficiency(
                        UT.Code.units(10000, aEnergyIN.mRec, aEnergyOUT.mRec * aMultiplier * RF_PER_EU, F)));
                if (aEnergyIN.mType == TD.Energy.STEAM) aList.add(
                    LH.getToolTipEfficiency(
                        UT.Code.units(10000, aEnergyIN.mRec, aEnergyOUT.mRec * aMultiplier * STEAM_PER_EU, F)));
            }
        }
    }

    public static final void addToolTipsEfficiency(List<String> aList, ItemStack aStack, boolean aF3_H,
        TE_Behavior_Energy_Stats aEnergyIN, TE_Behavior_Energy_Stats aEnergyOUT, TE_Behavior_Energy_Stats aEnergyOUT2,
        long aMultiplier) {
        if (TD.Energy.ALL_EU.contains(aEnergyIN.mType)) {
            if (TD.Energy.ALL_EU.contains(aEnergyOUT.mType)) {
                aList.add(LH.getToolTipEfficiency(UT.Code.units(10000, aEnergyIN.mRec, aEnergyOUT.mRec, F)));
            } else {
                if (aEnergyOUT.mType == TD.Energy.RF) aList
                    .add(LH.getToolTipEfficiency(UT.Code.units(10000, aEnergyIN.mRec * RF_PER_EU, aEnergyOUT.mRec, F)));
            }
            if (TD.Energy.ALL_EU.contains(aEnergyOUT2.mType)) {
                aList.add(LH.getToolTipEfficiency(UT.Code.units(10000, aEnergyIN.mRec, aEnergyOUT.mRec, F)));
            } else {
                if (aEnergyOUT2.mType == TD.Energy.RF) aList
                    .add(LH.getToolTipEfficiency(UT.Code.units(10000, aEnergyIN.mRec * RF_PER_EU, aEnergyOUT.mRec, F)));
            }
        } else {
            if (TD.Energy.ALL_EU.contains(aEnergyOUT.mType) && aEnergyIN.mType == TD.Energy.RF)
                aList.add(LH.getToolTipEfficiency(UT.Code.units(10000, aEnergyIN.mRec, aEnergyOUT.mRec * 8, F)));
            if (TD.Energy.ALL_EU.contains(aEnergyOUT2.mType) && aEnergyIN.mType == TD.Energy.RF)
                aList.add(LH.getToolTipEfficiency(UT.Code.units(10000, aEnergyIN.mRec, aEnergyOUT.mRec * 8, F)));
        }
    }

    public static final void addEnergyToolTips(ITileEntityEnergy aTileEntity, List<String> aToolTips,
        TagData aEnergyTypeIN, TagData aEnergyTypeOUT, String aSidesIN, String aSidesOUT) {
        if (aEnergyTypeIN != null) {
            long tMin = aTileEntity.getEnergySizeInputMin(aEnergyTypeOUT, SIDE_ANY),
                tRec = aTileEntity.getEnergySizeInputRecommended(aEnergyTypeOUT, SIDE_ANY),
                tMax = aTileEntity.getEnergySizeInputMax(aEnergyTypeOUT, SIDE_ANY);
            aToolTips.add(
                Chat.GREEN + LH.get(LH.ENERGY_INPUT)
                    + ": "
                    + Chat.WHITE
                    + tRec
                    + " "
                    + aEnergyTypeIN.getLocalisedChatNameShort()
                    + Chat.WHITE
                    + (tRec == tMin && tRec == tMax ? "/t"
                        : (tMin <= 1 ? "/t (up to " : "/t (" + tMin + " to ") + tMax
                            + (UT.Code.stringInvalid(aSidesIN) ? "" : ", " + aSidesIN)
                            + ")"));
            aToolTips.add(getToolTipRedstoneFluxAccept(aEnergyTypeIN));
        }
        if (aEnergyTypeOUT != null) {
            long tMin = aTileEntity.getEnergySizeOutputMin(aEnergyTypeOUT, SIDE_ANY),
                tRec = aTileEntity.getEnergySizeOutputRecommended(aEnergyTypeOUT, SIDE_ANY),
                tMax = aTileEntity.getEnergySizeOutputMax(aEnergyTypeOUT, SIDE_ANY);
            aToolTips.add(
                Chat.RED + LH.get(LH.ENERGY_OUTPUT)
                    + ": "
                    + Chat.WHITE
                    + tRec
                    + " "
                    + aEnergyTypeOUT.getLocalisedChatNameShort()
                    + Chat.WHITE
                    + (tRec == tMin && tRec == tMax ? "/t"
                        : (tMin <= 1 ? "/t (up to " : "/t (" + tMin + " to ") + tMax
                            + (UT.Code.stringInvalid(aSidesOUT) ? "" : ", " + aSidesOUT)
                            + ")"));
    ...
    static {
        ...
        add(
            TOOLTIP_SPAWNPROOF_OPTIFINE,
            "Mob Protection broken because Optifine has removed Metadata Support from Vanilla.");
        add(TOOLTIP_SPAWNPROOF_MP_BUG, "Mobs should Spawn on this Block, even if the NEI Overlay says the opposite.");
        add(
            TOOLTIP_SPAWNPROOF_MP_BROKEN,
            "Mobs cannot Spawn on this Block, even if the NEI Overlay says the opposite.");
        ...
        add(
            WIP,
            Chat.RESET + Chat.WHITE
                + Chat.BOLD
                + "WIP"
                + Chat.RESET_TOOLTIP
                + ", This may not be as functional as you expect it to be!");
    }
    ...
    public static class Chat {
        ...
        public static final String BLACK = EnumChatFormatting.BLACK.toString(),
            DBLUE = EnumChatFormatting.DARK_BLUE.toString(), DGREEN = EnumChatFormatting.DARK_GREEN.toString(),
            DCYAN = EnumChatFormatting.DARK_AQUA.toString(), DRED = EnumChatFormatting.DARK_RED.toString(),
            PURPLE = EnumChatFormatting.DARK_PURPLE.toString(), ORANGE = EnumChatFormatting.GOLD.toString(),
            GOLD = EnumChatFormatting.GOLD.toString(), GRAY = EnumChatFormatting.GRAY.toString(),
            DGRAY = EnumChatFormatting.DARK_GRAY.toString(), BLUE = EnumChatFormatting.BLUE.toString(),
            GREEN = EnumChatFormatting.GREEN.toString(), CYAN = EnumChatFormatting.AQUA.toString(),
            RED = EnumChatFormatting.RED.toString(), PINK = EnumChatFormatting.LIGHT_PURPLE.toString(),
            YELLOW = EnumChatFormatting.YELLOW.toString(), WHITE = EnumChatFormatting.WHITE.toString(),
            OBFUSCATED = EnumChatFormatting.OBFUSCATED.toString(), BOLD = EnumChatFormatting.BOLD.toString(),
            STRIKETHROUGH = EnumChatFormatting.STRIKETHROUGH.toString(),
            UNDERLINE = EnumChatFormatting.UNDERLINE.toString(), ITALIC = EnumChatFormatting.ITALIC.toString(),
            RESET = EnumChatFormatting.RESET.toString(), RESET_TOOLTIP = RESET + GRAY;

        public static final String _BLACK = " " + BLACK, _DBLUE = " " + DBLUE, _DGREEN = " " + DGREEN,
            _DCYAN = " " + DCYAN, _DRED = " " + DRED, _PURPLE = " " + PURPLE, _ORANGE = " " + ORANGE,
            _GOLD = " " + GOLD, _GRAY = " " + GRAY, _DGRAY = " " + DGRAY, _BLUE = " " + BLUE, _GREEN = " " + GREEN,
            _CYAN = " " + CYAN, _RED = " " + RED, _PINK = " " + PINK, _YELLOW = " " + YELLOW, _WHITE = " " + WHITE,
            _OBFUSCATED = " " + OBFUSCATED, _BOLD = " " + BOLD, _STRIKETHROUGH = " " + STRIKETHROUGH,
            _UNDERLINE = " " + UNDERLINE, _ITALIC = " " + ITALIC, _RESET = " " + RESET,
            _RESET_TOOLTIP = " " + RESET_TOOLTIP;

        public static String RAINBOW_FAST = BLACK, RAINBOW = BLACK, RAINBOW_SLOW = BLACK, BLINKING_CYAN = CYAN,
            BLINKING_RED = RED, BLINKING_ORANGE = ORANGE, BLINKING_GRAY = GRAY;
    }
}
