 ...
 * 
 *         Note: ALL the Methods can and will be called at any time by another Thread. Nothing here is synched to World
 *         Ticks.
 */
public interface IComputerizable {
    ...
    /**
     * The Function Call itself. The TileEntity implementing IComputerizable is always the one inside aDelegator.
     * aDelegator is only there for Singletons like Covers, that require more Data access.
     */
