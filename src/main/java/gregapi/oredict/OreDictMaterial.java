...
public final class OreDictMaterial implements ITagDataContainer<OreDictMaterial>, ICondition<OreDictMaterial> {
    ...
    private static final Set<String> INVALID_STRINGS_TO_START_A_MATERIAL_NAME = new HashSetNoNulls<>(
        Arrays.asList(
            "Mul",
            "Div",
            "Rich",
    ...
    /**
     * If a Material with the same Name but without ID (-1) exists it will be replaced automatically, regardless of
     * registration order.
     * <BR>
     * <BR>
     * In case there are two Materials with the same Name but a different ID, the one added later wins and overrides the
     * spot in the HashMap.
     * If this happens, then the earlier Material gets a Registration Target in order to let MetaItems work properly,
     * even when they get overridden.
     * That way there is no Danger to the World Save in having two or more Instances of the same Material with a
     * different ID. But it wastes space, so try to avoid that!
     * <BR>
     * <BR>
     * Please avoid having the same ID for two different Materials. This would cause some nasty collisions. So choose
     * one of the following ID Ranges, which has not been taken already! Also maybe your Name is already Listed, you
     * should check for that too. If you need a Range to be assigned to, then you just ask me.
     * <BR>
     * <BR>
     * I have to use an ID based System, as Item MetaData is the only proper way to differentiate between Items reliably
     * within all Mods.
     * 
     * <BR>
     * <BR>
     * My ID Range, do not touch unless you are me.
     * <BR>
     * [ 0: 9999] Gregorius Techneticies (And this API)
     * 
     * <BR>
     * <BR>
     * The large Ranges (given to people, who I expect to add many new Materials)
     * 
     * <BR>
     * [10000:10999] OvermindDL1
     * <BR>
     * [11000:11999] VirMan
     * <BR>
     * [12000:12999] EmperorHadriusIII
     * <BR>
     * [13000:13999] Qwertygiy
     * <BR>
     * [14000:14999] Lauren
     * <BR>
     * [15000:15999] Yuesha / GT6U
     * <BR>
     * [16000:16999] Altadoon
     * <BR>
     * [17000:17999] CHanzyLazer / GTCH
     * <BR>
     * [18000:18999] the next one who asks me (do not use unless I personally tell you to use this larger Range)
     * <BR>
     * [19000:19999] Free
     * 
     * <BR>
     * <BR>
     * The medium Ranges (given to people, who I expect to add some Materials, but not that many)
     * 
     * <BR>
     * [20000:20499] BloodAsp
     * <BR>
     * [20500:20999] Axelandre42
     * <BR>
     * [21000:21499] IceFrezze
     * <BR>
     * [21500:21999] the next one who asks me (do not use unless I personally tell you to use this medium Range), yes
     * this is still correct
     * <BR>
     * [22000:22499] kuzuanpa
     * <BR>
     * [22500:22999] reserved for now, unsure if needed.
     * <BR>
     * [23000:23499] Free
     * <BR>
     * [23500:23999] Free
     ...
     * <BR>
     * <BR>
     * The smaller Ranges (given to people, who I expect to not add many new Materials)
     * 
     * <BR>
     * [30000:30099] LinusPhoenix
     * <BR>
     * [30100:30199] ZL123
     * <BR>
     * [30200:30299] Mr10Movie
     * <BR>
     * [30300:30399] 28Smiles
     * <BR>
     * [30400:30499] Immibis
     * <BR>
     * [30500:30599] Mine_Sasha
     * <BR>
     * [30600:30699] Alkalus
     * <BR>
     * [30700:30799] Briareos81
     * <BR>
     * [30800:30899] SuperCoder79
     * <BR>
     * [30900:30999] ManaMetal Mod
     * <BR>
     * [31000:31099] BioAstroiner
     * <BR>
     * [31100:31199] KSP Atlas
     * <BR>
     * [31200:31299] mayonnaise
     * <BR>
     * [31300:31399] the next one who asks me (do not use unless I personally tell you to use this smaller Range)
     * <BR>
     * [31400:31499] Free
     * <BR>
     * [31500:31599] Free
     ...
     * <BR>
     * <BR>
     * The ID Range that is reserved for MineTweaker and alike Stuff, so people can create their own Materials if they
     * desire to do so.
     * <BR>
     * [32000:32765] Those are Reserved for Custom Materials.
     * 
     * <BR>
     * <BR>
     * Due to being from the Example Mod, I would not use that ID, as everyone who just blindly copypastes that Mod like
     * an idiot, uses this ID.
     * <BR>
     * [32766] That one ID that is used for the Example Mod.
     * 
     * @param aID          the MetaData an Item of this Material would have.
     *                     <BR>
     *                     Everything below 8000 is reserved for Chemical Elements/Anti-Elements and their Isotopes.
     *                     <BR>
     *                     Everything between [8000 and 9999] is reserved for GregTech itself (or the API itself), just
     *                     to prevent Conflicts.
     *                     <BR>
     *                     This means every ID you insert must have at least 5 Digits!
     * @param aNameOreDict the OreDictionary Name of this Material. If it contains Spaces or Minuses, those will be
     *                     removed for the OreDictionary Name. The OreDict-Name will get capitalised!
     */
    public static OreDictMaterial createMaterial(int aID, String aNameOreDict, String aLocalName) {
        ...
        if (aNameOreDict.isEmpty()) throw new IllegalArgumentException(
            "This OreDict Name is not usable, due to being an empty String, after stripping all the minuses and spaces.");
        // Those Characters are used to declare private Prefixes, it is not a good Idea to use them as Material Name at
        // all, since they would get ignored by my System automatically.
        if (aNameOreDict.contains("|") || aNameOreDict.contains("*")
            || aNameOreDict.contains(":")
            || aNameOreDict.contains(".")
            || aNameOreDict.contains("$"))
            throw new IllegalArgumentException(
                "The Material Name contains at least one of the following five invalid Characters '|', '*', ':', '.' or '$'");
        // if the ID is 0 or greater, then check the Name of the Material a bit more precise, to prevent shit from
        // happening.
        if (aID >= 0) {
            if (GAPI.mStartedInit) throw new IllegalStateException(
                "Materials with a valid ID have to be initialised in PreInit or earlier!");

            if (Ch_N.contains(aNameOreDict.charAt(0))) throw new IllegalArgumentException(
                "The OreDict Name '" + aNameOreDict
                    + "' is not suitable for a valid Material. Choose a different one, which doesn't happen to start with a Numeral. You can always set the Local Name to your liking, but the internal Name must always be a proper one.");

            if (INVALID_STRINGS_TO_START_A_MATERIAL_NAME.contains(aNameOreDict)) throw new IllegalArgumentException(
                "The OreDict Name '" + aNameOreDict
                    + "' is not suitable for a valid Material. Choose a different one, which doesn't happen to be a blacklisted Adjective. You can always set the Local Name to your liking, but the internal Name must always be a proper one.");

            for (String tInvalidString : INVALID_STRINGS_TO_START_A_MATERIAL_NAME)
                if (aNameOreDict.startsWith(tInvalidString)) throw new IllegalArgumentException(
                    "The OreDict Name '" + aNameOreDict
                        + "' is not suitable for a valid Material, as it conflicts with OreDict Prefixes. A better Name for your Material would be '"
                        + UT.Code.capitalise(aNameOreDict.replaceFirst(tInvalidString, ""))
                        + tInvalidString
                        + "' with the '"
                        + tInvalidString
                        + "' at the end of the Material Name instead of the beginning.");
        }
        ...
        if (rMaterial1.mID == aID) {
            ERR.println(
                "NOTICE: Two Materials used the same ID: " + aID
                    + " - Names: "
                    + aNameOreDict
                    + " and "
                    + rMaterial1.mNameInternal);
            return rMaterial1;
        }
    ...
    /**
     * Used by the OreDictManager to automatically generate an Invalid Material from a Name, with a safeguard in case
     * the Material actually exists already.
     */
    public static OreDictMaterial createAutoInvalidMaterial(String aNameOreDict) {
        ...
        if (rMaterial.mID < 0) rMaterial.put(
            TD.Properties.INVALID_MATERIAL,
            TD.Properties.UNUSED_MATERIAL,
            TD.Properties.AUTO_BLACKLIST,
    ...
    /**
     * The Index of this Material inside the Array. Negative for "Not in the Array" and therefore also for "Not
     * Unificatable", 0 is the NULL Material so a > 0 check could be useful for you.
     */
    ...
    /**
     * The localised Name for this Material including Spaces and Stuff. It Defaults to the internal Name (if you have
     * Spaces inside the Internal Name then those will be included in the Local Name but not in the final internal
     * Name).
     */
    ...
    /**
     * The Colors of this Material in its 4 different states. Any change to these 4 final Arrays will be reflected in
     * the Color of the Material at that state.
     */
    public final short[] mRGBaSolid = new short[] { 255, 255, 255, 255 },
        mRGBaLiquid = new short[] { 255, 255, 255, 255 }, mRGBaGas = new short[] { 255, 255, 255, 255 },
        mRGBaPlasma = new short[] { 255, 255, 255, 255 };
    ...
    public final short[] fRGBaSolid = new short[] { 255, 255, 255, 255 },
        fRGBaLiquid = new short[] { 255, 255, 255, 255 }, fRGBaGas = new short[] { 255, 255, 255, 255 },
        fRGBaPlasma = new short[] { 255, 255, 255, 255 };
    ...
    /**
     * The Atomic Values of one Molecule of this Naterial, Defaults to Technetium. If the Element is Antimatter, then
     * mProtons means Antiprotons and mElectrons means Positrons
     */
    ...
    public List<IIconContainer> mTextureSetsBlock = TextureSet.SET_NONE[0].mList,
        mTextureSetsItems = TextureSet.SET_NONE[1].mList;
    /** The Texture used for placing in Molds, Basins and Anvils. Overridden by Stone, Lava, Glass and the likes. */
    public ITexture mTextureSolid = null, mTextureSmooth = null, mTextureMolten = null, mTextureDust = null,
        mTextureGem = null;
    ...
    /**
     * The List of Materials this Material should register as too. This is for adding itself automatically to
     * "OreDictionary List"-Materials such as "AnyCopper" or "AnyBronze" for example
     */
    ...
    /**
     * The Material which is the target for Recycling a Crafting Recipe. Mainly to prevent things like Iron from showing
     * up twice in the Ingredients List
     */
    ...
    public OreDictMaterialStack mTargetCrushing = OM.stack(this, U), mTargetPulver = OM.stack(this, U),
        mTargetSmelting = OM.stack(this, U), mTargetSolidifying = OM.stack(this, U),
        mTargetSmashing = OM.stack(this, U), mTargetCutting = OM.stack(this, U), mTargetWorking = OM.stack(this, U),
        mTargetForging = OM.stack(this, U), mTargetBurning = OM.stack(this, 0), // The remaining Material when being
                                                                                // burned. Used for getting the Ashes.
        mTargetBending = OM.stack(this, U), mTargetCompressing = OM.stack(this, U),
        mTargetGenerifying = OM.stack(this, U);

    /** The Materials targetting this for certain kinds of Processing. */
    public final Set<OreDictMaterial> mTargetedCrushing = new HashSetNoNulls<>(F, this),
        mTargetedPulver = new HashSetNoNulls<>(F, this), mTargetedSmelting = new HashSetNoNulls<>(F, this),
        mTargetedSolidifying = new HashSetNoNulls<>(F, this), mTargetedSmashing = new HashSetNoNulls<>(F, this),
        mTargetedCutting = new HashSetNoNulls<>(F, this), mTargetedWorking = new HashSetNoNulls<>(F, this),
        mTargetedForging = new HashSetNoNulls<>(F, this), mTargetedBurning = new HashSetNoNulls<>(F, this),
        mTargetedBending = new HashSetNoNulls<>(F, this), mTargetedCompressing = new HashSetNoNulls<>(F, this),
        mTargetedGenerifying = new HashSetNoNulls<>(F, this);

    /**  */
    public long mLiquidUnit = U, mGasUnit = U, mPlasmaUnit = U;
    /**
     * References to this Materials Fluid States. The amount of the FluidStack equals one Material Unit. It is usually
     * either 144 or 1000, but other amounts are possible. Use "Util.translateUnits" for easy Math.
     */
    ...
    public final List<ObjectStack<Enchantment>> mEnchantmentTools = new ArrayListNoNulls<>(1),
        mEnchantmentWeapons = new ArrayListNoNulls<>(1), mEnchantmentAmmo = new ArrayListNoNulls<>(1),
        mEnchantmentRanged = new ArrayListNoNulls<>(1), mEnchantmentFishing = new ArrayListNoNulls<>(1),
        mEnchantmentArmors = new ArrayListNoNulls<>(1);
    ...
    /**
     * Gets the localised Name of this Material, but only after the Init-Phase (since Materials are added during
     * preInit). Otherwise defaults to the Name set by setLocal.
     */
    ...
    /**
     * Adds Identical Names which are getting re-registered to this Material. returns this Material, not the newly
     * created ones.
     */
    public OreDictMaterial addIdenticalNames(String... aNames) {
        for (String aName : aNames) {
            ...
            if (mNameInternal.equals(aName)) {
                ERR.println(
                    "The Material '" + mNameInternal
                        + "' has almost registered an identical Name as an alternative Name by accident, almost leading to Issues with the Recipe System.");
            } else {
    ...
    /**
     * Adds additional Names which this Material is getting re-registered to. For example "AnyCopper" would be something
     * "Copper" and "AnnealedCopper" are getting re-registered to, to make them interchangeable in some Recipes.
     */
    ...
    /**
     * Adds this Materials Name as an additional Name the passed Materials are getting re-registered to. For example
     * "AnyCopper" would be something "Copper" and "AnnealedCopper" are getting re-registered to, to make them
     * interchangeable in some Recipes.
     */
    ...
    public OreDictMaterial visDefault(OreDictMaterial... aMaterials) {
        ...
        visName(
            ...
            "plate" + mNameInternal,
            "stick" + mNameInternal);
        for (OreDictMaterial tMaterial : aMaterials) visName(
            "ore" + tMaterial.mNameInternal,
            "dust" + tMaterial.mNameInternal,
            "gem" + tMaterial.mNameInternal,
            "ingot" + tMaterial.mNameInternal,
            "plate" + tMaterial.mNameInternal,
            "stick" + tMaterial.mNameInternal);
        return this;
    }
    ...
    public OreDictMaterial addAlloyingRecipe(IOreDictConfigurationComponent aConfiguration) {
        ...
        for (OreDictMaterialStack tMaterial : aConfiguration.getUndividedComponents()) {
            if (tMaterial.mMaterial != MT.Air) {
                if (mMeltingPoint >= tMaterial.mMaterial.mBoilingPoint && !contains(TD.Atomic.ELEMENT))
                    mMeltingPoint = Math.max(C + 20, tMaterial.mMaterial.mBoilingPoint - 20);
                if (mMeltingPoint >= tMaterial.mMaterial.mBoilingPoint) ERR.println(
                    "The Alloy '" + mNameInternal
                        + "' cannot be created due to the Melting Point being higher than the Boiling Point of its Component '"
                        + tMaterial.mMaterial.mNameInternal
                        + "'");
            }
    ...
    /**
     * Sets the Molecule Configuration or Components of this Material. Calculates the Average of the MainStats and sets
     * them.
     */
    public OreDictMaterial setMoleculeConfiguration(IOreDictConfigurationComponent aComponents) {
        if (contains(TD.Atomic.ELEMENT))
            new IllegalArgumentException("Detected problematic tampering with Elements of the Periodic Table")
                .printStackTrace(ERR);

        mComponents = aComponents;
        double tDivider = 0, tProtons = 0, tElectrons = 0, tNeutrons = 0, tMass = 0, tGramPerCubicCentimeter = 0,
            tMeltingPoint = 0, tBoilingPoint = 0, tPlasmaPoint = 0;
        ...
        if (!contains(TD.Compounds.APPROXIMATE) && containsAny(TD.Processing.UUM, TD.Compounds.DECOMPOSABLE)) {
            ...
            if (tComponents.size() == 1 && tComponents.get(0).mAmount == U) {
                ...
                if (UT.Code.stringValid(tMaterial.mMaterial.mTooltipChemical)
                    ...
                    if (tMaterial.mMaterial.contains(TD.Atomic.ELEMENT) || tMaterial.mMaterial.mComponents == null
                        || (tMaterial.mMaterial.mComponents.getUndividedComponents()
                            .size() == 1
                            && tMaterial.mMaterial.mComponents.getComponents()
                                .get(0).mAmount == U)) {
                ...
                if (tMaterial.mAmount > U) {
                    if (tMaterial.mMaterial.mComponents == null) {
                        ...
                        if ((tMaterial.mAmount / U) / tMaterial.mMaterial.mComponents.getCommonDivider() > 1) {
                            mTooltipChemical += NUM_SUB[(int) UT.Code.bind(
                                0,
                                NUM_SUB.length - 1,
                                (tMaterial.mAmount / U) / tMaterial.mMaterial.mComponents.getCommonDivider())];
                        } else {
                        ...
                        mTooltipChemical += NUM_SUB[(int) UT.Code.bind(0, NUM_SUB.length - 1, tMaterial.mAmount / U)]
                            + ","
                            + NUM_SUB[(int) UT.Code
                                .bind(0, NUM_SUB.length - 1, tMaterial.mMaterial.mComponents.getCommonDivider())];
                    }
                }
            }
        }
    ...
    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1) {
        if (aCommonDivider == 0) {
            ...
            if (tAmount % U != 0) ERR.println(
                "WARNING: Material '" + mNameInternal
                    + "' has an Amount of "
                    + tAmount
                    + " Components and automatically generates a divider, that is leaving a tiny rest after the division, breaking some Material Amounts. Manual setting of Variables is required.");
        }
        return setMoleculeConfiguration(
            new OreDictConfigurationComponent(aCommonDivider, OM.stack(aMaterial1, aAmount1)));
    }

    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        OreDictMaterial aMaterial2, long aAmount2) {
        if (aCommonDivider == 0) {
        ...
        return setMoleculeConfiguration(
            new OreDictConfigurationComponent(
                aCommonDivider,
                OM.stack(aMaterial1, aAmount1),
                OM.stack(aMaterial2, aAmount2)));
    }

    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        OreDictMaterial aMaterial2, long aAmount2, OreDictMaterial aMaterial3, long aAmount3) {
        if (aCommonDivider == 0) {
        ...
        return setMoleculeConfiguration(
            new OreDictConfigurationComponent(
                ...
                OM.stack(aMaterial1, aAmount1),
                OM.stack(aMaterial2, aAmount2),
                OM.stack(aMaterial3, aAmount3)));
    }

    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        OreDictMaterial aMaterial2, long aAmount2, OreDictMaterial aMaterial3, long aAmount3,
        OreDictMaterial aMaterial4, long aAmount4) {
        if (aCommonDivider == 0) {
        ...
        return setMoleculeConfiguration(
            new OreDictConfigurationComponent(
                ...
                OM.stack(aMaterial2, aAmount2),
                OM.stack(aMaterial3, aAmount3),
                OM.stack(aMaterial4, aAmount4)));
    }

    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        OreDictMaterial aMaterial2, long aAmount2, OreDictMaterial aMaterial3, long aAmount3,
        OreDictMaterial aMaterial4, long aAmount4, OreDictMaterial aMaterial5, long aAmount5) {
        if (aCommonDivider == 0) {
        ...
        return setMoleculeConfiguration(
            new OreDictConfigurationComponent(
                ...
                OM.stack(aMaterial3, aAmount3),
                OM.stack(aMaterial4, aAmount4),
                OM.stack(aMaterial5, aAmount5)));
    }

    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        OreDictMaterial aMaterial2, long aAmount2, OreDictMaterial aMaterial3, long aAmount3,
        OreDictMaterial aMaterial4, long aAmount4, OreDictMaterial aMaterial5, long aAmount5,
        OreDictMaterial aMaterial6, long aAmount6) {
        ...
        return setMoleculeConfiguration(
            new OreDictConfigurationComponent(
                ...
                OM.stack(aMaterial4, aAmount4),
                OM.stack(aMaterial5, aAmount5),
                OM.stack(aMaterial6, aAmount6)));
    }

    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        OreDictMaterial aMaterial2, long aAmount2, OreDictMaterial aMaterial3, long aAmount3,
        OreDictMaterial aMaterial4, long aAmount4, OreDictMaterial aMaterial5, long aAmount5,
        OreDictMaterial aMaterial6, long aAmount6, OreDictMaterial aMaterial7, long aAmount7) {
    ...
    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        ...
        OreDictMaterial aMaterial4, long aAmount4, OreDictMaterial aMaterial5, long aAmount5,
        OreDictMaterial aMaterial6, long aAmount6, OreDictMaterial aMaterial7, long aAmount7,
        OreDictMaterial aMaterial8, long aAmount8) {
    ...
    public OreDictMaterial setMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        ...
        OreDictMaterial aMaterial4, long aAmount4, OreDictMaterial aMaterial5, long aAmount5,
        OreDictMaterial aMaterial6, long aAmount6, OreDictMaterial aMaterial7, long aAmount7,
        OreDictMaterial aMaterial8, long aAmount8, OreDictMaterial aMaterial9, long aAmount9) {
    ...
    public OreDictMaterial uumMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        OreDictMaterial aMaterial2, long aAmount2, OreDictMaterial aMaterial3, long aAmount3) {
        if (aMaterial1.contains(TD.Processing.UUM) && aMaterial2.contains(TD.Processing.UUM)
            && aMaterial3.contains(TD.Processing.UUM)) {
            put(TD.Processing.UUM);
        } else {
            ERR.println("WARNING: " + mNameInternal + " has a UUM Config with impossible Materials.");
        }
    ...
    public OreDictMaterial uumMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        ...
        if (aMaterial1.contains(TD.Processing.UUM) && aMaterial2.contains(TD.Processing.UUM)
            && aMaterial3.contains(TD.Processing.UUM)
            && aMaterial4.contains(TD.Processing.UUM)) {
            put(TD.Processing.UUM);
        } else {
            ERR.println("WARNING: " + mNameInternal + " has a UUM Config with impossible Materials.");
        }
    ...
    public OreDictMaterial uumMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        ...
        if (aMaterial1.contains(TD.Processing.UUM) && aMaterial2.contains(TD.Processing.UUM)
            && aMaterial3.contains(TD.Processing.UUM)
            && aMaterial4.contains(TD.Processing.UUM)
            && aMaterial5.contains(TD.Processing.UUM)) {
            put(TD.Processing.UUM);
        } else {
            ERR.println("WARNING: " + mNameInternal + " has a UUM Config with impossible Materials.");
        }
    ...
    public OreDictMaterial uumMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        ...
        if (aMaterial1.contains(TD.Processing.UUM) && aMaterial2.contains(TD.Processing.UUM)
            ...
            && aMaterial4.contains(TD.Processing.UUM)
            && aMaterial5.contains(TD.Processing.UUM)
            && aMaterial6.contains(TD.Processing.UUM)) {
            put(TD.Processing.UUM);
        } else {
            ERR.println("WARNING: " + mNameInternal + " has a UUM Config with impossible Materials.");
        }
    ...
    public OreDictMaterial uumMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        ...
        if (aMaterial1.contains(TD.Processing.UUM) && aMaterial2.contains(TD.Processing.UUM)
            ...
            && aMaterial5.contains(TD.Processing.UUM)
            && aMaterial6.contains(TD.Processing.UUM)
            && aMaterial7.contains(TD.Processing.UUM)) {
            put(TD.Processing.UUM);
        } else {
            ERR.println("WARNING: " + mNameInternal + " has a UUM Config with impossible Materials.");
        }
    ...
    public OreDictMaterial uumMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        ...
        if (aMaterial1.contains(TD.Processing.UUM) && aMaterial2.contains(TD.Processing.UUM)
            ...
            && aMaterial6.contains(TD.Processing.UUM)
            && aMaterial7.contains(TD.Processing.UUM)
            && aMaterial8.contains(TD.Processing.UUM)) {
            put(TD.Processing.UUM);
        } else {
            ERR.println("WARNING: " + mNameInternal + " has a UUM Config with impossible Materials.");
        }
    ...
    public OreDictMaterial uumMcfg(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        ...
        if (aMaterial1.contains(TD.Processing.UUM) && aMaterial2.contains(TD.Processing.UUM)
            ...
            && aMaterial7.contains(TD.Processing.UUM)
            && aMaterial8.contains(TD.Processing.UUM)
            && aMaterial9.contains(TD.Processing.UUM)) {
            put(TD.Processing.UUM);
        } else {
            ERR.println("WARNING: " + mNameInternal + " has a UUM Config with impossible Materials.");
        }
    ...
    public OreDictMaterial uumAloy(long aCommonDivider, OreDictMaterial aMaterial1, long aAmount1,
        OreDictMaterial aMaterial2, long aAmount2, OreDictMaterial aMaterial3, long aAmount3) {
        return uumMcfg(aCommonDivider, aMaterial1, aAmount1, aMaterial2, aAmount2, aMaterial3, aAmount3)
            .alloyCentrifuge();
    }
    ...
    public OreDictMaterial setAllToTheOutputOf(OreDictMaterial aMaterial, long aMultiplier, long aDivider) {
        ...
        setSolidifying(
            aMaterial.mTargetSolidifying.mMaterial,
            (aMaterial.mTargetSolidifying.mAmount * aMultiplier) / aDivider);
        ...
        setCompressing(
            aMaterial.mTargetCompressing.mMaterial,
            (aMaterial.mTargetCompressing.mAmount * aMultiplier) / aDivider);
        setCrushing(aMaterial.mTargetCrushing.mMaterial, (aMaterial.mTargetCrushing.mAmount * aMultiplier) / aDivider);
        return this;
    }

    /**
     * The result of trying to ore process it, if you want to disable ore processing, then set the Amount to 0. If
     * aMaterial == null it will choose the previous Material instead, which is usually "this".
     */
    ...
    /**
     * The result of trying to pulverise it, if you want to disable pulverising, then set the Amount to 0. If aMaterial
     * == null it will choose the previous Material instead, which is usually "this".
     */
    ...
    /**
     * The result of trying to smelt it, if you want to disable smelting, then set the Amount to 0. If aMaterial == null
     * it will choose "this".
     */
    ...
    /**
     * The result of cooling it down, if you want to disable cooling down, then set the Amount to 0. If aMaterial ==
     * null it will choose "this".
     */
    ...
    /**
     * The result of trying to smash it, if you want to disable smashing, then set the Amount to 0. If aMaterial == null
     * it will choose "this".
     */
    ...
    /**
     * The result of trying to cut it, if you want to disable cutting, then set the Amount to 0. If aMaterial == null it
     * will choose "this".
     */
    ...
    /**
     * The result of trying to craft with it, if you want to disable working, then set the Amount to 0. If aMaterial ==
     * null it will choose "this".
     */
    ...
    /**
     * The result of trying to forge it, if you want to disable forging, then set the Amount to 0. If aMaterial == null
     * it will choose "this".
     */
    ...
    /**
     * The result of trying to burn it (Ashes for example), if you want to disable burning, then set the Amount to 0. If
     * aMaterial == null it will choose "this".
     */
    ...
    /**
     * The result of trying to bend it, if you want to disable bending, then set the Amount to 0. If aMaterial == null
     * it will choose "this".
     */
    ...
    /**
     * The result of trying to compress it, if you want to disable compressing, then set the Amount to 0. If aMaterial
     * == null it will choose "this".
     */
    ...
    public OreDictMaterial setQuality(float aToolSpeed, long aToolDurability, long aToolQuality) {
        return qual(3, aToolSpeed, aToolDurability, aToolQuality);
    }

    public OreDictMaterial qual(long aHarvestLevel) {
        return qual(mToolTypes, mToolSpeed, mToolDurability, aHarvestLevel);
    }

    public OreDictMaterial qual(float aSpeed, long aDurability, long aQuality) {
        return qual(3, aSpeed, aDurability, aQuality);
    }
    ...
    public OreDictMaterial setMeltingPoint(long aMeltingPoint) {
        return heat(aMeltingPoint);
    }

    /** Sets the energetic Stats of this Material. Everything is measured in Kelvin. */
    public OreDictMaterial heat(long aMeltingPoint) {
        if (contains(TD.Atomic.ELEMENT)) {
            if (mMeltingPoint != 1000 && aMeltingPoint != mMeltingPoint)
                new IllegalArgumentException("Detected problematic tampering with Elements of the Periodic Table")
                    .printStackTrace(ERR);
            // if (mBoilingPoint != 3000 && aBoilingPoint != mBoilingPoint) new IllegalArgumentException("Detected
            // problematic tampering with Elements of the Periodic Table").printStackTrace(ERR);
        }
    ...
    public OreDictMaterial setStatsEnergetic(long aMeltingPoint, long aBoilingPoint) {
        return heat(aMeltingPoint, aBoilingPoint);
    }
    ...
    public OreDictMaterial heat(long aMeltingPoint, long aBoilingPoint) {
        if (contains(TD.Atomic.ELEMENT)) {
            if (mMeltingPoint != 1000 && aMeltingPoint != mMeltingPoint)
                new IllegalArgumentException("Detected problematic tampering with Elements of the Periodic Table")
                    .printStackTrace(ERR);
            if (mBoilingPoint != 3000 && aBoilingPoint != mBoilingPoint)
                new IllegalArgumentException("Detected problematic tampering with Elements of the Periodic Table")
                    .printStackTrace(ERR);
        }
    ...
    public OreDictMaterial setStatsEnergetic(long aMeltingPoint, long aBoilingPoint, long aPlasmaPoint) {
        return heat(aMeltingPoint, aBoilingPoint, aPlasmaPoint);
    }
    ...
    public OreDictMaterial setStats(long aProtonsAndElectrons, long aNeutrons, long aMeltingPoint, long aBoilingPoint,
        double aGramPerCubicCentimeter) {
    ...
    public OreDictMaterial setStatsElement(long aProtons, long aElectrons, long aNeutrons, long aAdditionalMass,
        double aGramPerCubicCentimeter) {
        mProtons = aProtons;
    ...
    /**
     * Sets the Color of this Material. Note: Whenever I use 256 as Parameter it of course goes back to 255 via
     * bindByte, this is just a marker for me if I did not assign a Color to a Material.
     */
    ...
    public OreDictMaterial stealQuality(OreDictMaterial aStatsToCopy) {
        return qual(aStatsToCopy);
    }

    public OreDictMaterial qual(OreDictMaterial aStatsToCopy) {
        return qual(
            aStatsToCopy.mToolTypes,
            aStatsToCopy.mToolSpeed,
            aStatsToCopy.mToolDurability,
            aStatsToCopy.mToolQuality);
    }
    ...
    public OreDictMaterial aspects(TC aAspect1, long aAmount1, TC aAspect2, long aAmount2, TC aAspect3, long aAmount3,
        TC aAspect4, long aAmount4) {
        return addAspects(
            TC.stack(aAspect1, aAmount1),
            TC.stack(aAspect2, aAmount2),
            TC.stack(aAspect3, aAmount3),
            TC.stack(aAspect4, aAmount4));
    }

    public OreDictMaterial aspects(TC aAspect1, long aAmount1, TC aAspect2, long aAmount2, TC aAspect3, long aAmount3,
        TC aAspect4, long aAmount4, TC aAspect5, long aAmount5) {
        return addAspects(
            TC.stack(aAspect1, aAmount1),
            TC.stack(aAspect2, aAmount2),
            TC.stack(aAspect3, aAmount3),
            TC.stack(aAspect4, aAmount4),
            TC.stack(aAspect5, aAmount5));
    }

    public OreDictMaterial aspects(TC aAspect1, long aAmount1, TC aAspect2, long aAmount2, TC aAspect3, long aAmount3,
        TC aAspect4, long aAmount4, TC aAspect5, long aAmount5, TC aAspect6, long aAmount6) {
        return addAspects(
            TC.stack(aAspect1, aAmount1),
            TC.stack(aAspect2, aAmount2),
            TC.stack(aAspect3, aAmount3),
            TC.stack(aAspect4, aAmount4),
            TC.stack(aAspect5, aAmount5),
            TC.stack(aAspect6, aAmount6));
    }

    public OreDictMaterial aspects(TC aAspect1, long aAmount1, TC aAspect2, long aAmount2, TC aAspect3, long aAmount3,
        TC aAspect4, long aAmount4, TC aAspect5, long aAmount5, TC aAspect6, long aAmount6, TC aAspect7,
        long aAmount7) {
        return addAspects(
            TC.stack(aAspect1, aAmount1),
            TC.stack(aAspect2, aAmount2),
            ...
            TC.stack(aAspect5, aAmount5),
            TC.stack(aAspect6, aAmount6),
            TC.stack(aAspect7, aAmount7));
    }

    public OreDictMaterial aspects(TC aAspect1, long aAmount1, TC aAspect2, long aAmount2, TC aAspect3, long aAmount3,
        TC aAspect4, long aAmount4, TC aAspect5, long aAmount5, TC aAspect6, long aAmount6, TC aAspect7, long aAmount7,
        TC aAspect8, long aAmount8) {
        return addAspects(
            TC.stack(aAspect1, aAmount1),
            TC.stack(aAspect2, aAmount2),
            TC.stack(aAspect3, aAmount3),
            ...
            TC.stack(aAspect6, aAmount6),
            TC.stack(aAspect7, aAmount7),
            TC.stack(aAspect8, aAmount8));
    }

    public OreDictMaterial aspects(TC aAspect1, long aAmount1, TC aAspect2, long aAmount2, TC aAspect3, long aAmount3,
        TC aAspect4, long aAmount4, TC aAspect5, long aAmount5, TC aAspect6, long aAmount6, TC aAspect7, long aAmount7,
        TC aAspect8, long aAmount8, TC aAspect9, long aAmount9) {
        return addAspects(
            TC.stack(aAspect1, aAmount1),
            TC.stack(aAspect2, aAmount2),
            TC.stack(aAspect3, aAmount3),
            ...
            TC.stack(aAspect7, aAmount7),
            TC.stack(aAspect8, aAmount8),
            TC.stack(aAspect9, aAmount9));
    }

    public OreDictMaterial aspects(TC aAspect1, long aAmount1, TC aAspect2, long aAmount2, TC aAspect3, long aAmount3,
        TC aAspect4, long aAmount4, TC aAspect5, long aAmount5, TC aAspect6, long aAmount6, TC aAspect7, long aAmount7,
        TC aAspect8, long aAmount8, TC aAspect9, long aAmount9, TC aAspect0, long aAmount0) {
        return addAspects(
            TC.stack(aAspect1, aAmount1),
            TC.stack(aAspect2, aAmount2),
            TC.stack(aAspect3, aAmount3),
    ...
    public OreDictMaterial addEnchantmentForFishing(Enchantment aEnchantment, int aEnchantmentLevel) {
        mEnchantmentFishing.add(
            new ObjectStack<>(
                aEnchantment,
                aEnchantment == Enchantment.field_151369_A ? Math.min(5, aEnchantmentLevel) : aEnchantmentLevel));
        return this;
    }
        ...
        if (aFluidStack != null) {
            ...
            FLUID_MAP.put(
                aFluidStack.getFluid()
                    .getName(),
                OM.stack(this, UT.Code.units(aFluidStack.amount, aUnit, U, T)));
        }
        return this;
    }
    ...
    public OreDictMaterial setPriorityPrefix(int aIndex) {
        ...
        if (!mNameInternal.startsWith("Clay") && !"Gravel".equalsIgnoreCase(mNameInternal))
            ...
            break;
            case 3:
            OreDictManager.INSTANCE
                .addReRegistrationWithReversal("block" + mNameInternal, "blockIngot" + mNameInternal);
            break;
            case 4:
            OreDictManager.INSTANCE
                .addReRegistrationWithReversal("block" + mNameInternal, "blockIngot" + mNameInternal);
    ...
    public OreDictMaterial setPriorityPrefix(int aIndex, OreDictPrefix aPrefix) {
        ...
        if (!mNameInternal.startsWith("Clay")) switch (mPriorityPrefixIndex) {
            ...
            case 1:
                OreDictManager.INSTANCE
                    .addReRegistrationWithReversal("block" + mNameInternal, "blockGem" + mNameInternal);
                break;
            case 2:
                OreDictManager.INSTANCE
                    .addReRegistrationWithReversal("block" + mNameInternal, "blockDust" + mNameInternal);
                break;
            case 3:
                OreDictManager.INSTANCE
                    .addReRegistrationWithReversal("block" + mNameInternal, "blockIngot" + mNameInternal);
