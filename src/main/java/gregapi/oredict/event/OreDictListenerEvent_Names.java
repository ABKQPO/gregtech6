...
public abstract class OreDictListenerEvent_Names implements IOreDictListenerEvent {
    ...
    public boolean addListener(Object aOreDictName, IOreDictListenerEvent aListener) {
        ...
        if (!tList.add(aListener))
            throw new UnknownError("Unknown Error: " + aOreDictName + "  -  " + aListener.toString());
        return T;
    }
    ...
    public boolean addListener(Object aOreDictName1, Object aOreDictName2, Object aOreDictName3,
        IOreDictListenerEvent aListener) {
        return addListener(aOreDictName1, aListener) && addListener(aOreDictName2, aListener)
            && addListener(aOreDictName3, aListener);
    }

    public boolean addListener(Object aOreDictName1, Object aOreDictName2, Object aOreDictName3, Object aOreDictName4,
        IOreDictListenerEvent aListener) {
        return addListener(aOreDictName1, aListener) && addListener(aOreDictName2, aListener)
            && addListener(aOreDictName3, aListener)
            && addListener(aOreDictName4, aListener);
    }
    ...
    public boolean addListener(OreDictListenerEvent_ThreeNames aListener) {
        return addListener(aListener.mName1, aListener) && addListener(aListener.mName2, aListener)
            && addListener(aListener.mName3, aListener);
    }
