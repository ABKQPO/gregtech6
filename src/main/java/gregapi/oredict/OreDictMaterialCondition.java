...
public class OreDictMaterialCondition {
    ...
    public static ICondition<OreDictMaterial> selfcrush() {
        return SelfCrush.INSTANCE;
    }
    ...
    public static ICondition<OreDictMaterial> selfforge() {
        return SelfForge.INSTANCE;
    }
    ...
    public static ICondition<OreDictMaterial> typemin(long aMinQuality) {
        return new TypeMin(aMinQuality);
    }

    public static ICondition<OreDictMaterial> typemax(long aMaxQuality) {
        return new TypeMax(aMaxQuality);
    }
    ...
    private static class SelfCrush implements ICondition<OreDictMaterial> {
        ...
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mTargetCrushing.mMaterial == aMaterial;
        }
    }
    ...
    private static class FullPulver implements ICondition<OreDictMaterial> {
        ...
        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mTargetPulver.mAmount >= U;
        }
    }
    ...
    private static class SelfForge implements ICondition<OreDictMaterial> {
        ...
        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mTargetForging.mMaterial == aMaterial;
        }
    }
    ...
    private static class FullForge implements ICondition<OreDictMaterial> {
        ...
        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mTargetForging.mAmount >= U;
        }
    }
    ...
    private static class TypeMin implements ICondition<OreDictMaterial> {
        ...
        public TypeMin(long aMinType) {
            mMinType = aMinType;
        }

        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mToolTypes >= mMinType;
        }
    }
    ...
    private static class TypeMax implements ICondition<OreDictMaterial> {
        ...
        public TypeMax(long aMaxType) {
            mMaxType = aMaxType;
        }

        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mToolTypes <= mMaxType;
        }
    }
    ...
    private static class QualityMin implements ICondition<OreDictMaterial> {
        ...
        public QualityMin(long aMinQuality) {
            mMinQuality = aMinQuality;
        }

        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mToolQuality >= mMinQuality;
        }
    }
    ...
    private static class QualityMax implements ICondition<OreDictMaterial> {
        ...
        public QualityMax(long aMaxQuality) {
            mMaxQuality = aMaxQuality;
        }

        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mToolQuality <= mMaxQuality;
        }
    }
    ...
    private static class MeltingPointMin implements ICondition<OreDictMaterial> {
        ...
        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mMeltingPoint >= mMeltingPoint;
        }
    }
    ...
    private static class BoilingPointMin implements ICondition<OreDictMaterial> {
        ...
        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mBoilingPoint >= mBoilingPoint;
        }
    }
    ...
    private static class PlasmaPointMin implements ICondition<OreDictMaterial> {
        ...
        @Override
        public boolean isTrue(OreDictMaterial aMaterial) {
            return aMaterial.mPlasmaPoint >= mPlasmaPoint;
        }
    }
