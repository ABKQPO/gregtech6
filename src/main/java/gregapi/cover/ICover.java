...
public interface ICover {
     ...
     */
    public void onTickPost(byte aCoverSide, CoverData aData, long aTimer, boolean aIsServerSide,
        boolean aReceivedBlockUpdate, boolean aReceivedInventoryUpdate);
     ...
     */
    public boolean onCoverClickedLeft(byte aCoverSide, CoverData aData, Entity aPlayer, byte aSideClicked, float aHitX,
     ...
     */
    public boolean interceptClickLeft(byte aCoverSide, CoverData aData, Entity aPlayer, byte aSideClicked, float aHitX,
        float aHitY, float aHitZ);
     ...
     * @return true to intercept clicking the Side of the normal Block and cause the click animation
     */
    public boolean onCoverClickedRight(byte aCoverSide, CoverData aData, Entity aPlayer, byte aSideClicked, float aHitX,
        float aHitY, float aHitZ);
     ...
     * @return true to intercept clicking the Side of the normal Block without the click animation.
     */
    public boolean interceptClickRight(byte aCoverSide, CoverData aData, Entity aPlayer, byte aSideClicked, float aHitX,
        float aHitY, float aHitZ);
    ...
    /**
     * @return if you need to save the visual state of this Cover to NBT because the visuals contain crucial
     *         information.
     */
    ...
    public void getCollisions(byte aCoverSide, CoverData aData, AxisAlignedBB aAABB, List<AxisAlignedBB> aList,
        Entity aEntity);

    public static final float[][] BOXES_COVERS = new float[][] {
        { PX_P[0], PX_P[0], PX_P[0], PX_N[0], PX_N[14], PX_N[0] },
        { PX_P[0], PX_P[14], PX_P[0], PX_N[0], PX_N[0], PX_N[0] },
        { PX_P[0], PX_P[0], PX_P[0], PX_N[0], PX_N[0], PX_N[14] },
        { PX_P[0], PX_P[0], PX_P[14], PX_N[0], PX_N[0], PX_N[0] },
        { PX_P[0], PX_P[0], PX_P[0], PX_N[14], PX_N[0], PX_N[0] },
        { PX_P[14], PX_P[0], PX_P[0], PX_N[0], PX_N[0], PX_N[0] } };
    public static final float[][] BOXES_HOLDERS = new float[][] {
        { PX_P[7] + PX_OFFSET, PX_P[0], PX_P[7] + PX_OFFSET, PX_N[7] - PX_OFFSET, PX_N[8], PX_N[7] - PX_OFFSET },
        { PX_P[7] + PX_OFFSET, PX_P[8], PX_P[7] + PX_OFFSET, PX_N[7] - PX_OFFSET, PX_N[0], PX_N[7] - PX_OFFSET },
        { PX_P[7] + PX_OFFSET, PX_P[7] + PX_OFFSET, PX_P[0], PX_N[7] - PX_OFFSET, PX_N[7] - PX_OFFSET, PX_N[8] },
        { PX_P[7] + PX_OFFSET, PX_P[7] + PX_OFFSET, PX_P[8], PX_N[7] - PX_OFFSET, PX_N[7] - PX_OFFSET, PX_N[0] },
        { PX_P[0], PX_P[7] + PX_OFFSET, PX_P[7] + PX_OFFSET, PX_N[8], PX_N[7] - PX_OFFSET, PX_N[7] - PX_OFFSET },
        { PX_P[8], PX_P[7] + PX_OFFSET, PX_P[7] + PX_OFFSET, PX_N[0], PX_N[7] - PX_OFFSET, PX_N[7] - PX_OFFSET } };
    ...
    public boolean getFluidTankDrainableOverride(byte aCoverSide, CoverData aData, byte aSide,
        FluidStack aFluidToDrain);

    public boolean getFluidTanksOverride(byte aCoverSide, CoverData aData, byte aSide);

    public IFluidTank getFluidTankFillable(byte aCoverSide, CoverData aData, byte aSide, FluidStack aFluidToFill,
        IFluidTank aDefault);

    public IFluidTank getFluidTankDrainable(byte aCoverSide, CoverData aData, byte aSide, FluidStack aFluidToDrain,
        IFluidTank aDefault);
