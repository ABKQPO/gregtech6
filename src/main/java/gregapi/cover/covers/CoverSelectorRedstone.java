...
public class CoverSelectorRedstone extends AbstractCoverAttachmentSelector {
    ...
    public void onCoverPlaced(byte aCoverSide, CoverData aData, Entity aPlayer, ItemStack aCover) {
        ...
        if (!aData.mStopped && aData.mTileEntity instanceof ITileEntitySwitchableMode) aData.visual(
            aCoverSide,
            ((ITileEntitySwitchableMode) aData.mTileEntity)
                .setStateMode(aData.mTileEntity.getRedstoneIncoming(aCoverSide)));
    }
    ...
    public void onCoverLoaded(byte aSide, CoverData aData) {
        ...
        if (aData.mTileEntity instanceof ITileEntitySwitchableMode)
            ((ITileEntitySwitchableMode) aData.mTileEntity).setStateMode(aData.mTileEntity.getRedstoneIncoming(aSide));
    }
