...
public class CoverControllerCovers extends AbstractCoverAttachment {
    ...
    public boolean onCoverClickedRight(byte aCoverSide, CoverData aData, Entity aPlayer, byte aSideClicked, float aHitX,
        ...
        if (aData.mBehaviours[tSide] != null) return aData.mBehaviours[tSide]
            .onCoverClickedRight(tSide, aData, aPlayer, aSideClicked, aHitX, aHitY, aHitZ);
        return F;
    }
    ...
    public boolean onCoverClickedLeft(byte aCoverSide, CoverData aData, Entity aPlayer, byte aSideClicked, float aHitX,
        ...
        if (tSide == aCoverSide || aSideClicked != aCoverSide) return F;
        if (aData.mBehaviours[tSide] != null) return aData.mBehaviours[tSide]
            .onCoverClickedLeft(tSide, aData, aPlayer, aSideClicked, aHitX, aHitY, aHitZ);
        return F;
    }
    ...
    public long onToolClick(byte aCoverSide, CoverData aData, String aTool, long aRemainingDurability, long aQuality,
        ...
        if (tSide == aCoverSide || aSideClicked != aCoverSide) {
            if (aTool.equals(TOOL_screwdriver)) {
                ...
                if (aChatReturn != null) aChatReturn.add(
                    (aData.mValues[aCoverSide] & B[0]) != 0 ? "Covers work when Input is OFF"
        ...
        if (aData.mBehaviours[tSide] != null) return aData.mBehaviours[tSide].onToolClick(
            tSide,
            aData,
            aTool,
    ...
    public ITexture getCoverTextureAttachment(byte aCoverSide, CoverData aData, byte aTextureSide) {
        return aCoverSide != aTextureSide ? sTextureBackground
            : BlockTextureMulti.get(sTextureBackground, sTextureForeground);
    }
    ...
    public static final ITexture sTextureBackground = BlockTextureDefault.get("machines/covers/coverswitch/base"),
        sTextureForeground = BlockTextureDefault.get("machines/covers/coverswitch/circuit");
