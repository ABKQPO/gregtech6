...
public class CoverDetectorRunningSuccessfully extends AbstractCoverAttachmentDetector {
    ...
    public boolean interceptCoverPlacement(byte aCoverSide, CoverData aData, Entity aPlayer) {
        return !(aData.mTileEntity.canTick() && aData.mTileEntity instanceof ITileEntityRunningSuccessfully);
    }
    ...
    public void onTickPost(byte aSide, CoverData aData, long aTimer, boolean aIsServerSide,
        ...
        if (aIsServerSide && aData.mTileEntity instanceof ITileEntityRunningSuccessfully) {
            aData.value(
                aSide,
                UT.Code
                    .bind4(((ITileEntityRunningSuccessfully) aData.mTileEntity).getStateRunningSuccessfully() ? 15 : 0),
                T);
        }
    }
    ...
    public static final ITexture sTextureForeground = BlockTextureDefault
        .get("machines/covers/detectorrunningsuccessfully/circuit");
}
