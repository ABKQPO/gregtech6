...
public class CoverDetectorRunningPassively extends AbstractCoverAttachmentDetector {
    ...
    public boolean interceptCoverPlacement(byte aCoverSide, CoverData aData, Entity aPlayer) {
        return !(aData.mTileEntity.canTick() && aData.mTileEntity instanceof ITileEntityRunningPassively);
    }
    ...
    public void onTickPost(byte aSide, CoverData aData, long aTimer, boolean aIsServerSide,
        ...
        if (aIsServerSide && aData.mTileEntity instanceof ITileEntityRunningPassively) {
            aData.value(
                aSide,
                UT.Code.bind4(((ITileEntityRunningPassively) aData.mTileEntity).getStateRunningPassively() ? 15 : 0),
                T);
        }
    }
    ...
    public static final ITexture sTextureForeground = BlockTextureDefault
        .get("machines/covers/detectorrunningpassively/circuit");
}
