...
public abstract class AbstractCoverDefault implements ICover {
    ...
    public void onCoverPlaced(byte aCoverSide, CoverData aData, Entity aPlayer, ItemStack aCover) {
        if (aPlayer != null) UT.Sounds.send(SFX.GT_SCREWDRIVER, aData.mTileEntity);
    }
    ...
    public ItemStack getCoverItem(byte aCoverSide, CoverData aData) {
        return ST.make(
            aData.mIDs[aCoverSide],
            1,
            aData.mMetas[aCoverSide],
            aData.mNBTs[aCoverSide] == null || aData.mNBTs[aCoverSide].hasNoTags() ? null : aData.mNBTs[aCoverSide]);
    }
    ...
    public ITexture getCoverTextureAttachment(byte aCoverSide, CoverData aData, byte aTextureSide) {
        return getCoverTextureSurface(aCoverSide, aData);
    }
    ...
    public void onAfterCrowbar(ITileEntityCoverable aTileEntity) {
        UT.Sounds.send(SFX.MC_BREAK, 1.0F, -1.0F, aTileEntity);
    }
    ...
    public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
        aList.add(LH.Chat.DGRAY + LH.get(LH.COVER_TOOLTIP));
    }
    ...
    public void getCollisions(byte aCoverSide, CoverData aData, AxisAlignedBB aAABB, List<AxisAlignedBB> aList,
        Entity aEntity) {
        aData.box(aAABB, aList, getCoverBounds(aCoverSide, aData));
    }
