...
public class CoverControllerAuto extends AbstractCoverAttachmentController {
    ...
    public boolean interceptCoverPlacement(byte aCoverSide, CoverData aData, Entity aPlayer) {
        return !(aData.mTileEntity instanceof ITileEntityRunningPossible) || !aData.mTileEntity.canTick()
            || super.interceptCoverPlacement(aCoverSide, aData, aPlayer);
    }
    ...
    public boolean getStateOnOff(byte aSide, CoverData aData) {
        return (aData.mTileEntity instanceof ITileEntityRunningPossible
            && ((ITileEntityRunningPossible) aData.mTileEntity).getStateRunningPossible())
