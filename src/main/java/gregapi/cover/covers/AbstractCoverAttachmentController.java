...
public abstract class AbstractCoverAttachmentController extends AbstractCoverAttachment {
    ...
    public void onCoverRemove(byte aCoverSide, CoverData aData, Entity aPlayer) {
        ...
        if (aData.mTileEntity instanceof ITileEntitySwitchableOnOff && aData.mTileEntity.getWorld() != null)
            ((ITileEntitySwitchableOnOff) aData.mTileEntity).setStateOnOff(T);
    }
    ...
    public void onCoverLoaded(byte aCoverSide, CoverData aData) {
        ...
        if (aData.mTileEntity instanceof ITileEntitySwitchableOnOff && aData.mTileEntity.getWorld() != null)
            ((ITileEntitySwitchableOnOff) aData.mTileEntity).setStateOnOff(getStateOnOff(aCoverSide, aData));
    }
