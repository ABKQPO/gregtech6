...
public class LanguageHandler {
    ...
    public static String translate(String aKey, String aDefault) {
        ...
        String rTranslation = LanguageRegistry.instance()
            .getStringLocalization(aKey);
    ...
    public static String getLocalName(OreDictPrefix aPrefix, OreDictMaterial aMaterial) {
        ...
        if (aPrefix == OP.crateGtRaw || aPrefix == OP.crateGt64Raw || aPrefix == OP.blockRaw)
            return aPrefix.mMaterialPre + getLocalName(OP.ore, aMaterial);
        if (aPrefix == OP.crateGtGem || aPrefix == OP.crateGt64Gem || aPrefix == OP.blockGem)
            return aPrefix.mMaterialPre + getLocalName(OP.gem, aMaterial);
        if (aPrefix == OP.crateGtDust || aPrefix == OP.crateGt64Dust || aPrefix == OP.blockDust)
            return aPrefix.mMaterialPre + getLocalName(OP.dust, aMaterial);
        if (aPrefix == OP.crateGtIngot || aPrefix == OP.crateGt64Ingot || aPrefix == OP.blockIngot)
            return aPrefix.mMaterialPre + getLocalName(OP.ingot, aMaterial);
        if (aPrefix == OP.crateGtPlate || aPrefix == OP.crateGt64Plate || aPrefix == OP.blockPlate)
            return aPrefix.mMaterialPre + getLocalName(OP.plate, aMaterial);
        if (aPrefix == OP.crateGtPlateGem || aPrefix == OP.crateGt64PlateGem || aPrefix == OP.blockPlateGem)
            return aPrefix.mMaterialPre + getLocalName(OP.plateGem, aMaterial);

        if (aMaterial.mID >= 0 && aMaterial.mID < 10 && aPrefix.contains(TD.Prefix.ORE))
            return APRIL_FOOLS ? "Schrödingers Ore" : "Unidentified Ore";
        ...
        if (aMaterial == MT.Empty) {
        ...
        } else if (aMaterial == MT.Stone) {
            if (aPrefix == OP.rockGt) return "Rock";
        } else if (aMaterial == MT.AncientDebris) {
        ...
        } else if (aMaterial == MT.Sand || aMaterial == MT.RedSand
            || aMaterial == MT.SoulSand
            || aMaterial == MT.EndSandWhite
            || aMaterial == MT.EndSandBlack) {
            ...
            } else if (aMaterial == MT.STONES.MarsSand) {
            ...
            } else if (aMaterial == MT.STONES.Holystone) {
                if (aPrefix == OP.rockGt) return "Holy Rock";
            } else if (aMaterial == MT.STONES.Umber) {
                if (aPrefix == OP.rockGt) return "Umber Rock";
            } else if (aMaterial == MT.STONES.Betweenstone) {
                if (aPrefix == OP.rockGt) return "Betweenrock";
            } else if (aMaterial == MT.STONES.Pitstone) {
                if (aPrefix == OP.rockGt) return "Pit Rock";
            } else if (aMaterial == MT.STONES.Gneiss) {
            ...
            } else if (aMaterial == MT.PrismarineLight || aMaterial == MT.PrismarineDark) {
                if (aPrefix == OP.rockGt) return aMaterial.mNameLocal + " Shard";
                if (aPrefix == OP.scrapGt) return aMaterial.mNameLocal + " Shards";
                if (aPrefix == OP.round) return aMaterial.mNameLocal + " Marble";
                if (aPrefix.mNameInternal.startsWith("gem"))
                    return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Crystal";
            } else if (aMaterial == MT.Frezarite || aMaterial == MT.Fluix
                || aMaterial == MT.Redstonia
                || aMaterial == MT.Palis
                || aMaterial == MT.Diamantine
                || aMaterial == MT.VoidCrystal
                || aMaterial == MT.Emeradic
                || aMaterial == MT.Enori) {
                    if (aPrefix.mNameInternal.startsWith("gem"))
                        return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Crystal";
                } else if (aMaterial == MT.InfusedDull) {
                ...
                } else if (aMaterial == MT.InfusedBalance) {
                ...
                } else if (aMaterial == MT.InfusedVis) {
                ...
                } else if (aMaterial == MT.InfusedAir) {
                ...
                } else if (aMaterial == MT.InfusedWater) {
                ...
                } else if (aMaterial == MT.InfusedEarth) {
                ...
                } else if (aMaterial == MT.InfusedFire) {
                ...
                } else if (aMaterial == MT.InfusedOrder) {
                ...
                } else if (aMaterial == MT.InfusedEntropy) {
                ...
                } else if (aMaterial == MT.OatAbyssal) {
                ...
                } else if (aMaterial == MT.WoodTreated) {
                    if (aPrefix == OP.rockGt) return aMaterial.mNameLocal;
                    ...
                    if (aPrefix.contains(TD.Prefix.DUST_BASED))
                ...
                } else if (aMaterial == MT.Steeleaf || aMaterial == MT.Fireleaf) {
                ...
                } else if (aMaterial == MT.Flint) {
                    if (aPrefix == OP.rockGt) return "Mario";
                } else if (aMaterial == MT.Pyrite) {
                    if (aPrefix.contains(TD.Prefix.ORE))
                        return aPrefix.mMaterialPre + MT.Au.mNameLocal + aPrefix.mMaterialPost;
                } else if (aMaterial == MT.MgCO3) {
                    if (aPrefix.containsAny(TD.Prefix.ORE, TD.Prefix.ORE_PROCESSING_BASED))
                        return aPrefix.mMaterialPre + "Magnesite" + aPrefix.mMaterialPost;
                } else if (aMaterial == MT.Asbestos) {
                    if (aPrefix.containsAny(TD.Prefix.ORE, TD.Prefix.ORE_PROCESSING_BASED))
                        return aPrefix.mMaterialPre + "Chrysotile" + aPrefix.mMaterialPost;
                } else if (aMaterial == MT.Talc) {
                    if (aPrefix.containsAny(TD.Prefix.ORE, TD.Prefix.ORE_PROCESSING_BASED))
                        return aPrefix.mMaterialPre + "Soapstone" + aPrefix.mMaterialPost;
                } else if (aMaterial == MT.AlO3H3) {
                    if (aPrefix.containsAny(TD.Prefix.ORE, TD.Prefix.ORE_PROCESSING_BASED))
                        return aPrefix.mMaterialPre + "Gibbsite" + aPrefix.mMaterialPost;
                ...
                } else if (aMaterial == MT.Butter || aMaterial == MT.ButterSalted) {
                    if (aPrefix.mNameInternal.startsWith("ingot")) return aPrefix.mMaterialPre + aMaterial.mNameLocal;
                } else if (aMaterial == MT.Indigo || aMaterial == MT.ConstructionFoam
                    || aMaterial == MT.Cocoa
                    || aMaterial == MT.Curry
                    || aMaterial == MT.Chocolate
                    || aMaterial == MT.Coffee
                    || aMaterial == MT.Chili
                    || aMaterial == MT.Cheese
                    || aMaterial == MT.Snow) {
                        if (aPrefix.contains(TD.Prefix.DUST_BASED))
                            return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Powder";
                    } else if (aMaterial == MT.Potato || aMaterial == MT.Hazelnut
                        || aMaterial == MT.Pistachio
                        || aMaterial == MT.Almond
                        || aMaterial == MT.Peanut
                        || aMaterial == MT.Nutmeg
                        || aMaterial == MT.Cinnamon
                        || aMaterial == MT.Vanilla
                        || aMaterial == MT.PepperBlack) {
                            if (aPrefix.contains(TD.Prefix.DUST_BASED))
                            ...
                            if (aPrefix.contains(TD.Prefix.DUST_BASED))
                                return aPrefix.mMaterialPre + "Silken " + aMaterial.mNameLocal;
                            if (aPrefix.mNameInternal.startsWith("ingot"))
                                return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Bar";
                        ...
                        } else if (aMaterial == MT.Lignite || aMaterial == MT.LigniteCoke
                            || aMaterial == MT.Charcoal
                            || aMaterial == MT.Coal
                            || aMaterial == MT.CoalCoke
                            || aMaterial == MT.Anthracite
                            || aMaterial == MT.Prismane
                            || aMaterial == MT.Lonsdaleite
                            || aMaterial == MT.PetCoke
                            || aMaterial == MT.HydratedCoal) {
                                if (aPrefix.mNameInternal.startsWith("ingot"))
                                    return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Brick";
                                if (aPrefix == OP.chunkGt)
                                    return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Chunk";
                                if (aPrefix == OP.nugget)
                                    return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Pellet";
                            } else if (aMaterial == MT.Sugar) {
                                if (aPrefix == OP.gemChipped) return "Sugar Cubes";
                            } else if (aMaterial == MT.KCl) {
                                if (aPrefix.contains(TD.Prefix.DUST_BASED)) return aPrefix.mMaterialPre + "Rock Salt";
                            } else if (aMaterial == MT.Ceramic) {
                                if (aPrefix == OP.scrapGt) return "Brittle Ceramic Scraps";
                                if (aPrefix.contains(TD.Prefix.DUST_BASED))
                                    return aPrefix.mMaterialPre + "Dry Clay Powder";
                            } else if (ANY.Blaze.mToThis.contains(aMaterial)) {
                                if (aPrefix.contains(TD.Prefix.DUST_BASED))
                                    return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Powder";
                                if (aPrefix.mNameInternal.startsWith("stick"))
                                    return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Rod";
                                if (aPrefix.mNameInternal.startsWith("ingot"))
                                    return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Bar";
                            } else if (ANY.Clay.mToThis.contains(aMaterial)) {
                                if (aPrefix.contains(TD.Prefix.DUST_BASED))
                                    return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Powder";
                            } else
                                ...
                                } else if (aMaterial == MT.Dilithium) {
                                    if (aPrefix.mNameInternal.startsWith("gem"))
                                        return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Crystal";
                                } else if (aMaterial == MT.Ectoplasm || aMaterial == MT.Tallow
                                    || aMaterial == MT.Gunpowder
                                    || aMaterial == MT.NaCl
                                    || aMaterial == MT.KCl
                                    || aMaterial == MT.KIO3
                                    || aMaterial == MT.Asphalt) {
                                        if (aPrefix.contains(TD.Prefix.DUST_BASED))
                                            return aPrefix.mMaterialPre + aMaterial.mNameLocal;
                                    } else if (aMaterial == MT.Black || aMaterial == MT.Red
                                        || aMaterial == MT.Green
                                        || aMaterial == MT.Brown
                                        || aMaterial == MT.Blue
                                        || aMaterial == MT.Purple
                                        || aMaterial == MT.Cyan
                                        || aMaterial == MT.LightGray
                                        || aMaterial == MT.Gray
                                        || aMaterial == MT.Pink
                                        || aMaterial == MT.Lime
                                        || aMaterial == MT.Yellow
                                        || aMaterial == MT.LightBlue
                                        || aMaterial == MT.Magenta
                                        || aMaterial == MT.Orange
                                        || aMaterial == MT.White) {
                                            if (aPrefix == OP.plantGtFiber) return aMaterial.mNameLocal + " String";
                                            if (aPrefix.contains(TD.Prefix.DUST_BASED))
                                                return aPrefix.mMaterialPre + aMaterial.mNameLocal + " Dye";
                                        } else if (aMaterial == MT.Wax || aMaterial == MT.WaxMagic
                                            || aMaterial == MT.WaxAmnesic
                                            || aMaterial == MT.WaxSoulful
                                            || aMaterial == MT.WaxBee
                                            || aMaterial == MT.WaxRefractory
                                            || aMaterial == MT.WaxPlant
                                            || aMaterial == MT.WaxParaffin
                                            || aMaterial == MT.Ash
                                            || aMaterial == MT.DarkAsh
                                            || aMaterial == MT.VolcanicAsh
                                            || aMaterial == MT.ArcaneAsh
                                            || aMaterial == MT.ArcaneCompound
                                            || aMaterial == MT.OREMATS.Vermiculite
                                            || aMaterial == MT.Talc
                                            || aMaterial == MT.OREMATS.Magnetite
                                            || aMaterial == MT.OREMATS.BasalticMineralSand
                                            || aMaterial == MT.OREMATS.GraniticMineralSand
                                            || aMaterial == MT.OREMATS.GarnetSand
                                            || aMaterial == MT.SluiceSand
                                            || aMaterial == MT.OREMATS.QuartzSand
                                            || aMaterial == MT.OREMATS.Pitchblende
                                            || aMaterial == MT.Bentonite
                                            || aMaterial == MT.Palygorskite
                                            || aMaterial == MT.RareEarth
                                            || aMaterial == MT.Oilsands) {
        ...
        if (aMaterial.contains(TD.Properties.STONE)) {
            if (aPrefix == OP.rockGt) return aMaterial.mNameLocal.endsWith("rock")
                ? (aMaterial.mNameLocal + " §§§").replaceFirst("rock §§§", " Rock")
                : aMaterial.mNameLocal + " Rock";
            if (aPrefix == OP.scrapGt) return aMaterial.mNameLocal + " Pebbles";
        }
        if (aMaterial.mID > 0 && aMaterial.mID <= 830
            && aMaterial.mID % 10 == 0
            && aMaterial.mMeltingPoint > C
            && aMaterial.mTargetCrushing.mMaterial == aMaterial
            && aMaterial.contains(TD.Processing.SMITHABLE)) {
            if (aPrefix.containsAny(TD.Prefix.ORE, TD.Prefix.ORE_PROCESSING_BASED))
                return aPrefix.mMaterialPre + "Native " + aMaterial.mNameLocal + aPrefix.mMaterialPost;
        }
