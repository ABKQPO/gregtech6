...
public class LoggerPlayerActivity implements Runnable {
    ...
    public void onPlayerInteraction(PlayerInteractEvent aEvent) {
        if (aEvent.entityPlayer != null && aEvent.entityPlayer.worldObj != null
            ...
            && mLog != null)
            mBufferedPlayerActivity.add(
                UT.Code.dateAndTime() + ";"
                    + aEvent.action.name()
                    + ";"
                    + aEvent.entityPlayer.getCommandSenderName()
                    + ";DIM:"
    ...
    public void onBlockHarvestingEvent(BlockEvent.HarvestDropsEvent aEvent) {
        if (aEvent.harvester != null && !aEvent.world.isRemote && mLog != null) mBufferedPlayerActivity.add(
            UT.Code.dateAndTime() + ";HARVEST_BLOCK;"
                + aEvent.harvester.getCommandSenderName()
                + ";DIM:"
                + aEvent.world.provider.dimensionId
                + ";"
                + aEvent.x
