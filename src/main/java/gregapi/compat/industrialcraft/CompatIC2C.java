...
public class CompatIC2C extends CompatBase implements IWrenchHandler {
    ...
    @Override
    public boolean supportsItem(ItemStack aWrench) {
        return ST.valid(aWrench) && ST.isGT_(aWrench);
    }

    @Override
    public boolean canWrench(ItemStack aWrench, int aX, int aY, int aZ, EntityPlayer aPlayer) {
        return F;
    }

    @Override
    public void useWrench(ItemStack aWrench, int aX, int aY, int aZ, EntityPlayer aPlayer) {/**/}
}
