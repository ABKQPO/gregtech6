...
public class CompatTC extends CompatBase implements ICompatTC {
    ...
    public CompatTC() {
        ...
        TC.STRONTIO.mAspect = new Aspect(
            "strontio",
            0xeec2b3,
            new Aspect[] { Aspect.MIND, Aspect.ENTROPY },
            new ResourceLocation(RES_PATH_ASPECTS + "STRONTIO.png"),
            1);
        TC.NEBRISUM.mAspect = new Aspect(
            "nebrisum",
            0xeeee7e,
            new Aspect[] { Aspect.MINE, Aspect.GREED },
            new ResourceLocation(RES_PATH_ASPECTS + "NEBRISUM.png"),
            1);
        TC.ELECTRUM.mAspect = new Aspect(
            "electrum",
            0xc0eeee,
            new Aspect[] { Aspect.ENERGY, Aspect.MECHANISM },
            new ResourceLocation(RES_PATH_ASPECTS + "ELECTRUM.png"),
            1);
        TC.MAGNETO.mAspect = new Aspect(
            "magneto",
            0xc0c0c0,
            new Aspect[] { Aspect.METAL, Aspect.TRAVEL },
            new ResourceLocation(RES_PATH_ASPECTS + "MAGNETO.png"),
            1);
        TC.RADIO.mAspect = new Aspect(
            "radio",
            0xc0ffc0,
            new Aspect[] { Aspect.LIGHT, Aspect.ENERGY },
            new ResourceLocation(RES_PATH_ASPECTS + "RADIO.png"),
            1);
        // TC.REFLEXIO .mAspect = new Aspect("reflexio" , 0xf0f0f0, new Aspect[] {Aspect.ENERGY, Aspect.EXCHANGE} , new
        // ResourceLocation(RES_PATH_ASPECTS + "REFLEXIO.png"), 1);

        TC.REFLEXIO.mAspect = Aspect.EXCHANGE;

        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Forest Squirrel",
            new AspectList().add(Aspect.BEAST, 2)
                .add(Aspect.EARTH, 2));
        ThaumcraftApi.registerEntityTag(
        ...
        ThaumcraftApi.registerEntityTag(
            ...
            new AspectList().add(Aspect.BEAST, 2)
                ...
                .add(Aspect.AIR, 1));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Glacier Penguin",
            new AspectList().add(Aspect.BEAST, 2)
                .add(Aspect.FLIGHT, 1)
                .add(Aspect.COLD, 2));
        ThaumcraftApi.registerEntityTag(
        ...
        ThaumcraftApi.registerEntityTag(
            ...
            new AspectList().add(Aspect.BEAST, 5)
                .add(Aspect.CLOTH, 5)
                .add(Aspect.SENSES, 5));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Wild Deer",
            new AspectList().add(Aspect.BEAST, 3)
                .add(Aspect.EARTH, 3));
        ThaumcraftApi.registerEntityTag(
        ...
        ThaumcraftApi.registerEntityTag(
            ...
            new AspectList().add(Aspect.UNDEAD, 3)
                .add(Aspect.MAN, 1)
                .add(Aspect.MAGIC, 1));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Loyal Zombie",
            new AspectList().add(Aspect.UNDEAD, 2)
                .add(Aspect.MAN, 1)
                .add(Aspect.EARTH, 1));
        ThaumcraftApi.registerEntityTag(
            ...
            new AspectList().add(Aspect.UNDEAD, 2)
                ...
                .add(Aspect.EARTH, 1));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Giant Miner",
            new AspectList().add(Aspect.MAN, 5)
                .add(Aspect.MINE, 3)
                .add(Aspect.GREED, 3));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Armored Giant",
            new AspectList().add(Aspect.MAN, 5)
                .add(Aspect.WEAPON, 3)
                .add(Aspect.ARMOR, 3));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Redcap",
            new AspectList().add(Aspect.MAN, 2)
                .add(Aspect.MINE, 2));
        ThaumcraftApi.registerEntityTag(
        ...
        ThaumcraftApi.registerEntityTag(
            ...
            new AspectList().add(Aspect.SLIME, 2)
                .add(Aspect.WATER, 2));
        ThaumcraftApi.registerEntityTag(
        ...
        ThaumcraftApi.registerEntityTag(
            ...
            new AspectList().add(Aspect.UNDEAD, 20)
                .add(Aspect.FIRE, 20));
        ThaumcraftApi.registerEntityTag(
        ...
        ThaumcraftApi.registerEntityTag(
            ...
            new AspectList().add(Aspect.BEAST, 1)
                ...
                .add(Aspect.POISON, 1));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Stable Ice Core",
            new AspectList().add(Aspect.ELDRITCH, 4)
                .add(Aspect.COLD, 1));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Unstable Ice Core",
            new AspectList().add(Aspect.ELDRITCH, 4)
                .add(Aspect.COLD, 1)
                .add(Aspect.EXCHANGE, 1));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Ice Crystal",
            new AspectList().add(Aspect.ELDRITCH, 4)
                .add(Aspect.COLD, 1));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.SnowGuardian",
        ...
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Block&Chain Goblin",
            new AspectList().add(Aspect.MAN, 4)
                .add(Aspect.WEAPON, 3));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Upper Goblin Knight",
            new AspectList().add(Aspect.MAN, 4)
                .add(Aspect.WEAPON, 3));
        ThaumcraftApi.registerEntityTag(
            "TwilightForest.Lower Goblin Knight",
            new AspectList().add(Aspect.MAN, 4)
                .add(Aspect.ARMOR, 3));
        ThaumcraftApi.registerEntityTag(
        ...
        ThaumcraftApi.registerEntityTag(
            ...
            new AspectList().add(Aspect.BEAST, 4)
                .add(Aspect.MAN, 4)
                .add(Aspect.WEAPON, 2));
        ThaumcraftApi.registerEntityTag(
    ...
    public void onServerStarting(FMLServerStartingEvent aEvent) {
        // These ItemStacks are Enchanted BEFORE being copied in Thaumcraft, which leads to them always having the SAME
        // Enchantment...
    ...
    public boolean scan(EntityPlayer aPlayer, ItemStack aStack) {
        ...
        ScanResult tScan;
        if (ST.meta(aStack) == W) {
            if (!ScanManager.hasBeenScanned(
                aPlayer,
                tScan = new ScanResult(
                    (byte) 2,
                    ST.id(aStack),
                    0,
                    ST.entity(aPlayer, ST.make(ST.item(aStack), 1, 0)),
                    "")))
                rReturn |= ScanManager.completeScan(aPlayer, tScan, "@");
            if (ST.item(aStack)
                .getHasSubtypes())
                for (int i = 1; i < 16; i++) if (!ScanManager.hasBeenScanned(
                    aPlayer,
                    tScan = new ScanResult(
                        (byte) 2,
                        ST.id(aStack),
                        i,
                        ST.entity(aPlayer, ST.make(ST.item(aStack), 1, i)),
                        "")))
                    rReturn |= ScanManager.completeScan(aPlayer, tScan, "@");
        } else {
            if (!ScanManager.hasBeenScanned(
                ...
                tScan = new ScanResult(
                    ...
                    ST.id(aStack),
                    ST.meta(aStack),
                    ST.entity(aPlayer, ST.copy_(aStack)),
                    "")))
                rReturn |= ScanManager.completeScan(aPlayer, tScan, "@");
        }
        return rReturn;
    ...
    public void onIDChanging(FMLModIdMappingEvent aEvent) {
        try {
            // This fixes the frikkin Axe, so it can use OreDict Logs, which is broken in way too many ways...
            // especially after the Block ID change of Vanilla MC that did not get ported properly into Thaumcraft.
            ...
            for (ItemStack tStack : OreDictManager.getOres(OD.woodLog, T)) {
                ...
                if (tBlock != NB) {
                    ItemElementalAxe.oreDictLogs
                        .add(Arrays.asList(new Object[] { tBlock, Integer.valueOf(ST.meta(tStack)) }));
                }
            }
            ...
            for (ItemStackContainer tStack : WoodDictionary.WOODS.keySet()) if (tStack.mBlock != NB) {
                if (tStack.mMetaData == W) {
                    for (int i = 0; i < 16; i++) ItemElementalAxe.oreDictLogs
                        .add(Arrays.asList(new Object[] { tStack.mBlock, Integer.valueOf(i) }));
                } else {
                    ItemElementalAxe.oreDictLogs
                        .add(Arrays.asList(new Object[] { tStack.mBlock, Integer.valueOf(tStack.mMetaData) }));
                }
            }
    ...
    public Object getAspectList(TC_AspectStack... aAspects) {
        ...
        if (aAspects != null) for (TC_AspectStack tAspect : aAspects)
    ...
    public Object addResearch(String aResearch, String aName, String aText, String[] aParentResearches,
        String aCategory, ItemStack aIcon, int aComplexity, int aType, int aX, int aY, List<TC_AspectStack> aAspects,
        ...
        ResearchItem rResearch = new ResearchItem(
            aResearch,
            aCategory,
            (AspectList) getAspectList(aAspects),
            aX,
            aY,
            aComplexity,
            aIcon);
        ...
        for (Object tPage : aPages) if (tPage != null) {
            ...
            if (tPage instanceof IArcaneRecipe) {
                tPages.add(new ResearchPage((IArcaneRecipe) tPage));
                continue;
            }
            if (tPage instanceof CrucibleRecipe) {
                tPages.add(new ResearchPage((CrucibleRecipe) tPage));
                continue;
            }
            if (tPage instanceof InfusionRecipe) {
                tPages.add(new ResearchPage((InfusionRecipe) tPage));
                continue;
            }
            if (tPage instanceof InfusionEnchantmentRecipe) {
        ...
        if (aParentResearches != null) {
            ...
            for (String tParent : aParentResearches)
                if (ConfigsGT.RECIPES.get(ConfigCategories.Recipes.researches, aResearch, T))
    ...
    public Object addCrucibleRecipe(String aResearch, Object aInput, ItemStack aOutput, List<TC_AspectStack> aAspects) {
        if (UT.Code.stringInvalid(aResearch) || aInput == null
            || aOutput == null
            || aAspects == null
            || aAspects.isEmpty()) return null;
    ...
    public boolean registerThaumcraftAspectsToItem(ItemStack aExampleStack, List<TC_AspectStack> aAspects,
        String aOreDict) {
        return F;
    }
    ...
    @Override
    @SuppressWarnings("deprecation")
    public boolean registerThaumcraftAspectsToItem(ItemStack aExampleStack, String aOreDict,
        TC_AspectStack... aAspects) {
        return F;
    }
    ...
    public boolean registerThaumcraftAspectsToItem(ItemStack aStack, List<TC_AspectStack> aAspects, boolean aAdditive) {
        ...
        if (!ThaumcraftApi.objectTags.containsKey(aKey))
            ThaumcraftApi.objectTags.put(aKey, (AspectList) getAspectList(aAspects));
        return T;
    }
