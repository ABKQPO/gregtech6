...
public interface ICompatTC extends ICompat {
    ...
    public static final int RESEARCH_TYPE_NORMAL = 0, RESEARCH_TYPE_SECONDARY = 1, RESEARCH_TYPE_FREE = 2,
        RESEARCH_TYPE_HIDDEN = 4, RESEARCH_TYPE_VIRTUAL = 8, RESEARCH_TYPE_ROUND = 16, RESEARCH_TYPE_SPECIAL = 32,
        RESEARCH_TYPE_AUTOUNLOCK = 64, RESEARCH_TYPE_LOST = 128;
    public static final String CATEGORY_ALCHEMY = "ALCHEMY";

    /** The Research Keys of GT */
    public static final String IRON_TO_STEEL = "GT_IRON_TO_STEEL", FILL_WATER_BUCKET = "GT_FILL_WATER_BUCKET",
        ...
        TRANSCONSTANTAN = "GT_TRANSCUPRONICKEL", TRANSBATTERYALLOY = "GT_TRANSBATTERYALLOY",
        ...
        CRYSTALLISATION = "GT_CRYSTALLISATION", ADVANCEDENTROPICPROCESSING = "GT_ADVANCEDENTROPICPROCESSING",
    ...
    /** Just dont use this anymore, it does not work properly. */
    @Deprecated
