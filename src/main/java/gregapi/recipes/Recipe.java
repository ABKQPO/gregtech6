...
public class Recipe {
    ...
    public static class RecipeMap implements Runnable {
        ...
        public final int mInputItemsCount, mOutputItemsCount, mInputFluidCount, mOutputFluidCount, mMinimalInputItems,
            mMinimalInputFluids, mMinimalInputs;
        public final long mNEISpecialValueMultiplier, mPower;
        public final boolean mNEIAllowed, mShowVoltageAmperageInNEI, mNeedsOutputs, mCombinePower, mUseBucketSizeIn,
            mUseBucketSizeOut;
        public boolean mLogErrors = T;
        /**
         * Used to determine Input Tank Size. Contains the size of the largest FluidStack Input, but is almost always at
         * least 1000.
         */
        public int mMaxFluidInputSize = 1000;
        /**
         * Used to determine Output Tank Size. Contains the size of the largest FluidStack Output, but is almost always
         * at least 1000.
         */
         ...
         */
        public RecipeMap(Collection<Recipe> aRecipeList, String aNameInternal, String aNameLocal, String aNameNEI,
            ...
            long aNEISpecialValueMultiplier, String aNEISpecialValuePost, boolean aFuelMap,
            boolean aShowVoltageAmperageInNEI, boolean aNEIAllowed, boolean aConfigAllowed, boolean aNeedsOutputs,
            boolean aCombinePower, boolean aUseBucketSizeIn, boolean aUseBucketSizeOut) {
            ...
            for (char tChar : mNameLocal.toCharArray()) {
                ...
                if (tChar == ' ' || tChar == '-'
                    ...
                    || tChar == '|'
                    || tChar == '/'
                    || tChar == '\\') tBuilder.append('_');
                else tBuilder.append(tChar);
            }
            ...
            if (RECIPE_MAPS.containsKey(mNameInternal))
                throw new IllegalArgumentException("Recipe Map Name already exists: " + mNameInternal);
            RECIPE_MAPS.put(mNameInternal, this);
            RECIPE_MAP_LIST.add(this);
            if (aFuelMap) FUEL_MAP_LIST.add(this);
            if (aConfigAllowed) if (GAPI.mBeforePreInit != null) GAPI.mBeforePreInit.add(this);
            else run();
        }
        ...
        @Override
        public void run() {
            mConfigFile = new Config(DirectoriesGT.CONFIG_RECIPES, mNameLocalUnderscored + ".cfg");
        }
        ...
        public RecipeMap(Collection<Recipe> aRecipeList, String aNameInternal, String aNameLocal, String aNameNEI,
            ...
            long aMinimalInputFluids, long aMinimalInputs, long aPower, String aNEISpecialValuePre,
            long aNEISpecialValueMultiplier, String aNEISpecialValuePost, boolean aShowVoltageAmperageInNEI,
            boolean aNEIAllowed, boolean aConfigAllowed, boolean aNeedsOutputs) {
            this(
                aRecipeList,
                aNameInternal,
                aNameLocal,
        ...
        public RecipeMap(Collection<Recipe> aRecipeList, String aNameInternal, String aNameLocal, String aNameNEI,
            long aProgressBarDirection, long aProgressBarAmount, String aNEIGUIPath, long aInputItemsCount,
            long aOutputItemsCount, long aMinimalInputItems, long aInputFluidCount, long aOutputFluidCount,
            long aMinimalInputFluids, long aPower, String aNEISpecialValuePre, long aNEISpecialValueMultiplier,
            String aNEISpecialValuePost, boolean aShowVoltageAmperageInNEI, boolean aNEIAllowed, boolean aConfigAllowed,
            boolean aNeedsOutputs) {
            this(
                aRecipeList,
                aNameInternal,
                aNameLocal,
        ...
        public RecipeMap(Collection<Recipe> aRecipeList, String aNameInternal, String aNameLocal, String aNameNEI,
            long aProgressBarDirection, long aProgressBarAmount, String aNEIGUIPath, long aInputItemsCount,
            long aOutputItemsCount, long aMinimalInputItems, long aMinimalInputFluids, long aPower,
            String aNEISpecialValuePre, long aNEISpecialValueMultiplier, String aNEISpecialValuePost,
        ...
        @Deprecated
        public RecipeMap(Collection<Recipe> aRecipeList, String aNameInternal, String aNameLocal, String aNameNEI,
            String aNEIGUIPath, long aInputItemsCount, long aOutputItemsCount, long aMinimalInputItems,
            long aMinimalInputFluids, long aPower, String aNEISpecialValuePre, long aNEISpecialValueMultiplier,
            String aNEISpecialValuePost, boolean aShowVoltageAmperageInNEI, boolean aNEIAllowed) {
            this(
                aRecipeList,
        ...
        public Recipe addRecipe(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs, Object aSpecial,
            long[] aOutputChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, long aDuration, long aEUt,
            long aSpecialValue) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack aInput,
            ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack aInput1,
            ItemStack aInput2, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
                    T,
                    ST.array(aInput1, aInput2),
                    ST.array(aOutput),
                    NI,
                    new long[] { aChance },
                    ZL_FS,
        ...
        public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack[] aInputs,
            ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, ItemStack aInput,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(aOptimize, T, T, ST.array(aInput), aOutputs, NI, ZL_LONG, ZL_FS, ZL_FS, aDuration, aEUt, 0));
        }

        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, ItemStack aInput1, ItemStack aInput2,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, ItemStack[] aInputs,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(aOptimize, T, T, aInputs, aOutputs, NI, ZL_LONG, ZL_FS, ZL_FS, aDuration, aEUt, 0));
        }

        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long[] aChances, ItemStack aInput,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long[] aChances, ItemStack aInput1,
            ItemStack aInput2, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipeX(boolean aOptimize, long aEUt, long aDuration, long[] aChances, ItemStack[] aInputs,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(aOptimize, T, T, aInputs, aOutputs, NI, aChances, ZL_FS, ZL_FS, aDuration, aEUt, 0));
        }

        public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long aChance, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
                    ...
                    NI,
                    new long[] { aChance },
                    FL.array(aFluidInput),
                    FL.array(aFluidOutput),
                    aDuration,
                    aEUt,
                    0));
        }
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack aInput,
            FluidStack aFluidInput, FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack aInput1,
            ItemStack aInput2, FluidStack aFluidInput, FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, ItemStack aInput, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, ItemStack aInput1, ItemStack aInput2,
            FluidStack aFluidInput, FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long[] aChances, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long[] aChances, ItemStack aInput1,
            ItemStack aInput2, FluidStack aFluidInput, FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, ItemStack aInput1, ItemStack aInput2,
            FluidStack aFluidInput, FluidStack... aFluidOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long aChance, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack aInput,
            FluidStack[] aFluidInputs, FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack aInput1,
            ItemStack aInput2, FluidStack[] aFluidInputs, FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, ItemStack aInput,
            FluidStack[] aFluidInputs, FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long[] aChances,
            FluidStack[] aFluidInputs, FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long[] aChances, ItemStack aInput1,
            ItemStack aInput2, FluidStack[] aFluidInputs, FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, ItemStack aInput,
            FluidStack[] aFluidInputs, FluidStack... aFluidOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, long aChance, FluidStack[] aFluidInputs,
            FluidStack[] aFluidOutputs, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack aInput,
            FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long aChance, ItemStack aInput1,
            ItemStack aInput2, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe0(boolean aOptimize, long aEUt, long aDuration, FluidStack[] aFluidInputs,
            FluidStack[] aFluidOutputs, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe1(boolean aOptimize, long aEUt, long aDuration, ItemStack aInput,
            FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe2(boolean aOptimize, long aEUt, long aDuration, long[] aChances, ItemStack aInput1,
            ItemStack aInput2, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, ItemStack aInput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, ItemStack aInput1, ItemStack aInput2,
            ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, ItemStack[] aInputs, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, ItemStack aInput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(aOptimize, T, T, ST.array(aInput), aOutputs, NI, ZL_LONG, ZL_FS, ZL_FS, aDuration, aEUt, 0),
                aCheckForCollisions,
                aFakeRecipe,
        ...
        public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, ItemStack aInput1, ItemStack aInput2,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, ItemStack[] aInputs, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(aOptimize, T, T, aInputs, aOutputs, NI, ZL_LONG, ZL_FS, ZL_FS, aDuration, aEUt, 0),
                aCheckForCollisions,
                aFakeRecipe,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long[] aChances, ItemStack aInput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(aOptimize, T, T, ST.array(aInput), aOutputs, NI, aChances, ZL_FS, ZL_FS, aDuration, aEUt, 0),
                aCheckForCollisions,
                aFakeRecipe,
                aHidden,
                aLogErrors);
        ...
        public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long[] aChances, ItemStack aInput1, ItemStack aInput2,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long[] aChances, ItemStack[] aInputs,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(aOptimize, T, T, aInputs, aOutputs, NI, aChances, ZL_FS, ZL_FS, aDuration, aEUt, 0),
                aCheckForCollisions,
        ...
        public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, ItemStack aInput, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, ItemStack[] aInputs, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, FluidStack aFluidInput, FluidStack aFluidOutput,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, ItemStack aInput, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe2(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, ItemStack aInput1, ItemStack aInput2, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, ItemStack[] aInputs, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long[] aChances, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long[] aChances, ItemStack aInput, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long[] aChances, ItemStack[] aInputs, FluidStack aFluidInput,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, FluidStack aFluidInput, FluidStack... aFluidOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
                    T,
        ...
        public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, ItemStack aInput, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long aChance, ItemStack[] aInputs, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack aOutput) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, FluidStack[] aFluidInputs, FluidStack aFluidOutput,
            ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, ItemStack aInput, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipeX(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, ItemStack[] aInputs, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long[] aChances, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe1(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, long[] aChances, ItemStack aInput, FluidStack[] aFluidInputs,
            FluidStack aFluidOutput, ItemStack... aOutputs) {
            return addRecipe(
                new Recipe(
                    aOptimize,
        ...
        public Recipe addRecipe0(boolean aOptimize, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            boolean aLogErrors, long aEUt, long aDuration, FluidStack[] aFluidInputs, FluidStack... aFluidOutputs) {
            return addRecipe(
                new Recipe(aOptimize, T, T, ZL_IS, ZL_IS, NI, ZL_LONG, aFluidInputs, aFluidOutputs, aDuration, aEUt, 0),
                aCheckForCollisions,
                aFakeRecipe,
                aHidden,
                aLogErrors);
        ...
        public Recipe addRecipe(Recipe aRecipe, boolean aCheckForCollisions, boolean aFakeRecipe, boolean aHidden,
            ...
            if (aCheckForCollisions
                && findRecipeInternal(null, null, F, F, Long.MAX_VALUE, null, aRecipe.mFluidInputs, aRecipe.mInputs)
                    != null)
                return null;
         ...
         */
        public Recipe addFakeRecipe(boolean aCheckForCollisions, ItemStack[] aInputs, ItemStack[] aOutputs,
            Object aSpecial, long[] aOutputChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs,
         ...
         */
        public Recipe addFakeRecipe(boolean aCheckForCollisions, ItemStack[] aInputs, ItemStack[] aOutputs,
            Object aSpecial, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, long aDuration, long aEUt,
            long aSpecialValue) {
            return addFakeRecipe(
                aCheckForCollisions,
                new Recipe(
        ...
        public synchronized Recipe add(Recipe aRecipe, boolean aLogErrors, boolean aAddConfig) {
            if (!aRecipe.mFakeRecipe) {
                ...
                if (aRecipe.mInputs.length + aRecipe.mFluidInputs.length <= 0) {
                    ...
                    if (mNeedsOutputs && aRecipe.mOutputs.length + aRecipe.mFluidOutputs.length <= 0) {
                        if (aLogErrors) ERR.println("ERROR: Recipe has no Outputs!");
                        tFailed = T;
                    }
                    if (aRecipe.mInputs.length < mMinimalInputItems) {
                        if (aLogErrors)
                            ERR.println("ERROR: Recipe has less than the minimal amount of Input ItemStacks!");
                        tFailed = T;
                    }
                    if (aRecipe.mFluidInputs.length < mMinimalInputFluids) {
                        if (aLogErrors)
                            ERR.println("ERROR: Recipe has less than the minimal amount of Input FluidStacks!");
                        tFailed = T;
                    }
                    if (aRecipe.mFluidInputs.length + aRecipe.mInputs.length < mMinimalInputs) {
                        if (aLogErrors)
                            ERR.println("ERROR: Recipe has less than the minimal amount of general Inputs!");
                        tFailed = T;
                    }
                    if (aRecipe.mInputs.length > mInputItemsCount) {
                        if (aLogErrors)
                            ERR.println("ERROR: Recipe has more than the maximum amount of Input ItemStacks!");
                        tFailed = T;
                    }
                    if (aRecipe.mFluidInputs.length > mInputFluidCount) {
                        if (aLogErrors)
                            ERR.println("ERROR: Recipe has more than the maximum amount of Input FluidStacks!");
                        tFailed = T;
                    }
                }
                if (aRecipe.mOutputs.length > mOutputItemsCount) {
                    if (aLogErrors)
                        ERR.println("WARNING: Recipe has more than the maximum amount of Output ItemStacks!");
                    tErrored = T;
                }
                if (aRecipe.mFluidOutputs.length > mOutputFluidCount) {
                    if (aLogErrors)
                        ERR.println("WARNING: Recipe has more than the maximum amount of Output FluidStacks!");
                    tErrored = T;
                }
                if (aRecipe.mDuration == 0) {
                    if (aLogErrors) ERR.println("WARNING: Recipe has no Duration Value!");
                    tErrored = T;
                }
                ...
                if (tErrored || tFailed) {
                    if (aLogErrors) {
                        ...
                        int i = 0;
                        for (StackTraceElement tElement : new Exception().getStackTrace()) if (!tElement.getClassName()
                            .equals(RecipeMap.class.getName()))
                            if (i++ < 5 && !tElement.getClassName()
                                .startsWith("sun")) ERR.println("\tat " + tElement);
                            else break;
                    }
            ...
            for (FluidStack tFluid : aRecipe.mFluidInputs) if (FL.Error.is(tFluid)) {
                ERR.println(
                    "Compat: The Fluid for a Recipe has not been found! This might just be for a Mod that is not installed or updated enough!");
                ERR.println("Input Items:  " + ST.names(aRecipe.mInputs));
                ERR.println("Input Fluid:  " + FL.configNames(aRecipe.mFluidInputs));
                ERR.println("Output Items: " + ST.names(aRecipe.mOutputs));
                ERR.println("Output Fluid: " + FL.configNames(aRecipe.mFluidOutputs));
            ...
            if (aAddConfig && mConfigFile != null) {
                ...
                if (UT.Code.stringValid(tConfigName)) {
                    aRecipe.mDuration = mConfigFile
                        .get(mNameLocalUnderscored, tConfigName, aRecipe.mEnabled ? aRecipe.mDuration : 0);
            ...
            for (FluidStack aFluid : aRecipe.mFluidInputs) if (aFluid != null) {
                String aFluidName = aFluid.getFluid()
                    .getName();
        ...
        public boolean containsInput(ItemStack aStack, IHasWorldAndCoords aTileEntity, ItemStack aSpecialSlot) {
            ...
            for (IRecipeMapHandler tHandler : mRecipeMapHandlers)
                if (tHandler.containsInput(this, aStack, aData)) return T;
            return F;
        }
         ...
         * 
         * @param aTileEntity    an Object representing the current coordinates of the executing Block/Entity/Whatever.
         *                       This may be null, especially during Startup.
         ...
         * @param aSpecialSlot   the content of the Special Slot, the regular Manager doesn't do anything with this, but
         *                       some custom ones do.
        ...
        /**
         * finds a Recipe matching the Fluid and ItemStack Inputs. (Using IFluidTank as parameter and converting it
         * automatically)
         * 
         * @param aTileEntity    an Object representing the current coordinates of the executing Block/Entity/Whatever.
         *                       This may be null, especially during Startup.
         ...
         * @return the Recipe it has found or null for no matching Recipe
         */
        public final Recipe findRecipe(IHasWorldAndCoords aTileEntity, Recipe aRecipe, boolean aNotUnificated,
            long aSize, ItemStack aSpecialSlot, IFluidTank[] aTanks, ItemStack... aInputs) {
        ...
        public Recipe findRecipeInternal(IHasWorldAndCoords aTileEntity, Recipe aRecipe, boolean aLoop,
            boolean aNotUnificated, long aSize, ItemStack aSpecialSlot, FluidStack[] aFluids, ItemStack... aInputs) {
            ...
            if (aRecipe != null) if (!aRecipe.mFakeRecipe && aRecipe.mCanBeBuffered
                && aRecipe.isRecipeInputEqual(F, T, aFluids, aInputs))
                return aRecipe.mEnabled && UT.Code.abs_greater_equal(aSize * mPower, aRecipe.mEUt) ? oRecipe = aRecipe
                    : null;
            if (oRecipe != null) if (!oRecipe.mFakeRecipe && oRecipe.mCanBeBuffered
                && oRecipe.isRecipeInputEqual(F, T, aFluids, aInputs))
                return oRecipe.mEnabled && UT.Code.abs_greater_equal(aSize * mPower, oRecipe.mEUt) ? oRecipe : null;

            // Because MineTweaker screws up at this.
            if (aLoop && mRecipeListSize != mRecipeList.size()) {
                ERR.println(
                    "RecipeMap for " + mNameLocal
                        + " got changed without re-initializing the HashMaps! This is a Bug of whatever Recipe Tweaker Mod you are using!");
                reInit();
            }
            ...
            try {
                ...
                if (mInputItemsCount > 0) for (ItemStack tStack1 : aInputs) if (tStack1 != null) {
                    Collection<Recipe> tRecipes = mRecipeItemMap.get(tStack1);
                    if (tRecipes != null) for (Recipe tRecipe : tRecipes)
                        if (!tRecipe.mFakeRecipe && tRecipe.isRecipeInputEqual(F, T, aFluids, aInputs))
                            return tRecipe.mEnabled && UT.Code.abs_greater_equal(aSize * mPower, tRecipe.mEUt)
                                ? oRecipe = tRecipe
                                : null;
                ...
                // If the minimal Amount of Items for the Recipe is 0, then it could be a Fluid-Only Recipe, so check
                // that Map too.
                if (mInputFluidCount > 0 && mMinimalInputItems == 0)
                    for (FluidStack aFluid : aFluids) if (aFluid != null) {
                        Collection<Recipe> tRecipes = mRecipeFluidMap.get(
                            aFluid.getFluid()
                                .getName());
                        if (tRecipes != null) for (Recipe tRecipe : tRecipes)
                            if (!tRecipe.mFakeRecipe && tRecipe.isRecipeInputEqual(F, T, aFluids, aInputs))
                ...
                if (aLoop && !mRecipeMapHandlers.isEmpty()) {
                    ...
                    if (!mRecipeMapHandlers.isEmpty()) {
                        ...
                        for (ItemStack tInput : aInputs) if (ST.valid(tInput)) {
                            ...
                            for (IRecipeMapHandler tHandler : mRecipeMapHandlers)
                                if (tHandler.addRecipesUsing(this, F, tInput, tData)) aLoop = T;
                        }
                        for (FluidStack tInput : aFluids) if (tInput != null) {
                            for (IRecipeMapHandler tHandler : mRecipeMapHandlers)
                                if (tHandler.addRecipesUsing(this, F, tInput.getFluid())) aLoop = T;
                        }
                        if (aLoop) return findRecipeInternal(
                            aTileEntity,
                            aRecipe,
                            F,
                            aNotUnificated,
                ...
                // Eh, try again, this can't really happen unless something fucks up with external NEI Plugins or
                // Minetweaker.
        ...
        public List<Recipe> getNEIRecipes(ItemStack... aOutputs) {
            for (ItemStack aOutput : aOutputs) if (ST.valid(aOutput)) {
                if (IL.Display_Fluid.equal(aOutput, T, T)) {
                    ...
                    if (tFluid != null) for (IRecipeMapHandler tHandler : mRecipeMapHandlers)
                        tHandler.addRecipesProducing(this, T, tFluid);
                } else {
                    OreDictItemData tData = OM.data_(aOutput);
                    for (IRecipeMapHandler tHandler : mRecipeMapHandlers)
                        tHandler.addRecipesProducing(this, T, aOutput, tData);
                }
            }
            ArrayListNoNulls<Recipe> rList = new ArrayListNoNulls<>();
                ...
                for (ItemStack aOutput : aOutputs) if (aOutput != null) {
                    if (IL.Display_Fluid.equal(aOutput, T, T)) {
                        ...
                        for (ItemStack tOutput : tRecipe.mOutputs)
                            if (tOutput != null && tOutput.getItem() == aOutput.getItem()) {
                                if (ST.meta_(tOutput) == W || ST.meta_(tOutput) == ST.meta_(aOutput)
                                    || tOutput.isItemStackDamageable()) {
                                    rList.add(tRecipe);
                                    break;
                                }
                            }
        ...
        public List<Recipe> getNEIUsages(ItemStack... aInputs) {
            for (ItemStack aInput : aInputs) if (ST.valid(aInput)) {
                if (IL.Display_Fluid.equal(aInput, T, T)) {
                    ...
                    if (tFluid != null)
                        for (IRecipeMapHandler tHandler : mRecipeMapHandlers) tHandler.addRecipesUsing(this, T, tFluid);
                } else {
                    OreDictItemData tData = OM.data_(aInput);
                    for (IRecipeMapHandler tHandler : mRecipeMapHandlers)
                        tHandler.addRecipesUsing(this, T, aInput, tData);
                }
            }
            ArrayListNoNulls<Recipe> rList = new ArrayListNoNulls<>();
            for (Recipe tRecipe : mRecipeList) if (tRecipe.mEnabled && !tRecipe.mHidden) {
                for (ItemStack aInput : aInputs) if (aInput != null) {
                    if (IL.Display_Fluid.equal(aInput, T, T)) {
                        ...
                        for (ItemStack tInput : tRecipe.mInputs)
                            if (tInput != null && tInput.getItem() == aInput.getItem()) {
                                if (ST.meta_(tInput) == W || ST.meta_(tInput) == ST.meta_(aInput)
                                    || tInput.isItemStackDamageable()) {
                                    rList.add(tRecipe);
                                    break;
                                }
                            }
        ...
        public boolean openNEI() {
            try {
                codechicken.nei.recipe.GuiCraftingRecipe.openRecipeGui(mNameNEI);
                return T;
            } catch (Throwable e) {/**/}
            return F;
        }
        ...
        public boolean guiRecipes(Object... aOutputs) {
            try {
                codechicken.nei.recipe.GuiCraftingRecipe.openRecipeGui(mNameNEI, aOutputs);
                return T;
            } catch (Throwable e) {/**/}
            return F;
        }
        ...
        public boolean guiUsesNEI(Object... aInputs) {
            try {
                codechicken.nei.recipe.GuiUsageRecipe.openRecipeGui(mNameNEI, aInputs);
                return T;
            } catch (Throwable e) {/**/}
            return F;
        }
        ...
        @Deprecated
        public static RecipeMap sMaceratorRecipes = new RecipeMap(), sFurnaceRecipes = RM.Furnace,
            sMicrowaveRecipes = RM.Microwave, sFurnaceFuel = FM.Furnace, sByProductList = RM.ByProductList,
            sCrucibleSmelting = RM.CrucibleSmelting, sCrucibleAlloying = RM.CrucibleAlloying,
            sGenerifierRecipes = RM.Generifier, sSharpeningRecipes = RM.Sharpening, sSifterRecipes = RM.Sifting,
            sHammerRecipes = RM.Hammer, sChiselRecipes = RM.Chisel, sShredderRecipes = RM.Shredder,
            sCrusherRecipes = RM.Crusher, sLatheRecipes = RM.Lathe, sCutterRecipes = RM.Cutter,
            sCoagulatorRecipes = RM.Coagulator, sSqueezerRecipes = RM.Squeezer, sJuicerRecipes = RM.Juicer,
            sMortarRecipes = RM.Mortar, sCompressorRecipes = RM.Compressor, sCentrifugeRecipes = RM.Centrifuge,
            sElectrolyzerRecipes = RM.Electrolyzer, sRollingMillRecipes = RM.RollingMill,
            sRollBenderRecipes = RM.RollBender, sRollFormerRecipes = RM.RollFormer,
            sClusterMillRecipes = RM.ClusterMill, sWiremillRecipes = RM.Wiremill, sMixerRecipes = RM.Mixer,
            sCannerRecipes = RM.Canner, sInjectorRecipes = RM.Injector, sRoastingRecipes = RM.Roasting,
            sDryingRecipes = RM.Drying, sFermenterRecipes = RM.Fermenter, sDistilleryRecipes = RM.Distillery,
            sExtruderRecipes = RM.Extruder, sPolarizerRecipes = RM.Polarizer, sLoomRecipes = RM.Loom,
            sCookingRecipes = RM.Cooking, sPressRecipes = RM.Press, sBathRecipes = RM.Bath,
            sSmelterRecipes = RM.Smelter, sLaserEngraverRecipes = RM.LaserEngraver, sWelderRecipes = RM.Welder,
            sCrystallisationCrucibleRecipes = RM.CrystallisationCrucible, sScannerVisualsRecipes = RM.ScannerVisuals,
            sPrinterRecipes = RM.Printer, sSluiceRecipes = RM.Sluice, sMagneticSeparatorRecipes = RM.MagneticSeparator,
            sAutocrafterRecipes = RM.Autocrafter, sMassfabRecipes = RM.Massfab,
            sScannerMolecularRecipes = RM.ScannerMolecular, sReplicatorRecipes = RM.Replicator,
            sSlicerRecipes = RM.Slicer, sCokeOvenRecipes = RM.CokeOven,
            sDistillationTowerRecipes = RM.DistillationTower, sAutoclaveRecipes = RM.Autoclave,
            sBoxinatorRecipes = RM.Boxinator, sUnboxinatorRecipes = RM.Unboxinator, sFusionRecipes = RM.Fusion,
            sBlastRecipes = RM.BlastFurnace, sImplosionRecipes = RM.ImplosionCompressor,
            sVacuumRecipes = RM.VacuumFreezer, sAssemblerRecipes = RM.Assembler, sCNCRecipes = RM.CNC,
            sFuelsBurn = FM.Burn, sFuelsGas = FM.Gas, sFuelsHot = FM.Hot, sFuelsPlasma = FM.Plasma,
            sFuelsEngine = FM.Engine, sFuelsTurbine = FM.Turbine, sFuelsMagic = FM.Magic;
    }

    public static void reInit() {
        for (RecipeMap tMapEntry : RecipeMap.RECIPE_MAPS.values()) tMapEntry.reInit();
    }
     ...
     * equal to the Output Array. A chance of 10000 equals 100% if the MaxChance Value is default.
     */
    ...
    /**
     * If this Recipe is not supposed to check for Input NBT Values. Thanks Applied Energistics Crystal Seeds for
     * somehow messing something up somewhere where i cant find it...
     */
    public boolean mNoNBTChecks = F;

    public int getOutputChance(long aIndex) {
        if (aIndex < 0 || aIndex >= mChances.length) return getMaxChance(aIndex);
        return (int) mChances[(int) aIndex];
    }

    public int getMaxChance(long aIndex) {
        if (aIndex < 0 || aIndex >= mMaxChances.length) return 10000;
        return (int) mMaxChances[(int) aIndex];
    }

    public ItemStack getRepresentativeInput(long aIndex) {
        if (aIndex < 0 || aIndex >= mInputs.length) return null;
        return ST.copy(mInputs[(int) aIndex]);
    }

    public ItemStack getOutput(long aIndex) {
        if (aIndex < 0 || aIndex >= mOutputs.length) return null;
        return ST.copy(mOutputs[(int) aIndex]);
    }

    public FluidStack getRepresentativeFluidInput(long aIndex) {
        if (aIndex < 0 || aIndex >= mFluidInputs.length || mFluidInputs[(int) aIndex] == null) return null;
        return mFluidInputs[(int) aIndex].copy();
    }

    public FluidStack getFluidOutput(long aIndex) {
        if (aIndex < 0 || aIndex >= mFluidOutputs.length || mFluidOutputs[(int) aIndex] == null) return null;
        return mFluidOutputs[(int) aIndex].copy();
    }
    ...
    public boolean blockINblockOUT() {
        return mInputs.length == 1 && mOutputs.length == 1
            && mFluidInputs.length == 0
            && mFluidOutputs.length == 0
            && ST.block(mInputs[0]) != NB
            && ST.block(mOutputs[0]) != NB
            && mInputs[0].stackSize == 1
            && mOutputs[0].stackSize == 1;
    }
            ...
            if (tOutput != null) {
                ...
                if (tChance > 0) {
                    ...
                    if (tChance >= tMax) {
                        ...
                        for (int j = 0, k = tOutput.stackSize * aProcessCount; j < k; j++)
                            if (aRandom.nextInt(tMax) < tChance) {
                                if (rArray[i] == null) rArray[i] = ST.amount(1, tOutput);
                                else rArray[i].stackSize++;
                            }
                    }
                } else {
                    rArray[i] = tOutput;
    ...
    public boolean checkStacksEqual(boolean aDecreaseStacksizeBySuccess, boolean aDontCheckStackSizes,
        ItemStack... aInputs) {
        ...
        for (ItemStack tInput : mInputs) if (ST.valid(tInput)) {
            ...
            for (int i = 0; i < aInputs.length; i++) if (!tChecked[i]) {
                ...
                if (ST.valid(aInput)) {
                    if ((aDontCheckStackSizes || aInput.stackSize >= tInput.stackSize) && OreDictManager.INSTANCE
                        .equal_(F, aInput, tInput, mNoNBTChecks || !tInput.hasTagCompound())) {
    ...
    public boolean isRecipeInputEqual(boolean aDecreaseStacksizeBySuccess, boolean aDontCheckStackSizes,
        ...
        for (FluidStack tFluid : mFluidInputs) if (tFluid != null) {
            boolean temp = T;
            for (FluidStack aFluid : aFluidInputs) if (aFluid != null && aFluid.isFluidEqual(tFluid)
                && (aDontCheckStackSizes || aFluid.amount >= tFluid.amount)) {
                    temp = F;
                    break;
                }
            if (temp) return F;
        ...
        if (aDecreaseStacksizeBySuccess) {
            for (FluidStack tFluid : mFluidInputs) if (tFluid != null) for (FluidStack aFluid : aFluidInputs)
    ...
    public boolean isRecipeInputEqual(boolean aDecreaseStacksizeBySuccess, boolean aDontCheckStackSizes,
        IFluidTank[] aFluidInputs, ItemStack... aInputs) {
        if (mFluidInputs.length > 0 && (aFluidInputs == null || aFluidInputs.length < 1)) return F;
        if (mInputs.length > 0 && (aInputs == null || aInputs.length < 1)) return F;
    ...
    public Recipe(boolean aOptimize, boolean aUnificate, ItemStack[] aInputs, ItemStack[] aOutputs,
        Object aSpecialItems, long[] aChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, long aDuration,
        long aEUt, long aSpecialValue) {
        this(
            aOptimize,
            aUnificate,
            T,
    ...
    public Recipe(boolean aOptimize, boolean aUnificate, boolean aCanBeBuffered, ItemStack[] aInputs,
        ItemStack[] aOutputs, Object aSpecialItems, long[] aChances, FluidStack[] aFluidInputs,
        ...
        aInputs = UT.Code.getWithoutTrailingNulls(aInputs)
            .toArray(ZL_IS);
        aOutputs = UT.Code.getWithoutTrailingNulls(aOutputs)
            .toArray(ZL_IS);
        if (aUnificate) {
        ...
        aFluidInputs = UT.Code.getWithoutNulls(aFluidInputs)
            .toArray(ZL_FS);
        aFluidOutputs = UT.Code.getWithoutNulls(aFluidOutputs)
            .toArray(ZL_FS);

        int l = UT.Code.bindInt(aDuration / 16);

        for (int i = 0; i < aChances.length; i++) if (aChances[i] <= 0) aChances[i] = 10000;
        for (int i = 0; i < aInputs.length; i++) if (aInputs[i] != null) {
            aInputs[i] = ST.copy_(aInputs[i]);
            if (aInputs[i].stackSize != 0) l = Math.min(aInputs[i].stackSize, l);
        }
        for (int i = 0; i < aOutputs.length; i++) if (aOutputs[i] != null) {
            aOutputs[i] = ST.validMeta_(aOutputs[i]);
            if (aOutputs[i].stackSize != 0) l = Math.min(aOutputs[i].stackSize, l);
        }
        for (int i = 0; i < aFluidInputs.length; i++) {
            aFluidInputs[i] = aFluidInputs[i].copy();
            if (aFluidInputs[i].amount != 0) l = Math.min(aFluidInputs[i].amount, l);
        }
        for (int i = 0; i < aFluidOutputs.length; i++) {
            aFluidOutputs[i] = aFluidOutputs[i].copy();
            if (aFluidOutputs[i].amount != 0) l = Math.min(aFluidOutputs[i].amount, l);
        }

        if (aOptimize) {
            for (int i = 0; i < aInputs.length; i++)
                if (aInputs[i] != NI && ST.meta_(aInputs[i]) != W) for (int j = 0; j < aOutputs.length; j++) {
            ...
            for (; l > 1; l--) {
                boolean temp = T;
                for (int j = 0; temp && j < aInputs.length; j++)
                    if (aInputs[j] != null && aInputs[j].stackSize % l != 0) temp = F;
                for (int j = 0; temp && j < aOutputs.length; j++)
                    if (aOutputs[j] != null && aOutputs[j].stackSize % l != 0) temp = F;
