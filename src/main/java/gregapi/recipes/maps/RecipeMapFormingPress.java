...
public class RecipeMapFormingPress extends RecipeMap {
    ...
    public RecipeMapFormingPress(Collection<Recipe> aRecipeList, String aUnlocalizedName, String aNameLocal,
        ...
        if (rRecipe == null) {
            if (IL.Shape_Mold_Name.equal(aInputs[0], F, T)) {
                ...
                return new Recipe(
                    ...
                    F,
                    F,
                    ST.array(IL.Shape_Mold_Name.get(0), ST.amount(1, aInputs[1])),
                    ST.array(tOutput),
                    null,
                    null,
                    null,
            ...
            if (IL.Shape_Mold_Name.equal(aInputs[1], F, T)) {
                ...
                return new Recipe(
                    ...
                    F,
                    F,
                    ST.array(IL.Shape_Mold_Name.get(0), ST.amount(1, aInputs[0])),
                    ST.array(tOutput),
                    null,
                    null,
                    null,
