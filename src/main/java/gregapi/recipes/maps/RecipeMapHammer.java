...
public class RecipeMapHammer extends RecipeMapSpecialSingleInput {
    ...
    public RecipeMapHammer(Collection<Recipe> aRecipeList, String aUnlocalizedName, String aNameLocal, String aNameNEI,
    ...
    public Recipe getRecipeFor(ItemStack aInput) {
        ...
        if (aData == null || !aData.validData()
            ...
            || aData.mPrefix.containsAny(TD.Prefix.DUST_ORE, TD.Prefix.IS_CONTAINER)) return null;
        ...
        long aCrushedAmount = aData.mMaterial.mMaterial.mTargetCrushing.mAmount,
            aMultiplier = aData.mMaterial.mMaterial.mOreMultiplier * aData.mMaterial.mMaterial.mOreProcessingMultiplier
        ...
        if (aData.mPrefix == orePoor) {
            ...
            if (tOutput == null)
                tOutput = OP.dustTiny.mat(aCrushedMat, UT.Code.units(aCrushedAmount, U, 2 * aMultiplier, F));
        ...
        if (tOutputs[0] == null)
            tOutputs[0] = OP.dust.mat(aCrushedMat, UT.Code.units(aCrushedAmount, U, aMultiplier, F));
