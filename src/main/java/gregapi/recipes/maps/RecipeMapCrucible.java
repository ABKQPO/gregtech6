...
public class RecipeMapCrucible extends RecipeMapSpecialSingleInput {
    ...
    public RecipeMapCrucible(Collection<Recipe> aRecipeList, String aUnlocalizedName, String aNameLocal,
    ...
    public List<Recipe> getNEIRecipes(ItemStack... aOutputs) {
        ...
        for (ItemStack aOutput : aOutputs) {
            ...
            for (OreDictMaterial tMat : aData.mMaterial.mMaterial.mTargetedSmelting)
                if (tSet.add(tMat) && !tMat.contains(TD.Properties.INVALID_MATERIAL)
                    && tMat.mTargetSmelting.mMaterial == aData.mMaterial.mMaterial) {
    ...
    public Recipe getRecipeFor(ItemStack aInput) {
        ...
        for (OreDictMaterialStack tMaterial : aData.getAllMaterialStacks())
            if (tMaterial.mMaterial.mTargetSmelting.mAmount > 0 && tMaterial.mMaterial.contains(MELTING)) OM
                .stack(
        ...
        return new Recipe(
            ...
            0,
            0,
            aData.mMaterial.mMaterial.mMeltingPoint);
    }
}
