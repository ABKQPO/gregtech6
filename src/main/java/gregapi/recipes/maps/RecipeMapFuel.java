...
public class RecipeMapFuel extends RecipeMap {
    ...
    public RecipeMapFuel(Collection<Recipe> aRecipeList, String aUnlocalizedName, String aNameLocal, String aNameNEI,
    ...
    public Recipe addFuel(ItemStack aInput, ItemStack aOutput, FluidStack aFluidInput, FluidStack aFluidOutput,
        long aFuelValueInEU) {
        return addFuel(aInput, aOutput, aFluidInput, aFluidOutput, 10000, aFuelValueInEU);
    }

    public Recipe addFuel(ItemStack aInput, ItemStack aOutput, FluidStack aFluidInput, FluidStack aFluidOutput,
        long aChance, long aFuelValueInEU) {
        return addRecipe(
            T,
            ST.array(aInput),
            ST.array(aOutput),
