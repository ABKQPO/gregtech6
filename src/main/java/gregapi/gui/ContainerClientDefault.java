...
public class ContainerClientDefault extends ContainerClient {
    ...
    public ContainerClientDefault(InventoryPlayer aInventoryPlayer, ITileEntityInventoryGUI aTileEntity, int aGUIID) {
        this(
            ...
            aTileEntity,
            aGUIID,
            RES_PATH_GUI + "chests/" + aTileEntity.getSizeInventoryGUI() + ".png");
    }
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        if (mContainer.mSlotCount != 16 && mContainer.mSlotCount <= 27)
            fontRendererObj.drawString(mContainer.mTileEntity.getInventoryNameGUI(), 8, 4, 4210752);
    }
}
