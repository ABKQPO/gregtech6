...
public class ContainerCommonBasicMachine extends ContainerCommon {
    ...
    public ContainerCommonBasicMachine(InventoryPlayer aInventoryPlayer, ITileEntityInventoryGUI aTileEntity,
        RecipeMap aRecipes, int aGUIID) {
    ...
    public int addSlots(InventoryPlayer aPlayerInventory) {
        ...
        addSlotToContainer(
            mRecipes.getSpecialSlot(mTileEntity, mRecipes.mInputItemsCount + mRecipes.mOutputItemsCount, 80, 43));
        ...
        switch (mRecipes.mOutputItemsCount) {
            ...
            case 1:
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 107, mRecipes.mOutputFluidCount > 6 ? 7 : 25).setCanPut(F));
                break;
            case 2:
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 107, mRecipes.mOutputFluidCount > 6 ? 7 : 25).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 125, mRecipes.mOutputFluidCount > 6 ? 7 : 25).setCanPut(F));
                break;
            case 3:
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 107, mRecipes.mOutputFluidCount > 6 ? 7 : 25).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 125, mRecipes.mOutputFluidCount > 6 ? 7 : 25).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 143, mRecipes.mOutputFluidCount > 6 ? 7 : 25).setCanPut(F));
                break;
            case 4:
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 107, mRecipes.mOutputFluidCount > 3 ? 7 : 16).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 125, mRecipes.mOutputFluidCount > 3 ? 7 : 16).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 107, mRecipes.mOutputFluidCount > 3 ? 25 : 34).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 125, mRecipes.mOutputFluidCount > 3 ? 25 : 34).setCanPut(F));
                break;
            case 5:
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 107, mRecipes.mOutputFluidCount > 3 ? 7 : 16).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 125, mRecipes.mOutputFluidCount > 3 ? 7 : 16).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 143, mRecipes.mOutputFluidCount > 3 ? 7 : 16).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 107, mRecipes.mOutputFluidCount > 3 ? 25 : 34).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 125, mRecipes.mOutputFluidCount > 3 ? 25 : 34).setCanPut(F));
            ...
            case 6:
                ...
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 125, mRecipes.mOutputFluidCount > 3 ? 25 : 34).setCanPut(F));
                addSlotToContainer(
                    new Slot_Normal(mTileEntity, tIndex++, 143, mRecipes.mOutputFluidCount > 3 ? 25 : 34).setCanPut(F));
                break;
            case 7:
        ...
        for (int i = 0; i < mRecipes.mInputFluidCount; i++) addSlotToContainer(
            new Slot_Render(mTileEntity, tIndex++, 53 - (i % 3) * 18, 63 - (i / 3) * 18)
                .setTooltip("Extract using a Tap or Nozzle", LH.Chat.WHITE));
        for (int i = 0; i < mRecipes.mOutputFluidCount; i++) addSlotToContainer(
            new Slot_Render(mTileEntity, tIndex++, 107 + (i % 3) * 18, 63 - (i / 3) * 18)
                .setTooltip("Extract using a Tap or Nozzle", LH.Chat.WHITE));
    ...
    public void detectAndSendChanges() {
        ...
        for (ICrafting tUpdate : (List<ICrafting>) crafters) {
            if (((MultiTileEntityBasicMachine) mTileEntity).mSuccessful) {
                ...
                tUpdate.sendProgressBarUpdate(
                    this,
                    0,
                    (short) UT.Code.units(
                        Math.min(
                            ((MultiTileEntityBasicMachine) mTileEntity).mMaxProgress,
                            ((MultiTileEntityBasicMachine) mTileEntity).mProgress),
                        ((MultiTileEntityBasicMachine) mTileEntity).mMaxProgress,
                        Short.MAX_VALUE,
                        T));
            } else {
    ...
    public int getSlotCount() {
        return mRecipes.mInputItemsCount + mRecipes.mOutputItemsCount
            + (mRecipes.getSpecialSlot(mTileEntity, 0, 80, 43) != null ? 1 : 0);
    }
    ...
    public int getShiftClickSlotCount() {
        return mRecipes.mInputItemsCount + (mRecipes.getSpecialSlot(mTileEntity, 0, 80, 43) != null ? 1 : 0);
    }
}
