...
public interface IItemReactorRod {
    ...
    /**
     * @return the amount of Neutrons emitted by the Rod to each of the 4 surrounding Rods. Only called once every 20
     *         ticks.
     */
    ...
    /**
     * @return the Texture used for rendering the Rod in a Reactor. Note: only Item ID and Metadata are available in
     *         aStack, not NBT!
     */
