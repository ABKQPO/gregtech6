...
public interface IFoodStat {
    ...
    /**
     * Warning: the "aPlayer" Parameter may be null! Amount of Water you get from this, negative = salty [-100.0F -
     * 100.0F]
     */
    ...
    /**
     * Warning: the "aPlayer" Parameter may be null! Temperature modification strength. Usually 0.5F for things that can
     * affect it and 0.1F for things that can't do much. 1.0F is max!
     */
