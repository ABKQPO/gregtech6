...
public abstract class MultiItemRandomWithCompat extends MultiItemRandom
    implements Runnable, squeek.applecore.api.food.IEdible, ic2.api.item.IBoxable, ic2.api.item.IItemReactorPlanStorage,
    ISpecialElectricItem, IElectricItemManager, IItemElectric {
    ...
    public squeek.applecore.api.food.FoodValues getFoodValues(ItemStack aStack) {
        ...
        return tFoodLevel > 0
            ? new squeek.applecore.api.food.FoodValues(tFoodLevel, tStat.getSaturation(this, aStack, null))
            : null;
    }
