...
public interface IToolStats {
     ...
     * "plasmatorch", "solderingtool"
     * 
     * @return Mining Speed for this Block from this Tool, 1.0 = Default Speed, 0.0 = cannot be mined. Tool Quality
     *         checks (like Diamond Tier or something) are separate from this check.
     */
    ...
    public int convertBlockDrops(List<ItemStack> aDrops, ItemStack aStack, EntityPlayer aPlayer, Block aBlock,
        long aAvailableConversions, int aX, int aY, int aZ, byte aMetaData, int aFortune, boolean aSilkTouch,
