...
public interface IBehavior<E extends Item> {
    ...
    public boolean onItemUse(E aItem, ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ,
        byte aSide, float hitX, float hitY, float hitZ);
    ...
    public EntityProjectile getProjectile(E aItem, TagData aProjectileType, ItemStack aStack, World aWorld, double aX,
        double aY, double aZ);

    public EntityProjectile getProjectile(E aItem, TagData aProjectileType, ItemStack aStack, World aWorld,
    ...
    public abstract class AbstractBehaviorDefault implements IBehavior<MultiItem> {
        ...
        @Override
        public boolean onItemUseFirst(MultiItem aItem, ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX,
            int aY, int aZ, byte aSide, float hitX, float hitY, float hitZ) {
            return F;
        }
        ...
        @Override
        public void onUpdate(MultiItem aItem, ItemStack aStack, World aWorld, Entity aPlayer, int aTimer,
            boolean aIsInHand) {/**/}
        ...
        @Override
        public EntityProjectile getProjectile(MultiItem aItem, TagData aProjectileType, ItemStack aStack, World aWorld,
    ...
    @Deprecated
    public abstract class Behaviour_None extends AbstractBehaviorDefault {
        /**/}
}
