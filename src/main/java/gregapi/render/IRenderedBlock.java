...
public interface IRenderedBlock {
    ...
    /**
     * sets the Block Size rendered by {@link RendererBlockTextured} for the Inventory Rendering. return false for
     * letting it select the normal Block Bounds.
     */
    @SideOnly(Side.CLIENT)
    public boolean setBlockBounds(int aRenderPass, ItemStack aStack);

    /**
     * sets the Block Size rendered by {@link RendererBlockTextured} for the World Rendering. return false for letting
     * it select the normal Block Bounds.
     */
    @SideOnly(Side.CLIENT)
