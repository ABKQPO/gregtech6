...
public class RendererBlockTextured implements ISimpleBlockRenderingHandler, IItemRenderer {
    ...
    public void renderInventoryBlock(Block aBlock, int aMetaData, int aModelID, RenderBlocks aRenderer) {
        ...
        if (aBlock instanceof IRenderedBlock) {
            ...
            if (tRenderer == null) {
                for (int i = 0, j = ((IRenderedBlock) aBlock).getRenderPasses(aStack); i < j; i++) {
                    if (((IRenderedBlock) aBlock).usesRenderPass(i, aStack)) {
                        ...
                        renderNegativeYFacing(
                            ...
                            0,
                            0,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_Y_NEG, aStack),
                            !tNeedsToSetBounds,
                            T,
                            aBlock);
                        Tessellator.instance.setNormal(0, 1, 0);
                        renderPositiveYFacing(
                            ...
                            0,
                            0,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_Y_POS, aStack),
                            !tNeedsToSetBounds,
                            T,
                            aBlock);
                        ...
                        renderNegativeZFacing(
                            ...
                            0,
                            0,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_Z_NEG, aStack),
                            !tNeedsToSetBounds,
                            T,
                            aBlock);
                        Tessellator.instance.setNormal(0, 0, 1);
                        renderPositiveZFacing(
                            ...
                            0,
                            0,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_Z_POS, aStack),
                            !tNeedsToSetBounds,
                            T,
                            aBlock);
                        ...
                        renderNegativeXFacing(
                            ...
                            0,
                            0,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_X_NEG, aStack),
                            !tNeedsToSetBounds,
                            T,
                            aBlock);
                        Tessellator.instance.setNormal(1, 0, 0);
                        renderPositiveXFacing(
                            ...
                            0,
                            0,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_X_POS, aStack),
                            !tNeedsToSetBounds,
                            T,
                            aBlock);
                ...
                if (!tRenderer.renderItem(aBlock, aRenderer))
                    for (int i = 0, j = tRenderer.getRenderPasses(aBlock, SIDES_ITEM_RENDER); i < j; i++) {
                        if (tRenderer.usesRenderPass(i, SIDES_ITEM_RENDER)) {
                            Tessellator.instance.startDrawingQuads();
                            if (tRenderer.setBlockBounds(aBlock, i, SIDES_ITEM_RENDER)) {
                                tNeedsToSetBounds = T;
                                aRenderer.setRenderBoundsFromBlock(aBlock);
                            } else {
                                if (tNeedsToSetBounds) aBlock.setBlockBounds(0, 0, 0, 1, 1, 1);
                            ...
                            renderNegativeYFacing(
                                ...
                                0,
                                0,
                                tRenderer.getTexture(aBlock, i, SIDE_Y_NEG, SIDES_ITEM_RENDER),
                                !tNeedsToSetBounds,
                                T,
                                tRenderer);
                            Tessellator.instance.setNormal(0, 1, 0);
                            renderPositiveYFacing(
                                ...
                                0,
                                0,
                                tRenderer.getTexture(aBlock, i, SIDE_Y_POS, SIDES_ITEM_RENDER),
                                !tNeedsToSetBounds,
                                T,
                                tRenderer);
                            Tessellator.instance.setNormal(0, 0, -1);
                            renderNegativeZFacing(
                                ...
                                0,
                                0,
                                tRenderer.getTexture(aBlock, i, SIDE_Z_NEG, SIDES_ITEM_RENDER),
                                !tNeedsToSetBounds,
                                T,
                                tRenderer);
                            Tessellator.instance.setNormal(0, 0, 1);
                            renderPositiveZFacing(
                                ...
                                0,
                                0,
                                tRenderer.getTexture(aBlock, i, SIDE_Z_POS, SIDES_ITEM_RENDER),
                                !tNeedsToSetBounds,
                                T,
                                tRenderer);
                            Tessellator.instance.setNormal(-1, 0, 0);
                            renderNegativeXFacing(
                                ...
                                0,
                                0,
                                tRenderer.getTexture(aBlock, i, SIDE_X_NEG, SIDES_ITEM_RENDER),
                                !tNeedsToSetBounds,
                                T,
                                tRenderer);
                            Tessellator.instance.setNormal(1, 0, 0);
                            renderPositiveXFacing(
                                ...
                                0,
                                0,
                                tRenderer.getTexture(aBlock, i, SIDE_X_POS, SIDES_ITEM_RENDER),
                                !tNeedsToSetBounds,
                                T,
                                tRenderer);
                            Tessellator.instance.draw();
        ...
        if (aBlock instanceof IRenderedBlock) {
            ...
            if (tRenderer == null) {
                ...
                if (aBlock instanceof IRenderedBlockObjectSideCheck) {
                    for (byte tSide : ALL_SIDES_VALID) tSides[tSide] = ((IRenderedBlockObjectSideCheck) aBlock)
                        .renderFullBlockSide(aBlock, aRenderer, tSide);
                } else {
                    for (byte tSide : ALL_SIDES_VALID) tSides[tSide] = aBlock
                ...
                for (int i = 0, j = ((IRenderedBlock) aBlock).getRenderPasses(aWorld, aX, aY, aZ, tSides); i < j; i++) {
                    if (((IRenderedBlock) aBlock).usesRenderPass(i, aWorld, aX, aY, aZ, tSides)) {
                        ...
                        if (renderNegativeYFacing(
                            ...
                            aY,
                            aZ,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_Y_NEG, tSides, aWorld, aX, aY, aZ),
                            !tNeedsToSetBounds,
                            tSides[SIDE_Y_NEG],
                            aBlock)) rReturn = T;
                        if (renderPositiveYFacing(
                            aWorld,
                            aRenderer,
                            aBlock,
                            aX,
                            aY,
                            aZ,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_Y_POS, tSides, aWorld, aX, aY, aZ),
                            !tNeedsToSetBounds,
                            tSides[SIDE_Y_POS],
                            aBlock)) rReturn = T;
                        if (renderNegativeZFacing(
                            aWorld,
                            aRenderer,
                            aBlock,
                            aX,
                            aY,
                            aZ,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_Z_NEG, tSides, aWorld, aX, aY, aZ),
                            !tNeedsToSetBounds,
                            tSides[SIDE_Z_NEG],
                            aBlock)) rReturn = T;
                        if (renderPositiveZFacing(
                            aWorld,
                            aRenderer,
                            aBlock,
                            aX,
                            aY,
                            aZ,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_Z_POS, tSides, aWorld, aX, aY, aZ),
                            !tNeedsToSetBounds,
                            tSides[SIDE_Z_POS],
                            aBlock)) rReturn = T;
                        if (renderNegativeXFacing(
                            aWorld,
                            aRenderer,
                            aBlock,
                            aX,
                            aY,
                            aZ,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_X_NEG, tSides, aWorld, aX, aY, aZ),
                            !tNeedsToSetBounds,
                            tSides[SIDE_X_NEG],
                            aBlock)) rReturn = T;
                        if (renderPositiveXFacing(
                            aWorld,
                            aRenderer,
                            aBlock,
                            aX,
                            aY,
                            aZ,
                            ((IRenderedBlock) aBlock).getTexture(i, SIDE_X_POS, tSides, aWorld, aX, aY, aZ),
                            !tNeedsToSetBounds,
                            tSides[SIDE_X_POS],
                            aBlock)) rReturn = T;
                    }
                ...
                if (tRenderer.renderBlock(aBlock, aRenderer, aWorld, aX, aY, aZ)) {
                    ...
                    if (tRenderer instanceof IRenderedBlockObjectSideCheck) {
                        for (byte tSide : ALL_SIDES_VALID) tSides[tSide] = ((IRenderedBlockObjectSideCheck) tRenderer)
                            .renderFullBlockSide(aBlock, aRenderer, tSide);
                    } else {
                        for (byte tSide : ALL_SIDES_VALID) tSides[tSide] = aBlock
                            .shouldSideBeRendered(aWorld, aX + OFFX[tSide], aY + OFFY[tSide], aZ + OFFZ[tSide], tSide);
                    ...
                    for (int i = 0, j = tRenderer.getRenderPasses(aBlock, tSides); i < j; i++) {
                        if (tRenderer.usesRenderPass(i, tSides)) {
                            ...
                            if (renderNegativeYFacing(
                                ...
                                aY,
                                aZ,
                                tRenderer.getTexture(aBlock, i, SIDE_Y_NEG, tSides),
                                !tNeedsToSetBounds,
                                tSides[SIDE_Y_NEG],
                                tRenderer)) rReturn = T;
                            if (renderPositiveYFacing(
                                ...
                                aY,
                                aZ,
                                tRenderer.getTexture(aBlock, i, SIDE_Y_POS, tSides),
                                !tNeedsToSetBounds,
                                tSides[SIDE_Y_POS],
                                tRenderer)) rReturn = T;
                            if (renderNegativeZFacing(
                                ...
                                aY,
                                aZ,
                                tRenderer.getTexture(aBlock, i, SIDE_Z_NEG, tSides),
                                !tNeedsToSetBounds,
                                tSides[SIDE_Z_NEG],
                                tRenderer)) rReturn = T;
                            if (renderPositiveZFacing(
                                ...
                                aY,
                                aZ,
                                tRenderer.getTexture(aBlock, i, SIDE_Z_POS, tSides),
                                !tNeedsToSetBounds,
                                tSides[SIDE_Z_POS],
                                tRenderer)) rReturn = T;
                            if (renderNegativeXFacing(
                                ...
                                aY,
                                aZ,
                                tRenderer.getTexture(aBlock, i, SIDE_X_NEG, tSides),
                                !tNeedsToSetBounds,
                                tSides[SIDE_X_NEG],
                                tRenderer)) rReturn = T;
                            if (renderPositiveXFacing(
                                ...
                                aY,
                                aZ,
                                tRenderer.getTexture(aBlock, i, SIDE_X_POS, tSides),
                                !tNeedsToSetBounds,
                                tSides[SIDE_X_POS],
                                tRenderer)) rReturn = T;
                        }
    ...
    public static boolean renderNegativeYFacing(IBlockAccess aWorld, RenderBlocks aRenderer, Block aBlock, int aX,
        int aY, int aZ, ITexture aIcon, boolean aFullBlock, boolean aShouldSideBeRendered,
        Object aRenderedBlockObject) {
    ...
    public static boolean renderPositiveYFacing(IBlockAccess aWorld, RenderBlocks aRenderer, Block aBlock, int aX,
        int aY, int aZ, ITexture aIcon, boolean aFullBlock, boolean aShouldSideBeRendered,
        Object aRenderedBlockObject) {
        if (aIcon == null || !aIcon.isValidTexture()) return F;
        int aBrightness = 240;
    ...
    public static boolean renderNegativeZFacing(IBlockAccess aWorld, RenderBlocks aRenderer, Block aBlock, int aX,
        int aY, int aZ, ITexture aIcon, boolean aFullBlock, boolean aShouldSideBeRendered,
        Object aRenderedBlockObject) {
        if (aIcon == null || !aIcon.isValidTexture()) return F;
        int aBrightness = 240;
    ...
    public static boolean renderPositiveZFacing(IBlockAccess aWorld, RenderBlocks aRenderer, Block aBlock, int aX,
        int aY, int aZ, ITexture aIcon, boolean aFullBlock, boolean aShouldSideBeRendered,
        Object aRenderedBlockObject) {
        if (aIcon == null || !aIcon.isValidTexture()) return F;
        int aBrightness = 240;
    ...
    public static boolean renderNegativeXFacing(IBlockAccess aWorld, RenderBlocks aRenderer, Block aBlock, int aX,
        int aY, int aZ, ITexture aIcon, boolean aFullBlock, boolean aShouldSideBeRendered,
        Object aRenderedBlockObject) {
        if (aIcon == null || !aIcon.isValidTexture()) return F;
        int aBrightness = 240;
    ...
    public static boolean renderPositiveXFacing(IBlockAccess aWorld, RenderBlocks aRenderer, Block aBlock, int aX,
        int aY, int aZ, ITexture aIcon, boolean aFullBlock, boolean aShouldSideBeRendered,
        Object aRenderedBlockObject) {
        if (aIcon == null || !aIcon.isValidTexture()) return F;
        int aBrightness = 240;
