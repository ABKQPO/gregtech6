...
public class TextureSet {
    ...
    public static TextureSet addTextureSet(String aModID, boolean aIsItem, String aNameSet) {
        ...
        for (int i = 0, j = tFileNameList.size(); i < j; i++) rSet.mList.add(
            aIsItem ? new TextureSetIconItem(aModID, aNameSet + "/" + tFileNameList.get(i))
                : new TextureSetIconBlock(aModID, aNameSet + "/" + tFileNameList.get(i)));
        return rSet;
    }

    /**
     * Adds a new Icon Name to all Texture Sets, or just returns the Index of an already existing Set with the same File
     * Name.
     * 
     * @param aModID    the Mod responsible for adding the Icons (which are located in either
     *                  assets\aModID.toLowerCase()\textures\items\materialicons\ or
    ...
    public static int addToAll(String aModID, boolean aIsItem, String aNameFile) {
        ...
        for (TextureSet tSet : (aIsItem ? INSTANCES_ITEM : INSTANCES_BLOCK)) tSet.mList.add(
            tSet.mIsItem ? new TextureSetIconItem(aModID, tSet.mNameSet + "/" + aNameFile)
                : new TextureSetIconBlock(aModID, tSet.mNameSet + "/" + aNameFile));
    ...
    public static final TextureSet[] SET_NONE = new TextureSet[] { addTextureSet(MD.GT.mID, F, "NONE"),
        addTextureSet(MD.GT.mID, T, "NONE") },
        ...
        SET_EMERALD = new TextureSet[] { addTextureSet(MD.GT.mID, F, "EMERALD"),
            addTextureSet(MD.GT.mID, T, "EMERALD") },
        SET_DIAMOND = new TextureSet[] { addTextureSet(MD.GT.mID, F, "DIAMOND"),
            addTextureSet(MD.GT.mID, T, "DIAMOND") },
        SET_LIGNITE = new TextureSet[] { addTextureSet(MD.GT.mID, F, "LIGNITE"),
            addTextureSet(MD.GT.mID, T, "LIGNITE") },
        SET_REDSTONE = new TextureSet[] { addTextureSet(MD.GT.mID, F, "REDSTONE"),
            addTextureSet(MD.GT.mID, T, "REDSTONE") },
        SET_MAGNETIC = new TextureSet[] { addTextureSet(MD.GT.mID, F, "MAGNETIC"),
            addTextureSet(MD.GT.mID, T, "MAGNETIC") },
        SET_METALLIC = new TextureSet[] { addTextureSet(MD.GT.mID, F, "METALLIC"),
            addTextureSet(MD.GT.mID, T, "METALLIC") },
        SET_PRISMARINE = new TextureSet[] { addTextureSet(MD.GT.mID, F, "PRISMARINE"),
            addTextureSet(MD.GT.mID, T, "PRISMARINE") },
        SET_CUBE_SHINY = new TextureSet[] { addTextureSet(MD.GT.mID, F, "CUBE_SHINY"),
            addTextureSet(MD.GT.mID, T, "CUBE_SHINY") },
        SET_NETHERSTAR = new TextureSet[] { addTextureSet(MD.GT.mID, F, "NETHERSTAR"),
            addTextureSet(MD.GT.mID, T, "NETHERSTAR") },
        SET_GEM_VERTICAL = new TextureSet[] { addTextureSet(MD.GT.mID, F, "GEM_VERTICAL"),
            addTextureSet(MD.GT.mID, T, "GEM_VERTICAL") },
        SET_GEM_HORIZONTAL = new TextureSet[] { addTextureSet(MD.GT.mID, F, "GEM_HORIZONTAL"),
            addTextureSet(MD.GT.mID, T, "GEM_HORIZONTAL") };
}
