...
public class NEI_RecipeMap extends TemplateRecipeHandler {
    ...
    public NEI_RecipeMap(RecipeMap aRecipeMap) {
        ...
        transferRects
            .add(new RecipeTransferRect(new Rectangle(70 - sOffsetX, 24 - sOffsetY, 36, 18), getOverlayIdentifier()));
    }
    ...
    public NEI_RecipeMap init() {
        ...
        FMLInterModComms.sendRuntimeMessage(
            ...
            MD.GAPI.mID + "@" + getRecipeName() + "@" + getOverlayIdentifier());
        return this;
    }
        ...
        public CachedDefaultRecipe(Recipe aRecipe) {
            ...
            switch (mRecipeMap.mInputItemsCount) {
                case 0:
                    break;
                case 1:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) mInputs.add(
                        new FixedPositionedStack(
                            aRecipe.getRepresentativeInput(tStartIndex),
                            53,
                            (mRecipeMap.mInputFluidCount > 6 ? 7 : 25)));
                    tStartIndex++;
                    break;
                case 2:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) mInputs.add(
                ...
                case 4:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) mInputs.add(
                        new FixedPositionedStack(
                            aRecipe.getRepresentativeInput(tStartIndex),
                            35,
                            (mRecipeMap.mInputFluidCount > 3 ? 7 : 16)));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) mInputs.add(
                        new FixedPositionedStack(
                            aRecipe.getRepresentativeInput(tStartIndex),
                    ...
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) mInputs.add(
                        new FixedPositionedStack(
                            aRecipe.getRepresentativeInput(tStartIndex),
                            35,
                            (mRecipeMap.mInputFluidCount > 3 ? 25 : 34)));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) mInputs.add(
                        new FixedPositionedStack(
                            aRecipe.getRepresentativeInput(tStartIndex),
                ...
                case 7:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 17, 7));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 35, 7));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 53, 7));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 17, 25));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 35, 25));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 53, 25));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 17, 43));
                    tStartIndex++;
                    break;
                case 8:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                    ...
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 35, 43));
                    tStartIndex++;
                    break;
                case 9:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                    ...
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 53, 43));
                    tStartIndex++;
                    break;
                case 10:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                    ...
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 53, 61));
                    tStartIndex++;
                    break;
                case 11:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                    ...
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 35, 61));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 53, 61));
                    tStartIndex++;
                ...
                default:
                    ...
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 17, 61));
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null)
                        mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 35, 61));
                    tStartIndex++;
            ...
            if (!mRecipeMap.mRecipeMachineList.isEmpty())
                mInputs.add(new FixedPositionedStack(mRecipeMap.mRecipeMachineList, 152, 83));
            ...
            switch (mRecipeMap.mOutputItemsCount) {
                case 0:
                    break;
                case 1:
                    if (aRecipe.getOutput(tStartIndex) != null) mOutputs.add(
                        new FixedPositionedStack(
                            aRecipe.getOutput(tStartIndex),
                            107,
                            (mRecipeMap.mOutputFluidCount > 6 ? 7 : 25),
                            aRecipe.getOutputChance(tStartIndex),
                            aRecipe.getMaxChance(tStartIndex)));
                    tStartIndex++;
                    break;
                case 2:
                    if (aRecipe.getOutput(tStartIndex) != null) mOutputs.add(
                ...
                case 4:
                    if (aRecipe.getOutput(tStartIndex) != null) mOutputs.add(
                        new FixedPositionedStack(
                            aRecipe.getOutput(tStartIndex),
                            107,
                            (mRecipeMap.mOutputFluidCount > 3 ? 7 : 16),
                            aRecipe.getOutputChance(tStartIndex),
                            aRecipe.getMaxChance(tStartIndex)));
                    tStartIndex++;
                    if (aRecipe.getOutput(tStartIndex) != null) mOutputs.add(
                    ...
                    if (aRecipe.getOutput(tStartIndex) != null) mOutputs.add(
                        new FixedPositionedStack(
                            aRecipe.getOutput(tStartIndex),
                            107,
                            (mRecipeMap.mOutputFluidCount > 3 ? 25 : 34),
                            aRecipe.getOutputChance(tStartIndex),
                            aRecipe.getMaxChance(tStartIndex)));
                    tStartIndex++;
                    if (aRecipe.getOutput(tStartIndex) != null) mOutputs.add(
            ...
            for (int i = 0; i < aRecipe.mFluidInputs.length && i < mRecipeMap.mInputFluidCount; i++)
                if (aRecipe.mFluidInputs[i] != null && aRecipe.mFluidInputs[i].getFluid() != null) mInputs.add(
                    new FixedPositionedStack(
                        FL.display(aRecipe.mFluidInputs[i], T, F, mRecipeMap.mUseBucketSizeIn),
                        53 - (i % 3) * 18,
                        63 - (i / 3) * 18));
            for (int i = 0; i < aRecipe.mFluidOutputs.length && i < mRecipeMap.mOutputFluidCount; i++)
                if (aRecipe.mFluidOutputs[i] != null && aRecipe.mFluidOutputs[i].getFluid() != null) mOutputs.add(
                    new FixedPositionedStack(
                        FL.display(aRecipe.mFluidOutputs[i], T, F, mRecipeMap.mUseBucketSizeOut),
                        107 + (i % 3) * 18,
                        63 - (i / 3) * 18));
        }
    }
    ...
    public static class GT_RectHandler implements IContainerInputHandler, IContainerTooltipHandler {
        ...
        public List<String> handleTooltip(GuiContainer gui, int mousex, int mousey, List<String> currenttip) {
            if (canHandle(gui) && currenttip.isEmpty()
                && new Rectangle(65, 13, 36, 18).contains(
                    new Point(
                        GuiDraw.getMousePosition().x - ((ContainerClient) gui).getLeft()
                            - RecipeInfo.getGuiOffset(gui)[0],
                        GuiDraw.getMousePosition().y - ((ContainerClient) gui).getTop()
                            - RecipeInfo.getGuiOffset(gui)[1])))
                currenttip.add("Recipes");
            return currenttip;
        }

        private boolean transferRect(GuiContainer gui, boolean usage) {
            return canHandle(gui) && new Rectangle(65, 13, 36, 18).contains(
                new Point(
                    GuiDraw.getMousePosition().x - ((ContainerClient) gui).getLeft() - RecipeInfo.getGuiOffset(gui)[0],
                    GuiDraw.getMousePosition().y - ((ContainerClient) gui).getTop() - RecipeInfo.getGuiOffset(gui)[1]))
                && (usage ? GuiUsageRecipe.openRecipeGui(((ContainerClient) gui).mNEI)
                    : GuiCraftingRecipe.openRecipeGui(((ContainerClient) gui).mNEI));
        }
    ...
    /**
     * Thanks to codewarrior0 for doing most of this, because Greg was way too lazy to do it, but not lazy enough to not
     * fix it. XD
     */
    public void sortRecipes() {
        if (arecipes.size() > 1000) return;
        Collections.sort(arecipes, new Comparator<CachedRecipe>() {

            @Override
            public int compare(CachedRecipe aRecipe1, CachedRecipe aRecipe2) {
                Recipe tRecipe1 = ((CachedDefaultRecipe) aRecipe1).mRecipe,
                    tRecipe2 = ((CachedDefaultRecipe) aRecipe2).mRecipe;
                ...
                if (tRecipe1.mFluidInputs.length > 0) {
                    tCompare = FL.regName(tRecipe1.mFluidInputs[0])
                        .compareTo(FL.regName(tRecipe2.mFluidInputs[0]));
                    if (tCompare != 0) return tCompare;
                }
                ...
                if (tRecipe1.mInputs.length > 0) {
                    ...
                    if (ST.valid(tInput1)) {
                        ...
                        if (tData1 != null && tData1.validMaterial()) {
                            ...
                            tCompare = tData1.mMaterial.mMaterial.mNameInternal
                                .compareTo(tData2.mMaterial.mMaterial.mNameInternal);
                            if (tCompare != 0) return tCompare;
                        ...
                        if (tCompare != 0) return tCompare;
                        tCompare = ST.regName(tInput1)
                            .compareTo(ST.regName(tInput2));
                        if (tCompare != 0) return tCompare;
    ...
    public void loadCraftingRecipes(ItemStack aResult) {
        ...
        try {
            ...
            if (tPrefixMaterial != null && !tPrefixMaterial.mBlackListed) {
                if (tPrefixMaterial.mMaterial.mMaterial.mID > 0 && BlocksGT.ore != null
                    && BlocksGT.oreBroken != null
                    && tPrefixMaterial.mPrefix.containsAny(TD.Prefix.ORE, TD.Prefix.ORE_PROCESSING_BASED)) {
                ...
                if (tPrefixMaterial.mPrefix.containsAny(TD.Prefix.DUST_BASED)
                    && tPrefixMaterial.mMaterial.mMaterial.mTargetPulver.mMaterial
                        == tPrefixMaterial.mMaterial.mMaterial) {
            ...
            for (Recipe tRecipe : mRecipeMap.getNEIRecipes(tResults.toArray(ZL_IS)))
                if (!tRecipes.contains(tRecipe)) tRecipes.add(tRecipe);
    ...
    public void loadUsageRecipes(ItemStack aInput) {
        ...
        try {
            ...
            ArrayList<Recipe> tRecipes = new ArrayListNoNulls<>();
            for (Recipe tRecipe : mRecipeMap.getNEIUsages(tInputs.toArray(ZL_IS)))
                if (!tRecipes.contains(tRecipe)) tRecipes.add(tRecipe);
            for (Recipe tRecipe : tRecipes) arecipes.add(new CachedDefaultRecipe(tRecipe));
            sortRecipes();
        } catch (Throwable e) {
    ...
    public String getGuiTexture() {
        return UT.Code.stringValid(mRecipeMap.mGUIPath) ? mRecipeMap.mGUIPath
            : RES_PATH_GUI + mRecipeMap.mNameInternal + ".png";
    }
        ...
        if (tObject instanceof CachedDefaultRecipe) {
            ...
            for (PositionedStack tStack : tRecipe.mOutputs) if (aStack == tStack.item) {
                if (tStack instanceof FixedPositionedStack && ((FixedPositionedStack) tStack).mChance > 0
                    && ((FixedPositionedStack) tStack).mChance != ((FixedPositionedStack) tStack).mMaxChance) {
                    long tChance = UT.Code.units(
                        ((FixedPositionedStack) tStack).mChance,
                        ((FixedPositionedStack) tStack).mMaxChance,
                        10000,
                        F);
                    currenttip.add(
                        1,
                        LH.Chat.BLINKING_CYAN + "Chance: "
                            + (tChance / 100)
                            + "."
                            + ((tChance % 100) < 10 ? "0" + (tChance % 100) : (tChance % 100))
                            + "%"
                            + (tStack.item.stackSize > 1 ? " each" : ""));
                }
                break;
            }
            for (PositionedStack tStack : tRecipe.mInputs) if (aStack == tStack.item) {
                if (!gregapi.data.IL.Display_Fluid.equal(tStack.item, T, T)) {
                    if (tStack.item.stackSize == 0)
    ...
    public void drawExtras(int aRecipeIndex) {
        ...
        if (tDuration > 0) drawText(
            10,
            113,
            "Time: " + (tDuration < 1200 ? UT.Code.makeString(tDuration) + " ticks"
                : tDuration < 36000 ? UT.Code.makeString(tDuration / 20) + " secs"
                    : UT.Code.makeString(tDuration / 1200) + " mins"),
            0xFF000000);
        if (UT.Code.stringValid(mRecipeMap.mNEISpecialValuePre) || UT.Code.stringValid(mRecipeMap.mNEISpecialValuePost))
            drawText(
                10,
                123,
                mRecipeMap.mNEISpecialValuePre + UT.Code.makeString(
                    ((CachedDefaultRecipe) arecipes.get(aRecipeIndex)).mRecipe.mSpecialValue
                        * mRecipeMap.mNEISpecialValueMultiplier)
                    + mRecipeMap.mNEISpecialValuePost,
                0xFF000000);
    }
}
