...
public class LoaderUnificationTargets implements Runnable {
    ...
    public void run() {
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreNetherrack, MT.OREMATS.Scheelite, MD.HBM, "tile.ore_nether_tungsten", 0);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreGneiss, MT.UNUSED.Schrabidium, MD.HBM, "tile.ore_gneiss_schrabidium", 0);
        OreDictManager.INSTANCE
            .setTarget(OP.oreNetherrack, MT.UNUSED.Schrabidium, MD.HBM, "tile.ore_nether_schrabidium", 0);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.OREMATS.Uraninite, MD.HBM, "tile.ore_uranium_scorched", 0);
        OreDictManager.INSTANCE.setTarget(OP.oreNetherrack, MT.OREMATS.Uraninite, MD.HBM, "tile.ore_nether_uranium", 0);
        OreDictManager.INSTANCE
            .setTarget(OP.oreNetherrack, MT.OREMATS.Uraninite, MD.HBM, "tile.ore_nether_uranium_scorched", 0);
        OreDictManager.INSTANCE.setTarget(OP.oreGneiss, MT.OREMATS.Uraninite, MD.HBM, "tile.ore_gneiss_uranium", 0);
        OreDictManager.INSTANCE
            .setTarget(OP.oreGneiss, MT.OREMATS.Uraninite, MD.HBM, "tile.ore_gneiss_uranium_scorched", 0);
        ...
        if (MD.GC_GALAXYSPACE.mLoaded) if (ST.valid(ST.make(MD.GC_GALAXYSPACE, "dungeonglowstone", 0))) {
            ...
            OreDictManager.INSTANCE
                .setTarget(OP.compressed, MT.Adamantite, MD.GC_GALAXYSPACE, "item.CompressedPlates", 0);
            OreDictManager.INSTANCE.setTarget(OP.compressed, MT.Co, MD.GC_GALAXYSPACE, "item.CompressedPlates", 1);
            OreDictManager.INSTANCE
                .setTarget(OP.compressed, MT.Duralumin, MD.GC_GALAXYSPACE, "item.CompressedPlates", 2);
            ...
            OreDictManager.INSTANCE
                .setTarget(OP.compressed, MT.Oriharukon, MD.GC_GALAXYSPACE, "item.CompressedPlates", 7);
            ...
            OreDictManager.INSTANCE
                .setTarget(OP.dust, MT.GlowstoneEnceladus, MD.GC_GALAXYSPACE, "item.GlowstoneDusts", 2);
            OreDictManager.INSTANCE
                .setTarget(OP.dust, MT.GlowstoneProteus, MD.GC_GALAXYSPACE, "item.GlowstoneDusts", 3);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.gearGt, MT.TitaniumAluminide, MD.GC_ADV_ROCKETRY, "advancedRocketryproductgear", 0);
        OreDictManager.INSTANCE
            .setTarget(OP.gearGt, MT.Iritanium, MD.GC_ADV_ROCKETRY, "advancedRocketryproductgear", 1);
        OreDictManager.INSTANCE
            .setTarget(OP.sheetGt, MT.TitaniumAluminide, MD.GC_ADV_ROCKETRY, "advancedRocketryproductsheet", 0);
        OreDictManager.INSTANCE
            .setTarget(OP.sheetGt, MT.Iritanium, MD.GC_ADV_ROCKETRY, "advancedRocketryproductsheet", 1);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.ChargedCertusQuartz, MD.AE, "tile.OreQuartzCharged", 0);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.blockIngot, MT.CrystallinePinkSlime, MD.EIO, "blockIngotStorageEndergy", 4);
        ...
        // OreDictManager.INSTANCE.setTarget(OP.dust , MT.AmmoniumChloride , MD.ReC, "reactorcraft_item_raw", 3); //
        // registered as dustAmmonium
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.OREMATS.Pitchblende, MD.ReC, "reactorcraft_block_ore", 1);
        ...
        // OreDictManager.INSTANCE.setTarget(OP.oreNetherrack , MT.AmmoniumChloride , MD.ReC, "reactorcraft_block_ore",
        // 6); // registered as oreAmmonium
        OreDictManager.INSTANCE.setTarget(OP.oreVanillastone, MT.CaCO3, MD.ReC, "reactorcraft_block_ore", 7);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.OREMATS.Magnetite, MD.ReC, "reactorcraft_block_ore", 8);
        OreDictManager.INSTANCE.setTarget(OP.oreNetherrack, MT.Th, MD.ReC, "reactorcraft_block_ore", 9);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.FluoriteBlue, MD.ReC, "reactorcraft_block_fluoriteore", 0);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.FluoritePink, MD.ReC, "reactorcraft_block_fluoriteore", 1);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.FluoriteOrange, MD.ReC, "reactorcraft_block_fluoriteore", 2);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.FluoriteMagenta, MD.ReC, "reactorcraft_block_fluoriteore", 3);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.FluoriteGreen, MD.ReC, "reactorcraft_block_fluoriteore", 4);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.FluoriteRed, MD.ReC, "reactorcraft_block_fluoriteore", 5);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.FluoriteWhite, MD.ReC, "reactorcraft_block_fluoriteore", 6);
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.FluoriteYellow, MD.ReC, "reactorcraft_block_fluoriteore", 7);
        ...
        // OreDictManager.INSTANCE.setTarget(OP.dust , MT.SludgeOrganic , MD.RoC, "rotarycraft_item_powders", 2); smelts
        // into ethanol
        ...
        // OreDictManager.INSTANCE.setTarget(OP.dust , MT.AmmoniumNitrate , MD.RoC, "rotarycraft_item_powders", 6); Salt
        // + Coal + Gunpowder + Redstone = 4 (180, 150, 200)
        ...
        // OreDictManager.INSTANCE.setTarget(OP.gem , MT.Ethanol , MD.RoC, "rotarycraft_item_ethanol", 0); burns for 400
        // furnace time
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.stickLong, MT.STONES.Livingrock, MD.RoC, "rotarycraft_item_modinterface", 18);
        OreDictManager.INSTANCE.setTarget(OP.stickLong, MT.HSLA, MD.RoC, "rotarycraft_item_gearcraft", 0);
        // OreDictManager.INSTANCE.setTarget(OP.stickLong , MT.Wood , MD.RoC, "rotarycraft_item_gearcraft", 16); // This
        // one does not really exist!
        OreDictManager.INSTANCE.setTarget(OP.stickLong, MT.Stone, MD.RoC, "rotarycraft_item_gearcraft", 32);
        OreDictManager.INSTANCE.setTarget(OP.stickLong, MT.Diamond, MD.RoC, "rotarycraft_item_gearcraft", 48); // 64
                                                                                                               // would
                                                                                                               // be
                                                                                                               // Bedrock
        ...
        // OreDictManager.INSTANCE.setTarget(OP.oreBlackstone , MT.Au , MD.NeLi, "Blackstone", 5); // DONT! This thing
        // is crafted with 4 Nuggets and a Blackstone!
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.CertusQuartz, MD.EtFu, "deepslate_certus_quartz_ore", 0, MD.AE);
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.ChargedCertusQuartz, MD.EtFu, "deepslate_certus_quartz_ore", 1, MD.AE);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.BlueSapphire, MD.EtFu, "deepslate_bluepower_ore", 2, MD.BP);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.OREMATS.Malachite, MD.EtFu, "deepslate_bop_ore", 4, MD.BoP);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.OREMATS.Cinnabar, MD.EtFu, "deepslate_thaumcraft_ore", 0, MD.TC);
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.InfusedAir, MD.EtFu, "deepslate_thaumcraft_ore", 1, MD.TC);
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.InfusedFire, MD.EtFu, "deepslate_thaumcraft_ore", 2, MD.TC);
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.InfusedWater, MD.EtFu, "deepslate_thaumcraft_ore", 3, MD.TC);
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.InfusedEarth, MD.EtFu, "deepslate_thaumcraft_ore", 4, MD.TC);
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.InfusedOrder, MD.EtFu, "deepslate_thaumcraft_ore", 5, MD.TC);
        OreDictManager.INSTANCE
            .setTarget(OP.oreDeepslate, MT.InfusedEntropy, MD.EtFu, "deepslate_thaumcraft_ore", 6, MD.TC);
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.OREMATS.Uraninite, ST.make(MD.IC2, "blockOreUran", 1, 0));
        ...
        OreDictManager.INSTANCE
            .setTarget(OP.oreVanillastone, MT.OREMATS.Uraninite, ST.make(MD.IC2, "uraniumOre", 1, 0));
        if (MD.IC2C.mLoaded) {
