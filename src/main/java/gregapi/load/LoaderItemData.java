...
public class LoaderItemData implements Runnable {
    ...
    public void run() {
        ...
        for (byte i = 0; i < 16; i++)
            OM.reg(OP.dyeMixable.mNameInternal + DYE_OREDICTS_POST[i], ST.make(Items.dye, 1, i));
        ...
        if (MD.UB.mLoaded) {
            ...
            for (String tName : new String[] { "metamorphicStone", "metamorphicCobblestone",
        ...
        if (MD.EB.mLoaded) {
            for (String tName : new String[] { "enhancedbiomes.tile.stoneEB", "enhancedbiomes.tile.stoneCobbleEB",
                "enhancedbiomes.tile.stoneBrickEB" }) {
        ...
        if (MD.BTL.mLoaded) {
            ...
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneTilesMossyCollapsing", 1, 0));// Weak
                                                                                                                // Mossy
                                                                                                                // Betweenstone
                                                                                                                // Tiles
            ...
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneSmoothMossy", 1, 0));// Mossy Smooth
                                                                                                       // Betweenstone
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneBricks", 1, 0));// Betweenstone Bricks
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneBricksCracked", 1, 0));// Cracked
                                                                                                         // Betweenstone
                                                                                                         // Brick
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneBricksMossy", 1, 0));// Mossy
                                                                                                       // Betweenstone
                                                                                                       // Bricks
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneTilesCollapsing", 1, 0));// Weak
                                                                                                           // Betweenstone
                                                                                                           // Tiles
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneTilesCracked", 1, 0));// Cracked
                                                                                                        // Betweenstone
                                                                                                        // Tiles
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneTilesFortress", 1, 0));// Glowing
                                                                                                         // Betweenstone
                                                                                                         // Tile
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "chiseledBetweenstone", 1, 0));// Chiseled
                                                                                                    // Betweenstone
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneTilesMossy", 1, 0));// Mossy
                                                                                                      // Betweenstone
                                                                                                      // Tiles
            OM.reg(OP.stone, MT.STONES.Betweenstone, ST.make(MD.BTL, "betweenstoneBricksMirage", 1, 0));// Betweenstone
                                                                                                        // Bricks Mirage
            ...
            OM.reg(OP.stone, MT.STONES.Cragrock, ST.make(MD.BTL, "glowingSmoothCragrock", 1, 0));// Glowing Smooth
                                                                                                 // Cragrock
            ...
            OM.reg(OP.stone, MT.STONES.Limestone, ST.make(MD.BTL, "crackedLimestoneBricks", 1, 0));// Cracked Limestone
                                                                                                   // Bricks
            OM.reg(OP.stone, MT.STONES.Limestone, ST.make(MD.BTL, "mossyLimestoneBricks", 1, 0));// Mossy Limestone
                                                                                                 // Bricks
            OM.reg(OP.stone, MT.STONES.Limestone, ST.make(MD.BTL, "polishedLimestone", 1, 0));// Polished Limestone
            OM.reg(OP.stone, MT.STONES.Limestone, ST.make(MD.BTL, "polishedLimestoneCollapsing", 1, 0));// Weak Polished
                                                                                                        // Limestone
        ...
        OM.data(
            ...
            9 * U16,
            MT.AluminiumAlloy,
            U * 2); // Upgrade Performance Engine
        OM.data(MD.RoC, "rotarycraft_item_upgrade", 1, 1, MT.HSLA, 33 * U9, MT.Redstone, U * 3, MT.Au, U * 2); // Upgrade
                                                                                                               // Redstone
                                                                                                               // Cooling
        OM.data(
            MD.RoC,
        ...
        OM.data(
            ...
            U * 1,
            MT.InductiveAlloy,
            U * 3); // Upgrade Flux Conductance
        OM.data(MD.RoC, "rotarycraft_item_upgrade", 1, 4, MT.HSLA, U * 2, ANY.W, U * 4, MT.Bedrock_HSLA_Alloy, U * 1); // Upgrade
                                                                                                                       // Thermal
                                                                                                                       // Stability
        OM.data(MD.RoC, "rotarycraft_item_upgrade", 1, 5, MT.HSLA, 37 * U8, MT.SpringSteel, U * 4, MT.Bedrock, U2); // Upgrade
                                                                                                                    // Torsion
                                                                                                                    // Resistance
        OM.data(
            MD.RoC,
        ...
        OM.data(
            ...
            U * 1,
            MT.SteelMagnetic,
            U * 2); // Upgrade Resonance Stability
        OM.data(
            MD.RoC,
            "rotarycraft_item_upgrade",
            1,
            ...
            U * 2,
            MT.Enderium,
            U * 1); // Flux Amplitude Upgrade

        OM.data(MD.RoC, "rotarycraft_item_engine", 1, 0, MT.HSLA, U * 7, MT.Redstone, U * 2); // DC Engine
        OM.data(MD.RoC, "rotarycraft_item_engine", 1, 3, MT.HSLA, 171 * U9, MT.Redstone, U * 1, MT.Au, U * 2); // Gasoline
                                                                                                               // Engine

        OM.data(MD.RoC, "rotarycraft_item_misccraft", 1, 0, ANY.W, U * 1, ANY.Glowstone, U * 4, MT.Obsidian, U * 54); // Heat
                                                                                                                      // Ray
                                                                                                                      // Barrel
        OM.data(MD.RoC, "rotarycraft_item_misccraft", 1, 1, ANY.Diamond, U * 4); // Lens
        OM.data(MD.RoC, "rotarycraft_item_misccraft", 1, 2, MT.HSLA, U * 1, MT.Redstone, 2 * U3, MT.Au, U * 1); // Power
                                                                                                                // Module
        OM.data(
            MD.RoC,
            "rotarycraft_item_misccraft",
            1,
            3,
            MT.NetherStar,
            U * 1,
            ...
            MT.Blaze,
            U9 * 2); // Heat Ray Core
        OM.data(MD.RoC, "rotarycraft_item_misccraft", 1, 4, MT.HSLA, U * 5, MT.Au, U * 8, MT.Redstone, U * 1); // Linear
                                                                                                               // Induction
                                                                                                               // Motor
        ...
        OM.data(MD.RoC, "rotarycraft_item_misccraft", 1, 9, MT.HSLA, U * 41, MT.Au, U * 65, MT.Redstone, 26 * U3); // Railgun
                                                                                                                   // Accelerator
        ...
        OM.data(
            ...
            U * 9,
            MT.Redstone,
            16 * U3); // Turret Aiming Unit
        OM.data(MD.RoC, "rotarycraft_item_misccraft", 1, 12, MT.HSLA, 624 * U9, ANY.W, U * 4, MT.TungstenAlloy, U * 1); // Compound
                                                                                                                        // Turbine
        OM.data(MD.RoC, "rotarycraft_item_misccraft", 1, 13, MT.HSLA, U * 65, MT.Bedrock, U * 16, ANY.Diamond, U * 16); // Bedrock
                                                                                                                        // Tension
                                                                                                                        // Coil
        ...
        OM.data(MD.RoC, "rotarycraft_item_enginecraft", 1, 15, MT.HSLA, U * 5, MT.Redstone, U * 1, MT.Au, U * 1); // Ignition
                                                                                                                  // Unit
        OM.data(MD.RoC, "rotarycraft_item_enginecraft", 1, 16, ANY.Diamond, U * 3); // Diamond Shaft Core
        OM.data(
            MD.RoC,
            "rotarycraft_item_enginecraft",
            1,
            17,
            MT.HSLA,
            192 * U9,
        ...
        OM.data(MD.RoC, "rotarycraft_item_shaftcraft", 1, 12, MT.HSLA, 15 * U9, ANY.Stone, U * 8); // Stone Flywheel
                                                                                                   // Core
        ...
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 50, ANY.Diamond, U * 3, MT.TungstenAlloy, U8 * 2); // 2x
                                                                                                            // Diamond
                                                                                                            // Gear
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 51, ANY.Diamond, U * 8, MT.TungstenAlloy, U8 * 4); // 4x
                                                                                                            // Diamond
                                                                                                            // Gear
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 52, ANY.Diamond, U * 13, MT.TungstenAlloy, U8 * 6); // 8x
                                                                                                             // Diamond
                                                                                                             // Gear
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 53, ANY.Diamond, U * 18, MT.TungstenAlloy, U8 * 8); // 16x
                                                                                                             // Diamond
                                                                                                             // Gear
        ...
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 114, MT.TungstenAlloy, U * 2, MT.HSLA, U * 2); // 2x Tungsten
                                                                                                        // Alloy Gear
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 115, MT.TungstenAlloy, U * 4, MT.HSLA, U * 6); // 4x Tungsten
                                                                                                        // Alloy Gear
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 116, MT.TungstenAlloy, U * 6, MT.HSLA, U * 10); // 8x Tungsten
                                                                                                         // Alloy Gear
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 117, MT.TungstenAlloy, U * 8, MT.HSLA, U * 14); // 16x Tungsten
                                                                                                         // Alloy Gear
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 118, MT.TungstenAlloy, U, MT.HSLA, U * 2); // Tungsten Alloy
                                                                                                    // Bearing
        OM.data(MD.RoC, "rotarycraft_item_gearcraft", 1, 119, MT.TungstenAlloy, U, MT.HSLA, U * 2); // Tungsten Alloy
                                                                                                    // Shaft Core

        OM.data(MD.RoC, "rotarycraft_item_borecraft", 1, 0, MT.HSLA, U * 7); // Drill
        OM.data(
            MD.RoC,
            "rotarycraft_item_borecraft",
            1,
            1,
            MT.HSLA,
            U * 1,
            ...
            MT.Obsidian,
            U * 18); // Pressure Head
        OM.data(MD.RoC, "rotarycraft_item_borecraft", 1, 2, MT.HSLA, U * 10, MT.Redstone, 4 * U, MT.Au, U * 1); // Radar
                                                                                                                // Unit
        OM.data(MD.RoC, "rotarycraft_item_borecraft", 1, 3, MT.HSLA, U * 4, MT.Redstone, 11 * U3, ANY.Wood, U * 8); // Sonar
                                                                                                                    // Unit
        ...
        OM.data(
            ...
            "rotarycraft_item_machine",
            1,
            73/* Self Detruct Mechanism */ ,
            MT.HSLA,
            U * 6,
            MT.Redstone,
            2 * U3);
        // OM.data(MD.RoC, "rotarycraft_item_machine" , 1, 74/* Cooling Fin */ ); // yep no value, too different
        // Recipes, which have nothing in common
        OM.data(
            MD.RoC,
            "rotarycraft_item_machine",
            1,
        ...
        OM.data(
            ...
            "rotarycraft_item_machine",
            1,
            111/* Shaft Power Bus Controller */ ,
            MT.HSLA,
            U * 17,
            MT.Redstone,
            2 * U3);
        ...
        OM.data(MD.BTL, "smoothBetweenstoneWallMossy", 1, 0, MT.STONES.Betweenstone, U * 9);// Mossy Smooth Betweenstone
                                                                                            // Wall
        OM.data(MD.BTL, "smoothBetweenstoneWallMossy", 1, 0, MT.STONES.Betweenstone, U * 9);// Mossy Smooth Betweenstone
                                                                                            // Wall
        ...
        OM.data(MD.BTL, "smoothBetweenstoneWallMossy", 1, 0, MT.STONES.Betweenstone, U * 9);// Mossy Smooth Betweenstone
                                                                                            // Wall
        OM.data(MD.BTL, "betweenstoneSmoothStairsMossy", 1, 0, MT.STONES.Betweenstone, U4 * 27);// Mossy Smooth
                                                                                                // Betweenstone Stairs
        OM.data(MD.BTL, "Mossy Smooth Betweenstone Slab", 1, 0, MT.STONES.Betweenstone, U2 * 9);// Mossy Smooth
                                                                                                // Betweenstone Slab
        ...
        OM.data(MD.BTL, "betweenstoneBrickWallCracked", 1, 0, MT.STONES.Betweenstone, U * 9);// Cracked Betweenstone
                                                                                             // Brick Wall
        OM.data(MD.BTL, "betweenstoneBrickStairsCracked", 1, 0, MT.STONES.Betweenstone, U4 * 27);// Cracked Betweenstone
                                                                                                 // Brick Stairs
        OM.data(MD.BTL, "Cracked Betweenstone Brick Slab", 1, 0, MT.STONES.Betweenstone, U2 * 9);// Cracked Betweenstone
                                                                                                 // Brick Slab
        OM.data(MD.BTL, "betweenstoneBrickWallMossy", 1, 0, MT.STONES.Betweenstone, U * 9);// Mossy Betweenstone Brick
                                                                                           // Wall
        OM.data(MD.BTL, "betweenstoneBrickStairsMossy", 1, 0, MT.STONES.Betweenstone, U4 * 27);// Mossy Betweenstone
                                                                                               // Brick Stairs
        OM.data(MD.BTL, "Mossy Betweenstone Brick Slab", 1, 0, MT.STONES.Betweenstone, U2 * 9);// Mossy Betweenstone
                                                                                               // Brick Slab
        ...
        OM.data(
            MD.HEX,
            "blockEnergizedHexoriumMonolithDarkGray",
            1,
            W,
            MT.HexoriumBlack,
            U * 6,
        ...
        OM.data(
            MD.HEX,
            "blockEnergizedHexoriumMonolithLightGray",
            1,
            W,
            MT.HexoriumBlack,
            U * 2,
        ...
        OM.data(
            MD.HEX,
            "blockEnergizedHexoriumMonolithTurquoise",
            1,
            W,
            MT.HexoriumGreen,
            U * 6,
        ...
        OM.data(
            MD.HEX,
            "blockMiniEnergizedHexoriumLightGray",
            1,
            W,
            MT.HexoriumBlack,
            U8 * 2,
        ...
        OM.data(
            MD.HEX,
            "blockMiniEnergizedHexoriumRainbow",
            1,
            W,
            MT.HexoriumWhite,
            U8 * 2,
        ...
        OM.dat2(
            ...
            MT.Terrasteel,
            U * 4,
            OM.stack(MT.Livingwood, OP.stick.mAmount * 2),
            OM.stack(ANY.Glowstone, U * 4));
        OM.dat2(
            MD.BOTA,
            "terraPick",
            1,
            ...
            U * 4,
            OM.stack(MT.Livingwood, OP.stick.mAmount * 2),
            OM.stack(MT.STONES.Livingrock, U * 8));
        OM.dat2(
            MD.BOTA,
            "glassPick",
            1,
        ...
        if (ST.valid(ST.make(MD.GC_GALAXYSPACE, "dungeonglowstone", 1, 0))) {
            ...
            OM.reg(ST.make(MD.GC_GALAXYSPACE, "dungeonglowstone", 1, 0), OD.glowstone);
            ...
            OM.reg(ST.make(MD.GC_GALAXYSPACE, "ceresglowstone", 1, W), OD.glowstone);
            OM.data(MD.GC_GALAXYSPACE, "ioglowstone", 1, W, MT.GlowstoneIo, U * 4);
            OM.reg(ST.make(MD.GC_GALAXYSPACE, "ioglowstone", 1, W), OD.glowstone);
            OM.data(MD.GC_GALAXYSPACE, "enceladusglowstone", 1, W, MT.GlowstoneEnceladus, U * 4);
            OM.reg(ST.make(MD.GC_GALAXYSPACE, "enceladusglowstone", 1, W), OD.glowstone);
            OM.data(MD.GC_GALAXYSPACE, "proteusglowstone", 1, W, MT.GlowstoneProteus, U * 4);
            OM.reg(ST.make(MD.GC_GALAXYSPACE, "proteusglowstone", 1, W), OD.glowstone);
            OM.data(MD.GC_GALAXYSPACE, "plutoglowstone", 1, W, MT.GlowstonePluto, U * 4);
            OM.reg(ST.make(MD.GC_GALAXYSPACE, "plutoglowstone", 1, W), OD.glowstone);
        ...
        OM.data(
            ST.make(Blocks.beacon, 1, W),
            MT.NetherStar,
            U * 1,
            OM.stack(MT.Obsidian, U * 27),
            OM.stack(MT.Glass, U * 5));
        OM.data(
            ST.make(Blocks.enchanting_table, 1, W),
            ANY.Diamond,
            U * 2,
            OM.stack(MT.Obsidian, U * 36),
            OM.stack(MT.Paper, U * 3));
