 ...
 *         This happens during the InitPhase, or if GregTech is installed within the PreInitPhase, since GregTech loads
 *         after all the Mods mentioned here, unlike the API.
 */
public class LoaderItemList implements Runnable {
    ...
    public void run() {
        ...
        ItemsGT.NO_TOOL_FATIQUE.add(ST.make(MD.BWM, "knife.wood", 1, W));// These Daggers would give Fatique when
                                                                         // thrown, for no reason.
        ItemsGT.NO_TOOL_FATIQUE.add(ST.make(MD.BWM, "knife.stone", 1, W));// These Daggers would give Fatique when
                                                                          // thrown, for no reason.
        ItemsGT.NO_TOOL_FATIQUE.add(ST.make(MD.BWM, "knife.iron", 1, W));// These Daggers would give Fatique when
                                                                         // thrown, for no reason.
        ItemsGT.NO_TOOL_FATIQUE.add(ST.make(MD.BWM, "knife.gold", 1, W));// These Daggers would give Fatique when
                                                                         // thrown, for no reason.
        ItemsGT.NO_TOOL_FATIQUE.add(ST.make(MD.BWM, "knife.diamond", 1, W));// These Daggers would give Fatique when
                                                                            // thrown, for no reason.
        ...
        StoneLayer.REPLACEABLE_BLOCKS.add(ST.block(MD.HBM, "tile.stone_gneiss", null));// Do not add HBM Alexandrite Ore
                                                                                       // to this List!
        ...
        StoneLayer.REPLACEABLE_BLOCKS.add(ST.block(MD.MF2, "oreCoalRich", null)); // The other two MF2 Ore Blocks are
                                                                                  // not safe for removal due to lack of
                                                                                  // Material Data for them.
        ...
        MT.H2O.mTextureDust = MT.Steam.mTextureDust = MT.FreshWater.mTextureDust = MT.DistWater.mTextureDust = MT.Ice.mTextureDust = MT.Snow.mTextureDust = MT.Snow.mTextureSolid = BlockTextureCopied
            .get(Blocks.snow);
        MT.H2O.mTextureMolten = MT.Steam.mTextureMolten = MT.FreshWater.mTextureMolten = MT.DistWater.mTextureMolten = MT.Ice.mTextureMolten = MT.Snow.mTextureMolten = BlockTextureCopied
            .get(Blocks.water);
        MT.H2O.mTextureSolid = MT.Steam.mTextureSolid = MT.FreshWater.mTextureSolid = MT.DistWater.mTextureSolid = MT.Ice.mTextureSolid = BlockTextureCopied
            .get(Blocks.packed_ice);
        MT.Glowstone.mTextureSolid = MT.Glowstone.mTextureGem = MT.Glowstone.mTextureMolten = BlockTextureCopied
            .get(Blocks.glowstone);
        ...
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.TE_Wrench.wild(1));
        IL.TE_Wrench_Battle.set(ST.make(MD.TE, "tool.battleWrenchInvar", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.TE_Wrench_Battle.wild(1));
        ...
        IL.RC_Firestone_Refined.set(
            ST.make(MD.RC, "firestone.refined", 1, W),
            new OreDictItemData(MT.Firestone, U, MT.Redstone, U * 36),
            OD.craftingFirestarter);
        IL.RC_Firestone_Cracked.set(
            ST.make(MD.RC, "firestone.cracked", 1, W),
            new OreDictItemData(MT.Firestone, U, MT.Redstone, U * 9),
            OD.craftingFirestarter);
        IL.RC_Crowbar_Iron
            .set(ST.make(MD.RC, "tool.crowbar", 1, 0), new OreDictItemData(ANY.Fe, U * 3).setUseVanillaDamage());
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.RC_Crowbar_Iron.wild(1));
        IL.RC_Crowbar_Steel.set(
            ST.make(MD.RC, "tool.crowbar.reinforced", 1, 0),
            new OreDictItemData(ANY.Steel, U * 3).setUseVanillaDamage());
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.RC_Crowbar_Steel.wild(1));
        IL.RC_Crowbar_Thaumium.set(
            ST.make(MD.RC, "tool.crowbar.magic", 1, 0),
            new OreDictItemData(MT.Thaumium, U * 3).setUseVanillaDamage());
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.RC_Crowbar_Thaumium.wild(1));
        IL.RC_Crowbar_Voidmetal.set(
            ST.make(MD.RC, "tool.crowbar.void", 1, 0),
            new OreDictItemData(MT.VoidMetal, U * 3).setUseVanillaDamage());
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.RC_Crowbar_Voidmetal.wild(1));
        IL.Tool_Sword_Steel.set(
            ST.make(MD.RC, "tool.steel.sword", 1, 0),
            new OreDictItemData(ANY.Steel, OP.toolHeadSword, ANY.Wood, U2).setUseVanillaDamage());
        IL.Tool_Pickaxe_Steel.set(
            ST.make(MD.RC, "tool.steel.pickaxe", 1, 0),
            new OreDictItemData(ANY.Steel, OP.toolHeadPickaxe, ANY.Wood, U).setUseVanillaDamage());
        IL.Tool_Shovel_Steel.set(
            ST.make(MD.RC, "tool.steel.shovel", 1, 0),
            new OreDictItemData(ANY.Steel, OP.toolHeadShovel, ANY.Wood, U).setUseVanillaDamage());
        IL.Tool_Axe_Steel.set(
            ST.make(MD.RC, "tool.steel.axe", 1, 0),
            new OreDictItemData(ANY.Steel, OP.toolHeadAxe, ANY.Wood, U).setUseVanillaDamage());
        IL.Tool_Hoe_Steel.set(
            ST.make(MD.RC, "tool.steel.hoe", 1, 0),
            new OreDictItemData(ANY.Steel, OP.toolHeadHoe, ANY.Wood, U).setUseVanillaDamage());
        IL.RC_Creosote_Bottle
            .set(ST.make(MD.RC, "fluid.creosote.bottle", 1, 0), null, "bottleCreosote", OD.container1000creosote);
        IL.RC_Creosote_Bucket.set(
            ST.make(MD.RC, "fluid.creosote.bucket", 1, 0),
            new OreDictItemData(ANY.Fe, U * 3),
            "bucketCreosote",
            OD.container1000creosote);
        ...
        IL.RC_Creosote_RefractoryCapsule
            .set(ST.make(MD.RC, "fluid.creosote.refactory", 1, 0), null, OD.container1000creosote);

        if (IL.RC_Creosote_Bottle.exists()) IL.RC_Creosote_Bottle.item()
            .setContainerItem(Items.glass_bottle);
        if (IL.RC_Creosote_Bucket.exists()) IL.RC_Creosote_Bucket.item()
            .setContainerItem(Items.bucket);
        if (IL.RC_Creosote_Cell.exists() && IL.Cell_Empty.exists()) IL.RC_Creosote_Cell.item()
            .setContainerItem(IL.Cell_Empty.getItem());

        IL.IE_Creosote_Bottle
            .set(ST.make(MD.IE, "fluidContainers", 1, 0), null, "bottleCreosote", OD.container1000creosote);
        IL.IE_Creosote_Bucket.set(
            ST.make(MD.IE, "fluidContainers", 1, 1),
            new OreDictItemData(ANY.Fe, U * 3),
            "bucketCreosote",
            OD.container1000creosote);
        IL.IE_Hammer.set(ST.make(MD.IE, "tool", 1, 0), new OreDictItemData(ANY.Fe, U * 2, ANY.Wood, U));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.IE_Hammer.get(1));
        ...
        IL.IE_Blueprint_Projectiles_Specialized
            .set(ST.make(MD.IE, "blueprint", 1, 1), new OreDictItemData(MT.Paper, 3 * U));
        IL.IE_Blueprint_Projectiles_Electrodes
            .set(ST.make(MD.IE, "blueprint", 1, 2), new OreDictItemData(MT.Paper, 3 * U));
        ...
        IL.IE_Crate
            .set(ST.make(MD.IE, "woodenDevice", 1, 4), new OreDictItemData(MT.WoodTreated, 8 * U), OD.craftingChest);

        IL.SC2_Wrench.set(ST.make(MD.SC2, "ItemSpanner", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.SC2_Wrench.wild(1));
        IL.SC2_Hammer.set(ST.make(MD.SC2, "ItemHammer", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.SC2_Hammer.wild(1));
        IL.SC2_Hammer_Gilded.set(ST.make(MD.SC2, "ItemBugHammer", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.SC2_Hammer_Gilded.wild(1));
        ...
        IL.A97_Hammer.set(ST.make(MD.A97, "wrench", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.A97_Hammer.wild(1));

        IL.FZ_Sludge.set(ST.make(MD.FZ, "sludge", 1, 0), null, OD.itemSlag);

        IL.ABYSSAL_Crate
            .set(ST.make(MD.ABYSSAL, "Crate", 1, 0), new OreDictItemData(ANY.Wood, 7 * U), OD.craftingChest);
        ...
        IL.Myst_Desk_Block.set(ST.make(MD.MYST, "WritingDesk", 1, 0)); // 0L and 8R X POS, 1L and 9R Z NEG, 2L and 10R X
                                                                       // NEG, 3L and 11R Z POS
        ...
        IL.ALF_LivingCobble.set(
            ST.make(MD.ALF, "LivingCobble", 1, 0),
            new OreDictItemData(MT.STONES.Livingrock, U * 9),
            OP.cobblestone);
        IL.ALF_DreamWood
            .set(ST.make(MD.ALF, "DreamLog", 1, 0), new OreDictItemData(MT.Dreamwood, U * 8, MT.Bark, U), OD.logWood);
        ...
        IL.TC_Greatwood_Log.set(
            ST.make(MD.TC, "blockMagicalLog", 1, 0),
            new OreDictItemData(MT.Greatwood, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TC_Silverwood_Log.set(
            ST.make(MD.TC, "blockMagicalLog", 1, 1),
            new OreDictItemData(MT.Silverwood, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TC_Greatwood_Planks.set(
            ST.make(MD.TC, "blockWoodenDevice", 1, 6),
            new OreDictItemData(MT.Greatwood, U),
            OP.plank.dat(MT.Greatwood));
        IL.TC_Silverwood_Planks.set(
            ST.make(MD.TC, "blockWoodenDevice", 1, 7),
            new OreDictItemData(MT.Silverwood, U),
            OP.plank.dat(MT.Silverwood));
        IL.TC_Greatwood_Sapling
            .set(ST.make(MD.TC, "blockCustomPlant", 1, 0), new OreDictItemData(MT.Greatwood, U2), OP.treeSapling);
        IL.TC_Silverwood_Sapling
            .set(ST.make(MD.TC, "blockCustomPlant", 1, 1), new OreDictItemData(MT.Silverwood, U2), OP.treeSapling);
        IL.TC_Shimmerleaf.set(
            ST.make(MD.TC, "blockCustomPlant", 1, 2),
            new OreDictItemData(MT.Hg, U),
            "flowerShimmerleaf",
            OD.itemQuicksilver);
        IL.TC_Cinderpearl
            .set(ST.make(MD.TC, "blockCustomPlant", 1, 3), new OreDictItemData(MT.Blaze, U9), "flowerCinderpearl");
        ...
        IL.TC_Block_Flesh
            .set(ST.make(MD.TC, "blockTaint", 1, 2), new OreDictItemData(MT.MeatRotten, 18 * U, MT.Bone, U));
        ...
        IL.TC_Phial
            .set(ST.make(MD.TC, "ItemEssence", 1, 0), new OreDictItemData(ANY.Clay, U4, MT.Glass, 3 * U4), CR.DELATE);
        ...
        IL.TC_Knowledge_Fragment
            .set(ST.make(MD.TC, "ItemResource", 1, 9), new OreDictItemData(MT.Paper, U9), "paperResearchFragment");
        ...
        IL.TC_Bucket_Death
            .set(ST.make(MD.TC, "ItemBucketDeath", 1, 0), new OreDictItemData(ANY.Fe, U * 3), OD.itemPoison);
        IL.TC_Bucket_Pure.set(ST.make(MD.TC, "ItemBucketPure", 1, 0), new OreDictItemData(ANY.Fe, U * 3));

        if (IL.TC_Bucket_Death.exists()) IL.TC_Bucket_Death.item()
            .setContainerItem(Items.bucket);
        if (IL.TC_Bucket_Pure.exists()) IL.TC_Bucket_Pure.item()
            .setContainerItem(Items.bucket);
        if (IL.TC_Gold_Ring.exists()) IL.TC_Gold_Ring.item()
            .setMaxStackSize(64);
        ...
        IL.TF_Hydrachop_Raw.set(
            ST.make(MD.TF, "item.hydraChop", 1, 0),
            new OreDictItemData(MT.MeatRaw, U * 8, MT.Bone, U * 2),
            "listAllhydraraw");
        IL.TF_Meef_Raw.set(
            ST.make(MD.TF, "item.meefRaw", 1, 0),
            new OreDictItemData(MT.MeatRaw, U * 2, MT.Bone, U9),
            "listAllbeefraw");
        IL.TF_Meef_Cooked.set(
            ST.make(MD.TF, "item.meefSteak", 1, 0),
            new OreDictItemData(MT.MeatCooked, U * 2, MT.Bone, U9),
            "listAllbeefcooked");
        IL.TF_Venison_Raw.set(
            ST.make(MD.TF, "item.venisonRaw", 1, 0),
            new OreDictItemData(MT.MeatRaw, U * 2, MT.Bone, U9),
            "foodVenisonraw");
        IL.TF_Venison_Cooked.set(
            ST.make(MD.TF, "item.venisonCooked", 1, 0),
            new OreDictItemData(MT.MeatCooked, U * 2, MT.Bone, U9),
            "foodVenisoncooked");
        IL.TF_Lamp_of_Cinders.set(
            ST.make(MD.TF, "item.lampOfCinders", 1, 0),
            null,
            OD.craftingFirestarter,
            OreDictToolNames.flintandtinder);
        IL.TF_Cube_of_Annihilation.set(ST.make(MD.TF, "item.cubeOfAnnihilation", 1, 0));
        IL.TF_Pick_Giant.set(
            ST.make(MD.TF, "item.giantPick", 1, 0),
            new OreDictItemData(MT.Stone, U * 1728, MT.WOODS.Oak, U * 1024, MT.Bark, U * 128).setUseVanillaDamage());
        IL.TF_Sword_Giant.set(
            ST.make(MD.TF, "item.giantSword", 1, 0),
            new OreDictItemData(MT.Stone, U * 1152, MT.WOODS.Oak, U * 512, MT.Bark, U * 64).setUseVanillaDamage());
        IL.TF_Mushgloom_Huge.set(ST.make(MD.TF, "tile.HugeGloomBlock", 1, 0), new OreDictItemData(MT.Glowstone, U));
        IL.TF_Mushgloom
            .set(ST.make(MD.TF, "tile.TFPlant", 1, 9), new OreDictItemData(MT.Glowstone, U4), OD.listAllmushroom);
        ...
        IL.TF_Giant_Log
            .set(ST.make(MD.TF, "tile.GiantLog", 1, 0), new OreDictItemData(MT.WOODS.Oak, U * 512, MT.Bark, U * 64));
        IL.TF_Log_Oak
            .set(ST.make(MD.TF, "tile.TFLog", 1, 0), new OreDictItemData(MT.WOODS.Oak, U * 8, MT.Bark, U), OD.logWood);
        IL.TF_Log_Canopy.set(
            ST.make(MD.TF, "tile.TFLog", 1, 1),
            new OreDictItemData(MT.WOODS.Spruce, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Log_Mangrove.set(
            ST.make(MD.TF, "tile.TFLog", 1, 2),
            new OreDictItemData(MT.WOODS.Birch, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Log_Darkwood.set(
            ST.make(MD.TF, "tile.TFLog", 1, 3),
            new OreDictItemData(MT.WOODS.Towerwood, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Log_Time.set(
            ST.make(MD.TF, "tile.TFMagicLog", 1, 0),
            new OreDictItemData(MT.WOODS.Spruce, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Log_Trans.set(
            ST.make(MD.TF, "tile.TFMagicLog", 1, 1),
            new OreDictItemData(MT.WOODS.Acacia, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Log_Mine.set(
            ST.make(MD.TF, "tile.TFMagicLog", 1, 2),
            new OreDictItemData(MT.WOODS.Birch, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Log_Sorting.set(
            ST.make(MD.TF, "tile.TFMagicLog", 1, 3),
            new OreDictItemData(MT.WOODS.DarkOak, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Core_Time.set(
            ST.make(MD.TF, "tile.TFMagicLogSpecial", 1, 0),
            new OreDictItemData(MT.WOODS.Spruce, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Core_Trans.set(
            ST.make(MD.TF, "tile.TFMagicLogSpecial", 1, 1),
            new OreDictItemData(MT.WOODS.Acacia, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Core_Mine.set(
            ST.make(MD.TF, "tile.TFMagicLogSpecial", 1, 2),
            new OreDictItemData(MT.WOODS.Birch, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TF_Core_Sorting.set(
            ST.make(MD.TF, "tile.TFMagicLogSpecial", 1, 3),
            new OreDictItemData(MT.WOODS.DarkOak, U * 8, MT.Bark, U),
            OD.logWood);
        ...
        IL.TF_Magic_Map_Empty
            .set(ST.make(MD.TF, "item.emptyMagicMap", 1, W), new OreDictItemData(MT.Paper, U * 8), OD.paperMap);
        ...
        IL.TF_Maze_Map_Empty
            .set(ST.make(MD.TF, "item.emptyMazeMap", 1, W), new OreDictItemData(MT.Paper, U * 8), OD.paperMap);
        ...
        IL.TF_Ore_Map_Empty
            .set(ST.make(MD.TF, "item.emptyOreMap", 1, W), new OreDictItemData(MT.Paper, U * 8), OD.paperMap);
        ...
        if (IL.TF_Magic_Map.exists()) IL.TF_Magic_Map.item()
            .setMaxStackSize(64);
        if (IL.TF_Maze_Map.exists()) IL.TF_Maze_Map.item()
            .setMaxStackSize(64);
        if (IL.TF_Ore_Map.exists()) IL.TF_Ore_Map.item()
            .setMaxStackSize(64);
        // These Bottles should actually have an empty Variant.
        if (IL.TF_Firefly_Jar.exists()) IL.TF_Firefly_Jar.item()
            .setContainerItem(Items.glass_bottle);
        if (IL.TF_Vial_FieryBlood.exists()) IL.TF_Vial_FieryBlood.item()
            .setContainerItem(Items.glass_bottle);
        if (IL.TF_Vial_FieryTears.exists()) IL.TF_Vial_FieryTears.item()
            .setContainerItem(Items.glass_bottle);
        // Make this work as infinite Lighter in Crafting Recipes. It is absolutely useless otherwise since the Final
        // Castle isn't finished.
        if (IL.TF_Lamp_of_Cinders.exists()) IL.TF_Lamp_of_Cinders.item()
            .setContainerItem(IL.TF_Lamp_of_Cinders.getItem());

        IL.DRPG_Bucket_Tar.set(ST.make(MD.DRPG, "bucketOfTar", 1, 0), null, "bucketTar");

        if (IL.DRPG_Bucket_Tar.exists()) IL.DRPG_Bucket_Tar.item()
            .setContainerItem(Items.bucket);

        IL.PFAA_Sands.set(ST.make(MD.PFAA, "weakOreSand", 1, 0));

        IL.RH_Sand_Magnetite.set(
            ST.make(MD.RH, "globbypotato_rockhounding_beachSands", 1, 0),
            new OreDictItemData(MT.OREMATS.GraniticMineralSand, U));
        IL.RH_Sand_Olivine
            .set(ST.make(MD.RH, "globbypotato_rockhounding_beachSands", 1, 1), new OreDictItemData(MT.Peridot, U));
        IL.RH_Sand_Coral
            .set(ST.make(MD.RH, "globbypotato_rockhounding_beachSands", 1, 2), new OreDictItemData(MT.Sand, U * 9));
        IL.RH_Sand_Gypsum
            .set(ST.make(MD.RH, "globbypotato_rockhounding_beachSands", 1, 3), new OreDictItemData(MT.Gypsum, U));
        ...
        IL.TROPIC_Sand_Black.set(
            ST.make(MD.TROPIC, "tile.mineralSand", 1, 2),
            new OreDictItemData(MT.OREMATS.BasalticMineralSand, U * 9));
        IL.TROPIC_Sand_Mineral
            .set(ST.make(MD.TROPIC, "tile.mineralSand", 1, 3), new OreDictItemData(MT.OREMATS.Cassiterite, U));
        IL.TROPIC_Sand_Pure.set(ST.make(MD.TROPIC, "tile.purifiedSand", 1, 0), new OreDictItemData(MT.Sand, U * 9));
        IL.TROPIC_Log_Palm.set(
            ST.make(MD.TROPIC, "tile.log", 1, 0),
            new OreDictItemData(MT.WOODS.Palm, U * 8, MT.Bark, U),
            OD.logWood);
        IL.TROPIC_Log_Mahogany.set(
            ST.make(MD.TROPIC, "tile.log", 1, 1),
            new OreDictItemData(MT.WOODS.Mahogany, U * 8, MT.Bark, U),
            OD.logWood);
        ...
        IL.TROPIC_Chest
            .set(ST.make(MD.TROPIC, "tile.bambooChest", 1, 0), new OreDictItemData(MT.Bamboo, 8 * U), OD.craftingChest);
        ...
        IL.CANDY_Comb
            .set(ST.make(MD.CANDY, "I37", 1, 0), null, OD.beeComb, OD.materialHoneycomb, "foodFilledhoneycomb");
        IL.CANDY_Chest
            .set(ST.make(MD.CANDY, "B56X", 1, 0), new OreDictItemData(MT.Marshmallow, 8 * U), OD.craftingChest);
        IL.CANDY_Sapling_Chocolate
            .set(ST.make(MD.CANDY, "B7", 1, 0), new OreDictItemData(MT.Chocolate, U2), OP.treeSapling);
        IL.CANDY_Sapling_Caramel.set(ST.make(MD.CANDY, "B7", 1, 1), new OreDictItemData(MT.Sugar, U2), OP.treeSapling);
        IL.CANDY_Sapling_White
            .set(ST.make(MD.CANDY, "B7", 1, 2), new OreDictItemData(MT.Chocolate, U2), OP.treeSapling);
        IL.CANDY_Sapling_Cherry.set(ST.make(MD.CANDY, "B7", 1, 3), null, OP.treeSapling);
        IL.CANDY_Leaves_Chocolate
            .set(ST.make(MD.CANDY, "B6", 1, 0), new OreDictItemData(MT.Chocolate, U2), OP.treeLeaves);
        ...
        IL.CANDY_Plank
            .set(ST.make(MD.CANDY, "B3", 1, 0), new OreDictItemData(MT.Marshmallow, U), OP.plank.dat(MT.Marshmallow));
        IL.CANDY_Plank_Dark
            .set(ST.make(MD.CANDY, "B3", 1, 1), new OreDictItemData(MT.Marshmallow, U), OP.plank.dat(MT.Marshmallow));
        IL.CANDY_Plank_Light
            .set(ST.make(MD.CANDY, "B3", 1, 2), new OreDictItemData(MT.Marshmallow, U), OP.plank.dat(MT.Marshmallow));
        ...
        IL.ERE_Bambucket_Water.set(
            ST.make(MD.ERE, "bambucketWater", 1, 0),
            new OreDictItemData(MT.Bamboo, 3 * U4),
            OD.container1000water);
        IL.ERE_Bambucket_Milk
            .set(ST.make(MD.ERE, "bambucketMilk", 1, 0), new OreDictItemData(MT.Bamboo, 3 * U4), OD.container1000milk);
        IL.ERE_Bambucket_Honey.set(
            ST.make(MD.ERE, "bambucketHoney", 1, 0),
            new OreDictItemData(MT.Bamboo, 3 * U4),
            OD.container1000honey);
        IL.ERE_Bambucket_AntiVenom
            .set(ST.make(MD.ERE, "bambucketAntiVenom", 1, 0), new OreDictItemData(MT.Bamboo, 3 * U4));
        IL.ERE_Bambucket_FormicAcid
            .set(ST.make(MD.ERE, "bambucketFormicAcid", 1, 0), new OreDictItemData(MT.Bamboo, 3 * U4));
        IL.ERE_Bambucket_BeetleJuice.set(
            ST.make(MD.ERE, "bambucketBeetleJuice", 1, 0),
            new OreDictItemData(MT.Bamboo, 3 * U4),
            OD.container1000juice);
        ...
        IL.BTL_Chest
            .set(ST.make(MD.BTL, "weedwoodChest", 1, 0), new OreDictItemData(MT.Weedwood, 8 * U), OD.craftingChest);
        ...
        IL.BTL_Weedwood_Planks
            .set(ST.make(MD.BTL, "weedwoodPlanks", 1, 0), new OreDictItemData(MT.Weedwood, U), OD.plankWeedwood);
        IL.BTL_Weedwood_Beam
            .set(ST.make(MD.BTL, "weedwood", 1, 0), new OreDictItemData(MT.Weedwood, U * 8), OD.beamWood);
        IL.BTL_Weedwood_Log
            .set(ST.make(MD.BTL, "weedwoodLog", 1, 0), new OreDictItemData(MT.Weedwood, U * 8, MT.Bark, U));
        OM.reg(IL.BTL_Weedwood_Log.wild(1), OD.logWood);
        ...
        IL.BTL_Tar
            .set(ST.make(MD.BTL, "unknownGeneric", 1, 29), null, OD.itemTar, DYE_OREDICTS_MIXABLE[DYE_INDEX_Black]);
        IL.BTL_Tar_Block
            .set(ST.make(MD.BTL, "solidTar", 1, 0), null, OD.itemTar, DYE_OREDICTS_MIXABLE[DYE_INDEX_Black]);
        IL.BTL_Bucket_Empty.set(ST.make(MD.BTL, "weedwoodBucket", 1, 0), new OreDictItemData(MT.Weedwood, 3 * U));
        IL.BTL_Bucket_Tar.set(
            ST.make(MD.BTL, "weedwoodBucketTar", 1, 0),
            new OreDictItemData(MT.Weedwood, 3 * U),
            OD.container1000tar);
        IL.BTL_Bucket_Swamp.set(ST.make(MD.BTL, "weedwoodBucketWater", 1, 0), new OreDictItemData(MT.Weedwood, 3 * U));
        IL.BTL_Bucket_Stagnant
            .set(ST.make(MD.BTL, "weedwoodBucketStagnantWater", 1, 0), new OreDictItemData(MT.Weedwood, 3 * U));
        IL.BTL_Bucket_Latex.set(
            ST.make(MD.BTL, "bucketOfRubber", 1, 0),
            new OreDictItemData(MT.Weedwood, 3 * U),
            OD.container1000latex);
        IL.BTL_Bucket_Infusion
            .set(ST.make(MD.BTL, "weedwoodBucketInfusion", 1, 0), new OreDictItemData(MT.Weedwood, 3 * U));

        if (IL.BTL_Bucket_Tar.exists()) IL.BTL_Bucket_Tar.item()
            .setContainerItem(IL.BTL_Bucket_Empty.getItem());
        if (IL.BTL_Bucket_Swamp.exists()) IL.BTL_Bucket_Swamp.item()
            .setContainerItem(IL.BTL_Bucket_Empty.getItem());
        if (IL.BTL_Bucket_Stagnant.exists()) IL.BTL_Bucket_Stagnant.item()
            .setContainerItem(IL.BTL_Bucket_Empty.getItem());
        if (IL.BTL_Bucket_Latex.exists()) IL.BTL_Bucket_Latex.item()
            .setContainerItem(IL.BTL_Bucket_Empty.getItem());
        if (IL.BTL_Bucket_Infusion.exists()) IL.BTL_Bucket_Infusion.item()
            .setContainerItem(IL.BTL_Bucket_Empty.getItem());

        if (!MD.AETHEL.mLoaded) {
            IL.AETHER_Chest.set(
                ST.make(MD.AETHER, "skyrootChest", 1, 0),
                new OreDictItemData(MT.Skyroot, 8 * U),
                OD.craftingChest);
            IL.AETHER_Skyroot_Planks
                .set(ST.make(MD.AETHER, "skyrootPlank", 1, 0), new OreDictItemData(MT.Skyroot, U), OD.plankSkyroot);
            IL.AETHER_Skyroot_Log
                .set(ST.make(MD.AETHER, "aetherLog", 1, 0), new OreDictItemData(MT.Skyroot, U * 8, MT.Bark, U));
            IL.AETHER_Skyroot_Log_Gold
                .set(ST.make(MD.AETHER, "aetherLog", 1, 2), new OreDictItemData(MT.Skyroot, U * 8, MT.AmberGolden, U));
            OM.reg(IL.AETHER_Skyroot_Log.wild(1), OD.logWood);
            IL.AETHER_Skyroot_Log_Small
                .set(ST.make(MD.AETHER, "skyrootLogWall", 1, 0), new OreDictItemData(MT.Skyroot, U * 8, MT.Bark, U));
            OM.reg(IL.AETHER_Skyroot_Log_Small.wild(1), OD.logWood);
            IL.AETHER_Bowl.set(ST.make(MD.AETHER, "shoyrootBowl", 1, 0), new OreDictItemData(MT.Skyroot, U));
            IL.AETHER_Bucket_Empty
                .set(ST.make(MD.AETHER, "skyrootBucket", 1, 0), new OreDictItemData(MT.Skyroot, U * 3));
            IL.AETHER_Bucket_Water.set(
                ST.make(MD.AETHER, "skyrootWaterBucket", 1, 0),
                new OreDictItemData(MT.Skyroot, U * 3),
                OD.container1000water);
            IL.AETHER_Bucket_Poison.set(
                ST.make(MD.AETHER, "skyrootPoisonBucket", 1, 0),
                new OreDictItemData(MT.Skyroot, U * 3),
                OD.container1000poison);
            IL.AETHER_Bucket_Milk.set(
                ST.make(MD.AETHER, "skyrootMilkBucket", 1, 0),
                new OreDictItemData(MT.Skyroot, U * 3),
                OD.container1000milk);
            IL.AETHER_Torch_Ambrosium.set(
                ST.make(MD.AETHER, "ambrosiumTorch", 1, 0),
                new OreDictItemData(MT.Ambrosium, U8, MT.Skyroot, U16),
                OD.blockTorch);
            ...
            IL.AETHER_Skyroot_Sapling_Dark
                .set(ST.make(MD.AETHER, "darkBlueSkyrootSapling", 1, 0), null, OP.treeSapling);
            IL.AETHER_Skyroot_Sapling_Purple
                .set(ST.make(MD.AETHER, "purpleCrystalSapling", 1, 0), null, OP.treeSapling);
            ...
            if (IL.AETHER_Bucket_Water.exists()) IL.AETHER_Bucket_Water.item()
                .setContainerItem(IL.AETHER_Bucket_Empty.getItem());
            if (IL.AETHER_Bucket_Poison.exists()) IL.AETHER_Bucket_Poison.item()
                .setContainerItem(IL.AETHER_Bucket_Empty.getItem());
            if (IL.AETHER_Bucket_Milk.exists()) IL.AETHER_Bucket_Milk.item()
                .setContainerItem(IL.AETHER_Bucket_Empty.getItem());

            if (IL.AETHER_Dirt.exists())
                Textures.BlockIcons.DIRTS[1] = new IconContainerCopied(IL.AETHER_Dirt.block(), 0, SIDE_BOTTOM);
        }

        IL.GrC_Honey_Jar.set(ST.make(MD.GrC_Bees, "grc.honeyJar", 1, 0), null, OD.container1000honey, CR.DELATE);
        if (IL.GrC_Honey_Jar.exists()) IL.GrC_Honey_Jar.item()
            .setContainerItem(Items.flower_pot);

        IL.GrC_Honey_Bucket.set(
            ST.make(MD.GrC_Bees, "grc.BucketFluidHoney", 1, 0),
            new OreDictItemData(ANY.Fe, U * 3),
            OD.container1000honey,
            CR.DELATE);
        IL.GrC_Honey_Bottle
            .set(ST.make(MD.GrC_Bees, "grc.BottleFluidHoney", 1, 0), null, OD.container250honey, CR.DELATE);
        IL.GrC_Milk_Bucket.set(
            ST.make(MD.GrC_Milk, "grcmilk.BucketFluidMilk", 1, 0),
            new OreDictItemData(ANY.Fe, U * 3),
            OD.container1000milk,
            CR.DELATE);
        IL.GrC_Milk_Bottle
            .set(ST.make(MD.GrC_Milk, "grcmilk.BottleFluidMilk", 1, 0), null, OD.container250milk, CR.DELATE);
        ...
        IL.GrC_Bamboo_Charcoal
            .set(ST.make(MD.GrC_Bamboo, "grc.bambooCoal", 1, 0), new OreDictItemData(MT.Charcoal, U2));
        ...
        IL.GrC_Ice_Cream_Chocolate
            .set(ST.make(MD.GrC_Milk, "grcmilk.IceCream", 1, 1), null, CR.DELATE, "foodChocolateicecream");
        IL.GrC_Ice_Cream_Grape
            .set(ST.make(MD.GrC_Milk, "grcmilk.IceCream", 1, 2), null, CR.DELATE, "foodGrapeicecream");
        IL.GrC_Ice_Cream_Apple
            .set(ST.make(MD.GrC_Milk, "grcmilk.IceCream", 1, 3), null, CR.DELATE, "foodAppleicecream");
        IL.GrC_Ice_Cream_Honey
            .set(ST.make(MD.GrC_Milk, "grcmilk.IceCream", 1, 4), null, CR.DELATE, "foodHoneyicecream");
        IL.GrC_Ice_Cream_Melon
            .set(ST.make(MD.GrC_Milk, "grcmilk.IceCream", 1, 5), null, CR.DELATE, "foodMelonicecream");
        ...
        IL.MoCr_Crab_Cooked
            .set(ST.make(MD.MoCr, "crabcooked", 1, 0), new OreDictItemData(MT.FishCooked, 3 * U2), "foodCrabcooked");
        IL.MoCr_Turkey_Raw.set(
            ST.make(MD.MoCr, "turkeyraw", 1, 0),
            new OreDictItemData(MT.MeatRaw, U * 3, MT.Bone, U4),
            "foodTurkeyraw");
        IL.MoCr_Turkey_Cooked.set(
            ST.make(MD.MoCr, "turkeycooked", 1, 0),
            new OreDictItemData(MT.MeatCooked, U * 3, MT.Bone, U4),
            "foodTurkeycooked");
        IL.MoCr_Rat_Raw
            .set(ST.make(MD.MoCr, "ratraw", 1, 0), new OreDictItemData(MT.MeatRaw, U * 1, MT.Bone, U9), "foodRatraw");
        IL.MoCr_Rat_Cooked.set(
            ST.make(MD.MoCr, "ratcooked", 1, 0),
            new OreDictItemData(MT.MeatCooked, U * 1, MT.Bone, U9),
            "foodRatcooked");
        IL.MoCr_Ostrich_Raw.set(
            ST.make(MD.MoCr, "ostrichraw", 1, 0),
            new OreDictItemData(MT.MeatRaw, U * 2, MT.Bone, U4),
            "foodOstrichraw");
        IL.MoCr_Ostrich_Cooked.set(
            ST.make(MD.MoCr, "ostrichcooked", 1, 0),
            new OreDictItemData(MT.MeatCooked, U * 2, MT.Bone, U4),
            "foodOstrichcooked");
        IL.MoCr_Turtle_Raw.set(
            ST.make(MD.MoCr, "turtleraw", 1, 0),
            new OreDictItemData(MT.MeatRaw, U * 2, MT.Bone, U9),
            "foodTurtleraw");

        IL.WiMo_Infected_Meat
            .set(ST.make(MD.WiMo, "infected_flesh", 1, 0), new OreDictItemData(MT.MeatRotten, U * 2, MT.Bone, U9));
        ...
        IL.MaCu_Polished_Logs
            .set(ST.make(MD.MaCu, "woods", 1, 2), new OreDictItemData(MT.WoodPolished, U * 8, MT.Bark, U), CR.DELATE);
        ...
        IL.NePl_Obsidian
            .set(ST.make(MD.NePl, "CryingObsidian", 1, 0), new OreDictItemData(MT.Obsidian, U * 9), OD.cryingObsidian);
        IL.NePl_Quartz_Bricks.set(ST.make(MD.NePl, "QuartzBricks", 1, 0), new OreDictItemData(MT.NetherQuartz, U * 4));
        IL.NePl_Blackstone.set(
            ST.make(MD.NePl, "Blackstone", 1, 0),
            OP.stone.dat(MT.STONES.Blackstone),
            OP.stoneCobble,
            OP.cobblestone);
        IL.NePl_Blackstone_Polished
            .set(ST.make(MD.NePl, "PolishedBlackstone", 1, 0), OP.stone.dat(MT.STONES.Blackstone), OP.stonePolished);
        IL.NePl_Blackstone_Chiseled.set(
            ST.make(MD.NePl, "ChiseledPolishedBlackstone", 1, 0),
            OP.stone.dat(MT.STONES.Blackstone),
            OP.stoneChiseled);
        IL.NePl_Blackstone_Bricks.set(
            ST.make(MD.NePl, "PolishedBlackstoneBricks", 1, 0),
            OP.stone.dat(MT.STONES.Blackstone),
            OP.stoneBricks);
        IL.NePl_Blackstone_Cracked.set(
            ST.make(MD.NePl, "CrackedPolishedBlackstoneBricks", 1, 0),
            OP.stone.dat(MT.STONES.Blackstone),
            OP.stoneBricks,
            OP.stoneCracked);
        ...
        IL.Crop_AbyssalOats
            .set(ST.make(MD.NeLi, "AbyssalOatItem", 1, 0), new OreDictItemData(MT.OatAbyssal, U), "cropAbyssalOats");
        IL.NeLi_Obsidian
            .set(ST.make(MD.NeLi, "CryingObsidian", 1, 0), new OreDictItemData(MT.Obsidian, U * 9), OD.cryingObsidian);
        ...
        IL.NeLi_Quartz_Chiseled_Pillar
            .set(ST.make(MD.NeLi, "QuartzPillar", 1, 0), new OreDictItemData(MT.NetherQuartz, U * 4));
        ...
        IL.NeLi_Void_Chiseled_Pillar
            .set(ST.make(MD.NeLi, "QuartzPillar", 1, 2), new OreDictItemData(MT.VoidQuartz, U * 4));
        IL.NeLi_Crystal_White
            .set(ST.make(MD.NeLi, "NetherCrystal", 1, 0), new OreDictItemData(MT.FluoriteWhite, U * 4));
        IL.NeLi_Crystal_Blue.set(ST.make(MD.NeLi, "NetherCrystal", 1, 1), new OreDictItemData(MT.FluoriteBlue, U * 4));
        IL.NeLi_Crystal_Green
            .set(ST.make(MD.NeLi, "NetherCrystal", 1, 2), new OreDictItemData(MT.FluoriteGreen, U * 4));
        IL.NeLi_Crystal_Yellow
            .set(ST.make(MD.NeLi, "NetherCrystal", 1, 3), new OreDictItemData(MT.FluoriteYellow, U * 4));
        IL.NeLi_Crystal_Magenta
            .set(ST.make(MD.NeLi, "NetherCrystal", 1, 4), new OreDictItemData(MT.FluoriteMagenta, U * 4));
        IL.NeLi_Budding_White
            .set(ST.make(MD.NeLi, "NetherCrystal", 1, 5), new OreDictItemData(MT.FluoriteWhite, U * 4));
        IL.NeLi_Budding_Blue.set(ST.make(MD.NeLi, "NetherCrystal", 1, 6), new OreDictItemData(MT.FluoriteBlue, U * 4));
        IL.NeLi_Budding_Green
            .set(ST.make(MD.NeLi, "NetherCrystal", 1, 7), new OreDictItemData(MT.FluoriteGreen, U * 4));
        IL.NeLi_Budding_Yellow
            .set(ST.make(MD.NeLi, "NetherCrystal", 1, 8), new OreDictItemData(MT.FluoriteYellow, U * 4));
        IL.NeLi_Budding_Magenta
            .set(ST.make(MD.NeLi, "NetherCrystal", 1, 9), new OreDictItemData(MT.FluoriteMagenta, U * 4));
        IL.NeLi_Cluster_White
            .set(ST.make(MD.NeLi, "CrystalClusterWhite", 1, 0), new OreDictItemData(MT.FluoriteWhite, U));
        IL.NeLi_Cluster_Blue.set(ST.make(MD.NeLi, "CrystalClusterBlue", 1, 0), new OreDictItemData(MT.FluoriteBlue, U));
        IL.NeLi_Cluster_Green
            .set(ST.make(MD.NeLi, "CrystalClusterGreen", 1, 0), new OreDictItemData(MT.FluoriteGreen, U));
        IL.NeLi_Cluster_Yellow
            .set(ST.make(MD.NeLi, "CrystalClusterYellow", 1, 0), new OreDictItemData(MT.FluoriteYellow, U));
        IL.NeLi_Cluster_Magenta
            .set(ST.make(MD.NeLi, "CrystalClusterMagenta", 1, 0), new OreDictItemData(MT.FluoriteMagenta, U));
        IL.NeLi_Clu2ter_White
            .set(ST.make(MD.NeLi, "CrystalClusterWhite", 1, 1), new OreDictItemData(MT.FluoriteWhite, U * 3));
        IL.NeLi_Clu2ter_Blue
            .set(ST.make(MD.NeLi, "CrystalClusterBlue", 1, 1), new OreDictItemData(MT.FluoriteBlue, U * 3));
        IL.NeLi_Clu2ter_Green
            .set(ST.make(MD.NeLi, "CrystalClusterGreen", 1, 1), new OreDictItemData(MT.FluoriteGreen, U * 3));
        IL.NeLi_Clu2ter_Yellow
            .set(ST.make(MD.NeLi, "CrystalClusterYellow", 1, 1), new OreDictItemData(MT.FluoriteYellow, U * 3));
        IL.NeLi_Clu2ter_Magenta
            .set(ST.make(MD.NeLi, "CrystalClusterMagenta", 1, 1), new OreDictItemData(MT.FluoriteMagenta, U * 3));
        IL.NeLi_Lamp_White.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 0),
            new OreDictItemData(MT.FluoriteWhite, U * 4, ANY.Glowstone, U * 4),
            CR.DELATE);
        IL.NeLi_Lamp_Blue.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 1),
            new OreDictItemData(MT.FluoriteBlue, U * 4, ANY.Glowstone, U * 4),
            CR.DELATE);
        IL.NeLi_Lamp_Green.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 2),
            new OreDictItemData(MT.FluoriteGreen, U * 4, ANY.Glowstone, U * 4),
            CR.DELATE);
        IL.NeLi_Lamp_Yellow.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 3),
            new OreDictItemData(MT.FluoriteYellow, U * 4, ANY.Glowstone, U * 4),
            CR.DELATE);
        IL.NeLi_Lamp_Magenta.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 4),
            new OreDictItemData(MT.FluoriteMagenta, U * 4, ANY.Glowstone, U * 4),
            CR.DELATE);
        IL.NeLi_Redstone_Lamp_White.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 5),
            new OreDictItemData(MT.FluoriteWhite, U * 4, ANY.Glowstone, U * 4, MT.Redstone, U * 4),
            CR.DELATE);
        IL.NeLi_Redstone_Lamp_Blue.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 6),
            new OreDictItemData(MT.FluoriteBlue, U * 4, ANY.Glowstone, U * 4, MT.Redstone, U * 4),
            CR.DELATE);
        IL.NeLi_Redstone_Lamp_Green.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 7),
            new OreDictItemData(MT.FluoriteGreen, U * 4, ANY.Glowstone, U * 4, MT.Redstone, U * 4),
            CR.DELATE);
        IL.NeLi_Redstone_Lamp_Yellow.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 8),
            new OreDictItemData(MT.FluoriteYellow, U * 4, ANY.Glowstone, U * 4, MT.Redstone, U * 4),
            CR.DELATE);
        IL.NeLi_Redstone_Lamp_Magenta.set(
            ST.make(MD.NeLi, "CrystalLamp", 1, 9),
            new OreDictItemData(MT.FluoriteMagenta, U * 4, ANY.Glowstone, U * 4, MT.Redstone, U * 4),
            CR.DELATE);
        IL.NeLi_Glass_White.set(
            ST.make(MD.NeLi, "TintedGlass", 1, 0),
            new OreDictItemData(MT.FluoriteWhite, U * 4, MT.Glass, U * 9),
            CR.DELATE);
        IL.NeLi_Glass_Blue.set(
            ST.make(MD.NeLi, "TintedGlass", 1, 1),
            new OreDictItemData(MT.FluoriteBlue, U * 4, MT.Glass, U * 9),
            CR.DELATE);
        IL.NeLi_Glass_Green.set(
            ST.make(MD.NeLi, "TintedGlass", 1, 2),
            new OreDictItemData(MT.FluoriteGreen, U * 4, MT.Glass, U * 9),
            CR.DELATE);
        IL.NeLi_Glass_Yellow.set(
            ST.make(MD.NeLi, "TintedGlass", 1, 3),
            new OreDictItemData(MT.FluoriteYellow, U * 4, MT.Glass, U * 9),
            CR.DELATE);
        IL.NeLi_Glass_Magenta.set(
            ST.make(MD.NeLi, "TintedGlass", 1, 4),
            new OreDictItemData(MT.FluoriteMagenta, U * 4, MT.Glass, U * 9),
            CR.DELATE);
        IL.NeLi_Magmatic_Netherrack.set(ST.make(MD.NeLi, "MagmaBlock", 1, 1), new OreDictItemData(MT.Netherrack, U));
        IL.NeLi_Magmatic_Blackstone
            .set(ST.make(MD.NeLi, "MagmaBlock", 1, 0), new OreDictItemData(MT.STONES.Blackstone, U * 9));
        IL.NeLi_Blackstone_Crying
            .set(ST.make(MD.NeLi, "CryingBlackstone", 1, 0), new OreDictItemData(MT.STONES.Blackstone, U * 9));
        IL.NeLi_Blackstone.set(
            ST.make(MD.NeLi, "Blackstone", 1, 0),
            OP.stone.dat(MT.STONES.Blackstone),
            OP.stoneCobble,
            OP.cobblestone);
        IL.NeLi_Blackstone_Polished
            .set(ST.make(MD.NeLi, "Blackstone", 1, 1), OP.stone.dat(MT.STONES.Blackstone), OP.stonePolished);
        IL.NeLi_Blackstone_Chiseled
            .set(ST.make(MD.NeLi, "Blackstone", 1, 2), OP.stone.dat(MT.STONES.Blackstone), OP.stoneChiseled);
        IL.NeLi_Blackstone_Bricks
            .set(ST.make(MD.NeLi, "Blackstone", 1, 3), OP.stone.dat(MT.STONES.Blackstone), OP.stoneBricks);
        IL.NeLi_Blackstone_Cracked.set(
            ST.make(MD.NeLi, "Blackstone", 1, 4),
            OP.stone.dat(MT.STONES.Blackstone),
            OP.stoneBricks,
            OP.stoneCracked);
        ...
        IL.NeLi_Strider_Flank_Raw.set(
            ST.make(MD.NeLi, "StriderFlankRaw", 1, 0),
            new OreDictItemData(MT.MeatRaw, U * 2, MT.Bone, U9),
            "listAllmeatraw");
        IL.NeLi_Strider_Flank_Cooked.set(
            ST.make(MD.NeLi, "StriderFlankCooked", 1, 0),
            new OreDictItemData(MT.MeatCooked, U * 2, MT.Bone, U9),
            "listAllmeatcooked");
        ...
        IL.NeLi_Bottle_Hellderberryjuice.set(
            ST.make(MD.NeLi, "JuiceHellderberry", 1, 0),
            null,
            CR.DELATE,
            "foodHellderberryjuice",
            OD.container250juice);
        IL.NeLi_Bucket_Spectral_Dew
            .set(ST.make(MD.NeLi, "SpectralBucket", 1, 0), new OreDictItemData(ANY.Fe, U * 3), OD.container1000water);
        ...
        IL.NeLi_Gloomstone
            .set(ST.make(MD.NeLi, "Gloomstone", 1, 0), new OreDictItemData(MT.Gloomstone, U * 4), OD.glowstone);
        ...
        if (IL.NeLi_Gloomstone.exists())
            MT.Gloomstone.mTextureSolid = MT.Gloomstone.mTextureGem = MT.Gloomstone.mTextureMolten = BlockTextureCopied
                .get(IL.NeLi_Gloomstone.block(), 0);
        ...
        if (IL.NeLi_Bowl_DevilishMaize.exists()) IL.NeLi_Bowl_DevilishMaize.item()
            .setContainerItem(Items.bowl);
        if (IL.NeLi_Bowl_DevilishPopcorn.exists()) IL.NeLi_Bowl_DevilishPopcorn.item()
            .setContainerItem(Items.bowl);
        if (IL.NeLi_Bowl_CrimsonStew.exists()) IL.NeLi_Bowl_CrimsonStew.item()
            .setContainerItem(Items.bowl);
        if (IL.NeLi_Bowl_WarpedStew.exists()) IL.NeLi_Bowl_WarpedStew.item()
            .setContainerItem(Items.bowl);
        if (IL.NeLi_Bowl_FoxfireStew.exists()) IL.NeLi_Bowl_FoxfireStew.item()
            .setContainerItem(Items.bowl);
        // if (IL.NeLi_Bucket_Spectral_Dew .exists()) IL.NeLi_Bucket_Spectral_Dew
        // .item().setContainerItem(Items.bucket); Should be fixed on the Netherlicious Side now. ^^
        if (IL.NeLi_Bottle_Hellderberryjuice.exists()) IL.NeLi_Bottle_Hellderberryjuice.item()
            .setContainerItem(Items.glass_bottle);
        ...
        IL.EtFu_Bark_Oak
            .set(ST.make(MD.EtFu, "bark", 1, 0), new OreDictItemData(MT.WOODS.Oak, U * 8, MT.Bark, U), OD.logWood);
        IL.EtFu_Bark_Spruce
            .set(ST.make(MD.EtFu, "bark", 1, 1), new OreDictItemData(MT.WOODS.Spruce, U * 8, MT.Bark, U), OD.logWood);
        IL.EtFu_Bark_Birch
            .set(ST.make(MD.EtFu, "bark", 1, 2), new OreDictItemData(MT.WOODS.Birch, U * 8, MT.Bark, U), OD.logWood);
        IL.EtFu_Bark_Jungle
            .set(ST.make(MD.EtFu, "bark", 1, 3), new OreDictItemData(MT.WOODS.Jungle, U * 8, MT.Bark, U), OD.logWood);
        IL.EtFu_Bark_Acacia
            .set(ST.make(MD.EtFu, "bark2", 1, 0), new OreDictItemData(MT.WOODS.Acacia, U * 8, MT.Bark, U), OD.logWood);
        IL.EtFu_Bark_DarkOak
            .set(ST.make(MD.EtFu, "bark2", 1, 1), new OreDictItemData(MT.WOODS.DarkOak, U * 8, MT.Bark, U), OD.logWood);
        IL.EtFu_Beam1_Oak
            .set(ST.make(MD.EtFu, "log_stripped", 1, 0), new OreDictItemData(MT.WOODS.Oak, U * 8), OD.beamWood);
        IL.EtFu_Beam1_Spruce
            .set(ST.make(MD.EtFu, "log_stripped", 1, 1), new OreDictItemData(MT.WOODS.Spruce, U * 8), OD.beamWood);
        IL.EtFu_Beam1_Birch
            .set(ST.make(MD.EtFu, "log_stripped", 1, 2), new OreDictItemData(MT.WOODS.Birch, U * 8), OD.beamWood);
        IL.EtFu_Beam1_Jungle
            .set(ST.make(MD.EtFu, "log_stripped", 1, 3), new OreDictItemData(MT.WOODS.Jungle, U * 8), OD.beamWood);
        IL.EtFu_Beam1_Acacia
            .set(ST.make(MD.EtFu, "log2_stripped", 1, 0), new OreDictItemData(MT.WOODS.Acacia, U * 8), OD.beamWood);
        IL.EtFu_Beam1_DarkOak
            .set(ST.make(MD.EtFu, "log2_stripped", 1, 1), new OreDictItemData(MT.WOODS.DarkOak, U * 8), OD.beamWood);
        IL.EtFu_Beam2_Oak
            .set(ST.make(MD.EtFu, "wood_stripped", 1, 0), new OreDictItemData(MT.WOODS.Oak, U * 8), OD.beamWood);
        IL.EtFu_Beam2_Spruce
            .set(ST.make(MD.EtFu, "wood_stripped", 1, 1), new OreDictItemData(MT.WOODS.Spruce, U * 8), OD.beamWood);
        IL.EtFu_Beam2_Birch
            .set(ST.make(MD.EtFu, "wood_stripped", 1, 2), new OreDictItemData(MT.WOODS.Birch, U * 8), OD.beamWood);
        IL.EtFu_Beam2_Jungle
            .set(ST.make(MD.EtFu, "wood_stripped", 1, 3), new OreDictItemData(MT.WOODS.Jungle, U * 8), OD.beamWood);
        IL.EtFu_Beam2_Acacia
            .set(ST.make(MD.EtFu, "wood2_stripped", 1, 0), new OreDictItemData(MT.WOODS.Acacia, U * 8), OD.beamWood);
        IL.EtFu_Beam2_DarkOak
            .set(ST.make(MD.EtFu, "wood2_stripped", 1, 1), new OreDictItemData(MT.WOODS.DarkOak, U * 8), OD.beamWood);
        ...
        IL.EtFu_Obsidian.set(
            ST.make(MD.EtFu, "crying_obsidian", 1, 0),
            new OreDictItemData(MT.Obsidian, U * 9, MT.Lapis, U),
            OD.cryingObsidian);
        ...
        IL.EtFu_Basalt.set(
            ST.make(MD.EtFu, "smooth_basalt", 1, 0),
            new OreDictItemData(MT.STONES.Basalt, U * 9),
            OP.stone.dat(MT.STONES.Basalt));
        IL.EtFu_Calcite
            .set(ST.make(MD.EtFu, "calcite", 1, 0), new OreDictItemData(MT.CaCO3, U * 9), OP.stone.dat(MT.CaCO3));
        IL.EtFu_Tuff.set(ST.make(MD.EtFu, "tuff", 1, 0), new OreDictItemData(MT.Stone, U * 9), OP.stone.dat(MT.Stone));
        IL.EtFu_Deepslate.set(
            ST.make(MD.EtFu, "deepslate", 1, 0),
            new OreDictItemData(MT.STONES.Deepslate, U * 9),
            OP.stone.dat(MT.STONES.Deepslate));
        IL.EtFu_Deepslate_Cobble.set(
            ST.make(MD.EtFu, "cobbled_deepslate", 1, 0),
            new OreDictItemData(MT.STONES.Deepslate, U * 9),
            OP.stone.dat(MT.STONES.Deepslate));
        IL.EtFu_Deepslate_Smooth.set(
            ST.make(MD.EtFu, "polished_deepslate", 1, 0),
            new OreDictItemData(MT.STONES.Deepslate, U * 9),
            OP.stone.dat(MT.STONES.Deepslate));
        IL.EtFu_Granite.set(
            ST.make(MD.EtFu, "stone", 1, 1),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite),
            CR.DELATE);
        IL.EtFu_Granite_Smooth.set(
            ST.make(MD.EtFu, "stone", 1, 2),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite),
            CR.DELATE);
        IL.EtFu_Diorite.set(
            ST.make(MD.EtFu, "stone", 1, 3),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite),
            CR.DELATE);
        IL.EtFu_Diorite_Smooth.set(
            ST.make(MD.EtFu, "stone", 1, 4),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite),
            CR.DELATE);
        IL.EtFu_Andesite.set(
            ST.make(MD.EtFu, "stone", 1, 5),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite),
            CR.DELATE);
        IL.EtFu_Andesite_Smooth.set(
            ST.make(MD.EtFu, "stone", 1, 6),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite),
            CR.DELATE);
        ...
        IL.EtFu_Block_Copper_Exposed_Waxed
            .set(ST.make(MD.EtFu, "copper_block", 1, 9), new OreDictItemData(ANY.Cu, U * 9));
        IL.EtFu_Block_Copper_Weathered_Waxed
            .set(ST.make(MD.EtFu, "copper_block", 1, 10), new OreDictItemData(ANY.Cu, U * 9));
        IL.EtFu_Block_Copper_Oxidized_Waxed
            .set(ST.make(MD.EtFu, "copper_block", 1, 11), new OreDictItemData(ANY.Cu, U * 9));
        IL.EtFu_Block_Copper_Cut.set(ST.make(MD.EtFu, "copper_block", 1, 4), new OreDictItemData(ANY.Cu, U * 4));
        IL.EtFu_Block_Copper_Cut_Exposed
            .set(ST.make(MD.EtFu, "copper_block", 1, 5), new OreDictItemData(ANY.Cu, U * 4));
        IL.EtFu_Block_Copper_Cut_Weathered
            .set(ST.make(MD.EtFu, "copper_block", 1, 6), new OreDictItemData(ANY.Cu, U * 4));
        IL.EtFu_Block_Copper_Cut_Oxidized
            .set(ST.make(MD.EtFu, "copper_block", 1, 7), new OreDictItemData(ANY.Cu, U * 4));
        IL.EtFu_Block_Copper_Cut_Waxed.set(ST.make(MD.EtFu, "copper_block", 1, 12), new OreDictItemData(ANY.Cu, U * 4));
        IL.EtFu_Block_Copper_Cut_Exposed_Waxed
            .set(ST.make(MD.EtFu, "copper_block", 1, 13), new OreDictItemData(ANY.Cu, U * 4));
        IL.EtFu_Block_Copper_Cut_Weathered_Waxed
            .set(ST.make(MD.EtFu, "copper_block", 1, 14), new OreDictItemData(ANY.Cu, U * 4));
        IL.EtFu_Block_Copper_Cut_Oxidized_Waxed
            .set(ST.make(MD.EtFu, "copper_block", 1, 15), new OreDictItemData(ANY.Cu, U * 4));
        IL.EtFu_Slabs_Copper_Cut.set(ST.make(MD.EtFu, "cut_copper_slab", 1, 0), new OreDictItemData(ANY.Cu, U * 2));
        IL.EtFu_Slabs_Copper_Cut_Exposed
            .set(ST.make(MD.EtFu, "cut_copper_slab", 1, 1), new OreDictItemData(ANY.Cu, U * 2));
        IL.EtFu_Slabs_Copper_Cut_Weathered
            .set(ST.make(MD.EtFu, "cut_copper_slab", 1, 2), new OreDictItemData(ANY.Cu, U * 2));
        IL.EtFu_Slabs_Copper_Cut_Oxidized
            .set(ST.make(MD.EtFu, "cut_copper_slab", 1, 3), new OreDictItemData(ANY.Cu, U * 2));
        IL.EtFu_Slabs_Copper_Cut_Waxed
            .set(ST.make(MD.EtFu, "cut_copper_slab", 1, 4), new OreDictItemData(ANY.Cu, U * 2));
        IL.EtFu_Slabs_Copper_Cut_Exposed_Waxed
            .set(ST.make(MD.EtFu, "cut_copper_slab", 1, 5), new OreDictItemData(ANY.Cu, U * 2));
        IL.EtFu_Slabs_Copper_Cut_Weathered_Waxed
            .set(ST.make(MD.EtFu, "cut_copper_slab", 1, 6), new OreDictItemData(ANY.Cu, U * 2));
        IL.EtFu_Slabs_Copper_Cut_Oxidized_Waxed
            .set(ST.make(MD.EtFu, "cut_copper_slab", 1, 7), new OreDictItemData(ANY.Cu, U * 2));
        IL.EtFu_Stair_Copper_Cut.set(ST.make(MD.EtFu, "cut_copper_stairs", 1, 0), new OreDictItemData(ANY.Cu, U * 3));
        IL.EtFu_Stair_Copper_Cut_Exposed
            .set(ST.make(MD.EtFu, "exposed_cut_copper_stairs", 1, 0), new OreDictItemData(ANY.Cu, U * 3));
        IL.EtFu_Stair_Copper_Cut_Weathered
            .set(ST.make(MD.EtFu, "weathered_cut_copper_stairs", 1, 0), new OreDictItemData(ANY.Cu, U * 3));
        IL.EtFu_Stair_Copper_Cut_Oxidized
            .set(ST.make(MD.EtFu, "oxidized_cut_copper_stairs", 1, 0), new OreDictItemData(ANY.Cu, U * 3));
        IL.EtFu_Stair_Copper_Cut_Waxed
            .set(ST.make(MD.EtFu, "waxed_cut_copper_stairs", 1, 0), new OreDictItemData(ANY.Cu, U * 3));
        IL.EtFu_Stair_Copper_Cut_Exposed_Waxed
            .set(ST.make(MD.EtFu, "waxed_exposed_cut_copper_stairs", 1, 0), new OreDictItemData(ANY.Cu, U * 3));
        IL.EtFu_Stair_Copper_Cut_Weathered_Waxed
            .set(ST.make(MD.EtFu, "waxed_weathered_cut_copper_stairs", 1, 0), new OreDictItemData(ANY.Cu, U * 3));
        IL.EtFu_Stair_Copper_Cut_Oxidized_Waxed
            .set(ST.make(MD.EtFu, "waxed_oxidized_cut_copper_stairs", 1, 0), new OreDictItemData(ANY.Cu, U * 3));
        ...
        if (IL.EtFu_Lingering_Potion.exists()) IL.EtFu_Lingering_Potion.item()
            .setContainerItem(Items.glass_bottle);
        if (IL.EtFu_Bottle_Honey.exists()) IL.EtFu_Bottle_Honey.item()
            .setContainerItem(Items.glass_bottle);
        if (IL.EtFu_Sus_Stew.exists()) IL.EtFu_Sus_Stew.item()
            .setContainerItem(Items.bowl);

        IL.GaSu_Granite.set(
            ST.make(MD.GaSu, "18Stones", 1, 1),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite),
            CR.DELATE);
        IL.GaSu_Granite_Smooth.set(
            ST.make(MD.GaSu, "18Stones", 1, 2),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite),
            CR.DELATE);
        IL.GaSu_Diorite.set(
            ST.make(MD.GaSu, "18Stones", 1, 3),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite),
            CR.DELATE);
        IL.GaSu_Diorite_Smooth.set(
            ST.make(MD.GaSu, "18Stones", 1, 4),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite),
            CR.DELATE);
        IL.GaSu_Andesite.set(
            ST.make(MD.GaSu, "18Stones", 1, 5),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite),
            CR.DELATE);
        IL.GaSu_Andesite_Smooth.set(
            ST.make(MD.GaSu, "18Stones", 1, 6),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite),
            CR.DELATE);
        IL.GaSu_Basalt.set(
            ST.make(MD.GaSu, "basalt", 1, 0),
            new OreDictItemData(MT.STONES.Basalt, U * 9),
            OP.stone.dat(MT.STONES.Basalt));
        IL.GaSu_Basalt_Smooth.set(
            ST.make(MD.GaSu, "basalt", 1, 1),
            new OreDictItemData(MT.STONES.Basalt, U * 9),
            OP.stone.dat(MT.STONES.Basalt));
        IL.GaSu_Beet_Seeds.set(ST.make(MD.GaSu, "beetrootSeeds", 1, 0), null, "seedBeet");

        IL.CHSL_Granite.set(
            ST.make(MD.CHSL, "granite", 1, 0),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite),
            CR.DELATE);
        IL.CHSL_Diorite.set(
            ST.make(MD.CHSL, "diorite", 1, 0),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite),
            CR.DELATE);
        IL.CHSL_Andesite.set(
            ST.make(MD.CHSL, "andesite", 1, 0),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite),
            CR.DELATE);
        IL.CHSL_Granite_Smooth.set(
            ST.make(MD.CHSL, "granite", 1, 1),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite),
            CR.DELATE);
        IL.CHSL_Diorite_Smooth.set(
            ST.make(MD.CHSL, "diorite", 1, 1),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite),
            CR.DELATE);
        IL.CHSL_Andesite_Smooth.set(
            ST.make(MD.CHSL, "andesite", 1, 1),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite),
            CR.DELATE);

        IL.BOTA_Andesite.set(
            ST.make(MD.BOTA, "stone", 1, 0),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite));
        IL.BOTA_Basalt.set(
            ST.make(MD.BOTA, "stone", 1, 1),
            new OreDictItemData(MT.STONES.Basalt, U * 9),
            OP.stone.dat(MT.STONES.Basalt));
        IL.BOTA_Diorite.set(
            ST.make(MD.BOTA, "stone", 1, 2),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite));
        IL.BOTA_Granite.set(
            ST.make(MD.BOTA, "stone", 1, 3),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite));
        IL.BOTA_Andesite_Smooth.set(
            ST.make(MD.BOTA, "stone", 1, 4),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite));
        IL.BOTA_Basalt_Smooth.set(
            ST.make(MD.BOTA, "stone", 1, 5),
            new OreDictItemData(MT.STONES.Basalt, U * 9),
            OP.stone.dat(MT.STONES.Basalt));
        IL.BOTA_Diorite_Smooth.set(
            ST.make(MD.BOTA, "stone", 1, 6),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite));
        IL.BOTA_Granite_Smooth.set(
            ST.make(MD.BOTA, "stone", 1, 7),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite));
        IL.BOTA_Andesite_Bricks.set(
            ST.make(MD.BOTA, "stone", 1, 8),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite));
        IL.BOTA_Basalt_Bricks.set(
            ST.make(MD.BOTA, "stone", 1, 9),
            new OreDictItemData(MT.STONES.Basalt, U * 9),
            OP.stone.dat(MT.STONES.Basalt));
        IL.BOTA_Diorite_Bricks.set(
            ST.make(MD.BOTA, "stone", 1, 10),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite));
        IL.BOTA_Granite_Bricks.set(
            ST.make(MD.BOTA, "stone", 1, 11),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite));
        IL.BOTA_Andesite_Chiseled.set(
            ST.make(MD.BOTA, "stone", 1, 12),
            new OreDictItemData(MT.STONES.Andesite, U * 9),
            OP.stone.dat(MT.STONES.Andesite));
        IL.BOTA_Basalt_Chiseled.set(
            ST.make(MD.BOTA, "stone", 1, 13),
            new OreDictItemData(MT.STONES.Basalt, U * 9),
            OP.stone.dat(MT.STONES.Basalt));
        IL.BOTA_Diorite_Chiseled.set(
            ST.make(MD.BOTA, "stone", 1, 14),
            new OreDictItemData(MT.STONES.Diorite, U * 9),
            OP.stone.dat(MT.STONES.Diorite));
        IL.BOTA_Granite_Chiseled.set(
            ST.make(MD.BOTA, "stone", 1, 15),
            new OreDictItemData(MT.STONES.Granite, U * 9),
            OP.stone.dat(MT.STONES.Granite));
        IL.BOTA_Livingrock.set(
            ST.make(MD.BOTA, "livingrock", 1, 0),
            new OreDictItemData(MT.STONES.Livingrock, U * 9),
            OP.stone.dat(MT.STONES.Livingrock));
        IL.BOTA_Prismarine.set(
            ST.make(MD.BOTA, "prismarine", 1, 0),
            new OreDictItemData(MT.PrismarineLight, U),
            OP.stone.dat(MT.PrismarineLight));
        IL.BOTA_Prismarine_Bricks.set(
            ST.make(MD.BOTA, "prismarine", 1, 1),
            new OreDictItemData(MT.PrismarineLight, U),
            OP.stone.dat(MT.PrismarineLight));
        IL.BOTA_Prismarine_Dark.set(
            ST.make(MD.BOTA, "prismarine", 1, 2),
            new OreDictItemData(MT.PrismarineDark, U),
            OP.stone.dat(MT.PrismarineDark));
        ...
        if (IL.EB_Dirt_Alfisol.exists())
            Textures.BlockIcons.DIRTS[5] = new IconContainerCopied(IL.EB_Dirt_Alfisol.block(), 0, SIDE_BOTTOM);
        if (IL.EB_Dirt_Andisol.exists())
            Textures.BlockIcons.DIRTS[6] = new IconContainerCopied(IL.EB_Dirt_Andisol.block(), 1, SIDE_BOTTOM);
        if (IL.EB_Dirt_Gelisol.exists())
            Textures.BlockIcons.DIRTS[7] = new IconContainerCopied(IL.EB_Dirt_Gelisol.block(), 3, SIDE_BOTTOM);
        if (IL.EB_Dirt_Histosol.exists())
            Textures.BlockIcons.DIRTS[8] = new IconContainerCopied(IL.EB_Dirt_Histosol.block(), 4, SIDE_BOTTOM);
        if (IL.EB_Dirt_Inceptisol.exists())
            Textures.BlockIcons.DIRTS[9] = new IconContainerCopied(IL.EB_Dirt_Inceptisol.block(), 5, SIDE_BOTTOM);
        if (IL.EB_Dirt_Mollisol.exists())
            Textures.BlockIcons.DIRTS[10] = new IconContainerCopied(IL.EB_Dirt_Mollisol.block(), 6, SIDE_BOTTOM);
        if (IL.EB_Dirt_Oxisol.exists())
            Textures.BlockIcons.DIRTS[11] = new IconContainerCopied(IL.EB_Dirt_Oxisol.block(), 7, SIDE_BOTTOM);
        ...
        IL.BoP_Ashes.set(
            ST.make(MD.BoP, "misc", 1, 1),
            new OreDictItemData(MT.VolcanicAsh, U4 * 9),
            DYE_OREDICTS_MIXABLE[DYE_INDEX_Gray]);
        ...
        IL.BoP_Grass_Netherrack
            .set(ST.make(MD.BoP, "overgrownNetherrack", 1, 0), new OreDictItemData(MT.Netherrack, U));
        ...
        if (IL.BoP_Dirt_Loamy.exists())
            Textures.BlockIcons.DIRTS[2] = new IconContainerCopied(IL.BoP_Dirt_Loamy.block(), 0, SIDE_BOTTOM);
        if (IL.BoP_Dirt_Sandy.exists())
            Textures.BlockIcons.DIRTS[3] = new IconContainerCopied(IL.BoP_Dirt_Sandy.block(), 2, SIDE_BOTTOM);
        if (IL.BoP_Dirt_Silty.exists())
            Textures.BlockIcons.DIRTS[4] = new IconContainerCopied(IL.BoP_Dirt_Silty.block(), 4, SIDE_BOTTOM);
        ...
        IL.BoP_HoneyComb
            .set(ST.make(MD.BoP, "food", 1, 9), null, OD.beeComb, OD.materialHoneycomb, "foodFilledhoneycomb");
        ...
        IL.BoP_Jar_Honey
            .set(ST.make(MD.BoP, "jarFilled", 1, 0), new OreDictItemData(MT.Glass, 21 * U), "foodHoneydrop");
        IL.BoP_Jar_Poison
            .set(ST.make(MD.BoP, "jarFilled", 1, 1), new OreDictItemData(MT.Glass, 21 * U), OD.container500poison);
        IL.BoP_Jar_Pixie.set(ST.make(MD.BoP, "jarFilled", 1, 2), new OreDictItemData(MT.Glass, 21 * U));

        if (IL.BoP_Jar_Honey.item() != null && IL.BoP_Jar_Empty.item() != null) IL.BoP_Jar_Honey.item()
            .setContainerItem(IL.BoP_Jar_Empty.item());

        IL.HiL_Ironwood.set(
            ST.make(MD.HiL, "tile.hl_ironwoodWood", 1, 0),
            new OreDictItemData(ANY.Wood, U * 8, MT.LiveRoot, U4),
            OD.logWood);
        ...
        IL.RoC_Ethanol_Extract
            .set(ST.make(MD.RoC, "rotarycraft_item_powders", 1, 16), new OreDictItemData(MT.Ethanol, U));
        IL.RoC_Ethanol_Crystal
            .set(ST.make(MD.RoC, "rotarycraft_item_ethanol", 1, 0), new OreDictItemData(MT.Ethanol, U));
        ...
        IL.GC_Infinite_Oxygen.set(ST.make(MD.GC, "item.infiniteOxygen", 1, 0));
        ItemsGT.DEBUG_ITEMS.add(IL.GC_Infinite_Oxygen.wild(1));
        ItemsGT.ILLEGAL_DROPS.add(IL.GC_Infinite_Oxygen.wild(1));
        IL.GC_Infinite_Battery.set(ST.make(MD.GC, "item.infiniteBattery", 1, 0));
        ItemsGT.DEBUG_ITEMS.add(IL.GC_Infinite_Battery.wild(1));
        ItemsGT.ILLEGAL_DROPS.add(IL.GC_Infinite_Battery.wild(1));
        IL.GC_Torch_Glowstone.set(
            ST.make(MD.GC, "tile.glowstoneTorch", 1, 0),
            new OreDictItemData(ANY.Glowstone, U4, ANY.Wood, U8),
            OD.blockTorch);
        ...
        IL.TG_Ore_Cluster_1.set(ST.make(MD.TG, "oreCluster", 1, 0));
        ItemsGT.DEBUG_ITEMS.add(IL.TG_Ore_Cluster_1.wild(1));
        ItemsGT.ILLEGAL_DROPS.add(IL.TG_Ore_Cluster_1.wild(1));
        IL.TG_Ore_Cluster_2.set(ST.make(MD.TG, "oreCluster2", 1, 0));
        ItemsGT.DEBUG_ITEMS.add(IL.TG_Ore_Cluster_2.wild(1));
        ItemsGT.ILLEGAL_DROPS.add(IL.TG_Ore_Cluster_2.wild(1));
        IL.TG_Spawner_Bug.set(ST.make(MD.TG, "TGMonsterSpawner", 1, 0));
        IL.TG_Spawner_Zombie.set(ST.make(MD.TG, "TGMonsterSpawner", 1, 1));

        if (IL.TG_Ore_Cluster_1.block() != NB) IL.TG_Ore_Cluster_1.block()
            .setHardness(1000)
            .setResistance(6000000)
            .setHarvestLevel(TOOL_pickaxe, 3);
        if (IL.TG_Ore_Cluster_2.block() != NB) IL.TG_Ore_Cluster_2.block()
            .setHardness(1000)
            .setResistance(6000000)
            .setHarvestLevel(TOOL_pickaxe, 3);

        IL.MFR_Hammer.set(ST.make(MD.MFR, "hammer", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.MFR_Hammer.wild(1));
        IL.MFR_Fertilizer
            .set(ST.make(MD.MFR, "fertilizer", 1, 0), null, OD.itemFertilizer, DYE_OREDICTS_MIXABLE[DYE_INDEX_Brown]);
        ...
        IL.HBM_Crushed_Obsidian
            .set(ST.make(MD.HBM, "tile.gravel_obsidian", 1, 0), new OreDictItemData(MT.Obsidian, U * 8));
        IL.HBM_Bottle_Mercury.set(
            ST.make(MD.HBM, "item.bottle_mercury", 1, 0),
            new OreDictItemData(MT.Hg, U, MT.Glass, U),
            OP.bottle.dat(MT.Hg));
        IL.HBM_Mercury_Drop.set(ST.make(MD.HBM, "item.nugget_mercury", 1, 0), new OreDictItemData(MT.Hg, U8));
        IL.HBM_Mercury_Drop_Tiny
            .set(ST.make(MD.HBM, "item.nugget_mercury_tiny", 1, 0), new OreDictItemData(MT.Hg, U72));
        ...
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.BC_Wrench.wild(1));

        IL.AE_Wrench_Certus.set(ST.make(MD.AE, "item.ToolCertusQuartzWrench", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.AE_Wrench_Certus.wild(1));
        IL.AE_Wrench_Quartz.set(ST.make(MD.AE, "item.ToolNetherQuartzWrench", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.AE_Wrench_Quartz.wild(1));
        IL.AE_Cutter_Certus.set(ST.make(MD.AE, "item.ToolCertusQuartzCuttingKnife", 1, 0));
        ItemsGT.CONTAINER_DURABILITY.add(IL.AE_Cutter_Certus.wild(1));
        IL.AE_Cutter_Quartz.set(ST.make(MD.AE, "item.ToolNetherQuartzCuttingKnife", 1, 0));
        ItemsGT.CONTAINER_DURABILITY.add(IL.AE_Cutter_Quartz.wild(1));
        IL.AE_Torch_Quartz.set(ST.make(MD.AE, "tile.BlockQuartzTorch", 1, 0), null, OD.blockTorch);

        IL.EIO_Wrench.set(ST.make(MD.EIO, "itemYetaWrench", 1, 0), null, CR.DELATE);
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.EIO_Wrench.wild(1));

        IL.FR_Wrench.set(ST.make(MD.FR, "wrench", 1, 0));
        ItemsGT.SPECIAL_CASE_TOOLS.add(IL.FR_Wrench.wild(1));
        ...
        IL.FR_Comb_Honey
            .set(ST.make(MD.FR, "beeCombs", 1, 0), null, OD.beeComb, OD.materialHoneycomb, "foodFilledhoneycomb");
        ...
        IL.FR_RefractoryCapsule
            .set(ST.make(MD.FR, "refractoryEmpty", 1, 0), new OreDictItemData(MT.WaxRefractory, 3 * U4));
        IL.FR_MagicCapsule.set(ST.make(MD.FRMB, "capsule.magic", 1, 0), new OreDictItemData(MT.WaxMagic, 3 * U4));
        IL.FR_SeedOil_Bucket.set(
            ST.make(MD.FR, "bucketSeedOil", 1, 0),
            new OreDictItemData(ANY.Fe, U * 3),
            OD.container1000seedoil,
            "bucketSeedoil");
        ...
        IL.FR_Honey_Bucket.set(
            ST.make(MD.FR, "bucketHoney", 1, 0),
            new OreDictItemData(ANY.Fe, U * 3),
            OD.container1000honey,
            "bucketHoney");
        ...
        IL.FR_Juice_Bucket.set(
            ST.make(MD.FR, "bucketJuice", 1, 0),
            new OreDictItemData(ANY.Fe, U * 3),
            OD.container1000juice,
            "bucketJuice");
        ...
        IL.FR_Casing_Hardened
            .set(ST.make(MD.FR, "hardenedMachine", 1, 0), new OreDictItemData(MT.Bronze, U * 8, ANY.Diamond, U * 4));
        IL.FR_Chipset_Tin.set(ST.make(MD.FR, "chipsets", 1, 0), new OreDictItemData(MT.Sn, U * 1, MT.Redstone, U * 6));
        IL.FR_Chipset_Bronze
            .set(ST.make(MD.FR, "chipsets", 1, 1), new OreDictItemData(MT.Bronze, U * 3, MT.Redstone, U * 6));
        IL.FR_Chipset_Iron
            .set(ST.make(MD.FR, "chipsets", 1, 2), new OreDictItemData(ANY.Fe, U * 3, MT.Redstone, U * 6));
        IL.FR_Chipset_Gold.set(ST.make(MD.FR, "chipsets", 1, 3), new OreDictItemData(MT.Au, U * 3, MT.Redstone, U * 6));
        IL.FR_ElectronTube_Copper.set(
            ST.make(MD.FR, "thermionicTubes", 1, 0),
            new OreDictItemData(ANY.Cu, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Tin.set(
            ST.make(MD.FR, "thermionicTubes", 1, 1),
            new OreDictItemData(MT.Sn, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Bronze.set(
            ST.make(MD.FR, "thermionicTubes", 1, 2),
            new OreDictItemData(MT.Bronze, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Iron.set(
            ST.make(MD.FR, "thermionicTubes", 1, 3),
            new OreDictItemData(ANY.Fe, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Gold.set(
            ST.make(MD.FR, "thermionicTubes", 1, 4),
            new OreDictItemData(MT.Au, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Diamond.set(
            ST.make(MD.FR, "thermionicTubes", 1, 5),
            new OreDictItemData(ANY.Diamond, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Obsidian.set(
            ST.make(MD.FR, "thermionicTubes", 1, 6),
            new OreDictItemData(MT.Obsidian, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Blaze.set(
            ST.make(MD.FR, "thermionicTubes", 1, 7),
            new OreDictItemData(MT.Blaze, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Rubber.set(
            ST.make(MD.FR, "thermionicTubes", 1, 8),
            new OreDictItemData(ANY.Rubber, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Emerald.set(
            ST.make(MD.FR, "thermionicTubes", 1, 9),
            new OreDictItemData(ANY.Emerald, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Apatite.set(
            ST.make(MD.FR, "thermionicTubes", 1, 10),
            new OreDictItemData(MT.Apatite, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Lapis.set(
            ST.make(MD.FR, "thermionicTubes", 1, 11),
            new OreDictItemData(MT.Lapis, 5 * U4, MT.Redstone, U2, MT.Glass, U8));
        IL.FR_ElectronTube_Ender.set(
            ST.make(MD.FR, "thermionicTubes", 1, 12),
            new OreDictItemData(MT.Endstone, 5 * U4, MT.EnderEye, U2, MT.Glass, U8));
        ...
        IL.Ancient_Debris
            .set((IL.EtFu_Ancient_Debris.exists() ? IL.EtFu_Ancient_Debris : IL.NePl_Ancient_Debris).get(1));

        if (MD.BINNIE.mLoaded) {
            Item tItem = ST.item(MD.BINNIE, "containerGlass");
            if (tItem != null) tItem.setContainerItem(Items.glass_bottle);
            tItem = ST.item(MD.BINNIE, "containerBucket");
            if (tItem != null) tItem.setContainerItem(Items.bucket);
        }
        ...
        if (MD.IC2C.mLoaded) {
            ...
            ItemsGT.CONTAINER_DURABILITY.add(IL.IC2_ForgeHammer.wild(1));
            IL.IC2_Debug.set(ST.mkic("debug", 1));
            ItemsGT.DEBUG_ITEMS.add(IL.IC2_Debug.wild(1));
            ItemsGT.ILLEGAL_DROPS.add(IL.IC2_Debug.wild(1));
            IL.IC2_AdvBattery.set(ST.mkic("advBattery", 1));
            IL.Cell_Universal_Fluid
                .set(ST.mkic("FluidCell", 1), new OreDictItemData(MT.Sn, U * 2, OM.stack(MT.Glass, U)), CR.DELATE);
        ...
        IL.IC2_Log_Rubber
            .set(ST.mkic("rubberWood", 1), new OreDictItemData(MT.WoodRubber, U * 8, MT.Bark, U), OD.logRubber);
        ...
        IL.IC2_Compressed_Coal_Chunk
            .set(ST.mkic("coalChunk", 1), new OreDictItemData(MT.Coal, U * 64, MT.Obsidian, U * 9));
        ...
        IL.Tool_Sword_Bronze.set(
            ST.mkic("bronzeSword", 1, 0),
            new OreDictItemData(MT.Bronze, OP.toolHeadSword, ANY.Wood, U2).setUseVanillaDamage());
        IL.Tool_Pickaxe_Bronze.set(
            ST.mkic("bronzePickaxe", 1, 0),
            new OreDictItemData(MT.Bronze, OP.toolHeadPickaxe, ANY.Wood, U).setUseVanillaDamage());
        IL.Tool_Shovel_Bronze.set(
            ST.mkic("bronzeShovel", 1, 0),
            new OreDictItemData(MT.Bronze, OP.toolHeadShovel, ANY.Wood, U).setUseVanillaDamage());
        IL.Tool_Axe_Bronze.set(
            ST.mkic("bronzeAxe", 1, 0),
            new OreDictItemData(MT.Bronze, OP.toolHeadAxe, ANY.Wood, U).setUseVanillaDamage());
        IL.Tool_Hoe_Bronze.set(
            ST.mkic("bronzeHoe", 1, 0),
            new OreDictItemData(MT.Bronze, OP.toolHeadHoe, ANY.Wood, U).setUseVanillaDamage());
        IL.IC2_WireCutter.set(ST.mkic("cutter", 1));
        ItemsGT.CONTAINER_DURABILITY.add(IL.IC2_WireCutter.wild(1));
