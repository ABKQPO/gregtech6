...
public class LoaderOreDictReRegistrations implements Runnable {
    ...
    public void run() {
        ...
        OreDictManager.INSTANCE
            .addReRegistrationWithReversal("blockChargedCertusQuartz", "blockGemChargedCertusQuartz");
        ...
        OreDictManager.INSTANCE
            .setAutomaticItemData("chipsetDiamond", new OreDictItemData(MT.Redstone, U, ANY.Diamond, U));
        OreDictManager.INSTANCE
            .setAutomaticItemData("chipsetPulsating", new OreDictItemData(MT.Redstone, U2, MT.EnderPearl, U2));
        ...
        OreDictManager.INSTANCE
            .setAutomaticItemData("chipsetEmerald", new OreDictItemData(MT.Redstone, U, ANY.Emerald, U));
        ...
        OreDictManager.INSTANCE
            .setAutomaticItemData(OD.logRubber, new OreDictItemData(MT.WoodRubber, U * 8, MT.Bark, U));
        ...
        OreDictManager.INSTANCE
            .setAutomaticItemData(OD.craftingPiston, new OreDictItemData(MT.Stone, U * 4, ANY.Wood, U * 3));
        ...
        OreDictManager.INSTANCE
            .setAutomaticItemData(OD.craftingRedstoneTorch, new OreDictItemData(MT.Redstone, U, ANY.Wood, U2));
        ...
        OreDictManager.INSTANCE
            .setAutomaticItemData(OP.stone.dat(MT.SoulSand), new OreDictItemData(MT.SoulSand, U * 9));
        OreDictManager.INSTANCE
            .setAutomaticItemData(OP.stone.dat(MT.EndSandWhite), new OreDictItemData(MT.EndSandWhite, U * 9));
        OreDictManager.INSTANCE
            .setAutomaticItemData(OP.stone.dat(MT.EndSandBlack), new OreDictItemData(MT.EndSandBlack, U * 9));
