 ...
 * 
 *         Utility for accessing the OreDictUnificator Data in a more short manner. The Short Name is for ease of
 *         overview and stands for "OredictManager".
 */
public class OM {
    ...
    public static ItemStack get(OreDictPrefix aPrefix, OreDictMaterial aMaterial, ItemStack aReplacement,
        long aStackSize) {
    ...
    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        OreDictMaterialStack aMaterial, OreDictMaterialStack... aByProducts) {
        data(ST.make(aModID, aModItemName, aStackSize, aMetaData), new OreDictItemData(aMaterial, aByProducts));
    }

    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        OreDictMaterial aMaterial, long aAmount, OreDictMaterialStack... aByProducts) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(aMaterial, aAmount, aByProducts));
    }

    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct, long aByProductAmount) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(aMaterial, aAmount, aByProduct, aByProductAmount));
    }

    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct, long aByProductAmount,
        OreDictMaterial aByProduct2, long aByProduct2Amount) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(
                aMaterial,
                aAmount,
                OM.stack(aByProduct, aByProductAmount),
                OM.stack(aByProduct2, aByProduct2Amount)));
    }

    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct, long aByProductAmount,
        OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3, long aByProduct3Amount) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(
                aMaterial,
                ...
                OM.stack(aByProduct, aByProductAmount),
                OM.stack(aByProduct2, aByProduct2Amount),
                OM.stack(aByProduct3, aByProduct3Amount)));
    }

    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct, long aByProductAmount,
        OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3, long aByProduct3Amount,
        OreDictMaterial aByProduct4, long aByProduct4Amount) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(
                aMaterial,
                ...
                OM.stack(aByProduct2, aByProduct2Amount),
                OM.stack(aByProduct3, aByProduct3Amount),
                OM.stack(aByProduct4, aByProduct4Amount)));
    }

    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct, long aByProductAmount,
        OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3, long aByProduct3Amount,
        OreDictMaterial aByProduct4, long aByProduct4Amount, OreDictMaterial aByProduct5, long aByProduct5Amount) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(
                aMaterial,
                ...
                OM.stack(aByProduct3, aByProduct3Amount),
                OM.stack(aByProduct4, aByProduct4Amount),
                OM.stack(aByProduct5, aByProduct5Amount)));
    }
    ...
    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        ...
        OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3, long aByProduct3Amount,
        OreDictMaterial aByProduct4, long aByProduct4Amount, OreDictMaterial aByProduct5, long aByProduct5Amount,
        OreDictMaterial aByProduct6, long aByProduct6Amount) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(
                aMaterial,
                ...
                OM.stack(aByProduct4, aByProduct4Amount),
                OM.stack(aByProduct5, aByProduct5Amount),
                OM.stack(aByProduct6, aByProduct6Amount)));
    }
    ...
    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        ...
        OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3, long aByProduct3Amount,
        OreDictMaterial aByProduct4, long aByProduct4Amount, OreDictMaterial aByProduct5, long aByProduct5Amount,
        OreDictMaterial aByProduct6, long aByProduct6Amount, OreDictMaterial aByProduct7, long aByProduct7Amount) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(
                aMaterial,
                ...
                OM.stack(aByProduct5, aByProduct5Amount),
                OM.stack(aByProduct6, aByProduct6Amount),
                OM.stack(aByProduct7, aByProduct7Amount)));
    }
    ...
    public static void data(ModData aModID, String aModItemName, int aStackSize, int aMetaData,
        ...
        OreDictMaterial aByProduct4, long aByProduct4Amount, OreDictMaterial aByProduct5, long aByProduct5Amount,
        OreDictMaterial aByProduct6, long aByProduct6Amount, OreDictMaterial aByProduct7, long aByProduct7Amount,
        OreDictMaterial aByProduct8, long aByProduct8Amount) {
        data(
            ST.make(aModID, aModItemName, aStackSize, aMetaData),
            new OreDictItemData(
                aMaterial,
                ...
                OM.stack(aByProduct6, aByProduct6Amount),
                OM.stack(aByProduct7, aByProduct7Amount),
                OM.stack(aByProduct8, aByProduct8Amount)));
    }
    ...
    public static void dat2(ModData aModID, String aModItemName, int aStackSize, OreDictMaterialStack aMaterial,
        OreDictMaterialStack... aByProducts) {
        dat2(ST.make(aModID, aModItemName, aStackSize, 0), aMaterial, aByProducts);
    }

    public static void dat2(ModData aModID, String aModItemName, int aStackSize, OreDictMaterial aMaterial,
        long aAmount, OreDictMaterialStack... aByProducts) {
        dat2(ST.make(aModID, aModItemName, aStackSize, 0), aMaterial, aAmount, aByProducts);
    }

    public static void dat2(ModData aModID, String aModItemName, int aStackSize, OreDictMaterial aMaterial,
        long aAmount, OreDictMaterial aByProduct, long aByProductAmount) {
    ...
    public static void data(ItemStack aStack, OreDictMaterial aMaterial, long aAmount,
        OreDictMaterialStack... aByProducts) {
        if (ST.valid(aStack))
            OreDictManager.INSTANCE.addItemData_(aStack, new OreDictItemData(aMaterial, aAmount, aByProducts));
    }

    public static void data(ItemStack aStack, OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct,
        long aByProductAmount) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE
            .addItemData_(aStack, new OreDictItemData(aMaterial, aAmount, aByProduct, aByProductAmount));
    }

    public static void data(ItemStack aStack, OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct,
        long aByProductAmount, OreDictMaterial aByProduct2, long aByProduct2Amount) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            aStack,
            new OreDictItemData(
                aMaterial,
                aAmount,
    ...
    public static void data(ItemStack aStack, OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct,
        long aByProductAmount, OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3,
        long aByProduct3Amount) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            aStack,
            new OreDictItemData(
                aMaterial,
    ...
    public static void data(ItemStack aStack, OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct,
        long aByProductAmount, OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3,
        long aByProduct3Amount, OreDictMaterial aByProduct4, long aByProduct4Amount) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            aStack,
            new OreDictItemData(
                aMaterial,
    ...
    public static void data(ItemStack aStack, OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct,
        long aByProductAmount, OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3,
        long aByProduct3Amount, OreDictMaterial aByProduct4, long aByProduct4Amount, OreDictMaterial aByProduct5,
    ...
    public static void data(ItemStack aStack, OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct,
        long aByProductAmount, OreDictMaterial aByProduct2, long aByProduct2Amount, OreDictMaterial aByProduct3,
        long aByProduct3Amount, OreDictMaterial aByProduct4, long aByProduct4Amount, OreDictMaterial aByProduct5,
        long aByProduct5Amount, OreDictMaterial aByProduct6, long aByProduct6Amount, OreDictMaterial aByProduct7,
        long aByProduct7Amount) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            aStack,
            new OreDictItemData(
                aMaterial,
    ...
    public static void data(ItemStack aStack, OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct,
        ...
        long aByProduct3Amount, OreDictMaterial aByProduct4, long aByProduct4Amount, OreDictMaterial aByProduct5,
        long aByProduct5Amount, OreDictMaterial aByProduct6, long aByProduct6Amount, OreDictMaterial aByProduct7,
        long aByProduct7Amount, OreDictMaterial aByProduct8, long aByProduct8Amount) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            aStack,
            new OreDictItemData(
                aMaterial,
    ...
    public static void dat2(ItemStack aStack, OreDictItemData aData) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            ST.copyMeta(0, aStack),
            aData.setUseVanillaDamage()
                .setNotFurnaceFuel());
    }
    ...
    public static void dat2(ItemStack aStack, OreDictMaterialStack aMaterial, OreDictMaterialStack... aByProducts) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            ST.copyMeta(0, aStack),
            new OreDictItemData(aMaterial, aByProducts).setUseVanillaDamage()
                .setNotFurnaceFuel());
    }

    public static void dat2(ItemStack aStack, OreDictMaterial aMaterial, long aAmount,
        OreDictMaterialStack... aByProducts) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            ST.copyMeta(0, aStack),
            new OreDictItemData(aMaterial, aAmount, aByProducts).setUseVanillaDamage()
                .setNotFurnaceFuel());
    }

    public static void dat2(ItemStack aStack, OreDictMaterial aMaterial, long aAmount, OreDictMaterial aByProduct,
        long aByProductAmount) {
        if (ST.valid(aStack)) OreDictManager.INSTANCE.addItemData_(
            ST.copyMeta(0, aStack),
            new OreDictItemData(aMaterial, aAmount, aByProduct, aByProductAmount).setUseVanillaDamage()
                .setNotFurnaceFuel());
    }
    ...
    public static boolean prefixcontainsmaterialmatches_(ItemStack aStack, OreDictMaterial aMaterial,
        TagData... aTags) {
        return prefixcontainsmaterialmatches(anydata_(aStack), aMaterial, aTags);
    }

    public static boolean prefixcontainsmaterialmatches(OreDictItemData aData, OreDictMaterial aMaterial,
        TagData... aTags) {
        return aData != null && aData.mPrefix != null
            && aData.mMaterial != null
            && (aMaterial == null || aData.mMaterial.mMaterial == aMaterial)
            && aData.mPrefix.containsAll(aTags);
    }
    ...
    public static boolean materialcontained(ItemStack aStack, boolean aReturnWhenNoData,
        OreDictMaterial... aMaterials) {
        return materialcontained(anydata(aStack), aReturnWhenNoData, aMaterials);
    }

    public static boolean materialcontained_(ItemStack aStack, boolean aReturnWhenNoData,
        OreDictMaterial... aMaterials) {
        return materialcontained(anydata_(aStack), aReturnWhenNoData, aMaterials);
    }

    public static boolean materialcontained(OreDictItemData aData, boolean aReturnWhenNoData,
        OreDictMaterial... aMaterials) {
        if (aData == null) return aReturnWhenNoData;
        for (OreDictMaterial aMaterial : aMaterials) for (OreDictMaterialStack tMaterial : aData.getAllMaterialStacks())
            if (aMaterial == tMaterial.mMaterial) return T;
        return F;
    }
    ...
    public static long total(Iterable<OreDictMaterialStack> aList) {
        ...
        for (OreDictMaterialStack tStack : aList)
            if (tStack != null && tStack.mMaterial != MT.NULL) rAmount += tStack.mAmount;
        return rAmount;
    }
    ...
    public static double weight(Iterable<OreDictMaterialStack> aList) {
        double rWeight = 0;
        for (OreDictMaterialStack tStack : aList)
            if (tStack != null && tStack.mMaterial != MT.NULL) rWeight += tStack.weight();
        return rWeight;
    }
    ...
    public static ItemStack pulverize(OreDictMaterial aMaterial, long aMaterialAmount) {
        return dust(
            aMaterial.mTargetPulver.mMaterial,
            UT.Code.units(aMaterialAmount, U, aMaterial.mTargetPulver.mAmount, F));
    }
    ...
    public static ItemStack gem(OreDictMaterial aMaterial, long aMaterialAmount) {
        ...
        if (aMaterialAmount >= U * 72) {
            ItemStack rStack = OP.blockGem.mat(aMaterial, UT.Code.bindStack(aMaterialAmount / (U * 9)));
            if (rStack != null) return rStack;
        }
        if (aMaterialAmount >= U)
            if (aMaterialAmount >= U * 32 || (((aMaterialAmount % U <= aMaterialAmount % (U2))))) {
                ItemStack rStack = OP.gem.mat(aMaterial, UT.Code.bindStack(aMaterialAmount / U));
                if (rStack != null) return rStack;
            }
        if (aMaterialAmount >= U2)
            if (aMaterialAmount >= U * 16 || (((aMaterialAmount % (U2) <= aMaterialAmount % (U4))))) {
                ItemStack rStack = OP.gemFlawed.mat(aMaterial, UT.Code.bindStack((aMaterialAmount * 2) / U));
                if (rStack != null) return rStack;
            }
    ...
    public static ItemStack dust(OreDictMaterial aMaterial, long aMaterialAmount) {
        ...
        if (aMaterialAmount >= U * 72) {
            ItemStack rStack = OP.blockDust.mat(aMaterial, UT.Code.bindStack(aMaterialAmount / (U * 9)));
            if (rStack != null) return rStack;
        }
        if (aMaterialAmount >= U) if (aMaterialAmount >= U * 16 || ((aMaterialAmount % U == 0))) {
            ItemStack rStack = OP.dust.mat(aMaterial, UT.Code.bindStack(aMaterialAmount / U));
            if (rStack != null) return rStack;
        }
        if (aMaterialAmount >= U4)
            if (aMaterialAmount >= U * 8 || (((aMaterialAmount % (U4) <= aMaterialAmount % (U9))))) {
                ItemStack rStack = OP.dustSmall.mat(aMaterial, UT.Code.bindStack((aMaterialAmount * 4) / U));
                if (rStack != null) return rStack;
            }
        if (aMaterialAmount >= U9)
            if (aMaterialAmount >= U || (((aMaterialAmount % (U9) <= aMaterialAmount % (U72))))) {
                ItemStack rStack = OP.dustTiny.mat(aMaterial, UT.Code.bindStack((aMaterialAmount * 9) / U));
                if (rStack != null) return rStack;
            }
    ...
    public static ItemStack ingot(OreDictMaterial aMaterial, long aMaterialAmount) {
        ...
        if (aMaterialAmount >= U * 72) {
            ItemStack rStack = OP.blockIngot.mat(aMaterial, UT.Code.bindStack(aMaterialAmount / (U * 9)));
            if (rStack != null) return rStack;
        }
        if (aMaterialAmount >= U) if (aMaterialAmount >= U * 16 || ((aMaterialAmount % U == 0))) {
            ItemStack rStack = OP.ingot.mat(aMaterial, UT.Code.bindStack(aMaterialAmount / U));
            if (rStack != null) return rStack;
        }
        if (aMaterialAmount >= U4)
            if (aMaterialAmount >= U * 8 || (((aMaterialAmount % (U4) <= aMaterialAmount % (U9))))) {
                ItemStack rStack = OP.chunkGt.mat(aMaterial, UT.Code.bindStack((aMaterialAmount * 4) / U));
                if (rStack != null) return rStack;
            }
    ...
    public static ItemStack solid(OreDictMaterial aMaterial, long aMaterialAmount) {
        ...
        if (aMaterialAmount >= U * 72) {
            ItemStack rStack = OP.blockSolid.mat(aMaterial, UT.Code.bindStack(aMaterialAmount / (U * 9)));
            if (rStack != null) return rStack;
        }
        if (aMaterialAmount >= U) if (aMaterialAmount >= U * 16 || ((aMaterialAmount % U == 0))) {
            ItemStack rStack = OP.ingot.mat(aMaterial, UT.Code.bindStack(aMaterialAmount / U));
    ...
    public static OreDictMaterialStack stack(OreDictMaterial aMaterial, long aAmount) {
        return aMaterial == null ? null : new OreDictMaterialStack(aMaterial, aAmount);
    }

    public static OreDictMaterialStack stack(long aAmount, OreDictMaterial aMaterial) {
        return aMaterial == null ? null : new OreDictMaterialStack(aMaterial, aAmount);
    }

    public static OreDictMaterialStack stack(OreDictMaterial aMaterial, OreDictPrefix aPrefix) {
        return aMaterial == null || aPrefix == null ? null : new OreDictMaterialStack(aMaterial, aPrefix.mAmount);
    }

    public static OreDictMaterialStack stack(OreDictPrefix aPrefix, OreDictMaterial aMaterial) {
        return aMaterial == null || aPrefix == null ? null : new OreDictMaterialStack(aMaterial, aPrefix.mAmount);
    }
}
