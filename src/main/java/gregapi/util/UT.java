 ...
 * 
 *         Utility for accessing the random Utility Functions in a more short manner. The Short Name is for ease of
 *         overview and stands for "UtiliTy". :P
 */
public class UT {
    ...
    public static class Fluids {
        ...
        public static int id_(Fluid aFluid) {
            return FluidRegistry.getFluidID(aFluid);
        }

        @Deprecated
        public static Fluid fluid(int aID) {
            return aID < 0 ? null : FluidRegistry.getFluid(aID);
        }

        @Deprecated
        public static Fluid fluid(String aFluidName) {
            return Code.stringInvalid(aFluidName) ? null : fluid_(aFluidName);
        }

        @Deprecated
        public static Fluid fluid_(String aFluidName) {
            return FluidRegistry.getFluid(aFluidName);
        }

        @Deprecated
        public static boolean equal(FluidStack aFluid1, FluidStack aFluid2) {
            return equal(aFluid1, aFluid2, F);
        }
        ...
        public static boolean is(IFluidTank aTank, String... aNames) {
            return is(aTank.getFluid(), aNames);
        }

        @Deprecated
        public static boolean is(FluidStack aFluid, String... aNames) {
            return aFluid != null && is(aFluid.getFluid(), aNames);
        }

        @Deprecated
        public static boolean is(Fluid aFluid, String... aNames) {
            if (aFluid != null) for (String aName : aNames) if (aFluid.getName()
                .equalsIgnoreCase(aName)) return T;
            return F;
        }

        @Deprecated
        public static ItemStack display(Fluid aFluid) {
            return aFluid == null ? null : display(make(aFluid, 0), F, F);
        }

        @Deprecated
        public static ItemStack display(FluidStack aFluid, boolean aUseStackSize, boolean aLimitStackSize) {
            return display(aFluid, aFluid == null ? 0 : aFluid.amount, aUseStackSize, aLimitStackSize);
        }

        @Deprecated
        public static ItemStack display(FluidTankGT aTank, boolean aUseStackSize, boolean aLimitStackSize) {
            return display(aTank.getFluid(), aTank.amount(), aUseStackSize, aLimitStackSize);
        }

        @Deprecated
        public static ItemStack display(FluidStack aFluid, long aAmount, boolean aUseStackSize,
            boolean aLimitStackSize) {
            if (aFluid == null || aFluid.getFluid() == null) return null;
            ItemStack rStack = IL.Display_Fluid.getWithMeta(
                aUseStackSize ? aLimitStackSize ? UT.Code.bind7(aAmount / 1000) : aAmount / 1000 : 1,
                id_(aFluid));
            if (rStack == null) return null;
            NBTTagCompound tNBT = NBT.makeString(
                "f",
                aFluid.getFluid()
                    .getName());
        ...
        public static boolean water(IFluidTank aFluid) {
            return aFluid != null && water(aFluid.getFluid());
        }
        ...
        public static boolean distw(IFluidTank aFluid) {
            return aFluid != null && distw(aFluid.getFluid());
        }
        ...
        public static boolean lava(IFluidTank aFluid) {
            return aFluid != null && lava(aFluid.getFluid());
        }
        ...
        public static boolean steam(IFluidTank aFluid) {
            return aFluid != null && steam(aFluid.getFluid());
        }
        ...
        public static boolean milk(IFluidTank aFluid) {
            return aFluid != null && milk(aFluid.getFluid());
        }
        ...
        public static boolean soym(IFluidTank aFluid) {
            return aFluid != null && soym(aFluid.getFluid());
        }
        ...
        public static boolean powerconducting(Fluid aFluid) {
            return aFluid != null && FluidsGT.POWER_CONDUCTING.contains(aFluid.getName());
        }

        /** @return if that Liquid is early-game and easy to handle */
        @Deprecated
        public static boolean simple(IFluidTank aFluid) {
            return aFluid != null && simple(aFluid.getFluid());
        }
        ...
        public static boolean simple(Fluid aFluid) {
            return aFluid != null && FluidsGT.SIMPLE.contains(aFluid.getName());
        }

        @Deprecated
        public static boolean acid(IFluidTank aFluid) {
            return aFluid != null && acid(aFluid.getFluid());
        }
        ...
        public static boolean acid(Fluid aFluid) {
            return aFluid != null && FluidsGT.ACID.contains(aFluid.getName());
        }

        @Deprecated
        public static boolean plasma(IFluidTank aFluid) {
            return aFluid != null && plasma(aFluid.getFluid());
        }
        ...
        public static boolean plasma(Fluid aFluid) {
            return aFluid != null && FluidsGT.PLASMA.contains(aFluid.getName());
        }

        @Deprecated
        public static boolean gas(IFluidTank aFluid, boolean aDefault) {
            return gas(aFluid.getFluid(), aDefault);
        }

        @Deprecated
        public static boolean gas(IFluidTank aFluid) {
            return gas(aFluid.getFluid(), F);
        }

        @Deprecated
        public static boolean gas(FluidStack aFluid, boolean aDefault) {
            return aFluid == null || aFluid.getFluid() == null ? aDefault
                : !FluidsGT.LIQUID.contains(
                    aFluid.getFluid()
                        .getName())
                    && (aFluid.getFluid()
                        .isGaseous(aFluid)
                        || FluidsGT.GAS.contains(
                            aFluid.getFluid()
                                .getName()));
        }
        ...
        public static boolean gas(Fluid aFluid, boolean aDefault) {
            return aFluid == null ? aDefault
                : !FluidsGT.LIQUID.contains(aFluid.getName())
                    && (aFluid.isGaseous() || FluidsGT.GAS.contains(aFluid.getName()));
        }
        ...
        public static boolean lighter(BlockFluidBase aFluid) {
            return aFluid != null && lighter(aFluid.getFluid());
        }
        ...
        public static boolean lighter(Fluid aFluid) {
            return aFluid != null && aFluid.getDensity(make(aFluid, 1000)) < 0;
        }

        @Deprecated
        public static int dir(BlockFluidBase aFluid) {
            return lighter(aFluid) ? +1 : -1;
        }
        ...
        public static long temperature(IFluidTank aFluid) {
            return temperature(aFluid.getFluid());
        }

        @Deprecated
        public static long temperature(IFluidTank aFluid, long aDefault) {
            return temperature(aFluid.getFluid(), aDefault);
        }

        @Deprecated
        public static long temperature(Fluid aFluid) {
            return temperature(aFluid, DEF_ENV_TEMP);
        }
        ...
        public static boolean exists(String aFluidName) {
            return FluidRegistry.getFluid(aFluidName) != null;
        }
        ...
        public static FluidStack make(int aFluid, long aAmount) {
            return aFluid < 0 ? null : new FluidStack(fluid(aFluid), Code.bindInt(aAmount));
        }
        ...
        public static FluidStack make(String aFluidName, long aAmount) {
            return make(FluidRegistry.getFluid(aFluidName), aAmount);
        }

        @Deprecated
        public static FluidStack make(String aFluidName, long aAmount, String aReplacementFluidName) {
            FluidStack rFluid = make(aFluidName, aAmount);
            return rFluid == null ? make(aReplacementFluidName, aAmount) : rFluid;
        }

        @Deprecated
        public static FluidStack make(String aFluidName, long aAmount, String aReplacementFluidName,
            long aReplacementAmount) {
            FluidStack rFluid = make(aFluidName, aAmount);
            return rFluid == null ? make(aReplacementFluidName, aReplacementAmount) : rFluid;
        }
        ...
        public static FluidStack make_(int aFluid, long aAmount) {
            return aFluid < 0 ? FL.Error.make(0) : new FluidStack(fluid(aFluid), Code.bindInt(aAmount));
        }

        @Deprecated
        public static FluidStack make_(Fluid aFluid, long aAmount) {
            return aFluid == null ? FL.Error.make(0) : new FluidStack(aFluid, Code.bindInt(aAmount));
        }

        @Deprecated
        public static FluidStack make_(String aFluidName, long aAmount) {
            return make_(FluidRegistry.getFluid(aFluidName), aAmount);
        }

        @Deprecated
        public static FluidStack make_(String aFluidName, long aAmount, String aReplacementFluidName) {
            FluidStack rFluid = make(aFluidName, aAmount);
            return rFluid == null ? make_(aReplacementFluidName, aAmount) : rFluid;
        }
        ...
        public static FluidStack make_(String aFluidName, long aAmount, String aReplacementFluidName,
            long aReplacementAmount) {
            FluidStack rFluid = make(aFluidName, aAmount);
            return rFluid == null ? make_(aReplacementFluidName, aReplacementAmount) : rFluid;
        }
        ...
        public static FluidStack mul(FluidStack aFluid, long aMultiplier) {
            return aFluid == null ? null : amount(aFluid, aFluid.amount * aMultiplier);
        }

        @Deprecated
        public static FluidStack mul(FluidStack aFluid, long aMultiplier, long aDivider, boolean aRoundUp) {
            return aFluid == null ? null : amount(aFluid, Code.units(aFluid.amount, aDivider, aMultiplier, aRoundUp));
        }

        @Deprecated
        public static long fill(@SuppressWarnings("rawtypes") DelegatorTileEntity aDelegator, FluidStack aFluid,
            boolean aDoFill) {
            return aDelegator != null && aDelegator.mTileEntity instanceof IFluidHandler && aFluid != null
                ? fill_(aDelegator, aFluid, aDoFill)
                : 0;
        }

        @Deprecated
        public static long fill_(@SuppressWarnings("rawtypes") DelegatorTileEntity aDelegator, FluidStack aFluid,
            boolean aDoFill) {
            return fill_((IFluidHandler) aDelegator.mTileEntity, aDelegator.mSideOfTileEntity, aFluid, aDoFill);
        }

        @Deprecated
        public static long fill(IFluidHandler aFluidHandler, byte aSide, FluidStack aFluid, boolean aDoFill) {
            return aFluidHandler != null && aFluid != null ? fill_(aFluidHandler, aSide, aFluid, aDoFill) : 0;
        }
        ...
        public static long fill(IFluidHandler aFluidHandler, byte[] aSides, FluidStack aFluid, boolean aDoFill) {
            return aFluidHandler != null && aFluid != null ? fill_(aFluidHandler, aSides, aFluid, aDoFill) : 0;
        }

        @Deprecated
        public static long fill_(IFluidHandler aFluidHandler, byte[] aSides, FluidStack aFluid, boolean aDoFill) {
            for (byte tSide : aSides) {
                long rFilled = aFluidHandler.fill(FORGE_DIR[tSide], aFluid, aDoFill);
        ...
        @Deprecated
        public static boolean fillAll(@SuppressWarnings("rawtypes") DelegatorTileEntity aDelegator, FluidStack aFluid,
            boolean aDoFill) {
            return aDelegator != null && aDelegator.mTileEntity instanceof IFluidHandler
                && aFluid != null
                && fillAll_(aDelegator, aFluid, aDoFill);
        }

        @Deprecated
        public static boolean fillAll_(@SuppressWarnings("rawtypes") DelegatorTileEntity aDelegator, FluidStack aFluid,
            boolean aDoFill) {
            return fillAll_((IFluidHandler) aDelegator.mTileEntity, aDelegator.mSideOfTileEntity, aFluid, aDoFill);
        }

        @Deprecated
        public static boolean fillAll(IFluidHandler aFluidHandler, byte aSide, FluidStack aFluid, boolean aDoFill) {
            return aFluidHandler != null && aFluid != null && fillAll_(aFluidHandler, aSide, aFluid, aDoFill);
        }

        @Deprecated
        public static boolean fillAll_(IFluidHandler aFluidHandler, byte aSide, FluidStack aFluid, boolean aDoFill) {
            return aFluidHandler.fill(FORGE_DIR[aSide], aFluid, F) == aFluid.amount
                && (!aDoFill || aFluidHandler.fill(FORGE_DIR[aSide], aFluid, T) > 0);
        }

        @Deprecated
        public static boolean fillAll(IFluidHandler aFluidHandler, byte[] aSides, FluidStack aFluid, boolean aDoFill) {
            return aFluidHandler != null && aFluid != null && fillAll_(aFluidHandler, aSides, aFluid, aDoFill);
        }

        @Deprecated
        public static boolean fillAll_(IFluidHandler aFluidHandler, byte[] aSides, FluidStack aFluid, boolean aDoFill) {
            for (byte tSide : aSides) if (aFluidHandler.fill(FORGE_DIR[tSide], aFluid, F) == aFluid.amount
                && (!aDoFill || aFluidHandler.fill(FORGE_DIR[tSide], aFluid, T) > 0)) return T;
            return F;
        }

        @Deprecated
        public static long move(@SuppressWarnings("rawtypes") DelegatorTileEntity aFrom,
            @SuppressWarnings("rawtypes") DelegatorTileEntity aTo) {
            return move(aFrom, aTo, Integer.MAX_VALUE);
        }

        @Deprecated
        public static long move_(@SuppressWarnings("rawtypes") DelegatorTileEntity aFrom,
            @SuppressWarnings("rawtypes") DelegatorTileEntity aTo) {
            return move_(aFrom, aTo, Integer.MAX_VALUE);
        }

        @Deprecated
        public static long move(@SuppressWarnings("rawtypes") DelegatorTileEntity aFrom,
            @SuppressWarnings("rawtypes") DelegatorTileEntity aTo, long aMaxMoved) {
            return aFrom != null && aFrom.mTileEntity instanceof IFluidHandler
                && aTo != null
                && aTo.mTileEntity instanceof IFluidHandler ? move_(aFrom, aTo, aMaxMoved) : 0;
        }
        ...
        public static long move_(@SuppressWarnings("rawtypes") DelegatorTileEntity aFrom,
            ...
            FluidStack tDrained = ((IFluidHandler) aFrom.mTileEntity)
                .drain(aFrom.getForgeSideOfTileEntity(), UT.Code.bindInt(aMaxMoved), F);
            if (tDrained == null || tDrained.amount <= 0) return 0;
            tDrained.amount = Code.bindInt(UT.Fluids.fill_(aTo, tDrained.copy(), T));
        ...
        @Deprecated
        public static long move(@SuppressWarnings("rawtypes") DelegatorTileEntity aFrom,
            @SuppressWarnings("rawtypes") DelegatorTileEntity aTo, FluidStack aMoved) {
            return aFrom != null && aFrom.mTileEntity instanceof IFluidHandler
                && aTo != null
                && aTo.mTileEntity instanceof IFluidHandler ? move_(aFrom, aTo, aMoved) : 0;
        }

        @Deprecated
        public static long move_(@SuppressWarnings("rawtypes") DelegatorTileEntity aFrom,
            @SuppressWarnings("rawtypes") DelegatorTileEntity aTo, FluidStack aMoved) {
            if (aMoved == null || aMoved.amount <= 0) return 0;
            FluidStack tDrained = ((IFluidHandler) aFrom.mTileEntity)
                .drain(aFrom.getForgeSideOfTileEntity(), aMoved, F);
            if (tDrained == null || tDrained.amount <= 0) return 0;
            tDrained.amount = Code.bindInt(UT.Fluids.fill_(aTo, tDrained.copy(), T));
            if (tDrained.amount <= 0) return 0;
            ((IFluidHandler) aFrom.mTileEntity).drain(aFrom.getForgeSideOfTileEntity(), tDrained, T);
        ...
        @Deprecated
        public static long move(IFluidTank aFrom, @SuppressWarnings("rawtypes") DelegatorTileEntity aTo) {
            return move(aFrom, aTo, Integer.MAX_VALUE);
        }

        @Deprecated
        public static long move_(IFluidTank aFrom, @SuppressWarnings("rawtypes") DelegatorTileEntity aTo) {
            return move_(aFrom, aTo, Integer.MAX_VALUE);
        }
        ...
        public static long move(IFluidTank aFrom, @SuppressWarnings("rawtypes") DelegatorTileEntity aTo,
            long aMaxMoved) {
            return aFrom != null && aTo != null && aTo.mTileEntity instanceof IFluidHandler
                ? move_(aFrom, aTo, aMaxMoved)
                : 0;
        }
        ...
        public static long move_(IFluidTank[] aFrom, @SuppressWarnings("rawtypes") DelegatorTileEntity aTo,
            ...
            if (aMaxMoved <= 0) return 0;
            long rAmount = 0;
            for (IFluidTank tFrom : aFrom) if (tFrom != null) rAmount += move_(tFrom, aTo, aMaxMoved);
            return rAmount;
        }

        @Deprecated
        public static long move(@SuppressWarnings("rawtypes") Iterable aFrom,
            @SuppressWarnings("rawtypes") DelegatorTileEntity aTo) {
            return move(aFrom, aTo, Integer.MAX_VALUE);
        }

        @Deprecated
        public static long move_(@SuppressWarnings("rawtypes") Iterable aFrom,
            @SuppressWarnings("rawtypes") DelegatorTileEntity aTo) {
            return move_(aFrom, aTo, Integer.MAX_VALUE);
        }
        ...
        public static long move_(@SuppressWarnings("rawtypes") Iterable aFrom,
            ...
            for (Object tFrom : aFrom)
                if (tFrom instanceof IFluidTank) rAmount += move_((IFluidTank) tFrom, aTo, aMaxMoved);
            return rAmount;
        }
        ...
        public static String name(Fluid aFluid, boolean aLocalized) {
            ...
            if (rName.contains("fluid.") || rName.contains("tile.")) return Code.capitalise(
                rName.replaceAll("fluid.", "")
                    .replaceAll("tile.", ""));
            return rName;
        }
        ...
        @Deprecated
        public static final Map<ItemStackContainer, FluidContainerData> sFilled2Data = FL.FULL_TO_DATA;
        @Deprecated
        public static final Map<ItemStackContainer, Map<String, FluidContainerData>> sEmpty2Fluid2Data = FL.EMPTY_TO_FLUID_TO_DATA;
        ...
        @Deprecated
        public static void registerFluidContainer(FluidStack aFluid, ItemStack aFull, ItemStack aEmpty,
            boolean aOverrideFillingEmpty, boolean aOverrideDrainingFull) {
        ...
        @Deprecated
        public static void registerFluidContainer(FluidStack aFluid, ItemStack aFull, ItemStack aEmpty,
            boolean aNullEmpty, boolean aOverrideFillingEmpty, boolean aOverrideDrainingFull) {
            if (aFluid == null || ST.invalid(aFull)) return;
            registerFluidContainer(
                new FluidContainerData(aFluid, aFull, aEmpty, aNullEmpty),
                aOverrideFillingEmpty,
                aOverrideDrainingFull);
        }
        ...
        @Deprecated
        public static void registerFluidContainer(FluidContainerData aData, boolean aOverrideFillingEmpty,
            boolean aOverrideDrainingFull) {
        ...
        @Deprecated
        public static void setFluidContainerData(FluidContainerData aData, boolean aOverrideFillingEmpty,
            boolean aOverrideDrainingFull) {
            ItemStackContainer tFilled = new ItemStackContainer(aData.filledContainer),
                tEmpty = new ItemStackContainer(aData.emptyContainer);
            ...
            String tFluidName = aData.fluid.getFluid()
                .getName();
        ...
        @Deprecated
        public static ItemStack fillFluidContainer(FluidStack aFluid, ItemStack aStack, boolean aRemoveFluidDirectly,
            boolean aCheckIFluidContainerItems, boolean aAllowPartialFilling) {
            return fillFluidContainer(
                aFluid,
                aStack,
                aRemoveFluidDirectly,
                aCheckIFluidContainerItems,
                aAllowPartialFilling,
                T);
        }

        @Deprecated
        public static ItemStack fillFluidContainer(FluidStack aFluid, ItemStack aStack, boolean aRemoveFluidDirectly,
            boolean aCheckIFluidContainerItems, boolean aAllowPartialFilling, boolean aIsNonCannerCheck) {
            ...
            if (aIsNonCannerCheck && IL.GC_Canister.exists()
                && (IL.GC_Canister.equal(aStack, T, T) || ST.equal(ST.container(aStack, T), IL.GC_Canister.wild(1))))
                return aStack;
            if (aCheckIFluidContainerItems && aStack.getItem() instanceof IFluidContainerItem
                ...
                && (((IFluidContainerItem) aStack.getItem()).getFluid(aStack) == null
                    || (Fluids.equal(((IFluidContainerItem) aStack.getItem()).getFluid(aStack), aFluid)
                        && ((IFluidContainerItem) aStack.getItem()).getFluid(aStack).amount
                            < ((IFluidContainerItem) aStack.getItem()).getCapacity(aStack)))
                && (aAllowPartialFilling
                    || ((IFluidContainerItem) aStack.getItem()).getCapacity(aStack) <= aFluid.amount)) {
                if (IL.Cell_Universal_Fluid.equal(aStack, T, T)
                    && (temperature(aFluid, DEF_ENV_TEMP) > MT.Sn.mMeltingPoint || !simple(aFluid)
                        || acid(aFluid)
                        || powerconducting(aFluid)))
                    return aStack;
                if (aRemoveFluidDirectly) aFluid.amount -= ((IFluidContainerItem) aStack.getItem())
                    .fill(aStack = ST.amount(1, aStack), aFluid, T);
                else((IFluidContainerItem) aStack.getItem()).fill(aStack = ST.amount(1, aStack), aFluid, T);
                return aStack;
            }
        ...
        @Deprecated
        public static ItemStack fillFluidContainer(IFluidTank aTank, ItemStack aStack, boolean aRemoveFluidDirectly,
            boolean aCheckIFluidContainerItems) {
            ...
            if (aCheckIFluidContainerItems && aStack.getItem() instanceof IFluidContainerItem
                ...
                if (IL.Cell_Universal_Fluid.equal(aStack, T, T)
                    && (temperature(aFluid, DEF_ENV_TEMP) > MT.Sn.mMeltingPoint || !simple(aFluid)
                        ...
                        || powerconducting(aFluid)))
                    return aStack;
                if (aRemoveFluidDirectly) aTank
                    .drain(((IFluidContainerItem) aStack.getItem()).fill(aStack = ST.amount(1, aStack), aFluid, T), T);
                else((IFluidContainerItem) aStack.getItem()).fill(aStack = ST.amount(1, aStack), aFluid, T);
                return aStack;
            }
            Map<String, FluidContainerData> tFluidToContainer = sEmpty2Fluid2Data.get(new ItemStackContainer(aStack));
        ...
        public static boolean containsFluid(ItemStack aStack, FluidStack aFluid, boolean aCheckIFluidContainerItems) {
            ...
            if (aCheckIFluidContainerItems && aStack.getItem() instanceof IFluidContainerItem
                && ((IFluidContainerItem) aStack.getItem()).getCapacity(aStack) > 0)
                return aFluid
                    .isFluidEqual(((IFluidContainerItem) aStack.getItem()).getFluid(aStack = ST.amount(1, aStack)));
        ...
        public static FluidStack getFluidForFilledItem(ItemStack aStack, boolean aCheckIFluidContainerItems) {
            ...
            if (aCheckIFluidContainerItems && aStack.getItem() instanceof IFluidContainerItem
                && ((IFluidContainerItem) aStack.getItem()).getCapacity(aStack) > 0) {
                FluidStack rFluid = ((IFluidContainerItem) aStack.getItem())
                    .drain(ST.amount(1, aStack), Integer.MAX_VALUE, T);
                if (IL.Cell_Universal_Fluid.equal(aStack, T, T)
                    && (temperature(rFluid, DEF_ENV_TEMP) > MT.Sn.mMeltingPoint || !simple(rFluid)
                        || acid(rFluid)
                        || powerconducting(rFluid)))
                    return NF;
                return rFluid;
            }
            FluidContainerData tData = sFilled2Data.get(new ItemStackContainer(aStack));
        ...
        public static ItemStack getContainerForFilledItem(ItemStack aStack, boolean aCheckIFluidContainerItems) {
            ...
            if (aCheckIFluidContainerItems && aStack.getItem() instanceof IFluidContainerItem
                ...
                if (aStack.getTagCompound()
                    .hasNoTags()) aStack.setTagCompound(null);
                return aStack;
            }
            return NI;
        }
        ...
        public static Fluid createLiquid(OreDictMaterial aMaterial, Set<String>... aFluidList) {
            return createLiquid(aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_MOLTEN), aFluidList);
        }

        @Deprecated
        @SafeVarargs
        public static Fluid createLiquid(OreDictMaterial aMaterial, IIconContainer aTexture,
            Set<String>... aFluidList) {
            return create(
                aMaterial.mNameInternal.toLowerCase(),
                aTexture,
                aMaterial.mNameLocal,
                aMaterial,
                aMaterial.mRGBaLiquid,
                STATE_LIQUID,
                1000,
                aMaterial.mMeltingPoint <= 0 ? 1000
                    : aMaterial.mMeltingPoint < 300 ? Math.min(300, aMaterial.mBoilingPoint - 1)
        ...
        public static Fluid createMolten(OreDictMaterial aMaterial, Set<String>... aFluidList) {
            return createMolten(aMaterial, L, aFluidList);
        }

        @Deprecated
        @SafeVarargs
        public static Fluid createMolten(OreDictMaterial aMaterial, IIconContainer aTexture,
            Set<String>... aFluidList) {
            return createMolten(aMaterial, L, aTexture, aFluidList);
        }
        ...
        public static Fluid createMolten(OreDictMaterial aMaterial, long aAmount, Set<String>... aFluidList) {
            return createMolten(
                aMaterial,
                aAmount,
                aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_MOLTEN),
                aFluidList);
        }

        @Deprecated
        @SafeVarargs
        public static Fluid createMolten(OreDictMaterial aMaterial, long aAmount, IIconContainer aTexture,
            Set<String>... aFluidList) {
            return create(
                "molten." + aMaterial.mNameInternal.toLowerCase(),
                aTexture,
                "Molten " + aMaterial.mNameLocal,
                aMaterial,
                aMaterial.mRGBaLiquid,
                STATE_LIQUID,
                aAmount,
                ...
                null,
                0,
                aFluidList).setLuminosity(10);
        }

        @Deprecated
        @SafeVarargs
        public static Fluid createGas(OreDictMaterial aMaterial, Set<String>... aFluidList) {
            return createGas(aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_GAS), aFluidList);
        }
        ...
        public static Fluid createGas(OreDictMaterial aMaterial, IIconContainer aTexture, Set<String>... aFluidList) {
            return create(
                ...
                STATE_GASEOUS,
                1000,
                aMaterial.mBoilingPoint <= 0 ? 3000
                    : aMaterial.mBoilingPoint < 300 ? Math.min(300, aMaterial.mPlasmaPoint - 1)
                        : aMaterial.mBoilingPoint,
                null,
                null,
                0,
                aFluidList);
        ...
        public static Fluid createVapour(OreDictMaterial aMaterial, Set<String>... aFluidList) {
            return createVapour(aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_GAS), aFluidList);
        }

        @Deprecated
        @SafeVarargs
        public static Fluid createVapour(OreDictMaterial aMaterial, IIconContainer aTexture,
            Set<String>... aFluidList) {
            return create(
                "vapor." + aMaterial.mNameInternal.toLowerCase(),
                aTexture,
                "Vaporized " + aMaterial.mNameLocal,
                aMaterial,
                aMaterial.mRGBaGas,
                STATE_GASEOUS,
                8 * L,
        ...
        public static Fluid createPlasma(OreDictMaterial aMaterial, Set<String>... aFluidList) {
            return createPlasma(aMaterial, aMaterial.mTextureSetsBlock.get(IconsGT.INDEX_BLOCK_PLASMA), aFluidList);
        }

        @Deprecated
        @SafeVarargs
        public static Fluid createPlasma(OreDictMaterial aMaterial, IIconContainer aTexture,
            Set<String>... aFluidList) {
            return create(
                "plasma." + aMaterial.mNameInternal.toLowerCase(),
                aTexture,
                aMaterial.mNameLocal + " Plasma",
                aMaterial,
                aMaterial.mRGBaPlasma,
                STATE_PLASMA,
                L * L,
                aMaterial.mPlasmaPoint <= 0 ? 10000 : Math.max(300, aMaterial.mPlasmaPoint),
                null,
                null,
                0,
                aFluidList);
        ...
        @Deprecated
        @SafeVarargs
        public static Fluid create(String aName, String aLocalized, OreDictMaterial aMaterial, int aState,
            long aAmountPerUnit, long aTemperatureK, Set<String>... aFluidList) {
            return create(
                aName,
                aLocalized,
                aMaterial,
        ...
        @SafeVarargs
        public static Fluid create(String aName, String aLocalized, OreDictMaterial aMaterial, int aState,
            long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer, ItemStack aEmptyContainer,
            int aFluidAmount, Set<String>... aFluidList) {
            return create(
                aName,
                new Textures.BlockIcons.CustomIcon("fluids/" + aName.toLowerCase()),
                aLocalized,
                aMaterial,
                null,
                aState,
        ...
        @Deprecated
        @SafeVarargs
        public static Fluid create(String aName, IIconContainer aTexture, String aLocalized, OreDictMaterial aMaterial,
            short[] aRGBa, int aState, long aAmountPerUnit, long aTemperatureK, ItemStack aFullContainer,
            ItemStack aEmptyContainer, int aFluidAmount, Set<String>... aFluidList) {
            aName = aName.toLowerCase();
            Fluid rFluid = new FluidGT(
                aName,
                aTexture,
                aRGBa == null ? UNCOLOURED : aRGBa,
                aTemperatureK,
                aState == 2 || aState == 3);
            ...
            if (aMaterial != null) {
                ...
                switch (aState) {
                    case STATE_LIQUID:
                        aMaterial.liquid(UT.Fluids.make(rFluid, UT.Code.bindInt(aAmountPerUnit)));
                        break;
                    case STATE_GASEOUS:
                        aMaterial.gas(UT.Fluids.make(rFluid, UT.Code.bindInt(aAmountPerUnit)));
                        break;
                    case STATE_PLASMA:
                        aMaterial.plasma(UT.Fluids.make(rFluid, UT.Code.bindInt(aAmountPerUnit)));
                        break;
                }
            ...
            if (aFullContainer != null && aEmptyContainer != null
                && !FluidContainerRegistry
                    .registerFluidContainer(UT.Fluids.make(rFluid, aFluidAmount), aFullContainer, aEmptyContainer)) {
                RM.Canner.addRecipe1(
                    T,
                    16,
                    Math.max(aFluidAmount / 64, 16),
                    aFullContainer,
                    NF,
                    UT.Fluids.make(rFluid, aFluidAmount),
                    ST.container(aFullContainer, F));
            }
            return rFluid;
        }
    }
    ...
    public static class Books {
        ...
        public static void display(EntityPlayer aPlayer, ItemStack aStack) {
            ...
            if (Code.stringValid(aMapping)) display(aPlayer, aMapping);
            else display(aPlayer, F, aStack);
        }
        ...
        public static ItemStack getWrittenBook(String aMapping) {
            return getWrittenBook(aMapping, F, null);
        }

        @Deprecated
        public static ItemStack getWrittenBook(String aMapping, ItemStack aStackToPutNBT) {
            return getWrittenBook(aMapping, F, aStackToPutNBT);
        }
        ...
        public static ItemStack getWrittenBook(String aMapping, boolean aForceRecreation, ItemStack aStackToPutNBT) {
            ...
            if (aForceRecreation && aMapping.startsWith("Material_Dictionary_")) UT.Books.createMaterialDictionary(
                OreDictMaterial.MATERIAL_MAP.get(aMapping.replaceFirst("Material_Dictionary_", "")),
                NI,
                NI);
            ...
            return NBT.set(
                aStackToPutNBT,
                (NBTTagCompound) tStack.getTagCompound()
                    .copy());
        }
        ...
        public static ItemStack getBookWithTitle(String aMapping, ItemStack aStackToPutNBT) {
            ...
            return NBT.set(
                aStackToPutNBT,
                NBT.make("title", NBT.getBookTitle(tStack), "author", NBT.getBookAuthor(tStack), "book", aMapping));
        }

        public static ItemStack createWrittenBook(String aMapping, String aTitle, String aAuthor,
            ItemStack aDefaultBook, String... aPages) {
        ...
        public static ItemStack createWrittenBook(String aMapping, String aTitle, String aAuthor,
            ItemStack aDefaultBook, boolean aLogging, String... aPages) {
            if (Code.stringInvalid(aMapping)) return null;
            ItemStack rStack = BOOK_MAP.get(aMapping);
            if (rStack == null)
                rStack = aDefaultBook == null ? ST.make(Items.written_book, 1, 0) : ST.amount(1, aDefaultBook);
        ...
        public static ItemStack addMaterialDictionary(OreDictMaterial aMat) {
            ...
            if (aMat.mDescription != null)
                for (int i = 0; i < aMat.mDescription.length; i++) if (Code.stringValid(aMat.mDescription[i])) tPages++;

            for (TagData tTag : TD.Properties.ALL_RELEVANTS) if (aMat.contains(tTag)) {
                tPages++;
                break;
            }
            for (TagData tTag : TD.Processing.ALL_MACHINES) if (aMat.contains(tTag)) {
                tPages++;
                break;
            }
            for (TagData tTag : TD.Processing.ALL_ORES) if (aMat.contains(tTag)) {
                tPages++;
                break;
            }
            ...
            for (OreDictMaterial tMat : OreDictMaterial.MATERIAL_MAP.values())
                if (tMat.mComponents != null && tMat.contains(TD.Compounds.DECOMPOSABLE)) {
                    for (OreDictMaterialStack tMt2 : tMat.mComponents.getUndividedComponents())
                        if (tMt2.mMaterial == aMat) {
                            temp = !(tCounter++ % 6 == 5);
                            if (!temp) tPages++;
                            break;
                        }
            ...
            for (OreDictMaterial tMat : aMat.mTargetedSmelting)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetSmelting.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedSolidifying)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetSolidifying.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedBurning)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetBurning.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedPulver)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetPulver.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedBending)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetBending.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedCompressing)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetCompressing.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedCrushing)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetCrushing.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedCutting)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetCutting.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedForging)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetForging.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedSmashing)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetSmashing.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            for (OreDictMaterial tMat : aMat.mTargetedWorking)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetWorking.has(aMat)) {
                    temp = !(tCounter++ % 6 == 5);
                    if (!temp) tPages++;
                }
            if (temp) {
            ...
            createWrittenBook(
                "Material_Dictionary_" + aMat.mNameInternal,
                aMat.getLocal(),
                "Material Dictionary Foundation",
                ST.make(ItemsGT.BOOKS, 1, tPages <= 50 ? 32002 : 32003),
                F,
                "If you can read this in a legitimate Material Dictionary, even if it is old, then this is a Bug, please report this to me!\n\nGregorius\nTechneticies\n\n2021");
            return ST.copy(aMat.mDictionaryBook = ST.book("Material_Dictionary_" + aMat.mNameInternal));
        }

        public static boolean createMaterialDictionary(OreDictMaterial aMat, ItemStack aDefaultBook,
            ItemStack aDefaultLargeBook) {
            ...
            tBook.add(
                "===================\n" + aMat.getLocal()
                    ...
                    + aMat.mPlasmaPoint
                    + " K\n===================\nDensity:\n"
                    + (aMat.mGramPerCubicCentimeter == 0 ? "???" : aMat.mGramPerCubicCentimeter)
                    + " g/cm3\n"
                    + aMat.getWeight(U)
                    + " kg/unit\n===================\n");
            ...
            if (aMat.mComponents == null) {
                if (aMat.contains(TD.Atomic.ELEMENT)) {
                    ...
                    for (TagData tTag : TD.Atomic.ALL)
                        if (tTag != TD.Atomic.ELEMENT && tTag != TD.Atomic.NONMETAL && aMat.contains(tTag))
                            tPage += tTag.getLocalisedNameLong() + "\n";
                }
            } else {
                temp = T;
                ...
                for (OreDictMaterialStack tMaterial : aMat.mComponents.getUndividedComponents())
                    tPage += (tMaterial.mAmount / U) + " " + tMaterial.mMaterial.getLocal() + "\n";
            }
            ...
            if (!aMat.mEnchantmentTools.isEmpty()) {
                ...
                for (ObjectStack<Enchantment> tEnchantment : aMat.mEnchantmentTools)
                    tPage += tEnchantment.mObject.getTranslatedName((int) tEnchantment.mAmount) + "\n";
                tBook.add(tPage + "===================\n");
            }
            if (!aMat.mEnchantmentWeapons.isEmpty()) {
                tPage = "Weapon Enchantments\n===================\n";
                for (ObjectStack<Enchantment> tEnchantment : aMat.mEnchantmentWeapons)
                    tPage += tEnchantment.mObject.getTranslatedName((int) tEnchantment.mAmount) + "\n";
                tBook.add(tPage + "===================\n");
            }
            if (!aMat.mEnchantmentAmmo.isEmpty()) {
                tPage = "Ammo Enchantments\n===================\n";
                for (ObjectStack<Enchantment> tEnchantment : aMat.mEnchantmentAmmo)
                    tPage += tEnchantment.mObject.getTranslatedName((int) tEnchantment.mAmount) + "\n";
                tBook.add(tPage + "===================\n");
            }
            if (!aMat.mEnchantmentRanged.isEmpty()) {
                tPage = "Ranged Enchantments\n===================\n";
                for (ObjectStack<Enchantment> tEnchantment : aMat.mEnchantmentRanged)
                    tPage += tEnchantment.mObject.getTranslatedName((int) tEnchantment.mAmount) + "\n";
                tBook.add(tPage + "===================\n");
            }
            if (!aMat.mEnchantmentFishing.isEmpty()) {
                tPage = "Fishing Enchantments\n===================\n";
                for (ObjectStack<Enchantment> tEnchantment : aMat.mEnchantmentFishing)
                    tPage += tEnchantment.mObject.getTranslatedName((int) tEnchantment.mAmount) + "\n";
                tBook.add(tPage + "===================\n");
            }
            if (!aMat.mEnchantmentArmors.isEmpty()) {
                tPage = "Armor Enchantments\n===================\n";
                for (ObjectStack<Enchantment> tEnchantment : aMat.mEnchantmentArmors)
                    tPage += tEnchantment.mObject.getTranslatedName((int) tEnchantment.mAmount) + "\n";
                tBook.add(tPage + "===================\n");
            }
            ...
            tPage += "Smelting:\n" + (aMat.mTargetSmelting.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetSmelting.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetSmelting.mAmount <= 0 ? "nothing"
                    : aMat.mTargetSmelting.mMaterial == aMat ? "itself" : aMat.mTargetSmelting.mMaterial.getLocal())
                + "\n";
            tPage += "Solidifying:\n" + (aMat.mTargetSolidifying.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetSolidifying.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetSolidifying.mAmount <= 0 ? "nothing"
                    : aMat.mTargetSolidifying.mMaterial == aMat ? "itself"
                        : aMat.mTargetSolidifying.mMaterial.getLocal())
                + "\n";
            tPage += "Burning:\n" + (aMat.mTargetBurning.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetBurning.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetBurning.mAmount <= 0 ? "nothing"
                    : aMat.mTargetBurning.mMaterial == aMat ? "itself" : aMat.mTargetBurning.mMaterial.getLocal())
                + "\n";
            tPage += "Pulverising:\n" + (aMat.mTargetPulver.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetPulver.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetPulver.mAmount <= 0 ? "nothing"
                    : aMat.mTargetPulver.mMaterial == aMat ? "itself" : aMat.mTargetPulver.mMaterial.getLocal())
                + "\n";
            tPage += "Crushing:\n" + (aMat.mTargetCrushing.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetCrushing.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetCrushing.mAmount <= 0 ? "nothing"
                    : aMat.mTargetCrushing.mMaterial == aMat ? "itself" : aMat.mTargetCrushing.mMaterial.getLocal())
                + "\n";
            ...
            tPage = "Processing Data\n===================\n";
            tPage += "Bending:\n" + (aMat.mTargetBending.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetBending.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetBending.mAmount <= 0 ? "nothing"
                    : aMat.mTargetBending.mMaterial == aMat ? "itself" : aMat.mTargetBending.mMaterial.getLocal())
                + "\n";
            tPage += "Compressing:\n" + (aMat.mTargetCompressing.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetCompressing.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetCompressing.mAmount <= 0 ? "nothing"
                    : aMat.mTargetCompressing.mMaterial == aMat ? "itself"
                        : aMat.mTargetCompressing.mMaterial.getLocal())
                + "\n";
            tPage += "Cutting:\n" + (aMat.mTargetCutting.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetCutting.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetCutting.mAmount <= 0 ? "nothing"
                    : aMat.mTargetCutting.mMaterial == aMat ? "itself" : aMat.mTargetCutting.mMaterial.getLocal())
                + "\n";
            tPage += "Forging:\n" + (aMat.mTargetForging.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetForging.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetForging.mAmount <= 0 ? "nothing"
                    : aMat.mTargetForging.mMaterial == aMat ? "itself" : aMat.mTargetForging.mMaterial.getLocal())
                + "\n";
            tPage += "Smashing:\n" + (aMat.mTargetSmashing.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetSmashing.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetSmashing.mAmount <= 0 ? "nothing"
                    : aMat.mTargetSmashing.mMaterial == aMat ? "itself" : aMat.mTargetSmashing.mMaterial.getLocal())
                + "\n";
            ...
            tPage = "Processing Data\n===================\n";
            tPage += "Working:\n" + (aMat.mTargetWorking.mAmount / U)
                + "."
                + ((int) (((double) (aMat.mTargetWorking.mAmount % U) / (double) U) * 1000))
                + " "
                + (aMat.mTargetWorking.mAmount <= 0 ? "nothing"
                    : aMat.mTargetWorking.mMaterial == aMat ? "itself" : aMat.mTargetWorking.mMaterial.getLocal())
                + "\n";
            ...
            if (aMat.mAspects.isEmpty()) {
                ...
                for (TC_AspectStack tAspect : aMat.mAspects)
                    tPage += tAspect.mAmount + "x " + tAspect.mAspect.mName + "\n";
            }
            ...
            for (OreDictMaterial tMat : aMat.mTargetedSmelting)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetSmelting.has(aMat))
                    tMap.put(tMat, tMat.mTargetSmelting.mAmount);
            ...
            for (Entry<OreDictMaterial, Long> tEntry : tMap.entrySet()) {
                temp = !(tCounter++ % 6 == 5);
                tPage += (tEntry.getValue() / U) + "."
                    + ((int) (((double) (tEntry.getValue() % U) / (double) U) * 1000))
                    + " from 1 "
                    + tEntry.getKey()
                        .getLocal()
                    + "\n";
            ...
            for (OreDictMaterial tMat : aMat.mTargetedSolidifying)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetSolidifying.has(aMat))
                    tMap.put(tMat, tMat.mTargetSolidifying.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedBurning)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetBurning.has(aMat))
                    tMap.put(tMat, tMat.mTargetBurning.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedPulver)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetPulver.has(aMat))
                    tMap.put(tMat, tMat.mTargetPulver.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedBending)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetBending.has(aMat))
                    tMap.put(tMat, tMat.mTargetBending.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedCompressing)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetCompressing.has(aMat))
                    tMap.put(tMat, tMat.mTargetCompressing.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedCrushing)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetCrushing.has(aMat))
                    tMap.put(tMat, tMat.mTargetCrushing.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedCutting)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetCutting.has(aMat))
                    tMap.put(tMat, tMat.mTargetCutting.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedForging)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetForging.has(aMat))
                    tMap.put(tMat, tMat.mTargetForging.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedSmashing)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetSmashing.has(aMat))
                    tMap.put(tMat, tMat.mTargetSmashing.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (OreDictMaterial tMat : aMat.mTargetedWorking)
                if (tMat.mTargetRegistration == tMat && tMat != aMat && tMat.mTargetWorking.has(aMat))
                    tMap.put(tMat, tMat.mTargetWorking.mAmount);
            tMap = Code.sortByValuesDescending(tMap);
            ...
            for (IOreDictConfigurationComponent tConfig : aMat.mAlloyCreationRecipes) {
                tPage = "Alloy:\n" + aMat.getLocal()
                    ...
                    + aMat.mBoilingPoint
                    + " K\n===================\nComponents per "
                    + tConfig.getCommonDivider()
                    + "\n";
                for (OreDictMaterialStack tMt2 : tConfig.getUndividedComponents())
                    tPage += (tMt2.mAmount / U) + " " + tMt2.mMaterial.getLocal() + "\n";
                tBook.add(tPage);
            }
            ...
            if (aMat.mDescription != null)
                for (int i = 0, j = 0; i < aMat.mDescription.length; i++) if (Code.stringValid(aMat.mDescription[i]))
                    tBook.add("Description Pg " + (++j) + "\n===================\n" + aMat.mDescription[i]);

            // ----------

            return null != createWrittenBook(
                "Material_Dictionary_" + aMat.mNameInternal,
                aMat.getLocal(),
                "Material Dictionary Foundation",
                tBook.size() <= 50
                    ? (ST.valid(aDefaultBook) ? ST.amount(1, aDefaultBook) : ST.make(ItemsGT.BOOKS, 1, 32002))
                    : (ST.valid(aDefaultLargeBook) ? ST.amount(1, aDefaultLargeBook)
                        : ST.make(ItemsGT.BOOKS, 1, 32003)),
                F,
                tBook.toArray(ZL_STRING));
        }
    }
    ...
    public static class Code {
        ...
        public static long combine(byte aValue1, byte aValue2, byte aValue3, byte aValue4, byte aValue5, byte aValue6,
            byte aValue7, byte aValue8) {
            return ((long) aValue1 & 0xff) | ((long) aValue2 & 0xff) << 8
                | ((long) aValue3 & 0xff) << 16
                | ((long) aValue4 & 0xff) << 24
                | ((long) aValue5 & 0xff) << 32
                | ((long) aValue6 & 0xff) << 40
                | ((long) aValue7 & 0xff) << 48
                | (long) aValue8 << 56;
        }
        ...
        public static UUID getUUID(byte[] aData, int aOffset) {
            return aData.length - aOffset < 16 ? null
                : new UUID(
                    combine(
                        aData[aOffset],
                        aData[aOffset + 1],
        ...
        public static <E> E select(E aReplacement, List<E> aList) {
            return aList == null || aList.isEmpty() ? aReplacement
                : select(RNGSUS.nextInt(aList.size()), aReplacement, aList);
        }
        ...
        public static <E> E select(E aReplacement, E... aArray) {
            return aArray == null || aArray.length <= 0 ? aReplacement
                : select(RNGSUS.nextInt(aArray.length), aReplacement, aArray);
        }
        ...
        /**
         * @return a Value for a Scale between 0 and aMax with aScale+1 possible Steps. 0 is only returned if the aValue
         *         is <= 0, aScale is only returned if the Value is >= aMax. The remaining values between ]0:aScale[ are
         *         returned for each Step of the Scale. This Function finds use in Displays such as the Barometer, but
         *         also in Redstone.
         */
        public static long scale(long aValue, long aMax, long aScale, boolean aInvert) {
            long rScale = (aValue <= 0 ? 0
                : aValue >= aMax ? aScale : aScale <= 2 ? 1 : 1 + (aValue * (aScale - 1)) / aMax);
            return aInvert ? aScale - rScale : rScale;
        }

        /**
         * @return a Value for a Scale between aMin and aMax with aScale+1 possible Steps. 0 is only returned if the
         *         aValue is <= aMin, aScale is only returned if the Value is >= aMax. The remaining values between
         *         ]0:aScale[ are returned for each Step of the Scale. This Function finds use in Displays such as the
         *         Barometer, but also in Redstone.
         */
        ...
        public static long bind(long aMin, long aMax, long aBoundValue) {
            return aMin > aMax ? Math.max(aMax, Math.min(aMin, aBoundValue))
                : Math.max(aMin, Math.min(aMax, aBoundValue));
        }
        ...
        public static int getRGBInt(short[] aColors) {
            return aColors == null ? 16777215
                : (bind8(aColors[0]) << 16) | (bind8(aColors[1]) << 8) | bind8(aColors[2]);
        }

        public static int getRGBaInt(short[] aColors) {
            return aColors == null ? 16777215
                : (bind8(aColors[0]) << 16) | (bind8(aColors[1]) << 8) | bind8(aColors[2]) | (bind8(aColors[3]) << 24);
        }
        ...
        public static short[] getRGBaArray(int aColors) {
            return new short[] { (short) ((aColors >>> 16) & 255), (short) ((aColors >>> 8) & 255),
                (short) (aColors & 255), (short) ((aColors >>> 24) & 255) };
        }
        ...
        public static short[] color(ItemStack aStack) {
            ...
            try {
                ...
                return UNCOLOURED;
            } // And ofcourse some Mod needs to crash here...
            ...
            short[] rModulation = getRGBaArray(
                aStack.getItem()
                    .getColorFromItemStack(aStack, 0));
        ...
        public static short[] color(String aResourceLocation) {
            ...
            try {
                tIcon = javax.imageio.ImageIO.read(
        ...
        public static String capitalise(String aString) {
            return aString == null ? ""
                : aString.length() <= 1 ? aString.toUpperCase()
        ...
        public static String capitaliseWords(String aString) {
            StringBuilder rString = new StringBuilder();
            for (String tString : aString.split(" ")) if (!tString.isEmpty()) rString.append(capitalise(tString))
                .append(" ");
            return rString.toString()
                .trim();
        }
        ...
        public static String displayUnits(long aAmount) {
            ...
            return (aAmount / U) + "."
                + (tDigits < 1 ? "000" : tDigits < 10 ? "00" + tDigits : tDigits < 100 ? "0" + tDigits : tDigits);
        }
        ...
        public static long units(long aAmount, long aOriginalUnit, long aTargetUnit, boolean aRoundUp) {
            ...
            return Math.max(
                0,
                ((aAmount * aTargetUnit) / aOriginalUnit)
                    + (aRoundUp && (aAmount * aTargetUnit) % aOriginalUnit > 0 ? 1 : 0));
        }
        ...
        /**
         * @return an Array containing the X and the Y Coordinate of the clicked Point, with the top left Corner as
         *         Origin, like on the Texture Sheet. return values should always be between [0.0F and 0.99F].
         */
        public static float[] getFacingCoordsClicked(byte aSide, float aHitX, float aHitY, float aHitZ) {
            switch (aSide) {
                ...
                case 2:
                    return new float[] { Math.min(0.99F, Math.max(0, 1 - aHitX)),
                        Math.min(0.99F, Math.max(0, 1 - aHitY)) };
                case 3:
                ...
                case 5:
                    return new float[] { Math.min(0.99F, Math.max(0, 1 - aHitZ)),
                        Math.min(0.99F, Math.max(0, 1 - aHitY)) };
                default:
        ...
        public static byte getOppositeSideForPlayerPlacing(Entity aPlayer, byte aDefaultFacing,
    ...
    public static class NBT {
        ...
        public static NBTTagCompound make(String aFirstKey, Object aFirstValue, Object... aTags) {
            ...
            if (aFirstValue == null) {/* Nothing */} else
                if (aFirstValue instanceof Boolean) rNBT.setBoolean(aFirstKey, (Boolean) aFirstValue);
                ...
                else if (aFirstValue instanceof RecipeMap)
                    rNBT.setString(aFirstKey, ((RecipeMap) aFirstValue).mNameInternal);
                else rNBT.setString(aFirstKey, aFirstValue.toString());

            for (int i = 1; i < aTags.length; i += 2) {
                if (aTags[i] == null) {/* Nothing */} else
                    if (aTags[i] instanceof Boolean) rNBT.setBoolean(aTags[i - 1].toString(), (Boolean) aTags[i]);
                    ...
                    else if (aTags[i] instanceof FluidStack)
                        rNBT.setTag(aTags[i - 1].toString(), FL.save((FluidStack) aTags[i]));
                    else if (aTags[i] instanceof OreDictMaterial)
                        rNBT.setString(aTags[i - 1].toString(), ((OreDictMaterial) aTags[i]).mNameInternal);
                    else if (aTags[i] instanceof RecipeMap)
                        rNBT.setString(aTags[i - 1].toString(), ((RecipeMap) aTags[i]).mNameInternal);
        ...
        public static NBTTagCompound make(NBTTagCompound aNBT, Object... aTags) {
            ...
            for (int i = 1; i < aTags.length; i += 2) {
                if (aTags[i] == null) {/* Nothing */} else
                    if (aTags[i] instanceof Boolean) aNBT.setBoolean(aTags[i - 1].toString(), (Boolean) aTags[i]);
                        ...
                        aNBT.setTag(aTags[i - 1].toString(), FL.save((FluidStack) aTags[i]));
                    else if (aTags[i] instanceof OreDictMaterial)
                        aNBT.setString(aTags[i - 1].toString(), ((OreDictMaterial) aTags[i]).mNameInternal);
                    else if (aTags[i] instanceof RecipeMap)
                        aNBT.setString(aTags[i - 1].toString(), ((RecipeMap) aTags[i]).mNameInternal);
        ...
        public static NBTTagList makeInv(ItemStack... aStacks) {
            ...
            for (int i = 0; i < aStacks.length; i++)
                if (ST.valid(aStacks[i])) rInventory.appendTag(makeShort(ST.save(aStacks[i]), "s", (short) i));
            return rInventory;
        }
        ...
        /**
         * Saves on Data Size by choosing the smallest possible Data Type, and by also not adding zeros. The regular
         * getLong() Function can also get the other Number Types.
         */
        public static NBTTagCompound setNumber(NBTTagCompound aNBT, Object aTag, long aValue) {
            ...
            if (aValue > Short.MAX_VALUE || aValue < Short.MIN_VALUE) {
                aNBT.setInteger(aTag.toString(), (int) aValue);
                return aNBT;
            }
            if (aValue > Byte.MAX_VALUE || aValue < Byte.MIN_VALUE) {
        ...
        /**
         * Saves on Data Size by choosing the smallest possible Data Type, and by also not adding zeros or negative
         * Numbers. The regular getLong() Function can also get the other Number Types.
         */
        ...
        public static ItemStack set(ItemStack aStack, NBTTagCompound aNBT) {
            ...
            for (Object tKey : aNBT.func_150296_c()) {
                ...
                if (tValue == null || (tValue instanceof NBTTagCompound && ((NBTTagCompound) tValue).hasNoTags())
                    || (tValue instanceof NBTPrimitive && ((NBTPrimitive) tValue).func_150291_c() == 0)
                    || (tValue instanceof NBTTagString && Code.stringInvalid(((NBTTagString) tValue).func_150285_a_())))
        ...
        public static List<String> getDataToolTip(NBTTagCompound aData, List<String> aList, boolean aAllDetails) {
            ...
            if (aData.hasKey(NBT_CANVAS_BLOCK)) {
                aList.add(
                    LH.Chat.CYAN + "Block Image: "
                        + ST.names(
                            ST.make(
                                Block.getBlockById(aData.getInteger(NBT_CANVAS_BLOCK)),
                                1,
                                aData.getInteger(NBT_CANVAS_META))));
                return aList;
            }
                    ...
                    if (tMaterial.contains(TD.Processing.UUM)) {
                        if (aAllDetails) {
                            ...
                            if (tMaterial.contains(TD.Atomic.ANTIMATTER)) {
                                aList
                                    .add(LH.Chat.WHITE + "Neutral Antimatter: " + LH.Chat.YELLOW + tMaterial.mNeutrons);
                            ...
                            aList.add(
                                LH.Chat.WHITE + "Energy: "
                                    + TD.Energy.QU.getChatFormat()
                                    + ((tMaterial.mNeutrons + tMaterial.mProtons) * 65536)
                                    + " "
                                    + TD.Energy.QU.getLocalisedNameShort());
                        } else {
                            aList.add(
                                LH.Chat.CYAN + "Mat Data: "
                                    + LH.Chat.WHITE
                                    + tMaterial.getLocal()
                                    + (aAllDetails ? ""
                                        : " (" + LH.Chat.YELLOW
            ...
            if (IL.GC_Schematic_1.exists() && aData.hasKey("gc_schematics_1")) {
                aList.add(
                    LH.Chat.CYAN + IL.GC_Schematic_1.getWithMeta(1, aData.getShort("gc_schematics_1"))
                        .getDisplayName());
                return aList;
            }
            if (IL.GC_Schematic_2.exists() && aData.hasKey("gc_schematics_2")) {
                aList.add(
                    LH.Chat.CYAN + IL.GC_Schematic_2.getWithMeta(1, aData.getShort("gc_schematics_2"))
                        .getDisplayName());
                return aList;
            }
            if (IL.GC_Schematic_3.exists() && aData.hasKey("gc_schematics_3")) {
                aList.add(
                    LH.Chat.CYAN + IL.GC_Schematic_3.getWithMeta(1, aData.getShort("gc_schematics_3"))
                        .getDisplayName());
                return aList;
            }
            if (IL.IE_Blueprint_Projectiles_Common.exists() && aData.hasKey("ie_blueprint")) {
                ...
                aList.add(
                    LH.Chat.CYAN + IL.IE_Blueprint_Projectiles_Common.getWithMeta(1, tMeta)
                        .getDisplayName());
                switch (tMeta) {
                    case 0:
            ...
            if (Code.stringValid(tString)) {
                ...
                if (aAllDetails) for (int i = 0, j = tString.length(); i < j; i += 64)
        ...
        public static int getEnchantmentLevelDestruction(ItemStack aStack) {
            return MD.RC.mLoaded ? getEnchantmentLevel(RailcraftEnchantments.destruction, aStack) : 0;
        }

        public static int getEnchantmentLevelWrecking(ItemStack aStack) {
            return MD.RC.mLoaded ? getEnchantmentLevel(RailcraftEnchantments.wrecking, aStack) : 0;
        }

        public static int getEnchantmentLevelImplosion(ItemStack aStack) {
            return MD.RC.mLoaded ? getEnchantmentLevel(RailcraftEnchantments.implosion, aStack) : 0;
        }

        public static int getEnchantmentLevelLootingFortune(ItemStack aStack) {
            return Math.max(
                getEnchantmentLevel(Enchantment.fortune, aStack),
                getEnchantmentLevel(Enchantment.looting, aStack));
        }
        ...
        public static int getEnchantmentXP(ItemStack aStack) {
            if (ST.invalid(aStack) || !aStack.hasTagCompound()
                || ST.isGT_(aStack)
                || (COMPAT_EU_ITEM != null && COMPAT_EU_ITEM.is(aStack))) return 0;
        ...
        public static int getEnchantmentXP(NBTTagCompound aNBT) {
            ...
            for (int i = 0; i < aList.tagCount(); i++) {
                ...
                if (UT.Reflection.getLowercaseClass(tEnchantment)
                    .contains("curse")) return 0;
    ...
    public static class Reflection {
        ...
        public static Object getFieldContent(Object aObject, String aField) {
            return getFieldContent(aObject, aField, T, T);
        }
        ...
        public static boolean setFieldContent(Object aObject, String aField, Object aValue) {
            return setFieldContent(aObject, aField, aValue, T, T);
        }
        ...
        public static boolean setFieldContent(Class<?> aClass, Object aObject, String aField, Object aValue) {
            return setFieldContent(aClass, aObject, aField, aValue, T, T);
        }

        public static boolean setFieldContent(Class<?> aClass, Object aObject, String aField, Object aValue,
            boolean aPrivate, boolean aLogErrors) {
            try {
        ...
        public static Object callMethod(Object aObject, String aMethod, boolean aPrivate,
            boolean aUseUpperCasedDataTypes, boolean aLogErrors, Object... aParameters) {
            return callMethod(
                aObject,
                new String[] { aMethod },
                aPrivate,
                aUseUpperCasedDataTypes,
                aLogErrors,
                aParameters);
        }

        public static Object callMethod(Object aObject, String[] aMethods, boolean aPrivate,
            boolean aUseUpperCasedDataTypes, boolean aLogErrors, Object... aParameters) {
            try {
                ...
                for (String aMethod : aMethods) {
                    try {
                        Method tMethod = aPrivate
                            ? (aObject instanceof Class)
                                ? ((Class<?>) aObject).getDeclaredMethod(aMethod, tParameterTypes)
                                : aObject.getClass()
                                    .getDeclaredMethod(aMethod, tParameterTypes)
                            : (aObject instanceof Class) ? ((Class<?>) aObject).getMethod(aMethod, tParameterTypes)
                                : aObject.getClass()
    ...
    public static class Inventories {
        ...
        @Deprecated
        public static byte moveStackIntoPipe(IInventory aTileEntity1, Object aTarget, int[] aGrabSlots, byte aGrabFrom,
            byte aPutTo, List<ItemStack> aFilter, boolean aInvertFilter, int aMaxTargetStackSize,
            int aMinTargetStackSize, int aMaxMoveAtOnce, int aMinMoveAtOnce) {
            return 0;
        }

        @Deprecated
        public static byte moveStackFromSlotAToSlotB(IInventory aTileEntity, IInventory aTarget, int aGrabFrom,
            int aPutTo, int aMaxTargetStackSize, int aMinTargetStackSize, int aMaxMoveAtOnce, int aMinMoveAtOnce) {
            return 0;
        }
        ...
        @Deprecated
        public static byte moveOneItemStack(Object aTileEntity1, Object aTileEntity2, byte aGrabFrom, byte aPutTo,
            List<ItemStack> aFilter, boolean aInvertFilter, int aMaxTargetStackSize, int aMinTargetStackSize,
            int aMaxMoveAtOnce, int aMinMoveAtOnce) {
            return 0;
        }

        @Deprecated
        public static byte moveOneItemStackIntoSlot(Object aTileEntity1, Object aTarget, byte aGrabFrom, int aPutTo,
            List<ItemStack> aFilter, boolean aInvertFilter, int aMaxTargetStackSize, int aMinTargetStackSize,
            int aMaxMoveAtOnce, int aMinMoveAtOnce) {
            return 0;
        }
        ...
        @Deprecated
        public static byte moveFromSlotToSlot(IInventory aTileEntity1, IInventory aTileEntity2, int aGrabFrom,
            int aPutTo, List<ItemStack> aFilter, boolean aInvertFilter, int aMaxTargetStackSize,
            int aMinTargetStackSize, int aMaxMoveAtOnce, int aMinMoveAtOnce) {
            return 0;
        }
        ...
        public static boolean unlockAchievement(EntityPlayer aPlayer, Achievement aAchievement) {
            return ST.achieve(aPlayer, aAchievement);
        }

        @Deprecated
        public static boolean checkAchievements(EntityPlayer aPlayer, ItemStack aStack) {
            return ST.check(aPlayer, aStack);
        }

        @Deprecated
        public static boolean addStackToPlayerInventory(EntityPlayer aPlayer, ItemStack aStack) {
            return ST.add(aPlayer, aStack);
        }

        @Deprecated
        public static boolean addStackToPlayerInventory(EntityPlayer aPlayer, ItemStack aStack,
            boolean aCurrentSlotFirst) {
            return ST.add(aPlayer, aStack, aCurrentSlotFirst);
        }

        @Deprecated
        public static boolean addStackToPlayerInventory(EntityPlayer aPlayer, IInventory aInventory, ItemStack aStack,
            boolean aCurrentSlotFirst) {
            return ST.add(aPlayer, aInventory, aStack, aCurrentSlotFirst);
        }

        @Deprecated
        public static boolean addStackToPlayerInventoryOrDrop(EntityPlayer aPlayer, ItemStack aStack) {
            return ST.give(aPlayer, aStack);
        }

        @Deprecated
        public static boolean addStackToPlayerInventoryOrDrop(EntityPlayer aPlayer, ItemStack aStack,
            boolean aCurrentSlotFirst) {
            return ST.give(aPlayer, aStack, aCurrentSlotFirst);
        }

        @Deprecated
        public static boolean addStackToPlayerInventoryOrDrop(EntityPlayer aPlayer, ItemStack aStack, World aWorld,
            double aX, double aY, double aZ) {
            return ST.give(aPlayer, aStack, aWorld, aX, aY, aZ);
        }

        @Deprecated
        public static boolean addStackToPlayerInventoryOrDrop(EntityPlayer aPlayer, ItemStack aStack,
            boolean aCurrentSlotFirst, World aWorld, double aX, double aY, double aZ) {
            return ST.give(aPlayer, aStack, aCurrentSlotFirst, aWorld, aX, aY, aZ);
        }

        @Deprecated
        public static boolean addStackToPlayerInventoryOrDrop(EntityPlayer aPlayer, IInventory aInventory,
            ItemStack aStack, boolean aCurrentSlotFirst, World aWorld, double aX, double aY, double aZ) {
            return ST.give(aPlayer, aInventory, aStack, aCurrentSlotFirst, aWorld, aX, aY, aZ);
        }
    ...
    public static class Sounds {
        ...
        public static boolean play(String aSound, int aTimeUntilNextSound, float aVolume) {
            if (!CODE_CLIENT || cpw.mods.fml.common.FMLCommonHandler.instance()
                .getEffectiveSide()
                .isServer()) return F;
        ...
        public static boolean play(String aSound, int aTimeUntilNextSound, float aVolume, Entity aEntity) {
            ...
            return play(
                ...
                aTimeUntilNextSound,
                aVolume,
                UT.Code.roundDown(aEntity.posX),
                UT.Code.roundDown(aEntity.posY),
                UT.Code.roundDown(aEntity.posZ));
        }
        ...
        public static boolean play(String aSound, int aTimeUntilNextSound, float aVolume, ChunkCoordinates aCoords) {
            ...
            return play(
                ...
                aTimeUntilNextSound,
                aVolume,
                0.9F + RNGSUS.nextFloat() * 0.2F,
                aCoords.posX,
                aCoords.posY,
                aCoords.posZ);
        }

        public static boolean play(String aSound, int aTimeUntilNextSound, float aVolume, float aPitch, int aX, int aY,
            int aZ) {
            return play(aSound, aTimeUntilNextSound, aVolume, aPitch, new ChunkCoordinates(aX, aY, aZ));
        }

        public static boolean play(String aSound, int aTimeUntilNextSound, float aVolume, float aPitch,
            ChunkCoordinates aCoords) {
            if (!CODE_CLIENT || cpw.mods.fml.common.FMLCommonHandler.instance()
                .getEffectiveSide()
                .isServer()) return F;
            ...
            sSoundsToPlay.add(
                new SoundWithLocation(
                    aPlayer.worldObj,
                    UT.Code.roundDown(aCoords.posX),
                    UT.Code.roundDown(aCoords.posY),
                    UT.Code.roundDown(aCoords.posZ),
                    aTimeUntilNextSound,
                    aSound,
                    aVolume,
                    Float.isNaN(aPitch) || aPitch == SFX.RANDOM_PITCH
                        ? SFX._7_GRAND_DAD_[SFX.PITCH_INDEX = ((SFX.PITCH_INDEX + 1) % SFX._7_GRAND_DAD_.length)]
                        : aPitch));
            return T;
        }
        ...
        public static boolean send(String aSound, IHasWorldAndCoords aTileEntity,
            boolean aIDontWannaFuckingCastThisShitAllTheTime) {
            return send(aSound, 1.0F, SFX.RANDOM_PITCH, aTileEntity.getWorld(), aTileEntity.getCoords());
        }
        ...
        public static boolean send(String aSound, TileEntity aTileEntity) {
            return send(
                ...
                1.0F,
                SFX.RANDOM_PITCH,
                aTileEntity.getWorldObj(),
                new ChunkCoordinates(aTileEntity.xCoord, aTileEntity.yCoord, aTileEntity.zCoord));
        }
        ...
        public static class PlayedSound {
            ...
            public boolean equals(Object aObject) {
                if (aObject instanceof PlayedSound)
                    return ((PlayedSound) aObject).mX == mX && ((PlayedSound) aObject).mY == mY
                        && ((PlayedSound) aObject).mZ == mZ
                        && ((PlayedSound) aObject).mSoundName.equals(mSoundName);
                return F;
            }
        ...
        public static class SoundWithLocation {
            ...
            public SoundWithLocation(World aWorld, int aX, int aY, int aZ, int aTimeUntilNextSound, String aSound,
                float aVolume, float aPitch) {
                mWorld = aWorld;
                mX = aX;
                mY = aY;
                mZ = aZ;
    ...
    public static class Entities {
        ...
        public static void sendchat(Object aPlayer, String... aChatMessages) {
            if (aPlayer instanceof EntityPlayerMP) for (String aMessage : aChatMessages)
                ((EntityPlayerMP) aPlayer).addChatComponentMessage(new ChatComponentText(aMessage));
        }

        /** Sends Messages to a Player */
        public static void sendchat(Object aPlayer, IChatComponent... aChatMessages) {
            if (aPlayer instanceof EntityPlayerMP) for (IChatComponent aMessage : aChatMessages)
                ((EntityPlayerMP) aPlayer).addChatComponentMessage(aMessage);
        }

        /** Sends Messages to a Player */
        public static void sendchat(Object aPlayer, @SuppressWarnings("rawtypes") List aChatMessages,
            boolean aSkipFirst) {
            if (aChatMessages != null && aPlayer instanceof EntityPlayerMP)
                for (Object aMessage : aChatMessages) if (aSkipFirst) aSkipFirst = F;
                else((EntityPlayerMP) aPlayer).addChatComponentMessage(
                    aMessage instanceof IChatComponent ? (IChatComponent) aMessage
                        : new ChatComponentText(aMessage.toString()));
        }

        public static void chat(Object aPlayer, String... aChatMessages) {
            if (aPlayer == null) aPlayer = GT_API.api_proxy.getThePlayer();
            if (aPlayer instanceof EntityPlayer) for (String aMessage : aChatMessages)
                ((EntityPlayer) aPlayer).addChatComponentMessage(new ChatComponentText(aMessage));
        }

        public static void chat(Object aPlayer, IChatComponent... aChatMessages) {
            if (aPlayer == null) aPlayer = GT_API.api_proxy.getThePlayer();
            if (aPlayer instanceof EntityPlayer) for (IChatComponent aMessage : aChatMessages)
        ...
        public static void chat(Object aPlayer, @SuppressWarnings("rawtypes") List aChatMessages, boolean aSkipFirst) {
            ...
            if (aChatMessages != null && aPlayer instanceof EntityPlayer)
                for (Object aMessage : aChatMessages) if (aSkipFirst) aSkipFirst = F;
                else((EntityPlayer) aPlayer).addChatComponentMessage(
                    aMessage instanceof IChatComponent ? (IChatComponent) aMessage
                        : new ChatComponentText(aMessage.toString()));
        }
        ...
        public static boolean isWearingFullFrostHazmat(EntityLivingBase aEntity) {
            ...
            for (byte i = 1; i < 5; i++)
                if (!ArmorsGT.HAZMATS_FROST.contains(aEntity.getEquipmentInSlot(i), T)) return F;
            return T;
        }

        public static boolean isWearingFullHeatHazmat(EntityLivingBase aEntity) {
            if (isCreative(aEntity) || aEntity.getClass() == EntityWither.class
                || aEntity.getClass() == EntityBlaze.class
                || aEntity.getClass() == EntityPigZombie.class
                || aEntity.getClass() == EntityMagmaCube.class
                || aEntity.getClass() == EntityGhast.class) return T;
            for (byte i = 1; i < 5; i++)
                if (!ArmorsGT.HAZMATS_HEAT.contains(aEntity.getEquipmentInSlot(i), T)) return F;
            return T;
        }

        public static boolean isWearingFullBioHazmat(EntityLivingBase aEntity) {
            if (isCreative(aEntity) || aEntity.getClass() == EntityWither.class
                || aEntity.getClass() == EntityIronGolem.class) return T;
        ...
        public static boolean isWearingFullChemHazmat(EntityLivingBase aEntity) {
            if (isCreative(aEntity)) return T;
            for (byte i = 1; i < 5; i++)
                if (!ArmorsGT.HAZMATS_CHEM.contains(aEntity.getEquipmentInSlot(i), T)) return F;
            return T;
        }
        ...
        public static boolean isWearingFullInsectHazmat(EntityLivingBase aEntity) {
            if (isCreative(aEntity) || aEntity.getClass() == EntityWither.class
                || aEntity.getClass() == EntityIronGolem.class) return T;
            for (byte i = 1; i < 5; i++)
                if (!ArmorsGT.HAZMATS_INSECTS.contains(aEntity.getEquipmentInSlot(i), T)) return F;
            return T;
        }
        ...
        public static boolean isWearingFullRadioHazmat(EntityLivingBase aEntity) {
            if (isCreative(aEntity) || aEntity.getClass() == EntityWither.class
                || aEntity.getClass() == EntityIronGolem.class) return T;
            for (byte i = 1; i < 5; i++)
                if (!ArmorsGT.HAZMATS_RADIOACTIVE.contains(aEntity.getEquipmentInSlot(i), T)) return F;
            return T;
        }
        ...
        public static boolean isWearingFullElectroHazmat(EntityLivingBase aEntity) {
            if (isCreative(aEntity)) return T;
            for (byte i = 1; i < 5; i++)
                if (!ArmorsGT.HAZMATS_LIGHTNING.contains(aEntity.getEquipmentInSlot(i), T)) return F;
            return T;
        }
        ...
        public static boolean isSlimeCreature(Entity aEntity) {
            return aEntity instanceof EntitySlime || UT.Reflection.getLowercaseClass(aEntity)
                .contains("slime");
        }

        public static boolean isEnderCreature(Entity aEntity) {
            return aEntity instanceof EntityEnderman || UT.Reflection.getLowercaseClass(aEntity)
                .contains("ender");
        }

        public static boolean isZombieCreature(Entity aEntity) {
            return aEntity instanceof EntityZombie || UT.Reflection.getLowercaseClass(aEntity)
                .contains("zombie");
        }

        public static boolean isCreeperCreature(Entity aEntity) {
            return aEntity instanceof EntityCreeper || UT.Reflection.getLowercaseClass(aEntity)
                .contains("creeper");
        }
        ...
        public static boolean isExplosiveCreature(Entity aEntity) {
            return isGhastCreature(aEntity) || isCreeperCreature(aEntity)
                || UT.Reflection.getLowercaseClass(aEntity)
                    .contains("firebeetle");
        }
        ...
        public static boolean isWereCreature(EntityLivingBase aEntity) {
            ...
            return tClassName.contains("wwolf") || tClassName.contains("yeti")
                || tClassName.contains("villagerwere")
                || tClassName.contains("wolfman")
                || tClassName.contains("werewolf")
                || tClassName.contains("alphawolf")
                || tClassName.contains("tamewere")
                || tClassName.contains("minotaur")
                || tClassName.contains("minoshroom");
        }
        ...
        public static float getHeatDamageFromItem(ItemStack aStack) {
            ...
            return tData == null ? 0
                : (tData.mPrefix == null ? 0 : tData.mPrefix.mHeatDamage)
                    + (tData.validMaterial() ? tData.mMaterial.mMaterial.mHeatDamage : 0);
        }
        ...
        public static boolean applyTemperatureDamage(Entity aEntity, long aTemperature, float aMultiplier, float aCap) {
            if (aTemperature > 320) return applyHeatDamage(
                aEntity,
                Math.max(1, Math.min(aCap, (aMultiplier * (aTemperature - 300)) / 50.0F)));
            if (aTemperature < 260) return applyFrostDamage(
                aEntity,
                Math.max(1, Math.min(aCap, (aMultiplier * (270 - aTemperature)) / 25.0F)));
            return F;
        }

        public static boolean applyChemDamage(Entity aEntity, float aDamage) {
            if (aDamage > 0 && aEntity instanceof EntityLivingBase
                && aEntity.isEntityAlive()
                && aEntity.getClass() != EntitySkeleton.class
                && !isWearingFullChemHazmat(((EntityLivingBase) aEntity))) {
                ...
                ((EntityLivingBase) aEntity)
                    .addPotionEffect(
                        new PotionEffect(
                            ...
                            Math.max(
                                20,
                                (int) (aDamage * 100 + Math.max(
                                    0,
                                    ((tEffect = ((EntityLivingBase) aEntity).getActivePotionEffect(Potion.poison))
                                        == null ? 0 : tEffect.getDuration())))),
                            1));
                return T;
            }
            return F;
        ...
        public static boolean applyHeatDamage(Entity aEntity, float aDamage) {
            if (aDamage > 0 && aEntity instanceof EntityLivingBase
                && aEntity.isEntityAlive()
                && aEntity.getClass() != EntityBlaze.class
                && ((EntityLivingBase) aEntity).getActivePotionEffect(Potion.fireResistance) == null
                && !isWearingFullHeatHazmat(((EntityLivingBase) aEntity))) {
        ...
        public static boolean applyFrostDamage(Entity aEntity, float aDamage) {
            if (aDamage > 0 && aEntity instanceof EntityLivingBase
                && aEntity.isEntityAlive()
                && !isWearingFullFrostHazmat(((EntityLivingBase) aEntity))) {
        ...
        public static boolean applyElectricityDamage(Entity aEntity, long aVoltage, long aAmperage) {
            ...
            if (aDamage > 0 && aEntity instanceof EntityLivingBase
                && aEntity.isEntityAlive()
                && !isWearingFullElectroHazmat(((EntityLivingBase) aEntity))) {
        ...
        public static boolean applyRadioactivity(Entity aEntity, int aLevel, int aAmountOfItems) {
            if (aLevel > 0 && aEntity instanceof EntityLivingBase
                && aEntity.isEntityAlive()
                && ((EntityLivingBase) aEntity).getCreatureAttribute() != EnumCreatureAttribute.UNDEAD
                && ((EntityLivingBase) aEntity).getCreatureAttribute() != EnumCreatureAttribute.ARTHROPOD
                && !isWearingFullRadioHazmat(((EntityLivingBase) aEntity))) {
                ...
                applyPotion(
                    ...
                    aLevel * 140 * aAmountOfItems + Math.max(
                        0,
                        ((tEffect = ((EntityLivingBase) aEntity).getActivePotionEffect(Potion.moveSlowdown)) == null ? 0
                            : tEffect.getDuration())),
                    (int) UT.Code.bind(0, 5, (5L * aLevel) / 7),
                    F);
                applyPotion(
                    aEntity,
                    Potion.digSlowdown,
                    aLevel * 150 * aAmountOfItems + Math.max(
                        0,
                        ((tEffect = ((EntityLivingBase) aEntity).getActivePotionEffect(Potion.digSlowdown)) == null ? 0
                            : tEffect.getDuration())),
                    (int) UT.Code.bind(0, 5, (5L * aLevel) / 7),
                    F);
                applyPotion(
                    ...
                    aLevel * 130 * aAmountOfItems + Math.max(
                        0,
                        ((tEffect = ((EntityLivingBase) aEntity).getActivePotionEffect(Potion.confusion)) == null ? 0
                            : tEffect.getDuration())),
                    (int) UT.Code.bind(0, 5, (5L * aLevel) / 7),
                    F);
                applyPotion(
                    ...
                    aLevel * 150 * aAmountOfItems + Math.max(
                        0,
                        ((tEffect = ((EntityLivingBase) aEntity).getActivePotionEffect(Potion.weakness)) == null ? 0
                            : tEffect.getDuration())),
                    (int) UT.Code.bind(0, 5, (5L * aLevel) / 7),
                    F);
                applyPotion(
                    ...
                    aLevel * 130 * aAmountOfItems + Math.max(
                        0,
                        ((tEffect = ((EntityLivingBase) aEntity).getActivePotionEffect(Potion.hunger)) == null ? 0
                            : tEffect.getDuration())),
                    (int) UT.Code.bind(0, 5, (5L * aLevel) / 7),
                    F);
                if (PotionsGT.ID_RADIATION >= 0) {
                    applyPotion(
                        aEntity,
                        PotionsGT.ID_RADIATION,
                        aLevel * 180 * aAmountOfItems + Math.max(
                            0,
                            ((tEffect = ((EntityLivingBase) aEntity)
                                .getActivePotionEffect(Potion.potionTypes[PotionsGT.ID_RADIATION])) == null ? 0
                                    : tEffect.getDuration())),
                        (int) UT.Code.bind(0, 4, (5L * aLevel) / 7),
                        F); // can only be between 0 and 4, or else IC2 WILL crash!!!
                } else {
                    applyPotion(
                        aEntity,
                        Potion.wither,
                        aLevel * 130 * aAmountOfItems + Math.max(
                            0,
                            ((tEffect = ((EntityLivingBase) aEntity).getActivePotionEffect(Potion.wither)) == null ? 0
                                : tEffect.getDuration())),
                        (int) UT.Code.bind(0, 5, (5L * aLevel) / 7),
                        F);
                }
        ...
        public static boolean applyPotion(Entity aEntity, Potion aPotion, int aDuration, int aLevel,
            boolean aInvisibleParticles) {
            return aPotion != null && applyPotion(aEntity, aPotion.id, aDuration, aLevel, aInvisibleParticles);
        }

        public static boolean applyPotion(Entity aEntity, int aID, int aDuration, int aLevel,
            boolean aInvisibleParticles) {
            if (aDuration <= 0 || !(aEntity instanceof EntityLivingBase)) return F;
            if (aID < -1) switch (aID) {
                case -2:
                    aID = PotionsGT.ID_RADIATION;
                    break;
                case -3:
                    aID = PotionsGT.ID_HYPOTHERMIA;
                    break;
                case -4:
                    aID = PotionsGT.ID_HEATSTROKE;
                    break;
                case -5:
                    aID = PotionsGT.ID_FROSTBITE;
                    break;
                case -6:
                    aID = PotionsGT.ID_DEHYDRATION;
                    break;
                case -7:
                    aID = PotionsGT.ID_INSANITY;
                    break;
                case -8:
                    aID = PotionsGT.ID_FLAMMABLE;
                    break;
                case -9:
                    aID = PotionsGT.ID_SLIPPERY;
                    break;
                case -10:
                    aID = PotionsGT.ID_CONDUCTIVE;
                    break;
                case -11:
                    aID = PotionsGT.ID_STICKY;
                    break;
            }
            if (aID < 0) return F;
            if (aLevel >= 0) {
                ((EntityLivingBase) aEntity)
                    .addPotionEffect(new PotionEffect(aID, aDuration, aLevel, aInvisibleParticles));
                return T;
            }
        ...
        public static byte pot(Object aEntity, Potion aPotion) {
            if (aPotion != null && aEntity instanceof EntityLivingBase) {
                ...
                // Limit the output value to six bit, which should be more than enough for Potions, and prevent Byte
                // Math Issues.
        ...
        public static byte potStrengthWeakness(Object aEntity) {
            return UT.Code.bindByte(pot0(aEntity, Potion.damageBoost) - pot0(aEntity, Potion.weakness));
        }

        public static byte potHasteFatique(Object aEntity) {
            return UT.Code.bindByte(pot0(aEntity, Potion.digSpeed) - pot0(aEntity, Potion.digSlowdown));
        }

        public static byte potSpeedSlowness(Object aEntity) {
            return UT.Code.bindByte(pot0(aEntity, Potion.moveSpeed) - pot0(aEntity, Potion.moveSlowdown));
        }
        ...
        public static Collection<EntityPlayer> getPlayersWithLastTarget(IHasWorldAndCoords aTarget) {
            return getPlayersWithLastTarget(6, aTarget);
        }

        public static Collection<EntityPlayer> getPlayersWithLastTarget(World aWorld, int aX, int aY, int aZ) {
            return getPlayersWithLastTarget(6, aWorld, aX, aY, aZ);
        }

        public static Collection<EntityPlayer> getPlayersWithLastTarget(World aWorld, ChunkCoordinates aCoords) {
            return getPlayersWithLastTarget(6, aWorld, aCoords);
        }

        public static Collection<EntityPlayer> getPlayersWithLastTarget(long aRange, IHasWorldAndCoords aTarget) {
            return getPlayersWithLastTarget(aRange, aTarget.getWorld(), aTarget.getCoords());
        }

        public static Collection<EntityPlayer> getPlayersWithLastTarget(long aRange, World aWorld, int aX, int aY,
            int aZ) {
            return getPlayersWithLastTarget(aRange, aWorld, new ChunkCoordinates(aX, aY, aZ));
        }

        public static Collection<EntityPlayer> getPlayersWithLastTarget(long aRange, World aWorld,
            ChunkCoordinates aCoords) {
            ...
            for (Entry<EntityPlayer, ChunkCoordinates> tEntry : PLAYER_LAST_CLICKED.entrySet()) {
                if (!tEntry.getKey().isDead && aWorld == tEntry.getKey().worldObj
                    && aCoords.equals(tEntry.getValue())) {
                    if (isCreative(tEntry.getKey()) || tEntry.getKey()
                        .getDistanceSq(aCoords.posX + 0.5, aCoords.posY + 0.5, aCoords.posZ + 0.5) <= aRange * aRange) {
        ...
        public static boolean canEdit(Object aPlayer, int aX, int aY, int aZ) {
            return !(aPlayer instanceof EntityPlayer)
                || ((EntityPlayer) aPlayer).canPlayerEdit(aX, aY, aZ, SIDE_TOP, NI);
        }

        public static boolean canEdit(Object aPlayer, int aX, int aY, int aZ, ItemStack aStack) {
            return !(aPlayer instanceof EntityPlayer)
                || ((EntityPlayer) aPlayer).canPlayerEdit(aX, aY, aZ, SIDE_TOP, aStack);
        }

        public static boolean canEdit(Object aPlayer, int aX, int aY, int aZ, int aSide, ItemStack aStack) {
            return !(aPlayer instanceof EntityPlayer)
                || ((EntityPlayer) aPlayer).canPlayerEdit(aX, aY, aZ, aSide, aStack);
        }
        ...
        public static boolean isSpectator(Object aPlayer) {
            return aPlayer instanceof EntityPlayerMP && ((EntityPlayerMP) aPlayer).theItemInWorldManager.getGameType()
                .getName()
        ...
        public static boolean consumeCurrentItem(EntityPlayer aPlayer) {
            ...
            if (aStack.stackSize != NEI_INFINITE && --aStack.stackSize <= 0)
                aPlayer.inventory.setInventorySlotContents(aPlayer.inventory.currentItem, NI);
    ...
    public static class Worlds {
        ...
        @Deprecated
        public static MovingObjectPosition getMovingObjectPositionFromPlayer(World aWorld, EntityPlayer aPlayer,
            boolean aFlag) {
        ...
        @Deprecated
        public static DelegatorTileEntity<TileEntity> getTileEntity(World aWorld, ChunkCoordinates aCoords, byte aSide,
            boolean aLoadUnloadedChunks) {
            return WD.te(aWorld, aCoords, aSide, aLoadUnloadedChunks);
        }

        @Deprecated
        public static DelegatorTileEntity<TileEntity> getTileEntity(World aWorld, int aX, int aY, int aZ, byte aSide,
            boolean aLoadUnloadedChunks) {
        ...
        @Deprecated
        public static boolean setBlockIfDifferent(World aWorld, int aX, int aY, int aZ, Block aBlock, int aMetaData,
            int aFlags) {
        ...
        @Deprecated
        public static boolean isVisuallyOccluded(World aWorld, int aX, int aY, int aZ, boolean aIgnoreUnloadedChunks,
            boolean aDefault) {
            return WD.visOcc(aWorld, aX, aY, aZ, aIgnoreUnloadedChunks, aDefault);
        }

        @Deprecated
        public static boolean isVisuallyOpaque(World aWorld, int aX, int aY, int aZ, boolean aIgnoreUnloadedChunks,
            boolean aDefault) {
        ...
        @Deprecated
        public static boolean isOccluded(World aWorld, int aX, int aY, int aZ, boolean aIgnoreUnloadedChunks,
            boolean aDefault) {
            return WD.occ(aWorld, aX, aY, aZ, aIgnoreUnloadedChunks, aDefault);
        }

        @Deprecated
        public static boolean isOpaque(World aWorld, int aX, int aY, int aZ, boolean aIgnoreUnloadedChunks,
            boolean aDefault) {
        ...
        @Deprecated
        public static void setOnFire(World aWorld, int aX, int aY, int aZ, boolean aReplaceCenter,
            boolean aCheckFlammability) {
            WD.burn(aWorld, aX, aY, aZ, aReplaceCenter, aCheckFlammability);
        }

        @Deprecated
        public static void setOnFire(World aWorld, ChunkCoordinates aCoords, boolean aReplaceCenter,
            boolean aCheckFlammability) {
        ...
        @Deprecated
        public static long getCoordinateScan(ArrayList<String> aList, EntityPlayer aPlayer, World aWorld,
            int aScanLevel, int aX, int aY, int aZ, byte aSide, float aClickX, float aClickY, float aClickZ) {
    ...
    public static class Stacks {
        ...
        @Deprecated
        public static boolean inList(Collection<ItemStack> aList, ItemStack aStack, boolean aTrueIfListEmpty,
        ...
        public static Block block(ModData aModID, String aBlock) {
            return block(make(aModID, aBlock, 1, null));
        }

        @Deprecated
        public static Block block(ModData aModID, String aBlock, Block aReplacement) {
            Block rBlock = block(aModID, aBlock);
            return rBlock == NB ? aReplacement : rBlock;
        }
        ...
        public static ItemStack make(ModData aModID, String aItem, long aAmount) {
            return make(aModID, aItem, aAmount, null);
        }

        @Deprecated
        public static ItemStack make(ModData aModID, String aItem, long aAmount, ItemStack aReplacement) {
            if (!aModID.mLoaded || Code.stringInvalid(aItem) || !GAPI_POST.mStartedPreInit) return null;
            if (aItem.length() > 5 && aItem.charAt(0) == 't'
                && aItem.charAt(1) == 'i'
                && aItem.charAt(2) == 'l'
                && aItem.charAt(3) == 'e'
                && aItem.charAt(4) == '.')
                return amount(
                    aAmount,
                    GameRegistry.findItemStack(aModID.mID, aItem, (int) aAmount),
                    GameRegistry.findItemStack(aModID.mID, aItem.substring(5), (int) aAmount),
                    aReplacement);
            return amount(aAmount, GameRegistry.findItemStack(aModID.mID, aItem, (int) aAmount), aReplacement);
        }

        @Deprecated
        public static ItemStack make(ModData aModID, String aItem, long aAmount, int aMeta) {
            ItemStack rStack = make(aModID, aItem, aAmount);
            if (rStack == null) return null;
            meta(rStack, aMeta);
            return rStack;
        }
        ...
        public static ItemStack make(ModData aModID, String aItem, long aAmount, int aMeta, ItemStack aReplacement) {
            ItemStack rStack = make(aModID, aItem, aAmount, aReplacement);
            if (rStack == null) return null;
            meta(rStack, aMeta);
            return rStack;
        }
        ...
        public static ItemStack make(String aModID, String aItem, long aAmount, ItemStack aReplacement) {
            if (Code.stringInvalid(aItem) || !GAPI_POST.mStartedPreInit) return null;
            if (aItem.length() > 5 && aItem.charAt(0) == 't'
                && aItem.charAt(1) == 'i'
                && aItem.charAt(2) == 'l'
                && aItem.charAt(3) == 'e'
                ...
                return amount(
                    ...
                    GameRegistry.findItemStack(aModID, aItem.substring(5), (int) aAmount),
                    aReplacement);
            return amount(aAmount, GameRegistry.findItemStack(aModID, aItem, (int) aAmount), aReplacement);
        }
        ...
        public static ItemStack make(long aItemID, long aStacksize, long aMetaData) {
            return aItemID == 0 ? null : make(Item.getItemById((int) aItemID), aStacksize, aMetaData);
        }

        @Deprecated
        public static ItemStack make(Item aItem, long aStacksize, long aMetaData) {
            return aItem == null ? null : make(new ItemStack(aItem, Code.bindInt(aStacksize), (int) aMetaData), null);
        }

        @Deprecated
        public static ItemStack make(Block aBlock, long aStacksize, long aMetaData) {
            return aBlock == null || aBlock == NB ? null
                : make(new ItemStack(aBlock, Code.bindInt(aStacksize), (int) aMetaData), null);
        }

        @Deprecated
        public static ItemStack make(long aItemID, long aStacksize, long aMetaData, NBTTagCompound aNBT) {
            return aItemID == 0 ? null : make(Item.getItemById((int) aItemID), aStacksize, aMetaData, aNBT);
        }

        @Deprecated
        public static ItemStack make(Item aItem, long aStacksize, long aMetaData, NBTTagCompound aNBT) {
            return aItem == null ? null : make(new ItemStack(aItem, Code.bindInt(aStacksize), (int) aMetaData), aNBT);
        }

        @Deprecated
        public static ItemStack make(Block aBlock, long aStacksize, long aMetaData, NBTTagCompound aNBT) {
            return aBlock == null || aBlock == NB ? null
                : make(new ItemStack(aBlock, Code.bindInt(aStacksize), (int) aMetaData), aNBT);
        }

        @Deprecated
        public static ItemStack make(ItemStack aStack, NBTTagCompound aNBT) {
            return make(aStack, null, aNBT);
        }
        ...
        public static ItemStack make(ItemStack aStack, String aName, NBTTagCompound aNBT) {
            ...
            aStack = aStack.copy();
            NBT.set(aStack, aNBT);
            if (aName != null) aStack.setStackDisplayName(aName);
            return aStack;
        }
        ...
        public static ItemStack make(ItemStackContainer aStack, String aName, NBTTagCompound aNBT) {
            ...
            if (rStack == null) return null;
            NBT.set(rStack, aNBT);
            if (aName != null) rStack.setStackDisplayName(aName);
            return rStack;
        }
        ...
        public static ItemStack copyMeta(long aMetaData, Object... aStacks) {
            return copyMeta(aMetaData, aStacks);
        }
    ...
    public static class Crafting {
        ...
        public static class Bits {
            ...
            @Deprecated
            public static final long NONE = 0, MIR = B[0], BUF = B[1], REV = B[5], KEEPNBT = B[2], DISMANTLE = B[3],
                NO_REM = B[4], NO_AUTO = B[14], NO_COLLISION_CHECK = B[10], DEL_OTHER_RECIPES = B[6],
                DEL_OTHER_RECIPES_IF_SAME_NBT = B[7], DEL_OTHER_SHAPED_RECIPES = B[8], DEL_OTHER_NATIVE_RECIPES = B[9],
                DEL_IF_NO_DYES = B[13], ONLY_IF_HAS_OTHER_RECIPES = B[11], ONLY_IF_HAS_RESULT = B[12],
                DEFAULT = BUF | NO_REM, DEFAULT_MIR = DEFAULT | MIR, DEFAULT_REV = DEFAULT | REV,
                DEFAULT_NCC = DEFAULT | NO_COLLISION_CHECK, DEFAULT_REV_NCC = DEFAULT_REV | NO_COLLISION_CHECK,
                DEFAULT_NAC = DEFAULT | NO_AUTO, DEFAULT_NAC_NCC = DEFAULT_NCC | NO_AUTO,
                DEFAULT_NAC_REV = DEFAULT_REV | NO_AUTO, DEFAULT_NAC_REV_NCC = DEFAULT_REV_NCC | NO_AUTO,
                DEFAULT_REM = DEFAULT | DEL_OTHER_RECIPES, DEFAULT_REM_REV = DEFAULT_REM | REV,
                DEFAULT_REM_NCC = DEFAULT_REM | NO_COLLISION_CHECK,
                DEFAULT_REM_REV_NCC = DEFAULT_REM_REV | NO_COLLISION_CHECK, DEFAULT_REM_NAC = DEFAULT_REM | NO_AUTO,
                DEFAULT_REM_NAC_NCC = DEFAULT_REM_NCC | NO_AUTO, DEFAULT_REM_NAC_REV = DEFAULT_REM_REV | NO_AUTO,
                DEFAULT_REM_NAC_REV_NCC = DEFAULT_REM_REV_NCC | NO_AUTO;
        }

        @Deprecated
        public static boolean shaped(ItemStack aResult, Enchantment[] aEnchantmentsAdded, int[] aEnchantmentLevelsAdded,
            Object[] aRecipe) {
        ...
        @Deprecated
        public static boolean shapeless(ItemStack aResult, Enchantment[] aEnchantmentsAdded,
        ...
        @Deprecated
        public static boolean remout(ItemStack aOutput, boolean aIgnoreNBT, boolean aNotRemoveShapelessRecipes,
            boolean aOnlyRemoveNativeHandlers, boolean aDontRemoveDyeingRecipes) {
            return CR.remout(
                aOutput,
                aIgnoreNBT,
                aNotRemoveShapelessRecipes,
                aOnlyRemoveNativeHandlers,
                aDontRemoveDyeingRecipes);
        }
    ...
    public static synchronized boolean removeSimpleIC2MachineRecipe(ItemStack aInput,
        @SuppressWarnings("rawtypes") Map aRecipeList, ItemStack aOutput) {
        if (!MD.IC2.mLoaded || (ST.invalid(aInput) && ST.invalid(aOutput))
            || aRecipeList == null
        ...
        while (tIterator.hasNext()) {
            ...
            if (aInput == null || tEntry.getKey()
                ...
                if (tList != null)
                    for (ItemStack tOutput : tList) if (ST.invalid(aOutput) || ST.equal(OM.get(tOutput), aOutput)) {
                        tIterator.remove();
                        rReturn = T;
                        break;
                    }
    ...
    public static boolean addSimpleIC2MachineRecipe(IMachineRecipeManager aRecipeManager, ItemStack aInput,
        NBTTagCompound aNBT, Object... aOutput) {
        if (!MD.IC2.mLoaded || ST.invalid(aInput) || aOutput == null || aRecipeManager == null) return F;
        try {
            aOutput = Code.getWithoutNulls(aOutput)
                .toArray(ZL);
            ...
            if (aRecipeManager instanceof IMachineRecipeManagerExt) {
                if (tOreName != null && !tOreName.mBlackListed && !OreDictManager.INSTANCE.isBlacklisted(aInput)) {
                    ((IMachineRecipeManagerExt) aRecipeManager).addRecipe(
                        (IRecipeInput) COMPAT_IC2.makeInput(tOreName.toString(), aInput.stackSize),
                        aNBT,
                        T,
                        OreDictManager.INSTANCE.getStackArray(T, aOutput));
                } else {
                    ((IMachineRecipeManagerExt) aRecipeManager).addRecipe(
                        (IRecipeInput) COMPAT_IC2.makeInput(aInput),
                        aNBT,
                        T,
                        OreDictManager.INSTANCE.getStackArray(T, aOutput));
                }
    ...
    @SuppressWarnings("unchecked")
    public static boolean addSimpleIC2MachineRecipe(ItemStack aInput, @SuppressWarnings("rawtypes") Map aRecipeList,
        NBTTagCompound aNBT, Object... aOutput) {
        if (!MD.IC2.mLoaded || ST.invalid(aInput) || aOutput.length == 0 || aRecipeList == null) return F;
        OreDictItemData tOreName = OM.association_(aInput);
        if (tOreName != null) {
            aRecipeList.put(
                COMPAT_IC2.makeInput(tOreName.toString(), aInput.stackSize),
                COMPAT_IC2.makeOutput(aNBT, OreDictManager.INSTANCE.getStackArray(T, aOutput)));
        } else {
            aRecipeList.put(
                COMPAT_IC2.makeInput(aInput),
                COMPAT_IC2.makeOutput(aNBT, OreDictManager.INSTANCE.getStackArray(T, aOutput)));
        }
        return T;
    }
    ...
    /**
     * Yes, I have read all those warning that it might break. But I don't expect any further development on this
     * Function by Forge during 1.7.10.
     * 
    ...
    public static class LoadingBar {
        ...
        public static boolean finish() {
            if (mBar != null && mEnabled) {
                if (mCount != mSize)
                    ERR.println("ERROR: Progress Bar needed a forced Finish, because of too few Steps.");
                try {
