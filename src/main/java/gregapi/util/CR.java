...
public class CR {
    ...
    public static final HashSetNoNulls<String> CLASSES_NATIVE = new HashSetNoNulls<>(
        F,
        ...
        CLASSES_SPECIAL = new HashSetNoNulls<>(
            F,
    ...
    static {
        for (String tDye : DYE_OREDICTS) OREDICT_DYE_LISTS.add(OreDictionary.getOres(tDye));
    }
    ...
    public static boolean shaped(ItemStack aResult, Object[] aRecipe) {
        return shaped(aResult, DEF, aRecipe);
    }
    ...
    public static boolean shaped(ItemStack aResult, long aBitMask, Object[] aRecipe) {
        return shaped(
            ...
            (aBitMask & BUF) != 0,
            (aBitMask & KEEPNBT) != 0,
            (aBitMask & DISMANTLE) != 0,
            (aBitMask & NO_REM) == 0,
            (aBitMask & REV) != 0,
            (aBitMask & DEL_OTHER_RECIPES) != 0,
            (aBitMask & DEL_OTHER_RECIPES_IF_SAME_NBT) != 0,
            (aBitMask & DEL_OTHER_SHAPED_RECIPES) != 0,
            (aBitMask & DEL_OTHER_NATIVE_RECIPES) != 0,
            (aBitMask & NO_COLLISION_CHECK) == 0,
            (aBitMask & ONLY_IF_HAS_OTHER_RECIPES) != 0,
            (aBitMask & ONLY_IF_HAS_RESULT) != 0,
            (aBitMask & DEL_IF_NO_DYES) != 0,
            (aBitMask & NO_AUTO) != 0,
            aRecipe);
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, String aRecipeC,
        char aC1, Object aO1, char aC2, Object aO2, char aC3, Object aO3, char aC4, Object aO4, char aC5, Object aO5,
        char aC6, Object aO6, char aC7, Object aO7, char aC8, Object aO8, char aC9, Object aO9) {
        return shaped(
            aResult,
            aBitMask,
            new Object[] { aRecipeA, aRecipeB, aRecipeC, aC1, aO1, aC2, aO2, aC3, aO3, aC4, aO4, aC5, aO5, aC6, aO6,
                aC7, aO7, aC8, aO8, aC9, aO9 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, String aRecipeC,
        char aC1, Object aO1, char aC2, Object aO2, char aC3, Object aO3, char aC4, Object aO4, char aC5, Object aO5,
        char aC6, Object aO6, char aC7, Object aO7, char aC8, Object aO8) {
        return shaped(
            aResult,
            aBitMask,
            new Object[] { aRecipeA, aRecipeB, aRecipeC, aC1, aO1, aC2, aO2, aC3, aO3, aC4, aO4, aC5, aO5, aC6, aO6,
    ...
    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, String aRecipeC,
        char aC1, Object aO1, char aC2, Object aO2, char aC3, Object aO3, char aC4, Object aO4, char aC5, Object aO5,
        char aC6, Object aO6, char aC7, Object aO7) {
        return shaped(
            aResult,
            aBitMask,
            new Object[] { aRecipeA, aRecipeB, aRecipeC, aC1, aO1, aC2, aO2, aC3, aO3, aC4, aO4, aC5, aO5, aC6, aO6,
    ...
    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, String aRecipeC,
        ...
        return shaped(
            aResult,
            aBitMask,
            new Object[] { aRecipeA, aRecipeB, aRecipeC, aC1, aO1, aC2, aO2, aC3, aO3, aC4, aO4, aC5, aO5 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, String aRecipeC,
        char aC1, Object aO1, char aC2, Object aO2, char aC3, Object aO3, char aC4, Object aO4) {
        return shaped(
            aResult,
            aBitMask,
            new Object[] { aRecipeA, aRecipeB, aRecipeC, aC1, aO1, aC2, aO2, aC3, aO3, aC4, aO4 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, String aRecipeC,
        char aC1, Object aO1, char aC2, Object aO2, char aC3, Object aO3) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aRecipeB, aRecipeC, aC1, aO1, aC2, aO2, aC3, aO3 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, String aRecipeC,
        char aC1, Object aO1, char aC2, Object aO2) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aRecipeB, aRecipeC, aC1, aO1, aC2, aO2 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, String aRecipeC,
        char aC1, Object aO1) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aRecipeB, aRecipeC, aC1, aO1 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, char aC1,
        Object aO1, char aC2, Object aO2, char aC3, Object aO3, char aC4, Object aO4, char aC5, Object aO5, char aC6,
        Object aO6) {
        return shaped(
            aResult,
            aBitMask,
            new Object[] { aRecipeA, aRecipeB, aC1, aO1, aC2, aO2, aC3, aO3, aC4, aO4, aC5, aO5, aC6, aO6 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, char aC1,
        Object aO1, char aC2, Object aO2, char aC3, Object aO3, char aC4, Object aO4, char aC5, Object aO5) {
        return shaped(
            aResult,
            aBitMask,
            new Object[] { aRecipeA, aRecipeB, aC1, aO1, aC2, aO2, aC3, aO3, aC4, aO4, aC5, aO5 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, char aC1,
        Object aO1, char aC2, Object aO2, char aC3, Object aO3, char aC4, Object aO4) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aRecipeB, aC1, aO1, aC2, aO2, aC3, aO3, aC4, aO4 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, char aC1,
        Object aO1, char aC2, Object aO2, char aC3, Object aO3) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aRecipeB, aC1, aO1, aC2, aO2, aC3, aO3 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, char aC1,
        Object aO1, char aC2, Object aO2) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aRecipeB, aC1, aO1, aC2, aO2 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, String aRecipeB, char aC1,
        Object aO1) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aRecipeB, aC1, aO1 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, char aC1, Object aO1, char aC2,
        Object aO2, char aC3, Object aO3) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aC1, aO1, aC2, aO2, aC3, aO3 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, char aC1, Object aO1, char aC2,
        Object aO2) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aC1, aO1, aC2, aO2 });
    }

    public static boolean shaped(ItemStack aResult, long aBitMask, String aRecipeA, char aC1, Object aO1) {
        return shaped(aResult, aBitMask, new Object[] { aRecipeA, aC1, aO1 });
    }

    private static boolean shaped(ItemStack aResult, Enchantment[] aEnchantmentsAdded, int[] aEnchantmentLevelsAdded,
        boolean aMirrored, boolean aBuffered, boolean aKeepNBT, boolean aDismantleable, boolean aRemovable,
        ...
        boolean aOnlyAddIfThereIsAnyRecipeOutputtingThis, boolean aOnlyAddIfResultIsNotNull,
        ...
        for (byte i = 0; i < aRecipe.length; i++) if (aRecipe[i] != null) {
            ...
            } else if (!(aRecipe[i] instanceof ItemStack || aRecipe[i] instanceof OreDictItemData
        ...
        try {
            ...
            for (; idx < aRecipe.length; idx += 2) {
                ...
                if (tInput instanceof ItemStack) {
                    ...
                    if (tStack == null) tRemoveRecipe = F;
                    else tItemStackMap.put(tChar, tStack);
        ...
        if (aRemoveAllOthersWithSameOutput || aRemoveAllOthersWithSameOutputIfTheyHaveSameNBT
            ...
            tThereWasARecipe = remout(
                aResult,
                !aRemoveAllOthersWithSameOutputIfTheyHaveSameNBT,
                aRemoveAllOtherShapedsWithSameOutput,
                aRemoveAllOtherNativeRecipes,
                aDeleteOnlyIfNoDyeInvolved) || tThereWasARecipe;
        ...
        if (tThereWasARecipe || !aOnlyAddIfThereIsAnyRecipeOutputtingThis) {
            if (BUFFERING && aBuffered) BUFFER.add(
                new AdvancedCraftingShaped(
                    ST.copy_(aResult),
                    aDismantleable,
                    aRemovable,
                    aKeepNBT,
    ...
    public static boolean shapeless(ItemStack aResult, Enchantment[] aEnchantmentsAdded, int[] aEnchantmentLevelsAdded,
        Object[] aRecipe) {
        return shapeless(aResult, aEnchantmentsAdded, aEnchantmentLevelsAdded, T, F, F, F, F, F, F, F, F, aRecipe);
    }

    /** Shapeless Crafting Recipes. Deletes conflicting Recipes too. */
    public static boolean shapeless(ItemStack aResult, Object[] aRecipe) {
        return shapeless(aResult, DEF, aRecipe);
    }
    ...
    private static boolean shapeless(ItemStack aResult, Enchantment[] aEnchantmentsAdded, int[] aEnchantmentLevelsAdded,
        boolean aBuffered, boolean aKeepNBT, boolean aDismantleable, boolean aRemovable, boolean aNotAutoCraftable,
        boolean aRemoveAllOthersWithSameOutput, boolean aRemoveAllOthersWithSameOutputIfTheyHaveSameNBT,
        boolean aRemoveAllOtherShapedsWithSameOutput, boolean aRemoveAllOtherNativeRecipes, Object[] aRecipe) {
        if (aRecipe == null || aRecipe.length <= 0) return F;
        if (aRecipe.length > 9)
        ...
        for (byte i = 0; i < aRecipe.length; i++) if (aRecipe[i] != null) {
            if (aRecipe[i] instanceof IItemContainer) {
                ...
                aRecipe[i] = ST.make((Block) aRecipe[i], 1, W);
            } else if (!(aRecipe[i] instanceof ItemStack || aRecipe[i] instanceof String
                || aRecipe[i] instanceof Character)) {
                    aRecipe[i] = aRecipe[i].toString();
                }
        }
    ...
    public static ItemStack getany(World aWorld, ItemStack... aRecipe) {
        return getany(aWorld, T, aRecipe);
    }
    ...
    public static ItemStack getany(World aWorld, boolean aAllowCache, ItemStack... aRecipe) {
        ...
        for (int i = 0; i < tList.size(); i++) if (tList.get(i)
            .matches(aCrafting, aWorld)) return (sLastRecipe = tList.get(i)).getCraftingResult(aCrafting);
        ...
        if (tIndex == 2) {
            ...
            if (tStack1.getItem() == tStack2.getItem() && tStack1.getItem()
                .isRepairable()) {
                int tNewDamage = ST.meta_(tStack1) + ST.meta_(tStack2)
                    + (tStack1.getMaxDamage() / -20)
                    - tStack1.getMaxDamage();
    ...
    public static ItemStack get(boolean aUncopiedStack, ItemStack... aRecipe) {
        ...
        InventoryCrafting aCrafting = crafting(aRecipe);
        List<IRecipe> tList = list();
        for (int i = 0; i < tList.size(); i++) try {
            if (tList.get(i)
                .matches(aCrafting, CS.DW))
                return aUncopiedStack ? ST.valisize(
                    tList.get(i)
                        .getRecipeOutput())
                    : ST.copy(
                        ST.valisize(
    ...
    public static List<ItemStack> outputs(List<IRecipe> aList, boolean aDeleteFromList, ItemStack... aRecipe) {
        ...
        for (int i = 0; i < aList.size(); i++) try {
            if (aList.get(i)
                .matches(aCrafting, CS.DW))
                rList.add(
                    ST.copy(
                        ST.valisize(
                            (aDeleteFromList ? aList.remove(i--) : aList.get(i)).getCraftingResult(aCrafting))));
        } catch (Throwable e) {
            e.printStackTrace(ERR);
        }
        return rList;
    ...
    public static boolean has(ItemStack aOutput) {
        ...
        List<IRecipe> tList = list();
        for (int i = 0; i < tList.size(); i++) if (ST.equal(
            OM.get(
                tList.get(i)
                    .getRecipeOutput()),
            aOutput,
            ...
            if (aDontRemoveDyeingRecipes) {
                if (tRecipe instanceof ShapedOreRecipe) {
                    ...
                    for (Object tObject : ((ShapedOreRecipe) tRecipe).getInput())
                        if (OREDICT_DYE_LISTS.contains(tObject)) {
                            temp = T;
                            break;
                        }
                    if (temp) continue;
    ...
    public static boolean remout(ModData aMod, String... aNames) {
        if (aMod.mLoaded) for (String aName : aNames) remout(aMod, aName, W);
        return aMod.mLoaded;
    }
    ...
    public static boolean remout(ModData aMod, String aName, int aMetaData) {
        return remout(ST.make(aMod, aName, 1, aMetaData));
    }
    ...
    public static void delate(ItemStack aOutput) {
        if (BUFFERING) RECIPES_TO_DELATE.add(aOutput);
        else remout(aOutput);
    }
    ...
    public static void delate(ModData aMod, String... aNames) {
        if (aMod.mLoaded) for (String aName : aNames) delate(aMod, aName, W);
    }
    ...
    public static void delate(ModData aMod, String aName, int aMetaData, int... aOtherMetaData) {
        ...
        delate(ST.make(aItem, 1, aMetaData));
        for (int tMetaData : aOtherMetaData) delate(ST.make(aItem, 1, tMetaData));
    }
    ...
    public static ItemStack remove(ItemStack... aRecipe) {
        ...
        for (int i = 0; i < tList.size(); i++) {
            try {
                for (; i < tList.size(); i++) {
                    if ((!(tList.get(i) instanceof ICraftingRecipeGT)
                        || ((ICraftingRecipeGT) tList.get(i)).isRemovableByGT()) && tList.get(i)
                            .matches(aCrafting, CS.DW)) {
                        tReturn = tList.get(i)
                            .getCraftingResult(aCrafting);
                        if (tReturn != null) {
