...
public interface IPacket {
    ...
    /**
     * It is VERY important that decoding and processing are in two different Steps! Otherwise there will be a
     * Memory-Leak caused by the Network Handler!
     * 
     * @return encoded byte Stream
     */
     ...
     * 
     * A better example might be provided by {@link gregapi.network.packets.PacketCoordinates} and
     * {@link gregapi.network.packets.data.PacketSyncDataShort}, because those ones are actually useful unlike this
     * example.
     */
    public static final class BasicPacket implements IPacket {
        ...
        @Override
        public byte getPacketID() {
            return 0; // This should be a constant. Do not make it a Variable, unless you REALLY know what you are
                      // doing.
        }
