...
public class PacketSyncDataLongAndIDsAndCovers extends PacketSyncDataLongAndIDs {
    ...
    public PacketSyncDataLongAndIDsAndCovers(int aX, int aY, int aZ, short aID1, short aID2, long aData,
    ...
    public PacketSyncDataLongAndIDsAndCovers(ChunkCoordinates aCoords, short aID1, short aID2, long aData,
        CoverData aCoverData) {
    ...
    private PacketSyncDataLongAndIDsAndCovers(int aX, int aY, int aZ, short aID1, short aID2, long aData,
    ...
    public PacketCoordinates decode2(int aX, int aY, int aZ, ByteArrayDataInput aData) {
        return new PacketSyncDataLongAndIDsAndCovers(
            aX,
            aY,
            aZ,
            aData.readShort(),
    ...
    public void process(IBlockAccess aWorld, INetworkHandler aNetworkHandler) {
        if (aWorld != null) {
            ...
            if (tBlock instanceof IBlockSyncDataAndCoversAndIDs)
                ((IBlockSyncDataAndCoversAndIDs) tBlock).receiveDataLong(
                    aWorld,
                    mX,
                    mY,
                    mZ,
