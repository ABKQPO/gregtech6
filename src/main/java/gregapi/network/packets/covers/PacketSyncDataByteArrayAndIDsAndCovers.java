...
public class PacketSyncDataByteArrayAndIDsAndCovers extends PacketSyncDataByteArrayAndIDs {
    ...
    public PacketSyncDataByteArrayAndIDsAndCovers(int aX, int aY, int aZ, short aID1, short aID2, byte[] aData,
    ...
    public PacketSyncDataByteArrayAndIDsAndCovers(ChunkCoordinates aCoords, short aID1, short aID2, byte[] aData,
        CoverData aCoverData) {
    ...
    private PacketSyncDataByteArrayAndIDsAndCovers(int aX, int aY, int aZ, short aID1, short aID2, byte[] aData,
    ...
    public void process(IBlockAccess aWorld, INetworkHandler aNetworkHandler) {
        if (aWorld != null) {
            ...
            if (tBlock instanceof IBlockSyncDataAndCoversAndIDs)
                ((IBlockSyncDataAndCoversAndIDs) tBlock).receiveDataByteArray(
                    aWorld,
                    mX,
                    mY,
                    mZ,
