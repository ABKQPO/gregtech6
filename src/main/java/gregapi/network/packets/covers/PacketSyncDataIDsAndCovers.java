...
public class PacketSyncDataIDsAndCovers extends PacketSyncDataIDs {
    ...
    public void process(IBlockAccess aWorld, INetworkHandler aNetworkHandler) {
        if (aWorld != null) {
            ...
            if (tBlock instanceof IBlockSyncDataAndCoversAndIDs) ((IBlockSyncDataAndCoversAndIDs) tBlock)
                .receiveData(aWorld, mX, mY, mZ, aNetworkHandler, mID1, mID2, mCoverIDs, mCoverMetas, mCoverVisuals);
        }
    }
}
