...
public class PacketSyncDataByteAndIDsAndCovers extends PacketSyncDataByteAndIDs {
    ...
    public PacketSyncDataByteAndIDsAndCovers(int aX, int aY, int aZ, short aID1, short aID2, byte aData,
    ...
    public PacketSyncDataByteAndIDsAndCovers(ChunkCoordinates aCoords, short aID1, short aID2, byte aData,
        CoverData aCoverData) {
    ...
    private PacketSyncDataByteAndIDsAndCovers(int aX, int aY, int aZ, short aID1, short aID2, byte aData,
    ...
    public PacketCoordinates decode2(int aX, int aY, int aZ, ByteArrayDataInput aData) {
        return new PacketSyncDataByteAndIDsAndCovers(
            aX,
            aY,
            aZ,
            aData.readShort(),
    ...
    public void process(IBlockAccess aWorld, INetworkHandler aNetworkHandler) {
        if (aWorld != null) {
            ...
            if (tBlock instanceof IBlockSyncDataAndCoversAndIDs)
                ((IBlockSyncDataAndCoversAndIDs) tBlock).receiveDataByte(
                    aWorld,
                    mX,
                    mY,
                    mZ,
