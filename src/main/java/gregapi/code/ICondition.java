...
public interface ICondition<O> {
    ...
    static class True<O> implements ICondition<O> {
    ...
    static class False<O> implements ICondition<O> {
    ...
    static class Null<O> implements ICondition<O> {
    ...
    static class NotNull<O> implements ICondition<O> {
