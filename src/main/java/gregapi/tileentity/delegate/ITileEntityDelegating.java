...
public interface ITileEntityDelegating extends ITileEntityCanDelegate {
    ...
    public static final byte EXTENDER_INV = 1, EXTENDER_TANK = 2, EXTENDER_REDSTONE = 4, EXTENDER_OTHER = 8,
        EXTENDER_CONTROL = 16, EXTENDER_ALL = 31;

    public static final String TOOLTIP_EXTENDER_EXCLUSIVE = LH
        .add("gt.tileentity.extender.tooltip.exclusive", "Cannot be attached to other Extenders!"),
    ...
    /**
     * Gets the TileEntity which is responsible for handling this Side. DO NOT RETURN NULL! Return a DelegatorTileEntity
     * Object without TileEntity, or a DelegatorTileEntity with the 'this' Object in order to not delegate.
     */
