...
public interface ITileEntitySoundSource extends ITileEntityUnloadable {
    ...
    public static class SoundSourceTileEntity implements ITickableSound {
        ...
        public SoundSourceTileEntity(IHasWorldAndCoords aTileEntity, boolean aRunning, String aSoundName,
        ...
        public float getXPosF() {
            return mTileEntity == null ? 0 : mTileEntity.getX() + 0.5F;
        }

        @Override
        public float getYPosF() {
            return mTileEntity == null ? 0 : mTileEntity.getY() + 0.5F;
        }

        @Override
        public float getZPosF() {
            return mTileEntity == null ? 0 : mTileEntity.getZ() + 0.5F;
        }
