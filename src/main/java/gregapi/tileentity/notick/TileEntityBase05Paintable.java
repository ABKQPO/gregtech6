...
public abstract class TileEntityBase05Paintable extends TileEntityBase04Covers implements IItemColorableRGB,
    ITileEntityDecolorable, IMTE_GetSubItems, IMTE_GetExplosionResistance, IMTE_GetBlockHardness, IMTE_SyncDataByte,
    IMTE_SyncDataByteArray, IMTE_GetFlammability, IMTE_GetFireSpreadSpeed, IMTE_GetLightOpacity {
    ...
    public IPacket getClientDataPacket(boolean aSendAll) {
        return aSendAll
            ? getClientDataPacketByteArray(
                ...
                getVisualData())
            : super.getClientDataPacketByte(aSendAll, getVisualData());
    }
