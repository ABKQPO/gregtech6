 ...
 */
public class MultiTileEntityChargingCraftingTable extends MultiTileEntityAdvancedCraftingTable
    ...
    public long doInject(TagData aEnergyType, byte aSide, long aSize, long aAmount, boolean aDoInject) {
        ...
        for (int i : SLOTS_TOOLS) if (slotHas(i) && aAmount > rReturn) {
            rReturn += IItemEnergy.Utility
                .inject(aEnergyType, slot(i), aSize, 1, this, getWorld(), getX(), getY(), getZ(), aDoInject);
        }
        return rReturn;
    }
