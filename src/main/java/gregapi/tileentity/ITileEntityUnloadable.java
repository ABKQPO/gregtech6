...
public interface ITileEntityUnloadable {
     ...
     * 
     * To do it properly just add a true Boolean Flag to your Member Variables ("mIsDead=false" for example) and set it
     * to true when "onChunkUnload" is called. Then return the following:
     * 
