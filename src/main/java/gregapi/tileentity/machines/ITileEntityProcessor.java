...
public interface ITileEntityProcessor extends ITileEntityProgress {
    ...
    public static class ProcessorDataRecipe {
        ...
        public ProcessorDataRecipe(Recipe aRecipe, byte aItemInputSide, byte aFluidInputSide, byte aItemOutputSide,
            byte aFluidOutputSide) {
        ...
        public ItemStack[] getItemInputs() {
            return mRecipe.mInputs;
        }

        public FluidStack[] getFluidInputs() {
            return mRecipe.mFluidInputs;
        }

        public ItemStack[] getItemOutputs() {
            return mRecipe.mOutputs;
        }

        public FluidStack[] getFluidOutputs() {
            return mRecipe.mFluidOutputs;
        }

        public byte getValidItemInputSide(ItemStack aStack) {
            return mItemInputSide;
        }

        public byte getValidFluidInputSide(FluidStack aFluid) {
            return mFluidInputSide;
        }
    ...
    public static class ProcessorDataDefault {
        ...
        public ProcessorDataDefault(ItemStack[] aItemInputs, FluidStack[] aFluidInputs, ItemStack[] aItemOutputs,
            FluidStack[] aFluidOutputs, byte aItemInputSide, byte aFluidInputSide, byte aItemOutputSide,
            byte aFluidOutputSide) {
            mItemInputSide = aItemInputSide;
            mFluidInputSide = aFluidInputSide;
            mItemOutputSide = aItemOutputSide;
        ...
        public byte getValidItemOutputSide(ItemStack aStack) {
            return mItemOutputSide;
        }

        public byte getValidFluidOutputSide(FluidStack aFluid) {
            return mFluidOutputSide;
        }
    }
}
