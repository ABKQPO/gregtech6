...
public interface ITileEntityMold extends ITileEntityUnloadable {
    ...
    /**
     * The first Parameter can also have a Material Amount higher or lower than the actually required Amount, usually
     * only in case it is done manually. It returns the amount of Material subtracted from the passed MaterialStack
     */
