...
public interface ITileEntityMultiBlockController extends ITileEntityUnloadable, IHasWorldAndCoords {
    ...
    public static class Util {
        ...
        public static boolean checkAndSetTarget(ITileEntityMultiBlockController aController, int aX, int aY, int aZ,
            int aRegistryMeta, int aRegistryID, int aDesign, int aMode, ChunkCoordinates aClickedAt, Entity aPlayer,
            ...
            if ((aInventory != null || aPlayer != null)
                ...
                if (WD.easyRep(aController.getWorld(), aX, aY, aZ)
                    && UT.Entities.canEdit(aPlayer, aX, aY, aZ, aStack)) {
                    if (aInventory == null || UT.Entities.hasInfiniteItems(aPlayer)) {
                        if (WD.set(aController.getWorld(), aX, aY, aZ, ST.make(aRegistryID, 1, aRegistryMeta))
                            && aPlayer != null) {
            ...
            if (tTileEntity instanceof MultiTileEntityMultiBlockPart
                && ((MultiTileEntityMultiBlockPart) tTileEntity).getMultiTileEntityID() == aRegistryMeta
                && ((MultiTileEntityMultiBlockPart) tTileEntity).getMultiTileEntityRegistryID() == aRegistryID) {
        ...
        public static boolean checkAndSetTargetOffset(ITileEntityMultiBlockController aController, int aX, int aY,
            int aZ, int aRegistryMeta, int aRegistryID, int aDesign, int aMode, ChunkCoordinates aClickedAt,
            Entity aPlayer, IInventory aInventory) {
            return checkAndSetTarget(
                aController,
                aX + aController.getX(),
                aY + aController.getY(),
                aZ + aController.getZ(),
        ...
        @Deprecated
        public static boolean checkAndSetTarget(ITileEntityMultiBlockController aController, int aX, int aY, int aZ,
            int aRegistryMeta, int aRegistryID, int aDesign, int aMode) {
            return checkAndSetTarget(
                aController,
                aX,
                aY,
        ...
        @Deprecated
        public static boolean checkAndSetTargetOffset(ITileEntityMultiBlockController aController, int aX, int aY,
            int aZ, int aRegistryMeta, int aRegistryID, int aDesign, int aMode) {
            return checkAndSetTarget(
                aController,
                aX + aController.getX(),
                aY + aController.getY(),
