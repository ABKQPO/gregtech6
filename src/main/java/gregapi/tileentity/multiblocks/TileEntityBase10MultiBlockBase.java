 ...
 */
public abstract class TileEntityBase10MultiBlockBase extends TileEntityBase09FacingSingle
            ...
            if (GT_API.sBlockIcons == null && aNBT.hasKey(NBT_TEXTURE)) {
                ...
                mTexturesFront = new IIconContainer[] {
                    new Textures.BlockIcons.CustomIcon(
                        "machines/multiblockmains/" + tTextureName + "/colored_front/bottom"),
                    new Textures.BlockIcons.CustomIcon(
                        "machines/multiblockmains/" + tTextureName + "/colored_front/top"),
                    new Textures.BlockIcons.CustomIcon(
                        "machines/multiblockmains/" + tTextureName + "/colored_front/side"),
                    new Textures.BlockIcons.CustomIcon(
                        "machines/multiblockmains/" + tTextureName + "/overlay_front/bottom"),
                    new Textures.BlockIcons.CustomIcon(
                        "machines/multiblockmains/" + tTextureName + "/overlay_front/top"),
                    new Textures.BlockIcons.CustomIcon(
                        "machines/multiblockmains/" + tTextureName + "/overlay_front/side") };
            } else {
    ...
    @Override
    public long onToolClickMultiBlock(String aTool, long aRemainingDurability, long aQuality, Entity aPlayer,
    ...
    public final byte getDirectionData() {
        return (byte) ((mFacing & 7) | (mStructureOkay ? 8 : 0));
    }

    @Override
    public final void setDirectionData(byte aData) {
        mFacing = (byte) (aData & 7);
        mStructureOkay = ((aData & 8) != 0);
    }

    @Override
    public ITexture getTexture2(Block aBlock, int aRenderPass, byte aSide, boolean[] aShouldSideBeRendered) {
        return aShouldSideBeRendered[aSide] ? BlockTextureMulti.get(
            BlockTextureDefault.get((aSide == mFacing ? mTexturesFront : mTextures)[FACES_TBS[aSide]], mRGBa),
            BlockTextureDefault.get((aSide == mFacing ? mTexturesFront : mTextures)[FACES_TBS[aSide] + 3])) : null;
    }
    ...
    public boolean checkStructure2(ChunkCoordinates aCoordinates, Entity aPlayer, IInventory aInventory) {
        return checkStructure2();
    }

    /**
     * Previous Version of the MultiBlock Structure Check without Builder Wand Support. Overriding this formerly
     * abstract function will still work for regular checks but is not recommended.
     */
    @Deprecated
