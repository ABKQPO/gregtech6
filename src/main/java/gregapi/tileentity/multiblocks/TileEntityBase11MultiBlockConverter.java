 ...
 */
public abstract class TileEntityBase11MultiBlockConverter extends TileEntityBase10MultiBlockBase
    implements ITileEntityRunningActively, ITileEntityEnergy, IMultiBlockEnergy {
    ...
    public void onTick2(long aTimer, boolean aIsServerSide) {
        ...
        if (aIsServerSide) {
            ...
            if (mActivity.mState != 0 && (mEnergyIN.mType == TD.Energy.RU || mEnergyOUT.mType == TD.Energy.RU)
                && WD.random(this, 20, CLIENT_TIME)) UT.Sounds.play(SFX.MC_MINECART, 1, 1.0F, getCoords());
        }
    }
    ...
    public boolean isEnergyType(TagData aEnergyType, byte aSide, boolean aEmitting) {
        return aEmitting ? aEnergyType == mEnergyOUT.mType : aEnergyType == mEnergyIN.mType;
    }
    ...
    public long getEnergySizeOutputMin(TagData aEnergyType, byte aSide) {
        return mEnergyOUT.sizeMin(aEnergyType);
    }

    @Override
    public long getEnergySizeOutputRecommended(TagData aEnergyType, byte aSide) {
        return mEnergyOUT.sizeRec(aEnergyType);
    }

    @Override
    public long getEnergySizeOutputMax(TagData aEnergyType, byte aSide) {
        return mEnergyOUT.sizeMax(aEnergyType);
    }

    @Override
    public long getEnergySizeInputMin(TagData aEnergyType, byte aSide) {
        return mEnergyIN.sizeMin(aEnergyType);
    }

    @Override
    public long getEnergySizeInputRecommended(TagData aEnergyType, byte aSide) {
        return mEnergyIN.sizeRec(aEnergyType);
    }

    @Override
    public long getEnergySizeInputMax(TagData aEnergyType, byte aSide) {
        return mEnergyIN.sizeMax(aEnergyType);
    }

    @Override
    public Collection<TagData> getEnergyTypes(byte aSide) {
        return new ArrayListNoNulls<>(F, mEnergyIN.mType, mEnergyOUT.mType);
    }
