...
public interface ITileEntityUSBPort extends ITileEntityUnloadable {
    ...
    /**
     * @return the Data Tag that is contained inside the "gt.usb.data" Tag of an USB Sticks NBTTagCompound. So
     *         "tItemStackUSB.getTagCompound().getCompoundTag(NBT_USB_DATA)".
     */
