...
public abstract class TileEntityBase06Covers extends TileEntityBase05Inventories
    ...
    public final long onToolClick(String aTool, long aRemainingDurability, long aQuality, Entity aPlayer,
        ...
        if (SIDES_VALID[aSide] && hasCovers()) {
            ...
            if (mCovers.mBehaviours[tSide] != null) {
                ...
                return mCovers.mBehaviours[tSide].onToolClick(
                    tSide,
                    mCovers,
                    aTool,
                    aRemainingDurability,
    ...
    public final boolean isSealable(byte aSide) {
        return (hasCovers() && mCovers.mBehaviours[aSide] != null
            && mCovers.mBehaviours[aSide].isSealable(aSide, mCovers)) || isSealable2(aSide);
    }
    ...
    public final void onWalkOver(EntityLivingBase aEntity) {
        if (!hasCovers() || mCovers.mBehaviours[SIDE_TOP] == null
            || !mCovers.mBehaviours[SIDE_TOP].onWalkOver(SIDE_TOP, mCovers, aEntity)) onWalkOver2(aEntity);
    }
