 ...
 */
public abstract class TileEntityBase03TicksAndSync extends TileEntityBase02AdjacentTEBuffer
    ...
    @Override
    public final net.minecraft.network.Packet getDescriptionPacket() {
        return null;
    }
    ...
    /**
     * Use this to check if it is required to send an update to the Clients. If you want you can call
     * "updateClientData", but then you need to return true in order for it to work.
     */
    ...
    /**
     * Used to reset all Variables which have something to do with the detection of Changes. A super Call is important
     * for this one!
     */
