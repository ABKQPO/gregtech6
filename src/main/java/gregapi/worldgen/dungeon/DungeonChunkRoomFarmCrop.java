...
public class DungeonChunkRoomFarmCrop extends DungeonChunkRoomEmpty {
    ...
    public boolean generate(DungeonData aData) {
        ...
        ArrayListNoNulls<Block> tCrops = new ArrayListNoNulls<>(
            F,
            Blocks.carrots,
            Blocks.potatoes,
            Blocks.wheat,
        ...
        for (int tX = 1; tX <= 14; tX++)
            for (int tZ = 1; tZ <= 14; tZ++) if ((tX <= 4 || tX >= 11) && (tZ <= 4 || tZ >= 11)) {
        ...
        aData.set(5, 1, 5, 32065);
        aData.set(5, 2, 5, Blocks.reeds);
        aData.set(5, 3, 5, Blocks.reeds);
        aData.set(5, 4, 5, Blocks.reeds);
        aData.set(5, 1, 10, 32065);
        aData.set(5, 2, 10, Blocks.cactus);
        aData.set(5, 3, 10, Blocks.cactus);
        aData.set(5, 4, 10, Blocks.cactus);
        aData.set(10, 1, 5, 32065);
        aData.set(10, 2, 5, Blocks.cactus);
        aData.set(10, 3, 5, Blocks.cactus);
        aData.set(10, 4, 5, Blocks.cactus);
        aData.set(10, 1, 10, 32065);
        aData.set(10, 2, 10, Blocks.reeds);
        aData.set(10, 3, 10, Blocks.reeds);
        aData.set(10, 4, 10, Blocks.reeds);

        if (aData.mRoomLayout[aData.mRoomX + 1][aData.mRoomZ] == 0) {
            aData.smooth(14, 3, 5, aData.mPrimary.mSlabs[SIDE_Z_POS], aData.mSecondary.mSlabs[SIDE_Z_POS]);
            aData.set(14, 3, 6, Blocks.log, 11);
            aData.set(13, 3, 6, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_X_NEG] + aData.next(3) * 4);
            aData.set(14, 3, 7, Blocks.log, 11);
            aData.set(13, 3, 7, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_X_NEG] + aData.next(3) * 4);
            aData.set(14, 3, 8, Blocks.log, 11);
            aData.set(13, 3, 8, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_X_NEG] + aData.next(3) * 4);
            aData.set(14, 3, 9, Blocks.log, 11);
            aData.set(13, 3, 9, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_X_NEG] + aData.next(3) * 4);
            aData.smooth(14, 3, 10, aData.mPrimary.mSlabs[SIDE_Z_NEG], aData.mSecondary.mSlabs[SIDE_Z_NEG]);

            aData.set(14, 1, 6, 32065);
            aData.set(
                14,
                2,
                6,
                BlocksGT.Saplings_AB,
                aData.next(BlocksGT.Saplings_AB.maxMeta()),
                BlocksGT.Saplings_CD,
                aData.next(BlocksGT.Saplings_CD.maxMeta()),
                Blocks.sapling,
                aData.next(6));
            aData.set(14, 1, 7, 32065);
            aData.set(
                14,
                2,
                7,
            ...
            aData.set(14, 4, 6, 32065);
            aData.flower(14, 5, 6);
            aData.set(14, 4, 7, 32065);
            aData.set(14, 5, 7, Blocks.double_plant, 1);
            aData.set(14, 6, 7, Blocks.double_plant, 9);
            aData.set(14, 4, 8, 32065);
            aData.flower(14, 5, 8);
            aData.set(14, 4, 9, 32065);
            aData.flower(14, 5, 9);
        }

        if (aData.mRoomLayout[aData.mRoomX - 1][aData.mRoomZ] == 0) {
            aData.smooth(1, 3, 5, aData.mPrimary.mSlabs[SIDE_Z_POS], aData.mSecondary.mSlabs[SIDE_Z_POS]);
            aData.set(1, 3, 6, Blocks.log, 11);
            aData.set(2, 3, 6, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_X_POS] + aData.next(3) * 4);
            aData.set(1, 3, 7, Blocks.log, 11);
            aData.set(2, 3, 7, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_X_POS] + aData.next(3) * 4);
            aData.set(1, 3, 8, Blocks.log, 11);
            aData.set(2, 3, 8, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_X_POS] + aData.next(3) * 4);
            aData.set(1, 3, 9, Blocks.log, 11);
            aData.set(2, 3, 9, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_X_POS] + aData.next(3) * 4);
            aData.smooth(1, 3, 10, aData.mPrimary.mSlabs[SIDE_Z_NEG], aData.mSecondary.mSlabs[SIDE_Z_NEG]);

            aData.set(1, 1, 6, 32065);
            aData.set(
                1,
                2,
                6,
            ...
            aData.set(1, 4, 6, 32065);
            aData.flower(1, 5, 6);
            aData.set(1, 4, 7, 32065);
            aData.flower(1, 5, 7);
            aData.set(1, 4, 8, 32065);
            aData.set(1, 5, 8, Blocks.double_plant, 0);
            aData.set(1, 6, 8, Blocks.double_plant, 9);
            aData.set(1, 4, 9, 32065);
            aData.flower(1, 5, 9);
        }

        if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ + 1] == 0) {
            aData.smooth(5, 3, 14, aData.mPrimary.mSlabs[SIDE_X_POS], aData.mSecondary.mSlabs[SIDE_X_POS]);
            aData.set(6, 3, 14, Blocks.log, 7);
            aData.set(6, 3, 13, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_Z_NEG] + aData.next(3) * 4);
            aData.set(7, 3, 14, Blocks.log, 7);
            aData.set(7, 3, 13, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_Z_NEG] + aData.next(3) * 4);
            aData.set(8, 3, 14, Blocks.log, 7);
            aData.set(8, 3, 13, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_Z_NEG] + aData.next(3) * 4);
            aData.set(9, 3, 14, Blocks.log, 7);
            aData.set(9, 3, 13, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_Z_NEG] + aData.next(3) * 4);
            aData.smooth(10, 3, 14, aData.mPrimary.mSlabs[SIDE_X_NEG], aData.mSecondary.mSlabs[SIDE_X_NEG]);

            aData.set(6, 1, 14, 32065);
            aData.set(
                6,
                2,
                14,
            ...
            aData.set(6, 4, 14, 32065);
            aData.flower(6, 5, 14);
            aData.set(7, 4, 14, 32065);
            aData.set(7, 5, 14, Blocks.double_plant, 4);
            aData.set(7, 6, 14, Blocks.double_plant, 9);
            aData.set(8, 4, 14, 32065);
            aData.flower(8, 5, 14);
            aData.set(9, 4, 14, 32065);
            aData.flower(9, 5, 14);
        }

        if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ - 1] == 0) {
            aData.smooth(5, 3, 1, aData.mPrimary.mSlabs[SIDE_X_POS], aData.mSecondary.mSlabs[SIDE_X_POS]);
            aData.set(6, 3, 1, Blocks.log, 7);
            aData.set(6, 3, 2, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_Z_POS] + aData.next(3) * 4);
            aData.set(7, 3, 1, Blocks.log, 7);
            aData.set(7, 3, 2, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_Z_POS] + aData.next(3) * 4);
            aData.set(8, 3, 1, Blocks.log, 7);
            aData.set(8, 3, 2, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_Z_POS] + aData.next(3) * 4);
            aData.set(9, 3, 1, Blocks.log, 7);
            aData.set(9, 3, 2, Blocks.cocoa, COMPASS_FROM_SIDE[SIDE_Z_POS] + aData.next(3) * 4);
            aData.smooth(10, 3, 1, aData.mPrimary.mSlabs[SIDE_X_NEG], aData.mSecondary.mSlabs[SIDE_X_NEG]);

            aData.set(6, 1, 1, 32065);
            aData.set(
                6,
                2,
                1,
            ...
            aData.set(6, 4, 1, 32065);
            aData.flower(6, 5, 1);
            aData.set(7, 4, 1, 32065);
            aData.flower(7, 5, 1);
            aData.set(8, 4, 1, 32065);
            aData.set(8, 5, 1, Blocks.double_plant, 5);
            aData.set(8, 6, 1, Blocks.double_plant, 9);
            aData.set(9, 4, 1, 32065);
            aData.flower(9, 5, 1);
        }
