...
public class DungeonChunkCorridor3 extends DungeonChunkCorridor {
    ...
    public boolean generate(DungeonData aData) {
        ...
        FL[] tDrinks = new FL[] { null, null, null, null, null, FL.Purple_Drink, FL.Purple_Drink, FL.Purple_Drink,
            FL.Vodka, FL.Mead, FL.Whiskey_GlenMcKenner, FL.Wine_Grape_Purple };
            ...
            switch (aData.next(4)) {
                case 0:
                    ...
                    aData.set(
                        ...
                        8,
                        SIDE_UNKNOWN,
                        (short) ((aData.next1in2() ? 508 : 8) + aData.next(3)),
                        UT.NBT.make("gt.dungeonloot", ChestGenHooks.STRONGHOLD_CORRIDOR, NBT_FACING, SIDE_X_NEG),
                        T,
                        T);
                    aData.smooth(10, 1, 9);
                ...
                case 2:
                    ...
                    aData.set(
                        ...
                        UT.NBT.make(
                            ...
                            SIDE_X_NEG,
                            NBT_KEY,
                            aData.mGeneratedKeys[2] ? aData.mKeyIDs[2] : aData.mKeyIDs[0]),
                        T,
                        T);
            ...
            switch (aData.next(4)) {
                case 0:
                    ...
                    aData.set(
                        ...
                        SIDE_UNKNOWN,
                        (short) ((aData.next1in2() ? 508 : 8) + aData.next(3)),
                        UT.NBT.make("gt.dungeonloot", ChestGenHooks.STRONGHOLD_CORRIDOR, NBT_FACING, SIDE_X_POS),
                        T,
                        T);
                ...
                case 2:
                    ...
                    aData.set(
                        ...
                        UT.NBT.make(
                            ...
                            SIDE_X_POS,
                            NBT_KEY,
                            aData.mGeneratedKeys[2] ? aData.mKeyIDs[2] : aData.mKeyIDs[1]),
                        T,
                        T);
                    aData.coins(3, 1, 8);
            ...
            switch (aData.next(4)) {
                case 0:
                    ...
                    aData.set(
                        ...
                        SIDE_UNKNOWN,
                        (short) ((aData.next1in2() ? 508 : 8) + aData.next(3)),
                        UT.NBT.make("gt.dungeonloot", ChestGenHooks.STRONGHOLD_CORRIDOR, NBT_FACING, SIDE_Z_NEG),
                        T,
                        T);
                    aData.smooth(9, 1, 10);
                ...
                case 2:
                    ...
                    aData.set(
                        ...
                        UT.NBT.make(
                            ...
                            SIDE_Z_NEG,
                            NBT_KEY,
                            aData.mGeneratedKeys[2] ? aData.mKeyIDs[2] : aData.mKeyIDs[3]),
                        T,
                        T);
            ...
            switch (aData.next(4)) {
                case 0:
                    ...
                    aData.set(
                        ...
                        SIDE_UNKNOWN,
                        (short) ((aData.next1in2() ? 508 : 8) + aData.next(3)),
                        UT.NBT.make("gt.dungeonloot", ChestGenHooks.STRONGHOLD_CORRIDOR, NBT_FACING, SIDE_Z_POS),
                        T,
                        T);
                ...
                case 2:
                    ...
                    aData.set(
                        ...
                        UT.NBT.make(
                            ...
                            SIDE_Z_POS,
                            NBT_KEY,
                            aData.mGeneratedKeys[2] ? aData.mKeyIDs[2] : aData.mKeyIDs[4]),
                        T,
                        T);
                    aData.coins(8, 1, 3);
