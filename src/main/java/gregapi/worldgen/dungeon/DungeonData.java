...
public class DungeonData extends WorldAndCoords {
    ...
    public DungeonData(World aWorld, int aX, int aY, int aZ, WorldgenDungeonGT aStructure, BlockStones aPrimaryBlock,
        BlockStones aSecondaryBlock, MultiTileEntityRegistry aRegistry,
        HashSetNoNulls<ChunkCoordinates> aLightUpdateCoords, HashSetNoNulls<TagData> aTags, long[] aKeyIDs,
        ItemStack[] aKeyStacks, boolean[] aGeneratedKeys, byte[][] aRoomLayout, int aRoomX, int aRoomZ,
        int aConnectionCount, int aColor, Random aRandom, NBTTagCompound aCoin) {
    ...
    public boolean bricks(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, 3 + next(3), 2);
    }

    public boolean cobbles(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, 1 + next(2), 2);
    }

    public boolean cobble(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.COBBL, 2);
    }

    public boolean mossycobble(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.MCOBL, 2);
    }

    public boolean brick(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.BRICK, 2);
    }

    public boolean redstoned(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.RSTBR, 3);
    }

    public boolean cracked(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.CRACK, 2);
    }

    public boolean mossy(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.MBRIK, 2);
    }

    public boolean chiseled(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.CHISL, 2);
    }

    public boolean tiles(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.TILES, 2);
    }

    public boolean smalltiles(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.STILE, 2);
    }

    public boolean smallbricks(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.SBRIK, 2);
    }

    public boolean smooth(int aX, int aY, int aZ, Block aPrimary, Block aSecondary) {
        return set(aX, aY, aZ, aY == 2 ? aSecondary : aPrimary, BlockStones.SMOTH, 2);
    }

    public boolean bricks(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, 3 + next(3), 2);
    }

    public boolean cobbles(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, 1 + next(2), 2);
    }

    public boolean cobble(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.COBBL, 2);
    }

    public boolean mossycobble(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.MCOBL, 2);
    }

    public boolean brick(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.BRICK, 2);
    }

    public boolean redstoned(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.RSTBR, 3);
    }

    public boolean cracked(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.CRACK, 2);
    }

    public boolean mossy(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.MBRIK, 2);
    }

    public boolean chiseled(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.CHISL, 2);
    }

    public boolean tiles(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.TILES, 2);
    }

    public boolean smalltiles(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.STILE, 2);
    }

    public boolean smallbricks(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.SBRIK, 2);
    }

    public boolean smooth(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, aY == 2 ? mSecondary : mPrimary, BlockStones.SMOTH, 2);
    }

    public boolean air(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, NB, 0, 2);
    }

    public boolean glass(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, BlocksGT.Glass, mColor, 2);
    }

    public boolean glassglow(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, BlocksGT.GlowGlass, mColor, 2);
    }

    public boolean colored(int aX, int aY, int aZ) {
        return set(aX, aY, aZ, BlocksGT.Concrete, mColor, 2);
    }
    ...
    public boolean coins(int aX, int aY, int aZ) {
        ...
        return mMTERegistryGT.mBlock
            .placeBlock(mWorld, mX + aX, mY + aY, mZ + aZ, SIDE_UNKNOWN, (short) 32700, mCoin, T, T);
    }

    public boolean set(int aX, int aY, int aZ, long aMeta) {
        return mMTERegistryGT.mBlock
            .placeBlock(mWorld, mX + aX, mY + aY, mZ + aZ, SIDE_UNKNOWN, (short) aMeta, null, T, T);
    }
    ...
    public boolean set(int aX, int aY, int aZ, long aMeta, boolean aCauseBlockUpdates, boolean aForcePlacement) {
        return mMTERegistryGT.mBlock.placeBlock(
            mWorld,
            mX + aX,
            mY + aY,
            mZ + aZ,
    ...
    public boolean set(int aX, int aY, int aZ, byte aSide, long aMeta, boolean aCauseBlockUpdates,
    ...
    public boolean set(int aX, int aY, int aZ, long aMeta, NBTTagCompound aNBT) {
        return mMTERegistryGT.mBlock
            .placeBlock(mWorld, mX + aX, mY + aY, mZ + aZ, SIDE_UNKNOWN, (short) aMeta, aNBT, T, T);
    }
    ...
    public boolean set(int aX, int aY, int aZ, long aMeta, NBTTagCompound aNBT, boolean aCauseBlockUpdates,
        boolean aForcePlacement) {
        return mMTERegistryGT.mBlock.placeBlock(
            mWorld,
            mX + aX,
    ...
    public boolean set(int aX, int aY, int aZ, byte aSide, long aMeta, NBTTagCompound aNBT, boolean aCauseBlockUpdates,
        boolean aForcePlacement) {
        return mMTERegistryGT.mBlock.placeBlock(
            mWorld,
            mX + aX,
    ...
    public boolean set(IBlockPlacable aBlock, int aX, int aY, int aZ, long[] aMetas) {
        return aBlock.placeBlock(
            mWorld,
            mX + aX,
            mY + aY,
            mZ + aZ,
            SIDE_UNKNOWN,
            (short) aMetas[next(aMetas.length)],
            null,
            T,
            T);
    }
    ...
    public boolean set(IBlockPlacable aBlock, int aX, int aY, int aZ, OreDictMaterial... aMaterials) {
        return aBlock.placeBlock(
            ...
            mZ + aZ,
            SIDE_UNKNOWN,
            aMaterials[next(aMaterials.length)].mID,
            null,
            T,
            T);
    }
    ...
    public boolean set(IBlockPlacable[] aBlocks, int aX, int aY, int aZ, long[] aMetas) {
        return aBlocks[next(aBlocks.length)].placeBlock(
            mWorld,
            mX + aX,
            mY + aY,
            mZ + aZ,
    ...
    public boolean set(IBlockPlacable aBlock, int aX, int aY, int aZ, long aMeta, boolean aCauseBlockUpdates,
        boolean aForcePlacement) {
        return aBlock.placeBlock(
            mWorld,
            mX + aX,
    ...
    public boolean obsidian(int aX, int aY, int aZ, boolean aGravity) {
        return set(
            ...
            Blocks.obsidian,
            0,
            IL.NeLi_Obsidian.exists() ? IL.NeLi_Obsidian.block() : IL.NePl_Obsidian.block(),
            0,
            IL.EtFu_Obsidian.block(),
            0,
            !aGravity ? Blocks.obsidian
                : IL.RC_Crushed_Obsidian.exists() ? IL.RC_Crushed_Obsidian.block()
                    : IL.HBM_Crushed_Obsidian.exists() ? IL.HBM_Crushed_Obsidian.block() : Blocks.obsidian,
            aGravity && IL.RC_Crushed_Obsidian.exists() ? 4 : 0);
    }
    ...
    public boolean flower(int aX, int aY, int aZ, boolean aGrassOnly, boolean aVanillaOnly) {
        if (BlocksGT.FlowersA != null) {
            if (aGrassOnly || BlocksGT.FlowersB == null) {
                ...
                switch (next(3)) {
                    case 0:
                        return set(aX, aY, aZ, (Block) BlocksGT.FlowersA, next(BlocksGT.FlowersA.maxMeta()), 2);
                    case 1:
                        return set(aX, aY, aZ, (Block) BlocksGT.FlowersB, next(BlocksGT.FlowersB.maxMeta()), 2);
                }
            }
        }
    ...
    public boolean ingots_or_plates(int aX, int aY, int aZ, long aStackSize, OreDictMaterial... aMaterials) {
        ItemStack aIngot = OP.ingot
            .mat(aMaterials[next(aMaterials.length)], aStackSize <= 0 ? nextStack() : UT.Code.bindStack(aStackSize));
        ItemStack aPlate = OP.plate
            .mat(aMaterials[next(aMaterials.length)], aStackSize <= 0 ? nextStack() : UT.Code.bindStack(aStackSize));
        if (ST.valid(aIngot)) return ST.valid(aPlate) && next1in2() ? set(aX, aY, aZ, 32085, ST.save(NBT_VALUE, aPlate))
            : set(aX, aY, aZ, 32084, ST.save(NBT_VALUE, aIngot));
    ...
    public boolean shelf(int aX, int aY, int aZ, long aMeta, byte aFacing, String aLootFront, NBTTagList aInventory) {
        return set(
            ...
            aZ,
            aMeta,
            UT.NBT.make(NBT_FACING, aFacing, "gt.dungeonloot.front", aLootFront, NBT_INV_LIST, aInventory));
    }
    ...
    public boolean shelf(int aX, int aY, int aZ, long aMeta, byte aFacing, String aLootFront, String aLootBack) {
        return set(
            ...
            aZ,
            aMeta,
            UT.NBT.make(NBT_FACING, aFacing, "gt.dungeonloot.front", aLootFront, "gt.dungeonloot.back", aLootBack));
    }

    public boolean shelf(int aX, int aY, int aZ, long aMeta, byte aFacing, String aLootFront, String aLootBack,
        NBTTagList aInventory) {
        return set(
            aX,
            aY,
            aZ,
    ...
    public boolean shelf(int aX, int aY, int aZ, long aMeta, byte aFacing, String[] aLootFront) {
        return set(
            ...
            UT.NBT.make(
                ...
                aFacing,
                "gt.dungeonloot.front",
                UT.Code.select(ChestGenHooks.STRONGHOLD_LIBRARY, aLootFront)));
    }
    ...
    public boolean shelf(int aX, int aY, int aZ, long aMeta, byte aFacing, String[] aLootFront, String[] aLootBack) {
        return set(
            ...
            UT.NBT.make(
                ...
                UT.Code.select(ChestGenHooks.STRONGHOLD_LIBRARY, aLootFront),
                "gt.dungeonloot.back",
                UT.Code.select(ChestGenHooks.STRONGHOLD_LIBRARY, aLootBack)));
    }
    ...
    public boolean cup(int aX, int aY, int aZ, FL aFluid) {
        return set(
            ...
            aZ,
            32739,
            FluidTankGT.writeToNBT(
                UT.NBT.make(NBT_COLOR, DYES_INT[mColor], NBT_PAINTED, T),
                NBT_TANK,
                aFluid == null ? null : aFluid.make(250)));
    }
    ...
    public boolean cup(int aX, int aY, int aZ, Fluid aFluid) {
        return set(
            ...
            32739,
            FluidTankGT
                .writeToNBT(UT.NBT.make(NBT_COLOR, DYES_INT[mColor], NBT_PAINTED, T), NBT_TANK, FL.make(aFluid, 250)));
    }
    ...
    public boolean pot(int aX, int aY, int aZ) {
        ...
        if (tTileEntity instanceof TileEntityFlowerPot) {
            if (next1in2()) {
                ((TileEntityFlowerPot) tTileEntity)
                    .func_145964_a(ST.item(BlocksGT.POT_FLOWER_TILES[tIndex]), BlocksGT.POT_FLOWER_METAS[tIndex]);
            } else {
                if (next1in2()) {
                    ((TileEntityFlowerPot) tTileEntity)
                        .func_145964_a(ST.item((Block) BlocksGT.FlowersA), next(BlocksGT.FlowersA.maxMeta()));
                } else {
                    ((TileEntityFlowerPot) tTileEntity)
                        .func_145964_a(ST.item((Block) BlocksGT.FlowersB), next(BlocksGT.FlowersB.maxMeta()));
                }
            }
        }
        return T;
    ...
    public boolean set(int aX, int aY, int aZ, Block aBlock1, int aMeta1, Block aBlock2, int aMeta2, int aFlags) {
        ...
        switch (next(2)) {
            ...
            default:
                return set(aX, aY, aZ, aBlock2, aMeta2, aFlags);
        }
    }

    public boolean set(int aX, int aY, int aZ, Block aBlock1, int aMeta1, Block aBlock2, int aMeta2, Block aBlock3,
        int aMeta3) {
        return set(aX, aY, aZ, aBlock1, aMeta1, aBlock2, aMeta2, aBlock3, aMeta3, 2);
    }

    public boolean set(int aX, int aY, int aZ, Block aBlock1, int aMeta1, Block aBlock2, int aMeta2, Block aBlock3,
        int aMeta3, int aFlags) {
        ...
        switch (next(3)) {
            ...
            case 1:
                return set(aX, aY, aZ, aBlock2, aMeta2, aFlags);
            default:
                return set(aX, aY, aZ, aBlock3, aMeta3, aFlags);
        }
    }

    public boolean set(int aX, int aY, int aZ, Block aBlock1, int aMeta1, Block aBlock2, int aMeta2, Block aBlock3,
        int aMeta3, Block aBlock4, int aMeta4) {
        return set(aX, aY, aZ, aBlock1, aMeta1, aBlock2, aMeta2, aBlock3, aMeta3, aBlock4, aMeta4, 2);
    }

    public boolean set(int aX, int aY, int aZ, Block aBlock1, int aMeta1, Block aBlock2, int aMeta2, Block aBlock3,
        int aMeta3, Block aBlock4, int aMeta4, int aFlags) {
        if (aBlock1 == NB || aBlock1 == null)
            return set(aX, aY, aZ, aBlock2, aMeta2, aBlock3, aMeta3, aBlock4, aMeta4, aFlags);
        if (aBlock2 == NB || aBlock2 == null)
            return set(aX, aY, aZ, aBlock1, aMeta1, aBlock3, aMeta3, aBlock4, aMeta4, aFlags);
        if (aBlock3 == NB || aBlock3 == null)
            return set(aX, aY, aZ, aBlock1, aMeta1, aBlock2, aMeta2, aBlock4, aMeta4, aFlags);
        if (aBlock4 == NB || aBlock4 == null)
            return set(aX, aY, aZ, aBlock1, aMeta1, aBlock2, aMeta2, aBlock3, aMeta3, aFlags);
        switch (next(4)) {
            case 0:
                return set(aX, aY, aZ, aBlock1, aMeta1, aFlags);
            case 1:
            ...
            case 2:
                return set(aX, aY, aZ, aBlock3, aMeta3, aFlags);
            default:
                return set(aX, aY, aZ, aBlock4, aMeta4, aFlags);
        }
    }
}
