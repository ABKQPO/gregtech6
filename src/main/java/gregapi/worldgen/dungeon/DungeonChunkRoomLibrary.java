        ...
        for (int tY = 1; tY <= 5; tY++) {
            ...
            if (tY == 3) {
                ...
                if (tKeyIndex < aData.mGeneratedKeys.length) {
                    ...
                    tList
                        .appendTag(UT.NBT.makeShort(ST.save(aData.mKeyStacks[tKeyIndex]), "s", (short) aData.next(14)));
                }
        ...
        switch (aData.next(4)) {
            case 0:
                ...
                aData.cup(
                    ...
                    2,
                    12,
                    FL.Potion_NightVision_1L,
                    aData.next1in2() ? tHexoriumColor : tHexoriumRandom,
                    aData.next1in2() ? 1 : 9);
                break;
            case 1:
