...
public class DungeonChunkRoomLibraryNormal extends DungeonChunkRoomLibrary {
    ...
    public boolean generate(DungeonData aData) {
        ...
        if (aData.mRoomLayout[aData.mRoomX + 1][aData.mRoomZ] == 0) {
            ...
            if (tDidntGenerateZPM && aData.next(16) == 0 && aData.zpm(14, 2, 6)) tDidntGenerateZPM = F;
            else aData.pot(14, 2, 6, aData.next1in2() ? tHexoriumColor : tHexoriumRandom, aData.next1in2() ? 1 : 9);
            aData.cup(14, 2, 7 + aData.next(2), FL.Potion_NightVision_1L);
            if (tDidntGenerateZPM && aData.next(16) == 0 && aData.zpm(14, 2, 9)) tDidntGenerateZPM = F;
            else aData.pot(14, 2, 9, aData.next1in2() ? tHexoriumColor : tHexoriumRandom, aData.next1in2() ? 1 : 9);
        ...
        if (aData.mRoomLayout[aData.mRoomX - 1][aData.mRoomZ] == 0) {
            ...
            if (tDidntGenerateZPM && aData.next(16) == 0 && aData.zpm(1, 2, 6)) tDidntGenerateZPM = F;
            else aData.pot(1, 2, 6, aData.next1in2() ? tHexoriumColor : tHexoriumRandom, aData.next1in2() ? 1 : 9);
            aData.cup(1, 2, 7 + aData.next(2), FL.Potion_NightVision_1L);
            if (tDidntGenerateZPM && aData.next(16) == 0 && aData.zpm(1, 2, 9)) tDidntGenerateZPM = F;
            else aData.pot(1, 2, 9, aData.next1in2() ? tHexoriumColor : tHexoriumRandom, aData.next1in2() ? 1 : 9);
        ...
        if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ + 1] == 0) {
            ...
            if (tDidntGenerateZPM && aData.next(16) == 0 && aData.zpm(6, 2, 14)) tDidntGenerateZPM = F;
            else aData.pot(6, 2, 14, aData.next1in2() ? tHexoriumColor : tHexoriumRandom, aData.next1in2() ? 1 : 9);
            aData.cup(7 + aData.next(2), 2, 14, FL.Potion_NightVision_1L);
            if (tDidntGenerateZPM && aData.next(16) == 0 && aData.zpm(9, 2, 14)) tDidntGenerateZPM = F;
            else aData.pot(9, 2, 14, aData.next1in2() ? tHexoriumColor : tHexoriumRandom, aData.next1in2() ? 1 : 9);
        ...
        if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ - 1] == 0) {
            ...
            if (tDidntGenerateZPM && aData.next(16) == 0 && aData.zpm(6, 2, 1)) tDidntGenerateZPM = F;
            else aData.pot(6, 2, 1, aData.next1in2() ? tHexoriumColor : tHexoriumRandom, aData.next1in2() ? 1 : 9);
            aData.cup(7 + aData.next(2), 2, 1, FL.Potion_NightVision_1L);
            if (tDidntGenerateZPM && aData.next(16) == 0 && aData.zpm(9, 2, 1)) tDidntGenerateZPM = F;
            else aData.pot(9, 2, 1, aData.next1in2() ? tHexoriumColor : tHexoriumRandom, aData.next1in2() ? 1 : 9);
