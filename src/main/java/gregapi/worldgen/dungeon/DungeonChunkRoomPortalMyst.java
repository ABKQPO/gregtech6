...
public class DungeonChunkRoomPortalMyst extends DungeonChunkRoomPortal {
    ...
    public boolean generate(DungeonData aData) {
        ...
        if (aData.mRoomLayout[aData.mRoomX - 1][aData.mRoomZ] != 0) {
            aData
                .set(14, 2, 10, SIDE_UNKNOWN, 502, UT.NBT.make(NBT_FACING, SIDE_X_NEG, NBT_INV_LIST, tInventory), T, T);
        ...
        if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ - 1] != 0) {
            aData
                .set(10, 2, 14, SIDE_UNKNOWN, 502, UT.NBT.make(NBT_FACING, SIDE_Z_NEG, NBT_INV_LIST, tInventory), T, T);
