...
public class DungeonChunkBarracks extends DungeonChunkRoomEmpty {
    ...
    public boolean generate(DungeonData aData) {
        ...
        FL[] tDrinks = new FL[] { null, null, null, null, null, FL.Purple_Drink, FL.Grenade_Juice, FL.Vodka,
            FL.Leninade, FL.Mead, FL.BAWLS, FL.Whiskey_GlenMcKenner, FL.Wine_Grape_Purple };

        Block tHexoriumColor = ST
        ...
        aData.set(
            ...
            SIDE_UNKNOWN,
            32074,
            ST.save(NBT_VALUE, OP.rockGt.mat(MT.STONES.SkyStone, 16 + aData.next(49))),
            T,
            T);// You need 4 Blocks of Sky Stone to start an AE System, so these 16+ Rocks will guarantee that you have
               // enough, even when AE Meteors are disabled, or if AE got added to the Modpack later.

        String[] tLoots = new String[] { ChestGenHooks.STRONGHOLD_LIBRARY, ChestGenHooks.STRONGHOLD_CORRIDOR,
            ChestGenHooks.STRONGHOLD_CROSSING, ChestGenHooks.PYRAMID_DESERT_CHEST, ChestGenHooks.PYRAMID_JUNGLE_CHEST,
            ChestGenHooks.VILLAGE_BLACKSMITH, ChestGenHooks.MINESHAFT_CORRIDOR, ChestGenHooks.DUNGEON_CHEST,
        ...
        aData.set(
            ...
            3010,
            UT.NBT
                .make("gt.dungeonloot", UT.Code.select("", tLoots), NBT_FACING, SIDE_Z_POS, NBT_KEY, aData.mKeyIDs[0]),
            T,
            T);
        aData.set(
            3,
            ...
            7110,
            UT.NBT
                .make("gt.dungeonloot.front", UT.Code.select("", tLoots), NBT_FACING, SIDE_Z_POS, NBT_INV_LIST, tList),
            T,
            T);
        ...
        aData.set(
            ...
            3010,
            UT.NBT
                .make("gt.dungeonloot", UT.Code.select("", tLoots), NBT_FACING, SIDE_Z_NEG, NBT_KEY, aData.mKeyIDs[1]),
            T,
            T);
        aData.set(
            3,
            ...
            7110,
            UT.NBT
                .make("gt.dungeonloot.front", UT.Code.select("", tLoots), NBT_FACING, SIDE_Z_NEG, NBT_INV_LIST, tList),
            T,
            T);
        ...
        aData.set(
            ...
            3010,
            UT.NBT
                .make("gt.dungeonloot", UT.Code.select("", tLoots), NBT_FACING, SIDE_Z_POS, NBT_KEY, aData.mKeyIDs[3]),
            T,
            T);
        aData.set(
            12,
        ...
        if (!aData.mGeneratedKeys[4]) {
            ...
            // Hint that there is something behind the Shelf.
            if (tKeySlot >= 14) {
                aData.cobble(12, 1, 15);
                aData.cobble(12, 2, 15);
                aData.cobble(12, 3, 15);
            }
        }
        aData.set(
            11,
            ...
            3010,
            UT.NBT
                .make("gt.dungeonloot", UT.Code.select("", tLoots), NBT_FACING, SIDE_Z_NEG, NBT_KEY, aData.mKeyIDs[4]),
            T,
            T);
        aData.set(
            12,
