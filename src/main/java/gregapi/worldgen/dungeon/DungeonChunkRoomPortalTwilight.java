    ...
    public boolean generate(DungeonData aData) {
        ...
        if (aData.mRoomLayout[aData.mRoomX + 1][aData.mRoomZ] != 0) {
            aData.set(
                ...
                SIDE_UNKNOWN,
                (short) 502,
                UT.NBT.make(NBT_FACING, SIDE_X_POS, NBT_INV_LIST, tInventory),
                T,
                T);
        ...
        if (aData.mRoomLayout[aData.mRoomX - 1][aData.mRoomZ] != 0) {
            aData.set(
                ...
                SIDE_UNKNOWN,
                (short) 502,
                UT.NBT.make(NBT_FACING, SIDE_X_NEG, NBT_INV_LIST, tInventory),
                T,
                T);
        ...
        if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ + 1] != 0) {
            aData.set(
                ...
                SIDE_UNKNOWN,
                (short) 502,
                UT.NBT.make(NBT_FACING, SIDE_Z_POS, NBT_INV_LIST, tInventory),
                T,
                T);
        ...
        if (aData.mRoomLayout[aData.mRoomX][aData.mRoomZ - 1] != 0) {
            aData.set(
                ...
                SIDE_UNKNOWN,
                (short) 502,
                UT.NBT.make(NBT_FACING, SIDE_Z_NEG, NBT_INV_LIST, tInventory),
                T,
                T);
