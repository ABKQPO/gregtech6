 ...
 *         It is a good Idea to just extend this Class and do a super Call in order to have an Empty Room generated
 *         before placing your Interior Design.
 */
public class DungeonChunkRoomEmpty extends DungeonChunkPillar {
    ...
    public boolean generate(DungeonData aData) {
        ...
        } // The Pillar is not important enough to fail the entire Room.
        ...
        if (WD.liquid(aData.mWorld, aData.mX + 8, aData.mY + 9, aData.mZ + 8)
            || aData.mWorld.canBlockSeeTheSky(aData.mX + 8, aData.mY + 9, aData.mZ + 8)) {
