...
public class DungeonChunkCorridor extends DungeonChunkPillar {
    ...
    public boolean generate(DungeonData aData) {
        if ((aData.mRoomLayout[aData.mRoomX + 1][aData.mRoomZ] != 0
            ...
            } // The Pillar is not important enough to fail the entire Corridor.
        }
        ...
        for (int tX = 5; tX <= 10; tX++) for (int tZ = 5; tZ <= 10; tZ++) for (int tY = 0; tY <= 4; tY++) {
            if (tY == 0) {
                ...
                if (tY == 4) {
                    if (WD.liquid(aData.mWorld, aData.mX + tX, aData.mY + tY + 1, aData.mZ + tZ)
                        || aData.mWorld.canBlockSeeTheSky(aData.mX + tX, aData.mY + tY + 1, aData.mZ + tZ)) {
        ...
        if (aData.next1in3()) switch (aData.next(4)) {
            case 0:
                if (aData.next1in2()) {
                    aData.set(6, 1, 9, SIDE_UNKNOWN, 32110, null, T, T);
            ...
            case 1:
                if (aData.next1in2()) {
                    aData.set(9, 1, 9, SIDE_UNKNOWN, 32110, null, T, T);
            ...
            case 2:
                if (aData.next1in2()) {
                    aData.set(6, 1, 6, SIDE_UNKNOWN, 32110, null, T, T);
            ...
            default:
                if (aData.next1in2()) {
                    aData.set(9, 1, 6, SIDE_UNKNOWN, 32110, null, T, T);
        ...
        if (WD.liquid(aData.mWorld, aData.mX + 7, aData.mY + 4, aData.mZ + 7)
            || WD.liquid(aData.mWorld, aData.mX + 7, aData.mY + 4, aData.mZ + 8)
            || WD.liquid(aData.mWorld, aData.mX + 8, aData.mY + 4, aData.mZ + 7)
            || WD.liquid(aData.mWorld, aData.mX + 8, aData.mY + 4, aData.mZ + 8)
            || aData.mWorld.canBlockSeeTheSky(aData.mX + 7, aData.mY + 4, aData.mZ + 7)
            || aData.mWorld.canBlockSeeTheSky(aData.mX + 7, aData.mY + 4, aData.mZ + 8)
            || aData.mWorld.canBlockSeeTheSky(aData.mX + 8, aData.mY + 4, aData.mZ + 7)
            || aData.mWorld.canBlockSeeTheSky(aData.mX + 8, aData.mY + 4, aData.mZ + 8)) {
