...
public abstract class WorldgenObject {
    ...
    public WorldgenObject(String aName, boolean aDefault, List<WorldgenObject>... aLists) {
        if (UT.Code.stringInvalid(aName)) throw new IllegalArgumentException(
            "The Name has to be not null and is also not allowed to be an empty String");
        mName = aName;
    ...
    public boolean enabled(World aWorld, int aDimType) {
        ...
        boolean tValue = getConfigFile().get(
            mCategory + ".dim",
