...
public class WorldAndCoords implements IHasWorldAndCoords, Comparable<WorldAndCoords> {
    ...
    public WorldAndCoords(TileEntity aTileEntity) {
        mWorld = aTileEntity.getWorldObj();
        mX = aTileEntity.xCoord;
        mY = aTileEntity.yCoord;
        mZ = aTileEntity.zCoord;
    }
    ...
    public ChunkCoordinates getCoords() {
        return new ChunkCoordinates(mX, mY, mZ);
    }
    ...
    public boolean isServerSide() {
        return mWorld == null ? cpw.mods.fml.common.FMLCommonHandler.instance()
            .getEffectiveSide()
            .isServer() : !mWorld.isRemote;
    }
    ...
    public TileEntity getTileEntity(int aX, int aY, int aZ) {
        return mWorld == null ? null : mWorld.getTileEntity(aX, aY, aZ);
    }

    @Override
    public Block getBlock(int aX, int aY, int aZ) {
        return mWorld == null ? NB : mWorld.getBlock(aX, aY, aZ);
    }

    @Override
    public byte getMetaData(int aX, int aY, int aZ) {
        return mWorld == null ? 0 : UT.Code.bind4(mWorld.getBlockMetadata(aX, aY, aZ));
    }

    @Override
    public byte getLightLevel(int aX, int aY, int aZ) {
        return mWorld == null ? 0 : UT.Code.bind4((long) mWorld.getLightBrightness(aX, aY, aZ) * 15);
    }

    @Override
    public boolean getOpacity(int aX, int aY, int aZ) {
        return mWorld != null && mWorld.getBlock(aX, aY, aZ)
            .isOpaqueCube();
    }

    @Override
    public boolean getSky(int aX, int aY, int aZ) {
        return mWorld == null || mWorld.canBlockSeeTheSky(aX, aY, aZ);
    }

    @Override
    public boolean getRain(int aX, int aY, int aZ) {
        return mWorld == null || mWorld.getPrecipitationHeight(aX, aZ) <= aY;
    }

    @Override
    public boolean getAir(int aX, int aY, int aZ) {
        return mWorld == null || mWorld.getBlock(aX, aY, aZ)
            .isAir(mWorld, aX, aY, aZ);
    }

    @Override
    public BiomeGenBase getBiome() {
        return getBiome(mX, mZ);
    }

    @Override
    public BiomeGenBase getBiome(int aX, int aZ) {
        return mWorld == null ? null : mWorld.getBiomeGenForCoords(aX, aZ);
    }

    @Override
    public BiomeGenBase getBiome(ChunkCoordinates aCoords) {
        return mWorld == null ? null : mWorld.getBiomeGenForCoords(aCoords.posX, aCoords.posZ);
    }

    @Override
    public TileEntity getTileEntity(ChunkCoordinates aCoords) {
        return mWorld == null ? null : mWorld.getTileEntity(aCoords.posX, aCoords.posY, aCoords.posZ);
    }

    @Override
    public Block getBlock(ChunkCoordinates aCoords) {
        return mWorld == null ? NB : mWorld.getBlock(aCoords.posX, aCoords.posY, aCoords.posZ);
    }

    @Override
    public byte getMetaData(ChunkCoordinates aCoords) {
        return mWorld == null ? 0 : UT.Code.bind4(mWorld.getBlockMetadata(aCoords.posX, aCoords.posY, aCoords.posZ));
    }

    @Override
    public byte getLightLevel(ChunkCoordinates aCoords) {
        return mWorld == null ? 0
            : UT.Code.bind4((long) mWorld.getLightBrightness(aCoords.posX, aCoords.posY, aCoords.posZ) * 15);
    }

    @Override
    public boolean getOpacity(ChunkCoordinates aCoords) {
        return mWorld != null && mWorld.getBlock(aCoords.posX, aCoords.posY, aCoords.posZ)
            .isOpaqueCube();
    }

    @Override
    public boolean getSky(ChunkCoordinates aCoords) {
        return mWorld == null || mWorld.canBlockSeeTheSky(aCoords.posX, aCoords.posY, aCoords.posZ);
    }

    @Override
    public boolean getRain(ChunkCoordinates aCoords) {
        return mWorld == null || mWorld.getPrecipitationHeight(aCoords.posX, aCoords.posZ) <= aCoords.posY;
    }

    @Override
    public boolean getAir(ChunkCoordinates aCoords) {
        return mWorld == null || mWorld.getBlock(aCoords.posX, aCoords.posY, aCoords.posZ)
            .isAir(mWorld, aCoords.posX, aCoords.posY, aCoords.posZ);
    }

    @Override
    public Block getBlockOffset(int aX, int aY, int aZ) {
        return getBlock(mX + aX, mY + aY, mZ + aZ);
    }
    ...
    public byte getMetaDataOffset(int aX, int aY, int aZ) {
        return getMetaData(mX + aX, mY + aY, mZ + aZ);
    }
    ...
    public byte getLightLevelOffset(int aX, int aY, int aZ) {
        return getLightLevel(mX + aX, mY + aY, mZ + aZ);
    }
    ...
    public boolean getOpacityOffset(int aX, int aY, int aZ) {
        return getOpacity(mX + aX, mY + aY, mZ + aZ);
    }
    ...
    public boolean getRainOffset(int aX, int aY, int aZ) {
        return getRain(mX + aX, mY + aY, mZ + aZ);
    }
    ...
    public boolean getSkyOffset(int aX, int aY, int aZ) {
        return getSky(mX + aX, mY + aY, mZ + aZ);
    }
    ...
    public boolean getAirOffset(int aX, int aY, int aZ) {
        return getAir(mX + aX, mY + aY, mZ + aZ);
    }
    ...
    public TileEntity getTileEntityOffset(int aX, int aY, int aZ) {
        return getTileEntity(mX + aX, mY + aY, mZ + aZ);
    }
        ...
        if (SIDES_INVALID[aSide]) {
            ...
            for (byte tSide : ALL_SIDES_VALID) {
                rRedstone = (byte) Math.max(
                    rRedstone,
                    mWorld.getIndirectPowerLevelTo(getOffsetX(tSide), getOffsetY(tSide), getOffsetZ(tSide), tSide));
                if (rRedstone >= 15) return 15;
            }
            return rRedstone;
        }
        return UT.Code
            .bind4(mWorld.getIndirectPowerLevelTo(getOffsetX(aSide), getOffsetY(aSide), getOffsetZ(aSide), aSide));
    }
    ...
    public boolean equals(Object aObject) {
        return aObject instanceof WorldAndCoords && ((WorldAndCoords) aObject).mWorld == mWorld
            && ((WorldAndCoords) aObject).mX == mX
            && ((WorldAndCoords) aObject).mY == mY
            && ((WorldAndCoords) aObject).mZ == mZ;
    }

    @Override
    public int hashCode() {
        return mX + mZ << 8 + mY << 16;
    }

    @Override
    public int compareTo(WorldAndCoords aObject) {
        return mY == aObject.mY ? mZ == aObject.mZ ? mX - aObject.mX : mZ - aObject.mZ : mY - aObject.mY;
    }

    @Override
    public String toString() {
        return "Pos{x=" + mX + ", y=" + mY + ", z=" + mZ + '}';
    }
}
