...
public interface IHasWorldAndCoords extends IHasWorld, IHasCoords {
    ...
    /**
     * Do not return null! See {@link ITileEntityDelegating} if aAllowDelegates is false, it will check if the
     * TileEntity can delegate, see {@link ITileEntityCanDelegate}, and if it can, then this will output a Delegator
     * Object with a null TileEntity instead.
     */
