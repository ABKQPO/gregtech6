...
public class DummyWorld extends World {
    ...
    public DummyWorld(ISaveHandler par1iSaveHandler, String par2Str, WorldProvider par3WorldProvider,
    ...
    public DummyWorld() {
        ...
        }, new WorldSettings(new WorldInfo(UT.NBT.make())), new Profiler());
    }
